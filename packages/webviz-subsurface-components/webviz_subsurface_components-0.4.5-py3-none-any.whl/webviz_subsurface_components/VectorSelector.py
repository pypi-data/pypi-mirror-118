...
- showSuggestions (boolean; default True):
    ...
    @_explicitize_args
    def __init__(self, id=Component.REQUIRED, maxNumSelectedNodes=Component.UNDEFINED, delimiter=Component.UNDEFINED, numMetaNodes=Component.UNDEFINED, data=Component.REQUIRED, label=Component.UNDEFINED, showSuggestions=Component.UNDEFINED, selectedTags=Component.UNDEFINED, placeholder=Component.UNDEFINED, numSecondsUntilSuggestionsAreShown=Component.UNDEFINED, lineBreakAfterTag=Component.UNDEFINED, persistence=Component.UNDEFINED, persisted_props=Component.UNDEFINED, persistence_type=Component.UNDEFINED, **kwargs):
        self._prop_names = ['id', 'data', 'delimiter', 'label', 'lineBreakAfterTag', 'maxNumSelectedNodes', 'numMetaNodes', 'numSecondsUntilSuggestionsAreShown', 'persisted_props', 'persistence', 'persistence_type', 'placeholder', 'selectedTags', 'showSuggestions']
        self._type = 'VectorSelector'
        self._namespace = 'webviz_subsurface_components'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'data', 'delimiter', 'label', 'lineBreakAfterTag', 'maxNumSelectedNodes', 'numMetaNodes', 'numSecondsUntilSuggestionsAreShown', 'persisted_props', 'persistence', 'persistence_type', 'placeholder', 'selectedTags', 'showSuggestions']
