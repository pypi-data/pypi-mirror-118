...
def hepmc_convert(input_file, output_file, input_type, hepmc_vers=3, nskip=0, nprocess=0, begin_func=None, progress_func=None, transform_func=None, reader=None, convert_func=None, rules=None, beam_particles=None):
    ...
    try:
        ...
        for evt_index, source_event in enumerate(reader.events(nskip, nprocess)):
            ...
            if convert_func:
                convert_func(evt_index, hepmc_event, source_event, rules=rules, beam_particles=beam_particles)
            ...
            elif input_type == McFileTypes.USER and rules:
                # User define conversion
                lund_to_hepmc(hepmc_event, source_event, rules, beam_particles=beam_particles)
