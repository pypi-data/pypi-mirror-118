...
def _tmp_path(file_name):
    """Gets output temporary file path"""

    return os.path.join(os.path.dirname(os.path.realpath(__file__)), 'tmp', file_name)

def test_Polarization():
    xout1=hm.WriterAscii (_tmp_path("testPolarization1.dat"))
    xout2=hm.WriterAscii(_tmp_path("testPolarization2.dat"))
    xout4=hm.WriterAsciiHepMC2(_tmp_path( "testPolarization4.out" ))
    xout5=hm.WriterAscii(_tmp_path("testPolarization5.out" ))
