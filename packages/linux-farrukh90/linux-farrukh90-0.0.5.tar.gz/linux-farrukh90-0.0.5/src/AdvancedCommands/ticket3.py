...
def filestructure():
    try:
        FILETOWORK="/root/services"
        # Checks if "/root/services" is created
 ...
 # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # 
    try:
        FILETOWORK="/root/ordered.txt"
        # Checks if "/root/ordered.txt" is created
        if os.path.getsize(FILETOWORK) <= 0:
            print(bcolors.FAIL + FILETOWORK + " " + "seems to be empty" + bcolors.ENDC  )
            time.sleep(0.5)
        else:
        ...
        with open(FILETOWORK) as file_content:
            ...
            if x and x[0].isdigit():
                ...
                print(bcolors.OKGREEN + FILETOWORK + " " + "is not numerated" + bcolors.ENDC  )
    except FileNotFoundError:
        print(bcolors.FAIL +  FILETOWORK + " is not created"+ bcolors.ENDC)
    time.sleep(0.5)
 # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # 
