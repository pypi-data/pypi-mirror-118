...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', '4.16.0-alpha.1630401092+21d73a51'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure 4.16.0-alpha.1630401092+21d73a51`
                """)
            else:
                raise
