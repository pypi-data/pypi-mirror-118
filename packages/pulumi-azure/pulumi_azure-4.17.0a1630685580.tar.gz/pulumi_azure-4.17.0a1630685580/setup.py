...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', '4.17.0-alpha.1630685580+1fa2b48c'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure 4.17.0-alpha.1630685580+1fa2b48c`
                """)
            else:
                raise
