...
static int import_petsc4py__PETSc(void) {
  ...
  __pyx_ptype_8petsc4py_5PETSc_FE = __Pyx_ImportType(module, "petsc4py.PETSc", "FE", sizeof(struct PyPetscFEObject), __Pyx_ImportType_CheckSize_Warn);
   if (!__pyx_ptype_8petsc4py_5PETSc_FE) goto bad;
  __pyx_ptype_8petsc4py_5PETSc_Quad = __Pyx_ImportType(module, "petsc4py.PETSc", "Quad", sizeof(struct PyPetscQuadObject), __Pyx_ImportType_CheckSize_Warn);
  ...
  __pyx_ptype_8petsc4py_5PETSc_DMLabel = __Pyx_ImportType(module, "petsc4py.PETSc", "DMLabel", sizeof(struct PyPetscDMLabelObject), __Pyx_ImportType_CheckSize_Warn);
