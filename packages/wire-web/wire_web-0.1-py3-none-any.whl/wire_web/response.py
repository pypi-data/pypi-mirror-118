from wire.enums import HttpStatusCode
import typing
import json
...
class Response:
    ...
    def __init__(self, content: typing.Any, status: typing.Union[int, HttpStatusCode] = 200, headers: dict = None, media_type: str = None) -> None:
