    ...
    def __init__(self):
        self.topics = {
            "bot": {
                ...
                "occurs": 1,
                "replies": ["you are thinking about me and my cousins", "bots are we?"],
                "checkin": "L",
            },
            "nature": {
                "elems": ["earth", "flower", "lake", "sea", "world", "forest", "grass"],
                "occurs": 2,
                "replies": [
                    "we must remind ourselves to protect our lovely " + "planet",
