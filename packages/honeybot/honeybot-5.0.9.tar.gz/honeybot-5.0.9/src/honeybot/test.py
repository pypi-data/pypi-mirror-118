...
class HoneybotTests(unittest.TestCase):
    ...
    def test_identify_command(self):
        self.assertEqual(bot.identify_command(), "msg NickServ identify  \r\n")

    def test_join_command(self):
        self.assertEqual(bot.join_channel_command("#abc"), "JOIN #abc \r\n")
    ...
    def test_pong_return(self):
        self.assertEqual(bot.pong_return("abc"), "PONG :abc\r\n")
