...
setup(
    name=_NAME,
    version="0.1.0",
    description="The base package to extend to create a Piper Task",
    packages=find_packages(),
    package_data={"pipertask": _get_resources("pipertask")},
    install_requires=requirements,
    python_requires=">=3.7",

    long_description=readme,
    long_description_content_type="text/markdown",
    url="https://github.com/piper-tools/pipertask",
