...
class window(QtWidgets.QMainWindow,Ui_MainWindow):
    ...
    def __init__(self):
        ...
        try:
            ...
            print(f'{Fore.RED}[{time.ctime()}][main/Error] error in initlazing:{e}')
    ...
    def download(self):
        ...
        try:
            ...
            print(f'{Fore.YELLOW}[{time.ctime()}][main/Warn] error in download:{e},ignored')
...
if __name__ == '__main__':
    ...
    print(f'[{time.ctime()}][main/Info] backend library:PyQt5 version {PYQT_VERSION_STR} build on Qt {QT_VERSION_STR}')
