...
class Parameter(TimedTable, Base):
    ...
    options = relationship("ParameterOption", back_populates="parameter", lazy="joined")

    type = relationship("ParameterType", back_populates="parameter", lazy="joined")

    value = relationship("ParameterValue", back_populates="parameter", lazy="joined")
...
class ParameterOption(TimedTable, Base):
    ...
    type = relationship("ParameterOptionType", back_populates="option", lazy="joined")
