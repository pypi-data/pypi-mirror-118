...
from pogema.generator import generate_positions_and_targets, generate_obstacles, generate_positions_and_targets_fast
...
def random_grid_generator(config, use_numba=True):
    ...
    if use_numba:
        ...
        starts_xy, finishes_xy = generate_positions_and_targets(obstacles, config)
...
class FastGrid:
    ...
    def prepare_grid(obstacles, starts_xy, finishes_xy, grid_config):
        ...
        return FastGrid(filled_obstacles, filled_positions, starts_xy, finishes_xy, grid_config, )
