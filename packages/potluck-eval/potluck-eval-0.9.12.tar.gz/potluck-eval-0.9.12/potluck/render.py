...
INSTRUCTIONS_TEMPLATE = "standalone_instructions.j2"
"""
The template name for instructions.
"""
...
def render_instructions(
    ...
    # Render the HTML instructions to the html output file
    with open(output_file, 'w', encoding="utf-8") as fout:
        fout.write(
            template.render(
                taskid=task_info["id"],
