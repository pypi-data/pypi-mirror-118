...
class Snippet(specifications.TestGroup):
    ...
    def compile(self, base_context):
        ...
        title = markdown.markdown(self.title, extensions=["extra"])
        caption = markdown.markdown(self.caption, extensions=["extra"])
        post = markdown.markdown(self.postscript, extensions=["extra"])
        ...
        for context in context_dicts:
            ...
            if soln_path in context["error_log"]:
