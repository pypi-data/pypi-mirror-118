...
class CreateShippingEstimateRequest(object):
    ...
    def __init__(self, distance_m=None, package_mass_g=None, transportation_method=None, project_id=None, create_order=None, local_vars_configuration=None):  # noqa: E501
