...
class OrdersApi(object):
    ...
    def retrieve_orders_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['page', 'metadata', 'metadata_example1', 'metadata_example2']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if 'metadata_example1' in local_var_params:
            query_params.append(('metadata[example1]', local_var_params['metadata_example1']))  # noqa: E501
        if 'metadata_example2' in local_var_params:
            query_params.append(('metadata[example2]', local_var_params['metadata_example2']))  # noqa: E501
