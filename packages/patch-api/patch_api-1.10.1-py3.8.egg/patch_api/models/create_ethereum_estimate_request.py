...
class CreateEthereumEstimateRequest(object):
    ...
    def __init__(self, timestamp=None, gas_used=None, transaction_value_eth_gwei=None, project_id=None, create_order=None, local_vars_configuration=None):  # noqa: E501
