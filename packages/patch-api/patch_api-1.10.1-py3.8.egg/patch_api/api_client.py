...
class ApiClient(object):
    ...
    def __init__(self, api_key=None, configuration=None, header_name=None, header_value=None,
                 cookie=None, pool_threads=1):
        if api_key is None:
          raise ValueError('ApiClient must be initialized with an api_key')
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(patch_api.models, klass)
