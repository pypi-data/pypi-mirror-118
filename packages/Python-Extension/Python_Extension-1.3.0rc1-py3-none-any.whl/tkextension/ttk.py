...
a = FileTree(tk, path='/Users/bluewind/Desktop')
a.place(relx=0.5, rely=0.45, relwidth=1, relheight=0.9, anchor='center')

Button(tk, text='Get', command=tk.quit).place(relx=0.5, rely=0.95, relwidth=0.8, relheight=0.1, anchor='center')
