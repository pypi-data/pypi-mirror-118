...
from krong.tasks.tagger.modules.char_unicode import (
    SPACE_SEPARATOR,
    NON_SPACING_MARK,
    LINE_SEPARATOR,
    PARAGRAPH_SEPARATOR,
...
from krong.tasks.tagger.dict.connection_costs import ConnectionCosts
from krong.tasks.tagger.dict.user_dictionary import UserDictionary
from krong.tasks.tagger.dict.known_dictionary import KnownDictionary
from krong.tasks.tagger.dict.unknown_dictionary import UnknownDictionary
from krong.tasks.tagger.dict.character_definition import (
    CharacterDefinition,
    character_category_map,
)
from krong.tasks.tagger.modules.dictionary_token import DictionaryToken
from krong.tasks.tagger.modules.decompound_token import DecompoundToken
from krong.tasks.tagger.modules.pos import POS
from krong.tasks.tagger.modules.token_attribute import TokenAttribute
...
class KoreanTokenizer(object):
    ...
    def __init__(
        ...
        self.user_dict = UserDictionary.open(
            os.path.join(
                PATH_CUR,
                path_userdict,
            )
    ...
    def set_input(self, in_string, preprocessed: bool):
