...
from krong.tasks.tagger.modules.korean_posstop_filter import KoreanPOSStopFilter
from krong.tasks.tagger.modules.korean_tokenizer import KoreanTokenizer
from krong.tasks.tagger.modules.korean_tokenizer import Type
from krong.tasks.tagger.modules.post_processing import PostProcessing
from krong.tasks.tagger.modules.synonym_graph_filter import SynonymGraphFilter
...
class KoreanAnalyzer(object):
    ...
    def __init__(
        self,
        path_userdict=os.path.join("..", "resources", "userdict.txt"),
    ...
    def do_analysis(self, in_string, preprocessed: bool = False):
