from krong.tasks.tagger.dict.dictionary import Dictionary
from krong.tasks.tagger.dict.character_definition import CharacterDefinition
from krong.tasks.tagger.dict.trie import Trie
