...
def get_training_parser(batch_size,
    ...
    Returns:
        ...
        argparse.ArgumentParser, argparse.ArgumentParser,
        argparse.ArgumentParser, argparse._SubParsersAction: main parser, global
            parser and, train, tune and eval actions subparsers and the
            subparser object.
    """
    ...
    return parser, global_parser, train_parser, tune_parser, eval_parser, subparsers
