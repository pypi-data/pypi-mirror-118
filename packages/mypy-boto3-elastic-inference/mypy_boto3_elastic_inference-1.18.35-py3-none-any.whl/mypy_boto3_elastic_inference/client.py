...
class ElasticInferenceClient(BaseClient):
    """
    [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.35/reference/services/elastic-inference.html#ElasticInference.Client)
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.35/reference/services/elastic-inference.html#ElasticInference.Client.can_paginate)
    ...
    def describe_accelerator_offerings(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.35/reference/services/elastic-inference.html#ElasticInference.Client.describe_accelerator_offerings)
    ...
    def describe_accelerator_types(self) -> DescribeAcceleratorTypesResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.35/reference/services/elastic-inference.html#ElasticInference.Client.describe_accelerator_types)
    ...
    def describe_accelerators(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.35/reference/services/elastic-inference.html#ElasticInference.Client.describe_accelerators)
    ...
    def generate_presigned_url(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.35/reference/services/elastic-inference.html#ElasticInference.Client.generate_presigned_url)
    ...
    def list_tags_for_resource(self, *, resourceArn: str) -> ListTagsForResourceResultTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.35/reference/services/elastic-inference.html#ElasticInference.Client.list_tags_for_resource)
    ...
    def tag_resource(self, *, resourceArn: str, tags: Dict[str, str]) -> Dict[str, Any]:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.35/reference/services/elastic-inference.html#ElasticInference.Client.tag_resource)
    ...
    def untag_resource(self, *, resourceArn: str, tagKeys: List[str]) -> Dict[str, Any]:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.35/reference/services/elastic-inference.html#ElasticInference.Client.untag_resource)
    ...
    def get_paginator(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.35/reference/services/elastic-inference.html#ElasticInference.Paginator.DescribeAccelerators)
