...
class XCPlc:
	def __init__(self, port: str, baudrate: int = 115200):
		...
		self._modbus = _Modbus(self._serial, timeout=0.3)
	...
	def set_coil(self, station: int, name: str, value: bool):
		...
		shift = int(name[1:], 8)
		self._modbus.write_coil(station=station, address=start_address+shift, value=value)
	...
	def set_uint16(self, station: int, name: str, value: int):
		...
		self._modbus.write_uint16(station, address, value)
