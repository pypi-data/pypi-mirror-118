...
class DynamoDB:
    ...
    def put_ddb_object(self, table_name, item_dict):
        """
    ...
    def put_ddb_df(self, table_name, df):
        """
        ...
        pandas_df = df.toPandas().astype(str)
    ...
    def get_ddb_object(self, table_name, key_name, search_key):
        """
