    ...
    """
{
    ...
    "package_data": {
        "cloudcomponents.cdk_developer_tools_notifications._jsii": [
            "cdk-developer-tools-notifications@1.41.0.jsii.tgz"
        ],
        "cloudcomponents.cdk_developer_tools_notifications": [
            "py.typed"
        ]
    ...
    "install_requires": [
        ...
        "aws-cdk.aws-codecommit>=1.121.0, <2.0.0",
        "aws-cdk.aws-codedeploy>=1.121.0, <2.0.0",
        "aws-cdk.aws-codepipeline>=1.121.0, <2.0.0",
        "aws-cdk.aws-codestarnotifications>=1.121.0, <2.0.0",
        "aws-cdk.aws-iam>=1.121.0, <2.0.0",
        "aws-cdk.aws-lambda-event-sources>=1.121.0, <2.0.0",
        "aws-cdk.aws-lambda>=1.121.0, <2.0.0",
        "aws-cdk.aws-sns>=1.121.0, <2.0.0",
        "aws-cdk.core>=1.121.0, <2.0.0",
        "cloudcomponents.cdk-chatops>=1.41.0, <2.0.0",
