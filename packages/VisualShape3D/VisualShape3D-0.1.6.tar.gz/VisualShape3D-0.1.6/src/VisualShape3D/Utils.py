...
def LineXPolygon(P0,L,Polygon):
    ...
    It returns ,
          (1)      P1, a tuple, the intersection point,;
          (2) [P1,P2], a list of two tuples for two intersection points;
                         plus a console warning : 
                         there are two points of intersection
          (3) 'Intersection point beyond the polygon' 
          (4) 'The line beyond the 2D plogon'
    ...
    if type(R) == str :
        ...
        if R == 'coplane':  # The line lies in the plane, so it reduces to 2D space
            ...
            if P1 is None : # and Points is None:
            ...
            elif type(Points) is tuple :  # single point
                P1 = Array(Points)
                ...
                P1,P2 = Points
                P1 = D2toD3Point(Array(P1),U,R0)
                P2 = D2toD3Point(Array(P2),U,R0)
