...
def stream_feature_view(
    ...
    .. code-block:: python
        ...
        # Declare your Entity and Input instances here or import them if defined elsewhere in
        # your Tecton repo. Check the API reference documentation for how to declare Input and Entity
        # instances
