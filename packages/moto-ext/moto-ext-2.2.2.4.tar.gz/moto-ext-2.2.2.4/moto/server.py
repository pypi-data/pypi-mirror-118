...
# TODO: how to keep up to date? externalize into json that is autogenerated on build?
URL_INDEX = {
    "acm": ["https?://acm.(.+).amazonaws.com"],
    "apigateway": ["https?://apigateway.(.+).amazonaws.com"],
    "applicationautoscaling": ["https?://application-autoscaling.(.+).amazonaws.com"],
    "athena": ["https?://athena.(.+).amazonaws.com"],
    "autoscaling": ["https?://autoscaling.(.+).amazonaws.com"],
    "batch": ["https?://batch.(.+).amazonaws.com"],
    "cloudformation": ["https?://cloudformation.(.+).amazonaws.com"],
    "cloudwatch": ["https?://monitoring.(.+).amazonaws.com"],
    "codecommit": ["https?://codecommit.(.+).amazonaws.com"],
    "codepipeline": ["https?://codepipeline.(.+).amazonaws.com"],
    "cognito-identity": ["https?://cognito-identity.(.+).amazonaws.com"],
    "cognito-idp": ["https?://cognito-idp.(.+).amazonaws.com"],
    "config": ["https?://config.(.+).amazonaws.com"],
    "datapipeline": ["https?://datapipeline.(.+).amazonaws.com"],
    "datasync": ["https?://(.*?)(datasync)(.*?).amazonaws.com"],
    "dms": ["https?://dms.(.+).amazonaws.com"],
    "dynamodb": ["https?://dynamodb.(.+).amazonaws.com"],
    "dynamodb2": ["https?://dynamodb.(.+).amazonaws.com"],
    "dynamodbstreams": ["https?://streams.dynamodb.(.+).amazonaws.com"],
    "ec2": ["https?://ec2\\.(.+)\\.amazonaws\\.com(|\\.cn)"],
    "ec2instanceconnect": ["https?://ec2-instance-connect\\.(.+)\\.amazonaws\\.com"],
    "ecr": ["https?://ecr.(.+).amazonaws.com", "https?://api.ecr.(.+).amazonaws.com"],
    "ecs": ["https?://ecs.(.+).amazonaws.com"],
    "eks": ["https?://eks.(.+).amazonaws.com"],
    "elasticbeanstalk": [
        "https?://elasticbeanstalk.(?P<region>[a-zA-Z0-9\\-_]+).amazonaws.com"
    ],
    "elb": ["https?://elasticloadbalancing.(.+).amazonaws.com"],
    "elbv2": ["https?://elasticloadbalancing.(.+).amazonaws.com"],
    "emr": [
        "https?://(.+).elasticmapreduce.amazonaws.com",
        "https?://elasticmapreduce.(.+).amazonaws.com",
    ],
    "events": ["https?://events.(.+).amazonaws.com"],
    "forecast": ["https?://forecast.(.+).amazonaws.com"],
    "glacier": ["https?://glacier.(.+).amazonaws.com"],
    "glue": ["https?://glue(.*).amazonaws.com"],
    "iam": ["https?://iam(.*).amazonaws.com"],
    "instance_metadata": ["http://169.254.169.254"],
    "iot": ["https?://iot.(.+).amazonaws.com"],
    "iot-data": ["https?://data.iot.(.+).amazonaws.com"],
    "kinesis": [
        "https?://kinesis\\.(.+).amazonaws.com",
        "https?://firehose.(.+).amazonaws.com",
    ],
    "kinesis-video-archived-media": ["https?://.*\\.kinesisvideo.(.+).amazonaws.com"],
    "kinesisvideo": ["https?://kinesisvideo.(.+).amazonaws.com"],
    "kms": ["https?://kms.(.+).amazonaws.com"],
    "lambda": ["https?://lambda.(.+).amazonaws.com(|.cn)"],
    "logs": ["https?://logs.(.+).amazonaws.com"],
    "managedblockchain": ["https?://managedblockchain.(.+).amazonaws.com"],
    "mediaconnect": ["https?://mediaconnect.(.+).amazonaws.com"],
    "medialive": ["https?://medialive.(.+).amazonaws.com"],
    "mediapackage": ["https?://mediapackage.(.+).amazonaws.com"],
    "mediastore": ["https?://mediastore.(.+).amazonaws.com"],
    "mediastore-data": ["https?://data.mediastore.(.+).amazonaws.com"],
    "moto_api": ["https?://motoapi.amazonaws.com"],
    "opsworks": ["https?://opsworks.us-east-1.amazonaws.com"],
    "organizations": ["https?://organizations.(.+).amazonaws.com"],
    "polly": ["https?://polly.(.+).amazonaws.com"],
    "ram": ["https?://ram.(.+).amazonaws.com"],
    "rds": ["https?://rds.(.+).amazonaws.com", "https?://rds.amazonaws.com"],
    "redshift": ["https?://redshift.(.+).amazonaws.com"],
    "resource-groups": ["https?://resource-groups(-fips)?.(.+).amazonaws.com"],
    "resourcegroupstaggingapi": ["https?://tagging.(.+).amazonaws.com"],
    ...
    "sagemaker": ["https?://api.sagemaker.(.+).amazonaws.com"],
    "secretsmanager": ["https?://secretsmanager.(.+).amazonaws.com"],
    "ses": ["https?://email.(.+).amazonaws.com", "https?://ses.(.+).amazonaws.com"],
    "sns": ["https?://sns.(.+).amazonaws.com"],
    "sqs": ["https?://(.*?)(queue|sqs)(.*?).amazonaws.com"],
    "ssm": ["https?://ssm.(.+).amazonaws.com", "https?://ssm.(.+).amazonaws.com.cn"],
    "stepfunctions": ["https?://states.(.+).amazonaws.com"],
    "sts": ["https?://sts(.*).amazonaws.com(|.cn)"],
    "support": ["https?://support.(.+).amazonaws.com"],
    "swf": ["https?://swf.(.+).amazonaws.com"],
    "transcribe": ["https?://transcribe.(.+).amazonaws.com"],
    "xray": ["https?://xray.(.+).amazonaws.com"],
}
