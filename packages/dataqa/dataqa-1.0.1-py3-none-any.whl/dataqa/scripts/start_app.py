...
def main(app_config_path, no_browser=False, no_es=False, auto_reload_flask=False):

    config = read_config(app_config_path)
    ...
    if not no_es:
        ...
        start_es_server.main(app_config_path["DEFAULT"]["ES_LOGS_PATH"],
                             app_config_path["DEFAULT"]["ES_DATA_PATH"])
