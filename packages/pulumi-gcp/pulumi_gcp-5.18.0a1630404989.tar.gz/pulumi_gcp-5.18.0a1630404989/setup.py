...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp', '5.18.0-alpha.1630404989+dda1c5ab'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp 5.18.0-alpha.1630404989+dda1c5ab`
                """)
            else:
                raise
