...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'consul', '3.3.0-alpha.1630675938+d3560a68'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource consul 3.3.0-alpha.1630675938+d3560a68`
                """)
            else:
                raise
