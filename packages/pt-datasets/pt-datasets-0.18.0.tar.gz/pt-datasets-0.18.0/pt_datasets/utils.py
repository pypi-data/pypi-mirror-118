...
def download_glove(dim: int) -> None:
    ...
    """
    supported_dims = (25, 100, 300)
    embeddings_meta = {
        25: (
            "http://magnitude.plasticity.ai/glove/light/glove.twitter.27B.25d.magnitude",
            "glove.twitter.27B.25d.magnitude",
        ),
        100: (
            "http://magnitude.plasticity.ai/glove/light/glove.twitter.27B.100d.magnitude",
            "glove.twitter.27B.100d.magnitude",
        ),
        300: (
            "http://magnitude.plasticity.ai/glove/light/glove.840B.300d.magnitude",
