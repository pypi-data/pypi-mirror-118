...
class GloVeEncoder(object):
    _supported_dims = (25, 100, 300)
    _embeddings = {
        25: "glove.twitter.27B.25d.magnitude",
        100: "glove.twitter.27B.100d.magnitude",
        300: "glove.840B.300d.magnitude",
    }

    def __init__(self, dim: int = 25):
