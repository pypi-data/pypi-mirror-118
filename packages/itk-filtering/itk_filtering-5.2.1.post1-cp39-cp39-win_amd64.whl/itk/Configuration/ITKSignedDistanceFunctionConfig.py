...
templates = (
  ...
  ('ShapeSignedDistanceFunction', 'itk::ShapeSignedDistanceFunction', 'itkShapeSignedDistanceFunctionD4', True, 'double,4'),
  ...
  ('PCAShapeSignedDistanceFunction', 'itk::PCAShapeSignedDistanceFunction', 'itkPCAShapeSignedDistanceFunctionD4IF4', True, 'double,4,itk::Image< float,4 >'),
  ('PCAShapeSignedDistanceFunction', 'itk::PCAShapeSignedDistanceFunction', 'itkPCAShapeSignedDistanceFunctionD4ID4', True, 'double,4,itk::Image< double,4 >'),
)
