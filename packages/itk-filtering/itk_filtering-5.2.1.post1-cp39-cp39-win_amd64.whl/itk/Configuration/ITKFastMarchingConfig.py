...
templates = (
  ...
  ('VectorContainer', 'itk::VectorContainer', 'itkVectorContainerULLNPI4SS', False, 'unsigned long long, itk::NodePair< itk::Index<4>, signed short >'),
  ('VectorContainer', 'itk::VectorContainer', 'itkVectorContainerUILSNUC4', False, 'unsigned int,itk::LevelSetNode< unsigned char,4 >'),
  ('VectorContainer', 'itk::VectorContainer', 'itkVectorContainerULLNPI4UC', False, 'unsigned long long, itk::NodePair< itk::Index<4>, unsigned char >'),
  ('VectorContainer', 'itk::VectorContainer', 'itkVectorContainerUILSNUS4', False, 'unsigned int,itk::LevelSetNode< unsigned short,4 >'),
  ('VectorContainer', 'itk::VectorContainer', 'itkVectorContainerULLNPI4US', False, 'unsigned long long, itk::NodePair< itk::Index<4>, unsigned short >'),
  ('VectorContainer', 'itk::VectorContainer', 'itkVectorContainerUILSNF4', False, 'unsigned int,itk::LevelSetNode< float,4 >'),
  ('VectorContainer', 'itk::VectorContainer', 'itkVectorContainerULLNPI4F', False, 'unsigned long long, itk::NodePair< itk::Index<4>, float >'),
  ('VectorContainer', 'itk::VectorContainer', 'itkVectorContainerUILSND4', False, 'unsigned int,itk::LevelSetNode< double,4 >'),
  ('VectorContainer', 'itk::VectorContainer', 'itkVectorContainerULLNPI4D', False, 'unsigned long long, itk::NodePair< itk::Index<4>, double >'),
