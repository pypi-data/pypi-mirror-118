...
templates = (
  ...
  ('NarrowBandLevelSetImageFilter', 'itk::NarrowBandLevelSetImageFilter', 'itkNarrowBandLevelSetImageFilterIF4IF4F', True, 'itk::Image< float,4 >,itk::Image< float,4 >,float'),
  ('NarrowBandLevelSetImageFilter', 'itk::NarrowBandLevelSetImageFilter', 'itkNarrowBandLevelSetImageFilterID4ID4D', True, 'itk::Image< double,4 >,itk::Image< double,4 >,double'),
