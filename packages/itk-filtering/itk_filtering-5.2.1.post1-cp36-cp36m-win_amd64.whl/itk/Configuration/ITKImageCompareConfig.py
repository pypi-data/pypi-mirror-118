...
templates = (
  ...
  ('CheckerBoardImageFilter', 'itk::CheckerBoardImageFilter', 'itkCheckerBoardImageFilterICD2', True, 'itk::Image< std::complex< double >,2 >'),
  ('CheckerBoardImageFilter', 'itk::CheckerBoardImageFilter', 'itkCheckerBoardImageFilterICD3', True, 'itk::Image< std::complex< double >,3 >'),
  ('CheckerBoardImageFilter', 'itk::CheckerBoardImageFilter', 'itkCheckerBoardImageFilterICD4', True, 'itk::Image< std::complex< double >,4 >'),
