...
templates = (
  ...
  ('AntiAliasBinaryImageFilter', 'itk::AntiAliasBinaryImageFilter', 'itkAntiAliasBinaryImageFilterIF4IF4', True, 'itk::Image< float,4 >, itk::Image< float,4 >'),
  ...
  ('AntiAliasBinaryImageFilter', 'itk::AntiAliasBinaryImageFilter', 'itkAntiAliasBinaryImageFilterID4ID4', True, 'itk::Image< double,4 >, itk::Image< double,4 >'),
)
