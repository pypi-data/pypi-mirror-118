...
class itkNodePairI4D(object):
    ...
    SetValue = _swig_new_instance_method(_itkNodePairPython.itkNodePairI4D_SetValue)
    GetValue = _swig_new_instance_method(_itkNodePairPython.itkNodePairI4D_GetValue)
    SetNode = _swig_new_instance_method(_itkNodePairPython.itkNodePairI4D_SetNode)
    GetNode = _swig_new_instance_method(_itkNodePairPython.itkNodePairI4D_GetNode)
    __lt__ = _swig_new_instance_method(_itkNodePairPython.itkNodePairI4D___lt__)
    __gt__ = _swig_new_instance_method(_itkNodePairPython.itkNodePairI4D___gt__)
    __le__ = _swig_new_instance_method(_itkNodePairPython.itkNodePairI4D___le__)
    __ge__ = _swig_new_instance_method(_itkNodePairPython.itkNodePairI4D___ge__)
...
class itkNodePairI4F(object):
    ...
    SetValue = _swig_new_instance_method(_itkNodePairPython.itkNodePairI4F_SetValue)
    GetValue = _swig_new_instance_method(_itkNodePairPython.itkNodePairI4F_GetValue)
    SetNode = _swig_new_instance_method(_itkNodePairPython.itkNodePairI4F_SetNode)
    GetNode = _swig_new_instance_method(_itkNodePairPython.itkNodePairI4F_GetNode)
    __lt__ = _swig_new_instance_method(_itkNodePairPython.itkNodePairI4F___lt__)
    __gt__ = _swig_new_instance_method(_itkNodePairPython.itkNodePairI4F___gt__)
    __le__ = _swig_new_instance_method(_itkNodePairPython.itkNodePairI4F___le__)
    __ge__ = _swig_new_instance_method(_itkNodePairPython.itkNodePairI4F___ge__)
...
class itkNodePairI4SS(object):
    ...
    SetValue = _swig_new_instance_method(_itkNodePairPython.itkNodePairI4SS_SetValue)
    GetValue = _swig_new_instance_method(_itkNodePairPython.itkNodePairI4SS_GetValue)
    SetNode = _swig_new_instance_method(_itkNodePairPython.itkNodePairI4SS_SetNode)
    GetNode = _swig_new_instance_method(_itkNodePairPython.itkNodePairI4SS_GetNode)
    __lt__ = _swig_new_instance_method(_itkNodePairPython.itkNodePairI4SS___lt__)
    __gt__ = _swig_new_instance_method(_itkNodePairPython.itkNodePairI4SS___gt__)
    __le__ = _swig_new_instance_method(_itkNodePairPython.itkNodePairI4SS___le__)
    __ge__ = _swig_new_instance_method(_itkNodePairPython.itkNodePairI4SS___ge__)
...
class itkNodePairI4UC(object):
    ...
    SetValue = _swig_new_instance_method(_itkNodePairPython.itkNodePairI4UC_SetValue)
    GetValue = _swig_new_instance_method(_itkNodePairPython.itkNodePairI4UC_GetValue)
    SetNode = _swig_new_instance_method(_itkNodePairPython.itkNodePairI4UC_SetNode)
    GetNode = _swig_new_instance_method(_itkNodePairPython.itkNodePairI4UC_GetNode)
    __lt__ = _swig_new_instance_method(_itkNodePairPython.itkNodePairI4UC___lt__)
    __gt__ = _swig_new_instance_method(_itkNodePairPython.itkNodePairI4UC___gt__)
    __le__ = _swig_new_instance_method(_itkNodePairPython.itkNodePairI4UC___le__)
    __ge__ = _swig_new_instance_method(_itkNodePairPython.itkNodePairI4UC___ge__)
...
class itkNodePairI4US(object):
    ...
    SetValue = _swig_new_instance_method(_itkNodePairPython.itkNodePairI4US_SetValue)
    GetValue = _swig_new_instance_method(_itkNodePairPython.itkNodePairI4US_GetValue)
    SetNode = _swig_new_instance_method(_itkNodePairPython.itkNodePairI4US_SetNode)
    GetNode = _swig_new_instance_method(_itkNodePairPython.itkNodePairI4US_GetNode)
    __lt__ = _swig_new_instance_method(_itkNodePairPython.itkNodePairI4US___lt__)
    __gt__ = _swig_new_instance_method(_itkNodePairPython.itkNodePairI4US___gt__)
    __le__ = _swig_new_instance_method(_itkNodePairPython.itkNodePairI4US___le__)
    __ge__ = _swig_new_instance_method(_itkNodePairPython.itkNodePairI4US___ge__)
