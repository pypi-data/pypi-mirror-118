                        ...
                        if len(sub.children) > 0:
                            for sub_children_name in sub.children:
                                if sub_children_name not in new_queues:
                                    ...
                                    fix_size = self.subjobindex[sub.name].queue + \
                                        self.subjobindex[sub.name].run
                                    ...
                                    fixed_queue_time = self.subjobindex[sub_children_name].queue - fix_size
                                    new_queues[sub_children_name] = fixed_queue_time if fixed_queue_time >= 0 else 0
