...
from weak_postagger.logic.utils import get_class_name_from_file, replace_abbreviations
...
from weak_postagger.logic.abbreviations import ABBREVIATIONS
...
class ListWeakModel:
    ...
    def __init__(self, directory_path: str, use_preprocess: bool = True, pre_processing_options: tp.List[str] = []):
        ...
        self.__abbreviations_dict = ABBREVIATIONS
    ...
    def label_message(self, sentence: str) -> tp.Tuple[str, str]:
        ...
        sentence_labels = []
        split_sentence = replace_abbreviations(split_sentence, self.__abbreviations_dict)
