...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'spotinst', '3.7.0-alpha.1630675945+1f1757a0'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource spotinst 3.7.0-alpha.1630675945+1f1757a0`
                """)
            else:
                raise
