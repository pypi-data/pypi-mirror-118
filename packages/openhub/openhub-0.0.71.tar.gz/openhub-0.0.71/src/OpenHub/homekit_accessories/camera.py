...
class Camera(PyHapCamera):
    ...
    def __init__(self, serial_no=None, display_name=None, *args, **kwargs):
        ...
        options = {"video": {
            ...
            'start_stream_cmd': "gst-launch-1.0 v4l2src ! video/x-h264, width={width}, height={height}, framerate={fps}/1 ! h264parse ! rtph264pay config-interval=1 pt=96 ! udpsink sync=false host={address} port={v_port}",
