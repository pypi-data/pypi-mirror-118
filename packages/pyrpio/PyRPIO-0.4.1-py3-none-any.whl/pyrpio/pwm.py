...
class PWM:
    ...
    def __init__(self, chip, channel, destroy_on_exit: bool = True):
    ...
    @classmethod
    def is_pwm_chip_available(cls, chip: int) -> bool:
        """Determine if PWM chip interface is available
        ...
        return os.path.isdir(chip_path)
    ...
    def close(self):
        ...
        if self._destroy_on_exit and self._channel is not None:
