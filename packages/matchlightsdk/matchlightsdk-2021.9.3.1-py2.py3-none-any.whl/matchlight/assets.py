...
class AssetMethods(object):
    ...
    def add_pii(self, custom_id, tags, pii_type, email, first_name=None,
       ...
       """
        ...
        pii_type = "employee_pii" if pii_type == None else pii_type
        data = {
            'type': pii_type,
            'customId': custom_id,
            'metadata': {
        ...
        if any((first_name, middle_name, last_name)):
            ...
            if first_name:
                for m in first_name:
                    ...
                    first_name = m['value'] or ""
                    first_name_fingerprints = blind_name(first_name)

            if middle_name:
                for m in middle_name:
                    middle_name = m['value'] or None
                    middle_name_fingerprints = blind_name(middle_name)

            if last_name:
                for m in last_name:
                    last_name = m['value'] or ""
                    last_name_fingerprints = blind_name(last_name)

            name_fingerprints = fingerprints_pii_name_variants(first_name or '', middle_name or None, last_name or '')
            detail= first_name_fingerprints + " " + middle_name_fingerprints + " " + last_name_fingerprints
            field = dict()
       ...
       """
        ...
        if email is not None:
            ...
            if email == "":
                ...
                field['variants'] = fingerprints_pii_email_address(email)
        ...
        if ssn is not None:
            ...
            if ssn == "":
                ...
                field['variants'] = [fingerprints_pii_ssn(ssn)]
            field['field_detail'] = 'ssn_fingerprints'
            field['type'] = 'ssn'
            field['pii_group'] = 1
        ...
        if street_address is not None:
            ...
            if street_address == "":
                ...
                field['variants'] = fingerprints_pii_address_variants(street_address)
        ...
        if any((city, state_province, zip_postal_code)):
            if city == "" and state_province == "" and zip_postal_code == "":
                csz_fingerprints = []
            else:
                csz_fingerprints = fingerprints_pii_city_state_zip_variants(
                    *[six.text_type(text) if text is not None else ''
        ...
        if phone is not None:
            ...
            if phone == "":
                ...
                field['variants'] = [fingerprints_pii_phone_number(phone)]
            field['field_detail'] = 'phone_fingerprints'
            field['type'] = 'phone'
            field['pii_group'] = 1
        ...
        if credit_card is not None:
            ...
            if credit_card == "":
                ...
                field['variants'] = [fingerprints_pii_credit_card(credit_card)]
        ...
        if medicare_id is not None:
            ...
            if medicare_id == "":
                ...
                field['variants'] = [fingerprints_pii_medicare_id(medicare_id)]
        ...
        if passport is not None:
            ...
            if passport == "":
                ...
                field['variants'] = [fingerprints_pii_passport(passport)]
            field['field_detail'] = 'passport_fingerprints'
            field['type'] = 'passport'
            field['pii_group'] = 1
        ...
        if iban is not None:
            ...
            if iban == "":
                ...
                field['variants'] = fingerprints_pii_iban(iban)
        ...
        if offline:
            ...
            return self.update_pii_from_fingerprints(data)
    ...
    def update_pii_from_fingerprints(self, fingerprint_data):
        """Add a PII record from fingerprinted data generated by the :class:`~/.Assets.add_pii` in offline mode.
           ...
           >>> API_ENDPOINT_PATH = '/v3/public/asset/update'
    ...
    def add_multi_pii_from_fingerprints(self, fingerprint_data):
        """Add a PII record from fingerprinted data generated by the :class:`~/.Assets.add_pii` in offline mode.
    ...
    def add_multi_pii(self, custom_id, tags, pii_type, email, first_name=None,
                      middle_name=None, last_name=None, ssn=None, street_address=None, city=None, state_province=None,
                      zip_postal_code=None, phone=None, credit_card=None, medicare_id=None, passport=None, iban=None,
                      offline=False):
        if first_name is not None and last_name is None:
        ...
        if any((first_name, middle_name, last_name)):
            if first_name:
                for m in first_name:
                    pii_group = m['pii_group']
                    #print(f"PII GROUP: {pii_group} --> FIRST NAME :{ first_name } --> LAST NAME :{ last_name }")
                    res = merge_data(pii_group,first_name,middle_name,last_name)
                    first_text,middle_text,last_text=res[0],res[1],res[2]
        ...
        if ssn:
            for m in ssn:
                ...
                field = dict()
                field["pii_group"] = m['pii_group']
                field['field_detail'] = 'ssn_'+str(m['pii_group'])
                field['type'] = 'ssn'
                field['variants'] = ssn_fingerprints
        ...
        if street_address:
            for m in street_address:
                ...
                field = dict()
                field["pii_group"] = m['pii_group']
                field['field_detail'] = 'street_address_'+str(m['pii_group'])
                field['type'] = 'address'
                field['variants'] = address_fingerprints
        ...
        if any((city, state_province, zip_postal_code)):
            if city:
                for m in city:
                    ...
                    field = dict()
                    field['field_detail'] = 'region_'+str(m['pii_group'])
                    field['type'] = 'region'
                    field['pii_group'] = pii_group
                    field['variants'] = csz_fingerprints
                    fields_list.append(field)
        ...
        if phone:
            for m in phone:
                ...
                field = dict()
                field["pii_group"] = m['pii_group']
                field['field_detail'] = 'phone_'+str(m['pii_group'])
                field['type'] = 'phone'
                field['variants'] = [phone_fingerprints]
        ...
        if credit_card:
            for m in credit_card:
                ...
                field = dict()
                field["pii_group"] = m['pii_group']
                field['field_detail'] = 'credit_card_'+str(m['pii_group'])
                field['type'] = 'credit_card'
                field['variants'] = [cc_fingerprints]
        ...
        if medicare_id:
            for m in medicare_id:
                ...
                field = dict()
                field["pii_group"] = m['pii_group']
                field['field_detail'] = 'medicare_'+str(m['pii_group'])
                field['type'] = 'medicare_id'
                field['variants'] = [medicare_id_fingerprints]
        ...
        if passport:
            for m in passport:
                ...
                field = dict()
                field["pii_group"] = m['pii_group']
                field['field_detail'] = 'passport_'+str(m['pii_group'])
                field['type'] = 'passport'
                field['variants'] = [passport_fingerprints]
        ...
        if iban:
            for m in iban:
                ...
                field = dict()
                field["pii_group"] = m['pii_group']
                field['field_detail'] = 'iban_'+str(m['pii_group'])
                field['type'] = 'iban'
                field['variants'] = iban_fingerprints
    ...
    def update_multi_pii(self, asset_id, custom_id, tags, pii_type, email, first_name=None,
        ...
        if any((first_name, middle_name, last_name)):
            ...
            if first_name:
                ...
                for m in first_name:
                    pii_group = m['pii_group']
                    first_text = m['value'] or ""
                    first_name_fingerprints = blind_name(first_text)

                    if middle_name:
                        middle_val = [middle for middle in middle_name if middle['pii_group'] == pii_group]
                        middle_text = middle_val[0]['value'] if len(middle_val)>0 else ""
                        middle_name_fingerprints = blind_name(middle_text)

                    if last_name:
                        last_val = [last for last in last_name if last['pii_group'] == pii_group]
                        last_text = last_val[0]['value'] if len(last_val)>0 else ""
                        last_name_fingerprints = blind_name(last_text)

                    name_fingerprints = fingerprints_pii_name_variants(first_text or '', middle_text or None, last_text or '')
                    detail = first_name_fingerprints
                    if middle_text:
                        detail += " " + middle_name_fingerprints

                    if last_text:
                        detail +=" " + last_name_fingerprints
                    field = dict()
                    field["pii_group"] = pii_group
                    field['field_detail'] = detail
                    field['type'] = 'name'
        ...
        if any((city, state_province, zip_postal_code)):
            ...
            if city:
                ...
                for m in city:
                    pii_group = m['pii_group']
                    city_text = m['value'] or ""
                    if state_province:
                        state_province_val = [state_province for state_province in state_province if
                                              state_province['pii_group'] == pii_group]
                        state_province_text = state_province_val[0]['value'] if len(state_province_val) > 0 else ""

                    if zip_postal_code:
                        zip_postal_code_val = [zip_postal_code for zip_postal_code in zip_postal_code if
                                               zip_postal_code['pii_group'] == pii_group]
                        zip_postal_code_text = zip_postal_code_val[0]['value'] if len(zip_postal_code_val) > 0 else ""
                    if city_text == "" and state_province_text == "" and zip_postal_code_text == "":
                        csz_fingerprints = []
                        city_detail = ""
                    else:
                        csz_fingerprints = fingerprints_pii_city_state_zip_variants(
                            *[six.text_type(text) if text is not None else ''
                              for text in (city_text,state_province_text, zip_postal_code_text)])


                    field = dict()
                    field["pii_group"] = pii_group
                    field['field_detail'] = "region_" + str(pii_group)
                    field['type'] = 'region'
                    field['variants'] = csz_fingerprints
                    fields_list.append(field)
    ...
    def delete_asset(self, asset_id):
        ...
        """
        return self.conn.public_request('/v3/public/asset/delete/{}'.format(asset_id), method="DELETE")
...
def insert_pii_client_file_data(self,file=None, offline=None):
        #test = pd.read_csv(file, names=['quantity', 'sku'])
