...
setup(
    ...
    url='https://bitbucket.org/monkey-python/monkey-crawler-soap/',
    description='Monkey crawler implementation for SOAP data sources using Zeep.',
