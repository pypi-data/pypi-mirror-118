    ...
    def get_typeahead_suggestions(
        ...
        :param options: Dictionary of options that influence the result-set.
            ...
            - `select_suggesters` (optional) list containing suggesters to be used.
                ...
                Available suggesters: ["facet_value", "facet_name", "content_phrase", "saved_search"]
        ...
        Example::Autocomplete on one specific suggester like `content_phrase`
            - The "content_phrase" suggester completes on key-phrases and item titles added via the `NLP-Tagger
            <https://squirro.atlassian.net/wiki/spaces/DOC/pages/2396061784/Content-based+Typeahead>`
            ...
            >>> client.get_typeahead_suggestions(project_id=project_id,
                     searchbar_query="pla",
                     cursor_pos=0, # cursor_pos is not needed for content_phrase suggester
                                   # - but API checks for the argument
