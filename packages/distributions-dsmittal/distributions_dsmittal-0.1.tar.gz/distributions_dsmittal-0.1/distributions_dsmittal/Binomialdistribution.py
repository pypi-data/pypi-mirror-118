...
class Binomial(Distribution):
    ...
    def pdf(self, k):
        ...
        return (math.factorial(self.n)/(math.factorial(self.n-k)*
            math.factorial(k)))*(self.p**k)*(1-self.p)**(self.n-k)
    ...
    def plot_bar_pdf(self):
        ...
        dist = [self.pdf(r) for r in list(range(0, self.n, 1)) ]
        # plotting the graph
        plt.bar(list(range(0, self.n, 1)), dist)
        plt.show()
