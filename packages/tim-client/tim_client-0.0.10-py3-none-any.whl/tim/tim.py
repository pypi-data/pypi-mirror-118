...
from tim.types import ExecuteResponse, Status
...
class Tim:
  ...
  def build_forecasting_model(
    ...
    config = ForecastJobConfiguration(
        **job_configuration, useCaseId=created_use_case_id
    ) if job_configuration else ForecastJobConfiguration(useCaseId=created_use_case_id)
  ...
  def build_anomaly_detection_model(
    ...
    config = AnomalyDetectionJobConfiguration(
        **job_configuration, useCaseId=created_use_case_id
    ) if job_configuration else AnomalyDetectionJobConfiguration(useCaseId=created_use_case_id)
  ...
  def get_anomaly_detection_jobs(
    ...
    return get_anomaly_detection_jobs(
        self.__credentials, offset, limit, sort, experiment_id, useCase_id, type
    )
