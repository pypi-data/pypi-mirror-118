...
compare_security(['399001.SZ','000001.SS'],"Close","2020-1-1","2021-6-26",twinx=True)
compare_security(['399102.SZ','399001.SZ'],"Close","2021-1-1","2021-6-26",twinx=True)
compare_security(['399102.SZ','399001.SZ'],"Close","2021-4-1","2021-6-26",twinx=True)

compare_security(['^HSI','000001.SS'],"Close","2021-5-1","2021-6-26",twinx=True)
compare_security(['^TWII','000001.SS'],"Close","2010-1-1","2021-6-26",twinx=True)

compare_security(['^HSI','^HSIL'],"Close","2020-1-1","2021-6-26",twinx=True)

hsil=get_prices_yf('^HSIL','2021-1-1','2021-6-26',threads=True)

compare_security(['000012.SS','000001.SS'],"Close","2010-1-1","2021-6-26",twinx=True)

compare_security(['^N225','000001.SS'],"Close","2010-1-1","2021-6-26",twinx=True)
compare_security(['^KS11','000001.SS'],"Close","2010-1-1","2021-6-26",twinx=True)
compare_security(['^BSESN','000001.SS'],"Close","2010-1-1","2021-6-26",twinx=True)
compare_security(['^BSESN','000001.SS'],"Close","2021-1-1","2021-6-26",twinx=True)

compare_security(['^GSPC','000001.SS'],"Close","2010-1-1","2021-6-26",twinx=True)
compare_security(['^DJI','^GSPC'],"Close","2010-1-1","2021-6-26",twinx=True)
compare_security(['^IXIC','^GSPC'],"Close","2010-1-1","2021-6-26",twinx=True)
