...
# MacOSX: English version
import os; os.chdir("/Volumes/MAXELL57/siateng")

# MacOSX: Chinese version
import os; os.chdir("/Volumes/MAXELL57/siat")
...
cfps=compare_snapshot(tickers,'Cashflow per Share',axisamp=5)

tat=compare_history(['BABA','JD'],'Total Asset Turnover')
cfps=compare_history(['AMZN','JD'],'CFPS')
