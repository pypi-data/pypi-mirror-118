...
def market_profile_china(market='SSE'):
    ...
    if market1 == 'SSE':
        ...
        print("\n=== Summary: Shanghai Stock Exchange ===")
        #typelist=list(set(info['type']))
        typelist=['总貌','主板','科创板']
        
        for t in typelist:
            subdf=info[info['type']==t]
            print('*** '+texttranslate(t)+':')
            ...
            for i in itemlist:
                ...
                try:
                    ...
                    #print('   ',texttranslate(i)+' '*blanknum,'：',end='')
                    print('   ',texttranslate(i)+'：',end='')
                except:
                    blanknum=maxlen-hzlen(i)
                    ...
                    #print('   ',texttranslate(i2)+' '*blanknum,'：',end='')
                    print('   ',texttranslate(i2)+'：',end='')
    ...
    if market1 == 'SZSE':
        ...
        print("\n=== Summary: Shenzhen Stock Exchange ===")
        typelist=['总貌','主板','创业板']
        for t in typelist:
            subdf=info[info['type']==t]
            print('*** '+texttranslate(t)+':')
    ...
    today=dt.date.today()
    print("\n*** Data source: Sina Finance,",today)
