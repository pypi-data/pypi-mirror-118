...
def format_file(fp, indents=2, all_top_comments=False, equal_sign=False, flatten=False, new_fp=None):
    """
...
def format_str(proto_str, indents=2, all_top_comments=False, equal_sign=False, flatten=False):
    """
