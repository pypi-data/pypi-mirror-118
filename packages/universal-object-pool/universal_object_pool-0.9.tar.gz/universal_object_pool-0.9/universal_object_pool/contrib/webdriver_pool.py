...
class WebDriverOperator(AbstractObject):
    ...
    def __init__(self, driver_klass=Chrome, is_open_picture=True, is_use_mobile_ua=False,
                 is_use_headless=False, **selenium_driver_kwargs):
        ...
        if driver_klass == Chrome:
            driver = self._create_a_chrome_driver()
        elif driver_klass == PhantomJS:
