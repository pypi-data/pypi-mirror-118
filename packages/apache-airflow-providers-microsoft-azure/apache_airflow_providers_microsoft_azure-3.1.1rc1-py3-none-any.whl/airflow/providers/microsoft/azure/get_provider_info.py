...
def get_provider_info():
    return {
        ...
        'versions': ['3.1.1', '3.1.0', '3.0.0', '2.0.0', '1.3.0', '1.2.0', '1.1.0', '1.0.0'],
        ...
        'connection-types': [
            ...
            {
                'hook-class-name': 'airflow.providers.microsoft.azure.hooks.azure_container_instance.AzureContainerInstanceHook',
            ...
            {
                'hook-class-name': 'airflow.providers.microsoft.azure.hooks.azure_container_registry.AzureContainerRegistryHook',
