...
class ConfigService:
    ...
    def update_merged_config(self):
        ...
        self.merged_config['stage'] = self._stage
    ...
    def load(self, working_dir, scope='application', config_overrides_string=None, stage='default'):
        self.working_dir = working_dir
        self._stage = Stages.shorten(stage)
        self.update_merged_config()
