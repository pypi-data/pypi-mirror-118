import torch
from kolibri.torchtext.vocab import Vocab
from typing import Optional, Callable
from kolibri.torchtext._torchtext import (
...
def build_vocab_from_text_file(file_path: str, tokenizer: Optional[Callable] = None, min_freq: int = 1, num_cpus: Optional[int] = 4) -> Vocab:
    ...
    Examples:
        >>> from kolibri.torchtext.vocab import build_vocab_from_text_file
...
def load_vocab_from_file(file_path: str, min_freq: int = 1, num_cpus: int = 4) -> Vocab:
    ...
    Examples:
        >>> from kolibri.torchtext.vocab import load_vocab_from_file
