...
from kolibri.torchtext.experimental.datasets import raw as experimental_raw
from kolibri.torchtext.legacy.vocab import Vocab, build_vocab_from_iterator
...
def Multi30k(
    ...
    Examples:
        >>> from kolibri.torchtext.experimental.datasets import Multi30k
        >>> from kolibri.torchtext.data.utils import get_tokenizer
...
def IWSLT2017(language_pair=('de', 'en'),
    ...
    **Language pairs**:
    ...
    Examples:
        >>> from kolibri.torchtext.experimental.datasets import IWSLT2017
        >>> from kolibri.torchtext.data.utils import get_tokenizer
        >>> src_tokenizer = get_tokenizer("spacy", language='de_core_news_sm')
...
def IWSLT2016(language_pair=('de', 'en'),
    ...
    **valid/test sets**: ['dev2010', 'tst2010', 'tst2011', 'tst2012', 'tst2013', 'tst2014']
    ...
    Examples:
        >>> from kolibri.torchtext.experimental.datasets import IWSLT2016
        >>> from kolibri.torchtext.data.utils import get_tokenizer
        >>> src_tokenizer = get_tokenizer("spacy", language='de_core_news_sm')
        >>> tgt_tokenizer = get_tokenizer("basic_english")
...
def WMT14(language_pair=('de', 'en'),
    ...
    **Language pairs**:
    ...
    Examples:
        >>> from kolibri.torchtext.experimental.datasets import WMT14
        >>> from kolibri.torchtext.data.utils import get_tokenizer
        >>> src_tokenizer = get_tokenizer("spacy", language='de_core_news_sm')
        >>> tgt_tokenizer = get_tokenizer("basic_english")
