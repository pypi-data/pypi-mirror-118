...
#from kolibri.torchtext import RegexTokenizer as RegexTokenizerPybind
from torch import Tensor
#from kolibri.torchtext import SentencePiece as SentencePiecePybind
import io
...
def basic_english_normalize():
    ...
    Examples:
        >>> import torch
        >>> from kolibri.torchtext.experimental.transforms import basic_english_normalize
...
def regex_tokenizer(patterns_list):
    ...
    Examples:
        >>> import torch
        >>> from kolibri.torchtext.experimental.transforms import regex_tokenizer
...
class TextSequentialTransforms(nn.Sequential):
    r"""A container to host a sequential text transforms.
        ...
        Example:
            >>> import torch
            >>> from kolibri.torchtext.experimental.transforms import basic_english_normalize, TextSequentialTransforms
...
def load_sp_model(sp_model):
    ...
    Examples:
        >>> from kolibri.torchtext.experimental.transforms import load_sp_model
    ...
    Examples:
        >>> from kolibri.torchtext.experimental.transforms import PRETRAINED_SP_MODEL
...
def sentencepiece_tokenizer(sp_model):
    ...
    Examples:
        >>> import torch
        >>> from kolibri.torchtext.experimental.transforms import sentencepiece_tokenizer
...
def sentencepiece_processor(sp_model):
    ...
    Examples:
        >>> import torch
        >>> from kolibri.torchtext.experimental.transforms import sentencepiece_processor
...
class VocabTransform(nn.Module):
    ...
    Example:
        >>> import torch
        >>> from kolibri.torchtext.vocab import vocab_from_file_object
        >>> f = open('vocab.txt', 'r')
...
class VectorTransform(nn.Module):
    ...
    Example:
        >>> import torch
        >>> from kolibri.torchtext.experimental.vectors import FastText
