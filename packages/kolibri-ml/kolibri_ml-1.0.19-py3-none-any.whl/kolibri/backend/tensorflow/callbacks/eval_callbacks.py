...
from kdmt.ml.metrics.scores import f1_score, recall_score, precision_score

class EvalCallBack(keras.callbacks.Callback):

    def __init__(self, kolibri_model, valid_x, valid_y,
        ...
        Args:
            ...
            valid_y: label texts
            step: metrics will be computed at each numner of steps, default 5
