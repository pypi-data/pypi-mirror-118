...
class CNN_Attention_Model(TFBaseTextClassificationModel):
    ...
    def build_model_arc(self) -> None:
        ...
        output = L.Dense(output_dim, **config['layer-output'])(input_layer)
        output = self._activation_layer()(output)

        self.nn_model = keras.Model(embed_model.input, output)
