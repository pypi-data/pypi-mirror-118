...
from kolibri.backend.tensorflow.callbacks.connl_callBack import ConllCallback
...
class MultiInputBaseModel(TFBaseModel):
    """
    ...
    def to_dict(self):
        ...
        base_dict.update({
            ...
            'nn_model': json.loads(model_json_str)
        })
        return base_dict
    ...
    def load_model(cls, model_path):
        ...
        if isinstance(model.nn_model.layers[-1], ConditionalRandomField):
            model.crf = model.nn_model.layers[-1]
