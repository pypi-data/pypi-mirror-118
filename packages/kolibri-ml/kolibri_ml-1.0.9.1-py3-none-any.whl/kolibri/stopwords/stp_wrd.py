...
from kolibri.datasets.ressources import Ressources
...
stopwords = resources.get('corpora/stop-words').path
...
class Stopwords():
    ...
    def __init__(self):
        ...
        self.stopwords_path = os.path.join(k.DATA_PATH,'corpora', 'stop-words')
