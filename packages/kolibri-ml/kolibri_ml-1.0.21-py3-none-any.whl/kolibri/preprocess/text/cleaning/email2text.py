...
class EmailMessage(object):
    ...
    def read(self, body_text, title_text=None):
        ...
        self.title = title_text
        front_content = re.search(pattern_caution_or_front_content, self.text, re.MULTILINE)
        front_content_end=front_content.end() if front_content else 0
...
class Fragment(object):
    ...
    def _get_caution_or_front_content(self):
        ...
        match = re.search(pattern_caution_or_front_content, self.body)
        cautions = []
        while match:
            caution = match.group()
