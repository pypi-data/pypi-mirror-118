...
def generate_sp_model(filename, vocab_size=20000,
    ...
    Examples:
        >>> from kolibri.torchtext.data.functional import generate_sp_model
...
def load_sp_model(spm):
    ...
    Examples:
        >>> from kolibri.torchtext.data.functional import load_sp_model
...
def sentencepiece_numericalizer(sp_model):
    ...
    Examples:
        >>> from kolibri.torchtext.data.functional import sentencepiece_numericalizer
...
def sentencepiece_tokenizer(sp_model):
    ...
    Examples:
        >>> from kolibri.torchtext.data.functional import sentencepiece_tokenizer
...
def custom_replace(replace_pattern):
    ...
    Examples:
        >>> from kolibri.torchtext.data.functional import custom_replace
...
def simple_space_split(iterator):
    ...
    Examples:
        >>> from kolibri.torchtext.data.functional import simple_space_split
...
def numericalize_tokens_from_iterator(vocab, iterator, removed_tokens=None):
    ...
    Examples:
        >>> from kolibri.torchtext.data.functional import simple_space_split
        >>> from kolibri.torchtext.data.functional import numericalize_tokens_from_iterator
...
def filter_wikipedia_xml(text_iterator):
    ...
    Examples:
        >>> from kolibri.torchtext.data.functional import filter_wikipedia_xml
        >>> from kolibri.torchtext.datasets import EnWik9
...
def to_map_style_dataset(iter_data):
    ...
    Examples:
        >>> from kolibri.torchtext.datasets import IMDB
        >>> from kolibri.torchtext.data import to_map_style_dataset
