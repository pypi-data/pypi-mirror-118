...
def WikiText2(tokenizer=None, root='.data', vocab=None, split=('train', 'valid', 'test')):
    ...
    Examples:
        >>> from kolibri.torchtext.experimental.datasets import WikiText2
        >>> from kolibri.torchtext.data.utils import get_tokenizer
...
def WikiText103(tokenizer=None, root='.data', vocab=None, split=('train', 'valid', 'test')):
    ...
    Examples:
        >>> from kolibri.torchtext.experimental.datasets import WikiText103
        >>> from kolibri.torchtext.data.utils import get_tokenizer
        >>> tokenizer = get_tokenizer("spacy")
...
def PennTreebank(tokenizer=None, root='.data', vocab=None, split=('train', 'valid', 'test')):
    ...
    Examples:
        >>> from kolibri.torchtext.experimental.datasets import PennTreebank
        >>> from kolibri.torchtext.data.utils import get_tokenizer
        >>> tokenizer = get_tokenizer("spacy")
...
def WMTNewsCrawl(tokenizer=None, root='.data', vocab=None, split='train', year=2010, language='en'):
    ...
    Examples:
        >>> from kolibri.torchtext.experimental.datasets import WMTNewsCrawl
        >>> from kolibri.torchtext.data.utils import get_tokenizer
        >>> tokenizer = get_tokenizer("spacy")
