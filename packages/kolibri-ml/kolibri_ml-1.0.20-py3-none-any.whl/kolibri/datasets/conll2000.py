...
if __name__ =='__main__':
    from kolibri.datasets import CoNLL2000

    train_iter = CoNLL2000(split='train')
    for text, pos, tag in train_iter:
        print(text, pos, tag)
