import torch
import logging
from kolibri.torchtext.data.utils import get_tokenizer
from kolibri.torchtext.legacy.vocab import build_vocab_from_iterator
from kolibri.torchtext import datasets as raw
from kolibri.torchtext.data.datasets_utils import _check_default_set
from kolibri.torchtext.data.datasets_utils import _wrap_datasets
from kolibri.torchtext.experimental.functional import (
    vocab_func,
    totensor,
    ngrams_func,
...
def AG_NEWS(root='.data', ngrams=1, vocab=None, tokenizer=None, split=('train', 'test')):
    ...
    Examples:
        >>> from kolibri.torchtext.experimental.datasets import AG_NEWS
        >>> from kolibri.torchtext.data.utils import get_tokenizer
...
def CONSUMERS(root='.data', ngrams=1, vocab=None, tokenizer=None, split=('train', 'test')):
    """ Defines AG_NEWS datasets.
        The labels includes:
            - 1 : World
            - 2 : Sports
    ...
    return _setup_datasets("CONSUMERS", root, ngrams, vocab, tokenizer, split)
...
def SogouNews(root='.data', ngrams=1, vocab=None, tokenizer=None, split=('train', 'test')):
    ...
    Examples:
        >>> from kolibri.torchtext.experimental.datasets import SogouNews
        >>> from kolibri.torchtext.data.utils import get_tokenizer
...
def DBpedia(root='.data', ngrams=1, vocab=None, tokenizer=None, split=('train', 'test')):
    ...
    Examples:
        >>> from kolibri.torchtext.experimental.datasets import DBpedia
        >>> from kolibri.torchtext.data.utils import get_tokenizer
...
def YelpReviewPolarity(root='.data', ngrams=1, vocab=None, tokenizer=None, split=('train', 'test')):
    ...
    Examples:
        >>> from kolibri.torchtext.experimental.datasets import YelpReviewPolarity
        >>> from kolibri.torchtext.data.utils import get_tokenizer
...
def YelpReviewFull(root='.data', ngrams=1, vocab=None, tokenizer=None, split=('train', 'test')):
    ...
    Examples:
        >>> from kolibri.torchtext.experimental.datasets import YelpReviewFull
        >>> from kolibri.torchtext.data.utils import get_tokenizer
...
def YahooAnswers(root='.data', ngrams=1, vocab=None, tokenizer=None, split=('train', 'test')):
    ...
    Examples:
        >>> from kolibri.torchtext.experimental.datasets import YahooAnswers
        >>> from kolibri.torchtext.data.utils import get_tokenizer
...
def AmazonReviewPolarity(root='.data', ngrams=1, vocab=None, tokenizer=None, split=('train', 'test')):
    ...
    Examples:
        >>> from kolibri.torchtext.experimental.datasets import AmazonReviewPolarity
        >>> from kolibri.torchtext.data.utils import get_tokenizer
...
def AmazonReviewFull(root='.data', ngrams=1, vocab=None, tokenizer=None, split=('train', 'test')):
    ...
    Examples:
        >>> from kolibri.torchtext.experimental.datasets import AmazonReviewFull
        >>> from kolibri.torchtext.data.utils import get_tokenizer
...
def IMDB(root='.data', ngrams=1, vocab=None, tokenizer=None, split=('train', 'test')):
    ...
    Examples:
        >>> from kolibri.torchtext.experimental.datasets import IMDB
        >>> from kolibri.torchtext.data.utils import get_tokenizer
