...
class FastText(TFBaseTextClassificationModel):
    ...
    def build_model_arc(self):
        ...
        self.nn_model = tf.keras.Model(embed_model.inputs, tensor)
...
class BiGRU_Model(TFBaseTextClassificationModel):
    ...
    def build_model_arc(self):
        ...
        self.nn_model = tf.keras.Model(embed_model.inputs, output_tensor)
...
class R_CNN_Model(TFBaseTextClassificationModel):
    ...
    def build_model_arc(self):
        ...
        self.nn_model = tf.keras.Model(embed_model.inputs, tensor_output)
