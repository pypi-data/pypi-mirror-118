...
class PlotSHAP:
    ...
    def is_available(algorithm, X_train, y_train, ml_task):
        ...
        if X_train.shape[1] > 500:
            ...
            return False
        if ml_task == TaskType.CLASSIFICATION and len(np.unique(y_train)) > 100:
            warnings.warn(
    ...
    def get_predictions(algorithm, X_vald, y_vald, ml_task):
        ...
        if ml_task == TaskType.CLASSIFICATION:
    ...
    def compute(
        ...
        try:
            ...
            if ml_task == TaskType.BINARY_CLASSIFICATION and isinstance(shap_values, list):
            ...
            if ml_task == TaskType.REGRESSION:
            ...
            elif ml_task == TaskType.BINARY_CLASSIFICATION:
