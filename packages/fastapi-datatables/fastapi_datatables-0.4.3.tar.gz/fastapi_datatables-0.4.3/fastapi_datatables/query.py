...
from typing import Callable, Iterable, Union, Literal, Optional, cast
...
GlobalDefaultFiltrationClass = FiltrationData


def set_default_filtration_class(filtration: type[FiltrationData]) -> None:
    global GlobalDefaultFiltrationClass
    GlobalDefaultFiltrationClass = filtration


def get_filtration(
    valid_columns: Iterable[str],
    *,
    default_filtration_class: Optional[type[FiltrationData]] = None,
    ...
    def get_filtration_data(
        ...
        **kwargs,
        ...
        return (default_filtration_class or GlobalDefaultFiltrationClass)(
