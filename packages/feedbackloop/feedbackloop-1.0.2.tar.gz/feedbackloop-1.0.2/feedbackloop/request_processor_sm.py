...
class RequestProcessor(Thread):
    ...
    def _handle(self, feedback_input, feedback_config, stream_name):
    ...
    def _process_input(self):
        ...
        feedback_input, feedback_config, stream_name = self._request_queue.get()
        try:
            logging.info("Processing request.")
            self._handle(feedback_input, feedback_config, stream_name)
        except Exception as e:
            logging.warn(
