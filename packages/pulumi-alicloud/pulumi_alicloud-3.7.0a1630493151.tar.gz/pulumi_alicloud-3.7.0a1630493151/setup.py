...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'alicloud', '3.7.0-alpha.1630493151+8da8dcbf'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource alicloud 3.7.0-alpha.1630493151+8da8dcbf`
                """)
            else:
                raise
