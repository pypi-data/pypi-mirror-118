# -*- coding: utf-8 -*-
#
# zenfilter documentation build configuration file, created by
...
htmlhelp_basename = 'zenfilterdoc'
...
latex_documents = [
  ('index', 'zenfilter.tex', u'zenfilter Documentation',
...
man_pages = [
    ('index', 'zenfilter', u'zenfilter Documentation',
     [u'Shlomi Fish'], 1)
]
