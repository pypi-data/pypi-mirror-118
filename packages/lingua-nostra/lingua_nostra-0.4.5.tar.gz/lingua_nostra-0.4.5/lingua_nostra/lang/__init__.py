...
from lingua_nostra.internal import get_default_lang, \
...
def get_active_lang():
    ...
    """
    _getlang = "Direct imports from lingua_nostra.lang"
...
def set_active_lang(lang_code):
    ...
    """
    _setlang = "Direct imports from lingua_nostra.lang"
    " have been deprecated. Use"
    " lingua_nostra.set_default_lang()"
...
def get_primary_lang_code(lang=None):
    ...
    """
    warn("Direct imports from lingua_nostra.lang have been deprecated. Use"
         " lingua_nostra.get_primary_lang_code()", DeprecationWarning)
...
def get_full_lang_code(lang=None):
    ...
    """
    warn("Direct imports from lingua_nostra.lang have been deprecated. Use"
         " lingua_nostra.get_full_lang_code()", DeprecationWarning)
