...
def test_corn():
    ...
    tea = module.corn_tea
    units = UnitGroup('Biorefinery', tea.units)
    assert np.allclose(tea.IRR, 0.37356967550781606, rtol=1e-2)
    ...
    assert np.allclose(tea.sales, 72934913.89320046, rtol=1e-2)
    assert np.allclose(tea.material_cost, 54210719.80237045, rtol=1e-2)
    assert np.allclose(tea.installed_equipment_cost, 82784988.1248156, rtol=1e-2)
    assert np.allclose(tea.utility_cost, 82501154.62951227, rtol=1e-2)
    ...
    assert np.allclose(units.get_electricity_consumption(), 2.357166625717917, rtol=1e-2)
...
def test_lipidcane():
    ...
    units = UnitGroup('Biorefinery', tea.units)
    assert np.allclose(tea.IRR, 0.2070713069735732, rtol=1e-2)
    ...
    assert np.allclose(tea.installed_equipment_cost, 236931997.54885623, rtol=1e-2)
    assert np.allclose(tea.utility_cost, -33147570.970166903, rtol=1e-2)
    ...
    assert np.allclose(units.get_electricity_consumption(), 16.12155209303832, rtol=1e-2)
    assert np.allclose(units.get_electricity_production(), 121.61530865119497, rtol=1e-2)
    bst.process_tools.default()
...
def test_cornstover():
    ...
    assert np.allclose(product.price, 0.7314694217002466, rtol=1e-2)
    assert np.allclose(tea.sales, 133592916.79848371, rtol=1e-2)
    assert np.allclose(tea.material_cost, 82503906.88686624, rtol=1e-2)
    assert np.allclose(tea.installed_equipment_cost, 215634014.14753655, rtol=1e-2)
...
def test_sugarcane():
    ...
    units = UnitGroup('Biorefinery', tea.units)
    assert np.allclose(tea.IRR, 0.11980499026991354, rtol=1e-2)
    assert np.allclose(feedstock.price, 0.03455, rtol=1e-2)
    assert np.allclose(product.price, 0.789, rtol=1e-2)
    assert np.allclose(tea.sales, 86924100.80067463, rtol=1e-2)
    assert np.allclose(tea.material_cost, 59825908.82267224, rtol=1e-2)
    assert np.allclose(tea.installed_equipment_cost, 203128097.7261707, rtol=1e-2)
    # assert np.allclose(tea.utility_cost, -18181977.881163258, rtol=1e-2)
    ...
    assert np.allclose(units.get_electricity_consumption(), 15.387729905823095, rtol=1e-2)
...
def test_LAOs():
    ...
    assert np.allclose(product.price, 1.3050756357492623, rtol=1e-2)
    assert np.allclose(tea.sales, 158582093.3268962, rtol=1e-2)
    assert np.allclose(tea.material_cost, 135664606.93240908, rtol=1e-2)
    assert np.allclose(tea.installed_equipment_cost, 53391969.276535235, rtol=1e-2)
    assert np.allclose(tea.utility_cost, 518973.84752009995, rtol=1e-2)
    assert np.allclose(units.get_heating_duty(), 37.830529776838524, rtol=1e-2)
    assert np.allclose(units.get_cooling_duty(), 123.51525780112365, rtol=1e-2)
    assert np.allclose(units.get_electricity_consumption(), 3.5853401580861703, rtol=1e-2)
    assert np.allclose(units.get_electricity_production(), 3.5853401580861712, rtol=1e-2)
    bst.process_tools.default()
