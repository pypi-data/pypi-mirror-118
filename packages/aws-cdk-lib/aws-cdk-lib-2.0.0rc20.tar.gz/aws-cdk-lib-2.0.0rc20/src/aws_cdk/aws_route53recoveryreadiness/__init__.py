...
class CfnCell(
    ...
    def __init__(
        ...
        *,
        ...
        jsii.create(CfnCell, self, [scope, id, props])
...
class CfnReadinessCheck(
    ...
    def __init__(
        ...
        *,
        ...
        jsii.create(CfnReadinessCheck, self, [scope, id, props])
...
class CfnRecoveryGroup(
    ...
    def __init__(
        ...
        *,
        ...
        jsii.create(CfnRecoveryGroup, self, [scope, id, props])
...
class CfnResourceSet(
    ...
    def __init__(
        ...
        *,
        ...
        jsii.create(CfnResourceSet, self, [scope, id, props])
