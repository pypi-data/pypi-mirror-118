...
class CfnFleet(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        compute_capacity: typing.Union["CfnFleet.ComputeCapacityProperty", _IResolvable_da3f097b],
    ...
    def compute_capacity(
        self,
    ) -> typing.Union["CfnFleet.ComputeCapacityProperty", _IResolvable_da3f097b]:
        ...
        '''
        return typing.cast(typing.Union["CfnFleet.ComputeCapacityProperty", _IResolvable_da3f097b], jsii.get(self, "computeCapacity"))

    @compute_capacity.setter
    def compute_capacity(
        self,
        value: typing.Union["CfnFleet.ComputeCapacityProperty", _IResolvable_da3f097b],
    ) -> None:
...
class CfnFleetProps:
    ...
    def compute_capacity(
        ...
        return typing.cast(typing.Union[CfnFleet.ComputeCapacityProperty, _IResolvable_da3f097b], result)
