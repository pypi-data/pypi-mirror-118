...
class EventBridgePutEvents(
    ...
    def __init__(
        ...
        *,
        ...
        jsii.create(EventBridgePutEvents, self, [scope, id, props])
...
class EventBridgePutEventsEntry:
    def __init__(
        ...
        *,
        ...
        :param source: (experimental) The service or application that caused this event to be generated.
...
class ResourceConfig:
    def __init__(
        ...
        *,
        ...
        :param instance_type: (experimental) ML compute instance type. Default: ec2.InstanceType(ec2.InstanceClass.M4, ec2.InstanceType.XLARGE)
...
class SnsPublish(
    ...
    def __init__(
        ...
        *,
        ...
        message_attributes: typing.Optional[typing.Mapping[builtins.str, MessageAttribute]] = None,
