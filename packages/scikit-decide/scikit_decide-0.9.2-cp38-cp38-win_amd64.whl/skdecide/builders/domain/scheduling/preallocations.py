...
class WithPreallocations:
    ...
    def _get_preallocations(self) -> Dict[int, List[str]]:  # TODO: To be handled by domain (applicable actions)
        """
    ...
    def get_preallocations(self) -> Dict[int, List[str]]:  # TODO: To be handled by domain (applicable actions)
        """
        Return a dictionary where the key is the id of a task (int)
        and the value indicates the pre-allocated resources for this task (as a list of str)"""
