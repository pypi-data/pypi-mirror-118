...
from biolib.compute_node.enclave.parent_api_types import VsockProxyResponse
...
class RemoteHostProxy:
    ...
    def terminate(self):
        ...
        if self._enclave_vsock_proxy:
            enclave.ParentApi.stop_vsock_proxy(self._enclave_vsock_proxy['id'])
    ...
    def _start_vsock_proxy_and_traffic_forwarder_and_return_local_port(self) -> int:
        ...
        self._enclave_vsock_proxy = enclave.ParentApi.start_vsock_proxy(self._remote_host)
