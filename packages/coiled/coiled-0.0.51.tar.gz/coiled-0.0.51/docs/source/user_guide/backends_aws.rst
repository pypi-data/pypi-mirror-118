...
.. note::
   ...
   The ECS backend is being deprecated. After September 16th, accounts using the
   ECS backend will be migrated to the default AWS VM backend.
...
On the next page, you will see the resources privisioned by Coiled in real time.
