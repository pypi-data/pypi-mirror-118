...
/* harmony export */   "CubeFileRenderer": () => (/* binding */ CubeFileRenderer),
 ...
 */
class CubeFileRenderer extends _lumino_widgets__WEBPACK_IMPORTED_MODULE_0__.Widget {
    /**
...
function UploadButtons(Props) {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: classes.root },
        ...
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("label", { htmlFor: "contained-button-file" },
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_material_ui_core_Button__WEBPACK_IMPORTED_MODULE_3__["default"], { variant: "contained", color: "primary", size: "small", component: "span" }, "Upload Structure"))));
}
...
/* harmony import */ var _material_ui_core_Switch__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @material-ui/core/Switch */ "./node_modules/@material-ui/core/esm/Switch/Switch.js");
...
/* harmony import */ var _material_ui_core_Radio__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @material-ui/core/Radio */ "./node_modules/@material-ui/core/esm/Radio/Radio.js");
/* harmony import */ var _material_ui_core_RadioGroup__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @material-ui/core/RadioGroup */ "./node_modules/@material-ui/core/esm/RadioGroup/RadioGroup.js");
...
class Visualizer extends (react__WEBPACK_IMPORTED_MODULE_0___default().Component) {
    constructor(props, context) {
        ...
        this.loadStructure = (event) => {
            this._stage.removeComponent(this._stage.getComponentsByName('struct').list[0]);
            this._stage
        ...
        window.requestAnimationFrame(() => {
            ...
            this._stage = new _osscar_ngl__WEBPACK_IMPORTED_MODULE_1__.Stage(this.uuid, {
                quality: 'high',
    ...
    render() {
        return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: "container" },
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_material_ui_core_Grid__WEBPACK_IMPORTED_MODULE_4__["default"], { container: true, spacing: 3, justify: "center", style: { marginTop: '10px' } },
            ...
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_material_ui_core_Grid__WEBPACK_IMPORTED_MODULE_4__["default"], { container: true, direction: "row", justify: "center", alignItems: "center", style: { marginTop: '20px' } },
                ...
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_material_ui_core_FormControlLabel__WEBPACK_IMPORTED_MODULE_7__["default"], { value: "spin", control: react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_material_ui_core_Switch__WEBPACK_IMPORTED_MODULE_8__["default"], { checked: this.state.spin, onChange: this.toggleSpin, name: "spin", color: "secondary" }), label: "Spin" })),
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_material_ui_core_Grid__WEBPACK_IMPORTED_MODULE_4__["default"], { container: true, direction: "row", justify: "center", alignItems: "center", style: { marginTop: '10px' } },
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_material_ui_core_RadioGroup__WEBPACK_IMPORTED_MODULE_9__["default"], { "aria-label": "camera", name: "camera", value: this.state.value, onChange: this.toggleCameraType, row: true },
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_material_ui_core_FormControlLabel__WEBPACK_IMPORTED_MODULE_7__["default"], { value: "perspective", control: react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_material_ui_core_Radio__WEBPACK_IMPORTED_MODULE_10__["default"], null), label: "Perspective" }),
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_material_ui_core_FormControlLabel__WEBPACK_IMPORTED_MODULE_7__["default"], { value: "orthographic", control: react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_material_ui_core_Radio__WEBPACK_IMPORTED_MODULE_10__["default"], null), label: "Orthographic" }),
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_material_ui_core_FormControlLabel__WEBPACK_IMPORTED_MODULE_7__["default"], { value: "stereo", control: react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_material_ui_core_Radio__WEBPACK_IMPORTED_MODULE_10__["default"], null), label: "Stereo" })))));
    }
}
...
//# sourceMappingURL=lib_index_js.67be042ab5c276f40aca.js.map