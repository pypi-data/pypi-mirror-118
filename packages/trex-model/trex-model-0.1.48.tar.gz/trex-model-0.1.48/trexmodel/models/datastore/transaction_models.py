...
class CustomerTransaction(BaseNModel, DictModel):
    ...
    dict_properties         = ['transaction_id', 'invoice_id', 'remarks', 'tax_amount', 'transact_amount', 'reward_giveaway_method',
                               ...
                               'transact_by_username', 'is_reward_redeemed', 'is_sales_transaction'
                               ]
    ...
    @staticmethod
    def create_manual_transaction(customer, remarks=None, transact_outlet=None, transact_by=None, transact_datetime=None, is_sales_transaction=False): 
