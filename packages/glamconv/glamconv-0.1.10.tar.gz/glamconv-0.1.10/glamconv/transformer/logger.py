...
class RunLog(object):
    ...
    def action_start(self, name, param_values):
        if self._current_step_log is not None:
            ...
            raise RuntimeError(u"Can't log an action start as no step has begun")
