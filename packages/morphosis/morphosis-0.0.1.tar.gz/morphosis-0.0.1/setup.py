...
setuptools.setup(
    ...
    version=version,
    url="https://gitlab.com/greenhousecode/ai/morphosis/",
    author="Greenhouse AI team",
    author_email="ai@greenhousegroup.com",
    package_dir={"morphosis": "src/morphosis"},
    classifiers=[
    ...
    install_requires=["numpy>=1.21.2,<2", "pandas>=1.3.2,<2", "scikit-learn<=0.24.2,>=0.21.0"],
    data_files=[(".", ["VERSION"])],
