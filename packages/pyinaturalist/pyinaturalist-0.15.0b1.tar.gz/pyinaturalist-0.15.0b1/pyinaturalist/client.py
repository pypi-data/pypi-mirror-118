...
class iNatClient:
    ...
    Examples:
        ...
        **Caching, Rate-limiting, and Retries**
        ...
        See :py:class:`.iNatSession` and the :ref:`user_guide` for details on these settings.
        ``iNatClient`` will accept any arguments for ``iNatSession``, for example:
