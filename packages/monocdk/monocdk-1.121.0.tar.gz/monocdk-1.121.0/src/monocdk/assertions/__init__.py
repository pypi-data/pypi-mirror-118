...
class Template(metaclass=jsii.JSIIMeta, jsii_type="monocdk.assertions.Template"):
    ...
    def find_mappings(
        ...
        :stability: experimental
        '''
        return typing.cast(typing.List[typing.Mapping[builtins.str, typing.Any]], jsii.invoke(self, "findMappings", [props]))
    ...
    def find_outputs(
        ...
        :stability: experimental
        '''
        return typing.cast(typing.List[typing.Mapping[builtins.str, typing.Any]], jsii.invoke(self, "findOutputs", [props]))
    ...
    def has_mapping(self, props: typing.Any) -> None:
        ...
        :stability: experimental
        '''
        return typing.cast(None, jsii.invoke(self, "hasMapping", [props]))

    @jsii.member(jsii_name="hasOutput")
    def has_output(self, props: typing.Any) -> None:
        ...
        :stability: experimental
        '''
        return typing.cast(None, jsii.invoke(self, "hasOutput", [props]))
