...
from infiniguard_health.event_engine.events import (
    ...
    SnapshotsNumDangerous, SnapshotsNumExceeded
)
...
STATE_FOR_SNAPSHOTS_NUM_EXCEEDED = ComponentState.CRITICAL
...
class SnapshotsNumRule(ThresholdRule):
    ...
    def get_threshold_levels(self):
        from iba_mgmt.const import DDE_SNAPSHOTS_HIGH_WATERMARK, MAX_SG_PER_CG
        SAFETY_BUFFER = 5
        ...
        return [
            ...
            ThresholdLevel(min_value=DDE_SNAPSHOTS_HIGH_WATERMARK,
                           event=SnapshotsNumDangerous,
                           state=STATE_FOR_SNAPSHOTS_NUM_DANGEROUS,
                           event_params={
                               'snapshots_num_percent_reached': int(DDE_SNAPSHOTS_HIGH_WATERMARK / MAX_SG_PER_CG * 100),
                               'snapshots_num_limit': MAX_SG_PER_CG
                           }),
            ThresholdLevel(min_value=MAX_SG_PER_CG - SAFETY_BUFFER,
                           event=SnapshotsNumExceeded,
                           state=STATE_FOR_SNAPSHOTS_NUM_EXCEEDED,
                           event_params={}),
        ]
...
CYBER_RECOVERY_RULES = (SnapshotRule, SnapshotsCapacityRule, PolicyRule)
initialized_rules = []
