...
st_cta, st_ctb = 'e', '20201025_esr_tstN100_aws'
...
# compute_spec_key, esti_spec_key = 'mpoly_1', 'esti_medtst_mpoly_13'
compute_spec_key, esti_spec_key = 'mpoly_1', 'esti_medtst_mpoly_13'
...
for st_regions in ar_regions:
    ...
    # Small memory is needed to execute the polynomial run, 1GB is already too much in fact.
    it_memory = 1024
