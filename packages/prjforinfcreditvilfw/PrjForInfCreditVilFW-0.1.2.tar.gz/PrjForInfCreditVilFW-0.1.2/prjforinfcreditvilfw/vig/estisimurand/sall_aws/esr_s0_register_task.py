"""
2020-12-23 09:42
This was copy-pasted over from G:/repos/ThaiJMP/boto3aws/aws_ecr/ecr_docker.py
"""
import logging
...
"""
the command is not important or even vcpus and memory since they can be changed When
tasks is submitted.
"""
