...
class Ui_PresetTrickLevel(object):
    def setupUi(self, PresetTrickLevel):
        ...
        self.trick_level_scroll_contents.setGeometry(QRect(0, 0, 525, 724))
    ...
    def retranslateUi(self, PresetTrickLevel):
        ...
        self.dangerous_combo.setItemText(2, QCoreApplication.translate("PresetTrickLevel", u"Never", None))

        self.cutscene_label.setText(QCoreApplication.translate("PresetTrickLevel", u"<html><head/><body><p>A dangerous action is the act of moving past a lock without the appropriate items needed to head backwards, or doing an action that can only be done once.</p><p><span style=\" font-weight:600;\">Randomly</span>: Dangerous actions might be required by logic.</p><p><span style=\" font-weight:600;\">Last Resort</span>: Only allows dangerous actions to be required if no other option is available for progression.</p><p><span style=\" font-weight:600;\">Never</span>: Will never require dangerous actions to happen logically.</p></body></html>", None))
