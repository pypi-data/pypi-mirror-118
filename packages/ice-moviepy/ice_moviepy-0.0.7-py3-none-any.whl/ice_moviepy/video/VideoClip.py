...
from .tools.textpic import Text_to_png, color_text
class VideoClip(Clip):
    ...
    def write_videofile(self, filename, fps=None, codec=None,
        ...
        >>> from ice_moviepy.editor import VideoFileClip
        ...
        if codec is None:
            ...
            try:
                ...
                raise ValueError("ice_moviepy couldn't find the codec associated "
        ...
        logger(message="ice_moviepy - Building video %s." % filename)
        if make_audio:
        ...
        if remove_temp and make_audio:
            if os.path.exists(audiofile):
                os.remove(audiofile)
        logger(message="ice_moviepy - video ready %s" % filename)
    ...
    def write_images_sequence(self, nameformat, fps=None, verbose=True,
        ...
        """
        logger = proglog.default_bar_logger(logger)
        logger(message='ice_moviepy - Writing frames %s.' % nameformat)
        ...
        logger(message='ice_moviepy - Done writing frames %s.' % nameformat)
    ...
    def subfx(self, fx, ta=0, tb=None, **kwargs):
        ...
        from ice_moviepy.video.compositing.concatenate import concatenate_videoclips
...
class TextClip(ImageClip):
    ...
    def __init__(self, txt=None, filename=None, size=None, color='black',
        ...
        coloredText=color_text(txt)
        Text_to_png(coloredText,tempfilename)
    ...
    def list(arg):
        ...
        if arg == 'font':
            ...
            raise Exception("ice_moviepy:Error! Argument must equal "
                            "'font' or 'color'")
