...
from ice_moviepy.audio.AudioClip import CompositeAudioClip
from ice_moviepy.tools import deprecated_version_of
from ice_moviepy.video.compositing.CompositeVideoClip import CompositeVideoClip
from ice_moviepy.video.compositing.on_color import on_color
from ice_moviepy.video.VideoClip import ColorClip, VideoClip
...
def concatenate_videoclips(clips, method="chain", transition=None,
    ...
    if method == "chain":
        ...
        raise Exception("ice_moviepy Error: The 'method' argument of "
