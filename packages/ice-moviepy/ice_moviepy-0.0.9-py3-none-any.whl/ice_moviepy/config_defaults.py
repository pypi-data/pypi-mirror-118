"""
Configuration of ice_moviepy


This file enables you to specify a configuration for ice_moviepy. In
particular you can enter the path to the FFMPEG and ImageMagick
binaries.

Defaults must be done BEFORE installing ice_moviepy: first make the changes,
then install ice_moviepy with
