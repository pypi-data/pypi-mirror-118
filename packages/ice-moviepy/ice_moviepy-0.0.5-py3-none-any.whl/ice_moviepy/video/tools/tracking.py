...
from ice_moviepy.decorators import convert_to_seconds, use_clip_fps_by_default
...
def manual_tracking(clip, t1=None, t2=None, fps=None, nobjects = 1,
    ...
    >>> from ice_moviepy.video.tools.tracking import manual_tracking
    ...
    >>> from ice_moviepy.video.tools.tracking import Trajectory
