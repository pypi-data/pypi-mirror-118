...
# file, but this would make the loading of ice_moviepy slower.
...
import ice_moviepy.video.fx.all as vfx
import ice_moviepy.audio.fx.all as afx
import ice_moviepy.video.compositing.transitions as transfx

# Tools

import ice_moviepy.video.tools as videotools
import ice_moviepy.video.io.ffmpeg_tools as ffmpeg_tools
...
try:
    from ice_moviepy.video.io.preview import show, preview
except ImportError:
...
try:
    from ice_moviepy.audio.io.preview import preview
except ImportError:
    def preview(self, *args, **kwargs):
        """ NOT AVAILABLE : clip.preview requires Pygame installed."""
        raise ImportError("clip.preview requires Pygame installed")
