...
import pygame as pg
from ice_moviepy.decorators import convert_masks_to_RGB, requires_duration
from ice_moviepy.tools import cvsecs

pg.init()
pg.display.set_caption('ice_moviepy')
...
def show(clip, t=0, with_mask=True, interactive=False):
    ...
    if with_mask and (clip.mask is not None):
        import ice_moviepy.video.compositing.CompositeVideoClip as cvc
