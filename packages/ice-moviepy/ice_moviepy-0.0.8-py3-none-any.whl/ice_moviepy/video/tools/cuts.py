...
the cuts in ice_moviepy """

from collections import defaultdict

import numpy as np

from ice_moviepy.decorators import use_clip_fps_by_default
...
class FramesMatches(list):
    ...
    def from_clip(clip, dist_thr, max_d, fps=None):
        ...
        >>> from ice_moviepy.video.tools.cuts import find_matching_frames
        ...
        clip
          A ice_moviepy video clip, possibly transformed/resized
