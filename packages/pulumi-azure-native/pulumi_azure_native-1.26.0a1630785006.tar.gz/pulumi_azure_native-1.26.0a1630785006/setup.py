...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure-native', '1.26.0a1630785006'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure-native 1.26.0a1630785006`
                """)
            else:
                raise
