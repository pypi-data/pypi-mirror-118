...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure-native', '1.26.0a1630738288'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure-native 1.26.0a1630738288`
                """)
            else:
                raise
