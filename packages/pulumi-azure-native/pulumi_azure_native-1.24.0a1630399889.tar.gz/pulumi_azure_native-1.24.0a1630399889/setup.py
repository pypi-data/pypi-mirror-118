...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure-native', '1.24.0a1630399889'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure-native 1.24.0a1630399889`
                """)
            else:
                raise
