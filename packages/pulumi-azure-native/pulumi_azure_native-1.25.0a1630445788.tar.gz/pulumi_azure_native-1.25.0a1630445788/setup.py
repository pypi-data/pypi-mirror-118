...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure-native', '1.25.0a1630445788'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure-native 1.25.0a1630445788`
                """)
            else:
                raise
