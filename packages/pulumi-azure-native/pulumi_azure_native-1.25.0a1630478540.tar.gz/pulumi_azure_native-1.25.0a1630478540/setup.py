...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure-native', '1.25.0a1630478540'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure-native 1.25.0a1630478540`
                """)
            else:
                raise
