...
setup(
    ...
    install_requires=['requests', 'beautifulsoup4', 'selenium', 'pandas', 'sqlalchemy', 'OQMD_new-version', 'periodic_table_new', 'generic_scraper', 'data_structure'], # For this project we are using two external libraries
