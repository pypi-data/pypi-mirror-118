...
#         return picture
    ...
    def upload_picture(
        ...
        existing_picture = self.find_picture(image_file_size, image_file_checksum)
        ...
        if existing_picture:
            ...
            picture = self.__set_picture_status(existing_picture.picture_id, ObjectStatus.enabled)
