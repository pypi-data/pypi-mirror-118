...
class NFSGetExportCommand(Subcommand):
    ...
    def options(parser):
        ...
        export.add_argument(
            '--id', type=str_decode, dest='ref', help='ID of export to list'
        )
        export.add_argument(
...
class NFSModExportCommand(Subcommand):
    ...
    def options(parser):
        export = parser.add_mutually_exclusive_group(required=True)
        export.add_argument(
            '--id', type=str_decode, dest='ref', help='ID of export to modify'
        )
        export.add_argument(
            '--export-path',
            type=str_decode,
...
class NFSDeleteExportCommand(Subcommand):
    ...
    def options(parser):
        export = parser.add_mutually_exclusive_group(required=True)
        export.add_argument(
            '--id', type=str_decode, dest='ref', help='ID of export to delete'
        )
        export.add_argument(
            '--export-path',
            type=str_decode,
