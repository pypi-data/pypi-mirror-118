...
from wpaudit.core.console import set_logger_configuration, print_info, print_exception
...
def format_finding_to_securityhub_format(aws_account_id,
    ...
    try:
        ...
        formatted_finding = {
            ...
            'GeneratorId': f'wpaudit-{aws_account_id}',
            ...
            'ProductFields': {'Product Name': 'WP Audit'},
...
if __name__ == "__main__":
    ...
    parser.add_argument('-f', '--file',
                        ...
                        help="The path of the JSON results file to process, e.g. "
                             "\"wpaudit-report/wpaudit-results/wpaudit_results_aws-<profile>.js\".")
