...
class itkNormalVariateGenerator(itk.ITKCommonBasePython.itkRandomVariateGeneratorBase):
    ...
    Monash University, 1994 To use this code, files needing to call the
    generator should include: and be linked with the maths library (-lm)
    FastNorm.h contains declaration of the initialization routine
    'initnorm()', definition of a macro 'FastGauss' used to generate
    variates, and three variables used in the macro. Read below for
    calling conventions.
