...
class itkSize5(object):
    ...
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    GetSizeDimension = _swig_new_static_method(_itkSizePython.itkSize5_GetSizeDimension)
    __add__ = _swig_new_instance_method(_itkSizePython.itkSize5___add__)
    __iadd__ = _swig_new_instance_method(_itkSizePython.itkSize5___iadd__)
    __sub__ = _swig_new_instance_method(_itkSizePython.itkSize5___sub__)
    __isub__ = _swig_new_instance_method(_itkSizePython.itkSize5___isub__)
    __mul__ = _swig_new_instance_method(_itkSizePython.itkSize5___mul__)
    __imul__ = _swig_new_instance_method(_itkSizePython.itkSize5___imul__)
    GetSize = _swig_new_instance_method(_itkSizePython.itkSize5_GetSize)
    SetSize = _swig_new_instance_method(_itkSizePython.itkSize5_SetSize)
    SetElement = _swig_new_instance_method(_itkSizePython.itkSize5_SetElement)
    GetElement = _swig_new_instance_method(_itkSizePython.itkSize5_GetElement)
    Fill = _swig_new_instance_method(_itkSizePython.itkSize5_Fill)
    assign = _swig_new_instance_method(_itkSizePython.itkSize5_assign)
    swap = _swig_new_instance_method(_itkSizePython.itkSize5_swap)
    begin = _swig_new_instance_method(_itkSizePython.itkSize5_begin)
    end = _swig_new_instance_method(_itkSizePython.itkSize5_end)
    rbegin = _swig_new_instance_method(_itkSizePython.itkSize5_rbegin)
    rend = _swig_new_instance_method(_itkSizePython.itkSize5_rend)
    size = _swig_new_instance_method(_itkSizePython.itkSize5_size)
    max_size = _swig_new_instance_method(_itkSizePython.itkSize5_max_size)
    empty = _swig_new_instance_method(_itkSizePython.itkSize5_empty)
    at = _swig_new_instance_method(_itkSizePython.itkSize5_at)
    front = _swig_new_instance_method(_itkSizePython.itkSize5_front)
    back = _swig_new_instance_method(_itkSizePython.itkSize5_back)
    data = _swig_new_instance_method(_itkSizePython.itkSize5_data)
    Filled = _swig_new_static_method(_itkSizePython.itkSize5_Filled)
    ...
    __getitem__ = _swig_new_instance_method(_itkSizePython.itkSize5___getitem__)
    __setitem__ = _swig_new_instance_method(_itkSizePython.itkSize5___setitem__)
    __len__ = _swig_new_static_method(_itkSizePython.itkSize5___len__)
    __repr__ = _swig_new_instance_method(_itkSizePython.itkSize5___repr__)
...
itkSize5_GetSizeDimension = _itkSizePython.itkSize5_GetSizeDimension
itkSize5_Filled = _itkSizePython.itkSize5_Filled
itkSize5___len__ = _itkSizePython.itkSize5___len__
