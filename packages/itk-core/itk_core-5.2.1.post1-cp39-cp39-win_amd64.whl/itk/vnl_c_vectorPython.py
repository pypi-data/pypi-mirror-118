...
class vnl_c_vectorCD(object):
    ...
    __repr__ = _swig_repr
    sum = _swig_new_static_method(_vnl_c_vectorPython.vnl_c_vectorCD_sum)
    squared_magnitude = _swig_new_static_method(_vnl_c_vectorPython.vnl_c_vectorCD_squared_magnitude)
    normalize = _swig_new_static_method(_vnl_c_vectorPython.vnl_c_vectorCD_normalize)
    copy = _swig_new_static_method(_vnl_c_vectorPython.vnl_c_vectorCD_copy)
    scale = _swig_new_static_method(_vnl_c_vectorPython.vnl_c_vectorCD_scale)
    add = _swig_new_static_method(_vnl_c_vectorPython.vnl_c_vectorCD_add)
    subtract = _swig_new_static_method(_vnl_c_vectorPython.vnl_c_vectorCD_subtract)
    multiply = _swig_new_static_method(_vnl_c_vectorPython.vnl_c_vectorCD_multiply)
    divide = _swig_new_static_method(_vnl_c_vectorPython.vnl_c_vectorCD_divide)
    negate = _swig_new_static_method(_vnl_c_vectorPython.vnl_c_vectorCD_negate)
    invert = _swig_new_static_method(_vnl_c_vectorPython.vnl_c_vectorCD_invert)
    saxpy = _swig_new_static_method(_vnl_c_vectorPython.vnl_c_vectorCD_saxpy)
    fill = _swig_new_static_method(_vnl_c_vectorPython.vnl_c_vectorCD_fill)
    reverse = _swig_new_static_method(_vnl_c_vectorPython.vnl_c_vectorCD_reverse)
    dot_product = _swig_new_static_method(_vnl_c_vectorPython.vnl_c_vectorCD_dot_product)
    inner_product = _swig_new_static_method(_vnl_c_vectorPython.vnl_c_vectorCD_inner_product)
    conjugate = _swig_new_static_method(_vnl_c_vectorPython.vnl_c_vectorCD_conjugate)
    max_value = _swig_new_static_method(_vnl_c_vectorPython.vnl_c_vectorCD_max_value)
    min_value = _swig_new_static_method(_vnl_c_vectorPython.vnl_c_vectorCD_min_value)
    arg_max = _swig_new_static_method(_vnl_c_vectorPython.vnl_c_vectorCD_arg_max)
    arg_min = _swig_new_static_method(_vnl_c_vectorPython.vnl_c_vectorCD_arg_min)
    mean = _swig_new_static_method(_vnl_c_vectorPython.vnl_c_vectorCD_mean)
    std = _swig_new_static_method(_vnl_c_vectorPython.vnl_c_vectorCD_std)
    sum_sq_diff_means = _swig_new_static_method(_vnl_c_vectorPython.vnl_c_vectorCD_sum_sq_diff_means)
    one_norm = _swig_new_static_method(_vnl_c_vectorPython.vnl_c_vectorCD_one_norm)
    two_norm = _swig_new_static_method(_vnl_c_vectorPython.vnl_c_vectorCD_two_norm)
    inf_norm = _swig_new_static_method(_vnl_c_vectorPython.vnl_c_vectorCD_inf_norm)
    two_nrm2 = _swig_new_static_method(_vnl_c_vectorPython.vnl_c_vectorCD_two_nrm2)
    rms_norm = _swig_new_static_method(_vnl_c_vectorPython.vnl_c_vectorCD_rms_norm)
    euclid_dist_sq = _swig_new_static_method(_vnl_c_vectorPython.vnl_c_vectorCD_euclid_dist_sq)
    allocate_Tptr = _swig_new_static_method(_vnl_c_vectorPython.vnl_c_vectorCD_allocate_Tptr)
    allocate_T = _swig_new_static_method(_vnl_c_vectorPython.vnl_c_vectorCD_allocate_T)
    deallocate = _swig_new_static_method(_vnl_c_vectorPython.vnl_c_vectorCD_deallocate)
...
vnl_c_vectorCD_sum = _vnl_c_vectorPython.vnl_c_vectorCD_sum
vnl_c_vectorCD_squared_magnitude = _vnl_c_vectorPython.vnl_c_vectorCD_squared_magnitude
vnl_c_vectorCD_normalize = _vnl_c_vectorPython.vnl_c_vectorCD_normalize
vnl_c_vectorCD_copy = _vnl_c_vectorPython.vnl_c_vectorCD_copy
vnl_c_vectorCD_scale = _vnl_c_vectorPython.vnl_c_vectorCD_scale
vnl_c_vectorCD_add = _vnl_c_vectorPython.vnl_c_vectorCD_add
vnl_c_vectorCD_subtract = _vnl_c_vectorPython.vnl_c_vectorCD_subtract
vnl_c_vectorCD_multiply = _vnl_c_vectorPython.vnl_c_vectorCD_multiply
vnl_c_vectorCD_divide = _vnl_c_vectorPython.vnl_c_vectorCD_divide
vnl_c_vectorCD_negate = _vnl_c_vectorPython.vnl_c_vectorCD_negate
vnl_c_vectorCD_invert = _vnl_c_vectorPython.vnl_c_vectorCD_invert
vnl_c_vectorCD_saxpy = _vnl_c_vectorPython.vnl_c_vectorCD_saxpy
vnl_c_vectorCD_fill = _vnl_c_vectorPython.vnl_c_vectorCD_fill
vnl_c_vectorCD_reverse = _vnl_c_vectorPython.vnl_c_vectorCD_reverse
vnl_c_vectorCD_dot_product = _vnl_c_vectorPython.vnl_c_vectorCD_dot_product
vnl_c_vectorCD_inner_product = _vnl_c_vectorPython.vnl_c_vectorCD_inner_product
vnl_c_vectorCD_conjugate = _vnl_c_vectorPython.vnl_c_vectorCD_conjugate
vnl_c_vectorCD_max_value = _vnl_c_vectorPython.vnl_c_vectorCD_max_value
vnl_c_vectorCD_min_value = _vnl_c_vectorPython.vnl_c_vectorCD_min_value
vnl_c_vectorCD_arg_max = _vnl_c_vectorPython.vnl_c_vectorCD_arg_max
vnl_c_vectorCD_arg_min = _vnl_c_vectorPython.vnl_c_vectorCD_arg_min
vnl_c_vectorCD_mean = _vnl_c_vectorPython.vnl_c_vectorCD_mean
vnl_c_vectorCD_std = _vnl_c_vectorPython.vnl_c_vectorCD_std
vnl_c_vectorCD_sum_sq_diff_means = _vnl_c_vectorPython.vnl_c_vectorCD_sum_sq_diff_means
vnl_c_vectorCD_one_norm = _vnl_c_vectorPython.vnl_c_vectorCD_one_norm
vnl_c_vectorCD_two_norm = _vnl_c_vectorPython.vnl_c_vectorCD_two_norm
vnl_c_vectorCD_inf_norm = _vnl_c_vectorPython.vnl_c_vectorCD_inf_norm
vnl_c_vectorCD_two_nrm2 = _vnl_c_vectorPython.vnl_c_vectorCD_two_nrm2
vnl_c_vectorCD_rms_norm = _vnl_c_vectorPython.vnl_c_vectorCD_rms_norm
vnl_c_vectorCD_euclid_dist_sq = _vnl_c_vectorPython.vnl_c_vectorCD_euclid_dist_sq
vnl_c_vectorCD_allocate_Tptr = _vnl_c_vectorPython.vnl_c_vectorCD_allocate_Tptr
vnl_c_vectorCD_allocate_T = _vnl_c_vectorPython.vnl_c_vectorCD_allocate_T
vnl_c_vectorCD_deallocate = _vnl_c_vectorPython.vnl_c_vectorCD_deallocate
