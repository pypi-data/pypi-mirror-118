...
class itkIndex5(object):
    ...
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    GetIndexDimension = _swig_new_static_method(_itkIndexPython.itkIndex5_GetIndexDimension)
    __add__ = _swig_new_instance_method(_itkIndexPython.itkIndex5___add__)
    __iadd__ = _swig_new_instance_method(_itkIndexPython.itkIndex5___iadd__)
    __isub__ = _swig_new_instance_method(_itkIndexPython.itkIndex5___isub__)
    __sub__ = _swig_new_instance_method(_itkIndexPython.itkIndex5___sub__)
    __mul__ = _swig_new_instance_method(_itkIndexPython.itkIndex5___mul__)
    GetIndex = _swig_new_instance_method(_itkIndexPython.itkIndex5_GetIndex)
    SetIndex = _swig_new_instance_method(_itkIndexPython.itkIndex5_SetIndex)
    SetElement = _swig_new_instance_method(_itkIndexPython.itkIndex5_SetElement)
    GetElement = _swig_new_instance_method(_itkIndexPython.itkIndex5_GetElement)
    Fill = _swig_new_instance_method(_itkIndexPython.itkIndex5_Fill)
    GetBasisIndex = _swig_new_static_method(_itkIndexPython.itkIndex5_GetBasisIndex)
    assign = _swig_new_instance_method(_itkIndexPython.itkIndex5_assign)
    swap = _swig_new_instance_method(_itkIndexPython.itkIndex5_swap)
    begin = _swig_new_instance_method(_itkIndexPython.itkIndex5_begin)
    end = _swig_new_instance_method(_itkIndexPython.itkIndex5_end)
    rbegin = _swig_new_instance_method(_itkIndexPython.itkIndex5_rbegin)
    rend = _swig_new_instance_method(_itkIndexPython.itkIndex5_rend)
    size = _swig_new_instance_method(_itkIndexPython.itkIndex5_size)
    max_size = _swig_new_instance_method(_itkIndexPython.itkIndex5_max_size)
    empty = _swig_new_instance_method(_itkIndexPython.itkIndex5_empty)
    at = _swig_new_instance_method(_itkIndexPython.itkIndex5_at)
    front = _swig_new_instance_method(_itkIndexPython.itkIndex5_front)
    back = _swig_new_instance_method(_itkIndexPython.itkIndex5_back)
    data = _swig_new_instance_method(_itkIndexPython.itkIndex5_data)
    Filled = _swig_new_static_method(_itkIndexPython.itkIndex5_Filled)
    ...
    __getitem__ = _swig_new_instance_method(_itkIndexPython.itkIndex5___getitem__)
    __setitem__ = _swig_new_instance_method(_itkIndexPython.itkIndex5___setitem__)
    __len__ = _swig_new_static_method(_itkIndexPython.itkIndex5___len__)
    __repr__ = _swig_new_instance_method(_itkIndexPython.itkIndex5___repr__)
...
itkIndex5_GetIndexDimension = _itkIndexPython.itkIndex5_GetIndexDimension
itkIndex5_GetBasisIndex = _itkIndexPython.itkIndex5_GetBasisIndex
itkIndex5_Filled = _itkIndexPython.itkIndex5_Filled
itkIndex5___len__ = _itkIndexPython.itkIndex5___len__
