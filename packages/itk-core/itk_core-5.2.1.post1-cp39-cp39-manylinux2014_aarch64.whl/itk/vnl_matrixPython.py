...
class vnl_matrixCD(object):
    ...
    size = _swig_new_instance_method(_vnl_matrixPython.vnl_matrixCD_size)
    rows = _swig_new_instance_method(_vnl_matrixPython.vnl_matrixCD_rows)
    cols = _swig_new_instance_method(_vnl_matrixPython.vnl_matrixCD_cols)
    columns = _swig_new_instance_method(_vnl_matrixPython.vnl_matrixCD_columns)
    put = _swig_new_instance_method(_vnl_matrixPython.vnl_matrixCD_put)
    get = _swig_new_instance_method(_vnl_matrixPython.vnl_matrixCD_get)
    __call__ = _swig_new_instance_method(_vnl_matrixPython.vnl_matrixCD___call__)
    fill = _swig_new_instance_method(_vnl_matrixPython.vnl_matrixCD_fill)
    fill_diagonal = _swig_new_instance_method(_vnl_matrixPython.vnl_matrixCD_fill_diagonal)
    set_diagonal = _swig_new_instance_method(_vnl_matrixPython.vnl_matrixCD_set_diagonal)
    copy_in = _swig_new_instance_method(_vnl_matrixPython.vnl_matrixCD_copy_in)
    set = _swig_new_instance_method(_vnl_matrixPython.vnl_matrixCD_set)
    copy_out = _swig_new_instance_method(_vnl_matrixPython.vnl_matrixCD_copy_out)
    ...
    __iadd__ = _swig_new_instance_method(_vnl_matrixPython.vnl_matrixCD___iadd__)
    __isub__ = _swig_new_instance_method(_vnl_matrixPython.vnl_matrixCD___isub__)
    __imul__ = _swig_new_instance_method(_vnl_matrixPython.vnl_matrixCD___imul__)
    __neg__ = _swig_new_instance_method(_vnl_matrixPython.vnl_matrixCD___neg__)
    ...
    __add__ = _swig_new_instance_method(_vnl_matrixPython.vnl_matrixCD___add__)
    __sub__ = _swig_new_instance_method(_vnl_matrixPython.vnl_matrixCD___sub__)
    __mul__ = _swig_new_instance_method(_vnl_matrixPython.vnl_matrixCD___mul__)
    transpose = _swig_new_instance_method(_vnl_matrixPython.vnl_matrixCD_transpose)
    conjugate_transpose = _swig_new_instance_method(_vnl_matrixPython.vnl_matrixCD_conjugate_transpose)
    update = _swig_new_instance_method(_vnl_matrixPython.vnl_matrixCD_update)
    set_column = _swig_new_instance_method(_vnl_matrixPython.vnl_matrixCD_set_column)
    set_columns = _swig_new_instance_method(_vnl_matrixPython.vnl_matrixCD_set_columns)
    set_row = _swig_new_instance_method(_vnl_matrixPython.vnl_matrixCD_set_row)
    extract = _swig_new_instance_method(_vnl_matrixPython.vnl_matrixCD_extract)
    get_row = _swig_new_instance_method(_vnl_matrixPython.vnl_matrixCD_get_row)
    get_column = _swig_new_instance_method(_vnl_matrixPython.vnl_matrixCD_get_column)
    get_rows = _swig_new_instance_method(_vnl_matrixPython.vnl_matrixCD_get_rows)
    get_columns = _swig_new_instance_method(_vnl_matrixPython.vnl_matrixCD_get_columns)
    get_n_rows = _swig_new_instance_method(_vnl_matrixPython.vnl_matrixCD_get_n_rows)
    get_n_columns = _swig_new_instance_method(_vnl_matrixPython.vnl_matrixCD_get_n_columns)
    get_diagonal = _swig_new_instance_method(_vnl_matrixPython.vnl_matrixCD_get_diagonal)
    flatten_row_major = _swig_new_instance_method(_vnl_matrixPython.vnl_matrixCD_flatten_row_major)
    flatten_column_major = _swig_new_instance_method(_vnl_matrixPython.vnl_matrixCD_flatten_column_major)
    set_identity = _swig_new_instance_method(_vnl_matrixPython.vnl_matrixCD_set_identity)
    inplace_transpose = _swig_new_instance_method(_vnl_matrixPython.vnl_matrixCD_inplace_transpose)
    flipud = _swig_new_instance_method(_vnl_matrixPython.vnl_matrixCD_flipud)
    fliplr = _swig_new_instance_method(_vnl_matrixPython.vnl_matrixCD_fliplr)
    normalize_rows = _swig_new_instance_method(_vnl_matrixPython.vnl_matrixCD_normalize_rows)
    normalize_columns = _swig_new_instance_method(_vnl_matrixPython.vnl_matrixCD_normalize_columns)
    scale_row = _swig_new_instance_method(_vnl_matrixPython.vnl_matrixCD_scale_row)
    scale_column = _swig_new_instance_method(_vnl_matrixPython.vnl_matrixCD_scale_column)
    swap = _swig_new_instance_method(_vnl_matrixPython.vnl_matrixCD_swap)
    array_one_norm = _swig_new_instance_method(_vnl_matrixPython.vnl_matrixCD_array_one_norm)
    array_two_norm = _swig_new_instance_method(_vnl_matrixPython.vnl_matrixCD_array_two_norm)
    array_inf_norm = _swig_new_instance_method(_vnl_matrixPython.vnl_matrixCD_array_inf_norm)
    absolute_value_sum = _swig_new_instance_method(_vnl_matrixPython.vnl_matrixCD_absolute_value_sum)
    absolute_value_max = _swig_new_instance_method(_vnl_matrixPython.vnl_matrixCD_absolute_value_max)
    operator_one_norm = _swig_new_instance_method(_vnl_matrixPython.vnl_matrixCD_operator_one_norm)
    operator_inf_norm = _swig_new_instance_method(_vnl_matrixPython.vnl_matrixCD_operator_inf_norm)
    frobenius_norm = _swig_new_instance_method(_vnl_matrixPython.vnl_matrixCD_frobenius_norm)
    fro_norm = _swig_new_instance_method(_vnl_matrixPython.vnl_matrixCD_fro_norm)
    rms = _swig_new_instance_method(_vnl_matrixPython.vnl_matrixCD_rms)
    min_value = _swig_new_instance_method(_vnl_matrixPython.vnl_matrixCD_min_value)
    max_value = _swig_new_instance_method(_vnl_matrixPython.vnl_matrixCD_max_value)
    arg_min = _swig_new_instance_method(_vnl_matrixPython.vnl_matrixCD_arg_min)
    arg_max = _swig_new_instance_method(_vnl_matrixPython.vnl_matrixCD_arg_max)
    mean = _swig_new_instance_method(_vnl_matrixPython.vnl_matrixCD_mean)
    empty = _swig_new_instance_method(_vnl_matrixPython.vnl_matrixCD_empty)
    is_identity = _swig_new_instance_method(_vnl_matrixPython.vnl_matrixCD_is_identity)
    is_zero = _swig_new_instance_method(_vnl_matrixPython.vnl_matrixCD_is_zero)
    is_equal = _swig_new_instance_method(_vnl_matrixPython.vnl_matrixCD_is_equal)
    is_finite = _swig_new_instance_method(_vnl_matrixPython.vnl_matrixCD_is_finite)
    has_nans = _swig_new_instance_method(_vnl_matrixPython.vnl_matrixCD_has_nans)
    assert_size = _swig_new_instance_method(_vnl_matrixPython.vnl_matrixCD_assert_size)
    assert_finite = _swig_new_instance_method(_vnl_matrixPython.vnl_matrixCD_assert_finite)
    read = _swig_new_static_method(_vnl_matrixPython.vnl_matrixCD_read)
    read_ascii = _swig_new_instance_method(_vnl_matrixPython.vnl_matrixCD_read_ascii)
    data_block = _swig_new_instance_method(_vnl_matrixPython.vnl_matrixCD_data_block)
    data_array = _swig_new_instance_method(_vnl_matrixPython.vnl_matrixCD_data_array)
    begin = _swig_new_instance_method(_vnl_matrixPython.vnl_matrixCD_begin)
    end = _swig_new_instance_method(_vnl_matrixPython.vnl_matrixCD_end)
    operator_eq = _swig_new_instance_method(_vnl_matrixPython.vnl_matrixCD_operator_eq)
    __eq__ = _swig_new_instance_method(_vnl_matrixPython.vnl_matrixCD___eq__)
    __ne__ = _swig_new_instance_method(_vnl_matrixPython.vnl_matrixCD___ne__)
    _print = _swig_new_instance_method(_vnl_matrixPython.vnl_matrixCD__print)
    clear = _swig_new_instance_method(_vnl_matrixPython.vnl_matrixCD_clear)
    set_size = _swig_new_instance_method(_vnl_matrixPython.vnl_matrixCD_set_size)

# Register vnl_matrixCD in _vnl_matrixPython:
_vnl_matrixPython.vnl_matrixCD_swigregister(vnl_matrixCD)
vnl_matrixCD_read = _vnl_matrixPython.vnl_matrixCD_read
