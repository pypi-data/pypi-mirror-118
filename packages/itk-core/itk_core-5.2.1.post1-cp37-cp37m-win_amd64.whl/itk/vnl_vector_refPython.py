...
class vnl_vector_refCD(itk.vnl_vectorPython.vnl_vectorCD):
    ...
    non_const = _swig_new_instance_method(_vnl_vector_refPython.vnl_vector_refCD_non_const)
    as_vector = _swig_new_instance_method(_vnl_vector_refPython.vnl_vector_refCD_as_vector)
