...
class vnl_vectorCD(object):
    ...
    size = _swig_new_instance_method(_vnl_vectorPython.vnl_vectorCD_size)
    put = _swig_new_instance_method(_vnl_vectorPython.vnl_vectorCD_put)
    get = _swig_new_instance_method(_vnl_vectorPython.vnl_vectorCD_get)
    fill = _swig_new_instance_method(_vnl_vectorPython.vnl_vectorCD_fill)
    copy_in = _swig_new_instance_method(_vnl_vectorPython.vnl_vectorCD_copy_in)
    copy_out = _swig_new_instance_method(_vnl_vectorPython.vnl_vectorCD_copy_out)
    set = _swig_new_instance_method(_vnl_vectorPython.vnl_vectorCD_set)
    __call__ = _swig_new_instance_method(_vnl_vectorPython.vnl_vectorCD___call__)
    ...
    __iadd__ = _swig_new_instance_method(_vnl_vectorPython.vnl_vectorCD___iadd__)
    __isub__ = _swig_new_instance_method(_vnl_vectorPython.vnl_vectorCD___isub__)
    pre_multiply = _swig_new_instance_method(_vnl_vectorPython.vnl_vectorCD_pre_multiply)
    post_multiply = _swig_new_instance_method(_vnl_vectorPython.vnl_vectorCD_post_multiply)
    __imul__ = _swig_new_instance_method(_vnl_vectorPython.vnl_vectorCD___imul__)
    __pos__ = _swig_new_instance_method(_vnl_vectorPython.vnl_vectorCD___pos__)
    __neg__ = _swig_new_instance_method(_vnl_vectorPython.vnl_vectorCD___neg__)
    ...
    __add__ = _swig_new_instance_method(_vnl_vectorPython.vnl_vectorCD___add__)
    __sub__ = _swig_new_instance_method(_vnl_vectorPython.vnl_vectorCD___sub__)
    __mul__ = _swig_new_instance_method(_vnl_vectorPython.vnl_vectorCD___mul__)
    data_block = _swig_new_instance_method(_vnl_vectorPython.vnl_vectorCD_data_block)
    begin = _swig_new_instance_method(_vnl_vectorPython.vnl_vectorCD_begin)
    end = _swig_new_instance_method(_vnl_vectorPython.vnl_vectorCD_end)
    front = _swig_new_instance_method(_vnl_vectorPython.vnl_vectorCD_front)
    back = _swig_new_instance_method(_vnl_vectorPython.vnl_vectorCD_back)
    extract = _swig_new_instance_method(_vnl_vectorPython.vnl_vectorCD_extract)
    update = _swig_new_instance_method(_vnl_vectorPython.vnl_vectorCD_update)
    squared_magnitude = _swig_new_instance_method(_vnl_vectorPython.vnl_vectorCD_squared_magnitude)
    magnitude = _swig_new_instance_method(_vnl_vectorPython.vnl_vectorCD_magnitude)
    one_norm = _swig_new_instance_method(_vnl_vectorPython.vnl_vectorCD_one_norm)
    two_norm = _swig_new_instance_method(_vnl_vectorPython.vnl_vectorCD_two_norm)
    inf_norm = _swig_new_instance_method(_vnl_vectorPython.vnl_vectorCD_inf_norm)
    normalize = _swig_new_instance_method(_vnl_vectorPython.vnl_vectorCD_normalize)
    rms = _swig_new_instance_method(_vnl_vectorPython.vnl_vectorCD_rms)
    min_value = _swig_new_instance_method(_vnl_vectorPython.vnl_vectorCD_min_value)
    max_value = _swig_new_instance_method(_vnl_vectorPython.vnl_vectorCD_max_value)
    arg_min = _swig_new_instance_method(_vnl_vectorPython.vnl_vectorCD_arg_min)
    arg_max = _swig_new_instance_method(_vnl_vectorPython.vnl_vectorCD_arg_max)
    mean = _swig_new_instance_method(_vnl_vectorPython.vnl_vectorCD_mean)
    sum = _swig_new_instance_method(_vnl_vectorPython.vnl_vectorCD_sum)
    flip = _swig_new_instance_method(_vnl_vectorPython.vnl_vectorCD_flip)
    roll = _swig_new_instance_method(_vnl_vectorPython.vnl_vectorCD_roll)
    roll_inplace = _swig_new_instance_method(_vnl_vectorPython.vnl_vectorCD_roll_inplace)
    swap = _swig_new_instance_method(_vnl_vectorPython.vnl_vectorCD_swap)
    assert_size = _swig_new_instance_method(_vnl_vectorPython.vnl_vectorCD_assert_size)
    assert_finite = _swig_new_instance_method(_vnl_vectorPython.vnl_vectorCD_assert_finite)
    is_finite = _swig_new_instance_method(_vnl_vectorPython.vnl_vectorCD_is_finite)
    is_zero = _swig_new_instance_method(_vnl_vectorPython.vnl_vectorCD_is_zero)
    empty = _swig_new_instance_method(_vnl_vectorPython.vnl_vectorCD_empty)
    is_equal = _swig_new_instance_method(_vnl_vectorPython.vnl_vectorCD_is_equal)
    operator_eq = _swig_new_instance_method(_vnl_vectorPython.vnl_vectorCD_operator_eq)
    __eq__ = _swig_new_instance_method(_vnl_vectorPython.vnl_vectorCD___eq__)
    __ne__ = _swig_new_instance_method(_vnl_vectorPython.vnl_vectorCD___ne__)
    set_size = _swig_new_instance_method(_vnl_vectorPython.vnl_vectorCD_set_size)
    clear = _swig_new_instance_method(_vnl_vectorPython.vnl_vectorCD_clear)
    read_ascii = _swig_new_instance_method(_vnl_vectorPython.vnl_vectorCD_read_ascii)
    read = _swig_new_static_method(_vnl_vectorPython.vnl_vectorCD_read)
    set_data = _swig_new_instance_method(_vnl_vectorPython.vnl_vectorCD_set_data)
    set_data_same_size = _swig_new_instance_method(_vnl_vectorPython.vnl_vectorCD_set_data_same_size)

# Register vnl_vectorCD in _vnl_vectorPython:
_vnl_vectorPython.vnl_vectorCD_swigregister(vnl_vectorCD)
vnl_vectorCD_read = _vnl_vectorPython.vnl_vectorCD_read
