...
class ImageInfo(object):
    ...
    def __init__(self, ssh_public_key=None, size_bytes=None, download_url=None, generator_version=None, created_at=None, expires_at=None, static_network_config=None, type=None, _configuration=None):  # noqa: E501
