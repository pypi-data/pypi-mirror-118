...
class AddHostsClusterCreateParams(object):
    ...
    def __init__(self, id=None, name=None, api_vip_dnsname=None, openshift_version=None, _configuration=None):  # noqa: E501
    ...
    def api_vip_dnsname(self, api_vip_dnsname):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and api_vip_dnsname is None:
