...
class ClusterDefaultConfig(object):
    ...
    def __init__(self, cluster_network_cidr=None, cluster_network_host_prefix=None, inactive_deletion_hours=None, service_network_cidr=None, ntp_source=None, _configuration=None):  # noqa: E501
    ...
    def cluster_network_cidr(self, cluster_network_cidr):
        ...
        if (self._configuration.client_side_validation and
                cluster_network_cidr is not None and not re.search(r'^((25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\.){3}(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)[\/]([1-9]|[1-2][0-9]|3[0-2]?)$', cluster_network_cidr)):  # noqa: E501
            raise ValueError(r"Invalid value for `cluster_network_cidr`, must be a follow pattern or equal to `/^((25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\.){3}(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)[\/]([1-9]|[1-2][0-9]|3[0-2]?)$/`")  # noqa: E501
    ...
    def cluster_network_host_prefix(self, cluster_network_host_prefix):
        ...
        """
        if (self._configuration.client_side_validation and
                cluster_network_host_prefix is not None and cluster_network_host_prefix > 32):  # noqa: E501
    ...
    def service_network_cidr(self, service_network_cidr):
        ...
        """
        if (self._configuration.client_side_validation and
                service_network_cidr is not None and not re.search(r'^((25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\.){3}(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)[\/]([1-9]|[1-2][0-9]|3[0-2]?)$', service_network_cidr)):  # noqa: E501
            raise ValueError(r"Invalid value for `service_network_cidr`, must be a follow pattern or equal to `/^((25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\.){3}(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)[\/]([1-9]|[1-2][0-9]|3[0-2]?)$/`")  # noqa: E501
