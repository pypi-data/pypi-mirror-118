...
class DhcpAllocationResponse(object):
    ...
    def __init__(self, api_vip_address=None, ingress_vip_address=None, api_vip_lease=None, ingress_vip_lease=None, _configuration=None):  # noqa: E501
    ...
    def api_vip_address(self, api_vip_address):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and api_vip_address is None:
    ...
    def ingress_vip_address(self, ingress_vip_address):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and ingress_vip_address is None:
