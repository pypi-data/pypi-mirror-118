...
class ClusterProgressInfo(object):
    ...
    def __init__(self, total_percentage=None, preparing_for_installation_stage_percentage=None, installing_stage_percentage=None, finalizing_stage_percentage=None, _configuration=None):  # noqa: E501
