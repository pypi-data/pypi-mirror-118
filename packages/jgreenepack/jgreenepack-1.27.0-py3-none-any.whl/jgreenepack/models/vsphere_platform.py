...
class VspherePlatform(object):
    ...
    def __init__(self, username=None, password=None, datacenter=None, v_center=None, cluster=None, default_datastore=None, network=None, folder=None, _configuration=None):  # noqa: E501
