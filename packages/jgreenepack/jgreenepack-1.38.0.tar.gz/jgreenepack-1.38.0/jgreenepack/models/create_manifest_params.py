...
class CreateManifestParams(object):
    ...
    def __init__(self, folder='manifests', file_name=None, content=None, _configuration=None):  # noqa: E501
    ...
    def file_name(self, file_name):
        ...
        if (self._configuration.client_side_validation and
                file_name is not None and not re.search(r'^[^\/]*\\.(yaml|yml|json)$', file_name)):  # noqa: E501
            raise ValueError(r"Invalid value for `file_name`, must be a follow pattern or equal to `/^[^\/]*\\.(yaml|yml|json)$/`")  # noqa: E501
