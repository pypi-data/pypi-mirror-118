...
class Disk(object):
    ...
    swagger_types = {
        ...
        'installation_eligibility': 'object',
        'smart': 'str',
        'io_perf': 'IoPerf'
    }
    ...
    def __init__(self, id=None, drive_type=None, vendor=None, name=None, path=None, hctl=None, by_path=None, by_id=None, model=None, wwn=None, serial=None, size_bytes=None, bootable=None, removable=None, is_installation_media=None, installation_eligibility=None, smart=None, io_perf=None, _configuration=None):  # noqa: E501
