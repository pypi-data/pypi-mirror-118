...
class OsImage(object):
    ...
    def __init__(self, openshift_version=None, cpu_architecture=None, url=None, rootfs_url=None, version=None, _configuration=None):  # noqa: E501
    ...
    def cpu_architecture(self, cpu_architecture):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and cpu_architecture is None:
    ...
    def rootfs_url(self, rootfs_url):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and rootfs_url is None:
