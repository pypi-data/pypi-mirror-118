...
import jgreenepack
from jgreenepack.models.api_vip_connectivity_response import ApiVipConnectivityResponse  # noqa: E501
...
class TestApiVipConnectivityResponse(unittest.TestCase):
    ...
    def testApiVipConnectivityResponse(self):
        ...
        # model = jgreenepack.models.api_vip_connectivity_response.ApiVipConnectivityResponse()  # noqa: E501
        pass
