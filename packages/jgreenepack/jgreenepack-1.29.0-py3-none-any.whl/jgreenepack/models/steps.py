...
class Steps(object):
    ...
    def __init__(self, next_instruction_seconds=None, post_step_action='continue', instructions=None, _configuration=None):  # noqa: E501
    ...
    def post_step_action(self, post_step_action):
        ...
        if (self._configuration.client_side_validation and
                post_step_action not in allowed_values):
            raise ValueError(
