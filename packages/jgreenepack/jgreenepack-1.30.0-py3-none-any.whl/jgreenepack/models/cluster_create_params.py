...
class ClusterCreateParams(object):
    ...
    def name(self, name):
        ...
        if (self._configuration.client_side_validation and
                name is not None and len(name) > 54):
    ...
    def openshift_version(self, openshift_version):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and openshift_version is None:
    ...
    def pull_secret(self, pull_secret):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and pull_secret is None:
