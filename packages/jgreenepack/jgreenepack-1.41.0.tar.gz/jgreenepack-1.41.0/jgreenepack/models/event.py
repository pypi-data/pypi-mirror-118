...
class Event(object):
    ...
    def __init__(self, cluster_id=None, host_id=None, severity=None, category=None, message=None, event_time=None, request_id=None, props=None, _configuration=None):  # noqa: E501
    ...
    def event_time(self, event_time):
        ...
        :type: datetime
        """
        if self._configuration.client_side_validation and event_time is None:
