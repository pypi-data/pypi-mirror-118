...
class HostUpdateParams(object):
    ...
    def __init__(self, host_role=None, host_name=None, disks_selected_config=None, machine_config_pool_name=None, _configuration=None):  # noqa: E501
    ...
    def host_role(self, host_role):
        ...
        if (self._configuration.client_side_validation and
                host_role not in allowed_values):
            raise ValueError(
