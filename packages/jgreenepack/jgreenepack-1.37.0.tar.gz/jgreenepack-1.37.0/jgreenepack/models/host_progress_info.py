...
class HostProgressInfo(object):
    ...
    def __init__(self, installation_percentage=None, current_stage=None, progress_info=None, stage_started_at=None, stage_updated_at=None, _configuration=None):  # noqa: E501
    ...
    def current_stage(self, current_stage):
        ...
        :type: HostStage
        """
        if self._configuration.client_side_validation and current_stage is None:
