...
class L3Connectivity(object):
    ...
    def __init__(self, outgoing_nic=None, remote_ip_address=None, successful=None, average_rtt_ms=None, packet_loss_percentage=None, _configuration=None):  # noqa: E501
