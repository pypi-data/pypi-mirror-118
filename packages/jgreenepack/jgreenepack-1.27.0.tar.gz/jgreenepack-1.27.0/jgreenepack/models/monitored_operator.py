...
class MonitoredOperator(object):
    ...
    def __init__(self, cluster_id=None, name=None, namespace=None, subscription_name=None, operator_type=None, properties=None, timeout_seconds=None, status=None, status_info=None, status_updated_at=None, _configuration=None):  # noqa: E501
