...
package_data = \
{'': ['*'], 'dxfeed': ['dxfeed-c-api/include/*']}

install_requires = \
['toml>=0.10.2,<0.11.0']

extras_require = \
{':python_full_version >= "3.6.1" and python_version < "3.7"': ['pandas>=1.0,!=1.1.5,<1.2'],
 ':python_version >= "3.7" and python_version < "4.0"': ['pandas>=1.0.0,<2.0.0'],
 'docs': ['jupyter>=1.0.0,<2.0.0', 'cython>=0.29.14,<0.30.0']}
