...
class RDSDBCluster(GenericBaseModel):
 ...
 def get_cfn_attribute(self,attribute):
  ...
  return LlAWr(RDSDBInstance,self).get_cfn_attribute(attribute)
 @LlAWV
 def get_deploy_templates():
...
class RDSDBParameterGroup(GenericBaseModel):
 ...
 def get_physical_resource_id(self,attribute=LlAWN,**kwargs):
...
class RDSDBInstance(GenericBaseModel):
 ...
 def get_deploy_templates():
  ...
  return{"create":{"function":"create_db_instance","parameters":attrs+[{"VpcSecurityGroupIds":"VPCSecurityGroups"}],"types":{"AllocatedStorage":LlAWk}},"delete":{"function":"delete_db_instance","parameters":["DBInstanceIdentifier"]}}
