...
class GlueTrigger(GenericBaseModel):
 ...
 def get_cfn_attribute(self,attribute_name):
  ...
  return qYLmH(GlueTrigger,self).get_cfn_attribute(attribute_name)
class GlueWorkflow(GenericBaseModel):
 ...
 def get_cfn_attribute(self,attribute_name):
  if attribute_name in REF_ATTRS:
   return self.props.get("Name")
  return qYLmH(GlueWorkflow,self).get_cfn_attribute(attribute_name)
class GlueJob(GenericBaseModel):
 ...
 def get_cfn_attribute(self,attribute_name):
  ...
  return qYLmH(GlueJob,self).get_cfn_attribute(attribute_name)
class GlueCrawler(GenericBaseModel):
 ...
 def get_cfn_attribute(self,attribute_name):
  if attribute_name in REF_ATTRS:
   return self.props["Name"]
  return qYLmH(GlueCrawler,self).get_cfn_attribute(attribute_name)
...
class GlueDatabase(GenericBaseModel):
 ...
 def get_cfn_attribute(self,attribute_name):
  ...
  return qYLmH(GlueDatabase,self).get_cfn_attribute(attribute_name)
...
class GlueTable(GenericBaseModel):
 ...
 def get_cfn_attribute(self,attribute_name):
  ...
  return qYLmH(GlueTable,self).get_cfn_attribute(attribute_name)
