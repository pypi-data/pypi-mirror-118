...
class SESTemplate(GenericBaseModel):
 ...
 def fetch_state(self,stack_name,resources):
  ...
  return(template or[KXqbm])[0]
 def get_physical_resource_id(self,attribute=KXqbm,**kwargs):
 ...
 def update_resource(self,new_resource,stack_name,resources):
  ...
  if KXqbw(template.get(attr,"")==new_template.get(attr,"")for attr in["SubjectPart","TextPart","HtmlPart"]):
   return
