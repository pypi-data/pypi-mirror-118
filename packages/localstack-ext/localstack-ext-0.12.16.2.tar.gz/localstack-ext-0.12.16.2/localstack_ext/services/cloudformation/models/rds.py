...
class RDSDBCluster(GenericBaseModel):
 ...
 def get_cfn_attribute(self,attribute):
  ...
  return GOrzB(RDSDBInstance,self).get_cfn_attribute(attribute)
 @GOrzD
 def get_deploy_templates():
...
class RDSDBParameterGroup(GenericBaseModel):
 ...
 def get_physical_resource_id(self,attribute=GOrzE,**kwargs):
...
class RDSDBInstance(GenericBaseModel):
 ...
 def get_deploy_templates():
  ...
  return{"create":{"function":"create_db_instance","parameters":attrs+[{"VpcSecurityGroupIds":"VPCSecurityGroups"}],"types":{"AllocatedStorage":GOrzW}},"delete":{"function":"delete_db_instance","parameters":["DBInstanceIdentifier"]}}
