...
class RDSDBCluster(GenericBaseModel):
 ...
 def get_cfn_attribute(self,attribute):
  ...
  return uPMJh(RDSDBInstance,self).get_cfn_attribute(attribute)
 @uPMJY
 def get_deploy_templates():
...
class RDSDBParameterGroup(GenericBaseModel):
 ...
 def get_physical_resource_id(self,attribute=uPMJz,**kwargs):
...
class RDSDBInstance(GenericBaseModel):
 ...
 def get_deploy_templates():
  ...
  return{"create":{"function":"create_db_instance","parameters":attrs+[{"VpcSecurityGroupIds":"VPCSecurityGroups"}],"types":{"AllocatedStorage":uPMJA}},"delete":{"function":"delete_db_instance","parameters":["DBInstanceIdentifier"]}}
