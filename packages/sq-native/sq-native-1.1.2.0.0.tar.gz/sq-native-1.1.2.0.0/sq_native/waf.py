    ...
    def __del__(self):
        ...
        if handle is not None:
            try:
                ...
                # The __del__ method might fail during shutdown with the following silent exception:
                # Exception TypeError: "'NoneType' object is not callable" in <bound method WAFEngine.__del__ of <sq_native.waf.WAFEngine instance at 0x7f4a72faf5f0>> ignored
                # In this case the WAF memory is leaked, but it's not that bad because the program
