...
UNITS_HELP = {
    "pt": "point (desktop publishing point: 1/72 inch, or about 0.353mm)",
    "mm": "millimeter",
    "cm": "centimeter",
    "in": "inch (exactly 25.4 mm)",
    "bp": "big point (25.4/72 mm)",
    "pc": "pica (12 points, or 1/6 inch)",
    "dd": "Didot point (1238 pt = 1157 dd)",
    "cc": "cicero (12 Didot points)",
    "nd": "new Didot (3/8 mm)",
    "nc": "new cicero (12 new Didot points)",
    "sp": "scaled point (1/2^16 pt)",
}
...
SIZES_HELP = {
    # http://www.printernational.org/iso-paper-sizes.php
    "4A0": "168.2cm x 237.8cm (ISO 216, for times an A0)",
    "2A0": "118.9cm x 168.2cm (ISO 216, twice an A0)",
    "A0": "84.1cm x 1189cm (ISO 216, has an aspect ration of √2, and an area of 1 m²)",
    "A1": "59.4cm x 84.1cm (ISO 216, half an A0)",
    "A2": "42cm x 59.4cm (ISO 216, half an A1)",
    "A3": "29.7cm x 42cm (ISO 216, half an A2)",
    "A4": "21cm x 29.1cm (ISO 216, half an A3)",
    "A5": "14.8cm x 21cm (ISO 216, half an A4)",
    "A6": "10.5cm x 14.8cm (ISO 216, half an A5)",
    "A7": "7.4cm x 10.5cm (ISO 216, half an A6)",
    "A8": "5.2cm x 7.4cm (ISO 216, half an A7)",
    "A9": "3.7cm x 5.2cm (ISO 216, half an A8)",
    "A10": "2.6cm x 3.7cm (ISO 216, half an A9)",
    "B0": "100cm x 141.4cm (ISO 216)",
    "B1": "70.7cm x 100cm (ISO 216, half a B0)",
    "B2": "50cm x 70.7cm (ISO 216, half a B1)",
    "B3": "35.3cm x 50cm (ISO 216, half a B2)",
    "B4": "25cm x 35.2cm (ISO 216, half a B3)",
    "B5": "17.6cm x 25cm (ISO 216, half a B4)",
    "B6": "12.5cm x 17.6cm (ISO 216, half a B5)",
    "B7": "8.8cm x 12.5cm (ISO 216, half a B6)",
    "B8": "6.2cm x 8.8cm (ISO 216, half a B7)",
    "B9": "4.4cm x 6.2cm (ISO 216, half a B8)",
    "B10": "3.1cm x 4.4cm (ISO 216, half a B9)",
    "A2extra": "445mm x 619mm",
    "A3extra": "322mm x 445mm",
    "A3super": "305mm x 508mm",
    "superA3": "305mm x 487mm",
    ...
    "10x14": "10in x 14in",
    # https://en.wikipedia.org/w/index.php?title=Paper_size&oldid=814180250
    "C0": "91.7cm × 129.7cm (ISO 269)",
    "C1": "64.8cm × 91.7cm (ISO 269, half a C0)",
    "C2": "45.8cm × 64.8cm (ISO 269, half a C1)",
    "C3": "32.4cm × 45.8cm (ISO 269, half a C2)",
    "C4": "22.9cm × 32.4cm (ISO 269, half a C3)",
    "C5": "16.2cm × 22.9cm (ISO 269, half a C4)",
    "C6": "11.4cm × 16.2cm (ISO 269, half a C5)",
    "C7": "8.1cm × 11.4cm (ISO 269, half a C6)",
    "C8": "5.7cm × 8.1cm (ISO 269, half a C7)",
    "C9": "4cm × 5.7cm (ISO 269, half a C8)",
    "C10": "2.8cm × 4cm (ISO 269, half a C9)",
    "juniorlegal": "5in × 8in",
    "memo": "synonym for halfletter",
    "governmentletter": "8in × 10in",
    "governmentlegal": "8.5in × 13in",
    "ledger": "17in x 11in",
    "Arch1": "9in x 12in (architectural size)",
    "Arch2": "12in x 18in (architectural size)",
    "Arch3": "18in x 24in (architectural size)",
    "Arch4": "24in x 36in (architectural size)",
    "Arch5": "30in x 42in (architectural size)",
    "Arch6": "36in x 48in (architectural size)",
    "ArchA": "other name for Arch1 (architectural size)",
    "ArchB": "other name for Arch2 (architectural size)",
    "ArchC": "other name for Arch3 (architectural size)",
    "ArchD": "other name for Arch4 (architectural size)",
    "ArchE1": "other name for Arch5 (architectural size)",
    "ArchE": "other name for Arch6 (architectural size)",
    "ArchE2": "26in x 38in (architectural size)",
    "ArchE3": "27in x 39in (architectural size)",
}
