...
class _ProfileDetail(QtWidgets.QDialog):
    ...
    def config(self):
        try:
            ...
            self.place_show.setText(main_paras.test_place)
            self.city_show.setText(main_paras.test_city)
            self.country_show.setText(main_paras.test_country)
            self.provider_show.setText(main_paras.test_provider)
            self.testing_mode_show.setText(main_paras.test_mode)
