"""
NOTE: This is mostly copied from https://github.com/davidtvs/pytorch-lr-finder/blob/master/torch_lr_finder/lr_finder.py.
One only changes it to apply for TPU. 
Almost all credits goes to davidtvs. Refer to their implementation for more details. 
