"""
Jwks - retrieve public keys from jwks url and use them to decode/verify JWTs
...
class   Jwks:
    ...
    def _load_jwks(self, url):
        ...
        try:
            ...
            print(f'JWK: Error: _load_jwk {str(e)}', file=sys.stderr)
            raise e
        ...
        try:
            ...
            if self.pub_keys and kid in self.pub_keys:
                ...
                try:
                    ...
                    print(f'JWK Error: decode Failed {str(e)}', file=sys.stderr)
                    return None
            else:
                print(f'JWK Error: decode requested Public Key with KID {kid} has not been loaded', file=sys.stderr)
        
        except Exception as e:
            print(f'JWK Error: decode Bad Token: {str(e)}', file=sys.stderr)
        ...
        try:
            ...
            if self.pub_keys and kid in self.pub_keys:
                ...
                try:
                    ...
                    print(f'jWK Error: signature_verify Failed: {str(e)}', file=sys.stderr)
            else:
                print(f'JWK Error: signature_verify: No Public Key with KID: {kid}', file=sys.stderr)
        
        except Exception as e:
            print(f'JWK Error: signature_verify Bad Token: {str(e)}', file=sys.stderr)
    ...
    def decode_noverify(self, token, **kwargs):
        ...
        try:
            ...
            print(f'JWK Error: decode_noverify: decode failed {str(e)}')
            return None
