...
class DAO(object):
    ...
    def save_publication(self, publication_data):
        ...
        for author_data in authors:
            ...
            publication_authors = PublicationAuthor(**{'authorId': author.id, 'publicationDoi': publication.id})
        ...
        for sources_data in sources:
            ...
            publication_sources = PublicationSource(**{'sourceId': source.id, 'publicationDoi': publication.id})
        ...
        for fos_data in fields_of_study:
            ...
            publication_fos = PublicationFieldOfStudy(**{'fieldOfStudyId': fos.id, 'publicationDoi': publication.id})
