...
def topicmodelingtransformer(dataset,no_topic,topic_word,column_name='clean_tweet'):
    modelweights_path=os.environ['FAST_TEXT_MODEL_PATH']
    print("starting transformer model with model path:",modelweights_path)
    num_topic=no_topic
