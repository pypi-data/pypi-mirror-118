...
class Simulation(object):
    ...
    def __call__(self, params_cal):
        ...
        if self.hiperparams.process=='normal':
            ...
            NSRP_simulation1(Df_params, self.hiperparams.year_ini, self.hiperparams.year_fin, self.hiperparams.temporal_resolution, self.hiperparams.process, self.hiperparams.Seasonality)
            ...
            NSRP_simulation1(Df_params1, self.hiperparams.year_ini, self.hiperparams.year_fin, self.hiperparams.temporal_resolution, 'normal', self.hiperparams.Seasonality)

            [Df_sim_join_hour_2, Df_sim_join_day_2, Intensidad_cellss2, Duracion_horas_cellss2]=\
            NSRP_simulation1(Df_params2, self.hiperparams.year_ini, self.hiperparams.year_fin, self.hiperparams.temporal_resolution, 'normal', self.hiperparams.Seasonality)
