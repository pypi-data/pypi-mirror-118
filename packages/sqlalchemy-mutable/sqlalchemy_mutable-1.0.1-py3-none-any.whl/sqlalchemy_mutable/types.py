...
class HTMLAttributesType(MutableJSONType):  # pylint: disable=abstract-method
    """HTML attributes dictionary type."""


HTMLAttributes.associate_with(HTMLAttributesType)
