...
class FeatureDaily:
    def __init__(self, code_list, start, end, save_mem=False):  # 开启save_mem会导致只保留最后20个数值 也就是最近一个月的因子值
        ...
        self.feature_group = {
            ...
            "gplearn_lv3": self.calc_feature_gplearn_lv3(),
        }
    ...
    def calc_feature_gplearn_lv3(self):
        need_feature_expressions = ['abs(sqrt(ts_max(daily_hq.pct_chg,10)))',
                                    'log(inv(ts_max(daily_hq.pct_chg,10)))',
                                    'sigmoid(abs(ts_max(daily_hq.pct_chg,10)))',
                                    'abs(abs(ts_cov(daily_hq.pct_chg,moneyflow.buy_elg_amount,10)))',
                                    'log(ts_std(ts_std(moneyflow.buy_elg_amount,5),5))',
                                    'inv(ts_std(ts_std(moneyflow.buy_elg_amount,5),5))',
                                    'cs_rank(ts_std(mul(daily_basic.volume,moneyflow.buy_elg_amount),10))',
                                    'abs(sqrt(ts_cov(daily_basic.volume,moneyflow.buy_elg_amount,10)))',
                                    'inv(ts_max(cs_orthogonalize(daily_hq.pct_chg,daily_basic.dv_ratio),10))',
                                    'sqrt(cs_rank(ts_std(moneyflow.buy_elg_amount,10)))',
                                    'ts_var(cs_orthogonalize(ts_count(daily_hq.volume,5),moneyflow.buy_elg_amount),10)',
                                    'cs_zscore(ts_std(ts_std(moneyflow.buy_elg_amount,5),5))',
                                    'sub(sub(ts_var(moneyflow.buy_elg_amount,10),express.express_total_assets),ts_count(cs_orthogonalize(daily_hq.open_hfq,daily_basic.turnover_rate),5))',
                                    'ts_min(sigmoid(div(moneyflow.buy_md_vol,moneyflow.buy_elg_vol)),10)',
                                    'abs(abs(ts_var(moneyflow.buy_elg_amount,5)))',
                                    'sub(abs(ts_var(moneyflow.buy_elg_amount,10)),moneyflow.net_mf_vol)',
                                    'ts_std(add(mul(daily_basic.volume,moneyflow.buy_elg_amount),ts_backward_pct_chg(moneyflow.sell_lg_amount,120)),10)',
                                    'sqrt(abs(ts_std(moneyflow.buy_elg_amount,5)))',
                                    'sub(ts_backward_pct_chg(ts_min(daily_hq.high_hfq,60),250),ts_max(daily_hq.pct_chg,10))',
                                    'cs_rank(inv(ts_std(moneyflow.buy_elg_amount,5)))',
                                    'ts_var(sub(ts_delta(top_list.reason_is_contain_zhangfu,10),moneyflow.buy_elg_amount),5)',
                                    'inv(ts_corr(add(moneyflow.buy_elg_amount,moneyflow.buy_md_vol),moneyflow.buy_md_vol,20))',
                                    'ts_std(abs(ts_cov(moneyflow.buy_elg_amount,daily_hq.amount,5)),5)',
                                    'log(cs_rank(ts_cov(daily_hq.pct_chg,moneyflow.buy_elg_amount,10)))',
                                    'sigmoid(ts_std(div(moneyflow.buy_elg_vol,moneyflow.sell_md_vol),10))',
                                    'ts_sum(add(mul(daily_hq.pct_chg,daily_basic.turnover_rate_f),ts_count(daily_hq.high_hfq,5)),10)',
                                    'log(ts_max(sub(daily_hq.pct_chg,daily_basic.dv_ttm),10))',
                                    'ts_var(ts_var(add(top_list.reason_is_contain_diefu,moneyflow.buy_elg_amount),5),10)',
                                    'abs(ts_max(ts_cov(moneyflow.buy_elg_amount,daily_hq.amount,5),5))',
                                    'div(sigmoid(cs_orthogonalize(moneyflow.buy_sm_vol,moneyflow.sell_md_amount)),ts_max(moneyflow.buy_lg_amount,5))',
                                    'ts_zscore(cs_rank(add(daily_hq.close,daily_basic.ps_ttm)),20)',
                                    'ts_max(mul(ts_sum(moneyflow.buy_elg_amount,5),moneyflow.buy_elg_amount),5)',
                                    'cs_rank(cs_rank(ts_cov(daily_basic.volume,moneyflow.buy_elg_amount,10)))',
                                    'mul(ts_count(mul(daily_hq.low_hfq,moneyflow.sell_lg_vol),250),ts_cov(daily_basic.volume,moneyflow.buy_elg_amount,10))',
                                    'abs(sigmoid(ts_max(daily_hq.pct_chg,20)))',
                                    'add(add(ts_var(moneyflow.buy_elg_amount,10),ts_zscore(daily_hq.open_hfq,250)),moneyflow.sell_elg_amount)',
                                    'ts_var(sub(ts_count(daily_hq.volume,250),add(moneyflow.buy_elg_amount,daily_hq.open_hfq)),10)',
                                    'cs_zscore(sigmoid(ts_zscore(daily_basic.circ_mv,20)))',
                                    'sqrt(ts_var(mul(moneyflow.sell_elg_amount,moneyflow.buy_elg_amount),5))',
                                    'abs(ts_max(add(daily_basic.pb,moneyflow.buy_elg_amount),10))',
                                    'ts_max(cs_rank(ts_cov(daily_hq.pct_chg,moneyflow.buy_elg_amount,10)),5)',
                                    'cs_rank(ts_zscore(mul(daily_hq.close_hfq,daily_basic.total_share),60))',
                                    'sqrt(log(ts_var(moneyflow.buy_elg_amount,5)))',
                                    'sigmoid(cs_rank(ts_mean(daily_hq.pct_chg,20)))',
                                    'sqrt(cs_rank(ts_mean(daily_hq.pct_chg,20)))',
                                    'cs_rank(cs_zscore(ts_mean(daily_hq.pct_chg,20)))',
                                    'sub(ts_max(add(top_list.reason_is_contain_diefu,moneyflow.buy_elg_amount),10),ts_delta(daily_hq.close,60))',
                                    'sub(ts_var(cs_orthogonalize(moneyflow.buy_elg_amount,daily_basic.total_mv),5),top_list.reason_is_contain_diefu)',
                                    'ts_max(cs_rank(cs_orthogonalize(daily_hq.pct_chg,daily_basic.total_mv)),5)',
                                    'sub(log(ts_cov(daily_basic.turnover_rate,moneyflow.buy_elg_amount,5)),express.express_yoy_net_profit)',
                                    'log(cs_rank(ts_mean(moneyflow.buy_elg_amount,5)))',
                                    'ts_std(ts_std(sub(daily_basic.turnover_rate,moneyflow.buy_elg_amount),500),10)',
                                    'add(sigmoid(ts_var(moneyflow.sell_lg_vol,5)),cs_rank(ts_mean(moneyflow.buy_elg_amount,5)))',
                                    'log(cs_rank(ts_max(daily_hq.pct_chg,20)))',
                                    'div(cs_rank(sub(moneyflow.buy_lg_amount,top_list.reason_is_contain_zhangfu)),ts_max(add(daily_basic.pb,moneyflow.buy_elg_amount),10))',
                                    'cs_rank(ts_backward_pct_chg(add(daily_hq.close_hfq,daily_basic.dv_ratio),20))',
                                    'add(add(ts_sum(daily_hq.close,60),ts_delta(daily_hq.pct_chg,5)),add(top_list.reason_is_contain_diefu,moneyflow.buy_elg_amount))',
                                    'sqrt(cs_rank(ts_zscore(daily_basic.total_mv,60)))',
                                    'cs_rank(sqrt(ts_cov(daily_basic.turnover_rate,moneyflow.buy_elg_amount,5)))',
                                    'cs_orthogonalize(cs_rank(ts_cov(daily_hq.pct_chg,moneyflow.buy_elg_amount,10)),cs_orthogonalize(ts_max(express.express_n_income,250),add(moneyflow.buy_lg_amount,factor_adj.adj_factor)))',
                                    'sub(ts_var(div(moneyflow.buy_elg_amount,daily_basic.float_share),10),inv(ts_std(daily_basic.circ_mv,20)))',
                                    'ts_std(mul(ts_skew(moneyflow.buy_lg_vol,500),moneyflow.buy_elg_amount),5)',
                                    'ts_sum(abs(cs_orthogonalize(moneyflow.buy_elg_amount,express.express_n_income)),5)',
                                    'ts_zscore(cs_rank(sub(daily_hq.high_hfq,daily_basic.dv_ttm)),20)',
                                    'ts_var(cs_zscore(cs_zscore(moneyflow.buy_lg_amount)),5)',
                                    'ts_std(add(ts_zscore(moneyflow.buy_md_amount,20),sub(express.express_total_profit,moneyflow.buy_elg_amount)),10)',
                                    'ts_max(sqrt(mul(moneyflow.sell_elg_amount,moneyflow.buy_elg_amount)),5)',
                                    'sigmoid(ts_zscore(ts_max(moneyflow.buy_elg_vol,10),500))',
                                    'sigmoid(sqrt(ts_mean(moneyflow.buy_elg_amount,5)))',
                                    'sqrt(cs_rank(ts_backward_pct_chg(daily_basic.ps,10)))',
                                    'add(ts_std(cs_zscore(moneyflow.buy_elg_vol),5),ts_zscore(daily_hq.close,120))',
                                    'ts_zscore(sub(ts_zscore(daily_hq.open_hfq,250),daily_hq.close_hfq),20)',
                                    'sub(cs_zscore(ts_zscore(daily_basic.total_mv,60)),div(sub(daily_hq.high_hfq,moneyflow.sell_elg_amount),ts_sum(moneyflow.buy_lg_vol,5)))',
                                    'div(cs_rank(sub(moneyflow.sell_md_vol,express.express_n_income)),moneyflow.buy_elg_amount)',
                                    'ts_max(sqrt(add(daily_hq.low_hfq,moneyflow.buy_elg_amount)),5)',
                                    'sqrt(ts_var(mul(moneyflow.buy_elg_amount,daily_basic.pb),5))',
                                    'add(sigmoid(ts_max(moneyflow.buy_lg_amount,250)),moneyflow.buy_elg_amount)',
                                    'cs_rank(cs_rank(ts_backward_pct_chg(daily_hq.close,20)))',
                                    'sigmoid(cs_rank(ts_backward_pct_chg(daily_hq.close,20)))',
                                    'ts_var(sqrt(ts_sum(moneyflow.buy_elg_amount,500)),5)',
                                    'add(ts_count(ts_delta(daily_basic.dv_ratio,60),250),moneyflow.buy_elg_amount)',
                                    'add(ts_skew(cs_orthogonalize(moneyflow.buy_md_vol,daily_basic.total_mv),250),ts_max(moneyflow.buy_elg_amount,5))',
                                    'add(ts_count(ts_std(daily_basic.circ_mv,10),5),add(top_list.reason_is_contain_diefu,moneyflow.buy_elg_amount))',
                                    'div(add(add(daily_basic.dv_ratio,factor_adj.adj_factor),moneyflow.buy_lg_amount),moneyflow.sell_sm_vol)',
                                    'cs_orthogonalize(cs_rank(ts_max(moneyflow.buy_elg_amount,5)),ts_mean(ts_delta(moneyflow.buy_md_vol,20),10))',
                                    'inv(abs(div(moneyflow.buy_elg_amount,moneyflow.sell_lg_vol)))',
                                    'ts_var(add(add(top_list.reason_is_contain_diefu,moneyflow.buy_elg_amount),cs_orthogonalize(moneyflow.sell_elg_amount,daily_hq.close_hfq)),10)',
                                    'ts_min(sub(sub(daily_basic.ps,factor_adj.adj_factor),moneyflow.buy_elg_amount),5)',
                                    'sub(inv(div(moneyflow.sell_md_amount,moneyflow.buy_sm_amount)),cs_zscore(sub(moneyflow.sell_lg_amount,daily_hq.open_hfq)))',
                                    'sqrt(ts_std(add(daily_hq.pct_chg,moneyflow.buy_lg_amount),5))',
                                    'mul(inv(cs_orthogonalize(moneyflow.sell_lg_amount,factor_adj.adj_factor)),moneyflow.buy_md_vol)',
                                    'sigmoid(inv(div(moneyflow.buy_lg_vol,moneyflow.buy_elg_amount)))',
                                    'inv(inv(div(moneyflow.buy_lg_vol,moneyflow.buy_elg_amount)))',
                                    'add(log(ts_mean(moneyflow.sell_elg_vol,10)),moneyflow.buy_elg_amount)',
                                    'ts_var(abs(cs_orthogonalize(moneyflow.buy_lg_amount,express.express_total_profit)),5)',
                                    'add(ts_max(add(top_list.reason_is_contain_diefu,moneyflow.buy_elg_amount),10),div(moneyflow.buy_md_amount,moneyflow.sell_lg_amount))',
                                    'mul(sub(add(daily_hq.low_hfq,moneyflow.buy_elg_amount),daily_basic.ps_ttm),ts_sum(daily_hq.close,250))',
                                    'ts_zscore(add(ts_delta(daily_basic.ps,10),daily_hq.close_hfq),120)',
                                    'add(log(log(moneyflow.sell_md_vol)),add(moneyflow.buy_elg_amount,daily_hq.open_hfq))',
                                    'inv(div(add(moneyflow.buy_elg_vol,moneyflow.buy_lg_amount),add(top_list.reason_is_contain_zhangfu,daily_hq.volume)))',
                                    'cs_rank(ts_var(mul(moneyflow.buy_elg_amount,daily_basic.pb),5))',
                                    'sub(abs(ts_mean(moneyflow.buy_elg_amount,5)),sqrt(cs_orthogonalize(moneyflow.buy_lg_vol,daily_basic.pb)))',
                                    'cs_rank(div(cs_rank(moneyflow.buy_md_amount),moneyflow.buy_elg_amount))',
                                    'add(sigmoid(ts_min(daily_basic.pe_ttm,10)),moneyflow.buy_elg_amount)',
                                    'ts_std(ts_var(cs_zscore(daily_hq.pct_chg),5),5)',
                                    'cs_rank(inv(div(moneyflow.buy_lg_vol,moneyflow.buy_elg_amount)))',
                                    'cs_rank(ts_backward_pct_chg(cs_orthogonalize(daily_basic.pb,daily_basic.ps_ttm),10))',
                                    'cs_rank(cs_rank(sqrt(moneyflow.buy_elg_amount)))',
                                    'cs_rank(inv(cs_rank(moneyflow.buy_elg_amount)))',
                                    'cs_zscore(ts_mean(sub(express.express_diluted_roe,daily_hq.pct_chg),20))',
                                    'ts_var(sub(cs_orthogonalize(moneyflow.buy_lg_amount,express.express_total_profit),ts_mean(moneyflow.buy_lg_amount,5)),5)',
                                    'ts_std(add(mul(daily_basic.volume,daily_hq.amount),daily_basic.turnover_rate_f),5)',
                                    'ts_std(abs(ts_zscore(moneyflow.buy_elg_vol,250)),5)',
                                    'ts_backward_pct_chg(log(sigmoid(daily_hq.close)),10)',
                                    'sub(cs_rank(ts_delta(moneyflow.sell_elg_amount,5)),moneyflow.buy_elg_amount)',
                                    'cs_rank(cs_orthogonalize(sqrt(moneyflow.buy_elg_amount),express.express_diluted_roe))',
                                    'ts_max(ts_zscore(add(top_list.reason_is_contain_diefu,moneyflow.buy_elg_vol),120),10)',
                                    'ts_var(sqrt(ts_mean(moneyflow.buy_elg_amount,5)),10)',
                                    'abs(sqrt(inv(moneyflow.buy_elg_amount)))',
                                    'ts_var(cs_orthogonalize(mul(daily_hq.amount,daily_basic.volume),express.express_total_hldr_eqy_exc_min_int),5)',
                                    'ts_max(cs_rank(ts_cov(daily_hq.pct_chg,moneyflow.buy_elg_amount,10)),10)',
                                    'ts_min(sigmoid(sub(moneyflow.buy_sm_amount,moneyflow.buy_elg_amount)),10)',
                                    'sub(inv(ts_std(moneyflow.sell_md_amount,120)),cs_zscore(ts_std(moneyflow.buy_lg_amount,5)))',
                                    'ts_var(add(ts_delta(moneyflow.buy_elg_amount,500),ts_count(daily_hq.open_hfq,5)),10)',
                                    'add(div(ts_cov(moneyflow.sell_lg_vol,daily_basic.turnover_rate,5),add(moneyflow.buy_sm_amount,moneyflow.buy_lg_amount)),moneyflow.buy_elg_amount)',
                                    'cs_zscore(cs_zscore(ts_mean(daily_hq.pct_chg,5)))',
                                    'log(inv(div(daily_hq.volume,moneyflow.buy_elg_amount)))',
                                    'inv(abs(div(daily_hq.volume,moneyflow.buy_elg_amount)))',
                                    'inv(div(cs_rank(moneyflow.buy_md_amount),moneyflow.buy_elg_amount))',
                                    'sqrt(div(cs_rank(moneyflow.buy_md_amount),moneyflow.buy_elg_amount))',
                                    'add(cs_zscore(ts_sum(daily_hq.close,250)),ts_zscore(moneyflow.buy_elg_vol,500))',
                                    'mul(ts_count(ts_delay(daily_hq.close,20),5),sub(daily_basic.turnover_rate,moneyflow.buy_elg_amount))',
                                    'cs_orthogonalize(ts_max(cs_orthogonalize(daily_hq.pct_chg,daily_basic.dv_ratio),10),ts_delay(daily_basic.volume,5))',
                                    'cs_orthogonalize(cs_rank(div(moneyflow.buy_lg_vol,moneyflow.buy_elg_amount)),daily_basic.free_share)',
                                    'inv(cs_rank(ts_zscore(daily_hq.high_hfq,20)))',
                                    'abs(cs_rank(ts_zscore(daily_hq.high_hfq,20)))',
                                    'ts_cov(ts_zscore(sub(top_list.reason_is_contain_zhangfu,moneyflow.sell_md_amount),250),daily_hq.pct_chg,10)',
                                    'log(ts_std(add(moneyflow.sell_lg_amount,daily_basic.turnover_rate_f),5))',
                                    'abs(ts_std(add(moneyflow.sell_lg_amount,daily_basic.turnover_rate_f),5))',
                                    'abs(ts_var(add(moneyflow.sell_lg_amount,daily_basic.pe_ttm),5))',
                                    'inv(sigmoid(div(moneyflow.buy_elg_amount,moneyflow.sell_sm_amount)))',
                                    'add(abs(div(moneyflow.buy_lg_amount,daily_hq.amount)),moneyflow.buy_elg_amount)',
                                    'cs_zscore(ts_backward_pct_chg(sub(daily_basic.total_mv,moneyflow.net_mf_amount),20))',
                                    'cs_zscore(ts_backward_pct_chg(add(express.express_diluted_eps,daily_basic.circ_mv),20))',
                                    'cs_zscore(ts_backward_pct_chg(sub(daily_basic.ps_ttm,daily_basic.total_mv),20))',
                                    'inv(sigmoid(ts_zscore(daily_hq.close_hfq,120)))',
                                    'cs_rank(add(ts_delta(daily_hq.pct_chg,60),ts_var(moneyflow.buy_elg_amount,20)))',
                                    'sub(abs(div(daily_hq.volume,moneyflow.buy_elg_amount)),ts_kurt(ts_backward_pct_chg(daily_basic.ps_ttm,5),250))',
                                    'sigmoid(cs_rank(ts_var(moneyflow.buy_elg_amount,20)))',
                                    'sub(ts_var(ts_delta(moneyflow.buy_elg_amount,10),10),ts_delta(cs_orthogonalize(moneyflow.buy_sm_amount,express.express_operate_profit),120))',
                                    'mul(cs_rank(ts_zscore(daily_basic.total_mv,250)),sigmoid(div(moneyflow.buy_elg_amount,daily_hq.close)))',
                                    'ts_zscore(add(ts_delta(daily_basic.ps,10),daily_hq.close_hfq),20)',
                                    'add(ts_std(sub(daily_basic.turnover_rate,moneyflow.buy_md_amount),5),add(ts_var(daily_hq.amount,5),mul(moneyflow.buy_elg_vol,moneyflow.sell_sm_amount)))',
                                    'cs_rank(ts_zscore(log(daily_hq.high_hfq),120))',
                                    'sqrt(sqrt(add(moneyflow.buy_elg_amount,daily_hq.close)))',
                                    'add(add(mul(daily_hq.close,moneyflow.buy_elg_amount),ts_count(daily_basic.pb,10)),express.express_total_assets)',
                                    'sigmoid(cs_rank(div(moneyflow.buy_lg_amount,moneyflow.buy_sm_amount)))',
                                    'log(add(mul(daily_hq.close,moneyflow.buy_elg_amount),ts_count(daily_basic.pb,10)))',
                                    'cs_zscore(sigmoid(ts_zscore(daily_hq.close,120)))',
                                    'sqrt(ts_std(ts_cov(daily_hq.amount,moneyflow.buy_elg_vol,5),5))',
                                    'sub(ts_var(cs_orthogonalize(daily_hq.amount,express.express_total_assets),5),ts_median(ts_var(moneyflow.buy_lg_amount,5),500))',
                                    'mul(div(sub(daily_hq.volume,express.express_n_income),ts_var(moneyflow.buy_elg_amount,10)),cs_orthogonalize(ts_corr(moneyflow.buy_sm_vol,moneyflow.buy_lg_vol,120),moneyflow.buy_md_vol))',
                                    'ts_delta(cs_zscore(sqrt(daily_hq.close_hfq)),20)',
                                    'inv(ts_var(cs_orthogonalize(moneyflow.buy_elg_amount,daily_basic.free_share),5))',
                                    'cs_rank(ts_backward_pct_chg(mul(daily_hq.low_hfq,daily_hq.close),20))',
                                    'abs(div(cs_orthogonalize(moneyflow.buy_sm_vol,moneyflow.buy_lg_amount),moneyflow.buy_md_amount))',
                                    'ts_var(cs_zscore(cs_orthogonalize(daily_hq.amount,express.express_diluted_eps)),10)',
                                    'ts_zscore(log(cs_rank(daily_hq.close)),10)',
                                    'cs_rank(ts_delta(cs_rank(daily_basic.total_mv),20))',
                                    'ts_var(add(sub(top_list.reason_is_contain_zhangfu,daily_hq.amount),express.express_yoy_net_profit),5)',
                                    'add(ts_max(mul(daily_basic.volume,daily_hq.pct_chg),20),ts_zscore(daily_hq.amount,250))',
                                    'cs_rank(ts_mean(mul(daily_hq.pct_chg,moneyflow.sell_md_amount),5))',
                                    'ts_zscore(cs_zscore(add(daily_basic.free_share,daily_basic.circ_mv)),20)',
                                    'sqrt(ts_std(cs_orthogonalize(moneyflow.buy_elg_amount,express.express_n_income),20))',
                                    'ts_zscore(cs_zscore(sub(daily_basic.circ_mv,moneyflow.sell_lg_vol)),20)',
                                    'ts_zscore(cs_zscore(sub(daily_hq.low_hfq,daily_basic.total_mv)),20)',
                                    'sqrt(ts_max(div(moneyflow.buy_lg_amount,moneyflow.buy_md_amount),5))',
                                    'sub(abs(ts_std(moneyflow.buy_md_amount,20)),ts_var(moneyflow.buy_elg_amount,20))',
                                    'ts_mean(cs_zscore(mul(moneyflow.sell_md_amount,daily_hq.pct_chg)),10)',
                                    'cs_orthogonalize(cs_zscore(ts_backward_pct_chg(daily_basic.circ_mv,5)),express.express_operate_profit)',
                                    'div(ts_std(sub(moneyflow.buy_lg_vol,moneyflow.sell_lg_amount),20),moneyflow.buy_elg_amount)',
                                    'inv(div(sqrt(daily_basic.turnover_rate_f),mul(moneyflow.buy_elg_amount,daily_basic.turnover_rate_f)))',
                                    'abs(div(sqrt(daily_basic.turnover_rate_f),mul(moneyflow.buy_elg_amount,daily_basic.turnover_rate_f)))',
                                    'cs_zscore(ts_sum(sqrt(moneyflow.buy_elg_amount),5))',
                                    'sigmoid(sqrt(ts_std(moneyflow.buy_elg_amount,20)))',
                                    'mul(inv(add(daily_basic.free_share,daily_basic.circ_mv)),ts_var(mul(moneyflow.sell_elg_amount,moneyflow.buy_elg_amount),5))',
                                    'ts_var(sigmoid(cs_zscore(moneyflow.sell_lg_amount)),5)',
                                    'sigmoid(ts_mean(div(moneyflow.buy_elg_vol,moneyflow.sell_sm_vol),10))',
                                    'cs_rank(ts_std(add(moneyflow.sell_lg_amount,daily_basic.turnover_rate_f),5))',
                                    'cs_rank(div(mul(daily_hq.amount,moneyflow.sell_lg_amount),moneyflow.sell_sm_vol))',
                                    'cs_zscore(sigmoid(ts_backward_pct_chg(daily_basic.ps,5)))',
                                    'ts_backward_pct_chg(div(inv(daily_basic.circ_mv),cs_rank(daily_hq.open_hfq)),10)',
                                    'ts_backward_pct_chg(sqrt(abs(daily_basic.total_mv)),10)',
                                    'ts_backward_pct_chg(inv(sub(moneyflow.sell_lg_vol,daily_basic.circ_mv)),10)',
                                    'ts_backward_pct_chg(sub(sqrt(daily_basic.circ_mv),daily_basic.volume),10)',
                                    'add(ts_max(div(daily_basic.free_share,daily_basic.circ_mv),60),sqrt(ts_cov(daily_basic.turnover_rate,moneyflow.buy_elg_amount,5)))',
                                    'cs_rank(log(ts_var(moneyflow.sell_elg_amount,5)))',
                                    'ts_mean(ts_corr(add(moneyflow.buy_elg_amount,moneyflow.buy_md_vol),moneyflow.buy_md_vol,20),10)',
                                    'sigmoid(sub(ts_zscore(daily_hq.close,20),top_list.reason_is_contain_diefu))',
                                    'sub(ts_mean(ts_count(daily_hq.low_hfq,20),120),moneyflow.buy_elg_amount)',
                                    'ts_backward_pct_chg(add(add(express.express_operate_profit,daily_basic.volume),daily_basic.total_mv),10)',
                                    'sigmoid(cs_zscore(ts_max(moneyflow.buy_elg_amount,20)))',
                                    'ts_sum(abs(div(moneyflow.buy_elg_amount,daily_basic.float_share)),5)',
                                    'mul(ts_min(div(daily_hq.open_hfq,moneyflow.buy_lg_amount),20),moneyflow.buy_elg_amount)',
                                    'mul(ts_max(add(moneyflow.buy_elg_vol,express.express_operate_profit),10),moneyflow.buy_elg_amount)',
                                    'ts_backward_pct_chg(log(add(daily_basic.circ_mv,moneyflow.sell_md_amount)),10)',
                                    'ts_std(cs_zscore(sub(daily_hq.amount,express.express_operate_profit)),5)',
                                    'inv(add(ts_delta(daily_hq.pct_chg,60),ts_var(moneyflow.buy_elg_amount,20)))',
                                    'cs_rank(log(add(moneyflow.buy_elg_amount,daily_hq.high_hfq)))',
                                    'cs_rank(inv(add(moneyflow.buy_elg_amount,daily_hq.high_hfq)))',
                                    'cs_zscore(cs_rank(mul(daily_hq.close,moneyflow.buy_elg_amount)))',
                                    'ts_max(ts_zscore(cs_orthogonalize(daily_hq.pct_chg,factor_adj.adj_factor),120),20)',
                                    'sub(cs_zscore(sub(daily_hq.open_hfq,moneyflow.buy_elg_vol)),ts_backward_pct_chg(abs(daily_hq.open_hfq),10))',
                                    'sqrt(ts_var(ts_var(moneyflow.sell_elg_amount,5),5))',
                                    'sub(cs_zscore(ts_mean(moneyflow.sell_elg_amount,60)),moneyflow.buy_elg_amount)',
                                    'mul(sigmoid(ts_zscore(daily_basic.total_mv,20)),sigmoid(daily_hq.low_hfq))',
                                    'sigmoid(inv(mul(moneyflow.buy_elg_amount,moneyflow.sell_sm_amount)))',
                                    'ts_zscore(add(mul(daily_basic.circ_mv,daily_hq.close_hfq),daily_basic.ps_ttm),120)',
                                    'div(mul(div(moneyflow.buy_elg_amount,moneyflow.sell_sm_amount),mul(moneyflow.buy_sm_amount,daily_basic.pb)),moneyflow.sell_md_vol)',
                                    'ts_zscore(add(add(daily_basic.total_mv,moneyflow.buy_sm_amount),add(moneyflow.buy_sm_amount,daily_hq.high_hfq)),20)',
                                    'sqrt(sigmoid(ts_zscore(daily_basic.circ_mv,20)))',
                                    'ts_zscore(add(add(daily_hq.close,daily_basic.circ_mv),ts_delta(daily_hq.pct_chg,120)),20)',
                                    'ts_sum(cs_zscore(cs_zscore(moneyflow.buy_elg_amount)),10)',
                                    'cs_orthogonalize(cs_zscore(ts_backward_pct_chg(daily_basic.total_mv,5)),sub(express.express_total_assets,top_list.reason_is_contain_zhangfu))',
                                    'add(ts_zscore(cs_orthogonalize(daily_hq.close,daily_basic.ps_ttm),250),mul(daily_basic.total_mv,moneyflow.buy_elg_amount))',
                                    'div(ts_mean(sub(moneyflow.buy_sm_amount,moneyflow.buy_lg_amount),20),ts_var(moneyflow.sell_sm_amount,5))',
                                    'ts_std(abs(cs_orthogonalize(moneyflow.buy_lg_amount,express.express_total_profit)),10)',
                                    'ts_zscore(cs_rank(cs_orthogonalize(daily_basic.circ_mv,daily_basic.total_share)),60)',
                                    'add(ts_sum(ts_min(moneyflow.buy_lg_vol,250),5),ts_var(moneyflow.buy_lg_amount,10))',
                                    'ts_max(sub(ts_delta(moneyflow.sell_elg_vol,5),cs_orthogonalize(moneyflow.buy_sm_vol,daily_hq.amount)),20)',
                                    'abs(cs_rank(div(moneyflow.buy_elg_amount,daily_basic.volume)))',
                                    'abs(inv(div(moneyflow.buy_elg_vol,moneyflow.sell_md_vol)))',
                                    'inv(inv(div(moneyflow.buy_elg_vol,moneyflow.sell_md_vol)))',
                                    'ts_zscore(abs(add(daily_hq.volume,daily_basic.circ_mv)),20)',
                                    'mul(ts_max(cs_zscore(daily_hq.pct_chg),20),daily_hq.high_hfq)',
                                    'add(cs_zscore(sub(daily_hq.volume,daily_hq.high_hfq)),add(moneyflow.buy_elg_amount,daily_hq.high_hfq))',
                                    'cs_rank(ts_var(ts_mean(moneyflow.buy_elg_amount,10),5))',
                                    'cs_rank(ts_zscore(sqrt(daily_hq.close_hfq),500))',
                                    'inv(ts_var(mul(moneyflow.buy_md_amount,daily_basic.volume),5))',
                                    'abs(ts_std(ts_std(moneyflow.sell_md_amount,5),5))',
                                    'log(ts_std(ts_std(moneyflow.sell_md_amount,5),5))',
                                    'add(cs_rank(ts_median(moneyflow.buy_sm_amount,5)),sqrt(ts_var(moneyflow.sell_md_amount,5)))',
                                    'ts_max(ts_delta(add(moneyflow.sell_elg_amount,daily_hq.amount),5),10)',
                                    'sigmoid(cs_zscore(ts_sum(moneyflow.buy_elg_amount,10)))',
                                    'abs(sqrt(add(daily_hq.low_hfq,moneyflow.buy_elg_amount)))',
                                    'sub(ts_max(ts_count(daily_basic.free_share,120),5),moneyflow.buy_elg_amount)',
                                    'sub(ts_count(abs(daily_basic.pb),120),moneyflow.buy_elg_amount)',
                                    'cs_orthogonalize(sqrt(add(daily_hq.low_hfq,moneyflow.buy_elg_amount)),ts_sum(mul(daily_basic.ps_ttm,moneyflow.buy_elg_vol),5))',
                                    'log(div(ts_var(moneyflow.buy_elg_amount,5),daily_basic.ps))',
                                    'inv(cs_rank(ts_var(moneyflow.buy_lg_amount,10)))',
                                    'inv(cs_rank(ts_zscore(daily_basic.ps_ttm,20)))',
                                    'sigmoid(cs_rank(ts_std(moneyflow.sell_elg_amount,5)))',
                                    'ts_delta(sqrt(sub(daily_basic.total_mv,daily_basic.turnover_rate)),10)',
                                    'sqrt(abs(ts_var(moneyflow.sell_elg_amount,5)))',
                                    'sqrt(abs(div(moneyflow.buy_md_vol,moneyflow.buy_elg_vol)))',
                                    'abs(sub(ts_mean(moneyflow.buy_elg_amount,5),div(moneyflow.sell_elg_vol,daily_basic.total_share)))',
                                    'div(add(mul(moneyflow.sell_elg_amount,daily_hq.volume),add(daily_basic.total_share,daily_hq.close_hfq)),moneyflow.buy_sm_vol)',
                                    'inv(cs_rank(add(daily_basic.pb,moneyflow.buy_elg_amount)))',
                                    'add(abs(div(moneyflow.buy_lg_amount,daily_hq.amount)),sub(add(express.express_total_profit,daily_basic.ps_ttm),moneyflow.buy_elg_amount))',
                                    'add(ts_std(ts_zscore(moneyflow.buy_lg_amount,20),5),moneyflow.buy_elg_amount)',
                                    'add(cs_orthogonalize(sub(moneyflow.sell_lg_amount,daily_basic.turnover_rate_f),sub(daily_basic.dv_ttm,moneyflow.buy_sm_vol)),ts_cov(daily_hq.open_hfq,daily_basic.turnover_rate_f,5))',
                                    'sqrt(div(sqrt(moneyflow.sell_md_vol),daily_hq.amount))',
                                    'sqrt(div(div(daily_basic.turnover_rate_f,moneyflow.sell_lg_amount),mul(daily_hq.close,daily_basic.turnover_rate_f)))',
                                    'ts_backward_pct_chg(mul(sub(express.express_revenue,daily_basic.pb),ts_sum(daily_basic.ps_ttm,120)),10)',
                                    'ts_var(cs_zscore(ts_zscore(moneyflow.buy_lg_amount,500)),10)',
                                    'ts_max(mul(mul(moneyflow.sell_elg_amount,daily_basic.volume),daily_basic.turnover_rate_f),10)',
                                    'cs_orthogonalize(cs_rank(ts_zscore(daily_basic.pb,60)),ts_delta(ts_var(daily_basic.total_mv,10),20))',
                                    'sqrt(inv(ts_std(moneyflow.sell_md_amount,5)))',
                                    'sub(cs_zscore(sub(moneyflow.buy_lg_amount,daily_basic.pe_ttm)),ts_std(moneyflow.sell_md_amount,5))',
                                    'inv(cs_rank(ts_var(moneyflow.sell_elg_amount,5)))',
                                    'cs_rank(ts_zscore(add(top_list.reason_is_contain_zhangfu,daily_basic.total_mv),250))',
                                    'inv(ts_std(add(moneyflow.sell_md_amount,daily_basic.pe_ttm),5))',
                                    'abs(ts_std(add(moneyflow.sell_md_amount,daily_basic.pe_ttm),5))',
                                    'ts_zscore(sqrt(cs_orthogonalize(daily_hq.close,daily_basic.total_share)),60)',
                                    'mul(cs_rank(ts_max(daily_hq.pct_chg,20)),moneyflow.sell_lg_amount)',
                                    'ts_zscore(abs(sub(daily_basic.ps_ttm,daily_hq.close_hfq)),60)',
                                    'add(cs_zscore(ts_var(moneyflow.buy_lg_amount,5)),ts_mean(mul(moneyflow.sell_elg_amount,daily_basic.volume),10))',
                                    'ts_var(sqrt(mul(moneyflow.sell_elg_amount,moneyflow.sell_elg_amount)),5)',
                                    'inv(ts_max(add(moneyflow.sell_elg_amount,moneyflow.buy_lg_amount),10))',
                                    'ts_backward_pct_chg(cs_rank(sub(daily_basic.circ_mv,moneyflow.net_mf_vol)),20)',
                                    'inv(sigmoid(div(moneyflow.buy_md_vol,moneyflow.buy_elg_vol)))',
                                    'cs_rank(ts_max(add(moneyflow.sell_elg_amount,moneyflow.buy_lg_amount),10))',
                                    'inv(ts_var(mul(daily_hq.close,moneyflow.buy_elg_amount),5))',
                                    'ts_mean(sub(div(daily_hq.close_hfq,daily_basic.total_share),moneyflow.buy_elg_amount),5)',
                                    'cs_zscore(cs_rank(mul(daily_basic.turnover_rate,moneyflow.buy_elg_amount)))',
                                    'sub(cs_rank(sub(express.express_diluted_eps,moneyflow.sell_sm_vol)),ts_max(moneyflow.buy_lg_amount,5))',
                                    'log(ts_var(mul(moneyflow.sell_sm_amount,moneyflow.sell_elg_amount),5))',
                                    'mul(abs(ts_cov(daily_basic.turnover_rate,moneyflow.buy_elg_amount,5)),daily_hq.amount)',
                                    'cs_rank(ts_zscore(abs(daily_hq.low_hfq),60))',
                                    'cs_zscore(ts_std(sqrt(moneyflow.sell_md_amount),5))',
                                    'cs_rank(ts_mean(sub(express.express_yoy_net_profit,daily_hq.pct_chg),20))',
                                    'div(ts_sum(sub(moneyflow.buy_sm_vol,moneyflow.buy_lg_vol),60),daily_basic.circ_mv)',
                                    'cs_zscore(ts_zscore(cs_orthogonalize(daily_basic.ps,daily_basic.free_share),20))',
                                    'ts_max(ts_delta(add(daily_basic.total_share,daily_hq.high_hfq),5),5)',
                                    'add(cs_rank(ts_delay(moneyflow.sell_elg_amount,250)),div(daily_basic.total_share,moneyflow.buy_elg_amount))',
                                    'ts_var(add(mul(top_list.reason_is_contain_zhangfu,daily_basic.circ_mv),add(moneyflow.sell_lg_amount,daily_basic.pe_ttm)),5)',
                                    'sub(ts_mean(mul(moneyflow.sell_elg_amount,daily_basic.volume),10),sigmoid(cs_zscore(moneyflow.sell_elg_amount)))',
                                    'log(sub(add(moneyflow.sell_md_amount,moneyflow.sell_elg_amount),add(moneyflow.buy_md_amount,express.express_total_profit)))',
                                    'ts_delta(sqrt(sub(daily_basic.total_mv,express.express_total_hldr_eqy_exc_min_int)),10)',
                                    'log(mul(ts_max(daily_hq.close,5),ts_cov(moneyflow.sell_md_amount,daily_basic.pb,5)))']
