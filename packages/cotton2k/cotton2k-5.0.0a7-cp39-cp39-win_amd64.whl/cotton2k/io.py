...
def read_input(path: Union[Path, str, dict, Profile], session=None) -> Simulation:
        ...
        kwargs = {
            ...
            "soil": {
                "initial": [
                    ...
                    for layer in profile.site.soil
                ],
                "hydrology": {
                    ...
                    "layers": [
                        ...
                        for layer in profile.site.soil_hydrology
                    ],
                },
            },
    ...
    sim = Simulation(kwargs.pop("id", 0), kwargs.pop("version", 0x0400), **kwargs)  # type: ignore[arg-type]
    ...
    sim.climate = Climate(climate_start_date, kwargs.pop("climate"))[sim.start_date :]  # type: ignore[misc]
    return sim
