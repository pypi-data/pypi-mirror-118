...
class THdfsTableSink(object):
    ...
    def __init__(self, partition_key_exprs=None, overwrite=None, skip_header_line_count=None, input_is_clustered=None, sort_columns=None, write_id=None, sorting_order=None, is_result_sink=False, external_output_dir=None, external_output_partition_depth=None,):
