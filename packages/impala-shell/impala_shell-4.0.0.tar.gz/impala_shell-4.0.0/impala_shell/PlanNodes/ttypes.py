...
class TRuntimeFilterTargetDesc(object):
    ...
    def __init__(self, node_id=None, target_expr=None, is_bound_by_partition_columns=None, target_expr_slotids=None, is_local_target=None, kudu_col_name=None, kudu_col_type=None, low_value=None, high_value=None,):
