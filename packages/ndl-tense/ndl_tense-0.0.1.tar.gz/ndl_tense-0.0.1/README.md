...
From a terminal, type "pip install ndl_tense".
":$ pip install ndl_tense"
...
## pipeline
---------------------------------------------------
Step-by-step guide to run the code for preparing 
the data of the English tense project

Originally by Adnane Ez-zizi, 06/08/2020,
Adapted by Tekevwe Kwakpovwe, 08/2021
---------------------------------------------------
