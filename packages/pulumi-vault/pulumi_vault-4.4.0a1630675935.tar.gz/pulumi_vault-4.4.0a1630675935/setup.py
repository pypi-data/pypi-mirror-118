...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'vault', '4.4.0-alpha.1630675935+ef6ad6f2'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource vault 4.4.0-alpha.1630675935+ef6ad6f2`
                """)
            else:
                raise
