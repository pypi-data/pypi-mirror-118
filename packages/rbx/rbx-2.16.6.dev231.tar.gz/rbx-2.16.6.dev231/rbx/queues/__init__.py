...
class Queue:
    ...
    def enqueue(self, function, *args, enqueue_in=None, **kwargs):
        ...
        with warnings.catch_warnings():
            ...
            if enqueue_in and isinstance(enqueue_in, int):
                logger.debug(f'Job queued in {enqueue_in}s: {function}, {args}, {kwargs}')
                return self.queue.enqueue_in(timedelta(enqueue_in), function, *args, **kwargs)
            else:
