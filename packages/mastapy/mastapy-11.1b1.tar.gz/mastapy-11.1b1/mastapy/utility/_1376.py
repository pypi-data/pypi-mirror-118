...
class SystemDirectoryPopulator(_0.APIBase):
    ...
    @property
    def version_to_copy(self) -> '_1375.SystemDirectory':
        ...
        return constructor.new(_1375.SystemDirectory)(self.wrapped.VersionToCopy) if self.wrapped.VersionToCopy else None

    @property
    def current_version(self) -> '_1375.SystemDirectory':
        ...
        return constructor.new(_1375.SystemDirectory)(self.wrapped.CurrentVersion) if self.wrapped.CurrentVersion else None
