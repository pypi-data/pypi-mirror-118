...
from mastapy.utility import _1373
...
class MeasurementBase(_0.APIBase):
    ...
    @property
    def rounding_method(self) -> '_1373.RoundingMethods':
        ...
        return constructor.new(_1373.RoundingMethods)(value) if value else None

    @rounding_method.setter
    def rounding_method(self, value: '_1373.RoundingMethods'):
    ...
    def current_unit(self) -> '_1385.Unit':
        ...
        if _1385.Unit.TYPE not in self.wrapped.CurrentUnit.__class__.__mro__:
