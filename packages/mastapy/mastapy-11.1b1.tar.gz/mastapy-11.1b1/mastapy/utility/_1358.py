...
from mastapy.utility import _1368, _1357
...
class EnvironmentSummary(_0.APIBase):
    ...
    @property
    def current_culture(self) -> '_1368.NumberFormatInfoSummary':
        ...
        return constructor.new(_1368.NumberFormatInfoSummary)(self.wrapped.CurrentCulture) if self.wrapped.CurrentCulture else None

    @property
    def dispatchers(self) -> 'List[_1357.DispatcherHelper]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Dispatchers, constructor.new(_1357.DispatcherHelper))
        return value
