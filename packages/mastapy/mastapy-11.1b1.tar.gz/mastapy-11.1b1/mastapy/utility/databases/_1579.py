...
from mastapy.utility.databases import _1577, _1574, _1573
...
TKey = TypeVar('TKey', bound='_1574.DatabaseKey')
TValue = TypeVar('TValue', bound='_0.APIBase')


class SQLDatabase(_1573.Database['TKey', 'TValue'], Generic[TKey, TValue]):
    '''SQLDatabase
    ...
    def save(self, item: '_1577.NamedDatabaseItem'):
    ...
    def delete(self, key: '_1574.DatabaseKey'):
