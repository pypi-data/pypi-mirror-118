...
from mastapy.utility.databases import _1577, _1579, _1578
...
TValue = TypeVar('TValue', bound='_1577.NamedDatabaseItem')


class NamedDatabase(_1579.SQLDatabase['_1578.NamedKey', 'TValue'], Generic[TValue]):
    '''NamedDatabase
    ...
    def rename(self, item: '_1577.NamedDatabaseItem', new_name: 'str') -> 'bool':
    ...
    def duplicate(self, new_name: 'str', item: '_1577.NamedDatabaseItem') -> '_1577.NamedDatabaseItem':
