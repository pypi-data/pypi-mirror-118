...
from mastapy.utility.report import _1539, _1532
...
class UserTextRow(_1532.CustomRow):
    '''UserTextRow
    ...
    @property
    def heading_size(self) -> '_1539.HeadingSize':
        '''HeadingSize: 'HeadingSize' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.HeadingSize)
        return constructor.new(_1539.HeadingSize)(value) if value else None

    @heading_size.setter
    def heading_size(self, value: '_1539.HeadingSize'):
