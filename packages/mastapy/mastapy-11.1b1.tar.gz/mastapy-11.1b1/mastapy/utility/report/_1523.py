...
from mastapy.utility.report import _1524, _1527
...
TItem = TypeVar('TItem', bound='_1527.CustomReportPropertyItem')


class CustomReportMultiPropertyItem(_1524.CustomReportMultiPropertyItemBase, Generic[TItem]):
    '''CustomReportMultiPropertyItem
