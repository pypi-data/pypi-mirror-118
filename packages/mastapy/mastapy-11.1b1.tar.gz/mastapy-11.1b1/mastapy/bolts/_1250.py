...
from mastapy.bolts import _1265, _1246
...
class BoltMaterial(_1246.BoltedJointMaterial):
    '''BoltMaterial
    ...
    @property
    def strength_grade(self) -> '_1265.StrengthGrades':
        ...
        return constructor.new(_1265.StrengthGrades)(value) if value else None

    @strength_grade.setter
    def strength_grade(self, value: '_1265.StrengthGrades'):
