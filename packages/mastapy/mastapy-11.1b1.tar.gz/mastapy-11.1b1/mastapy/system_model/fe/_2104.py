...
class IndependentMastaCreatedCondensationNode(_0.APIBase):
    ...
    @property
    def fe_substructure_node(self) -> '_2093.FESubstructureNode':
        ...
        return constructor.new(_2093.FESubstructureNode)(self.wrapped.FESubstructureNode) if self.wrapped.FESubstructureNode else None
