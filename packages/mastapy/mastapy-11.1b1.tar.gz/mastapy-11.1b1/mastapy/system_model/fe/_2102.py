...
from mastapy.system_model.fe import _2108, _2098
...
class FESubstructureWithSelectionForStaticAnalysis(_2098.FESubstructureWithSelection):
    '''FESubstructureWithSelectionForStaticAnalysis
    ...
    @property
    def boundary_conditions_selected_nodes(self) -> 'List[_2108.NodeBoundaryConditionStaticAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BoundaryConditionsSelectedNodes, constructor.new(_2108.NodeBoundaryConditionStaticAnalysis))
        return value

    @property
    def boundary_conditions_all_nodes(self) -> 'List[_2108.NodeBoundaryConditionStaticAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BoundaryConditionsAllNodes, constructor.new(_2108.NodeBoundaryConditionStaticAnalysis))
        return value

    @property
    def force_results(self) -> 'List[_1345.VectorWithLinearAndAngularComponents]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ForceResults, constructor.new(_1345.VectorWithLinearAndAngularComponents))
        return value

    @property
    def displacement_results(self) -> 'List[_1345.VectorWithLinearAndAngularComponents]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DisplacementResults, constructor.new(_1345.VectorWithLinearAndAngularComponents))
        return value
