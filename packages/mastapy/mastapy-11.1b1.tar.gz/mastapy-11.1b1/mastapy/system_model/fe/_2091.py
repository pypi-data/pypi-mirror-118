...
from mastapy.system_model.fe import (
    _2071, _2096, _2119, _2065,
    _2067, _2092, _2117, _2093,
    _2089, _2103, _2104, _2102,
    _2099, _2100, _2101
)
from mastapy._internal.python_net import python_net_import
from mastapy.system_model.part_model import _2157, _2153, _2161
...
from mastapy.system_model.fe.links import _2126
...
class FESubstructure(_62.FEStiffness):
    ...
    @property
    def bearing_node_alignment(self) -> '_2071.BearingNodeAlignmentOption':
        ...
        return constructor.new(_2071.BearingNodeAlignmentOption)(value) if value else None

    @bearing_node_alignment.setter
    def bearing_node_alignment(self, value: '_2071.BearingNodeAlignmentOption'):
    ...
    @property
    def alignment_method(self) -> '_2065.AlignmentMethod':
        ...
        return constructor.new(_2065.AlignmentMethod)(value) if value else None

    @alignment_method.setter
    def alignment_method(self, value: '_2065.AlignmentMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def alignment_to_component(self) -> '_1933.RelativeComponentAlignment[_2153.Component]':
        ...
        return constructor.new(_1933.RelativeComponentAlignment)[_2153.Component](self.wrapped.AlignmentToComponent) if self.wrapped.AlignmentToComponent else None

    @property
    def alignment_using_axial_node_positions(self) -> '_2067.AlignmentUsingAxialNodePositions':
        ...
        return constructor.new(_2067.AlignmentUsingAxialNodePositions)(self.wrapped.AlignmentUsingAxialNodePositions) if self.wrapped.AlignmentUsingAxialNodePositions else None

    @property
    def coordinate_system(self) -> '_1279.CoordinateSystem3D':
        ...
        return constructor.new(_1279.CoordinateSystem3D)(self.wrapped.CoordinateSystem) if self.wrapped.CoordinateSystem else None

    @property
    def export(self) -> '_2092.FESubstructureExportOptions':
        ...
        return constructor.new(_2092.FESubstructureExportOptions)(self.wrapped.Export) if self.wrapped.Export else None
    ...
    @property
    def shafts_that_can_be_replaced(self) -> 'List[_2117.ReplacedShaftSelectionHelper]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftsThatCanBeReplaced, constructor.new(_2117.ReplacedShaftSelectionHelper))
        return value

    @property
    def nodes(self) -> 'List[_2093.FESubstructureNode]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Nodes, constructor.new(_2093.FESubstructureNode))
        return value

    @property
    def replaced_shafts(self) -> 'List[_2190.Shaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ReplacedShafts, constructor.new(_2190.Shaft))
        return value

    @property
    def links(self) -> 'List[_2126.FELink]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Links, constructor.new(_2126.FELink))
        return value

    @property
    def thermal_expansion_forces(self) -> 'List[_1345.VectorWithLinearAndAngularComponents]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ThermalExpansionForces, constructor.new(_1345.VectorWithLinearAndAngularComponents))
        return value

    @property
    def thermal_expansion_displacements(self) -> 'List[_1345.VectorWithLinearAndAngularComponents]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ThermalExpansionDisplacements, constructor.new(_1345.VectorWithLinearAndAngularComponents))
        return value

    @property
    def geometries(self) -> 'List[_2089.FEStiffnessGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Geometries, constructor.new(_2089.FEStiffnessGeometry))
        return value

    @property
    def gear_meshing_options(self) -> 'List[_2103.GearMeshingOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearMeshingOptions, constructor.new(_2103.GearMeshingOptions))
        return value

    @property
    def independent_masta_created_condensation_nodes(self) -> 'List[_2104.IndependentMastaCreatedCondensationNode]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.IndependentMastaCreatedCondensationNodes, constructor.new(_2104.IndependentMastaCreatedCondensationNode))
        return value

    @property
    def fe_part(self) -> '_2161.FEPart':
        ...
        return constructor.new(_2161.FEPart)(self.wrapped.FEPart) if self.wrapped.FEPart else None
    ...
    def load_existing_masta_fe_file_with_progress(self, file_name: 'str', progress: '_7242.TaskProgress'):
        ''' 'LoadExistingMastaFEFile' is the original name of this method.
    ...
    def create_fe_substructure_with_selection_for_static_analysis(self) -> '_2102.FESubstructureWithSelectionForStaticAnalysis':
    ...
    def create_fe_substructure_with_selection_components(self) -> '_2099.FESubstructureWithSelectionComponents':
    ...
    def create_fe_substructure_with_selection_for_harmonic_analysis(self) -> '_2100.FESubstructureWithSelectionForHarmonicAnalysis':
    ...
    def create_fe_substructure_with_selection_for_modal_analysis(self) -> '_2101.FESubstructureWithSelectionForModalAnalysis':
    ...
    def import_fe_mesh(self, file_path: 'str', format_: '_152.FEExportFormat', length_scale: Optional['float'] = 1.0, force_scale: Optional['float'] = 1.0, progress: Optional['_7242.TaskProgress'] = None):
    ...
    def links_for(self, node: '_2093.FESubstructureNode') -> 'List[_2126.FELink]':
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.LinksFor(node.wrapped if node else None), constructor.new(_2126.FELink))
