...
from mastapy.system_model.fe import _2074
...
class BearingRaceNodeLink(_0.APIBase):
    ...
    @property
    def race_position(self) -> '_2074.BearingRacePosition':
        ...
        return constructor.new(_2074.BearingRacePosition)(value) if value else None
