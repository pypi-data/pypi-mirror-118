...
from mastapy.system_model.fe import _2113, _2112
...
class SystemDeflectionFEExportOptions(_0.APIBase):
    ...
    @property
    def nodes(self) -> 'List[_2113.PerNodeExportOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Nodes, constructor.new(_2113.PerNodeExportOptions))
        return value

    @property
    def links(self) -> 'List[_2112.PerLinkExportOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Links, constructor.new(_2112.PerLinkExportOptions))
        return value
