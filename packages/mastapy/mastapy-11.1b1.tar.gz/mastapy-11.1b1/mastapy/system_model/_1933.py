...
from mastapy.system_model import _1934
...
T = TypeVar('T', bound='_2153.Component')
...
class RelativeComponentAlignment(_0.APIBase, Generic[T]):
    ...
    @property
    def alignment_axis(self) -> '_1271.AlignmentAxis':
    ...
    def alignment_axis(self, value: '_1271.AlignmentAxis'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.AlignmentAxis = value

    @property
    def axial_offset(self) -> '_1934.RelativeOffsetOption':
        ...
        return constructor.new(_1934.RelativeOffsetOption)(value) if value else None

    @axial_offset.setter
    def axial_offset(self, value: '_1934.RelativeOffsetOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
