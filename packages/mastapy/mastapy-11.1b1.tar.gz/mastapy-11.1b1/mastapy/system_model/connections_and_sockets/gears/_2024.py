...
class HypoidGearMesh(_2008.AGMAGleasonConicalGearMesh):
    '''HypoidGearMesh
    ...
    @property
    def hypoid_gear_mesh_design(self) -> '_924.HypoidGearMeshDesign':
        ...
        return constructor.new(_924.HypoidGearMeshDesign)(self.wrapped.HypoidGearMeshDesign) if self.wrapped.HypoidGearMeshDesign else None
