...
class ConceptGearMesh(_2022.GearMesh):
    '''ConceptGearMesh
    ...
    @property
    def concept_gear_mesh_design(self) -> '_1106.ConceptGearMeshDesign':
        ...
        return constructor.new(_1106.ConceptGearMeshDesign)(self.wrapped.ConceptGearMeshDesign) if self.wrapped.ConceptGearMeshDesign else None
