...
class MassDiscAdvancedTimeSteppingAnalysisForModulation(_6818.VirtualComponentAdvancedTimeSteppingAnalysisForModulation):
    '''MassDiscAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_load_case(self) -> '_6605.MassDiscLoadCase':
        ...
        return constructor.new(_6605.MassDiscLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None

    @property
    def system_deflection_results(self) -> '_2481.MassDiscSystemDeflection':
        ...
        return constructor.new(_2481.MassDiscSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
