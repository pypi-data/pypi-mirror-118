...
class AGMAGleasonConicalGearSetAdvancedTimeSteppingAnalysisForModulation(_6729.ConicalGearSetAdvancedTimeSteppingAnalysisForModulation):
    '''AGMAGleasonConicalGearSetAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2397.AGMAGleasonConicalGearSetSystemDeflection':
