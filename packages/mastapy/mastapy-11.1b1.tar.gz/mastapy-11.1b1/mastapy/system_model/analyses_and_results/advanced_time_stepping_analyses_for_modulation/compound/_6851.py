...
class ConceptCouplingCompoundAdvancedTimeSteppingAnalysisForModulation(_6862.CouplingCompoundAdvancedTimeSteppingAnalysisForModulation):
    '''ConceptCouplingCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2288.ConceptCoupling':
        ...
        return constructor.new(_2288.ConceptCoupling)(self.wrapped.ComponentDesign) if self.wrapped.ComponentDesign else None
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6721.ConceptCouplingAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_6721.ConceptCouplingAdvancedTimeSteppingAnalysisForModulation))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_6721.ConceptCouplingAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_6721.ConceptCouplingAdvancedTimeSteppingAnalysisForModulation))
        return value
