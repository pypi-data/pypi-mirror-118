...
class PointLoadAdvancedTimeSteppingAnalysisForModulation(_6818.VirtualComponentAdvancedTimeSteppingAnalysisForModulation):
    '''PointLoadAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2493.PointLoadSystemDeflection':
        ...
        return constructor.new(_2493.PointLoadSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
