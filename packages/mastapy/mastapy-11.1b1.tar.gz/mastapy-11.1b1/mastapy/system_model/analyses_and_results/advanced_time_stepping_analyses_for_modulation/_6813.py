...
class TorqueConverterAdvancedTimeSteppingAnalysisForModulation(_6732.CouplingAdvancedTimeSteppingAnalysisForModulation):
    '''TorqueConverterAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2532.TorqueConverterSystemDeflection':
        ...
        return constructor.new(_2532.TorqueConverterSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
