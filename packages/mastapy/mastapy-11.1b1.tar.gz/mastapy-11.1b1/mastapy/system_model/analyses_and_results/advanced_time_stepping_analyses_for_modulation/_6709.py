...
class BevelDifferentialPlanetGearAdvancedTimeSteppingAnalysisForModulation(_6706.BevelDifferentialGearAdvancedTimeSteppingAnalysisForModulation):
    '''BevelDifferentialPlanetGearAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2224.BevelDifferentialPlanetGear':
        ...
        return constructor.new(_2224.BevelDifferentialPlanetGear)(self.wrapped.ComponentDesign) if self.wrapped.ComponentDesign else None

    @property
    def system_deflection_results(self) -> '_2406.BevelDifferentialPlanetGearSystemDeflection':
        ...
        return constructor.new(_2406.BevelDifferentialPlanetGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
