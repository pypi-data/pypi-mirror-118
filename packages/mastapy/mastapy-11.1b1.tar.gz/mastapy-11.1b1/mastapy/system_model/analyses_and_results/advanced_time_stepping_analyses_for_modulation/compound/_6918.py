...
class RollingRingConnectionCompoundAdvancedTimeSteppingAnalysisForModulation(_6890.InterMountableComponentConnectionCompoundAdvancedTimeSteppingAnalysisForModulation):
    '''RollingRingConnectionCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2001.RollingRingConnection':
        ...
        return constructor.new(_2001.RollingRingConnection)(self.wrapped.ComponentDesign) if self.wrapped.ComponentDesign else None

    @property
    def connection_design(self) -> '_2001.RollingRingConnection':
        ...
        return constructor.new(_2001.RollingRingConnection)(self.wrapped.ConnectionDesign) if self.wrapped.ConnectionDesign else None

    @property
    def connection_analysis_cases_ready(self) -> 'List[_6789.RollingRingConnectionAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_6789.RollingRingConnectionAdvancedTimeSteppingAnalysisForModulation))
        return value
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6789.RollingRingConnectionAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_6789.RollingRingConnectionAdvancedTimeSteppingAnalysisForModulation))
        return value
