...
class ClutchConnectionAdvancedTimeSteppingAnalysisForModulation(_6733.CouplingConnectionAdvancedTimeSteppingAnalysisForModulation):
    '''ClutchConnectionAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2413.ClutchConnectionSystemDeflection':
        ...
        return constructor.new(_2413.ClutchConnectionSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
