...
class ShaftHubConnectionAdvancedTimeSteppingAnalysisForModulation(_6731.ConnectorAdvancedTimeSteppingAnalysisForModulation):
    '''ShaftHubConnectionAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2503.ShaftHubConnectionSystemDeflection':
        ...
        return constructor.new(_2503.ShaftHubConnectionSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
