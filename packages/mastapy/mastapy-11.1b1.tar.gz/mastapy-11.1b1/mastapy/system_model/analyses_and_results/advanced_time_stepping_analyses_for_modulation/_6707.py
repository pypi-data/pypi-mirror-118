...
class BevelDifferentialGearMeshAdvancedTimeSteppingAnalysisForModulation(_6712.BevelGearMeshAdvancedTimeSteppingAnalysisForModulation):
    '''BevelDifferentialGearMeshAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2403.BevelDifferentialGearMeshSystemDeflection':
        ...
        return constructor.new(_2403.BevelDifferentialGearMeshSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
