...
class CVTPulleyAdvancedTimeSteppingAnalysisForModulation(_6784.PulleyAdvancedTimeSteppingAnalysisForModulation):
    '''CVTPulleyAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2435.CVTPulleySystemDeflection':
        ...
        return constructor.new(_2435.CVTPulleySystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
