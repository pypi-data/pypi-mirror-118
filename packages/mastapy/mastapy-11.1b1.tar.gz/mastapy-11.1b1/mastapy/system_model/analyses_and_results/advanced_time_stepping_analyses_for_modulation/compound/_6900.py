...
class MassDiscCompoundAdvancedTimeSteppingAnalysisForModulation(_6947.VirtualComponentCompoundAdvancedTimeSteppingAnalysisForModulation):
    '''MassDiscCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2170.MassDisc':
        ...
        return constructor.new(_2170.MassDisc)(self.wrapped.ComponentDesign) if self.wrapped.ComponentDesign else None

    @property
    def component_analysis_cases_ready(self) -> 'List[_6771.MassDiscAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6771.MassDiscAdvancedTimeSteppingAnalysisForModulation))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6771.MassDiscAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6771.MassDiscAdvancedTimeSteppingAnalysisForModulation))
        return value
