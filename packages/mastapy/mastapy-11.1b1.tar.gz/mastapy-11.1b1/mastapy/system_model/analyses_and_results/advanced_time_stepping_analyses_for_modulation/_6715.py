...
class BoltedJointAdvancedTimeSteppingAnalysisForModulation(_6794.SpecialisedAssemblyAdvancedTimeSteppingAnalysisForModulation):
    '''BoltedJointAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def assembly_load_case(self) -> '_6512.BoltedJointLoadCase':
        ...
        return constructor.new(_6512.BoltedJointLoadCase)(self.wrapped.AssemblyLoadCase) if self.wrapped.AssemblyLoadCase else None

    @property
    def system_deflection_results(self) -> '_2411.BoltedJointSystemDeflection':
        ...
        return constructor.new(_2411.BoltedJointSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
