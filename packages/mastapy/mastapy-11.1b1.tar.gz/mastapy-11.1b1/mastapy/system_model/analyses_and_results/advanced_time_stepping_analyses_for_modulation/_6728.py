...
class ConicalGearMeshAdvancedTimeSteppingAnalysisForModulation(_6754.GearMeshAdvancedTimeSteppingAnalysisForModulation):
    '''ConicalGearMeshAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2426.ConicalGearMeshSystemDeflection':
