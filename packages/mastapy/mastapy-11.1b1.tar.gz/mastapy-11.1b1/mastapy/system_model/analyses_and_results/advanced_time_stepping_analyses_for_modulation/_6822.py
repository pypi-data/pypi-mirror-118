...
class ZerolBevelGearAdvancedTimeSteppingAnalysisForModulation(_6711.BevelGearAdvancedTimeSteppingAnalysisForModulation):
    '''ZerolBevelGearAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2543.ZerolBevelGearSystemDeflection':
        ...
        return constructor.new(_2543.ZerolBevelGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
