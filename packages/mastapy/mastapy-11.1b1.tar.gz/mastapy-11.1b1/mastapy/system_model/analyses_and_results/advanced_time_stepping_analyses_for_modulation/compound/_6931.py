...
class StraightBevelDiffGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation(_6842.BevelGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation):
    '''StraightBevelDiffGearMeshCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2034.StraightBevelDiffGearMesh':
        ...
        return constructor.new(_2034.StraightBevelDiffGearMesh)(self.wrapped.ComponentDesign) if self.wrapped.ComponentDesign else None
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6802.StraightBevelDiffGearMeshAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_6802.StraightBevelDiffGearMeshAdvancedTimeSteppingAnalysisForModulation))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_6802.StraightBevelDiffGearMeshAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_6802.StraightBevelDiffGearMeshAdvancedTimeSteppingAnalysisForModulation))
        return value
