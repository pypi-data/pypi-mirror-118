...
class BeltDriveCompoundAdvancedTimeSteppingAnalysisForModulation(_6923.SpecialisedAssemblyCompoundAdvancedTimeSteppingAnalysisForModulation):
    '''BeltDriveCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2283.BeltDrive':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6705.BeltDriveAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_6705.BeltDriveAdvancedTimeSteppingAnalysisForModulation))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_6705.BeltDriveAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_6705.BeltDriveAdvancedTimeSteppingAnalysisForModulation))
        return value
