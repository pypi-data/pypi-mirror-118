...
class CylindricalPlanetGearAdvancedTimeSteppingAnalysisForModulation(_6742.CylindricalGearAdvancedTimeSteppingAnalysisForModulation):
    '''CylindricalPlanetGearAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2234.CylindricalPlanetGear':
        ...
        return constructor.new(_2234.CylindricalPlanetGear)(self.wrapped.ComponentDesign) if self.wrapped.ComponentDesign else None

    @property
    def system_deflection_results(self) -> '_2452.CylindricalPlanetGearSystemDeflection':
        ...
        return constructor.new(_2452.CylindricalPlanetGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
