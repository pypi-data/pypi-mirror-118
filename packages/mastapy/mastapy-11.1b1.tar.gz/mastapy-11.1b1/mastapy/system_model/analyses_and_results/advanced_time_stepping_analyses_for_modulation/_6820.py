...
class WormGearMeshAdvancedTimeSteppingAnalysisForModulation(_6754.GearMeshAdvancedTimeSteppingAnalysisForModulation):
    '''WormGearMeshAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2538.WormGearMeshSystemDeflection':
        ...
        return constructor.new(_2538.WormGearMeshSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
