...
class CVTCompoundAdvancedTimeSteppingAnalysisForModulation(_6835.BeltDriveCompoundAdvancedTimeSteppingAnalysisForModulation):
    '''CVTCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6735.CVTAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_6735.CVTAdvancedTimeSteppingAnalysisForModulation))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_6735.CVTAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_6735.CVTAdvancedTimeSteppingAnalysisForModulation))
        return value
