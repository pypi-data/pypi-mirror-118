...
from mastapy.system_model.part_model.couplings import _2297, _2294
...
class PulleyCompoundAdvancedTimeSteppingAnalysisForModulation(_6864.CouplingHalfCompoundAdvancedTimeSteppingAnalysisForModulation):
    '''PulleyCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2297.Pulley':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6784.PulleyAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6784.PulleyAdvancedTimeSteppingAnalysisForModulation))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_6784.PulleyAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6784.PulleyAdvancedTimeSteppingAnalysisForModulation))
        return value
