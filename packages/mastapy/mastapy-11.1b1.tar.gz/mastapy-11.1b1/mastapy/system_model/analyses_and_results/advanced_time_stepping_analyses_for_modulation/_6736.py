...
from mastapy.system_model.connections_and_sockets import _1982
...
class CVTBeltConnectionAdvancedTimeSteppingAnalysisForModulation(_6704.BeltConnectionAdvancedTimeSteppingAnalysisForModulation):
    '''CVTBeltConnectionAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def connection_design(self) -> '_1982.CVTBeltConnection':
        ...
        return constructor.new(_1982.CVTBeltConnection)(self.wrapped.ConnectionDesign) if self.wrapped.ConnectionDesign else None

    @property
    def system_deflection_results(self) -> '_2434.CVTBeltConnectionSystemDeflection':
        ...
        return constructor.new(_2434.CVTBeltConnectionSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
