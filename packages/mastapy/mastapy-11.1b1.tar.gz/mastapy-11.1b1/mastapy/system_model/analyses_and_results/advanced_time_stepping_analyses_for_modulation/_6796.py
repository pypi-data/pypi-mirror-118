...
class SpiralBevelGearMeshAdvancedTimeSteppingAnalysisForModulation(_6712.BevelGearMeshAdvancedTimeSteppingAnalysisForModulation):
    '''SpiralBevelGearMeshAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2509.SpiralBevelGearMeshSystemDeflection':
        ...
        return constructor.new(_2509.SpiralBevelGearMeshSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
