...
class MassDiscCompoundSteadyStateSynchronousResponseAtASpeed(_3196.VirtualComponentCompoundSteadyStateSynchronousResponseAtASpeed):
    '''MassDiscCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3019.MassDiscSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3019.MassDiscSteadyStateSynchronousResponseAtASpeed))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3019.MassDiscSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3019.MassDiscSteadyStateSynchronousResponseAtASpeed))
        return value
