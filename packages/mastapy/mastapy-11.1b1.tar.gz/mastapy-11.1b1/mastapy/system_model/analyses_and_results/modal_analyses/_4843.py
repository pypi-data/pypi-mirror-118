...
from mastapy.system_model.analyses_and_results.modal_analyses import _4842, _4841, _4849
...
class FaceGearSetModalAnalysis(_4849.GearSetModalAnalysis):
    '''FaceGearSetModalAnalysis
    ...
    @property
    def face_gears_modal_analysis(self) -> 'List[_4842.FaceGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGearsModalAnalysis, constructor.new(_4842.FaceGearModalAnalysis))
        return value

    @property
    def face_meshes_modal_analysis(self) -> 'List[_4841.FaceGearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshesModalAnalysis, constructor.new(_4841.FaceGearMeshModalAnalysis))
        return value
