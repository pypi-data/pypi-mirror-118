...
class BeltConnectionCompoundModalAnalysis(_5005.InterMountableComponentConnectionCompoundModalAnalysis):
    '''BeltConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4796.BeltConnectionModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4796.BeltConnectionModalAnalysis))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_4796.BeltConnectionModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4796.BeltConnectionModalAnalysis))
        return value
