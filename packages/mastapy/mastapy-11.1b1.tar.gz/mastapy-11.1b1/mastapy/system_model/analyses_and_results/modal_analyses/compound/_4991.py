...
class DatumCompoundModalAnalysis(_4965.ComponentCompoundModalAnalysis):
    '''DatumCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4839.DatumModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4839.DatumModalAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4839.DatumModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4839.DatumModalAnalysis))
        return value
