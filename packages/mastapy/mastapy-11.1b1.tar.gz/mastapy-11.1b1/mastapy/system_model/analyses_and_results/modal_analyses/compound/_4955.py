...
class BevelDifferentialSunGearCompoundModalAnalysis(_4951.BevelDifferentialGearCompoundModalAnalysis):
    '''BevelDifferentialSunGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4802.BevelDifferentialSunGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4802.BevelDifferentialSunGearModalAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4802.BevelDifferentialSunGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4802.BevelDifferentialSunGearModalAnalysis))
        return value
