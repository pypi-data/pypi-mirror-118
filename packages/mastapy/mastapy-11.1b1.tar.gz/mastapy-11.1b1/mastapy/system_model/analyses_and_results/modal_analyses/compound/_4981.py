...
class CVTCompoundModalAnalysis(_4950.BeltDriveCompoundModalAnalysis):
    '''CVTCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4829.CVTModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_4829.CVTModalAnalysis))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_4829.CVTModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_4829.CVTModalAnalysis))
        return value
