...
class CycloidalDiscPlanetaryBearingConnectionCompoundModalAnalysis(_4943.AbstractShaftToMountableComponentConnectionCompoundModalAnalysis):
    '''CycloidalDiscPlanetaryBearingConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4834.CycloidalDiscPlanetaryBearingConnectionModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4834.CycloidalDiscPlanetaryBearingConnectionModalAnalysis))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_4834.CycloidalDiscPlanetaryBearingConnectionModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4834.CycloidalDiscPlanetaryBearingConnectionModalAnalysis))
        return value
