...
TMeasurement = TypeVar('TMeasurement', bound='_1380.MeasurementBase')


class WhineWaterfallReferenceValues(_4920.WhineWaterfallReferenceValuesBase, Generic[TMeasurement]):
    '''WhineWaterfallReferenceValues
