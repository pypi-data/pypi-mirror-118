...
class CoaxialConnectionCompoundModalAnalysis(_5037.ShaftToMountableComponentConnectionCompoundModalAnalysis):
    '''CoaxialConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4811.CoaxialConnectionModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4811.CoaxialConnectionModalAnalysis))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_4811.CoaxialConnectionModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4811.CoaxialConnectionModalAnalysis))
        return value
