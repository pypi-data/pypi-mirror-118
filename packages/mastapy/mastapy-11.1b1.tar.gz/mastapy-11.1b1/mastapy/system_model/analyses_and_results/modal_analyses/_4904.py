...
from mastapy.system_model.analyses_and_results.modal_analyses import _4903, _4902, _4805
...
class StraightBevelGearSetModalAnalysis(_4805.BevelGearSetModalAnalysis):
    '''StraightBevelGearSetModalAnalysis
    ...
    @property
    def straight_bevel_gears_modal_analysis(self) -> 'List[_4903.StraightBevelGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelGearsModalAnalysis, constructor.new(_4903.StraightBevelGearModalAnalysis))
        return value

    @property
    def straight_bevel_meshes_modal_analysis(self) -> 'List[_4902.StraightBevelGearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelMeshesModalAnalysis, constructor.new(_4902.StraightBevelGearMeshModalAnalysis))
        return value
