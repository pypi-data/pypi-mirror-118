...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4987, _4988, _5000
...
class CylindricalGearSetCompoundModalAnalysis(_5000.GearSetCompoundModalAnalysis):
    '''CylindricalGearSetCompoundModalAnalysis
    ...
    @property
    def cylindrical_gears_compound_modal_analysis(self) -> 'List[_4987.CylindricalGearCompoundModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearsCompoundModalAnalysis, constructor.new(_4987.CylindricalGearCompoundModalAnalysis))
        return value

    @property
    def cylindrical_meshes_compound_modal_analysis(self) -> 'List[_4988.CylindricalGearMeshCompoundModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshesCompoundModalAnalysis, constructor.new(_4988.CylindricalGearMeshCompoundModalAnalysis))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4837.CylindricalGearSetModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_4837.CylindricalGearSetModalAnalysis))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_4837.CylindricalGearSetModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_4837.CylindricalGearSetModalAnalysis))
        return value
