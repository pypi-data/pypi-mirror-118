...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4999
...
class CylindricalGearMeshCompoundModalAnalysis(_4999.GearMeshCompoundModalAnalysis):
    '''CylindricalGearMeshCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4835.CylindricalGearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4835.CylindricalGearMeshModalAnalysis))
        return value
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4835.CylindricalGearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4835.CylindricalGearMeshModalAnalysis))
        return value
