...
from mastapy.system_model.analyses_and_results.modal_analyses import _4900, _4899, _4805
...
class StraightBevelDiffGearSetModalAnalysis(_4805.BevelGearSetModalAnalysis):
    '''StraightBevelDiffGearSetModalAnalysis
    ...
    @property
    def straight_bevel_diff_gears_modal_analysis(self) -> 'List[_4900.StraightBevelDiffGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffGearsModalAnalysis, constructor.new(_4900.StraightBevelDiffGearModalAnalysis))
        return value

    @property
    def straight_bevel_diff_meshes_modal_analysis(self) -> 'List[_4899.StraightBevelDiffGearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshesModalAnalysis, constructor.new(_4899.StraightBevelDiffGearMeshModalAnalysis))
        return value
