...
class KlingelnbergCycloPalloidConicalGearMeshCompoundModalAnalysis(_4973.ConicalGearMeshCompoundModalAnalysis):
    '''KlingelnbergCycloPalloidConicalGearMeshCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4855.KlingelnbergCycloPalloidConicalGearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4855.KlingelnbergCycloPalloidConicalGearMeshModalAnalysis))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_4855.KlingelnbergCycloPalloidConicalGearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4855.KlingelnbergCycloPalloidConicalGearMeshModalAnalysis))
        return value
