...
from mastapy.utility.modal_analysis import _1547
...
class RigidlyConnectedDesignEntityGroupModalAnalysis(_2359.DesignEntityGroupAnalysis):
    '''RigidlyConnectedDesignEntityGroupModalAnalysis
    ...
    @property
    def excitation_frequencies_at_reference_speed(self) -> 'List[_1547.DesignEntityExcitationDescription]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ExcitationFrequenciesAtReferenceSpeed, constructor.new(_1547.DesignEntityExcitationDescription))
        return value
