...
from mastapy.system_model.analyses_and_results.modal_analyses import _2342, _4794
...
class RootAssemblyModalAnalysis(_4794.AssemblyModalAnalysis):
    '''RootAssemblyModalAnalysis
    ...
    @property
    def modal_analysis_inputs(self) -> '_2342.ModalAnalysis':
        ...
        if _2342.ModalAnalysis.TYPE not in self.wrapped.ModalAnalysisInputs.__class__.__mro__:
