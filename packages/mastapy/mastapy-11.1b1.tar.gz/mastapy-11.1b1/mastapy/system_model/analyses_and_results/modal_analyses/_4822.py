...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation import _2345
...
class ConnectionModalAnalysis(_7225.ConnectionStaticLoadAnalysisCase):
    '''ConnectionModalAnalysis
    ...
    def modal_analysis(self) -> '_2342.ModalAnalysis':
        ...
        if _2342.ModalAnalysis.TYPE not in self.wrapped.ModalAnalysis.__class__.__mro__:
    ...
    @property
    def excited_modes_summary(self) -> 'List[_4938.SingleExcitationResultsModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ExcitedModesSummary, constructor.new(_4938.SingleExcitationResultsModalAnalysis))
        return value
