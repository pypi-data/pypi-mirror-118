...
class ClutchHalfCompoundModalAnalysis(_4979.CouplingHalfCompoundModalAnalysis):
    '''ClutchHalfCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4809.ClutchHalfModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4809.ClutchHalfModalAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4809.ClutchHalfModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4809.ClutchHalfModalAnalysis))
        return value
