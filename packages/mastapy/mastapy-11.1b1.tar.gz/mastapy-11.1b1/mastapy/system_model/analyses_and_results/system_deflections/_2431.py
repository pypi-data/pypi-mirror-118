...
class CouplingConnectionSystemDeflection(_2469.InterMountableComponentConnectionSystemDeflection):
    '''CouplingConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3769.CouplingConnectionPowerFlow':
