...
from mastapy.system_model.analyses_and_results.system_deflections import _2543, _2541, _2409
...
class ZerolBevelGearSetSystemDeflection(_2409.BevelGearSetSystemDeflection):
    '''ZerolBevelGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3864.ZerolBevelGearSetPowerFlow':
        ...
        return constructor.new(_3864.ZerolBevelGearSetPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
    ...
    @property
    def zerol_bevel_gears_system_deflection(self) -> 'List[_2543.ZerolBevelGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelGearsSystemDeflection, constructor.new(_2543.ZerolBevelGearSystemDeflection))
        return value

    @property
    def zerol_bevel_meshes_system_deflection(self) -> 'List[_2541.ZerolBevelGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelMeshesSystemDeflection, constructor.new(_2541.ZerolBevelGearMeshSystemDeflection))
        return value
