...
from mastapy.system_model.analyses_and_results.power_flows import _3756, _3776
...
class CoaxialConnectionSystemDeflection(_2507.ShaftToMountableComponentConnectionSystemDeflection):
    '''CoaxialConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3756.CoaxialConnectionPowerFlow':
