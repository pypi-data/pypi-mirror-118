...
class MassDiscSystemDeflection(_2537.VirtualComponentSystemDeflection):
    '''MassDiscSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3808.MassDiscPowerFlow':
        ...
        return constructor.new(_3808.MassDiscPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
