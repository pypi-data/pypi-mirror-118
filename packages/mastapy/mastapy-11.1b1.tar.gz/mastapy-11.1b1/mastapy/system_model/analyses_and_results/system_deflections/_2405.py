...
from mastapy.system_model.analyses_and_results.power_flows import _3744, _3746, _3747
...
class BevelDifferentialGearSystemDeflection(_2410.BevelGearSystemDeflection):
    '''BevelDifferentialGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3744.BevelDifferentialGearPowerFlow':
