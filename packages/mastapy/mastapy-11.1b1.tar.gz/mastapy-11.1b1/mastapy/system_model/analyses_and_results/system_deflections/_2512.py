...
class SpringDamperConnectionSystemDeflection(_2431.CouplingConnectionSystemDeflection):
    '''SpringDamperConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3837.SpringDamperConnectionPowerFlow':
        ...
        return constructor.new(_3837.SpringDamperConnectionPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
