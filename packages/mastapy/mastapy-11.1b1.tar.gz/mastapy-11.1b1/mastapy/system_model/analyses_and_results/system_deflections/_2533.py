...
class TorqueConverterTurbineSystemDeflection(_2432.CouplingHalfSystemDeflection):
    '''TorqueConverterTurbineSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3856.TorqueConverterTurbinePowerFlow':
        ...
        return constructor.new(_3856.TorqueConverterTurbinePowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
