...
from mastapy.math_utility.measured_vectors import _1343, _1342
from mastapy.system_model.analyses_and_results.power_flows import (
    _3757, _3733, _3734, _3737,
    _3740, _3744, _3746, _3747,
    _3749, _3752, _3754, _3759,
    _3762, _3765, _3768, _3770,
    _3774, _3778, _3781, _3783,
    _3784, _3785, _3787, _3789,
    _3792, _3794, _3796, _3800,
    _3803, _3806, _3808, _3809,
    _3810, _3811, _3814, _3818,
    _3819, _3822, _3823, _3824,
    _3828, _3830, _3831, _3835,
    _3838, _3841, _3844, _3846,
    _3847, _3848, _3849, _3851,
...
class ComponentSystemDeflection(_2487.PartSystemDeflection):
    '''ComponentSystemDeflection
    ...
    @property
    def rigidly_connected_components(self) -> '_2550.RigidlyConnectedComponentGroupSystemDeflection':
        ...
        return constructor.new(_2550.RigidlyConnectedComponentGroupSystemDeflection)(self.wrapped.RigidlyConnectedComponents) if self.wrapped.RigidlyConnectedComponents else None

    @property
    def mass_properties_in_local_coordinate_system_from_node_model(self) -> '_1299.MassProperties':
        ...
        return constructor.new(_1299.MassProperties)(self.wrapped.MassPropertiesInLocalCoordinateSystemFromNodeModel) if self.wrapped.MassPropertiesInLocalCoordinateSystemFromNodeModel else None

    @property
    def node_results(self) -> 'List[_1343.NodeResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.NodeResults, constructor.new(_1343.NodeResults))
        return value

    @property
    def connected_components_forces_in_lcs(self) -> 'List[_1342.ForceResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectedComponentsForcesInLCS, constructor.new(_1342.ForceResults))
        return value

    @property
    def connected_components_forces_in_wcs(self) -> 'List[_1342.ForceResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectedComponentsForcesInWCS, constructor.new(_1342.ForceResults))
        return value

    @property
    def power_flow_results(self) -> '_3757.ComponentPowerFlow':
        ...
        if _3757.ComponentPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
    ...
    @property
    def power_flow_results_of_type_abstract_shaft_or_housing_power_flow(self) -> '_3733.AbstractShaftOrHousingPowerFlow':
    ...
    @property
    def power_flow_results_of_type_bolt_power_flow(self) -> '_3752.BoltPowerFlow':
        ...
        if _3752.BoltPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
    ...
    @property
    def power_flow_results_of_type_datum_power_flow(self) -> '_3784.DatumPowerFlow':
        ...
        if _3784.DatumPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
    ...
    @property
    def power_flow_results_of_type_external_cad_model_power_flow(self) -> '_3785.ExternalCADModelPowerFlow':
        ...
        if _3785.ExternalCADModelPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
    ...
    @property
    def power_flow_results_of_type_guide_dxf_model_power_flow(self) -> '_3794.GuideDxfModelPowerFlow':
        ...
        if _3794.GuideDxfModelPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
    ...
    @property
    def power_flow_results_of_type_mountable_component_power_flow(self) -> '_3810.MountableComponentPowerFlow':
