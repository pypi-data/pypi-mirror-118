...
class RingPinToDiscContactReporting(_0.APIBase):
    ...
    @property
    def contact(self) -> '_2552.SplineFlankContactReporting':
        ...
        return constructor.new(_2552.SplineFlankContactReporting)(self.wrapped.Contact) if self.wrapped.Contact else None

    @property
    def information_at_ring_pin_to_disc_contact_point_from_geometry(self) -> '_6593.InformationAtRingPinToDiscContactPointFromGeometry':
        ...
        return constructor.new(_6593.InformationAtRingPinToDiscContactPointFromGeometry)(self.wrapped.InformationAtRingPinToDiscContactPointFromGeometry) if self.wrapped.InformationAtRingPinToDiscContactPointFromGeometry else None

    @property
    def information_for_contact_points_along_face_width(self) -> 'List[_2468.InformationForContactAtPointAlongFaceWidth]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.InformationForContactPointsAlongFaceWidth, constructor.new(_2468.InformationForContactAtPointAlongFaceWidth))
        return value
