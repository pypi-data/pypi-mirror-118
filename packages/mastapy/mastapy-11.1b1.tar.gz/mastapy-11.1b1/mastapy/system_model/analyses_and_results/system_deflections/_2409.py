...
class BevelGearSetSystemDeflection(_2397.AGMAGleasonConicalGearSetSystemDeflection):
    '''BevelGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3750.BevelGearSetPowerFlow':
