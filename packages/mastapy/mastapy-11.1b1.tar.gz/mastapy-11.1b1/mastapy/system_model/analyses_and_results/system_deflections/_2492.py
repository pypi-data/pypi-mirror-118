...
from mastapy.system_model.analyses_and_results.system_deflections.reporting import _2548
...
class PlanetCarrierSystemDeflection(_2484.MountableComponentSystemDeflection):
    '''PlanetCarrierSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3818.PlanetCarrierPowerFlow':
        ...
        return constructor.new(_3818.PlanetCarrierPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None

    @property
    def windup(self) -> 'List[_2548.PlanetCarrierWindup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Windup, constructor.new(_2548.PlanetCarrierWindup))
        return value
