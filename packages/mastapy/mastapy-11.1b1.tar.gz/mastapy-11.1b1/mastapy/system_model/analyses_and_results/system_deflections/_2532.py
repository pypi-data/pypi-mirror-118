...
class TorqueConverterSystemDeflection(_2433.CouplingSystemDeflection):
    '''TorqueConverterSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3854.TorqueConverterPowerFlow':
        ...
        return constructor.new(_3854.TorqueConverterPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
