...
class FaceGearMeshSystemDeflection(_2461.GearMeshSystemDeflection):
    '''FaceGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3786.FaceGearMeshPowerFlow':
        ...
        return constructor.new(_3786.FaceGearMeshPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
