...
from mastapy.system_model.analyses_and_results.power_flows import _3800, _3803, _3806
...
class KlingelnbergCycloPalloidConicalGearSystemDeflection(_2428.ConicalGearSystemDeflection):
    '''KlingelnbergCycloPalloidConicalGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3800.KlingelnbergCycloPalloidConicalGearPowerFlow':
