...
class BevelGearMeshSystemDeflection(_2396.AGMAGleasonConicalGearMeshSystemDeflection):
    '''BevelGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3748.BevelGearMeshPowerFlow':
