...
class FaceGearSystemDeflection(_2463.GearSystemDeflection):
    '''FaceGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3787.FaceGearPowerFlow':
        ...
        return constructor.new(_3787.FaceGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
