...
class CylindricalGearSystemDeflectionWithLTCAResults(_2447.CylindricalGearSystemDeflection):
    '''CylindricalGearSystemDeflectionWithLTCAResults
    ...
    @property
    def cylindrical_gear_ltca_results(self) -> '_797.CylindricalGearLoadDistributionAnalysis':
        ...
        return constructor.new(_797.CylindricalGearLoadDistributionAnalysis)(self.wrapped.CylindricalGearLTCAResults) if self.wrapped.CylindricalGearLTCAResults else None
