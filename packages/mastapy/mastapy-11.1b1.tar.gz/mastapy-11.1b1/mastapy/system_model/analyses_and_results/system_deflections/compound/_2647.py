...
class RollingRingConnectionCompoundSystemDeflection(_2619.InterMountableComponentConnectionCompoundSystemDeflection):
    '''RollingRingConnectionCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2500.RollingRingConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_2500.RollingRingConnectionSystemDeflection))
        return value
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2500.RollingRingConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_2500.RollingRingConnectionSystemDeflection))
        return value
