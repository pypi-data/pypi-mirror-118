...
class TorqueConverterPumpSystemDeflection(_2432.CouplingHalfSystemDeflection):
    '''TorqueConverterPumpSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3855.TorqueConverterPumpPowerFlow':
        ...
        return constructor.new(_3855.TorqueConverterPumpPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
