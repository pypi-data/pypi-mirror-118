...
class StraightBevelDiffGearMeshSystemDeflection(_2408.BevelGearMeshSystemDeflection):
    '''StraightBevelDiffGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3840.StraightBevelDiffGearMeshPowerFlow':
        ...
        return constructor.new(_3840.StraightBevelDiffGearMeshPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
