...
class CVTSystemDeflection(_2402.BeltDriveSystemDeflection):
    '''CVTSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3773.CVTPowerFlow':
        ...
        return constructor.new(_3773.CVTPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
