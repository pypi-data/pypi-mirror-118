...
class CylindricalPlanetGearSystemDeflection(_2449.CylindricalGearSystemDeflectionWithLTCAResults):
    '''CylindricalPlanetGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3783.CylindricalPlanetGearPowerFlow':
        ...
        return constructor.new(_3783.CylindricalPlanetGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
