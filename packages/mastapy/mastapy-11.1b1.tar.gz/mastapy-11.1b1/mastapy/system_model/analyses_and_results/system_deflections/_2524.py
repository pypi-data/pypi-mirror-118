...
from mastapy.system_model.analyses_and_results.power_flows import _3849, _3848, _3851
...
class SynchroniserPartSystemDeflection(_2432.CouplingHalfSystemDeflection):
    '''SynchroniserPartSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3849.SynchroniserPartPowerFlow':
