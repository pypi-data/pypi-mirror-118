...
class KlingelnbergCycloPalloidSpiralBevelGearSystemDeflection(_2472.KlingelnbergCycloPalloidConicalGearSystemDeflection):
    '''KlingelnbergCycloPalloidSpiralBevelGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3806.KlingelnbergCycloPalloidSpiralBevelGearPowerFlow':
        ...
        return constructor.new(_3806.KlingelnbergCycloPalloidSpiralBevelGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
