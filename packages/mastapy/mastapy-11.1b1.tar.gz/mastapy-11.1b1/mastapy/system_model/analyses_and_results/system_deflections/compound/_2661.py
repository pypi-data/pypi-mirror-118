...
class StraightBevelDiffGearMeshCompoundSystemDeflection(_2570.BevelGearMeshCompoundSystemDeflection):
    '''StraightBevelDiffGearMeshCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2515.StraightBevelDiffGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_2515.StraightBevelDiffGearMeshSystemDeflection))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_2515.StraightBevelDiffGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_2515.StraightBevelDiffGearMeshSystemDeflection))
        return value
