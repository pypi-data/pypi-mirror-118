...
class BevelDifferentialPlanetGearSystemDeflection(_2405.BevelDifferentialGearSystemDeflection):
    '''BevelDifferentialPlanetGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3746.BevelDifferentialPlanetGearPowerFlow':
        ...
        return constructor.new(_3746.BevelDifferentialPlanetGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
