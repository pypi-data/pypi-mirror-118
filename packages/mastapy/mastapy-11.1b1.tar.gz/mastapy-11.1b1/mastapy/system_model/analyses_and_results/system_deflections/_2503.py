...
from mastapy.detailed_rigid_connectors.rating import _1218
from mastapy.detailed_rigid_connectors.splines.ratings import (
    _1206, _1208, _1210, _1212,
    _1214
)
from mastapy._internal.cast_exception import CastException
from mastapy.detailed_rigid_connectors.keyed_joints.rating import _1224
from mastapy.detailed_rigid_connectors.interference_fits.rating import _1231
from mastapy.bearings.bearing_results import _1667
from mastapy.system_model.analyses_and_results.system_deflections.reporting import _2552
...
class ShaftHubConnectionSystemDeflection(_2430.ConnectorSystemDeflection):
    '''ShaftHubConnectionSystemDeflection
    ...
    @property
    def component_load_case(self) -> '_6634.ShaftHubConnectionLoadCase':
        ...
        return constructor.new(_6634.ShaftHubConnectionLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None

    @property
    def power_flow_results(self) -> '_3830.ShaftHubConnectionPowerFlow':
        ...
        return constructor.new(_3830.ShaftHubConnectionPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None

    @property
    def component_detailed_analysis(self) -> '_1218.ShaftHubConnectionRating':
        ...
        if _1218.ShaftHubConnectionRating.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_agma6123_spline_joint_rating(self) -> '_1206.AGMA6123SplineJointRating':
        ...
        if _1206.AGMA6123SplineJointRating.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_din5466_spline_rating(self) -> '_1208.DIN5466SplineRating':
        ...
        if _1208.DIN5466SplineRating.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_gbt17855_spline_joint_rating(self) -> '_1210.GBT17855SplineJointRating':
        ...
        if _1210.GBT17855SplineJointRating.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_sae_spline_joint_rating(self) -> '_1212.SAESplineJointRating':
        ...
        if _1212.SAESplineJointRating.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_spline_joint_rating(self) -> '_1214.SplineJointRating':
        ...
        if _1214.SplineJointRating.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_keyway_rating(self) -> '_1224.KeywayRating':
        ...
        if _1224.KeywayRating.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_detailed_analysis_of_type_interference_fit_rating(self) -> '_1231.InterferenceFitRating':
        ...
        if _1231.InterferenceFitRating.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def stiffness_matrix_in_local_coordinate_system(self) -> '_1667.BearingStiffnessMatrixReporter':
        ...
        return constructor.new(_1667.BearingStiffnessMatrixReporter)(self.wrapped.StiffnessMatrixInLocalCoordinateSystem) if self.wrapped.StiffnessMatrixInLocalCoordinateSystem else None

    @property
    def stiffness_matrix_in_unrotated_coordinate_system(self) -> '_1667.BearingStiffnessMatrixReporter':
        ...
        return constructor.new(_1667.BearingStiffnessMatrixReporter)(self.wrapped.StiffnessMatrixInUnrotatedCoordinateSystem) if self.wrapped.StiffnessMatrixInUnrotatedCoordinateSystem else None
    ...
    @property
    def left_flank_contacts(self) -> 'List[_2552.SplineFlankContactReporting]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LeftFlankContacts, constructor.new(_2552.SplineFlankContactReporting))
        return value

    @property
    def right_flank_contacts(self) -> 'List[_2552.SplineFlankContactReporting]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RightFlankContacts, constructor.new(_2552.SplineFlankContactReporting))
        return value

    @property
    def tip_contacts(self) -> 'List[_2552.SplineFlankContactReporting]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.TipContacts, constructor.new(_2552.SplineFlankContactReporting))
        return value
