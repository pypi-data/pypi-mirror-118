...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2589
...
class BearingCompoundSystemDeflection(_2589.ConnectorCompoundSystemDeflection):
    '''BearingCompoundSystemDeflection
    ...
    @property
    def component_detailed_analysis(self) -> '_1673.LoadedBearingDutyCycle':
        ...
        if _1673.LoadedBearingDutyCycle.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2400.BearingSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2400.BearingSystemDeflection))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2400.BearingSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2400.BearingSystemDeflection))
        return value
