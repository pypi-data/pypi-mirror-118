...
from mastapy.system_model.analyses_and_results.system_deflections import _2467, _2465, _2397
...
class HypoidGearSetSystemDeflection(_2397.AGMAGleasonConicalGearSetSystemDeflection):
    '''HypoidGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3797.HypoidGearSetPowerFlow':
        ...
        return constructor.new(_3797.HypoidGearSetPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
    ...
    @property
    def hypoid_gears_system_deflection(self) -> 'List[_2467.HypoidGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidGearsSystemDeflection, constructor.new(_2467.HypoidGearSystemDeflection))
        return value

    @property
    def hypoid_meshes_system_deflection(self) -> 'List[_2465.HypoidGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidMeshesSystemDeflection, constructor.new(_2465.HypoidGearMeshSystemDeflection))
        return value
