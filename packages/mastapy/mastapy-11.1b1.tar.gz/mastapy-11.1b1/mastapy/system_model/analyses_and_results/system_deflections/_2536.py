...
class UnbalancedMassSystemDeflection(_2537.VirtualComponentSystemDeflection):
    '''UnbalancedMassSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3857.UnbalancedMassPowerFlow':
        ...
        return constructor.new(_3857.UnbalancedMassPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
