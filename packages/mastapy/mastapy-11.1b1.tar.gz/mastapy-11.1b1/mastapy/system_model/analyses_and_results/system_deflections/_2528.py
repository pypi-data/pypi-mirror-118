...
from mastapy.system_model.drawing import _1964, _1954
...
class SystemDeflectionDrawStyle(_1954.ContourDrawStyle):
    '''SystemDeflectionDrawStyle
    ...
    @property
    def force_arrow_scaling(self) -> '_1964.ScalingDrawStyle':
        ...
        return constructor.new(_1964.ScalingDrawStyle)(self.wrapped.ForceArrowScaling) if self.wrapped.ForceArrowScaling else None
