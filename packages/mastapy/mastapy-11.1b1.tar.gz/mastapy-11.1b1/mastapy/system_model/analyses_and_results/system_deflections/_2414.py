...
class ClutchHalfSystemDeflection(_2432.CouplingHalfSystemDeflection):
    '''ClutchHalfSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3754.ClutchHalfPowerFlow':
        ...
        return constructor.new(_3754.ClutchHalfPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
