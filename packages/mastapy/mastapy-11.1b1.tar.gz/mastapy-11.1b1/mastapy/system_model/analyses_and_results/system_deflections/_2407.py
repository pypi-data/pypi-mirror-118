...
class BevelDifferentialSunGearSystemDeflection(_2405.BevelDifferentialGearSystemDeflection):
    '''BevelDifferentialSunGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3747.BevelDifferentialSunGearPowerFlow':
        ...
        return constructor.new(_3747.BevelDifferentialSunGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
