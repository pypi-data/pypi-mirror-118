...
class CVTBeltConnectionSystemDeflection(_2401.BeltConnectionSystemDeflection):
    '''CVTBeltConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3772.CVTBeltConnectionPowerFlow':
        ...
        return constructor.new(_3772.CVTBeltConnectionPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
