...
from mastapy.system_model.analyses_and_results.system_deflections import _2479, _2529
...
class SystemDeflection(_7228.FEAnalysis):
    '''SystemDeflection
    ...
    @property
    def overall_efficiency_results(self) -> '_2479.LoadCaseOverallEfficiencyResult':
        ...
        return constructor.new(_2479.LoadCaseOverallEfficiencyResult)(self.wrapped.OverallEfficiencyResults) if self.wrapped.OverallEfficiencyResults else None

    @property
    def analysis_options(self) -> '_2529.SystemDeflectionOptions':
        ...
        return constructor.new(_2529.SystemDeflectionOptions)(self.wrapped.AnalysisOptions) if self.wrapped.AnalysisOptions else None
