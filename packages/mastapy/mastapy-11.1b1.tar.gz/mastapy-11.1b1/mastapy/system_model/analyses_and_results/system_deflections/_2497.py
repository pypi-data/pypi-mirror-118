...
from mastapy.system_model.analyses_and_results.system_deflections import _2498, _2469
...
class RingPinsToDiscConnectionSystemDeflection(_2469.InterMountableComponentConnectionSystemDeflection):
    '''RingPinsToDiscConnectionSystemDeflection
    ...
    @property
    def connection_load_case(self) -> '_6629.RingPinsToDiscConnectionLoadCase':
        ...
        return constructor.new(_6629.RingPinsToDiscConnectionLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None

    @property
    def power_flow_results(self) -> '_3825.RingPinsToDiscConnectionPowerFlow':
        ...
        return constructor.new(_3825.RingPinsToDiscConnectionPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None

    @property
    def ring_pin_to_disc_contacts(self) -> 'List[_2498.RingPinToDiscContactReporting]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RingPinToDiscContacts, constructor.new(_2498.RingPinToDiscContactReporting))
        return value
