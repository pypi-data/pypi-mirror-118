...
from mastapy.system_model.analyses_and_results.system_deflections import _2540, _2538, _2462
...
class WormGearSetSystemDeflection(_2462.GearSetSystemDeflection):
    '''WormGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3861.WormGearSetPowerFlow':
        ...
        return constructor.new(_3861.WormGearSetPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
    ...
    @property
    def worm_gears_system_deflection(self) -> 'List[_2540.WormGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsSystemDeflection, constructor.new(_2540.WormGearSystemDeflection))
        return value

    @property
    def worm_meshes_system_deflection(self) -> 'List[_2538.WormGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesSystemDeflection, constructor.new(_2538.WormGearMeshSystemDeflection))
        return value
