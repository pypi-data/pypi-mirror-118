...
class ExternalCADModelSystemDeflection(_2417.ComponentSystemDeflection):
    '''ExternalCADModelSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3785.ExternalCADModelPowerFlow':
        ...
        return constructor.new(_3785.ExternalCADModelPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
