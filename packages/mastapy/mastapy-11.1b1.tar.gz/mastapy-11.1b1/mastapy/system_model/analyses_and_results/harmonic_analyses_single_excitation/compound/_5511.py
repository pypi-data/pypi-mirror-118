...
class BevelDifferentialGearCompoundHarmonicAnalysisOfSingleExcitation(_5516.BevelGearCompoundHarmonicAnalysisOfSingleExcitation):
    '''BevelDifferentialGearCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5381.BevelDifferentialGearHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5381.BevelDifferentialGearHarmonicAnalysisOfSingleExcitation))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_5381.BevelDifferentialGearHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5381.BevelDifferentialGearHarmonicAnalysisOfSingleExcitation))
        return value
