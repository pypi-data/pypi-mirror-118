...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation import _5432, _5377
...
class RootAssemblyHarmonicAnalysisOfSingleExcitation(_5377.AssemblyHarmonicAnalysisOfSingleExcitation):
    '''RootAssemblyHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def harmonic_analysis_of_single_excitation_inputs(self) -> '_5432.HarmonicAnalysisOfSingleExcitation':
        ...
        return constructor.new(_5432.HarmonicAnalysisOfSingleExcitation)(self.wrapped.HarmonicAnalysisOfSingleExcitationInputs) if self.wrapped.HarmonicAnalysisOfSingleExcitationInputs else None
