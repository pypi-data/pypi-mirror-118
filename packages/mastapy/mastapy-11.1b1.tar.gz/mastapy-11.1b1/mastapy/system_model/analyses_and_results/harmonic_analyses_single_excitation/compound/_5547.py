...
class CylindricalGearCompoundHarmonicAnalysisOfSingleExcitation(_5558.GearCompoundHarmonicAnalysisOfSingleExcitation):
    '''CylindricalGearCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5417.CylindricalGearHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5417.CylindricalGearHarmonicAnalysisOfSingleExcitation))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5417.CylindricalGearHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5417.CylindricalGearHarmonicAnalysisOfSingleExcitation))
        return value
