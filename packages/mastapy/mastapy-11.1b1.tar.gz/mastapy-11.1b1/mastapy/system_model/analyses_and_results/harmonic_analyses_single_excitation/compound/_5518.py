...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation.compound import _5506
...
class BevelGearSetCompoundHarmonicAnalysisOfSingleExcitation(_5506.AGMAGleasonConicalGearSetCompoundHarmonicAnalysisOfSingleExcitation):
    '''BevelGearSetCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5388.BevelGearSetHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_5388.BevelGearSetHarmonicAnalysisOfSingleExcitation))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5388.BevelGearSetHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_5388.BevelGearSetHarmonicAnalysisOfSingleExcitation))
        return value
