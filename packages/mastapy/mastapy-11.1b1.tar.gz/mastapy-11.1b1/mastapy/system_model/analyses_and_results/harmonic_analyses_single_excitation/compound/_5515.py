...
class BevelDifferentialSunGearCompoundHarmonicAnalysisOfSingleExcitation(_5511.BevelDifferentialGearCompoundHarmonicAnalysisOfSingleExcitation):
    '''BevelDifferentialSunGearCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5385.BevelDifferentialSunGearHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5385.BevelDifferentialSunGearHarmonicAnalysisOfSingleExcitation))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_5385.BevelDifferentialSunGearHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5385.BevelDifferentialSunGearHarmonicAnalysisOfSingleExcitation))
        return value
