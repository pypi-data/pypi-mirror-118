...
class PartToPartShearCouplingHalfCompoundHarmonicAnalysisOfSingleExcitation(_5539.CouplingHalfCompoundHarmonicAnalysisOfSingleExcitation):
    '''PartToPartShearCouplingHalfCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5452.PartToPartShearCouplingHalfHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5452.PartToPartShearCouplingHalfHarmonicAnalysisOfSingleExcitation))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_5452.PartToPartShearCouplingHalfHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5452.PartToPartShearCouplingHalfHarmonicAnalysisOfSingleExcitation))
        return value
