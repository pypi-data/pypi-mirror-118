...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _2344, _4277
...
class RootAssemblyModalAnalysisAtAStiffness(_4277.AssemblyModalAnalysisAtAStiffness):
    '''RootAssemblyModalAnalysisAtAStiffness
    ...
    @property
    def modal_analysis_at_a_stiffness_inputs(self) -> '_2344.ModalAnalysisAtAStiffness':
        ...
        return constructor.new(_2344.ModalAnalysisAtAStiffness)(self.wrapped.ModalAnalysisAtAStiffnessInputs) if self.wrapped.ModalAnalysisAtAStiffnessInputs else None
