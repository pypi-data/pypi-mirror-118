...
class VirtualComponentCompoundModalAnalysisAtAStiffness(_4477.MountableComponentCompoundModalAnalysisAtAStiffness):
    '''VirtualComponentCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4393.VirtualComponentModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4393.VirtualComponentModalAnalysisAtAStiffness))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_4393.VirtualComponentModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4393.VirtualComponentModalAnalysisAtAStiffness))
        return value
