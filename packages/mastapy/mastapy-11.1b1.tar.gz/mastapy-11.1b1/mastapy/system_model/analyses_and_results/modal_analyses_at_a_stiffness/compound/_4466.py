...
class KlingelnbergCycloPalloidConicalGearCompoundModalAnalysisAtAStiffness(_4432.ConicalGearCompoundModalAnalysisAtAStiffness):
    '''KlingelnbergCycloPalloidConicalGearCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4338.KlingelnbergCycloPalloidConicalGearModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4338.KlingelnbergCycloPalloidConicalGearModalAnalysisAtAStiffness))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_4338.KlingelnbergCycloPalloidConicalGearModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4338.KlingelnbergCycloPalloidConicalGearModalAnalysisAtAStiffness))
        return value
