...
from mastapy.system_model.analyses_and_results.static_loads import _6499, _6612
from mastapy.system_model import _1923
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4089, _4090
...
class ParametricStudyToolOptions(_0.APIBase):
    ...
    @property
    def parametric_study_type(self) -> '_6612.ParametricStudyType':
        ...
        return constructor.new(_6612.ParametricStudyType)(value) if value else None

    @parametric_study_type.setter
    def parametric_study_type(self, value: '_6612.ParametricStudyType'):
    ...
    @property
    def external_full_fe_loader(self) -> '_1923.ExternalFullFELoader':
        ...
        return constructor.new(_1923.ExternalFullFELoader)(self.wrapped.ExternalFullFELoader) if self.wrapped.ExternalFullFELoader else None

    @property
    def step_results(self) -> 'List[_4089.ParametricStudyToolStepResult]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StepResults, constructor.new(_4089.ParametricStudyToolStepResult))
        return value

    @property
    def study_variables(self) -> 'List[_4090.ParametricStudyVariable]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StudyVariables, constructor.new(_4090.ParametricStudyVariable))
        return value
