...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4042, _4041, _4061
...
class CylindricalGearSetParametricStudyTool(_4061.GearSetParametricStudyTool):
    '''CylindricalGearSetParametricStudyTool
    ...
    @property
    def cylindrical_gears_parametric_study_tool(self) -> 'List[_4042.CylindricalGearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearsParametricStudyTool, constructor.new(_4042.CylindricalGearParametricStudyTool))
        return value

    @property
    def cylindrical_meshes_parametric_study_tool(self) -> 'List[_4041.CylindricalGearMeshParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshesParametricStudyTool, constructor.new(_4041.CylindricalGearMeshParametricStudyTool))
        return value

    @property
    def assembly_system_deflection_results(self) -> 'List[_2444.CylindricalGearSetSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySystemDeflectionResults, constructor.new(_2444.CylindricalGearSetSystemDeflection))
        return value
