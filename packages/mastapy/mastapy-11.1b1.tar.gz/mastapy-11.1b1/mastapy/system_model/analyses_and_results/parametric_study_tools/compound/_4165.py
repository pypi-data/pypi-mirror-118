...
class CoaxialConnectionCompoundParametricStudyTool(_4238.ShaftToMountableComponentConnectionCompoundParametricStudyTool):
    '''CoaxialConnectionCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4018.CoaxialConnectionParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4018.CoaxialConnectionParametricStudyTool))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_4018.CoaxialConnectionParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4018.CoaxialConnectionParametricStudyTool))
        return value
