...
class BevelDifferentialSunGearCompoundParametricStudyTool(_4152.BevelDifferentialGearCompoundParametricStudyTool):
    '''BevelDifferentialSunGearCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4009.BevelDifferentialSunGearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4009.BevelDifferentialSunGearParametricStudyTool))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4009.BevelDifferentialSunGearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4009.BevelDifferentialSunGearParametricStudyTool))
        return value
