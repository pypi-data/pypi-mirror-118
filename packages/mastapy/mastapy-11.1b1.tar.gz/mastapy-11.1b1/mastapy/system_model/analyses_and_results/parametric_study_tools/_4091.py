...
class PartParametricStudyTool(_7229.PartAnalysisCase):
    '''PartParametricStudyTool
    ...
    @property
    def parametric_study_tool(self) -> '_4086.ParametricStudyTool':
        ...
        return constructor.new(_4086.ParametricStudyTool)(self.wrapped.ParametricStudyTool) if self.wrapped.ParametricStudyTool else None

    @property
    def data_logger(self) -> '_1595.DataLoggerWithCharts':
        ...
        return constructor.new(_1595.DataLoggerWithCharts)(self.wrapped.DataLogger) if self.wrapped.DataLogger else None
