...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4081, _4078
...
class ParametricStudyVariable(_2355.AnalysisCaseVariable):
    '''ParametricStudyVariable
    ...
    @property
    def dimension(self) -> '_4081.ParametricStudyDimension':
        ...
        return constructor.new(_4081.ParametricStudyDimension)(value) if value else None

    @dimension.setter
    def dimension(self, value: '_4081.ParametricStudyDimension'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.Dimension = value

    @property
    def distribution(self) -> '_4078.MonteCarloDistribution':
        ...
        return constructor.new(_4078.MonteCarloDistribution)(value) if value else None

    @distribution.setter
    def distribution(self, value: '_4078.MonteCarloDistribution'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
