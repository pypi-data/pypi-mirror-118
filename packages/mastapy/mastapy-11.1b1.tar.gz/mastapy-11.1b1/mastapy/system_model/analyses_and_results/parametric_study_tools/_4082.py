...
class ParametricStudyDOEResultVariable(_1334.ParetoOptimisationVariableBase):
    '''ParametricStudyDOEResultVariable
    ...
    @property
    def target(self) -> '_1336.PropertyTargetForDominantCandidateSearch':
    ...
    @target.setter
    def target(self, value: '_1336.PropertyTargetForDominantCandidateSearch'):
