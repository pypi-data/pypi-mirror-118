...
class MassDiscCompoundParametricStudyTool(_4263.VirtualComponentCompoundParametricStudyTool):
    '''MassDiscCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4076.MassDiscParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4076.MassDiscParametricStudyTool))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4076.MassDiscParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4076.MassDiscParametricStudyTool))
        return value
