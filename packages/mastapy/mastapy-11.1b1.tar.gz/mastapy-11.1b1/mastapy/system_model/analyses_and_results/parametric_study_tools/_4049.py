...
class DutyCycleResultsForAllGearSets(_0.APIBase):
    ...
    @property
    def duty_cycle_results(self) -> '_1153.GearSetGroupDutyCycle':
        ...
        return constructor.new(_1153.GearSetGroupDutyCycle)(self.wrapped.DutyCycleResults) if self.wrapped.DutyCycleResults else None
