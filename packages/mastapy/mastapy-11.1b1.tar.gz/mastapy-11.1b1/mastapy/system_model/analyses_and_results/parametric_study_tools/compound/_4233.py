...
class RollingRingCompoundParametricStudyTool(_4180.CouplingHalfCompoundParametricStudyTool):
    '''RollingRingCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4105.RollingRingParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4105.RollingRingParametricStudyTool))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4105.RollingRingParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4105.RollingRingParametricStudyTool))
        return value
