...
class CylindricalGearParametricStudyTool(_4060.GearParametricStudyTool):
    '''CylindricalGearParametricStudyTool
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2447.CylindricalGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2447.CylindricalGearSystemDeflection))
        return value
