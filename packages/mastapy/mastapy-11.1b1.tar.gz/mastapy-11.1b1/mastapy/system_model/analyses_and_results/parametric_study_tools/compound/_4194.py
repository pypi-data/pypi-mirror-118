...
class FaceGearCompoundParametricStudyTool(_4199.GearCompoundParametricStudyTool):
    '''FaceGearCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4055.FaceGearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4055.FaceGearParametricStudyTool))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4055.FaceGearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4055.FaceGearParametricStudyTool))
        return value
