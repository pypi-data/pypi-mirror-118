...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _6958, _6964
...
class RootAssemblyAdvancedSystemDeflection(_6964.AssemblyAdvancedSystemDeflection):
    '''RootAssemblyAdvancedSystemDeflection
    ...
    @property
    def advanced_system_deflection_inputs(self) -> '_6958.AdvancedSystemDeflection':
        ...
        return constructor.new(_6958.AdvancedSystemDeflection)(self.wrapped.AdvancedSystemDeflectionInputs) if self.wrapped.AdvancedSystemDeflectionInputs else None
