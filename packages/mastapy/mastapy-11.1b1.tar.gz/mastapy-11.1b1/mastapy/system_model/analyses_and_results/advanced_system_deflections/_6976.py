...
class BoltAdvancedSystemDeflection(_6982.ComponentAdvancedSystemDeflection):
    '''BoltAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2412.BoltSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2412.BoltSystemDeflection))
        return value
