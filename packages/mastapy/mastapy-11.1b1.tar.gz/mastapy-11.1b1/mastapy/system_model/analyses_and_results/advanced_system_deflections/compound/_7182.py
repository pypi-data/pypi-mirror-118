...
class RollingRingCompoundAdvancedSystemDeflection(_7129.CouplingHalfCompoundAdvancedSystemDeflection):
    '''RollingRingCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7051.RollingRingAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_7051.RollingRingAdvancedSystemDeflection))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7051.RollingRingAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_7051.RollingRingAdvancedSystemDeflection))
        return value
