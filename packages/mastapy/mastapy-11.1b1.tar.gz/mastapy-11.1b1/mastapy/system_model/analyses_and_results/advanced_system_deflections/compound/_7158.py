...
class KlingelnbergCycloPalloidConicalGearSetCompoundAdvancedSystemDeflection(_7124.ConicalGearSetCompoundAdvancedSystemDeflection):
    '''KlingelnbergCycloPalloidConicalGearSetCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7027.KlingelnbergCycloPalloidConicalGearSetAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_7027.KlingelnbergCycloPalloidConicalGearSetAdvancedSystemDeflection))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7027.KlingelnbergCycloPalloidConicalGearSetAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_7027.KlingelnbergCycloPalloidConicalGearSetAdvancedSystemDeflection))
        return value
