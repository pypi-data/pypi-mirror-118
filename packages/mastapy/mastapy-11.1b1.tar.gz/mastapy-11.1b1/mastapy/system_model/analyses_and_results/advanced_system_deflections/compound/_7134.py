...
from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import _7114
...
class CycloidalDiscCentralBearingConnectionCompoundAdvancedSystemDeflection(_7114.CoaxialConnectionCompoundAdvancedSystemDeflection):
    '''CycloidalDiscCentralBearingConnectionCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7003.CycloidalDiscCentralBearingConnectionAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_7003.CycloidalDiscCentralBearingConnectionAdvancedSystemDeflection))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_7003.CycloidalDiscCentralBearingConnectionAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_7003.CycloidalDiscCentralBearingConnectionAdvancedSystemDeflection))
        return value
