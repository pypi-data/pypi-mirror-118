...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7005, _7009, _7006
...
class CylindricalMeshedGearAdvancedSystemDeflection(_0.APIBase):
    ...
    @property
    def cylindrical_gear_advanced_system_deflection(self) -> '_7005.CylindricalGearAdvancedSystemDeflection':
        ...
        if _7005.CylindricalGearAdvancedSystemDeflection.TYPE not in self.wrapped.CylindricalGearAdvancedSystemDeflection.__class__.__mro__:
    ...
    @property
    def other_cylindrical_gear_advanced_system_deflection(self) -> '_7005.CylindricalGearAdvancedSystemDeflection':
        ...
        if _7005.CylindricalGearAdvancedSystemDeflection.TYPE not in self.wrapped.OtherCylindricalGearAdvancedSystemDeflection.__class__.__mro__:
    ...
    @property
    def cylindrical_gear_mesh_advanced_system_deflection(self) -> '_7006.CylindricalGearMeshAdvancedSystemDeflection':
        ...
        return constructor.new(_7006.CylindricalGearMeshAdvancedSystemDeflection)(self.wrapped.CylindricalGearMeshAdvancedSystemDeflection) if self.wrapped.CylindricalGearMeshAdvancedSystemDeflection else None
