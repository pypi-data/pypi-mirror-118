...
class BevelDifferentialGearAdvancedSystemDeflection(_6973.BevelGearAdvancedSystemDeflection):
    '''BevelDifferentialGearAdvancedSystemDeflection
    ...
    @property
    def component_detailed_analysis(self) -> '_507.BevelGearRating':
        ...
        if _507.BevelGearRating.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2405.BevelDifferentialGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2405.BevelDifferentialGearSystemDeflection))
        return value
