...
class CycloidalDiscPlanetaryBearingConnectionAdvancedSystemDeflection(_6957.AbstractShaftToMountableComponentConnectionAdvancedSystemDeflection):
    '''CycloidalDiscPlanetaryBearingConnectionAdvancedSystemDeflection
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2439.CycloidalDiscPlanetaryBearingConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2439.CycloidalDiscPlanetaryBearingConnectionSystemDeflection))
        return value
