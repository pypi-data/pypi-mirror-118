...
class ShaftAdvancedSystemDeflection(_6955.AbstractShaftAdvancedSystemDeflection):
    '''ShaftAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2506.ShaftSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2506.ShaftSystemDeflection))
        return value
