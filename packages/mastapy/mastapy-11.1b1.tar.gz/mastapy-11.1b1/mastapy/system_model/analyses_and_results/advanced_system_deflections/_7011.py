...
class ExternalCADModelAdvancedSystemDeflection(_6982.ComponentAdvancedSystemDeflection):
    '''ExternalCADModelAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2454.ExternalCADModelSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2454.ExternalCADModelSystemDeflection))
        return value
