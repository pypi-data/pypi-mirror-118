...
class SpringDamperAdvancedSystemDeflection(_6995.CouplingAdvancedSystemDeflection):
    '''SpringDamperAdvancedSystemDeflection
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2514.SpringDamperSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySystemDeflectionResults, constructor.new(_2514.SpringDamperSystemDeflection))
        return value
