...
class GearMeshAdvancedSystemDeflection(_7024.InterMountableComponentConnectionAdvancedSystemDeflection):
    '''GearMeshAdvancedSystemDeflection
    ...
    @property
    def misalignment_fourier_series_for_first_tooth_passing_period(self) -> '_1294.FourierSeries':
        ...
        return constructor.new(_1294.FourierSeries)(self.wrapped.MisalignmentFourierSeriesForFirstToothPassingPeriod) if self.wrapped.MisalignmentFourierSeriesForFirstToothPassingPeriod else None
