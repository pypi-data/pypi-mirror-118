...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7084, _7085, _7019
...
class WormGearSetAdvancedSystemDeflection(_7019.GearSetAdvancedSystemDeflection):
    '''WormGearSetAdvancedSystemDeflection
    ...
    @property
    def worm_gears_advanced_system_deflection(self) -> 'List[_7084.WormGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsAdvancedSystemDeflection, constructor.new(_7084.WormGearAdvancedSystemDeflection))
        return value

    @property
    def worm_meshes_advanced_system_deflection(self) -> 'List[_7085.WormGearMeshAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesAdvancedSystemDeflection, constructor.new(_7085.WormGearMeshAdvancedSystemDeflection))
        return value
