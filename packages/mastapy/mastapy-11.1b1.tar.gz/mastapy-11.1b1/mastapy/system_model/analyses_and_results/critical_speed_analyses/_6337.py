...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6335, _6336, _6243
...
class StraightBevelGearSetCriticalSpeedAnalysis(_6243.BevelGearSetCriticalSpeedAnalysis):
    '''StraightBevelGearSetCriticalSpeedAnalysis
    ...
    @property
    def straight_bevel_gears_critical_speed_analysis(self) -> 'List[_6335.StraightBevelGearCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelGearsCriticalSpeedAnalysis, constructor.new(_6335.StraightBevelGearCriticalSpeedAnalysis))
        return value

    @property
    def straight_bevel_meshes_critical_speed_analysis(self) -> 'List[_6336.StraightBevelGearMeshCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelMeshesCriticalSpeedAnalysis, constructor.new(_6336.StraightBevelGearMeshCriticalSpeedAnalysis))
        return value
