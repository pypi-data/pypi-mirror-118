...
class KlingelnbergCycloPalloidConicalGearSetCompoundCriticalSpeedAnalysis(_6390.ConicalGearSetCompoundCriticalSpeedAnalysis):
    '''KlingelnbergCycloPalloidConicalGearSetCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6295.KlingelnbergCycloPalloidConicalGearSetCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_6295.KlingelnbergCycloPalloidConicalGearSetCriticalSpeedAnalysis))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6295.KlingelnbergCycloPalloidConicalGearSetCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_6295.KlingelnbergCycloPalloidConicalGearSetCriticalSpeedAnalysis))
        return value
