...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6289, _6290, _6231
...
class HypoidGearSetCriticalSpeedAnalysis(_6231.AGMAGleasonConicalGearSetCriticalSpeedAnalysis):
    '''HypoidGearSetCriticalSpeedAnalysis
    ...
    @property
    def hypoid_gears_critical_speed_analysis(self) -> 'List[_6289.HypoidGearCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidGearsCriticalSpeedAnalysis, constructor.new(_6289.HypoidGearCriticalSpeedAnalysis))
        return value

    @property
    def hypoid_meshes_critical_speed_analysis(self) -> 'List[_6290.HypoidGearMeshCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidMeshesCriticalSpeedAnalysis, constructor.new(_6290.HypoidGearMeshCriticalSpeedAnalysis))
        return value
