...
class MeasurementComponentCompoundCriticalSpeedAnalysis(_6478.VirtualComponentCompoundCriticalSpeedAnalysis):
    '''MeasurementComponentCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6303.MeasurementComponentCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6303.MeasurementComponentCriticalSpeedAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_6303.MeasurementComponentCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6303.MeasurementComponentCriticalSpeedAnalysis))
        return value
