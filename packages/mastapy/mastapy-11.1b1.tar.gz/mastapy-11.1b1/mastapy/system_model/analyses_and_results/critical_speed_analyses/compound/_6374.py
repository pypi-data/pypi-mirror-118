...
class BevelGearSetCompoundCriticalSpeedAnalysis(_6362.AGMAGleasonConicalGearSetCompoundCriticalSpeedAnalysis):
    '''BevelGearSetCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6243.BevelGearSetCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_6243.BevelGearSetCriticalSpeedAnalysis))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6243.BevelGearSetCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_6243.BevelGearSetCriticalSpeedAnalysis))
        return value
