...
class PlanetaryGearSetCompoundCriticalSpeedAnalysis(_6405.CylindricalGearSetCompoundCriticalSpeedAnalysis):
    '''PlanetaryGearSetCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6311.PlanetaryGearSetCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_6311.PlanetaryGearSetCriticalSpeedAnalysis))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_6311.PlanetaryGearSetCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_6311.PlanetaryGearSetCriticalSpeedAnalysis))
        return value
