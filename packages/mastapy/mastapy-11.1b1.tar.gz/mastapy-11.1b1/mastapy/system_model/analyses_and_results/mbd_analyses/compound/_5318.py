...
class ShaftToMountableComponentConnectionCompoundMultibodyDynamicsAnalysis(_5224.AbstractShaftToMountableComponentConnectionCompoundMultibodyDynamicsAnalysis):
    '''ShaftToMountableComponentConnectionCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5179.ShaftToMountableComponentConnectionMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_5179.ShaftToMountableComponentConnectionMultibodyDynamicsAnalysis))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_5179.ShaftToMountableComponentConnectionMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_5179.ShaftToMountableComponentConnectionMultibodyDynamicsAnalysis))
        return value
