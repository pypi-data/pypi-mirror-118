...
from mastapy.system_model.analyses_and_results.mbd_analyses.compound import _5336
...
class SynchroniserSleeveCompoundMultibodyDynamicsAnalysis(_5336.SynchroniserPartCompoundMultibodyDynamicsAnalysis):
    '''SynchroniserSleeveCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5199.SynchroniserSleeveMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5199.SynchroniserSleeveMultibodyDynamicsAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_5199.SynchroniserSleeveMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5199.SynchroniserSleeveMultibodyDynamicsAnalysis))
        return value
