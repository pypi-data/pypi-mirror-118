...
from mastapy.system_model.analyses_and_results.mbd_analyses.compound import _5268
...
class CylindricalPlanetGearCompoundMultibodyDynamicsAnalysis(_5268.CylindricalGearCompoundMultibodyDynamicsAnalysis):
    '''CylindricalPlanetGearCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5122.CylindricalPlanetGearMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5122.CylindricalPlanetGearMultibodyDynamicsAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_5122.CylindricalPlanetGearMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5122.CylindricalPlanetGearMultibodyDynamicsAnalysis))
        return value
