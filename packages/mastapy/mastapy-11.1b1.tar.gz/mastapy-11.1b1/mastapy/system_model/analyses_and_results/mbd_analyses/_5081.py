...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5168, _5181
...
class BeltDriveMultibodyDynamicsAnalysis(_5181.SpecialisedAssemblyMultibodyDynamicsAnalysis):
    '''BeltDriveMultibodyDynamicsAnalysis
    ...
    @property
    def pulleys(self) -> 'List[_5168.PulleyMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Pulleys, constructor.new(_5168.PulleyMultibodyDynamicsAnalysis))
        return value
