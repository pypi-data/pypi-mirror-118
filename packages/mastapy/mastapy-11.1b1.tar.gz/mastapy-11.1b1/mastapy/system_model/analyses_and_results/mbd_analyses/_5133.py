...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5132, _5130, _5181
...
class GearSetMultibodyDynamicsAnalysis(_5181.SpecialisedAssemblyMultibodyDynamicsAnalysis):
    '''GearSetMultibodyDynamicsAnalysis
    ...
    @property
    def gears(self) -> 'List[_5132.GearMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_5132.GearMultibodyDynamicsAnalysis))
        return value

    @property
    def meshes(self) -> 'List[_5130.GearMeshMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Meshes, constructor.new(_5130.GearMeshMultibodyDynamicsAnalysis))
        return value
