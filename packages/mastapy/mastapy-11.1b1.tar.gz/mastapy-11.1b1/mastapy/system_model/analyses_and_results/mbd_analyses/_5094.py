...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5092, _5111
...
class ClutchMultibodyDynamicsAnalysis(_5111.CouplingMultibodyDynamicsAnalysis):
    '''ClutchMultibodyDynamicsAnalysis
    ...
    @property
    def clutch_connection(self) -> '_5092.ClutchConnectionMultibodyDynamicsAnalysis':
        ...
        return constructor.new(_5092.ClutchConnectionMultibodyDynamicsAnalysis)(self.wrapped.ClutchConnection) if self.wrapped.ClutchConnection else None
