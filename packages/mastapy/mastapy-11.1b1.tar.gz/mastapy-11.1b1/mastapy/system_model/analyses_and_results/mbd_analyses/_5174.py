...
from mastapy.system_model.analyses_and_results.mbd_analyses import _2346, _5077
...
class RootAssemblyMultibodyDynamicsAnalysis(_5077.AssemblyMultibodyDynamicsAnalysis):
    '''RootAssemblyMultibodyDynamicsAnalysis
    ...
    @property
    def multibody_dynamics_analysis_inputs(self) -> '_2346.MultibodyDynamicsAnalysis':
        ...
        return constructor.new(_2346.MultibodyDynamicsAnalysis)(self.wrapped.MultibodyDynamicsAnalysisInputs) if self.wrapped.MultibodyDynamicsAnalysisInputs else None
