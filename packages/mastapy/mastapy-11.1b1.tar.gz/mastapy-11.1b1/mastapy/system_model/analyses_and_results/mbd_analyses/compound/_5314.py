...
class RollingRingConnectionCompoundMultibodyDynamicsAnalysis(_5286.InterMountableComponentConnectionCompoundMultibodyDynamicsAnalysis):
    '''RollingRingConnectionCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5172.RollingRingConnectionMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_5172.RollingRingConnectionMultibodyDynamicsAnalysis))
        return value
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5172.RollingRingConnectionMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_5172.RollingRingConnectionMultibodyDynamicsAnalysis))
        return value
