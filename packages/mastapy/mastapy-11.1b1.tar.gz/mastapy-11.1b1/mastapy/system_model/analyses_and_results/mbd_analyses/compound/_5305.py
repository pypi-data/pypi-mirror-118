...
from mastapy.system_model.analyses_and_results.mbd_analyses.compound import _5270
...
class PlanetaryGearSetCompoundMultibodyDynamicsAnalysis(_5270.CylindricalGearSetCompoundMultibodyDynamicsAnalysis):
    '''PlanetaryGearSetCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5164.PlanetaryGearSetMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_5164.PlanetaryGearSetMultibodyDynamicsAnalysis))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_5164.PlanetaryGearSetMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_5164.PlanetaryGearSetMultibodyDynamicsAnalysis))
        return value
