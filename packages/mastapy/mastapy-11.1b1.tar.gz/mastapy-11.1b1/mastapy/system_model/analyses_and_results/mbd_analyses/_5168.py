...
from mastapy.system_model.analyses_and_results.mbd_analyses.reporting import _5218
...
class PulleyMultibodyDynamicsAnalysis(_5110.CouplingHalfMultibodyDynamicsAnalysis):
    '''PulleyMultibodyDynamicsAnalysis
    ...
    @property
    def peak_pulley_torque(self) -> 'List[_5218.DynamicTorqueResultAtTime]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PeakPulleyTorque, constructor.new(_5218.DynamicTorqueResultAtTime))
        return value
