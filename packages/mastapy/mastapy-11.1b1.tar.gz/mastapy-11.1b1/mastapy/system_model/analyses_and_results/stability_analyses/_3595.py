...
from mastapy.system_model.analyses_and_results.stability_analyses import _3596, _3594, _3482
...
class ZerolBevelGearSetStabilityAnalysis(_3482.BevelGearSetStabilityAnalysis):
    '''ZerolBevelGearSetStabilityAnalysis
    ...
    @property
    def zerol_bevel_gears_stability_analysis(self) -> 'List[_3596.ZerolBevelGearStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelGearsStabilityAnalysis, constructor.new(_3596.ZerolBevelGearStabilityAnalysis))
        return value

    @property
    def zerol_bevel_meshes_stability_analysis(self) -> 'List[_3594.ZerolBevelGearMeshStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelMeshesStabilityAnalysis, constructor.new(_3594.ZerolBevelGearMeshStabilityAnalysis))
        return value
