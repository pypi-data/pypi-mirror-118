...
from mastapy.system_model.analyses_and_results.stability_analyses import _3496, _3494, _3525
...
class ConceptGearSetStabilityAnalysis(_3525.GearSetStabilityAnalysis):
    '''ConceptGearSetStabilityAnalysis
    ...
    @property
    def concept_gears_stability_analysis(self) -> 'List[_3496.ConceptGearStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearsStabilityAnalysis, constructor.new(_3496.ConceptGearStabilityAnalysis))
        return value

    @property
    def concept_meshes_stability_analysis(self) -> 'List[_3494.ConceptGearMeshStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshesStabilityAnalysis, constructor.new(_3494.ConceptGearMeshStabilityAnalysis))
        return value
