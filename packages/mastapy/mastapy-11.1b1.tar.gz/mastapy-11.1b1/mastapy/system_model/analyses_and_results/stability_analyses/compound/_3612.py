...
class BevelDifferentialSunGearCompoundStabilityAnalysis(_3608.BevelDifferentialGearCompoundStabilityAnalysis):
    '''BevelDifferentialSunGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3480.BevelDifferentialSunGearStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3480.BevelDifferentialSunGearStabilityAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3480.BevelDifferentialSunGearStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3480.BevelDifferentialSunGearStabilityAnalysis))
        return value
