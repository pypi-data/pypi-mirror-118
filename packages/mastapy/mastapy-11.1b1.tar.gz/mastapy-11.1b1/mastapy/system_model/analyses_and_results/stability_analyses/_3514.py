...
from mastapy.system_model.analyses_and_results.stability_analyses import _3515, _3513, _3525
...
class CylindricalGearSetStabilityAnalysis(_3525.GearSetStabilityAnalysis):
    '''CylindricalGearSetStabilityAnalysis
    ...
    @property
    def cylindrical_gears_stability_analysis(self) -> 'List[_3515.CylindricalGearStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearsStabilityAnalysis, constructor.new(_3515.CylindricalGearStabilityAnalysis))
        return value

    @property
    def cylindrical_meshes_stability_analysis(self) -> 'List[_3513.CylindricalGearMeshStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshesStabilityAnalysis, constructor.new(_3513.CylindricalGearMeshStabilityAnalysis))
        return value
