...
from mastapy.system_model.analyses_and_results.stability_analyses import _2349, _3472
...
class RootAssemblyStabilityAnalysis(_3472.AssemblyStabilityAnalysis):
    '''RootAssemblyStabilityAnalysis
    ...
    @property
    def stability_analysis_inputs(self) -> '_2349.StabilityAnalysis':
        ...
        return constructor.new(_2349.StabilityAnalysis)(self.wrapped.StabilityAnalysisInputs) if self.wrapped.StabilityAnalysisInputs else None
