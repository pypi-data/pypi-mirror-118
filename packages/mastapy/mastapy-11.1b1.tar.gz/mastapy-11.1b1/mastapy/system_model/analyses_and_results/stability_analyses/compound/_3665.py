...
class KlingelnbergCycloPalloidConicalGearSetCompoundStabilityAnalysis(_3631.ConicalGearSetCompoundStabilityAnalysis):
    '''KlingelnbergCycloPalloidConicalGearSetCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3533.KlingelnbergCycloPalloidConicalGearSetStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_3533.KlingelnbergCycloPalloidConicalGearSetStabilityAnalysis))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3533.KlingelnbergCycloPalloidConicalGearSetStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_3533.KlingelnbergCycloPalloidConicalGearSetStabilityAnalysis))
        return value
