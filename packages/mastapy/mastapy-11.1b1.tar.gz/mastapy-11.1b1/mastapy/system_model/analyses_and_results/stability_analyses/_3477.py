...
from mastapy.system_model.analyses_and_results.stability_analyses import _3478, _3476, _3482
...
class BevelDifferentialGearSetStabilityAnalysis(_3482.BevelGearSetStabilityAnalysis):
    '''BevelDifferentialGearSetStabilityAnalysis
    ...
    @property
    def bevel_differential_gears_stability_analysis(self) -> 'List[_3478.BevelDifferentialGearStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelDifferentialGearsStabilityAnalysis, constructor.new(_3478.BevelDifferentialGearStabilityAnalysis))
        return value

    @property
    def bevel_differential_meshes_stability_analysis(self) -> 'List[_3476.BevelDifferentialGearMeshStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelDifferentialMeshesStabilityAnalysis, constructor.new(_3476.BevelDifferentialGearMeshStabilityAnalysis))
        return value
