...
class CouplingCompoundPowerFlow(_3963.SpecialisedAssemblyCompoundPowerFlow):
    '''CouplingCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3771.CouplingPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_3771.CouplingPowerFlow))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3771.CouplingPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_3771.CouplingPowerFlow))
        return value
