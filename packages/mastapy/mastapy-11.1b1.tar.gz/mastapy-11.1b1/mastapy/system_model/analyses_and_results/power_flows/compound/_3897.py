...
class ConicalGearCompoundPowerFlow(_3923.GearCompoundPowerFlow):
    '''ConicalGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3765.ConicalGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3765.ConicalGearPowerFlow))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_3765.ConicalGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3765.ConicalGearPowerFlow))
        return value
