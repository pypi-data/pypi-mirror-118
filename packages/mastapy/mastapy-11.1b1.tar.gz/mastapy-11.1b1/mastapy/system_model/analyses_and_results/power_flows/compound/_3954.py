...
class RingPinsCompoundPowerFlow(_3942.MountableComponentCompoundPowerFlow):
    '''RingPinsCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3824.RingPinsPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3824.RingPinsPowerFlow))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3824.RingPinsPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3824.RingPinsPowerFlow))
        return value
