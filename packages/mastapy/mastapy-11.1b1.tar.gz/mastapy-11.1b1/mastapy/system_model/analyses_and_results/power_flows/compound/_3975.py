...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3973, _3974, _3883
...
class StraightBevelGearSetCompoundPowerFlow(_3883.BevelGearSetCompoundPowerFlow):
    '''StraightBevelGearSetCompoundPowerFlow
    ...
    @property
    def straight_bevel_gears_compound_power_flow(self) -> 'List[_3973.StraightBevelGearCompoundPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelGearsCompoundPowerFlow, constructor.new(_3973.StraightBevelGearCompoundPowerFlow))
        return value

    @property
    def straight_bevel_meshes_compound_power_flow(self) -> 'List[_3974.StraightBevelGearMeshCompoundPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelMeshesCompoundPowerFlow, constructor.new(_3974.StraightBevelGearMeshCompoundPowerFlow))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3845.StraightBevelGearSetPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_3845.StraightBevelGearSetPowerFlow))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_3845.StraightBevelGearSetPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_3845.StraightBevelGearSetPowerFlow))
        return value
