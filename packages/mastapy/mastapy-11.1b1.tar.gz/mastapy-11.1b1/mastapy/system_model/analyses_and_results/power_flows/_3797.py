...
from mastapy.system_model.analyses_and_results.power_flows import _3796, _3795, _3738
...
class HypoidGearSetPowerFlow(_3738.AGMAGleasonConicalGearSetPowerFlow):
    '''HypoidGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self) -> 'List[_3796.HypoidGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearsPowerFlow, constructor.new(_3796.HypoidGearPowerFlow))
        return value

    @property
    def hypoid_gears_power_flow(self) -> 'List[_3796.HypoidGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidGearsPowerFlow, constructor.new(_3796.HypoidGearPowerFlow))
        return value

    @property
    def meshes_power_flow(self) -> 'List[_3795.HypoidGearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshesPowerFlow, constructor.new(_3795.HypoidGearMeshPowerFlow))
        return value

    @property
    def hypoid_meshes_power_flow(self) -> 'List[_3795.HypoidGearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidMeshesPowerFlow, constructor.new(_3795.HypoidGearMeshPowerFlow))
        return value
