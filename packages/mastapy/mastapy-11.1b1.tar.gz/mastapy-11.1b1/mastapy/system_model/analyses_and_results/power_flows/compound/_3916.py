...
class DatumCompoundPowerFlow(_3890.ComponentCompoundPowerFlow):
    '''DatumCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3784.DatumPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3784.DatumPowerFlow))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3784.DatumPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3784.DatumPowerFlow))
        return value
