...
from mastapy.system_model.analyses_and_results.power_flows import _3753, _3849
...
class SynchroniserHalfPowerFlow(_3849.SynchroniserPartPowerFlow):
    '''SynchroniserHalfPowerFlow
    ...
    @property
    def clutch_connection(self) -> '_3753.ClutchConnectionPowerFlow':
        ...
        return constructor.new(_3753.ClutchConnectionPowerFlow)(self.wrapped.ClutchConnection) if self.wrapped.ClutchConnection else None
