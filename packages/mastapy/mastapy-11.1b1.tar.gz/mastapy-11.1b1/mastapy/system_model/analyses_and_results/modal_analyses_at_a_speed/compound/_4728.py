...
class KlingelnbergCycloPalloidHypoidGearMeshCompoundModalAnalysisAtASpeed(_4725.KlingelnbergCycloPalloidConicalGearMeshCompoundModalAnalysisAtASpeed):
    '''KlingelnbergCycloPalloidHypoidGearMeshCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4598.KlingelnbergCycloPalloidHypoidGearMeshModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4598.KlingelnbergCycloPalloidHypoidGearMeshModalAnalysisAtASpeed))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_4598.KlingelnbergCycloPalloidHypoidGearMeshModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4598.KlingelnbergCycloPalloidHypoidGearMeshModalAnalysisAtASpeed))
        return value
