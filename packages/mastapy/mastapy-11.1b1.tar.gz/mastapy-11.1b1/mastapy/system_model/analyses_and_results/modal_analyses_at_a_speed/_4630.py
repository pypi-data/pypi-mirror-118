...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4629, _4628, _4547
...
class SpiralBevelGearSetModalAnalysisAtASpeed(_4547.BevelGearSetModalAnalysisAtASpeed):
    '''SpiralBevelGearSetModalAnalysisAtASpeed
    ...
    @property
    def spiral_bevel_gears_modal_analysis_at_a_speed(self) -> 'List[_4629.SpiralBevelGearModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelGearsModalAnalysisAtASpeed, constructor.new(_4629.SpiralBevelGearModalAnalysisAtASpeed))
        return value

    @property
    def spiral_bevel_meshes_modal_analysis_at_a_speed(self) -> 'List[_4628.SpiralBevelGearMeshModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelMeshesModalAnalysisAtASpeed, constructor.new(_4628.SpiralBevelGearMeshModalAnalysisAtASpeed))
        return value
