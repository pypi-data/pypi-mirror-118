...
class StraightBevelPlanetGearCompoundModalAnalysisAtASpeed(_4763.StraightBevelDiffGearCompoundModalAnalysisAtASpeed):
    '''StraightBevelPlanetGearCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4640.StraightBevelPlanetGearModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4640.StraightBevelPlanetGearModalAnalysisAtASpeed))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4640.StraightBevelPlanetGearModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4640.StraightBevelPlanetGearModalAnalysisAtASpeed))
        return value
