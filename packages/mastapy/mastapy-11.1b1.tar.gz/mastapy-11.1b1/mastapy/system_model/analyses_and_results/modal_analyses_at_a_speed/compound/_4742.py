...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed.compound import _4707
...
class PlanetaryGearSetCompoundModalAnalysisAtASpeed(_4707.CylindricalGearSetCompoundModalAnalysisAtASpeed):
    '''PlanetaryGearSetCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4613.PlanetaryGearSetModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_4613.PlanetaryGearSetModalAnalysisAtASpeed))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_4613.PlanetaryGearSetModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_4613.PlanetaryGearSetModalAnalysisAtASpeed))
        return value
