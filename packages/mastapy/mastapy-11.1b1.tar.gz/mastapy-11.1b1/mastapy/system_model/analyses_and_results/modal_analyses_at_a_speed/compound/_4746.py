...
class PulleyCompoundModalAnalysisAtASpeed(_4697.CouplingHalfCompoundModalAnalysisAtASpeed):
    '''PulleyCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4617.PulleyModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4617.PulleyModalAnalysisAtASpeed))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4617.PulleyModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4617.PulleyModalAnalysisAtASpeed))
        return value
