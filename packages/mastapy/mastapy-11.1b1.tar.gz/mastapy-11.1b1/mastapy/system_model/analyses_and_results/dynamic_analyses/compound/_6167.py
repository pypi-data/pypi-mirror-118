...
class MountableComponentCompoundDynamicAnalysis(_6115.ComponentCompoundDynamicAnalysis):
    '''MountableComponentCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6038.MountableComponentDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6038.MountableComponentDynamicAnalysis))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_6038.MountableComponentDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6038.MountableComponentDynamicAnalysis))
        return value
