...
class BevelDifferentialSunGearCompoundDynamicAnalysis(_6101.BevelDifferentialGearCompoundDynamicAnalysis):
    '''BevelDifferentialSunGearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5975.BevelDifferentialSunGearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5975.BevelDifferentialSunGearDynamicAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_5975.BevelDifferentialSunGearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5975.BevelDifferentialSunGearDynamicAnalysis))
        return value
