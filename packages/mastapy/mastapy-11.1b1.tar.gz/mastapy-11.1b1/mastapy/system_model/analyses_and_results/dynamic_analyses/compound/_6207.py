...
class TorqueConverterCompoundDynamicAnalysis(_6127.CouplingCompoundDynamicAnalysis):
    '''TorqueConverterCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6079.TorqueConverterDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_6079.TorqueConverterDynamicAnalysis))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_6079.TorqueConverterDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_6079.TorqueConverterDynamicAnalysis))
        return value
