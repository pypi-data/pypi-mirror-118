...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6066, _6067, _5978
...
class StraightBevelDiffGearSetDynamicAnalysis(_5978.BevelGearSetDynamicAnalysis):
    '''StraightBevelDiffGearSetDynamicAnalysis
    ...
    @property
    def straight_bevel_diff_gears_dynamic_analysis(self) -> 'List[_6066.StraightBevelDiffGearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffGearsDynamicAnalysis, constructor.new(_6066.StraightBevelDiffGearDynamicAnalysis))
        return value

    @property
    def straight_bevel_diff_meshes_dynamic_analysis(self) -> 'List[_6067.StraightBevelDiffGearMeshDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshesDynamicAnalysis, constructor.new(_6067.StraightBevelDiffGearMeshDynamicAnalysis))
        return value
