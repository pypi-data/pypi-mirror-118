...
class ConceptCouplingCompoundDynamicAnalysis(_6127.CouplingCompoundDynamicAnalysis):
    '''ConceptCouplingCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5987.ConceptCouplingDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_5987.ConceptCouplingDynamicAnalysis))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_5987.ConceptCouplingDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_5987.ConceptCouplingDynamicAnalysis))
        return value
