...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6060, _6061, _5978
...
class SpiralBevelGearSetDynamicAnalysis(_5978.BevelGearSetDynamicAnalysis):
    '''SpiralBevelGearSetDynamicAnalysis
    ...
    @property
    def spiral_bevel_gears_dynamic_analysis(self) -> 'List[_6060.SpiralBevelGearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelGearsDynamicAnalysis, constructor.new(_6060.SpiralBevelGearDynamicAnalysis))
        return value

    @property
    def spiral_bevel_meshes_dynamic_analysis(self) -> 'List[_6061.SpiralBevelGearMeshDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelMeshesDynamicAnalysis, constructor.new(_6061.SpiralBevelGearMeshDynamicAnalysis))
        return value
