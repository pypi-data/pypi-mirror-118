...
class GuideDxfModelCompoundDynamicAnalysis(_6115.ComponentCompoundDynamicAnalysis):
    '''GuideDxfModelCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6022.GuideDxfModelDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6022.GuideDxfModelDynamicAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_6022.GuideDxfModelDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6022.GuideDxfModelDynamicAnalysis))
        return value
