...
from mastapy.system_model.analyses_and_results.flexible_pin_analyses import _5952
...
class FlexiblePinAnalysisStopStartAnalysis(_5952.FlexiblePinAnalysis):
    '''FlexiblePinAnalysisStopStartAnalysis
    ...
    @property
    def shaft_nominal_load_case(self) -> '_2506.ShaftSystemDeflection':
        ...
        return constructor.new(_2506.ShaftSystemDeflection)(self.wrapped.ShaftNominalLoadCase) if self.wrapped.ShaftNominalLoadCase else None

    @property
    def shaft_extreme_load_case(self) -> '_2506.ShaftSystemDeflection':
        ...
        return constructor.new(_2506.ShaftSystemDeflection)(self.wrapped.ShaftExtremeLoadCase) if self.wrapped.ShaftExtremeLoadCase else None
