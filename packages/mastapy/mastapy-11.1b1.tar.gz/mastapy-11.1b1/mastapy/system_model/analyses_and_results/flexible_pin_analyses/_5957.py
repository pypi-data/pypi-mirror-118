...
class FlexiblePinAnalysisOptions(_0.APIBase):
    ...
    @property
    def extreme_load_case_for_stop_start(self) -> '_6486.StaticLoadCase':
        '''StaticLoadCase: 'ExtremeLoadCaseForStopStart' is the original name of this property.'''

        if _6486.StaticLoadCase.TYPE not in self.wrapped.ExtremeLoadCaseForStopStart.__class__.__mro__:
    ...
    def extreme_load_case_for_stop_start(self, value: '_6486.StaticLoadCase'):
    ...
    @property
    def nominal_load_case_for_stop_start(self) -> '_6486.StaticLoadCase':
        '''StaticLoadCase: 'NominalLoadCaseForStopStart' is the original name of this property.'''

        if _6486.StaticLoadCase.TYPE not in self.wrapped.NominalLoadCaseForStopStart.__class__.__mro__:
    ...
    def nominal_load_case_for_stop_start(self, value: '_6486.StaticLoadCase'):
        value = value.wrapped if value else None
