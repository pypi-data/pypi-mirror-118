...
from mastapy.system_model import _1918
...
class ConceptCouplingLoadCase(_6534.CouplingLoadCase):
    '''ConceptCouplingLoadCase
    ...
    @property
    def speed_ratio_specification_method(self) -> '_1918.ConceptCouplingSpeedRatioSpecificationMethod':
        ...
        return constructor.new(_1918.ConceptCouplingSpeedRatioSpecificationMethod)(value) if value else None

    @speed_ratio_specification_method.setter
    def speed_ratio_specification_method(self, value: '_1918.ConceptCouplingSpeedRatioSpecificationMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.SpeedRatioSpecificationMethod = value

    @property
    def speed_ratio_vs_time(self) -> '_1315.Vector2DListAccessor':
        ...
        return constructor.new(_1315.Vector2DListAccessor)(self.wrapped.SpeedRatioVsTime) if self.wrapped.SpeedRatioVsTime else None
    ...
    @property
    def speed_ratio_pid_control(self) -> '_1355.PIDControlSettings':
        ...
        return constructor.new(_1355.PIDControlSettings)(self.wrapped.SpeedRatioPIDControl) if self.wrapped.SpeedRatioPIDControl else None
