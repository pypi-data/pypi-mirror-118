...
from mastapy.system_model.analyses_and_results.static_loads import _6599, _6600, _6598
...
class KlingelnbergCycloPalloidHypoidGearSetLoadCase(_6598.KlingelnbergCycloPalloidConicalGearSetLoadCase):
    '''KlingelnbergCycloPalloidHypoidGearSetLoadCase
    ...
    @property
    def gears(self) -> 'List[_6599.KlingelnbergCycloPalloidHypoidGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_6599.KlingelnbergCycloPalloidHypoidGearLoadCase))
        return value

    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_load_case(self) -> 'List[_6599.KlingelnbergCycloPalloidHypoidGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergCycloPalloidHypoidGearsLoadCase, constructor.new(_6599.KlingelnbergCycloPalloidHypoidGearLoadCase))
        return value

    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_load_case(self) -> 'List[_6600.KlingelnbergCycloPalloidHypoidGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergCycloPalloidHypoidMeshesLoadCase, constructor.new(_6600.KlingelnbergCycloPalloidHypoidGearMeshLoadCase))
        return value
