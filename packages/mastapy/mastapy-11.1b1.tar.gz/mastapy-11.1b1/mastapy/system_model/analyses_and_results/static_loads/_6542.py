...
from mastapy.system_model.analyses_and_results.static_loads import _6543, _6572
...
class CylindricalGearLoadCase(_6572.GearLoadCase):
    '''CylindricalGearLoadCase
    ...
    @property
    def gear_manufacture_errors(self) -> '_6543.CylindricalGearManufactureError':
        ...
        return constructor.new(_6543.CylindricalGearManufactureError)(self.wrapped.GearManufactureErrors) if self.wrapped.GearManufactureErrors else None

    @property
    def overridden_micro_geometry(self) -> '_1034.CylindricalGearMicroGeometry':
        ...
        return constructor.new(_1034.CylindricalGearMicroGeometry)(self.wrapped.OverriddenMicroGeometry) if self.wrapped.OverriddenMicroGeometry else None
