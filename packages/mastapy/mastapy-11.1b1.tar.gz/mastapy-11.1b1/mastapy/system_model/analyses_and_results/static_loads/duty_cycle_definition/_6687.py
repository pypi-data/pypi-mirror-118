...
from mastapy.system_model.analyses_and_results.static_loads.duty_cycle_definition import (
    _6677, _6688, _6679, _6676,
    _6680, _6682, _6689, _6686,
    _6678, _6681, _6675
)
...
class TimeSeriesImporter(_0.APIBase):
    ...
    @property
    def import_type(self) -> '_6592.ImportType':
        '''ImportType: 'ImportType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.ImportType)
        return constructor.new(_6592.ImportType)(value) if value else None

    @import_type.setter
    def import_type(self, value: '_6592.ImportType'):
    ...
    @property
    def time_step_input(self) -> '_6688.TimeStepInputOptions':
        ...
        return constructor.new(_6688.TimeStepInputOptions)(self.wrapped.TimeStepInput) if self.wrapped.TimeStepInput else None

    @property
    def gear_ratio_options(self) -> '_6679.GearRatioInputOptions':
        ...
        return constructor.new(_6679.GearRatioInputOptions)(self.wrapped.GearRatioOptions) if self.wrapped.GearRatioOptions else None

    @property
    def design_state_options(self) -> '_6676.DesignStateOptions':
        ...
        return constructor.new(_6676.DesignStateOptions)(self.wrapped.DesignStateOptions) if self.wrapped.DesignStateOptions else None

    @property
    def load_case_name_inputs(self) -> '_6680.LoadCaseNameOptions':
        ...
        return constructor.new(_6680.LoadCaseNameOptions)(self.wrapped.LoadCaseNameInputs) if self.wrapped.LoadCaseNameInputs else None

    @property
    def file_inputs(self) -> 'List[_6682.MultiTimeSeriesDataInputFileOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FileInputs, constructor.new(_6682.MultiTimeSeriesDataInputFileOptions))
        return value

    @property
    def torque_inputs(self) -> 'List[_6689.TorqueInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.TorqueInputs, constructor.new(_6689.TorqueInputOptions))
        return value

    @property
    def speed_inputs(self) -> 'List[_6686.SpeedInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpeedInputs, constructor.new(_6686.SpeedInputOptions))
        return value

    @property
    def force_inputs(self) -> 'List[_6678.ForceInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ForceInputs, constructor.new(_6678.ForceInputOptions))
        return value

    @property
    def moment_inputs(self) -> 'List[_6681.MomentInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MomentInputs, constructor.new(_6681.MomentInputOptions))
        return value

    @property
    def boost_pressure_inputs(self) -> 'List[_6675.BoostPressureLoadCaseInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BoostPressureInputs, constructor.new(_6675.BoostPressureLoadCaseInputOptions))
        return value

    @property
    def columns(self) -> 'List[_1566.ColumnTitle]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Columns, constructor.new(_1566.ColumnTitle))
        return value
