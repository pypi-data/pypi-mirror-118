...
class GearLoadCase(_6609.MountableComponentLoadCase):
    '''GearLoadCase
    ...
    @property
    def gear_manufacture_errors(self) -> '_6573.GearManufactureError':
        ...
        if _6573.GearManufactureError.TYPE not in self.wrapped.GearManufactureErrors.__class__.__mro__:
    ...
    @property
    def gear_manufacture_errors_of_type_conical_gear_manufacture_error(self) -> '_6526.ConicalGearManufactureError':
        ...
        if _6526.ConicalGearManufactureError.TYPE not in self.wrapped.GearManufactureErrors.__class__.__mro__:
    ...
    @property
    def gear_manufacture_errors_of_type_cylindrical_gear_manufacture_error(self) -> '_6543.CylindricalGearManufactureError':
        ...
        if _6543.CylindricalGearManufactureError.TYPE not in self.wrapped.GearManufactureErrors.__class__.__mro__:
