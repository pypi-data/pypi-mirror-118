...
from mastapy.system_model.analyses_and_results.static_loads import _6566, _6567, _6577
...
class FaceGearSetLoadCase(_6577.GearSetLoadCase):
    '''FaceGearSetLoadCase
    ...
    @property
    def gears(self) -> 'List[_6566.FaceGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_6566.FaceGearLoadCase))
        return value

    @property
    def face_gears_load_case(self) -> 'List[_6566.FaceGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGearsLoadCase, constructor.new(_6566.FaceGearLoadCase))
        return value

    @property
    def face_meshes_load_case(self) -> 'List[_6567.FaceGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshesLoadCase, constructor.new(_6567.FaceGearMeshLoadCase))
        return value
