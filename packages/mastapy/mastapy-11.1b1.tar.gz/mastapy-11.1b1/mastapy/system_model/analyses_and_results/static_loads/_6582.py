...
from mastapy.system_model.analyses_and_results.static_loads import _6610, _6584, _6560
...
class HarmonicLoadDataExcelImport(_6584.HarmonicLoadDataImportBase['_6560.ElectricMachineHarmonicLoadExcelImportOptions']):
    '''HarmonicLoadDataExcelImport
    ...
    @property
    def speeds(self) -> 'List[_6610.NamedSpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Speeds, constructor.new(_6610.NamedSpeed))
        return value
