...
from mastapy.system_model.analyses_and_results.static_loads import _6554, _6562
...
class ElectricMachineHarmonicLoadDataFromMotorPackages(_6554.ElectricMachineHarmonicLoadData, Generic[T]):
    '''ElectricMachineHarmonicLoadDataFromMotorPackages
