...
from mastapy.system_model.analyses_and_results.static_loads import _6588, _6584, _6562
...
class HarmonicLoadDataImportFromMotorPackages(_6584.HarmonicLoadDataImportBase['T'], Generic[T]):
    '''HarmonicLoadDataImportFromMotorPackages
