...
class RootAssemblyLoadCase(_6500.AssemblyLoadCase):
    '''RootAssemblyLoadCase
    ...
    @property
    def drive_cycle_pid_control_settings(self) -> '_1355.PIDControlSettings':
        ...
        return constructor.new(_1355.PIDControlSettings)(self.wrapped.DriveCyclePIDControlSettings) if self.wrapped.DriveCyclePIDControlSettings else None
    ...
    @property
    def supercharger_rotor_sets(self) -> 'List[_6546.CylindricalGearSetLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SuperchargerRotorSets, constructor.new(_6546.CylindricalGearSetLoadCase))
        return value
