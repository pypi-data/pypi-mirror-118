...
class GearSetHarmonicLoadData(_6580.HarmonicLoadDataBase):
    '''GearSetHarmonicLoadData
    ...
    @property
    def gear_mesh_te_order_type(self) -> '_6575.GearMeshTEOrderType':
        ...
        return constructor.new(_6575.GearMeshTEOrderType)(value) if value else None

    @gear_mesh_te_order_type.setter
    def gear_mesh_te_order_type(self, value: '_6575.GearMeshTEOrderType'):
