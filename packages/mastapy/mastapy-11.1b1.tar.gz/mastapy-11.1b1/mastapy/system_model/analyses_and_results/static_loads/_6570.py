...
class FlexiblePinAssemblyLoadCase(_6637.SpecialisedAssemblyLoadCase):
    '''FlexiblePinAssemblyLoadCase
    ...
    @property
    def include_inner_race_distortion_for_flexible_pin_spindle(self) -> '_1367.LoadCaseOverrideOption':
    ...
    def include_inner_race_distortion_for_flexible_pin_spindle(self, value: '_1367.LoadCaseOverrideOption'):
