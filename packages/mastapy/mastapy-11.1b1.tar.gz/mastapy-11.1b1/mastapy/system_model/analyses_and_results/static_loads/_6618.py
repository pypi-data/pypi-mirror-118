...
class PlanetaryGearSetLoadCase(_6546.CylindricalGearSetLoadCase):
    '''PlanetaryGearSetLoadCase
    ...
    @property
    def include_gear_blank_elastic_distortion(self) -> '_1367.LoadCaseOverrideOption':
    ...
    def include_gear_blank_elastic_distortion(self, value: '_1367.LoadCaseOverrideOption'):
    ...
    @property
    def assembly_design(self) -> '_2249.PlanetaryGearSet':
        ...
        return constructor.new(_2249.PlanetaryGearSet)(self.wrapped.AssemblyDesign) if self.wrapped.AssemblyDesign else None
