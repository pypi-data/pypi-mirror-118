...
class CylindricalGearSetLoadCase(_6577.GearSetLoadCase):
    '''CylindricalGearSetLoadCase
    ...
    @property
    def reset_micro_geometry(self) -> '_6626.ResetMicroGeometryOptions':
        ...
        return constructor.new(_6626.ResetMicroGeometryOptions)(value) if value else None

    @reset_micro_geometry.setter
    def reset_micro_geometry(self, value: '_6626.ResetMicroGeometryOptions'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def ltca(self) -> '_996.LTCALoadCaseModifiableSettings':
        ...
        return constructor.new(_996.LTCALoadCaseModifiableSettings)(self.wrapped.LTCA) if self.wrapped.LTCA else None

    @property
    def gears(self) -> 'List[_6542.CylindricalGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_6542.CylindricalGearLoadCase))
        return value

    @property
    def cylindrical_gears_load_case(self) -> 'List[_6542.CylindricalGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearsLoadCase, constructor.new(_6542.CylindricalGearLoadCase))
        return value

    @property
    def cylindrical_meshes_load_case(self) -> 'List[_6544.CylindricalGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshesLoadCase, constructor.new(_6544.CylindricalGearMeshLoadCase))
        return value

    def get_harmonic_load_data_for_import(self) -> '_6545.CylindricalGearSetHarmonicLoadData':
