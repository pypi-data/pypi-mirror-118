...
class PartLoadCase(_2364.PartAnalysis):
    '''PartLoadCase
    ...
    @property
    def static_load_case(self) -> '_6486.StaticLoadCase':
        ...
        if _6486.StaticLoadCase.TYPE not in self.wrapped.StaticLoadCase.__class__.__mro__:
    ...
    @property
    def time_series_load_case(self) -> '_6487.TimeSeriesLoadCase':
        ...
        return constructor.new(_6487.TimeSeriesLoadCase)(self.wrapped.TimeSeriesLoadCase) if self.wrapped.TimeSeriesLoadCase else None
    ...
    def get_harmonic_load_data_for_import(self) -> '_6580.HarmonicLoadDataBase':
