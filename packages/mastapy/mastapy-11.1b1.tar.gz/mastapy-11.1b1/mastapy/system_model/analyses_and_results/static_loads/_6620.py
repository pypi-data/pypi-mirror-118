...
from mastapy.system_model.analyses_and_results.static_loads import _6619, _6609
...
class PlanetCarrierLoadCase(_6609.MountableComponentLoadCase):
    '''PlanetCarrierLoadCase
    ...
    @property
    def planet_manufacture_errors(self) -> 'List[_6619.PlanetarySocketManufactureError]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PlanetManufactureErrors, constructor.new(_6619.PlanetarySocketManufactureError))
        return value
