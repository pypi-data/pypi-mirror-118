...
class PlanetaryGearSetCompoundSteadyStateSynchronousResponse(_3385.CylindricalGearSetCompoundSteadyStateSynchronousResponse):
    '''PlanetaryGearSetCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3288.PlanetaryGearSetSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_3288.PlanetaryGearSetSteadyStateSynchronousResponse))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_3288.PlanetaryGearSetSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_3288.PlanetaryGearSetSteadyStateSynchronousResponse))
        return value
