...
class SpecialisedAssemblyCompoundSteadyStateSynchronousResponse(_3336.AbstractAssemblyCompoundSteadyStateSynchronousResponse):
    '''SpecialisedAssemblyCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3302.SpecialisedAssemblySteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_3302.SpecialisedAssemblySteadyStateSynchronousResponse))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3302.SpecialisedAssemblySteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_3302.SpecialisedAssemblySteadyStateSynchronousResponse))
        return value
