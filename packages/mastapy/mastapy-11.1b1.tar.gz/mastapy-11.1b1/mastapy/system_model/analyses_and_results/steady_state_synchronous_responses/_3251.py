...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _3252, _3250, _3263
...
class CylindricalGearSetSteadyStateSynchronousResponse(_3263.GearSetSteadyStateSynchronousResponse):
    '''CylindricalGearSetSteadyStateSynchronousResponse
    ...
    @property
    def cylindrical_gears_steady_state_synchronous_response(self) -> 'List[_3252.CylindricalGearSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearsSteadyStateSynchronousResponse, constructor.new(_3252.CylindricalGearSteadyStateSynchronousResponse))
        return value

    @property
    def cylindrical_meshes_steady_state_synchronous_response(self) -> 'List[_3250.CylindricalGearMeshSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshesSteadyStateSynchronousResponse, constructor.new(_3250.CylindricalGearMeshSteadyStateSynchronousResponse))
        return value
