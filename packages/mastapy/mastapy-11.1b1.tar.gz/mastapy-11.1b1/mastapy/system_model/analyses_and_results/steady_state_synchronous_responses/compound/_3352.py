...
class BevelGearCompoundSteadyStateSynchronousResponse(_3340.AGMAGleasonConicalGearCompoundSteadyStateSynchronousResponse):
    '''BevelGearCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3221.BevelGearSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3221.BevelGearSteadyStateSynchronousResponse))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_3221.BevelGearSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3221.BevelGearSteadyStateSynchronousResponse))
        return value
