...
class CouplingConnectionCompoundSteadyStateSynchronousResponse(_3401.InterMountableComponentConnectionCompoundSteadyStateSynchronousResponse):
    '''CouplingConnectionCompoundSteadyStateSynchronousResponse
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3240.CouplingConnectionSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_3240.CouplingConnectionSteadyStateSynchronousResponse))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_3240.CouplingConnectionSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_3240.CouplingConnectionSteadyStateSynchronousResponse))
        return value
