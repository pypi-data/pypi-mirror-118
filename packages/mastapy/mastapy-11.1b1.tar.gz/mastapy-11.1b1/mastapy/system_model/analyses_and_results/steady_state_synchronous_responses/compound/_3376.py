...
class CVTBeltConnectionCompoundSteadyStateSynchronousResponse(_3345.BeltConnectionCompoundSteadyStateSynchronousResponse):
    '''CVTBeltConnectionCompoundSteadyStateSynchronousResponse
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3243.CVTBeltConnectionSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_3243.CVTBeltConnectionSteadyStateSynchronousResponse))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_3243.CVTBeltConnectionSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_3243.CVTBeltConnectionSteadyStateSynchronousResponse))
        return value
