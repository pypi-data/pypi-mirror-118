...
class CycloidalDiscCentralBearingConnectionCompoundSteadyStateSynchronousResponse(_3360.CoaxialConnectionCompoundSteadyStateSynchronousResponse):
    '''CycloidalDiscCentralBearingConnectionCompoundSteadyStateSynchronousResponse
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3247.CycloidalDiscCentralBearingConnectionSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_3247.CycloidalDiscCentralBearingConnectionSteadyStateSynchronousResponse))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_3247.CycloidalDiscCentralBearingConnectionSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_3247.CycloidalDiscCentralBearingConnectionSteadyStateSynchronousResponse))
        return value
