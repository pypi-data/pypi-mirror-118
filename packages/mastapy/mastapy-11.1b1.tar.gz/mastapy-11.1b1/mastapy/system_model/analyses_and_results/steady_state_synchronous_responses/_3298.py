...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _3309, _3210
...
class RootAssemblySteadyStateSynchronousResponse(_3210.AssemblySteadyStateSynchronousResponse):
    '''RootAssemblySteadyStateSynchronousResponse
    ...
    @property
    def steady_state_synchronous_response_inputs(self) -> '_3309.SteadyStateSynchronousResponse':
        ...
        return constructor.new(_3309.SteadyStateSynchronousResponse)(self.wrapped.SteadyStateSynchronousResponseInputs) if self.wrapped.SteadyStateSynchronousResponseInputs else None
