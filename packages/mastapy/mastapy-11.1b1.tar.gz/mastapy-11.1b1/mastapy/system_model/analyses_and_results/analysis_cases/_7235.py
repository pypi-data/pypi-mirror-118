...
class TimeSeriesLoadAnalysisCase(_7219.AnalysisCase):
    '''TimeSeriesLoadAnalysisCase
    ...
    @property
    def load_case(self) -> '_6487.TimeSeriesLoadCase':
        ...
        return constructor.new(_6487.TimeSeriesLoadCase)(self.wrapped.LoadCase) if self.wrapped.LoadCase else None
