...
class TorqueConverterPumpCompoundHarmonicAnalysis(_5861.CouplingHalfCompoundHarmonicAnalysis):
    '''TorqueConverterPumpCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5776.TorqueConverterPumpHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5776.TorqueConverterPumpHarmonicAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_5776.TorqueConverterPumpHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5776.TorqueConverterPumpHarmonicAnalysis))
        return value
