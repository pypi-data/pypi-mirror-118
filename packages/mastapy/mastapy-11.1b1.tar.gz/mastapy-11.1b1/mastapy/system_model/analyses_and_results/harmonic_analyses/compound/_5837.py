...
class BevelDifferentialSunGearCompoundHarmonicAnalysis(_5833.BevelDifferentialGearCompoundHarmonicAnalysis):
    '''BevelDifferentialSunGearCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5645.BevelDifferentialSunGearHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5645.BevelDifferentialSunGearHarmonicAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_5645.BevelDifferentialSunGearHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5645.BevelDifferentialSunGearHarmonicAnalysis))
        return value
