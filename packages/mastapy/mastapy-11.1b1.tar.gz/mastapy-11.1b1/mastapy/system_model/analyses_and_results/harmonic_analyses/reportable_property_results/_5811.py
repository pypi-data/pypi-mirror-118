...
from mastapy.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import _5804, _5809
...
class ResultsForMultipleOrdersForGroups(_5809.ResultsForMultipleOrders):
    '''ResultsForMultipleOrdersForGroups
    ...
    @property
    def groups(self) -> 'List[_5804.HarmonicAnalysisResultsBrokenDownByGroupsWithinAHarmonic]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Groups, constructor.new(_5804.HarmonicAnalysisResultsBrokenDownByGroupsWithinAHarmonic))
        return value
