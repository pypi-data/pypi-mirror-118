...
from mastapy.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import _5807, _5814
...
class ResultsForOrderIncludingSurfaces(_5814.ResultsForOrderIncludingNodes):
    '''ResultsForOrderIncludingSurfaces
    ...
    @property
    def fe_surfaces(self) -> 'List[_5807.HarmonicAnalysisResultsBrokenDownBySurfaceWithinAHarmonic]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FESurfaces, constructor.new(_5807.HarmonicAnalysisResultsBrokenDownBySurfaceWithinAHarmonic))
        return value
