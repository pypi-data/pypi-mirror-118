...
class SpiralBevelGearMeshCompoundHarmonicAnalysis(_5839.BevelGearMeshCompoundHarmonicAnalysis):
    '''SpiralBevelGearMeshCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5757.SpiralBevelGearMeshHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_5757.SpiralBevelGearMeshHarmonicAnalysis))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_5757.SpiralBevelGearMeshHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_5757.SpiralBevelGearMeshHarmonicAnalysis))
        return value
