...
from mastapy.system_model.analyses_and_results.modal_analyses import (
    _4869, _4792, _4795, _4799,
    _4801, _4802, _4804, _4809,
    _4814, _4817, _4820, _4823,
    _4826, _4830, _4836, _4838,
    _4842, _4848, _4852, _4856,
    _4859, _4862, _4864, _4865,
    _4870, _4874, _4878, _4879,
    _4880, _4881, _4882, _4886,
    _4888, _4894, _4897, _4900,
    _4903, _4905, _4906, _4907,
    _4909, _4910, _4913, _4914,
    _4915, _4916, _4923, _4926
)
...
from mastapy.system_model.analyses_and_results.system_deflections import (
    _2484, _2398, _2400, _2405,
    _2406, _2407, _2410, _2414,
    _2420, _2424, _2428, _2430,
    _2432, _2435, _2447, _2448,
    _2449, _2452, _2458, _2463,
    _2467, _2472, _2475, _2478,
    _2481, _2482, _2486, _2489,
    _2492, _2493, _2494, _2495,
    _2496, _2501, _2503, _2511,
    _2513, _2517, _2520, _2521,
    _2522, _2523, _2524, _2525,
    _2531, _2533, _2536, _2537,
    _2540, _2543
)
...
class MountableComponentHarmonicAnalysis(_5656.ComponentHarmonicAnalysis):
    '''MountableComponentHarmonicAnalysis
    ...
    @property
    def coupled_modal_analysis(self) -> '_4869.MountableComponentModalAnalysis':
        ...
        if _4869.MountableComponentModalAnalysis.TYPE not in self.wrapped.CoupledModalAnalysis.__class__.__mro__:
    ...
    @property
    def coupled_modal_analysis_of_type_agma_gleason_conical_gear_modal_analysis(self) -> '_4792.AGMAGleasonConicalGearModalAnalysis':
        ...
        if _4792.AGMAGleasonConicalGearModalAnalysis.TYPE not in self.wrapped.CoupledModalAnalysis.__class__.__mro__:
    ...
    @property
    def coupled_modal_analysis_of_type_bearing_modal_analysis(self) -> '_4795.BearingModalAnalysis':
        ...
        if _4795.BearingModalAnalysis.TYPE not in self.wrapped.CoupledModalAnalysis.__class__.__mro__:
    ...
    @property
    def coupled_modal_analysis_of_type_bevel_differential_gear_modal_analysis(self) -> '_4799.BevelDifferentialGearModalAnalysis':
        ...
        if _4799.BevelDifferentialGearModalAnalysis.TYPE not in self.wrapped.CoupledModalAnalysis.__class__.__mro__:
    ...
    @property
    def coupled_modal_analysis_of_type_bevel_differential_planet_gear_modal_analysis(self) -> '_4801.BevelDifferentialPlanetGearModalAnalysis':
        ...
        if _4801.BevelDifferentialPlanetGearModalAnalysis.TYPE not in self.wrapped.CoupledModalAnalysis.__class__.__mro__:
    ...
    @property
    def coupled_modal_analysis_of_type_bevel_differential_sun_gear_modal_analysis(self) -> '_4802.BevelDifferentialSunGearModalAnalysis':
        ...
        if _4802.BevelDifferentialSunGearModalAnalysis.TYPE not in self.wrapped.CoupledModalAnalysis.__class__.__mro__:
    ...
    @property
    def coupled_modal_analysis_of_type_bevel_gear_modal_analysis(self) -> '_4804.BevelGearModalAnalysis':
        ...
        if _4804.BevelGearModalAnalysis.TYPE not in self.wrapped.CoupledModalAnalysis.__class__.__mro__:
    ...
    @property
    def coupled_modal_analysis_of_type_clutch_half_modal_analysis(self) -> '_4809.ClutchHalfModalAnalysis':
        ...
        if _4809.ClutchHalfModalAnalysis.TYPE not in self.wrapped.CoupledModalAnalysis.__class__.__mro__:
    ...
    @property
    def coupled_modal_analysis_of_type_concept_coupling_half_modal_analysis(self) -> '_4814.ConceptCouplingHalfModalAnalysis':
        ...
        if _4814.ConceptCouplingHalfModalAnalysis.TYPE not in self.wrapped.CoupledModalAnalysis.__class__.__mro__:
    ...
    @property
    def coupled_modal_analysis_of_type_concept_gear_modal_analysis(self) -> '_4817.ConceptGearModalAnalysis':
        ...
        if _4817.ConceptGearModalAnalysis.TYPE not in self.wrapped.CoupledModalAnalysis.__class__.__mro__:
    ...
    @property
    def coupled_modal_analysis_of_type_conical_gear_modal_analysis(self) -> '_4820.ConicalGearModalAnalysis':
        ...
        if _4820.ConicalGearModalAnalysis.TYPE not in self.wrapped.CoupledModalAnalysis.__class__.__mro__:
    ...
    @property
    def coupled_modal_analysis_of_type_connector_modal_analysis(self) -> '_4823.ConnectorModalAnalysis':
        ...
        if _4823.ConnectorModalAnalysis.TYPE not in self.wrapped.CoupledModalAnalysis.__class__.__mro__:
    ...
    @property
    def coupled_modal_analysis_of_type_coupling_half_modal_analysis(self) -> '_4826.CouplingHalfModalAnalysis':
        ...
        if _4826.CouplingHalfModalAnalysis.TYPE not in self.wrapped.CoupledModalAnalysis.__class__.__mro__:
    ...
    @property
    def coupled_modal_analysis_of_type_cvt_pulley_modal_analysis(self) -> '_4830.CVTPulleyModalAnalysis':
        ...
        if _4830.CVTPulleyModalAnalysis.TYPE not in self.wrapped.CoupledModalAnalysis.__class__.__mro__:
    ...
    @property
    def coupled_modal_analysis_of_type_cylindrical_gear_modal_analysis(self) -> '_4836.CylindricalGearModalAnalysis':
        ...
        if _4836.CylindricalGearModalAnalysis.TYPE not in self.wrapped.CoupledModalAnalysis.__class__.__mro__:
    ...
    @property
    def coupled_modal_analysis_of_type_cylindrical_planet_gear_modal_analysis(self) -> '_4838.CylindricalPlanetGearModalAnalysis':
        ...
        if _4838.CylindricalPlanetGearModalAnalysis.TYPE not in self.wrapped.CoupledModalAnalysis.__class__.__mro__:
    ...
    @property
    def coupled_modal_analysis_of_type_face_gear_modal_analysis(self) -> '_4842.FaceGearModalAnalysis':
        ...
        if _4842.FaceGearModalAnalysis.TYPE not in self.wrapped.CoupledModalAnalysis.__class__.__mro__:
    ...
    @property
    def coupled_modal_analysis_of_type_gear_modal_analysis(self) -> '_4848.GearModalAnalysis':
        ...
        if _4848.GearModalAnalysis.TYPE not in self.wrapped.CoupledModalAnalysis.__class__.__mro__:
    ...
    @property
    def coupled_modal_analysis_of_type_hypoid_gear_modal_analysis(self) -> '_4852.HypoidGearModalAnalysis':
        ...
        if _4852.HypoidGearModalAnalysis.TYPE not in self.wrapped.CoupledModalAnalysis.__class__.__mro__:
    ...
    @property
    def coupled_modal_analysis_of_type_klingelnberg_cyclo_palloid_conical_gear_modal_analysis(self) -> '_4856.KlingelnbergCycloPalloidConicalGearModalAnalysis':
        ...
        if _4856.KlingelnbergCycloPalloidConicalGearModalAnalysis.TYPE not in self.wrapped.CoupledModalAnalysis.__class__.__mro__:
    ...
    @property
    def coupled_modal_analysis_of_type_klingelnberg_cyclo_palloid_hypoid_gear_modal_analysis(self) -> '_4859.KlingelnbergCycloPalloidHypoidGearModalAnalysis':
        ...
        if _4859.KlingelnbergCycloPalloidHypoidGearModalAnalysis.TYPE not in self.wrapped.CoupledModalAnalysis.__class__.__mro__:
    ...
    @property
    def coupled_modal_analysis_of_type_klingelnberg_cyclo_palloid_spiral_bevel_gear_modal_analysis(self) -> '_4862.KlingelnbergCycloPalloidSpiralBevelGearModalAnalysis':
        ...
        if _4862.KlingelnbergCycloPalloidSpiralBevelGearModalAnalysis.TYPE not in self.wrapped.CoupledModalAnalysis.__class__.__mro__:
    ...
    @property
    def coupled_modal_analysis_of_type_mass_disc_modal_analysis(self) -> '_4864.MassDiscModalAnalysis':
        ...
        if _4864.MassDiscModalAnalysis.TYPE not in self.wrapped.CoupledModalAnalysis.__class__.__mro__:
    ...
    @property
    def coupled_modal_analysis_of_type_measurement_component_modal_analysis(self) -> '_4865.MeasurementComponentModalAnalysis':
        ...
        if _4865.MeasurementComponentModalAnalysis.TYPE not in self.wrapped.CoupledModalAnalysis.__class__.__mro__:
    ...
    @property
    def coupled_modal_analysis_of_type_oil_seal_modal_analysis(self) -> '_4870.OilSealModalAnalysis':
        ...
        if _4870.OilSealModalAnalysis.TYPE not in self.wrapped.CoupledModalAnalysis.__class__.__mro__:
    ...
    @property
    def coupled_modal_analysis_of_type_part_to_part_shear_coupling_half_modal_analysis(self) -> '_4874.PartToPartShearCouplingHalfModalAnalysis':
        ...
        if _4874.PartToPartShearCouplingHalfModalAnalysis.TYPE not in self.wrapped.CoupledModalAnalysis.__class__.__mro__:
    ...
    @property
    def coupled_modal_analysis_of_type_planet_carrier_modal_analysis(self) -> '_4878.PlanetCarrierModalAnalysis':
        ...
        if _4878.PlanetCarrierModalAnalysis.TYPE not in self.wrapped.CoupledModalAnalysis.__class__.__mro__:
    ...
    @property
    def coupled_modal_analysis_of_type_point_load_modal_analysis(self) -> '_4879.PointLoadModalAnalysis':
        ...
        if _4879.PointLoadModalAnalysis.TYPE not in self.wrapped.CoupledModalAnalysis.__class__.__mro__:
    ...
    @property
    def coupled_modal_analysis_of_type_power_load_modal_analysis(self) -> '_4880.PowerLoadModalAnalysis':
        ...
        if _4880.PowerLoadModalAnalysis.TYPE not in self.wrapped.CoupledModalAnalysis.__class__.__mro__:
    ...
    @property
    def coupled_modal_analysis_of_type_pulley_modal_analysis(self) -> '_4881.PulleyModalAnalysis':
        ...
        if _4881.PulleyModalAnalysis.TYPE not in self.wrapped.CoupledModalAnalysis.__class__.__mro__:
    ...
    @property
    def coupled_modal_analysis_of_type_ring_pins_modal_analysis(self) -> '_4882.RingPinsModalAnalysis':
        ...
        if _4882.RingPinsModalAnalysis.TYPE not in self.wrapped.CoupledModalAnalysis.__class__.__mro__:
    ...
    @property
    def coupled_modal_analysis_of_type_rolling_ring_modal_analysis(self) -> '_4886.RollingRingModalAnalysis':
        ...
        if _4886.RollingRingModalAnalysis.TYPE not in self.wrapped.CoupledModalAnalysis.__class__.__mro__:
    ...
    @property
    def coupled_modal_analysis_of_type_shaft_hub_connection_modal_analysis(self) -> '_4888.ShaftHubConnectionModalAnalysis':
        ...
        if _4888.ShaftHubConnectionModalAnalysis.TYPE not in self.wrapped.CoupledModalAnalysis.__class__.__mro__:
    ...
    @property
    def coupled_modal_analysis_of_type_spiral_bevel_gear_modal_analysis(self) -> '_4894.SpiralBevelGearModalAnalysis':
        ...
        if _4894.SpiralBevelGearModalAnalysis.TYPE not in self.wrapped.CoupledModalAnalysis.__class__.__mro__:
    ...
    @property
    def coupled_modal_analysis_of_type_spring_damper_half_modal_analysis(self) -> '_4897.SpringDamperHalfModalAnalysis':
        ...
        if _4897.SpringDamperHalfModalAnalysis.TYPE not in self.wrapped.CoupledModalAnalysis.__class__.__mro__:
    ...
    @property
    def coupled_modal_analysis_of_type_straight_bevel_diff_gear_modal_analysis(self) -> '_4900.StraightBevelDiffGearModalAnalysis':
        ...
        if _4900.StraightBevelDiffGearModalAnalysis.TYPE not in self.wrapped.CoupledModalAnalysis.__class__.__mro__:
    ...
    @property
    def coupled_modal_analysis_of_type_straight_bevel_gear_modal_analysis(self) -> '_4903.StraightBevelGearModalAnalysis':
        ...
        if _4903.StraightBevelGearModalAnalysis.TYPE not in self.wrapped.CoupledModalAnalysis.__class__.__mro__:
    ...
    @property
    def coupled_modal_analysis_of_type_straight_bevel_planet_gear_modal_analysis(self) -> '_4905.StraightBevelPlanetGearModalAnalysis':
        ...
        if _4905.StraightBevelPlanetGearModalAnalysis.TYPE not in self.wrapped.CoupledModalAnalysis.__class__.__mro__:
    ...
    @property
    def coupled_modal_analysis_of_type_straight_bevel_sun_gear_modal_analysis(self) -> '_4906.StraightBevelSunGearModalAnalysis':
        ...
        if _4906.StraightBevelSunGearModalAnalysis.TYPE not in self.wrapped.CoupledModalAnalysis.__class__.__mro__:
    ...
    @property
    def coupled_modal_analysis_of_type_synchroniser_half_modal_analysis(self) -> '_4907.SynchroniserHalfModalAnalysis':
        ...
        if _4907.SynchroniserHalfModalAnalysis.TYPE not in self.wrapped.CoupledModalAnalysis.__class__.__mro__:
    ...
    @property
    def coupled_modal_analysis_of_type_synchroniser_part_modal_analysis(self) -> '_4909.SynchroniserPartModalAnalysis':
        ...
        if _4909.SynchroniserPartModalAnalysis.TYPE not in self.wrapped.CoupledModalAnalysis.__class__.__mro__:
    ...
    @property
    def coupled_modal_analysis_of_type_synchroniser_sleeve_modal_analysis(self) -> '_4910.SynchroniserSleeveModalAnalysis':
        ...
        if _4910.SynchroniserSleeveModalAnalysis.TYPE not in self.wrapped.CoupledModalAnalysis.__class__.__mro__:
    ...
    @property
    def coupled_modal_analysis_of_type_torque_converter_pump_modal_analysis(self) -> '_4913.TorqueConverterPumpModalAnalysis':
        ...
        if _4913.TorqueConverterPumpModalAnalysis.TYPE not in self.wrapped.CoupledModalAnalysis.__class__.__mro__:
    ...
    @property
    def coupled_modal_analysis_of_type_torque_converter_turbine_modal_analysis(self) -> '_4914.TorqueConverterTurbineModalAnalysis':
        ...
        if _4914.TorqueConverterTurbineModalAnalysis.TYPE not in self.wrapped.CoupledModalAnalysis.__class__.__mro__:
    ...
    @property
    def coupled_modal_analysis_of_type_unbalanced_mass_modal_analysis(self) -> '_4915.UnbalancedMassModalAnalysis':
        ...
        if _4915.UnbalancedMassModalAnalysis.TYPE not in self.wrapped.CoupledModalAnalysis.__class__.__mro__:
    ...
    @property
    def coupled_modal_analysis_of_type_virtual_component_modal_analysis(self) -> '_4916.VirtualComponentModalAnalysis':
        ...
        if _4916.VirtualComponentModalAnalysis.TYPE not in self.wrapped.CoupledModalAnalysis.__class__.__mro__:
    ...
    @property
    def coupled_modal_analysis_of_type_worm_gear_modal_analysis(self) -> '_4923.WormGearModalAnalysis':
        ...
        if _4923.WormGearModalAnalysis.TYPE not in self.wrapped.CoupledModalAnalysis.__class__.__mro__:
    ...
    @property
    def coupled_modal_analysis_of_type_zerol_bevel_gear_modal_analysis(self) -> '_4926.ZerolBevelGearModalAnalysis':
        ...
        if _4926.ZerolBevelGearModalAnalysis.TYPE not in self.wrapped.CoupledModalAnalysis.__class__.__mro__:
    ...
    @property
    def system_deflection_results(self) -> '_2484.MountableComponentSystemDeflection':
        ...
        if _2484.MountableComponentSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_agma_gleason_conical_gear_system_deflection(self) -> '_2398.AGMAGleasonConicalGearSystemDeflection':
    ...
    @property
    def system_deflection_results_of_type_bearing_system_deflection(self) -> '_2400.BearingSystemDeflection':
        ...
        if _2400.BearingSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_clutch_half_system_deflection(self) -> '_2414.ClutchHalfSystemDeflection':
        ...
        if _2414.ClutchHalfSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_concept_coupling_half_system_deflection(self) -> '_2420.ConceptCouplingHalfSystemDeflection':
        ...
        if _2420.ConceptCouplingHalfSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_concept_gear_system_deflection(self) -> '_2424.ConceptGearSystemDeflection':
        ...
        if _2424.ConceptGearSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_conical_gear_system_deflection(self) -> '_2428.ConicalGearSystemDeflection':
        ...
        if _2428.ConicalGearSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_connector_system_deflection(self) -> '_2430.ConnectorSystemDeflection':
        ...
        if _2430.ConnectorSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_coupling_half_system_deflection(self) -> '_2432.CouplingHalfSystemDeflection':
        ...
        if _2432.CouplingHalfSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_cvt_pulley_system_deflection(self) -> '_2435.CVTPulleySystemDeflection':
        ...
        if _2435.CVTPulleySystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_cylindrical_gear_system_deflection(self) -> '_2447.CylindricalGearSystemDeflection':
        ...
        if _2447.CylindricalGearSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_cylindrical_gear_system_deflection_timestep(self) -> '_2448.CylindricalGearSystemDeflectionTimestep':
        ...
        if _2448.CylindricalGearSystemDeflectionTimestep.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_cylindrical_gear_system_deflection_with_ltca_results(self) -> '_2449.CylindricalGearSystemDeflectionWithLTCAResults':
        ...
        if _2449.CylindricalGearSystemDeflectionWithLTCAResults.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_cylindrical_planet_gear_system_deflection(self) -> '_2452.CylindricalPlanetGearSystemDeflection':
        ...
        if _2452.CylindricalPlanetGearSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_face_gear_system_deflection(self) -> '_2458.FaceGearSystemDeflection':
        ...
        if _2458.FaceGearSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_gear_system_deflection(self) -> '_2463.GearSystemDeflection':
        ...
        if _2463.GearSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_klingelnberg_cyclo_palloid_conical_gear_system_deflection(self) -> '_2472.KlingelnbergCycloPalloidConicalGearSystemDeflection':
        ...
        if _2472.KlingelnbergCycloPalloidConicalGearSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_klingelnberg_cyclo_palloid_hypoid_gear_system_deflection(self) -> '_2475.KlingelnbergCycloPalloidHypoidGearSystemDeflection':
        ...
        if _2475.KlingelnbergCycloPalloidHypoidGearSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_klingelnberg_cyclo_palloid_spiral_bevel_gear_system_deflection(self) -> '_2478.KlingelnbergCycloPalloidSpiralBevelGearSystemDeflection':
        ...
        if _2478.KlingelnbergCycloPalloidSpiralBevelGearSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_mass_disc_system_deflection(self) -> '_2481.MassDiscSystemDeflection':
        ...
        if _2481.MassDiscSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_measurement_component_system_deflection(self) -> '_2482.MeasurementComponentSystemDeflection':
        ...
        if _2482.MeasurementComponentSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_oil_seal_system_deflection(self) -> '_2486.OilSealSystemDeflection':
        ...
        if _2486.OilSealSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_part_to_part_shear_coupling_half_system_deflection(self) -> '_2489.PartToPartShearCouplingHalfSystemDeflection':
        ...
        if _2489.PartToPartShearCouplingHalfSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_planet_carrier_system_deflection(self) -> '_2492.PlanetCarrierSystemDeflection':
        ...
        if _2492.PlanetCarrierSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_point_load_system_deflection(self) -> '_2493.PointLoadSystemDeflection':
        ...
        if _2493.PointLoadSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_power_load_system_deflection(self) -> '_2494.PowerLoadSystemDeflection':
        ...
        if _2494.PowerLoadSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_pulley_system_deflection(self) -> '_2495.PulleySystemDeflection':
        ...
        if _2495.PulleySystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_ring_pins_system_deflection(self) -> '_2496.RingPinsSystemDeflection':
        ...
        if _2496.RingPinsSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_rolling_ring_system_deflection(self) -> '_2501.RollingRingSystemDeflection':
        ...
        if _2501.RollingRingSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_shaft_hub_connection_system_deflection(self) -> '_2503.ShaftHubConnectionSystemDeflection':
        ...
        if _2503.ShaftHubConnectionSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_spring_damper_half_system_deflection(self) -> '_2513.SpringDamperHalfSystemDeflection':
        ...
        if _2513.SpringDamperHalfSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_synchroniser_half_system_deflection(self) -> '_2523.SynchroniserHalfSystemDeflection':
        ...
        if _2523.SynchroniserHalfSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_synchroniser_part_system_deflection(self) -> '_2524.SynchroniserPartSystemDeflection':
        ...
        if _2524.SynchroniserPartSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_synchroniser_sleeve_system_deflection(self) -> '_2525.SynchroniserSleeveSystemDeflection':
        ...
        if _2525.SynchroniserSleeveSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_torque_converter_pump_system_deflection(self) -> '_2531.TorqueConverterPumpSystemDeflection':
        ...
        if _2531.TorqueConverterPumpSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_torque_converter_turbine_system_deflection(self) -> '_2533.TorqueConverterTurbineSystemDeflection':
        ...
        if _2533.TorqueConverterTurbineSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_unbalanced_mass_system_deflection(self) -> '_2536.UnbalancedMassSystemDeflection':
        ...
        if _2536.UnbalancedMassSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_virtual_component_system_deflection(self) -> '_2537.VirtualComponentSystemDeflection':
        ...
        if _2537.VirtualComponentSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
    ...
    @property
    def system_deflection_results_of_type_worm_gear_system_deflection(self) -> '_2540.WormGearSystemDeflection':
        ...
        if _2540.WormGearSystemDeflection.TYPE not in self.wrapped.SystemDeflectionResults.__class__.__mro__:
