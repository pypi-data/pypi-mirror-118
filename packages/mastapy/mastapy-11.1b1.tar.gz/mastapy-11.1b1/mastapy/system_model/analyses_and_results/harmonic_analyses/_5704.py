...
class GearMeshHarmonicAnalysis(_5719.InterMountableComponentConnectionHarmonicAnalysis):
    '''GearMeshHarmonicAnalysis
    ...
    @property
    def tooth_passing_harmonics(self) -> 'List[_3852.ToothPassingHarmonic]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ToothPassingHarmonics, constructor.new(_3852.ToothPassingHarmonic))
        return value

    @property
    def system_deflection_results(self) -> '_2461.GearMeshSystemDeflection':
