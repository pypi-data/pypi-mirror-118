...
from mastapy.system_model.analyses_and_results.system_deflections import _2444, _2445, _2446
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5678, _5679, _5707
...
class CylindricalGearSetHarmonicAnalysis(_5707.GearSetHarmonicAnalysis):
    '''CylindricalGearSetHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2444.CylindricalGearSetSystemDeflection':
    ...
    @property
    def gears_harmonic_analysis(self) -> 'List[_5678.CylindricalGearHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearsHarmonicAnalysis, constructor.new(_5678.CylindricalGearHarmonicAnalysis))
        return value

    @property
    def cylindrical_gears_harmonic_analysis(self) -> 'List[_5678.CylindricalGearHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearsHarmonicAnalysis, constructor.new(_5678.CylindricalGearHarmonicAnalysis))
        return value

    @property
    def meshes_harmonic_analysis(self) -> 'List[_5679.CylindricalGearMeshHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshesHarmonicAnalysis, constructor.new(_5679.CylindricalGearMeshHarmonicAnalysis))
        return value

    @property
    def cylindrical_meshes_harmonic_analysis(self) -> 'List[_5679.CylindricalGearMeshHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshesHarmonicAnalysis, constructor.new(_5679.CylindricalGearMeshHarmonicAnalysis))
        return value
