...
class BeltConnectionCompoundHarmonicAnalysis(_5887.InterMountableComponentConnectionCompoundHarmonicAnalysis):
    '''BeltConnectionCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5639.BeltConnectionHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_5639.BeltConnectionHarmonicAnalysis))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_5639.BeltConnectionHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_5639.BeltConnectionHarmonicAnalysis))
        return value
