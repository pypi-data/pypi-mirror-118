...
class CVTPulleyCompoundHarmonicAnalysis(_5910.PulleyCompoundHarmonicAnalysis):
    '''CVTPulleyCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5673.CVTPulleyHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5673.CVTPulleyHarmonicAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_5673.CVTPulleyHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5673.CVTPulleyHarmonicAnalysis))
        return value
