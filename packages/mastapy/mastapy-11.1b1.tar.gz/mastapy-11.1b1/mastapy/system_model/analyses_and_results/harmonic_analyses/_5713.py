...
from mastapy.system_model.analyses_and_results.harmonic_analyses.results import _5790
from mastapy.system_model.analyses_and_results.modal_analyses import _4868
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5755, _5701
...
class HarmonicAnalysisOptions(_0.APIBase):
    ...
    @property
    def excitation_selection(self) -> '_5790.ExcitationSourceSelectionGroup':
        ...
        return constructor.new(_5790.ExcitationSourceSelectionGroup)(self.wrapped.ExcitationSelection) if self.wrapped.ExcitationSelection else None

    @property
    def modal_analysis_options(self) -> '_4868.ModalAnalysisOptions':
        ...
        return constructor.new(_4868.ModalAnalysisOptions)(self.wrapped.ModalAnalysisOptions) if self.wrapped.ModalAnalysisOptions else None
