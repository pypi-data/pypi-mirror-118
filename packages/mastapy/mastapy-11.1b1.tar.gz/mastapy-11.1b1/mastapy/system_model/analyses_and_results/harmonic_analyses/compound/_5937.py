...
class SynchroniserPartCompoundHarmonicAnalysis(_5861.CouplingHalfCompoundHarmonicAnalysis):
    '''SynchroniserPartCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5772.SynchroniserPartHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5772.SynchroniserPartHarmonicAnalysis))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_5772.SynchroniserPartHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5772.SynchroniserPartHarmonicAnalysis))
        return value
