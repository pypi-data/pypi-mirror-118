...
from mastapy.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import _5814, _5797
...
class SingleWhineAnalysisResultsPropertyAccessor(_5797.AbstractSingleWhineAnalysisResultsPropertyAccessor):
    '''SingleWhineAnalysisResultsPropertyAccessor
    ...
    @property
    def orders(self) -> 'List[_5814.ResultsForOrderIncludingNodes]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Orders, constructor.new(_5814.ResultsForOrderIncludingNodes))
        return value
