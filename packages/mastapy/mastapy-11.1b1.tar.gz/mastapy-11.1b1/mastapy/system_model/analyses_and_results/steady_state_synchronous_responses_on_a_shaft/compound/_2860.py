...
class CycloidalDiscCompoundSteadyStateSynchronousResponseOnAShaft(_2816.AbstractShaftCompoundSteadyStateSynchronousResponseOnAShaft):
    '''CycloidalDiscCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2731.CycloidalDiscSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2731.CycloidalDiscSteadyStateSynchronousResponseOnAShaft))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_2731.CycloidalDiscSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2731.CycloidalDiscSteadyStateSynchronousResponseOnAShaft))
        return value
