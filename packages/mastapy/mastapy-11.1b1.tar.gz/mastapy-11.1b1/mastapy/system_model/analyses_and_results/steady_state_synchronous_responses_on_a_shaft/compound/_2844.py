...
class ConceptGearCompoundSteadyStateSynchronousResponseOnAShaft(_2873.GearCompoundSteadyStateSynchronousResponseOnAShaft):
    '''ConceptGearCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2716.ConceptGearSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2716.ConceptGearSteadyStateSynchronousResponseOnAShaft))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_2716.ConceptGearSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2716.ConceptGearSteadyStateSynchronousResponseOnAShaft))
        return value
