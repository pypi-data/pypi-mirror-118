...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_on_a_shaft.compound import _2864
...
class PlanetaryGearSetCompoundSteadyStateSynchronousResponseOnAShaft(_2864.CylindricalGearSetCompoundSteadyStateSynchronousResponseOnAShaft):
    '''PlanetaryGearSetCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2769.PlanetaryGearSetSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_2769.PlanetaryGearSetSteadyStateSynchronousResponseOnAShaft))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_2769.PlanetaryGearSetSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_2769.PlanetaryGearSetSteadyStateSynchronousResponseOnAShaft))
        return value
