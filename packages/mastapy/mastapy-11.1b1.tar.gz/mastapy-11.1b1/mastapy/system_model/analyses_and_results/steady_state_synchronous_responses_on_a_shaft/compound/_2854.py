...
class CouplingHalfCompoundSteadyStateSynchronousResponseOnAShaft(_2892.MountableComponentCompoundSteadyStateSynchronousResponseOnAShaft):
    '''CouplingHalfCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2723.CouplingHalfSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2723.CouplingHalfSteadyStateSynchronousResponseOnAShaft))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_2723.CouplingHalfSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2723.CouplingHalfSteadyStateSynchronousResponseOnAShaft))
        return value
