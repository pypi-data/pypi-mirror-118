...
class ShaftCompoundSteadyStateSynchronousResponseOnAShaft(_2816.AbstractShaftCompoundSteadyStateSynchronousResponseOnAShaft):
    '''ShaftCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2781.ShaftSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2781.ShaftSteadyStateSynchronousResponseOnAShaft))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2781.ShaftSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2781.ShaftSteadyStateSynchronousResponseOnAShaft))
        return value
