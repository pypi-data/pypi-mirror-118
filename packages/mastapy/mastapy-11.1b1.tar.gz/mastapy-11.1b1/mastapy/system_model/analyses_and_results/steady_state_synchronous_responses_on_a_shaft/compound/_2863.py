...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_on_a_shaft.compound import _2874
...
class CylindricalGearMeshCompoundSteadyStateSynchronousResponseOnAShaft(_2874.GearMeshCompoundSteadyStateSynchronousResponseOnAShaft):
    '''CylindricalGearMeshCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_design(self) -> '_2018.CylindricalGearMesh':
        ...
        return constructor.new(_2018.CylindricalGearMesh)(self.wrapped.ComponentDesign) if self.wrapped.ComponentDesign else None
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2732.CylindricalGearMeshSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_2732.CylindricalGearMeshSteadyStateSynchronousResponseOnAShaft))
        return value
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_2732.CylindricalGearMeshSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_2732.CylindricalGearMeshSteadyStateSynchronousResponseOnAShaft))
        return value
