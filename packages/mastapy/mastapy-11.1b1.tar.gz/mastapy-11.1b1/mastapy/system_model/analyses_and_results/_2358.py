...
from mastapy.utility.model_validation import _1544, _1545
...
class DesignEntityAnalysis(_0.APIBase):
    ...
    @property
    def active_report_as_text(self) -> '_1508.CustomReport':
        ...
        return constructor.new(_1508.CustomReport)(self.wrapped.ActiveReportAsText) if self.wrapped.ActiveReportAsText else None
    ...
    @property
    def component_design(self) -> '_1919.DesignEntity':
        ...
        if _1919.DesignEntity.TYPE not in self.wrapped.ComponentDesign.__class__.__mro__:
    ...
    @property
    def component_design_of_type_connection(self) -> '_1981.Connection':
    ...
    @property
    def component_design_of_type_part(self) -> '_2176.Part':
    ...
    def status(self) -> '_1544.Status':
        ...
        return constructor.new(_1544.Status)(self.wrapped.Status) if self.wrapped.Status else None

    @property
    def all_status_errors(self) -> 'List[_1545.StatusItem]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AllStatusErrors, constructor.new(_1545.StatusItem))
        return value
