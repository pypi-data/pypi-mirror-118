...
from mastapy.system_model.optimization import _1946
...
class OptimizationStep(_0.APIBase):
    ...
    @property
    def optimisation_target(self) -> '_1946.MicroGeometryOptimisationTarget':
        ...
        return constructor.new(_1946.MicroGeometryOptimisationTarget)(value) if value else None

    @optimisation_target.setter
    def optimisation_target(self, value: '_1946.MicroGeometryOptimisationTarget'):
