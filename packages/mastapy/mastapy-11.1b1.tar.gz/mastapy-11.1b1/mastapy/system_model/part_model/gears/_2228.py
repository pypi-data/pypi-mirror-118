...
class ConceptGear(_2237.Gear):
    ...
    @property
    def active_gear_design(self) -> '_1105.ConceptGearDesign':
        ...
        return constructor.new(_1105.ConceptGearDesign)(self.wrapped.ActiveGearDesign) if self.wrapped.ActiveGearDesign else None

    @property
    def concept_gear_design(self) -> '_1105.ConceptGearDesign':
        ...
        return constructor.new(_1105.ConceptGearDesign)(self.wrapped.ConceptGearDesign) if self.wrapped.ConceptGearDesign else None
