...
from mastapy.system_model.part_model.gears.supercharger_rotor_set import _2270
from mastapy.system_model.part_model.gears import _2232, _2239
...
class CylindricalGearSet(_2239.GearSet):
    '''CylindricalGearSet
    ...
    @property
    def active_gear_set_design(self) -> '_965.CylindricalGearSetDesign':
    ...
    @property
    def cylindrical_gear_set_design(self) -> '_965.CylindricalGearSetDesign':
        ...
        if _965.CylindricalGearSetDesign.TYPE not in self.wrapped.CylindricalGearSetDesign.__class__.__mro__:
    ...
    @property
    def supercharger_rotor_set(self) -> '_2270.SuperchargerRotorSet':
        ...
        return constructor.new(_2270.SuperchargerRotorSet)(self.wrapped.SuperchargerRotorSet) if self.wrapped.SuperchargerRotorSet else None

    @property
    def cylindrical_gears(self) -> 'List[_2232.CylindricalGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGears, constructor.new(_2232.CylindricalGear))
        return value

    @property
    def cylindrical_meshes(self) -> 'List[_2018.CylindricalGearMesh]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshes, constructor.new(_2018.CylindricalGearMesh))
        return value

    @property
    def gear_set_designs(self) -> 'List[_965.CylindricalGearSetDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearSetDesigns, constructor.new(_965.CylindricalGearSetDesign))
        return value
