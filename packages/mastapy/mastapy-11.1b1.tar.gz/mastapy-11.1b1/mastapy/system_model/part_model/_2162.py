...
class FlexiblePinAssembly(_2184.SpecialisedAssembly):
    '''FlexiblePinAssembly
    ...
    @property
    def planet_gear(self) -> '_2232.CylindricalGear':
        ...
        if _2232.CylindricalGear.TYPE not in self.wrapped.PlanetGear.__class__.__mro__:
