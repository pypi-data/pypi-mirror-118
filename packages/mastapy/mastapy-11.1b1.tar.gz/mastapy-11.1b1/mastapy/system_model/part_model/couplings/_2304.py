...
class RollingRingAssembly(_2184.SpecialisedAssembly):
    '''RollingRingAssembly
    ...
    @property
    def rolling_rings(self) -> 'List[_2303.RollingRing]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RollingRings, constructor.new(_2303.RollingRing))
        return value
