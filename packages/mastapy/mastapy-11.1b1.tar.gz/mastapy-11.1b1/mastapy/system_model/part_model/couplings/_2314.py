...
from mastapy.system_model.part_model.couplings import _2315, _2317, _2290
...
class TorqueConverter(_2290.Coupling):
    '''TorqueConverter
    ...
    @property
    def pump(self) -> '_2315.TorqueConverterPump':
        ...
        return constructor.new(_2315.TorqueConverterPump)(self.wrapped.Pump) if self.wrapped.Pump else None

    @property
    def turbine(self) -> '_2317.TorqueConverterTurbine':
        ...
        return constructor.new(_2317.TorqueConverterTurbine)(self.wrapped.Turbine) if self.wrapped.Turbine else None
