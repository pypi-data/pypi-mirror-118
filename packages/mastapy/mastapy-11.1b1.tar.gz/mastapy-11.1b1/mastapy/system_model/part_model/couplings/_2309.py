...
from mastapy.system_model.part_model.couplings import _2313, _2311
...
class Synchroniser(_2184.SpecialisedAssembly):
    '''Synchroniser
    ...
    @property
    def hub_and_sleeve(self) -> '_2313.SynchroniserSleeve':
        ...
        return constructor.new(_2313.SynchroniserSleeve)(self.wrapped.HubAndSleeve) if self.wrapped.HubAndSleeve else None

    @property
    def left_cone(self) -> '_2311.SynchroniserHalf':
        ...
        return constructor.new(_2311.SynchroniserHalf)(self.wrapped.LeftCone) if self.wrapped.LeftCone else None

    @property
    def right_cone(self) -> '_2311.SynchroniserHalf':
        ...
        return constructor.new(_2311.SynchroniserHalf)(self.wrapped.RightCone) if self.wrapped.RightCone else None

    @property
    def clutch_connection_left(self) -> '_2051.ClutchConnection':
        ...
        return constructor.new(_2051.ClutchConnection)(self.wrapped.ClutchConnectionLeft) if self.wrapped.ClutchConnectionLeft else None

    @property
    def clutch_connection_right(self) -> '_2051.ClutchConnection':
        ...
        return constructor.new(_2051.ClutchConnection)(self.wrapped.ClutchConnectionRight) if self.wrapped.ClutchConnectionRight else None
