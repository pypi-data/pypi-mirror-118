...
from mastapy.system_model.connections_and_sockets import (
    _1985, _1975, _1976, _1983,
    _1988, _1989, _1991, _1992,
    _1993, _1994, _1995, _1997,
    _1998, _1999, _2002, _2003,
...
class Connector(_2172.MountableComponent):
    '''Connector
    ...
    @property
    def outer_socket(self) -> '_1985.CylindricalSocket':
        ...
        if _1985.CylindricalSocket.TYPE not in self.wrapped.OuterSocket.__class__.__mro__:
    ...
    @property
    def outer_socket_of_type_bearing_inner_socket(self) -> '_1975.BearingInnerSocket':
        ...
        if _1975.BearingInnerSocket.TYPE not in self.wrapped.OuterSocket.__class__.__mro__:
    ...
    @property
    def outer_socket_of_type_bearing_outer_socket(self) -> '_1976.BearingOuterSocket':
        ...
        if _1976.BearingOuterSocket.TYPE not in self.wrapped.OuterSocket.__class__.__mro__:
    ...
    @property
    def outer_socket_of_type_cvt_pulley_socket(self) -> '_1983.CVTPulleySocket':
        ...
        if _1983.CVTPulleySocket.TYPE not in self.wrapped.OuterSocket.__class__.__mro__:
    ...
    @property
    def outer_socket_of_type_inner_shaft_socket(self) -> '_1988.InnerShaftSocket':
        ...
        if _1988.InnerShaftSocket.TYPE not in self.wrapped.OuterSocket.__class__.__mro__:
    ...
    @property
    def outer_socket_of_type_inner_shaft_socket_base(self) -> '_1989.InnerShaftSocketBase':
        ...
        if _1989.InnerShaftSocketBase.TYPE not in self.wrapped.OuterSocket.__class__.__mro__:
    ...
    @property
    def outer_socket_of_type_mountable_component_inner_socket(self) -> '_1991.MountableComponentInnerSocket':
        ...
        if _1991.MountableComponentInnerSocket.TYPE not in self.wrapped.OuterSocket.__class__.__mro__:
    ...
    @property
    def outer_socket_of_type_mountable_component_outer_socket(self) -> '_1992.MountableComponentOuterSocket':
        ...
        if _1992.MountableComponentOuterSocket.TYPE not in self.wrapped.OuterSocket.__class__.__mro__:
    ...
    @property
    def outer_socket_of_type_mountable_component_socket(self) -> '_1993.MountableComponentSocket':
        ...
        if _1993.MountableComponentSocket.TYPE not in self.wrapped.OuterSocket.__class__.__mro__:
    ...
    @property
    def outer_socket_of_type_outer_shaft_socket(self) -> '_1994.OuterShaftSocket':
        ...
        if _1994.OuterShaftSocket.TYPE not in self.wrapped.OuterSocket.__class__.__mro__:
    ...
    @property
    def outer_socket_of_type_outer_shaft_socket_base(self) -> '_1995.OuterShaftSocketBase':
        ...
        if _1995.OuterShaftSocketBase.TYPE not in self.wrapped.OuterSocket.__class__.__mro__:
    ...
    @property
    def outer_socket_of_type_planetary_socket(self) -> '_1997.PlanetarySocket':
        ...
        if _1997.PlanetarySocket.TYPE not in self.wrapped.OuterSocket.__class__.__mro__:
    ...
    @property
    def outer_socket_of_type_planetary_socket_base(self) -> '_1998.PlanetarySocketBase':
        ...
        if _1998.PlanetarySocketBase.TYPE not in self.wrapped.OuterSocket.__class__.__mro__:
    ...
    @property
    def outer_socket_of_type_pulley_socket(self) -> '_1999.PulleySocket':
        ...
        if _1999.PulleySocket.TYPE not in self.wrapped.OuterSocket.__class__.__mro__:
    ...
    @property
    def outer_socket_of_type_rolling_ring_socket(self) -> '_2002.RollingRingSocket':
        ...
        if _2002.RollingRingSocket.TYPE not in self.wrapped.OuterSocket.__class__.__mro__:
    ...
    @property
    def outer_socket_of_type_shaft_socket(self) -> '_2003.ShaftSocket':
        ...
        if _2003.ShaftSocket.TYPE not in self.wrapped.OuterSocket.__class__.__mro__:
    ...
    @property
    def outer_socket_of_type_cylindrical_gear_teeth_socket(self) -> '_2019.CylindricalGearTeethSocket':
        ...
        if _2019.CylindricalGearTeethSocket.TYPE not in self.wrapped.OuterSocket.__class__.__mro__:
    ...
    @property
    def outer_socket_of_type_cycloidal_disc_axial_left_socket(self) -> '_2042.CycloidalDiscAxialLeftSocket':
        ...
        if _2042.CycloidalDiscAxialLeftSocket.TYPE not in self.wrapped.OuterSocket.__class__.__mro__:
    ...
    @property
    def outer_socket_of_type_cycloidal_disc_axial_right_socket(self) -> '_2043.CycloidalDiscAxialRightSocket':
        ...
        if _2043.CycloidalDiscAxialRightSocket.TYPE not in self.wrapped.OuterSocket.__class__.__mro__:
    ...
    @property
    def outer_socket_of_type_cycloidal_disc_inner_socket(self) -> '_2045.CycloidalDiscInnerSocket':
        ...
        if _2045.CycloidalDiscInnerSocket.TYPE not in self.wrapped.OuterSocket.__class__.__mro__:
    ...
    @property
    def outer_socket_of_type_cycloidal_disc_outer_socket(self) -> '_2046.CycloidalDiscOuterSocket':
        ...
        if _2046.CycloidalDiscOuterSocket.TYPE not in self.wrapped.OuterSocket.__class__.__mro__:
    ...
    @property
    def outer_socket_of_type_cycloidal_disc_planetary_bearing_socket(self) -> '_2048.CycloidalDiscPlanetaryBearingSocket':
        ...
        if _2048.CycloidalDiscPlanetaryBearingSocket.TYPE not in self.wrapped.OuterSocket.__class__.__mro__:
    ...
    @property
    def outer_socket_of_type_ring_pins_socket(self) -> '_2049.RingPinsSocket':
        ...
        if _2049.RingPinsSocket.TYPE not in self.wrapped.OuterSocket.__class__.__mro__:
    ...
    @property
    def outer_socket_of_type_clutch_socket(self) -> '_2052.ClutchSocket':
        ...
        if _2052.ClutchSocket.TYPE not in self.wrapped.OuterSocket.__class__.__mro__:
    ...
    @property
    def outer_socket_of_type_concept_coupling_socket(self) -> '_2054.ConceptCouplingSocket':
        ...
        if _2054.ConceptCouplingSocket.TYPE not in self.wrapped.OuterSocket.__class__.__mro__:
    ...
    @property
    def outer_socket_of_type_coupling_socket(self) -> '_2056.CouplingSocket':
        ...
        if _2056.CouplingSocket.TYPE not in self.wrapped.OuterSocket.__class__.__mro__:
    ...
    @property
    def outer_socket_of_type_part_to_part_shear_coupling_socket(self) -> '_2058.PartToPartShearCouplingSocket':
        ...
        if _2058.PartToPartShearCouplingSocket.TYPE not in self.wrapped.OuterSocket.__class__.__mro__:
    ...
    @property
    def outer_socket_of_type_spring_damper_socket(self) -> '_2060.SpringDamperSocket':
        ...
        if _2060.SpringDamperSocket.TYPE not in self.wrapped.OuterSocket.__class__.__mro__:
    ...
    @property
    def outer_socket_of_type_torque_converter_pump_socket(self) -> '_2062.TorqueConverterPumpSocket':
        ...
        if _2062.TorqueConverterPumpSocket.TYPE not in self.wrapped.OuterSocket.__class__.__mro__:
    ...
    @property
    def outer_socket_of_type_torque_converter_turbine_socket(self) -> '_2063.TorqueConverterTurbineSocket':
        ...
        if _2063.TorqueConverterTurbineSocket.TYPE not in self.wrapped.OuterSocket.__class__.__mro__:
    ...
    @property
    def outer_connection(self) -> '_1981.Connection':
        ...
        if _1981.Connection.TYPE not in self.wrapped.OuterConnection.__class__.__mro__:
    ...
    @property
    def outer_connection_of_type_abstract_shaft_to_mountable_component_connection(self) -> '_1974.AbstractShaftToMountableComponentConnection':
        ...
        if _1974.AbstractShaftToMountableComponentConnection.TYPE not in self.wrapped.OuterConnection.__class__.__mro__:
    ...
    @property
    def outer_connection_of_type_belt_connection(self) -> '_1977.BeltConnection':
        ...
        if _1977.BeltConnection.TYPE not in self.wrapped.OuterConnection.__class__.__mro__:
    ...
    @property
    def outer_connection_of_type_coaxial_connection(self) -> '_1978.CoaxialConnection':
        ...
        if _1978.CoaxialConnection.TYPE not in self.wrapped.OuterConnection.__class__.__mro__:
    ...
    @property
    def outer_connection_of_type_cvt_belt_connection(self) -> '_1982.CVTBeltConnection':
        ...
        if _1982.CVTBeltConnection.TYPE not in self.wrapped.OuterConnection.__class__.__mro__:
    ...
    @property
    def outer_connection_of_type_inter_mountable_component_connection(self) -> '_1990.InterMountableComponentConnection':
        ...
        if _1990.InterMountableComponentConnection.TYPE not in self.wrapped.OuterConnection.__class__.__mro__:
    ...
    @property
    def outer_connection_of_type_planetary_connection(self) -> '_1996.PlanetaryConnection':
        ...
        if _1996.PlanetaryConnection.TYPE not in self.wrapped.OuterConnection.__class__.__mro__:
    ...
    @property
    def outer_connection_of_type_rolling_ring_connection(self) -> '_2001.RollingRingConnection':
        ...
        if _2001.RollingRingConnection.TYPE not in self.wrapped.OuterConnection.__class__.__mro__:
    ...
    @property
    def outer_connection_of_type_shaft_to_mountable_component_connection(self) -> '_2004.ShaftToMountableComponentConnection':
        ...
        if _2004.ShaftToMountableComponentConnection.TYPE not in self.wrapped.OuterConnection.__class__.__mro__:
    ...
    @property
    def outer_connection_of_type_agma_gleason_conical_gear_mesh(self) -> '_2008.AGMAGleasonConicalGearMesh':
        ...
        if _2008.AGMAGleasonConicalGearMesh.TYPE not in self.wrapped.OuterConnection.__class__.__mro__:
    ...
    @property
    def outer_connection_of_type_bevel_differential_gear_mesh(self) -> '_2010.BevelDifferentialGearMesh':
        ...
        if _2010.BevelDifferentialGearMesh.TYPE not in self.wrapped.OuterConnection.__class__.__mro__:
    ...
    @property
    def outer_connection_of_type_bevel_gear_mesh(self) -> '_2012.BevelGearMesh':
        ...
        if _2012.BevelGearMesh.TYPE not in self.wrapped.OuterConnection.__class__.__mro__:
    ...
    @property
    def outer_connection_of_type_concept_gear_mesh(self) -> '_2014.ConceptGearMesh':
        ...
        if _2014.ConceptGearMesh.TYPE not in self.wrapped.OuterConnection.__class__.__mro__:
    ...
    @property
    def outer_connection_of_type_conical_gear_mesh(self) -> '_2016.ConicalGearMesh':
        ...
        if _2016.ConicalGearMesh.TYPE not in self.wrapped.OuterConnection.__class__.__mro__:
    ...
    @property
    def outer_connection_of_type_cylindrical_gear_mesh(self) -> '_2018.CylindricalGearMesh':
        ...
        if _2018.CylindricalGearMesh.TYPE not in self.wrapped.OuterConnection.__class__.__mro__:
    ...
    @property
    def outer_connection_of_type_face_gear_mesh(self) -> '_2020.FaceGearMesh':
        ...
        if _2020.FaceGearMesh.TYPE not in self.wrapped.OuterConnection.__class__.__mro__:
    ...
    @property
    def outer_connection_of_type_gear_mesh(self) -> '_2022.GearMesh':
        ...
        if _2022.GearMesh.TYPE not in self.wrapped.OuterConnection.__class__.__mro__:
    ...
    @property
    def outer_connection_of_type_hypoid_gear_mesh(self) -> '_2024.HypoidGearMesh':
        ...
        if _2024.HypoidGearMesh.TYPE not in self.wrapped.OuterConnection.__class__.__mro__:
    ...
    @property
    def outer_connection_of_type_klingelnberg_cyclo_palloid_conical_gear_mesh(self) -> '_2027.KlingelnbergCycloPalloidConicalGearMesh':
        ...
        if _2027.KlingelnbergCycloPalloidConicalGearMesh.TYPE not in self.wrapped.OuterConnection.__class__.__mro__:
    ...
    @property
    def outer_connection_of_type_klingelnberg_cyclo_palloid_hypoid_gear_mesh(self) -> '_2028.KlingelnbergCycloPalloidHypoidGearMesh':
        ...
        if _2028.KlingelnbergCycloPalloidHypoidGearMesh.TYPE not in self.wrapped.OuterConnection.__class__.__mro__:
    ...
    @property
    def outer_connection_of_type_klingelnberg_cyclo_palloid_spiral_bevel_gear_mesh(self) -> '_2029.KlingelnbergCycloPalloidSpiralBevelGearMesh':
        ...
        if _2029.KlingelnbergCycloPalloidSpiralBevelGearMesh.TYPE not in self.wrapped.OuterConnection.__class__.__mro__:
    ...
    @property
    def outer_connection_of_type_spiral_bevel_gear_mesh(self) -> '_2032.SpiralBevelGearMesh':
        ...
        if _2032.SpiralBevelGearMesh.TYPE not in self.wrapped.OuterConnection.__class__.__mro__:
    ...
    @property
    def outer_connection_of_type_straight_bevel_diff_gear_mesh(self) -> '_2034.StraightBevelDiffGearMesh':
        ...
        if _2034.StraightBevelDiffGearMesh.TYPE not in self.wrapped.OuterConnection.__class__.__mro__:
    ...
    @property
    def outer_connection_of_type_straight_bevel_gear_mesh(self) -> '_2036.StraightBevelGearMesh':
        ...
        if _2036.StraightBevelGearMesh.TYPE not in self.wrapped.OuterConnection.__class__.__mro__:
    ...
    @property
    def outer_connection_of_type_worm_gear_mesh(self) -> '_2038.WormGearMesh':
        ...
        if _2038.WormGearMesh.TYPE not in self.wrapped.OuterConnection.__class__.__mro__:
    ...
    @property
    def outer_connection_of_type_zerol_bevel_gear_mesh(self) -> '_2040.ZerolBevelGearMesh':
        ...
        if _2040.ZerolBevelGearMesh.TYPE not in self.wrapped.OuterConnection.__class__.__mro__:
    ...
    @property
    def outer_connection_of_type_cycloidal_disc_central_bearing_connection(self) -> '_2044.CycloidalDiscCentralBearingConnection':
        ...
        if _2044.CycloidalDiscCentralBearingConnection.TYPE not in self.wrapped.OuterConnection.__class__.__mro__:
    ...
    @property
    def outer_connection_of_type_cycloidal_disc_planetary_bearing_connection(self) -> '_2047.CycloidalDiscPlanetaryBearingConnection':
        ...
        if _2047.CycloidalDiscPlanetaryBearingConnection.TYPE not in self.wrapped.OuterConnection.__class__.__mro__:
    ...
    @property
    def outer_connection_of_type_ring_pins_to_disc_connection(self) -> '_2050.RingPinsToDiscConnection':
        ...
        if _2050.RingPinsToDiscConnection.TYPE not in self.wrapped.OuterConnection.__class__.__mro__:
    ...
    @property
    def outer_connection_of_type_clutch_connection(self) -> '_2051.ClutchConnection':
        ...
        if _2051.ClutchConnection.TYPE not in self.wrapped.OuterConnection.__class__.__mro__:
    ...
    @property
    def outer_connection_of_type_concept_coupling_connection(self) -> '_2053.ConceptCouplingConnection':
        ...
        if _2053.ConceptCouplingConnection.TYPE not in self.wrapped.OuterConnection.__class__.__mro__:
    ...
    @property
    def outer_connection_of_type_coupling_connection(self) -> '_2055.CouplingConnection':
        ...
        if _2055.CouplingConnection.TYPE not in self.wrapped.OuterConnection.__class__.__mro__:
    ...
    @property
    def outer_connection_of_type_part_to_part_shear_coupling_connection(self) -> '_2057.PartToPartShearCouplingConnection':
        ...
        if _2057.PartToPartShearCouplingConnection.TYPE not in self.wrapped.OuterConnection.__class__.__mro__:
    ...
    @property
    def outer_connection_of_type_spring_damper_connection(self) -> '_2059.SpringDamperConnection':
        ...
        if _2059.SpringDamperConnection.TYPE not in self.wrapped.OuterConnection.__class__.__mro__:
    ...
    @property
    def outer_connection_of_type_torque_converter_connection(self) -> '_2061.TorqueConverterConnection':
        ...
        if _2061.TorqueConverterConnection.TYPE not in self.wrapped.OuterConnection.__class__.__mro__:
    ...
    @property
    def outer_component(self) -> '_2145.AbstractShaft':
        ...
        if _2145.AbstractShaft.TYPE not in self.wrapped.OuterComponent.__class__.__mro__:
    ...
    @property
    def outer_component_of_type_shaft(self) -> '_2190.Shaft':
        ...
        if _2190.Shaft.TYPE not in self.wrapped.OuterComponent.__class__.__mro__:
    ...
    @property
    def outer_component_of_type_cycloidal_disc(self) -> '_2276.CycloidalDisc':
        ...
        if _2276.CycloidalDisc.TYPE not in self.wrapped.OuterComponent.__class__.__mro__:
    ...
    def house_in(self, shaft: '_2145.AbstractShaft', offset: Optional['float'] = float('nan')) -> '_1981.Connection':
    ...
    def try_house_in(self, shaft: '_2145.AbstractShaft', offset: Optional['float'] = float('nan')) -> '_2154.ComponentsConnectedResult':
    ...
    def other_component(self, component: '_2153.Component') -> '_2145.AbstractShaft':
