...
from mastapy.utility.enums import _1568
...
class ScalingDrawStyle(_0.APIBase):
    ...
    @property
    def bearing_force_arrows(self) -> '_1568.BearingForceArrowOption':
        ...
        return constructor.new(_1568.BearingForceArrowOption)(value) if value else None

    @bearing_force_arrows.setter
    def bearing_force_arrows(self, value: '_1568.BearingForceArrowOption'):
