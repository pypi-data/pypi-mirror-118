...
from mastapy.math_utility.measured_vectors import _1341
...
class ShaftDeflectionDrawingNodeItem(_0.APIBase):
    ...
    @property
    def node_detail(self) -> '_1341.ForceAndDisplacementResults':
        ...
        return constructor.new(_1341.ForceAndDisplacementResults)(self.wrapped.NodeDetail) if self.wrapped.NodeDetail else None

    @property
    def section_to_the_left_side(self) -> '_2505.ShaftSectionSystemDeflection':
        ...
        return constructor.new(_2505.ShaftSectionSystemDeflection)(self.wrapped.SectionToTheLeftSide) if self.wrapped.SectionToTheLeftSide else None

    @property
    def section_to_the_right_side(self) -> '_2505.ShaftSectionSystemDeflection':
        ...
        return constructor.new(_2505.ShaftSectionSystemDeflection)(self.wrapped.SectionToTheRightSide) if self.wrapped.SectionToTheRightSide else None
