...
class RotorDynamicsViewable(_0.APIBase):
    ...
    @property
    def rotor_dynamics(self) -> '_3726.RotorDynamicsDrawStyle':
        ...
        if _3726.RotorDynamicsDrawStyle.TYPE not in self.wrapped.RotorDynamics.__class__.__mro__:
    ...
    @property
    def rotor_dynamics_of_type_steady_state_synchronous_response_draw_style(self) -> '_3310.SteadyStateSynchronousResponseDrawStyle':
        ...
        if _3310.SteadyStateSynchronousResponseDrawStyle.TYPE not in self.wrapped.RotorDynamics.__class__.__mro__:
    ...
    @property
    def rotor_dynamics_of_type_stability_analysis_draw_style(self) -> '_3571.StabilityAnalysisDrawStyle':
        ...
        if _3571.StabilityAnalysisDrawStyle.TYPE not in self.wrapped.RotorDynamics.__class__.__mro__:
    ...
    @property
    def rotor_dynamics_of_type_critical_speed_analysis_draw_style(self) -> '_6265.CriticalSpeedAnalysisDrawStyle':
        ...
        if _6265.CriticalSpeedAnalysisDrawStyle.TYPE not in self.wrapped.RotorDynamics.__class__.__mro__:
