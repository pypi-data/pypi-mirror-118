...
from mastapy.gears.fe_model.conical import _1136
...
class ConicalSetFEModel(_1129.GearSetFEModel):
    '''ConicalSetFEModel
    ...
    @property
    def flank_data_source(self) -> '_1136.FlankDataSource':
        ...
        return constructor.new(_1136.FlankDataSource)(value) if value else None

    @flank_data_source.setter
    def flank_data_source(self, value: '_1136.FlankDataSource'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
