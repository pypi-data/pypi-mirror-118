...
class ProcessLeadCalculation(_0.APIBase):
    ...
    @property
    def right_flank_accuracy_calculation(self) -> '_612.CalculateLeadDeviationAccuracy':
        ...
        return constructor.new(_612.CalculateLeadDeviationAccuracy)(self.wrapped.RightFlankAccuracyCalculation) if self.wrapped.RightFlankAccuracyCalculation else None

    @property
    def left_flank_accuracy_calculation(self) -> '_612.CalculateLeadDeviationAccuracy':
        ...
        return constructor.new(_612.CalculateLeadDeviationAccuracy)(self.wrapped.LeftFlankAccuracyCalculation) if self.wrapped.LeftFlankAccuracyCalculation else None
