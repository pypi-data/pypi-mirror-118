...
from mastapy.gears.manufacturing.cylindrical.cutters import _682, _678, _679
...
class RackShape(_693.CutterShapeDefinition):
    '''RackShape
    ...
    @property
    def design(self) -> '_682.CylindricalGearRackDesign':
