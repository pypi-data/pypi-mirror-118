...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _643, _637
...
class WormGrindingProcessSimulationInput(_637.ProcessSimulationInput):
    '''WormGrindingProcessSimulationInput
    ...
    @property
    def worm_grinder_manufacture_error(self) -> '_643.WormGrinderManufactureError':
        ...
        return constructor.new(_643.WormGrinderManufactureError)(self.wrapped.WormGrinderManufactureError) if self.wrapped.WormGrinderManufactureError else None
