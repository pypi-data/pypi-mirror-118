...
from mastapy.gears.manufacturing.cylindrical import _585, _584
...
class MicroGeometryInputsLead(_585.MicroGeometryInputs['_584.LeadModificationSegment']):
    '''MicroGeometryInputsLead
    ...
    @property
    def lead_micro_geometry_range(self) -> '_1269.Range':
        ...
        if _1269.Range.TYPE not in self.wrapped.LeadMicroGeometryRange.__class__.__mro__:
