...
from mastapy.gears.manufacturing.cylindrical.cutters.tangibles import _695, _700, _698
...
class CylindricalGearHobDesign(_682.CylindricalGearRackDesign):
    '''CylindricalGearHobDesign
    ...
    @property
    def hob_edge_type(self) -> '_583.HobEdgeTypes':
        '''HobEdgeTypes: 'HobEdgeType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.HobEdgeType)
        return constructor.new(_583.HobEdgeTypes)(value) if value else None

    @hob_edge_type.setter
    def hob_edge_type(self, value: '_583.HobEdgeTypes'):
    ...
    @property
    def nominal_hob_shape(self) -> '_695.CylindricalGearHobShape':
        ...
        return constructor.new(_695.CylindricalGearHobShape)(self.wrapped.NominalHobShape) if self.wrapped.NominalHobShape else None

    @property
    def nominal_rack_shape(self) -> '_700.RackShape':
        ...
        if _700.RackShape.TYPE not in self.wrapped.NominalRackShape.__class__.__mro__:
    ...
    @property
    def nominal_rack_shape_of_type_cylindrical_gear_hob_shape(self) -> '_695.CylindricalGearHobShape':
        ...
        if _695.CylindricalGearHobShape.TYPE not in self.wrapped.NominalRackShape.__class__.__mro__:
    ...
    @property
    def nominal_rack_shape_of_type_cylindrical_gear_worm_grinder_shape(self) -> '_698.CylindricalGearWormGrinderShape':
        ...
        if _698.CylindricalGearWormGrinderShape.TYPE not in self.wrapped.NominalRackShape.__class__.__mro__:
    ...
    @property
    def maximum_hob_material_shape(self) -> '_695.CylindricalGearHobShape':
        ...
        return constructor.new(_695.CylindricalGearHobShape)(self.wrapped.MaximumHobMaterialShape) if self.wrapped.MaximumHobMaterialShape else None

    @property
    def minimum_hob_material_shape(self) -> '_695.CylindricalGearHobShape':
        ...
        return constructor.new(_695.CylindricalGearHobShape)(self.wrapped.MinimumHobMaterialShape) if self.wrapped.MinimumHobMaterialShape else None
