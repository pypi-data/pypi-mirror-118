...
from mastapy.gears.manufacturing.cylindrical.cutter_simulation import _655
...
class FormWheelGrindingSimulationCalculator(_655.CutterSimulationCalc):
    '''FormWheelGrindingSimulationCalculator
    ...
    @property
    def profiled_grinding_wheel(self) -> '_694.CylindricalGearFormedWheelGrinderTangible':
        ...
        return constructor.new(_694.CylindricalGearFormedWheelGrinderTangible)(self.wrapped.ProfiledGrindingWheel) if self.wrapped.ProfiledGrindingWheel else None
