...
class CylindricalGearShaperTangible(_693.CutterShapeDefinition):
    '''CylindricalGearShaperTangible
    ...
    @property
    def design(self) -> '_684.CylindricalGearShaper':
        ...
        return constructor.new(_684.CylindricalGearShaper)(self.wrapped.Design) if self.wrapped.Design else None
