...
class HobSimulationCalculator(_667.RackSimulationCalculator):
    '''HobSimulationCalculator
    ...
    @property
    def hob(self) -> '_695.CylindricalGearHobShape':
        ...
        return constructor.new(_695.CylindricalGearHobShape)(self.wrapped.Hob) if self.wrapped.Hob else None
