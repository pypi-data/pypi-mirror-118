...
from mastapy.gears.manufacturing.cylindrical.axial_and_plunge_shaving_dynamics import _715
...
class RollAngleRangeRelativeToAccuracy(_0.APIBase):
    ...
    @property
    def roll_angle_range(self) -> 'List[_715.RollAngleReportObject]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RollAngleRange, constructor.new(_715.RollAngleReportObject))
        return value
