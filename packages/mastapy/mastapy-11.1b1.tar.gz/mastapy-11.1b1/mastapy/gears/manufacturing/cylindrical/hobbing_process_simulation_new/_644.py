...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _646
...
class WormGrindingCutterCalculation(_646.WormGrindingProcessCalculation):
    '''WormGrindingCutterCalculation
    ...
    @property
    def input_gear_point_of_interest(self) -> '_605.PointOfInterest':
        ...
        return constructor.new(_605.PointOfInterest)(self.wrapped.InputGearPointOfInterest) if self.wrapped.InputGearPointOfInterest else None
