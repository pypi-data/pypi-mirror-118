...
class WormGrinderSimulationCalculator(_667.RackSimulationCalculator):
    '''WormGrinderSimulationCalculator
    ...
    @property
    def worm_grinder(self) -> '_698.CylindricalGearWormGrinderShape':
        ...
        return constructor.new(_698.CylindricalGearWormGrinderShape)(self.wrapped.WormGrinder) if self.wrapped.WormGrinder else None
