...
from mastapy.gears.gear_designs.cylindrical import _942
from mastapy.gears.manufacturing.cylindrical.plunge_shaving import _608, _594
...
class PlungeShaverGeneration(_0.APIBase):
    ...
    @property
    def calculated_conjugate_face_width(self) -> '_1269.Range':
        ...
        if _1269.Range.TYPE not in self.wrapped.CalculatedConjugateFaceWidth.__class__.__mro__:
    ...
    @property
    def crossed_axis_calculation_details(self) -> '_942.CrossedAxisCylindricalGearPairLineContact':
        ...
        return constructor.new(_942.CrossedAxisCylindricalGearPairLineContact)(self.wrapped.CrossedAxisCalculationDetails) if self.wrapped.CrossedAxisCalculationDetails else None

    @property
    def points_of_interest_on_the_shaver(self) -> 'List[_608.ShaverPointOfInterest]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PointsOfInterestOnTheShaver, constructor.new(_608.ShaverPointOfInterest))
        return value

    @property
    def calculation_errors(self) -> 'List[_594.CalculationError]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CalculationErrors, constructor.new(_594.CalculationError))
        return value
