...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _612, _618
...
class HobbingProcessLeadCalculation(_618.HobbingProcessCalculation):
    '''HobbingProcessLeadCalculation
