...
from mastapy.gears.manufacturing.cylindrical.axial_and_plunge_shaving_dynamics import _714, _713, _717
from mastapy.gears.manufacturing.cylindrical.cutter_simulation import _656
from mastapy.gears.manufacturing.cylindrical.cutters import _685, _680
...
class ShavingDynamicsCalculation(_0.APIBase, Generic[T]):
    ...
    @property
    def accuracy_level_iso6(self) -> '_714.RollAngleRangeRelativeToAccuracy':
        ...
        return constructor.new(_714.RollAngleRangeRelativeToAccuracy)(self.wrapped.AccuracyLevelISO6) if self.wrapped.AccuracyLevelISO6 else None

    @property
    def accuracy_level_iso7(self) -> '_714.RollAngleRangeRelativeToAccuracy':
        ...
        return constructor.new(_714.RollAngleRangeRelativeToAccuracy)(self.wrapped.AccuracyLevelISO7) if self.wrapped.AccuracyLevelISO7 else None

    @property
    def designed_gear(self) -> '_656.CylindricalCutterSimulatableGear':
        ...
        return constructor.new(_656.CylindricalCutterSimulatableGear)(self.wrapped.DesignedGear) if self.wrapped.DesignedGear else None

    @property
    def shaver(self) -> '_685.CylindricalGearShaver':
        ...
        if _685.CylindricalGearShaver.TYPE not in self.wrapped.Shaver.__class__.__mro__:
    ...
    @property
    def life_shaver(self) -> '_685.CylindricalGearShaver':
        ...
        if _685.CylindricalGearShaver.TYPE not in self.wrapped.LifeShaver.__class__.__mro__:
    ...
    @property
    def new_cutter_start_of_shaving(self) -> '_962.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_962.CylindricalGearProfileMeasurement)(self.wrapped.NewCutterStartOfShaving) if self.wrapped.NewCutterStartOfShaving else None

    @property
    def life_cutter_start_of_shaving(self) -> '_962.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_962.CylindricalGearProfileMeasurement)(self.wrapped.LifeCutterStartOfShaving) if self.wrapped.LifeCutterStartOfShaving else None
