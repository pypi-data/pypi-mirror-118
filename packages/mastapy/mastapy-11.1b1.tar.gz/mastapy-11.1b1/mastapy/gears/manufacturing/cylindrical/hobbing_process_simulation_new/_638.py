...
T = TypeVar('T', bound='_637.ProcessSimulationInput')
...
class ProcessSimulationNew(_0.APIBase, Generic[T]):
    ...
    @property
    def lead_calculation(self) -> '_634.ProcessLeadCalculation':
        ...
        return constructor.new(_634.ProcessLeadCalculation)(self.wrapped.LeadCalculation) if self.wrapped.LeadCalculation else None

    @property
    def profile_calculation(self) -> '_636.ProcessProfileCalculation':
        ...
        return constructor.new(_636.ProcessProfileCalculation)(self.wrapped.ProfileCalculation) if self.wrapped.ProfileCalculation else None

    @property
    def pitch_calculation(self) -> '_635.ProcessPitchCalculation':
        ...
        return constructor.new(_635.ProcessPitchCalculation)(self.wrapped.PitchCalculation) if self.wrapped.PitchCalculation else None

    @property
    def gear_tooth_shape_calculation(self) -> '_633.ProcessGearShape':
        ...
        return constructor.new(_633.ProcessGearShape)(self.wrapped.GearToothShapeCalculation) if self.wrapped.GearToothShapeCalculation else None

    @property
    def total_modification_calculation(self) -> '_640.ProcessTotalModificationCalculation':
        ...
        return constructor.new(_640.ProcessTotalModificationCalculation)(self.wrapped.TotalModificationCalculation) if self.wrapped.TotalModificationCalculation else None
