...
class ProcessProfileCalculation(_0.APIBase):
    ...
    @property
    def right_flank_accuracy_calculation(self) -> '_614.CalculateProfileDeviationAccuracy':
        ...
        return constructor.new(_614.CalculateProfileDeviationAccuracy)(self.wrapped.RightFlankAccuracyCalculation) if self.wrapped.RightFlankAccuracyCalculation else None

    @property
    def left_flank_accuracy_calculation(self) -> '_614.CalculateProfileDeviationAccuracy':
        ...
        return constructor.new(_614.CalculateProfileDeviationAccuracy)(self.wrapped.LeftFlankAccuracyCalculation) if self.wrapped.LeftFlankAccuracyCalculation else None
