...
from mastapy.gears.manufacturing.cylindrical.axial_and_plunge_shaving_dynamics import _722, _703
...
class ConventionalShavingDynamicsViewModel(_722.ShavingDynamicsViewModel['_703.ConventionalShavingDynamics']):
    '''ConventionalShavingDynamicsViewModel
