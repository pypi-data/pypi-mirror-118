...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _614, _618
...
class HobbingProcessProfileCalculation(_618.HobbingProcessCalculation):
    '''HobbingProcessProfileCalculation
