...
from mastapy.gears.manufacturing.cylindrical.cutter_simulation import _665
...
class RoughCutterCreationSettings(_0.APIBase):
    ...
    @property
    def rough_thickness_used_to_generate_cutter(self) -> '_1018.TolerancedMetalMeasurements':
        ...
        return constructor.new(_1018.TolerancedMetalMeasurements)(value) if value else None

    @rough_thickness_used_to_generate_cutter.setter
    def rough_thickness_used_to_generate_cutter(self, value: '_1018.TolerancedMetalMeasurements'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.RoughThicknessUsedToGenerateCutter = value

    @property
    def finish_thickness_used_to_generate_cutter(self) -> '_1018.TolerancedMetalMeasurements':
    ...
    def finish_thickness_used_to_generate_cutter(self, value: '_1018.TolerancedMetalMeasurements'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.FinishThicknessUsedToGenerateCutter = value

    @property
    def rough_tool_clearances(self) -> '_665.ManufacturingOperationConstraints':
        ...
        return constructor.new(_665.ManufacturingOperationConstraints)(self.wrapped.RoughToolClearances) if self.wrapped.RoughToolClearances else None

    @property
    def finish_tool_clearances(self) -> '_665.ManufacturingOperationConstraints':
        ...
        return constructor.new(_665.ManufacturingOperationConstraints)(self.wrapped.FinishToolClearances) if self.wrapped.FinishToolClearances else None
