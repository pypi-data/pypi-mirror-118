...
class GearCutterSimulation(_0.APIBase):
    ...
    @property
    def cutter_simulation_of_type_finish_cutter_simulation(self) -> '_660.FinishCutterSimulation':
        ...
        if _660.FinishCutterSimulation.TYPE not in self.wrapped.CutterSimulation.__class__.__mro__:
    ...
    @property
    def cutter_simulation_of_type_rough_cutter_simulation(self) -> '_668.RoughCutterSimulation':
        ...
        if _668.RoughCutterSimulation.TYPE not in self.wrapped.CutterSimulation.__class__.__mro__:
    ...
    @property
    def minimum_thickness(self) -> '_655.CutterSimulationCalc':
        ...
        if _655.CutterSimulationCalc.TYPE not in self.wrapped.MinimumThickness.__class__.__mro__:
    ...
    @property
    def minimum_thickness_of_type_form_wheel_grinding_simulation_calculator(self) -> '_662.FormWheelGrindingSimulationCalculator':
        ...
        if _662.FormWheelGrindingSimulationCalculator.TYPE not in self.wrapped.MinimumThickness.__class__.__mro__:
    ...
    @property
    def minimum_thickness_of_type_hob_simulation_calculator(self) -> '_664.HobSimulationCalculator':
        ...
        if _664.HobSimulationCalculator.TYPE not in self.wrapped.MinimumThickness.__class__.__mro__:
    ...
    @property
    def minimum_thickness_of_type_rack_simulation_calculator(self) -> '_667.RackSimulationCalculator':
        ...
        if _667.RackSimulationCalculator.TYPE not in self.wrapped.MinimumThickness.__class__.__mro__:
    ...
    @property
    def minimum_thickness_of_type_shaper_simulation_calculator(self) -> '_669.ShaperSimulationCalculator':
        ...
        if _669.ShaperSimulationCalculator.TYPE not in self.wrapped.MinimumThickness.__class__.__mro__:
    ...
    @property
    def minimum_thickness_of_type_shaving_simulation_calculator(self) -> '_670.ShavingSimulationCalculator':
        ...
        if _670.ShavingSimulationCalculator.TYPE not in self.wrapped.MinimumThickness.__class__.__mro__:
    ...
    @property
    def minimum_thickness_of_type_virtual_simulation_calculator(self) -> '_671.VirtualSimulationCalculator':
        ...
        if _671.VirtualSimulationCalculator.TYPE not in self.wrapped.MinimumThickness.__class__.__mro__:
    ...
    @property
    def minimum_thickness_of_type_worm_grinder_simulation_calculator(self) -> '_672.WormGrinderSimulationCalculator':
        ...
        if _672.WormGrinderSimulationCalculator.TYPE not in self.wrapped.MinimumThickness.__class__.__mro__:
    ...
    @property
    def average_thickness(self) -> '_655.CutterSimulationCalc':
        ...
        if _655.CutterSimulationCalc.TYPE not in self.wrapped.AverageThickness.__class__.__mro__:
    ...
    @property
    def average_thickness_of_type_form_wheel_grinding_simulation_calculator(self) -> '_662.FormWheelGrindingSimulationCalculator':
        ...
        if _662.FormWheelGrindingSimulationCalculator.TYPE not in self.wrapped.AverageThickness.__class__.__mro__:
    ...
    @property
    def average_thickness_of_type_hob_simulation_calculator(self) -> '_664.HobSimulationCalculator':
        ...
        if _664.HobSimulationCalculator.TYPE not in self.wrapped.AverageThickness.__class__.__mro__:
    ...
    @property
    def average_thickness_of_type_rack_simulation_calculator(self) -> '_667.RackSimulationCalculator':
        ...
        if _667.RackSimulationCalculator.TYPE not in self.wrapped.AverageThickness.__class__.__mro__:
    ...
    @property
    def average_thickness_of_type_shaper_simulation_calculator(self) -> '_669.ShaperSimulationCalculator':
        ...
        if _669.ShaperSimulationCalculator.TYPE not in self.wrapped.AverageThickness.__class__.__mro__:
    ...
    @property
    def average_thickness_of_type_shaving_simulation_calculator(self) -> '_670.ShavingSimulationCalculator':
        ...
        if _670.ShavingSimulationCalculator.TYPE not in self.wrapped.AverageThickness.__class__.__mro__:
    ...
    @property
    def average_thickness_of_type_virtual_simulation_calculator(self) -> '_671.VirtualSimulationCalculator':
        ...
        if _671.VirtualSimulationCalculator.TYPE not in self.wrapped.AverageThickness.__class__.__mro__:
    ...
    @property
    def average_thickness_of_type_worm_grinder_simulation_calculator(self) -> '_672.WormGrinderSimulationCalculator':
        ...
        if _672.WormGrinderSimulationCalculator.TYPE not in self.wrapped.AverageThickness.__class__.__mro__:
    ...
    @property
    def maximum_thickness(self) -> '_655.CutterSimulationCalc':
        ...
        if _655.CutterSimulationCalc.TYPE not in self.wrapped.MaximumThickness.__class__.__mro__:
    ...
    @property
    def maximum_thickness_of_type_form_wheel_grinding_simulation_calculator(self) -> '_662.FormWheelGrindingSimulationCalculator':
        ...
        if _662.FormWheelGrindingSimulationCalculator.TYPE not in self.wrapped.MaximumThickness.__class__.__mro__:
    ...
    @property
    def maximum_thickness_of_type_hob_simulation_calculator(self) -> '_664.HobSimulationCalculator':
        ...
        if _664.HobSimulationCalculator.TYPE not in self.wrapped.MaximumThickness.__class__.__mro__:
    ...
    @property
    def maximum_thickness_of_type_rack_simulation_calculator(self) -> '_667.RackSimulationCalculator':
        ...
        if _667.RackSimulationCalculator.TYPE not in self.wrapped.MaximumThickness.__class__.__mro__:
    ...
    @property
    def maximum_thickness_of_type_shaper_simulation_calculator(self) -> '_669.ShaperSimulationCalculator':
        ...
        if _669.ShaperSimulationCalculator.TYPE not in self.wrapped.MaximumThickness.__class__.__mro__:
    ...
    @property
    def maximum_thickness_of_type_shaving_simulation_calculator(self) -> '_670.ShavingSimulationCalculator':
        ...
        if _670.ShavingSimulationCalculator.TYPE not in self.wrapped.MaximumThickness.__class__.__mro__:
    ...
    @property
    def maximum_thickness_of_type_virtual_simulation_calculator(self) -> '_671.VirtualSimulationCalculator':
        ...
        if _671.VirtualSimulationCalculator.TYPE not in self.wrapped.MaximumThickness.__class__.__mro__:
    ...
    @property
    def maximum_thickness_of_type_worm_grinder_simulation_calculator(self) -> '_672.WormGrinderSimulationCalculator':
        ...
        if _672.WormGrinderSimulationCalculator.TYPE not in self.wrapped.MaximumThickness.__class__.__mro__:
    ...
    @property
    def smallest_active_profile(self) -> '_655.CutterSimulationCalc':
        ...
        if _655.CutterSimulationCalc.TYPE not in self.wrapped.SmallestActiveProfile.__class__.__mro__:
    ...
    @property
    def smallest_active_profile_of_type_form_wheel_grinding_simulation_calculator(self) -> '_662.FormWheelGrindingSimulationCalculator':
        ...
        if _662.FormWheelGrindingSimulationCalculator.TYPE not in self.wrapped.SmallestActiveProfile.__class__.__mro__:
    ...
    @property
    def smallest_active_profile_of_type_hob_simulation_calculator(self) -> '_664.HobSimulationCalculator':
        ...
        if _664.HobSimulationCalculator.TYPE not in self.wrapped.SmallestActiveProfile.__class__.__mro__:
    ...
    @property
    def smallest_active_profile_of_type_rack_simulation_calculator(self) -> '_667.RackSimulationCalculator':
        ...
        if _667.RackSimulationCalculator.TYPE not in self.wrapped.SmallestActiveProfile.__class__.__mro__:
    ...
    @property
    def smallest_active_profile_of_type_shaper_simulation_calculator(self) -> '_669.ShaperSimulationCalculator':
        ...
        if _669.ShaperSimulationCalculator.TYPE not in self.wrapped.SmallestActiveProfile.__class__.__mro__:
    ...
    @property
    def smallest_active_profile_of_type_shaving_simulation_calculator(self) -> '_670.ShavingSimulationCalculator':
        ...
        if _670.ShavingSimulationCalculator.TYPE not in self.wrapped.SmallestActiveProfile.__class__.__mro__:
    ...
    @property
    def smallest_active_profile_of_type_virtual_simulation_calculator(self) -> '_671.VirtualSimulationCalculator':
        ...
        if _671.VirtualSimulationCalculator.TYPE not in self.wrapped.SmallestActiveProfile.__class__.__mro__:
    ...
    @property
    def smallest_active_profile_of_type_worm_grinder_simulation_calculator(self) -> '_672.WormGrinderSimulationCalculator':
        ...
        if _672.WormGrinderSimulationCalculator.TYPE not in self.wrapped.SmallestActiveProfile.__class__.__mro__:
    ...
    @property
    def minimum_thickness_virtual(self) -> '_671.VirtualSimulationCalculator':
        ...
        return constructor.new(_671.VirtualSimulationCalculator)(self.wrapped.MinimumThicknessVirtual) if self.wrapped.MinimumThicknessVirtual else None

    @property
    def average_thickness_virtual(self) -> '_671.VirtualSimulationCalculator':
        ...
        return constructor.new(_671.VirtualSimulationCalculator)(self.wrapped.AverageThicknessVirtual) if self.wrapped.AverageThicknessVirtual else None

    @property
    def maximum_thickness_virtual(self) -> '_671.VirtualSimulationCalculator':
        ...
        return constructor.new(_671.VirtualSimulationCalculator)(self.wrapped.MaximumThicknessVirtual) if self.wrapped.MaximumThicknessVirtual else None

    @property
    def thickness_calculators(self) -> 'List[_655.CutterSimulationCalc]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ThicknessCalculators, constructor.new(_655.CutterSimulationCalc))
        return value

    @property
    def virtual_thickness_calculators(self) -> 'List[_671.VirtualSimulationCalculator]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.VirtualThicknessCalculators, constructor.new(_671.VirtualSimulationCalculator))
        return value

    @property
    def gear_mesh_cutter_simulations(self) -> 'List[_658.CylindricalManufacturedRealGearInMesh]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearMeshCutterSimulations, constructor.new(_658.CylindricalManufacturedRealGearInMesh))
        return value

    @property
    def gear_mesh_cutter_simulations_virtual(self) -> 'List[_659.CylindricalManufacturedVirtualGearInMesh]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearMeshCutterSimulationsVirtual, constructor.new(_659.CylindricalManufacturedVirtualGearInMesh))
        return value
