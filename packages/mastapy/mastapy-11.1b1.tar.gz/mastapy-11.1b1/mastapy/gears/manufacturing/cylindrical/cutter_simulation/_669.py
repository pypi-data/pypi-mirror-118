...
class ShaperSimulationCalculator(_655.CutterSimulationCalc):
    '''ShaperSimulationCalculator
    ...
    @property
    def shaper(self) -> '_696.CylindricalGearShaperTangible':
        ...
        return constructor.new(_696.CylindricalGearShaperTangible)(self.wrapped.Shaper) if self.wrapped.Shaper else None
