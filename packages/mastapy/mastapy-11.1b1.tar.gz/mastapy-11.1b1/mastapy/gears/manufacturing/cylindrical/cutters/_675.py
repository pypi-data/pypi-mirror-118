...
from mastapy.gears.manufacturing.cylindrical import _562
...
class CylindricalFormedWheelGrinderDatabase(_562.CylindricalCutterDatabase['_677.CylindricalGearFormGrindingWheel']):
    '''CylindricalFormedWheelGrinderDatabase
