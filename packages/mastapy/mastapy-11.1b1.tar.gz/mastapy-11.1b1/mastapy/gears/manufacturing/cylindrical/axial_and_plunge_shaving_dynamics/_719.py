...
class ShavingDynamicsCalculationForDesignedGears(_718.ShavingDynamicsCalculation['T'], Generic[T]):
    '''ShavingDynamicsCalculationForDesignedGears
    ...
    @property
    def start_of_shaving_profile(self) -> '_962.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_962.CylindricalGearProfileMeasurement)(self.wrapped.StartOfShavingProfile.Value) if self.wrapped.StartOfShavingProfile.Value else None

    @property
    def end_of_shaving_profile(self) -> '_962.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_962.CylindricalGearProfileMeasurement)(self.wrapped.EndOfShavingProfile.Value) if self.wrapped.EndOfShavingProfile.Value else None

    @property
    def redressing(self) -> '_716.ShaverRedressing[T]':
        ...
        if _716.ShaverRedressing[T].TYPE not in self.wrapped.Redressing.__class__.__mro__:
    ...
    @property
    def redressing_of_type_axial_shaver_redressing(self) -> '_702.AxialShaverRedressing':
        ...
        if _702.AxialShaverRedressing.TYPE not in self.wrapped.Redressing.__class__.__mro__:
    ...
    @property
    def redressing_of_type_plunge_shaver_redressing(self) -> '_709.PlungeShaverRedressing':
        ...
        if _709.PlungeShaverRedressing.TYPE not in self.wrapped.Redressing.__class__.__mro__:
