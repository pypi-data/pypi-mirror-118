...
from mastapy.gears.gear_designs.cylindrical import _963
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _614, _646
...
class WormGrindingProcessProfileCalculation(_646.WormGrindingProcessCalculation):
    '''WormGrindingProcessProfileCalculation
    ...
    @property
    def right_flank(self) -> '_614.CalculateProfileDeviationAccuracy':
        ...
        return constructor.new(_614.CalculateProfileDeviationAccuracy)(self.wrapped.RightFlank) if self.wrapped.RightFlank else None

    @property
    def left_flank(self) -> '_614.CalculateProfileDeviationAccuracy':
        ...
        return constructor.new(_614.CalculateProfileDeviationAccuracy)(self.wrapped.LeftFlank) if self.wrapped.LeftFlank else None
