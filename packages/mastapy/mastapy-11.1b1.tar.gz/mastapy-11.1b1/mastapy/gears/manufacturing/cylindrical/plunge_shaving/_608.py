...
class ShaverPointOfInterest(_0.APIBase):
    ...
    @property
    def point_of_interest_on_the_gear(self) -> '_605.PointOfInterest':
        ...
        return constructor.new(_605.PointOfInterest)(self.wrapped.PointOfInterestOnTheGear) if self.wrapped.PointOfInterestOnTheGear else None
