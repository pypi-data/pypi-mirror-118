...
class PlungeShaverCalculationInputs(_0.APIBase):
    ...
    @property
    def input_gear_geometry(self) -> '_656.CylindricalCutterSimulatableGear':
        ...
        return constructor.new(_656.CylindricalCutterSimulatableGear)(self.wrapped.InputGearGeometry) if self.wrapped.InputGearGeometry else None

    @property
    def tooth_thickness(self) -> '_1022.ToothThicknessSpecificationBase':
        ...
        if _1022.ToothThicknessSpecificationBase.TYPE not in self.wrapped.ToothThickness.__class__.__mro__:
    ...
    @property
    def tooth_thickness_of_type_finish_tooth_thickness_design_specification(self) -> '_982.FinishToothThicknessDesignSpecification':
        ...
        if _982.FinishToothThicknessDesignSpecification.TYPE not in self.wrapped.ToothThickness.__class__.__mro__:
    ...
    @property
    def tooth_thickness_of_type_readonly_tooth_thickness_specification(self) -> '_1003.ReadonlyToothThicknessSpecification':
        ...
        if _1003.ReadonlyToothThicknessSpecification.TYPE not in self.wrapped.ToothThickness.__class__.__mro__:
    ...
    @property
    def tooth_thickness_of_type_tooth_thickness_specification(self) -> '_1021.ToothThicknessSpecification':
        ...
        if _1021.ToothThicknessSpecification.TYPE not in self.wrapped.ToothThickness.__class__.__mro__:
