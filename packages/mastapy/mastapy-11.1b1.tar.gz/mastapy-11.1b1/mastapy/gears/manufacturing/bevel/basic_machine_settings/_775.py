...
from mastapy.gears.manufacturing.bevel.basic_machine_settings import _773
...
class BasicConicalGearMachineSettingsGenerated(_773.BasicConicalGearMachineSettings):
    '''BasicConicalGearMachineSettingsGenerated
