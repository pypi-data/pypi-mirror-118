...
from mastapy.gears.manufacturing.bevel import _750, _764
...
class ManufacturingMachine(_1577.NamedDatabaseItem):
    '''ManufacturingMachine
    ...
    @property
    def machine_type(self) -> '_750.MachineTypes':
        '''MachineTypes: 'MachineType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.MachineType)
        return constructor.new(_750.MachineTypes)(value) if value else None

    @machine_type.setter
    def machine_type(self, value: '_750.MachineTypes'):
    ...
    @property
    def wheel_formate_machine_type(self) -> '_764.WheelFormatMachineTypes':
        ...
        return constructor.new(_764.WheelFormatMachineTypes)(value) if value else None

    @wheel_formate_machine_type.setter
    def wheel_formate_machine_type(self, value: '_764.WheelFormatMachineTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
