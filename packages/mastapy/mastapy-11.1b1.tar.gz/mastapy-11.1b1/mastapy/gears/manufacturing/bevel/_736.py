...
from mastapy.gears.manufacturing.bevel import _747, _731
...
class ConicalMeshManufacturingAnalysis(_1149.GearMeshImplementationAnalysis):
    '''ConicalMeshManufacturingAnalysis
    ...
    @property
    def tca(self) -> '_747.EaseOffBasedTCA':
        ...
        return constructor.new(_747.EaseOffBasedTCA)(self.wrapped.TCA) if self.wrapped.TCA else None

    @property
    def meshed_gears(self) -> 'List[_731.ConicalMeshedGearManufacturingAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshedGears, constructor.new(_731.ConicalMeshedGearManufacturingAnalysis))
        return value
