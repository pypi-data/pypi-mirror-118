...
from mastapy.gears.gear_designs.face import _933, _927
...
class FaceGearMeshDesign(_887.GearMeshDesign):
    '''FaceGearMeshDesign
    ...
    @property
    def face_gear_set(self) -> '_933.FaceGearSetDesign':
        ...
        return constructor.new(_933.FaceGearSetDesign)(self.wrapped.FaceGearSet) if self.wrapped.FaceGearSet else None
