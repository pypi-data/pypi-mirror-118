...
class ConicalGearCutter(_0.APIBase):
    ...
    @property
    def outer_toprem_letter_concave(self) -> '_1100.TopremLetter':
        ...
        return constructor.new(_1100.TopremLetter)(value) if value else None

    @outer_toprem_letter_concave.setter
    def outer_toprem_letter_concave(self, value: '_1100.TopremLetter'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.OuterTopremLetterConcave = value

    @property
    def inner_toprem_letter_convex(self) -> '_1100.TopremLetter':
    ...
    def inner_toprem_letter_convex(self, value: '_1100.TopremLetter'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
