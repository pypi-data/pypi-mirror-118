...
from mastapy.gears.gear_designs.zerol_bevel import _890, _891
...
class ZerolBevelGearSetDesign(_1111.BevelGearSetDesign):
    '''ZerolBevelGearSetDesign
    ...
    @property
    def gears(self) -> 'List[_890.ZerolBevelGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_890.ZerolBevelGearDesign))
        return value

    @property
    def zerol_bevel_gears(self) -> 'List[_890.ZerolBevelGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelGears, constructor.new(_890.ZerolBevelGearDesign))
        return value

    @property
    def zerol_bevel_meshes(self) -> 'List[_891.ZerolBevelGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelMeshes, constructor.new(_891.ZerolBevelGearMeshDesign))
        return value
