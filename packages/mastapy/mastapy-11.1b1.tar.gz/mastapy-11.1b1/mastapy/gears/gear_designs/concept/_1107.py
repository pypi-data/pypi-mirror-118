...
from mastapy.gears.gear_designs.concept import _1105, _1106
...
class ConceptGearSetDesign(_888.GearSetDesign):
    '''ConceptGearSetDesign
    ...
    @property
    def gears(self) -> 'List[_1105.ConceptGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_1105.ConceptGearDesign))
        return value

    @property
    def concept_gears(self) -> 'List[_1105.ConceptGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGears, constructor.new(_1105.ConceptGearDesign))
        return value

    @property
    def concept_meshes(self) -> 'List[_1106.ConceptGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshes, constructor.new(_1106.ConceptGearMeshDesign))
        return value
