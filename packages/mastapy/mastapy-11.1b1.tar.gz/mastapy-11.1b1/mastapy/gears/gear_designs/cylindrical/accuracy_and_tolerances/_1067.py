...
from mastapy.gears.gear_designs.cylindrical.accuracy_and_tolerances import _1069, _1065, _1074
...
class CylindricalAccuracyGrader(_0.APIBase):
    ...
    @property
    def accuracy_grades(self) -> '_1069.CylindricalAccuracyGrades':
        ...
        if _1069.CylindricalAccuracyGrades.TYPE not in self.wrapped.AccuracyGrades.__class__.__mro__:
    ...
    @property
    def accuracy_grades_of_type_agma20151_accuracy_grades(self) -> '_1065.AGMA20151AccuracyGrades':
        ...
        if _1065.AGMA20151AccuracyGrades.TYPE not in self.wrapped.AccuracyGrades.__class__.__mro__:
    ...
    @property
    def accuracy_grades_of_type_iso1328_accuracy_grades(self) -> '_1074.ISO1328AccuracyGrades':
        ...
        if _1074.ISO1328AccuracyGrades.TYPE not in self.wrapped.AccuracyGrades.__class__.__mro__:
