...
class FinishStockSpecification(_1005.RelativeValuesSpecification['FinishStockSpecification']):
    ...
    @property
    def normal(self) -> '_1019.TolerancedValueSpecification[FinishStockSpecification]':
        ...
        if _1019.TolerancedValueSpecification[FinishStockSpecification].TYPE not in self.wrapped.Normal.__class__.__mro__:
    ...
    @property
    def tangent_to_reference_circle(self) -> '_1019.TolerancedValueSpecification[FinishStockSpecification]':
        ...
        if _1019.TolerancedValueSpecification[FinishStockSpecification].TYPE not in self.wrapped.TangentToReferenceCircle.__class__.__mro__:
