...
class CylindricalGearLeadModificationAtProfilePosition(_1030.CylindricalGearLeadModification):
    '''CylindricalGearLeadModificationAtProfilePosition
    ...
    @property
    def profile_measurement(self) -> '_962.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_962.CylindricalGearProfileMeasurement)(self.wrapped.ProfileMeasurement) if self.wrapped.ProfileMeasurement else None
