...
from mastapy.gears.gear_designs.cylindrical import (
    _936, _983, _1006, _1000,
    _1024, _966, _997, _950,
    _957, _967
)
...
class CylindricalGearSetDesign(_888.GearSetDesign):
    '''CylindricalGearSetDesign
    ...
    @property
    def profile_shift_distribution_rule(self) -> '_936.AddendumModificationDistributionRule':
        ...
        return constructor.new(_936.AddendumModificationDistributionRule)(value) if value else None

    @profile_shift_distribution_rule.setter
    def profile_shift_distribution_rule(self, value: '_936.AddendumModificationDistributionRule'):
    ...
    @property
    def gear_fit_system(self) -> '_983.GearFitSystems':
        ...
        return constructor.new(_983.GearFitSystems)(value) if value else None

    @gear_fit_system.setter
    def gear_fit_system(self, value: '_983.GearFitSystems'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def scuffing(self) -> '_1006.Scuffing':
        ...
        return constructor.new(_1006.Scuffing)(self.wrapped.Scuffing) if self.wrapped.Scuffing else None

    @property
    def micropitting(self) -> '_1000.Micropitting':
        ...
        return constructor.new(_1000.Micropitting)(self.wrapped.Micropitting) if self.wrapped.Micropitting else None
    ...
    @property
    def left_flank(self) -> '_966.CylindricalGearSetFlankDesign':
        ...
        return constructor.new(_966.CylindricalGearSetFlankDesign)(self.wrapped.LeftFlank) if self.wrapped.LeftFlank else None

    @property
    def right_flank(self) -> '_966.CylindricalGearSetFlankDesign':
        ...
        return constructor.new(_966.CylindricalGearSetFlankDesign)(self.wrapped.RightFlank) if self.wrapped.RightFlank else None

    @property
    def ltca_settings(self) -> '_997.LtcaSettings':
        ...
        return constructor.new(_997.LtcaSettings)(self.wrapped.LTCASettings) if self.wrapped.LTCASettings else None

    @property
    def cylindrical_gear_set_manufacturing_configuration(self) -> '_577.CylindricalSetManufacturingConfig':
        ...
        return constructor.new(_577.CylindricalSetManufacturingConfig)(self.wrapped.CylindricalGearSetManufacturingConfiguration) if self.wrapped.CylindricalGearSetManufacturingConfiguration else None

    @property
    def gears(self) -> 'List[_950.CylindricalGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_950.CylindricalGearDesign))
        return value

    @property
    def cylindrical_gears(self) -> 'List[_950.CylindricalGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGears, constructor.new(_950.CylindricalGearDesign))
        return value
    ...
    @property
    def flanks(self) -> 'List[_966.CylindricalGearSetFlankDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Flanks, constructor.new(_966.CylindricalGearSetFlankDesign))
        return value

    @property
    def micro_geometries(self) -> 'List[_1039.CylindricalGearSetMicroGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MicroGeometries, constructor.new(_1039.CylindricalGearSetMicroGeometry))
        return value

    @property
    def both_flanks(self) -> '_966.CylindricalGearSetFlankDesign':
        ...
        return constructor.new(_966.CylindricalGearSetFlankDesign)(self.wrapped.BothFlanks) if self.wrapped.BothFlanks else None

    @property
    def manufacturing_configurations(self) -> 'List[_577.CylindricalSetManufacturingConfig]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ManufacturingConfigurations, constructor.new(_577.CylindricalSetManufacturingConfig))
        return value
    ...
    def create_optimiser(self, duty_cycle: '_426.CylindricalGearSetDutyCycleRating') -> '_967.CylindricalGearSetMacroGeometryOptimiser':
    ...
    def set_active_manufacturing_configuration(self, value: '_577.CylindricalSetManufacturingConfig'):
    ...
    def add_new_manufacturing_configuration(self, new_config_name: Optional['str'] = 'None') -> '_577.CylindricalSetManufacturingConfig':
    ...
    def delete_manufacturing_configuration(self, config: '_577.CylindricalSetManufacturingConfig'):
    ...
    def add_new_micro_geometry(self) -> '_1039.CylindricalGearSetMicroGeometry':
    ...
    def delete_micro_geometry(self, micro_geometry: '_1039.CylindricalGearSetMicroGeometry'):
    ...
    def set_active_micro_geometry(self, value: '_1039.CylindricalGearSetMicroGeometry'):
    ...
    def micro_geometry_named(self, micro_geometry_name: 'str') -> '_1039.CylindricalGearSetMicroGeometry':
