...
class Usage(_1364.IndependentReportablePropertiesBase['Usage']):
    '''Usage
    ...
    @property
    def spur_gear_load_sharing_code(self) -> '_1011.SpurGearLoadSharingCodes':
        ...
        return constructor.new(_1011.SpurGearLoadSharingCodes)(value) if value else None

    @spur_gear_load_sharing_code.setter
    def spur_gear_load_sharing_code(self, value: '_1011.SpurGearLoadSharingCodes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
