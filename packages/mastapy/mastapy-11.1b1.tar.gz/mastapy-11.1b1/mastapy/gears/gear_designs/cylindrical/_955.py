...
class CylindricalGearDesignSettings(_1369.PerMachineSettings):
    '''CylindricalGearDesignSettings
    ...
    @property
    def default_micro_geometry_lead_tolerance_chart_view(self) -> '_1053.MicroGeometryLeadToleranceChartView':
        ...
        return constructor.new(_1053.MicroGeometryLeadToleranceChartView)(value) if value else None

    @default_micro_geometry_lead_tolerance_chart_view.setter
    def default_micro_geometry_lead_tolerance_chart_view(self, value: '_1053.MicroGeometryLeadToleranceChartView'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.DefaultMicroGeometryLeadToleranceChartView = value

    @property
    def default_scale_and_range_of_flank_relief_axes_for_micro_geometry_tolerance_charts(self) -> '_980.DoubleAxisScaleAndRange':
        ...
        return constructor.new(_980.DoubleAxisScaleAndRange)(value) if value else None

    @default_scale_and_range_of_flank_relief_axes_for_micro_geometry_tolerance_charts.setter
    def default_scale_and_range_of_flank_relief_axes_for_micro_geometry_tolerance_charts(self, value: '_980.DoubleAxisScaleAndRange'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.DefaultScaleAndRangeOfFlankReliefAxesForMicroGeometryToleranceCharts = value

    @property
    def default_flank_side_with_zero_face_width(self) -> '_523.FlankSide':
        ...
        return constructor.new(_523.FlankSide)(value) if value else None

    @default_flank_side_with_zero_face_width.setter
    def default_flank_side_with_zero_face_width(self, value: '_523.FlankSide'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.DefaultFlankSideWithZeroFaceWidth = value

    @property
    def cylindrical_gear_profile_measurement(self) -> '_963.CylindricalGearProfileMeasurementType':
        ...
        return constructor.new(_963.CylindricalGearProfileMeasurementType)(value) if value else None

    @cylindrical_gear_profile_measurement.setter
    def cylindrical_gear_profile_measurement(self, value: '_963.CylindricalGearProfileMeasurementType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def tolerance_rounding_system(self) -> '_1382.MeasurementSystem':
        ...
        return constructor.new(_1382.MeasurementSystem)(value) if value else None

    @tolerance_rounding_system.setter
    def tolerance_rounding_system(self, value: '_1382.MeasurementSystem'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def micro_geometry_lead_relief_definition(self) -> '_998.MicroGeometryConvention':
        ...
        return constructor.new(_998.MicroGeometryConvention)(value) if value else None

    @micro_geometry_lead_relief_definition.setter
    def micro_geometry_lead_relief_definition(self, value: '_998.MicroGeometryConvention'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.MicroGeometryLeadReliefDefinition = value

    @property
    def micro_geometry_profile_relief_definition(self) -> '_999.MicroGeometryProfileConvention':
        ...
        return constructor.new(_999.MicroGeometryProfileConvention)(value) if value else None

    @micro_geometry_profile_relief_definition.setter
    def micro_geometry_profile_relief_definition(self, value: '_999.MicroGeometryProfileConvention'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def main_profile_modification_ends_at_the_start_of_tip_relief_by_default(self) -> '_530.MainProfileReliefEndsAtTheStartOfTipReliefOption':
        ...
        return constructor.new(_530.MainProfileReliefEndsAtTheStartOfTipReliefOption)(value) if value else None

    @main_profile_modification_ends_at_the_start_of_tip_relief_by_default.setter
    def main_profile_modification_ends_at_the_start_of_tip_relief_by_default(self, value: '_530.MainProfileReliefEndsAtTheStartOfTipReliefOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def parabolic_tip_relief_starts_tangent_to_main_profile_relief_by_default(self) -> '_533.ParabolicTipReliefStartsTangentToMainProfileRelief':
        ...
        return constructor.new(_533.ParabolicTipReliefStartsTangentToMainProfileRelief)(value) if value else None

    @parabolic_tip_relief_starts_tangent_to_main_profile_relief_by_default.setter
    def parabolic_tip_relief_starts_tangent_to_main_profile_relief_by_default(self, value: '_533.ParabolicTipReliefStartsTangentToMainProfileRelief'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def main_profile_modification_ends_at_the_start_of_root_relief_by_default(self) -> '_529.MainProfileReliefEndsAtTheStartOfRootReliefOption':
        ...
        return constructor.new(_529.MainProfileReliefEndsAtTheStartOfRootReliefOption)(value) if value else None

    @main_profile_modification_ends_at_the_start_of_root_relief_by_default.setter
    def main_profile_modification_ends_at_the_start_of_root_relief_by_default(self, value: '_529.MainProfileReliefEndsAtTheStartOfRootReliefOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def parabolic_root_relief_starts_tangent_to_main_profile_relief_by_default(self) -> '_532.ParabolicRootReliefStartsTangentToMainProfileRelief':
        ...
        return constructor.new(_532.ParabolicRootReliefStartsTangentToMainProfileRelief)(value) if value else None

    @parabolic_root_relief_starts_tangent_to_main_profile_relief_by_default.setter
    def parabolic_root_relief_starts_tangent_to_main_profile_relief_by_default(self, value: '_532.ParabolicRootReliefStartsTangentToMainProfileRelief'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
