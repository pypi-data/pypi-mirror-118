...
from mastapy.gears.gear_designs.cylindrical import _961, _944
...
class CylindricalGearPinionTypeCutter(_944.CylindricalGearAbstractRack):
    '''CylindricalGearPinionTypeCutter
    ...
    @property
    def left_flank(self) -> '_961.CylindricalGearPinionTypeCutterFlank':
        ...
        return constructor.new(_961.CylindricalGearPinionTypeCutterFlank)(self.wrapped.LeftFlank) if self.wrapped.LeftFlank else None

    @property
    def right_flank(self) -> '_961.CylindricalGearPinionTypeCutterFlank':
        ...
        return constructor.new(_961.CylindricalGearPinionTypeCutterFlank)(self.wrapped.RightFlank) if self.wrapped.RightFlank else None
