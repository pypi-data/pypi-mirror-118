...
class CylindricalMeshedGear(_0.APIBase):
    ...
    @property
    def left_flank(self) -> '_974.CylindricalMeshedGearFlank':
        ...
        return constructor.new(_974.CylindricalMeshedGearFlank)(self.wrapped.LeftFlank) if self.wrapped.LeftFlank else None

    @property
    def right_flank(self) -> '_974.CylindricalMeshedGearFlank':
        ...
        return constructor.new(_974.CylindricalMeshedGearFlank)(self.wrapped.RightFlank) if self.wrapped.RightFlank else None

    @property
    def flanks(self) -> 'List[_974.CylindricalMeshedGearFlank]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Flanks, constructor.new(_974.CylindricalMeshedGearFlank))
        return value

    @property
    def both_flanks(self) -> '_974.CylindricalMeshedGearFlank':
        ...
        return constructor.new(_974.CylindricalMeshedGearFlank)(self.wrapped.BothFlanks) if self.wrapped.BothFlanks else None
