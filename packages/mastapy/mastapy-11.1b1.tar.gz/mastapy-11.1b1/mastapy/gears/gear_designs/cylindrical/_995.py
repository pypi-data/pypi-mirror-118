...
from mastapy.gears.gear_designs.cylindrical import _975, _972
...
class LinearBacklashSepcification(_0.APIBase):
    ...
    @property
    def normal_backlash(self) -> '_975.CylindricalMeshLinearBacklashSpecification':
        ...
        if _975.CylindricalMeshLinearBacklashSpecification.TYPE not in self.wrapped.NormalBacklash.__class__.__mro__:
    ...
    @property
    def circumferential_backlash_pitch_circle(self) -> '_975.CylindricalMeshLinearBacklashSpecification':
        ...
        if _975.CylindricalMeshLinearBacklashSpecification.TYPE not in self.wrapped.CircumferentialBacklashPitchCircle.__class__.__mro__:
    ...
    @property
    def circumferential_backlash_reference_circle(self) -> '_975.CylindricalMeshLinearBacklashSpecification':
        ...
        if _975.CylindricalMeshLinearBacklashSpecification.TYPE not in self.wrapped.CircumferentialBacklashReferenceCircle.__class__.__mro__:
    ...
    @property
    def radial_backlash(self) -> '_975.CylindricalMeshLinearBacklashSpecification':
        ...
        if _975.CylindricalMeshLinearBacklashSpecification.TYPE not in self.wrapped.RadialBacklash.__class__.__mro__:
    ...
    @property
    def linear_backlash(self) -> 'List[_975.CylindricalMeshLinearBacklashSpecification]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LinearBacklash, constructor.new(_975.CylindricalMeshLinearBacklashSpecification))
        return value
