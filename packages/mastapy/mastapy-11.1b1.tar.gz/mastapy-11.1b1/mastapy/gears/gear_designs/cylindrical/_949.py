...
class CylindricalGearDefaults(_1369.PerMachineSettings):
    '''CylindricalGearDefaults
    ...
    @property
    def finish_stock_type(self) -> '_1025.FinishStockType':
    ...
    def finish_stock_type(self, value: '_1025.FinishStockType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.FinishStockType = value

    @property
    def system_of_fits_defaults(self) -> '_1070.DIN3967SystemOfGearFits':
        ...
        return constructor.new(_1070.DIN3967SystemOfGearFits)(self.wrapped.SystemOfFitsDefaults) if self.wrapped.SystemOfFitsDefaults else None

    @property
    def rough_cutter_creation_settings(self) -> '_692.RoughCutterCreationSettings':
        ...
        return constructor.new(_692.RoughCutterCreationSettings)(self.wrapped.RoughCutterCreationSettings) if self.wrapped.RoughCutterCreationSettings else None
