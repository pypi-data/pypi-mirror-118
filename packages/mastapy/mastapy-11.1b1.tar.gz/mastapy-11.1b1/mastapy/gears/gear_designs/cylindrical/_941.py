...
class CrossedAxisCylindricalGearPair(_0.APIBase):
    ...
    @property
    def shaver(self) -> '_656.CylindricalCutterSimulatableGear':
        ...
        return constructor.new(_656.CylindricalCutterSimulatableGear)(self.wrapped.Shaver) if self.wrapped.Shaver else None
