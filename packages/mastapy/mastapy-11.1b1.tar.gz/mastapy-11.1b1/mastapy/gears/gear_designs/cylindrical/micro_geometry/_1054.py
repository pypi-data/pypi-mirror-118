...
class MicroGeometryViewingOptions(_0.APIBase):
    ...
    @property
    def gear_option(self) -> '_1043.DrawDefiningGearOrBoth':
        ...
        return constructor.new(_1043.DrawDefiningGearOrBoth)(value) if value else None

    @gear_option.setter
    def gear_option(self, value: '_1043.DrawDefiningGearOrBoth'):
