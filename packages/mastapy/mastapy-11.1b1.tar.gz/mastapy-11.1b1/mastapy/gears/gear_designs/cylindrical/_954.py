...
class CylindricalGearDesignConstraintSettings(_1369.PerMachineSettings):
    '''CylindricalGearDesignConstraintSettings
    ...
    @property
    def cylindrical_gear_design_constraints(self) -> '_952.CylindricalGearDesignConstraints':
        ...
        return constructor.new(_952.CylindricalGearDesignConstraints)(self.wrapped.CylindricalGearDesignConstraints) if self.wrapped.CylindricalGearDesignConstraints else None
