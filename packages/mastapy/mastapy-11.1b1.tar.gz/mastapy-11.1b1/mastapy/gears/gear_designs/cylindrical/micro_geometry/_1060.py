...
class SingleCylindricalGearTriangularEndModification(_0.APIBase):
    ...
    @property
    def profile_evaluation(self) -> '_962.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_962.CylindricalGearProfileMeasurement)(self.wrapped.ProfileEvaluation) if self.wrapped.ProfileEvaluation else None

    @property
    def profile_start(self) -> '_962.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_962.CylindricalGearProfileMeasurement)(self.wrapped.ProfileStart) if self.wrapped.ProfileStart else None
