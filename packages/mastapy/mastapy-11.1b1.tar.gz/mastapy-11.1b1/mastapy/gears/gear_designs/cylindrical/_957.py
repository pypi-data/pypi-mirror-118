...
class CylindricalGearMeshDesign(_887.GearMeshDesign):
    '''CylindricalGearMeshDesign
    ...
    @property
    def profile_modification(self) -> '_964.CylindricalGearProfileModifications':
        ...
        return constructor.new(_964.CylindricalGearProfileModifications)(value) if value else None

    @profile_modification.setter
    def profile_modification(self, value: '_964.CylindricalGearProfileModifications'):
    ...
    @property
    def type_of_mechanism_housing(self) -> '_1023.TypeOfMechanismHousing':
        ...
        return constructor.new(_1023.TypeOfMechanismHousing)(value) if value else None

    @type_of_mechanism_housing.setter
    def type_of_mechanism_housing(self, value: '_1023.TypeOfMechanismHousing'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def left_flank(self) -> '_958.CylindricalGearMeshFlankDesign':
        ...
        return constructor.new(_958.CylindricalGearMeshFlankDesign)(self.wrapped.LeftFlank) if self.wrapped.LeftFlank else None

    @property
    def right_flank(self) -> '_958.CylindricalGearMeshFlankDesign':
        ...
        return constructor.new(_958.CylindricalGearMeshFlankDesign)(self.wrapped.RightFlank) if self.wrapped.RightFlank else None

    @property
    def backlash_specification(self) -> '_937.BacklashSpecification':
        ...
        return constructor.new(_937.BacklashSpecification)(self.wrapped.BacklashSpecification) if self.wrapped.BacklashSpecification else None

    @property
    def valid_normal_module_range(self) -> '_1346.ShortLengthRange':
        ...
        return constructor.new(_1346.ShortLengthRange)(self.wrapped.ValidNormalModuleRange) if self.wrapped.ValidNormalModuleRange else None
    ...
    @property
    def cylindrical_meshed_gear(self) -> 'List[_973.CylindricalMeshedGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshedGear, constructor.new(_973.CylindricalMeshedGear))
        return value

    @property
    def flanks(self) -> 'List[_958.CylindricalGearMeshFlankDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Flanks, constructor.new(_958.CylindricalGearMeshFlankDesign))
        return value

    @property
    def gear_a(self) -> '_950.CylindricalGearDesign':
    ...
    @property
    def gear_b(self) -> '_950.CylindricalGearDesign':
    ...
    @property
    def both_flanks(self) -> '_958.CylindricalGearMeshFlankDesign':
        ...
        return constructor.new(_958.CylindricalGearMeshFlankDesign)(self.wrapped.BothFlanks) if self.wrapped.BothFlanks else None
