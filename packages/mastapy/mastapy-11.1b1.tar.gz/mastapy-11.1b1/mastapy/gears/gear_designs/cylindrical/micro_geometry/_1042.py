...
from mastapy.gears.gear_designs.cylindrical.micro_geometry import _1060, _1048, _1055
...
class CylindricalGearTriangularEndModificationAtOrientation(_0.APIBase):
    ...
    @property
    def linear(self) -> '_1060.SingleCylindricalGearTriangularEndModification':
        ...
        if _1060.SingleCylindricalGearTriangularEndModification.TYPE not in self.wrapped.Linear.__class__.__mro__:
    ...
    @property
    def linear_of_type_linear_cylindrical_gear_triangular_end_modification(self) -> '_1048.LinearCylindricalGearTriangularEndModification':
        ...
        if _1048.LinearCylindricalGearTriangularEndModification.TYPE not in self.wrapped.Linear.__class__.__mro__:
    ...
    @property
    def linear_of_type_parabolic_cylindrical_gear_triangular_end_modification(self) -> '_1055.ParabolicCylindricalGearTriangularEndModification':
        ...
        if _1055.ParabolicCylindricalGearTriangularEndModification.TYPE not in self.wrapped.Linear.__class__.__mro__:
    ...
    @property
    def parabolic(self) -> '_1060.SingleCylindricalGearTriangularEndModification':
        ...
        if _1060.SingleCylindricalGearTriangularEndModification.TYPE not in self.wrapped.Parabolic.__class__.__mro__:
    ...
    @property
    def parabolic_of_type_linear_cylindrical_gear_triangular_end_modification(self) -> '_1048.LinearCylindricalGearTriangularEndModification':
        ...
        if _1048.LinearCylindricalGearTriangularEndModification.TYPE not in self.wrapped.Parabolic.__class__.__mro__:
    ...
    @property
    def parabolic_of_type_parabolic_cylindrical_gear_triangular_end_modification(self) -> '_1055.ParabolicCylindricalGearTriangularEndModification':
        ...
        if _1055.ParabolicCylindricalGearTriangularEndModification.TYPE not in self.wrapped.Parabolic.__class__.__mro__:
