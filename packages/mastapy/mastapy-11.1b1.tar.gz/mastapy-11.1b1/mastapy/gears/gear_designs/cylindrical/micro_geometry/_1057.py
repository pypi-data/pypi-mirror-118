...
class ProfileReliefWithDeviation(_1059.ReliefWithDeviation):
    '''ProfileReliefWithDeviation
    ...
    @property
    def position_on_profile(self) -> '_962.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_962.CylindricalGearProfileMeasurement)(self.wrapped.PositionOnProfile) if self.wrapped.PositionOnProfile else None
