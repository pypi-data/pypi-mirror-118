...
from mastapy.gears.gear_designs.cylindrical import _960, _945
...
class CylindricalGearPinionTypeCutterFlank(_945.CylindricalGearAbstractRackFlank):
    '''CylindricalGearPinionTypeCutterFlank
    ...
    @property
    def cutter(self) -> '_960.CylindricalGearPinionTypeCutter':
        ...
        return constructor.new(_960.CylindricalGearPinionTypeCutter)(self.wrapped.Cutter) if self.wrapped.Cutter else None
