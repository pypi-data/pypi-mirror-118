...
from mastapy.gears.gear_designs.cylindrical.accuracy_and_tolerances import _1068
...
class ISO1328AccuracyGraderCommon(_1068.CylindricalAccuracyGraderWithProfileFormAndSlope):
    '''ISO1328AccuracyGraderCommon
