...
from mastapy.gears.gear_designs.worm import _895, _896
...
class WormGearSetDesign(_888.GearSetDesign):
    '''WormGearSetDesign
    ...
    @property
    def gears(self) -> 'List[_895.WormGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_895.WormGearDesign))
        return value
    ...
    @property
    def worm_meshes(self) -> 'List[_896.WormGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshes, constructor.new(_896.WormGearMeshDesign))
        return value
