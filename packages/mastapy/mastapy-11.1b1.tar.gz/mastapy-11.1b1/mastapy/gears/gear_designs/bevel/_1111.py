...
from mastapy.gears.gear_designs.bevel import _1119, _1120, _1118
...
class BevelGearSetDesign(_1124.AGMAGleasonConicalGearSetDesign):
    '''BevelGearSetDesign
    ...
    @property
    def backlash_distribution_rule(self) -> '_1080.BacklashDistributionRule':
        ...
        return constructor.new(_1080.BacklashDistributionRule)(value) if value else None

    @backlash_distribution_rule.setter
    def backlash_distribution_rule(self, value: '_1080.BacklashDistributionRule'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.BacklashDistributionRule = value

    @property
    def backlash_used_for_tooth_thickness_calculation(self) -> '_1300.MaxMinMean':
        ...
        return constructor.new(_1300.MaxMinMean)(value) if value else None

    @backlash_used_for_tooth_thickness_calculation.setter
    def backlash_used_for_tooth_thickness_calculation(self, value: '_1300.MaxMinMean'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def round_cutter_specifications(self) -> '_1120.WheelFinishCutterPointWidthRestrictionMethod':
        ...
        return constructor.new(_1120.WheelFinishCutterPointWidthRestrictionMethod)(value) if value else None

    @round_cutter_specifications.setter
    def round_cutter_specifications(self, value: '_1120.WheelFinishCutterPointWidthRestrictionMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def tooth_proportions_input_method(self) -> '_1118.ToothProportionsInputMethod':
        ...
        return constructor.new(_1118.ToothProportionsInputMethod)(value) if value else None

    @tooth_proportions_input_method.setter
    def tooth_proportions_input_method(self, value: '_1118.ToothProportionsInputMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
