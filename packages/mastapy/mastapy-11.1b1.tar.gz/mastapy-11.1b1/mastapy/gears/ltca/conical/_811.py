...
class ConicalMeshLoadDistributionAnalysis(_784.GearMeshLoadDistributionAnalysis):
    '''ConicalMeshLoadDistributionAnalysis
    ...
    @property
    def conical_mesh_manufacturing_analysis(self) -> '_736.ConicalMeshManufacturingAnalysis':
        ...
        return constructor.new(_736.ConicalMeshManufacturingAnalysis)(self.wrapped.ConicalMeshManufacturingAnalysis) if self.wrapped.ConicalMeshManufacturingAnalysis else None

    @property
    def meshed_gears(self) -> 'List[_810.ConicalMeshedGearLoadDistributionAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshedGears, constructor.new(_810.ConicalMeshedGearLoadDistributionAnalysis))
        return value
