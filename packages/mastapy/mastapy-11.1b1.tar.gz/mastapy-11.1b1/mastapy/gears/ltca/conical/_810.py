...
class ConicalMeshedGearLoadDistributionAnalysis(_0.APIBase):
    ...
    @property
    def contact_charts(self) -> '_1140.GearLTCAContactCharts':
        ...
        if _1140.GearLTCAContactCharts.TYPE not in self.wrapped.ContactCharts.__class__.__mro__:
    ...
    @property
    def contact_charts_as_text_file(self) -> '_1139.GearLTCAContactChartDataAsTextFile':
        ...
        if _1139.GearLTCAContactChartDataAsTextFile.TYPE not in self.wrapped.ContactChartsAsTextFile.__class__.__mro__:
