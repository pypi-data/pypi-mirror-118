...
class CylindricalGearMeshLoadedContactLine(_786.GearMeshLoadedContactLine):
    '''CylindricalGearMeshLoadedContactLine
    ...
    @property
    def loaded_contact_strip_end_points(self) -> 'List[_800.CylindricalGearMeshLoadedContactPoint]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadedContactStripEndPoints, constructor.new(_800.CylindricalGearMeshLoadedContactPoint))
        return value
