...
class PocketingPowerLossCoefficients(_1577.NamedDatabaseItem):
    '''PocketingPowerLossCoefficients
    ...
    @property
    def raw_pocketing_power_loss_lookup_table(self) -> '_1347.GriddedSurfaceAccessor':
        '''GriddedSurfaceAccessor: 'RawPocketingPowerLossLookupTable' is the original name of this property.'''

        return constructor.new(_1347.GriddedSurfaceAccessor)(self.wrapped.RawPocketingPowerLossLookupTable) if self.wrapped.RawPocketingPowerLossLookupTable else None

    @raw_pocketing_power_loss_lookup_table.setter
    def raw_pocketing_power_loss_lookup_table(self, value: '_1347.GriddedSurfaceAccessor'):
