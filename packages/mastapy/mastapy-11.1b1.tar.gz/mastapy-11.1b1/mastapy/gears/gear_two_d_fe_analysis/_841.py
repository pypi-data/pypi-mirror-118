...
class CylindricalGearTwoDimensionalFEAnalysis(_0.APIBase):
    ...
    @property
    def findley_critical_plane_analysis(self) -> '_842.FindleyCriticalPlaneAnalysis':
        ...
        return constructor.new(_842.FindleyCriticalPlaneAnalysis)(self.wrapped.FindleyCriticalPlaneAnalysis) if self.wrapped.FindleyCriticalPlaneAnalysis else None
