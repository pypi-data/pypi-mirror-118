...
class CylindricalGearSetParetoOptimiser(_853.GearSetParetoOptimiser):
    '''CylindricalGearSetParetoOptimiser
    ...
    @property
    def selected_candidate_geometry(self) -> '_965.CylindricalGearSetDesign':
    ...
    @property
    def candidate_gear_sets(self) -> 'List[_965.CylindricalGearSetDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CandidateGearSets, constructor.new(_965.CylindricalGearSetDesign))
        return value

    @property
    def all_candidate_gear_sets(self) -> 'List[_965.CylindricalGearSetDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AllCandidateGearSets, constructor.new(_965.CylindricalGearSetDesign))
        return value
