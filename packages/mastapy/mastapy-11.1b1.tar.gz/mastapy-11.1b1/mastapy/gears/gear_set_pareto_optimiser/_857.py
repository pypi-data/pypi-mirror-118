...
from mastapy.gears.gear_set_pareto_optimiser import _847, _858
...
class MicroGeometryDesignSpaceSearch(_847.DesignSpaceSearchBase['_801.CylindricalGearSetLoadDistributionAnalysis', '_858.MicroGeometryDesignSpaceSearchCandidate']):
    '''MicroGeometryDesignSpaceSearch
    ...
    @property
    def load_case_duty_cycle(self) -> '_801.CylindricalGearSetLoadDistributionAnalysis':
        ...
        if _801.CylindricalGearSetLoadDistributionAnalysis.TYPE not in self.wrapped.LoadCaseDutyCycle.__class__.__mro__:
    ...
    @property
    def selected_candidate_micro_geometry(self) -> '_1039.CylindricalGearSetMicroGeometry':
        ...
        return constructor.new(_1039.CylindricalGearSetMicroGeometry)(self.wrapped.SelectedCandidateMicroGeometry) if self.wrapped.SelectedCandidateMicroGeometry else None

    @property
    def candidate_gear_sets(self) -> 'List[_1039.CylindricalGearSetMicroGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CandidateGearSets, constructor.new(_1039.CylindricalGearSetMicroGeometry))
        return value

    @property
    def all_candidate_gear_sets(self) -> 'List[_1039.CylindricalGearSetMicroGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AllCandidateGearSets, constructor.new(_1039.CylindricalGearSetMicroGeometry))
        return value
