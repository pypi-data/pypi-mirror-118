...
class MicroGeometryDesignSpaceSearchChartInformation(_845.ChartInfoBase['_801.CylindricalGearSetLoadDistributionAnalysis', '_858.MicroGeometryDesignSpaceSearchCandidate']):
    '''MicroGeometryDesignSpaceSearchChartInformation
    ...
    @property
    def optimiser(self) -> '_857.MicroGeometryDesignSpaceSearch':
