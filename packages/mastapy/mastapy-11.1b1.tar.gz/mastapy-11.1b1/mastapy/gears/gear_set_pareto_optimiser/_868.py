...
from mastapy.gears.gear_set_pareto_optimiser import _870
...
class ParetoFaceGearSetDutyCycleOptimisationStrategyDatabase(_870.ParetoFaceRatingOptimisationStrategyDatabase):
    '''ParetoFaceGearSetDutyCycleOptimisationStrategyDatabase
