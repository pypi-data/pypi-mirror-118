...
from mastapy.math_utility.optimisation import _1321
...
class OptimisationTarget(_0.APIBase, Generic[T]):
    ...
    @property
    def input_setters(self) -> 'List[_1321.InputSetter[T]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.InputSetters, constructor.new(_1321.InputSetter)[T])
        return value
