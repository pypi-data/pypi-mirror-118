...
from mastapy.gears.rating.conical import _493, _494
...
class GearSetOptimisationResult(_0.APIBase):
    ...
    @property
    def gear_set(self) -> '_888.GearSetDesign':
        ...
        if _888.GearSetDesign.TYPE not in self.wrapped.GearSet.__class__.__mro__:
    ...
    @property
    def gear_set_of_type_zerol_bevel_gear_set_design(self) -> '_892.ZerolBevelGearSetDesign':
        ...
        if _892.ZerolBevelGearSetDesign.TYPE not in self.wrapped.GearSet.__class__.__mro__:
    ...
    @property
    def gear_set_of_type_worm_gear_set_design(self) -> '_897.WormGearSetDesign':
        ...
        if _897.WormGearSetDesign.TYPE not in self.wrapped.GearSet.__class__.__mro__:
    ...
    @property
    def gear_set_of_type_straight_bevel_diff_gear_set_design(self) -> '_901.StraightBevelDiffGearSetDesign':
        ...
        if _901.StraightBevelDiffGearSetDesign.TYPE not in self.wrapped.GearSet.__class__.__mro__:
    ...
    @property
    def gear_set_of_type_straight_bevel_gear_set_design(self) -> '_905.StraightBevelGearSetDesign':
        ...
        if _905.StraightBevelGearSetDesign.TYPE not in self.wrapped.GearSet.__class__.__mro__:
    ...
    @property
    def gear_set_of_type_spiral_bevel_gear_set_design(self) -> '_909.SpiralBevelGearSetDesign':
        ...
        if _909.SpiralBevelGearSetDesign.TYPE not in self.wrapped.GearSet.__class__.__mro__:
    ...
    @property
    def gear_set_of_type_klingelnberg_cyclo_palloid_spiral_bevel_gear_set_design(self) -> '_913.KlingelnbergCycloPalloidSpiralBevelGearSetDesign':
        ...
        if _913.KlingelnbergCycloPalloidSpiralBevelGearSetDesign.TYPE not in self.wrapped.GearSet.__class__.__mro__:
    ...
    @property
    def gear_set_of_type_klingelnberg_cyclo_palloid_hypoid_gear_set_design(self) -> '_917.KlingelnbergCycloPalloidHypoidGearSetDesign':
        ...
        if _917.KlingelnbergCycloPalloidHypoidGearSetDesign.TYPE not in self.wrapped.GearSet.__class__.__mro__:
    ...
    @property
    def gear_set_of_type_klingelnberg_conical_gear_set_design(self) -> '_921.KlingelnbergConicalGearSetDesign':
        ...
        if _921.KlingelnbergConicalGearSetDesign.TYPE not in self.wrapped.GearSet.__class__.__mro__:
    ...
    @property
    def gear_set_of_type_hypoid_gear_set_design(self) -> '_925.HypoidGearSetDesign':
        ...
        if _925.HypoidGearSetDesign.TYPE not in self.wrapped.GearSet.__class__.__mro__:
    ...
    @property
    def gear_set_of_type_face_gear_set_design(self) -> '_933.FaceGearSetDesign':
        ...
        if _933.FaceGearSetDesign.TYPE not in self.wrapped.GearSet.__class__.__mro__:
    ...
    @property
    def gear_set_of_type_cylindrical_gear_set_design(self) -> '_965.CylindricalGearSetDesign':
        ...
        if _965.CylindricalGearSetDesign.TYPE not in self.wrapped.GearSet.__class__.__mro__:
    ...
    @property
    def gear_set_of_type_cylindrical_planetary_gear_set_design(self) -> '_976.CylindricalPlanetaryGearSetDesign':
        ...
        if _976.CylindricalPlanetaryGearSetDesign.TYPE not in self.wrapped.GearSet.__class__.__mro__:
    ...
    @property
    def gear_set_of_type_conical_gear_set_design(self) -> '_1085.ConicalGearSetDesign':
        ...
        if _1085.ConicalGearSetDesign.TYPE not in self.wrapped.GearSet.__class__.__mro__:
    ...
    @property
    def gear_set_of_type_concept_gear_set_design(self) -> '_1107.ConceptGearSetDesign':
        ...
        if _1107.ConceptGearSetDesign.TYPE not in self.wrapped.GearSet.__class__.__mro__:
    ...
    @property
    def gear_set_of_type_bevel_gear_set_design(self) -> '_1111.BevelGearSetDesign':
        ...
        if _1111.BevelGearSetDesign.TYPE not in self.wrapped.GearSet.__class__.__mro__:
    ...
    @property
    def gear_set_of_type_agma_gleason_conical_gear_set_design(self) -> '_1124.AGMAGleasonConicalGearSetDesign':
        ...
        if _1124.AGMAGleasonConicalGearSetDesign.TYPE not in self.wrapped.GearSet.__class__.__mro__:
    ...
    @property
    def rating_of_type_conical_gear_set_duty_cycle_rating(self) -> '_493.ConicalGearSetDutyCycleRating':
        ...
        if _493.ConicalGearSetDutyCycleRating.TYPE not in self.wrapped.Rating.__class__.__mro__:
    ...
    @property
    def rating_of_type_conical_gear_set_rating(self) -> '_494.ConicalGearSetRating':
        ...
        if _494.ConicalGearSetRating.TYPE not in self.wrapped.Rating.__class__.__mro__:
    ...
    @property
    def rating_of_type_concept_gear_set_duty_cycle_rating(self) -> '_504.ConceptGearSetDutyCycleRating':
        ...
        if _504.ConceptGearSetDutyCycleRating.TYPE not in self.wrapped.Rating.__class__.__mro__:
    ...
    @property
    def rating_of_type_concept_gear_set_rating(self) -> '_505.ConceptGearSetRating':
        ...
        if _505.ConceptGearSetRating.TYPE not in self.wrapped.Rating.__class__.__mro__:
    ...
    @property
    def rating_of_type_bevel_gear_set_rating(self) -> '_508.BevelGearSetRating':
        ...
        if _508.BevelGearSetRating.TYPE not in self.wrapped.Rating.__class__.__mro__:
    ...
    @property
    def rating_of_type_agma_gleason_conical_gear_set_rating(self) -> '_519.AGMAGleasonConicalGearSetRating':
        ...
        if _519.AGMAGleasonConicalGearSetRating.TYPE not in self.wrapped.Rating.__class__.__mro__:
    ...
    @property
    def optimisation_history(self) -> '_1324.OptimisationHistory':
        '''OptimisationHistory: 'OptimisationHistory' is the original name of this property.'''

        return constructor.new(_1324.OptimisationHistory)(self.wrapped.OptimisationHistory) if self.wrapped.OptimisationHistory else None

    @optimisation_history.setter
    def optimisation_history(self, value: '_1324.OptimisationHistory'):
