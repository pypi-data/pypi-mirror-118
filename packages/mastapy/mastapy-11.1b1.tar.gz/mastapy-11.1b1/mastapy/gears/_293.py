...
from mastapy.gears.gear_designs.cylindrical import _1018, _954
...
class GearSetDesignGroup(_0.APIBase):
    ...
    @property
    def default_rough_toleranced_metal_measurement(self) -> '_1018.TolerancedMetalMeasurements':
    ...
    def default_rough_toleranced_metal_measurement(self, value: '_1018.TolerancedMetalMeasurements'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
