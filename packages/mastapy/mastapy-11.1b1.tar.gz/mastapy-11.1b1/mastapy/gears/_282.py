...
class BevelHypoidGearRatingSettings(_1369.PerMachineSettings):
    '''BevelHypoidGearRatingSettings
    ...
    @property
    def bevel_gear_rating_method(self) -> '_557.RatingMethods':
        ...
        return constructor.new(_557.RatingMethods)(value) if value else None

    @bevel_gear_rating_method.setter
    def bevel_gear_rating_method(self, value: '_557.RatingMethods'):
