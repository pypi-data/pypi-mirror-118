...
class KlingelnbergCycloPalloidSpiralBevelGearRating(_377.KlingelnbergCycloPalloidConicalGearRating):
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear(self) -> '_911.KlingelnbergCycloPalloidSpiralBevelGearDesign':
        ...
        return constructor.new(_911.KlingelnbergCycloPalloidSpiralBevelGearDesign)(self.wrapped.KlingelnbergCycloPalloidSpiralBevelGear) if self.wrapped.KlingelnbergCycloPalloidSpiralBevelGear else None
