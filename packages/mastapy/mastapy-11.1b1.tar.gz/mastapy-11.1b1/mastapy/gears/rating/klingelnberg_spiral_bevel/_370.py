...
class KlingelnbergCycloPalloidSpiralBevelGearMeshRating(_376.KlingelnbergCycloPalloidConicalGearMeshRating):
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_mesh(self) -> '_912.KlingelnbergCycloPalloidSpiralBevelGearMeshDesign':
        ...
        return constructor.new(_912.KlingelnbergCycloPalloidSpiralBevelGearMeshDesign)(self.wrapped.KlingelnbergCycloPalloidSpiralBevelGearMesh) if self.wrapped.KlingelnbergCycloPalloidSpiralBevelGearMesh else None
