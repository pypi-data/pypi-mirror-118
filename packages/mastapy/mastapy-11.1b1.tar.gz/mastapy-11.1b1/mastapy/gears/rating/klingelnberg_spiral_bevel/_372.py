...
class KlingelnbergCycloPalloidSpiralBevelGearSetRating(_378.KlingelnbergCycloPalloidConicalGearSetRating):
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_set(self) -> '_913.KlingelnbergCycloPalloidSpiralBevelGearSetDesign':
        ...
        return constructor.new(_913.KlingelnbergCycloPalloidSpiralBevelGearSetDesign)(self.wrapped.KlingelnbergCycloPalloidSpiralBevelGearSet) if self.wrapped.KlingelnbergCycloPalloidSpiralBevelGearSet else None
