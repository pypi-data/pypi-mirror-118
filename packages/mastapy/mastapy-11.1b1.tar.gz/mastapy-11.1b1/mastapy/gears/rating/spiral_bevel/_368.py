...
class SpiralBevelGearRating(_507.BevelGearRating):
    '''SpiralBevelGearRating
    ...
    @property
    def spiral_bevel_gear(self) -> '_907.SpiralBevelGearDesign':
        ...
        return constructor.new(_907.SpiralBevelGearDesign)(self.wrapped.SpiralBevelGear) if self.wrapped.SpiralBevelGear else None
