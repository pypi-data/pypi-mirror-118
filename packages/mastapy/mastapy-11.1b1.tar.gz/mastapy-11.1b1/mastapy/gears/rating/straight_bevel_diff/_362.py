...
class StraightBevelDiffGearSetRating(_494.ConicalGearSetRating):
    ...
    @property
    def straight_bevel_diff_gear_set(self) -> '_901.StraightBevelDiffGearSetDesign':
        ...
        return constructor.new(_901.StraightBevelDiffGearSetDesign)(self.wrapped.StraightBevelDiffGearSet) if self.wrapped.StraightBevelDiffGearSet else None
