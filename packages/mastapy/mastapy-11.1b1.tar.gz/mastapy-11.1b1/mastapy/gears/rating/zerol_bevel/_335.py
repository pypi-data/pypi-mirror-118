...
class ZerolBevelGearRating(_507.BevelGearRating):
    '''ZerolBevelGearRating
    ...
    @property
    def zerol_bevel_gear(self) -> '_890.ZerolBevelGearDesign':
        ...
        return constructor.new(_890.ZerolBevelGearDesign)(self.wrapped.ZerolBevelGear) if self.wrapped.ZerolBevelGear else None
