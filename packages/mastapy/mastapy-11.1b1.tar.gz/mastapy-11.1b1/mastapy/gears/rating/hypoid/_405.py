...
class HypoidGearSetRating(_519.AGMAGleasonConicalGearSetRating):
    '''HypoidGearSetRating
    ...
    @property
    def hypoid_gear_set(self) -> '_925.HypoidGearSetDesign':
        ...
        return constructor.new(_925.HypoidGearSetDesign)(self.wrapped.HypoidGearSet) if self.wrapped.HypoidGearSet else None
