...
class ToothFlankFractureAnalysisContactPoint(_0.APIBase):
    ...
    @property
    def analysis_point_with_maximum_local_material_exposure(self) -> '_484.ToothFlankFractureAnalysisPoint':
        ...
        return constructor.new(_484.ToothFlankFractureAnalysisPoint)(self.wrapped.AnalysisPointWithMaximumLocalMaterialExposure) if self.wrapped.AnalysisPointWithMaximumLocalMaterialExposure else None

    @property
    def watch_points(self) -> 'List[_484.ToothFlankFractureAnalysisPoint]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WatchPoints, constructor.new(_484.ToothFlankFractureAnalysisPoint))
        return value
