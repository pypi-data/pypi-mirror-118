...
from mastapy.gears.rating.cylindrical.din3990 import _485
...
class VDI2737InternalGearSingleFlankRating(_0.APIBase):
    ...
    @property
    def iso_gear_rating_of_type_din3990_gear_single_flank_rating(self) -> '_485.DIN3990GearSingleFlankRating':
        ...
        if _485.DIN3990GearSingleFlankRating.TYPE not in self.wrapped.ISOGearRating.__class__.__mro__:
