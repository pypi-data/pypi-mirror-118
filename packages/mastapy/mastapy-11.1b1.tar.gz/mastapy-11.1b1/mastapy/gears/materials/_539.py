...
from mastapy.gears.materials import _560, _546
...
class BevelGearMaterial(_546.GearMaterial):
    '''BevelGearMaterial
    ...
    @property
    def sn_curve_definition(self) -> '_560.SNCurveDefinition':
        ...
        return constructor.new(_560.SNCurveDefinition)(value) if value else None

    @sn_curve_definition.setter
    def sn_curve_definition(self, value: '_560.SNCurveDefinition'):
