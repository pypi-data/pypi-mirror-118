...
from mastapy.gears.materials import _547, _553
...
class KlingelnbergConicalGearMaterialDatabase(_547.GearMaterialDatabase['_553.KlingelnbergCycloPalloidConicalGearMaterial']):
    '''KlingelnbergConicalGearMaterialDatabase
