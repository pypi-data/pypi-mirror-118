...
from mastapy.math_utility.measured_data import _1348
...
class OnedimensionalFunctionLookupTable(_1348.LookupTableBase['OnedimensionalFunctionLookupTable']):
    '''OnedimensionalFunctionLookupTable
    ...
    @property
    def lookup_table(self) -> '_1315.Vector2DListAccessor':
        '''Vector2DListAccessor: 'LookupTable' is the original name of this property.'''

        return constructor.new(_1315.Vector2DListAccessor)(self.wrapped.LookupTable) if self.wrapped.LookupTable else None

    @lookup_table.setter
    def lookup_table(self, value: '_1315.Vector2DListAccessor'):
