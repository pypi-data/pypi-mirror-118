...
from mastapy.math_utility.measured_data import _1347, _1348
...
class TwodimensionalFunctionLookupTable(_1348.LookupTableBase['TwodimensionalFunctionLookupTable']):
    '''TwodimensionalFunctionLookupTable
    ...
    @property
    def lookup_table(self) -> '_1347.GriddedSurfaceAccessor':
        '''GriddedSurfaceAccessor: 'LookupTable' is the original name of this property.'''

        return constructor.new(_1347.GriddedSurfaceAccessor)(self.wrapped.LookupTable) if self.wrapped.LookupTable else None

    @lookup_table.setter
    def lookup_table(self, value: '_1347.GriddedSurfaceAccessor'):
