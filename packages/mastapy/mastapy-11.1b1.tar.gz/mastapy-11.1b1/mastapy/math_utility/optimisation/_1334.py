...
from mastapy.math_utility.optimisation import _1339, _1338
...
class ParetoOptimisationVariableBase(_0.APIBase):
    ...
    @property
    def specification_type(self) -> '_1339.TargetingPropertyTo':
        ...
        return constructor.new(_1339.TargetingPropertyTo)(value) if value else None

    @specification_type.setter
    def specification_type(self, value: '_1339.TargetingPropertyTo'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.SpecificationType = value

    @property
    def specify_input_range_as(self) -> '_1338.SpecifyOptimisationInputAs':
        ...
        return constructor.new(_1338.SpecifyOptimisationInputAs)(value) if value else None

    @specify_input_range_as.setter
    def specify_input_range_as(self, value: '_1338.SpecifyOptimisationInputAs'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
