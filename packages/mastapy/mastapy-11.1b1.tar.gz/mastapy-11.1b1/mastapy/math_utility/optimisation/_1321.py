...
from mastapy.math_utility.optimisation import _1328
...
class InputSetter(_0.APIBase, Generic[T]):
    ...
    @property
    def optimiser_input(self) -> '_1328.ParetoOptimisationInput':
        ...
        return constructor.new(_1328.ParetoOptimisationInput)(self.wrapped.OptimiserInput) if self.wrapped.OptimiserInput else None
