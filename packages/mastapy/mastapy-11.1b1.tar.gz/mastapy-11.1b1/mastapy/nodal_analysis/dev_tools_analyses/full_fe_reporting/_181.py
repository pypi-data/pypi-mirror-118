...
from mastapy.fe_tools.enums import _1167
...
class ElementPropertiesBase(_0.APIBase):
    ...
    @property
    def class_(self) -> '_1167.ElementPropertyClass':
        ...
        return constructor.new(_1167.ElementPropertyClass)(value) if value else None
