...
from mastapy.fe_tools.vis_tools_global.vis_tools_global_enums import _1163
...
class ElementPropertiesShell(_189.ElementPropertiesWithMaterial):
    ...
    @property
    def wall_type(self) -> '_1163.ElementPropertiesShellWallType':
        ...
        return constructor.new(_1163.ElementPropertiesShellWallType)(value) if value else None
