...
from mastapy.fe_tools.vis_tools_global.vis_tools_global_enums import _1162, _1161
...
class ContactPairReporting(_0.APIBase):
    ...
    @property
    def reference_surface_type(self) -> '_1162.ContactPairReferenceSurfaceType':
        ...
        return constructor.new(_1162.ContactPairReferenceSurfaceType)(value) if value else None

    @property
    def constrained_surface_type(self) -> '_1161.ContactPairConstrainedSurfaceType':
        ...
        return constructor.new(_1161.ContactPairConstrainedSurfaceType)(value) if value else None
