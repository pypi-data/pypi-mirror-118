...
from mastapy.math_utility.stiffness_calculators import _1318
...
class SurfaceToSurfaceContactStiffnessEntity(_120.ArbitraryNodalComponent):
    ...
    @property
    def contact(self) -> '_1318.SurfaceToSurfaceContact':
        ...
        return constructor.new(_1318.SurfaceToSurfaceContact)(self.wrapped.Contact) if self.wrapped.Contact else None
