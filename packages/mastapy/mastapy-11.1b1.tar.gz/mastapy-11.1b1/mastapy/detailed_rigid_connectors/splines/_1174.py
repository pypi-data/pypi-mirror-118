...
from mastapy.detailed_rigid_connectors.splines import _1184, _1193, _1201
...
class DIN5480SplineHalfDesign(_1201.StandardSplineHalfDesign):
    '''DIN5480SplineHalfDesign
    ...
    @property
    def manufacturing_type(self) -> '_1184.ManufacturingTypes':
        ...
        return constructor.new(_1184.ManufacturingTypes)(value) if value else None

    @manufacturing_type.setter
    def manufacturing_type(self, value: '_1184.ManufacturingTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ManufacturingType = value

    @property
    def finishing_method(self) -> '_1193.FinishingMethods':
        ...
        return constructor.new(_1193.FinishingMethods)(value) if value else None

    @finishing_method.setter
    def finishing_method(self, value: '_1193.FinishingMethods'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
