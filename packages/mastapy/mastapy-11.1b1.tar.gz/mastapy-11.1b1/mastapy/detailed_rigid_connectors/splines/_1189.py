...
from mastapy.detailed_rigid_connectors.splines.tolerances_and_deviations import _1204
from mastapy.detailed_rigid_connectors.splines import _1201
...
class SAESplineHalfDesign(_1201.StandardSplineHalfDesign):
    '''SAESplineHalfDesign
    ...
    @property
    def sae_accuracy_and_tolerance(self) -> '_1204.SAESplineTolerances':
        ...
        return constructor.new(_1204.SAESplineTolerances)(self.wrapped.SAEAccuracyAndTolerance) if self.wrapped.SAEAccuracyAndTolerance else None
