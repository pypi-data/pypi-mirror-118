...
from mastapy.detailed_rigid_connectors.splines.ratings import _1213
...
class SplineJointRating(_1218.ShaftHubConnectionRating):
    '''SplineJointRating
    ...
    @property
    def spline_half_ratings(self) -> 'List[_1213.SplineHalfRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SplineHalfRatings, constructor.new(_1213.SplineHalfRating))
        return value
