...
from mastapy.bearings.tolerances import _1648, _1634, _1640
...
class InterferenceFitHalfDesign(_1170.DetailedRigidConnectorHalfDesign):
    '''InterferenceFitHalfDesign
    ...
    @property
    def stress_region(self) -> '_1229.StressRegions':
        ...
        return constructor.new(_1229.StressRegions)(value) if value else None
    ...
    @property
    def tolerance(self) -> '_1648.SupportTolerance':
        ...
        if _1648.SupportTolerance.TYPE not in self.wrapped.Tolerance.__class__.__mro__:
    ...
    @property
    def tolerance_of_type_inner_support_tolerance(self) -> '_1634.InnerSupportTolerance':
        ...
        if _1634.InnerSupportTolerance.TYPE not in self.wrapped.Tolerance.__class__.__mro__:
    ...
    @property
    def tolerance_of_type_outer_support_tolerance(self) -> '_1640.OuterSupportTolerance':
        ...
        if _1640.OuterSupportTolerance.TYPE not in self.wrapped.Tolerance.__class__.__mro__:
