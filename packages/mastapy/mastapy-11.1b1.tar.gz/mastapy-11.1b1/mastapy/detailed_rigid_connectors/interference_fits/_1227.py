...
from mastapy.detailed_rigid_connectors.interference_fits import _1226, _1225, _1230
...
class InterferenceFitDesign(_1169.DetailedRigidConnectorDesign):
    '''InterferenceFitDesign
    ...
    @property
    def calculation_method(self) -> '_1226.CalculationMethods':
        ...
        return constructor.new(_1226.CalculationMethods)(value) if value else None

    @calculation_method.setter
    def calculation_method(self, value: '_1226.CalculationMethods'):
    ...
    @property
    def assembly_method(self) -> '_1225.AssemblyMethods':
        ...
        return constructor.new(_1225.AssemblyMethods)(value) if value else None

    @assembly_method.setter
    def assembly_method(self, value: '_1225.AssemblyMethods'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
