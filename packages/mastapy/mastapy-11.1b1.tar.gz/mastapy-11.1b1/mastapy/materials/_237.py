...
class LubricationDetail(_1577.NamedDatabaseItem):
    '''LubricationDetail
    ...
    @property
    def density_vs_temperature(self) -> '_1315.Vector2DListAccessor':
        '''Vector2DListAccessor: 'DensityVsTemperature' is the original name of this property.'''

        return constructor.new(_1315.Vector2DListAccessor)(self.wrapped.DensityVsTemperature) if self.wrapped.DensityVsTemperature else None

    @density_vs_temperature.setter
    def density_vs_temperature(self, value: '_1315.Vector2DListAccessor'):
