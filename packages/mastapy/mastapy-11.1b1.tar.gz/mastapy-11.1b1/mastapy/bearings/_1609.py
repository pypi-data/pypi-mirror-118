...
from mastapy.bearings import (
    _1619, _1618, _1611, _1612
)
from mastapy._internal.overridable_constructor import _unpack_overridable
from mastapy._internal import enum_with_selected_value_runtime, conversion, constructor
from mastapy.bearings.bearing_results.rolling.skf_module import _1816
...
class BearingSettings(_1369.PerMachineSettings):
    '''BearingSettings
    ...
    @property
    def failure_probability_for_rating_life_percent(self) -> '_1618.RatingLife':
        ...
        return constructor.new(_1618.RatingLife)(value) if value else None

    @failure_probability_for_rating_life_percent.setter
    def failure_probability_for_rating_life_percent(self, value: '_1618.RatingLife'):
    ...
    @property
    def include_exponent_and_reduction_factors_in_isots162812008(self) -> '_1611.ExponentAndReductionFactorsInISO16281Calculation':
        ...
        return constructor.new(_1611.ExponentAndReductionFactorsInISO16281Calculation)(value) if value else None

    @include_exponent_and_reduction_factors_in_isots162812008.setter
    def include_exponent_and_reduction_factors_in_isots162812008(self, value: '_1611.ExponentAndReductionFactorsInISO16281Calculation'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def skf_credentials(self) -> '_1816.SKFCredentials':
        ...
        return constructor.new(_1816.SKFCredentials)(self.wrapped.SKFCredentials) if self.wrapped.SKFCredentials else None
