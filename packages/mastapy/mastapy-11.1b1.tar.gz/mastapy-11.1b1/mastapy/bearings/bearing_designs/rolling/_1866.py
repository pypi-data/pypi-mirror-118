...
class CylindricalRollerBearing(_1876.NonBarrelRollerBearing):
    '''CylindricalRollerBearing
    ...
    @property
    def permissible_axial_load_default_calculation_method(self) -> '_1668.CylindricalRollerMaxAxialLoadMethod':
        ...
        return constructor.new(_1668.CylindricalRollerMaxAxialLoadMethod)(value) if value else None

    @permissible_axial_load_default_calculation_method.setter
    def permissible_axial_load_default_calculation_method(self, value: '_1668.CylindricalRollerMaxAxialLoadMethod'):
