...
from mastapy.bearings.bearing_designs.rolling import _1878, _1879, _1877
...
class NonBarrelRollerBearing(_1877.RollerBearing):
    '''NonBarrelRollerBearing
    ...
    @property
    def roller_end_shape(self) -> '_1878.RollerEndShape':
        ...
        return constructor.new(_1878.RollerEndShape)(value) if value else None

    @roller_end_shape.setter
    def roller_end_shape(self, value: '_1878.RollerEndShape'):
    ...
    @property
    def ribs(self) -> 'List[_1879.RollerRibDetail]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Ribs, constructor.new(_1879.RollerRibDetail))
        return value
