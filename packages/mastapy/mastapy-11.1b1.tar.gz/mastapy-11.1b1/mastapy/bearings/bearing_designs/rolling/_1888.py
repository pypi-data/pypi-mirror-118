...
from mastapy.bearings import _1617
...
class ThrustBallBearing(_1858.BallBearing):
    '''ThrustBallBearing
    ...
    @property
    def outer_ring_mounting(self) -> '_1617.OuterRingMounting':
        ...
        return constructor.new(_1617.OuterRingMounting)(value) if value else None

    @outer_ring_mounting.setter
    def outer_ring_mounting(self, value: '_1617.OuterRingMounting'):
