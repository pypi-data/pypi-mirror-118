...
class BearingProtectionDetailsModifier(_0.APIBase):
    ...
    @property
    def current_protection_level(self) -> '_1863.BearingProtectionLevel':
        ...
        return constructor.new(_1863.BearingProtectionLevel)(value) if value else None

    @property
    def new_protection_level(self) -> '_1863.BearingProtectionLevel':
    ...
    def new_protection_level(self, value: '_1863.BearingProtectionLevel'):
