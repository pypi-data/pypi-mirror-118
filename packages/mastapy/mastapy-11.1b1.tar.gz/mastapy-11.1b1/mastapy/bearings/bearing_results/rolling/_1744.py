...
class LoadedNonBarrelRollerBearingRow(_1749.LoadedRollerBearingRow):
    '''LoadedNonBarrelRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1743.LoadedNonBarrelRollerBearingResults':
