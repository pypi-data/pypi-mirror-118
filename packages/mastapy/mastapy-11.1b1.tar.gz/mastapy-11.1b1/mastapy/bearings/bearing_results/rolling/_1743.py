...
from mastapy.bearings.bearing_results.rolling import _1792, _1748
...
class LoadedNonBarrelRollerBearingResults(_1748.LoadedRollerBearingResults):
    '''LoadedNonBarrelRollerBearingResults
    ...
    @property
    def smt_rib_stress(self) -> '_1792.SMTRibStressResults':
        ...
        return constructor.new(_1792.SMTRibStressResults)(self.wrapped.SMTRibStress) if self.wrapped.SMTRibStress else None
