...
from mastapy.bearings.bearing_results.rolling import _1743
...
class LoadedAxialThrustCylindricalRollerBearingResults(_1743.LoadedNonBarrelRollerBearingResults):
    '''LoadedAxialThrustCylindricalRollerBearingResults
