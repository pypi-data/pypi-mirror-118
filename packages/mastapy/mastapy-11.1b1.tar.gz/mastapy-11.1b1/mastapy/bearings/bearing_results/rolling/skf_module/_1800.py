...
from mastapy.bearings.bearing_results.rolling.skf_module import _1813, _1815
...
class DynamicAxialLoadCarryingCapacity(_1815.SKFCalculationResult):
    '''DynamicAxialLoadCarryingCapacity
    ...
    @property
    def permissible_axial_load(self) -> '_1813.PermissibleAxialLoad':
        ...
        return constructor.new(_1813.PermissibleAxialLoad)(self.wrapped.PermissibleAxialLoad) if self.wrapped.PermissibleAxialLoad else None
