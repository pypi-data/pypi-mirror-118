...
from mastapy.bearings.bearing_results.rolling import _1784, _1743
...
class LoadedCylindricalRollerBearingResults(_1743.LoadedNonBarrelRollerBearingResults):
    '''LoadedCylindricalRollerBearingResults
    ...
    @property
    def permissible_continuous_axial_load(self) -> '_1784.PermissibleContinuousAxialLoadResults':
        ...
        return constructor.new(_1784.PermissibleContinuousAxialLoadResults)(self.wrapped.PermissibleContinuousAxialLoad) if self.wrapped.PermissibleContinuousAxialLoad else None
