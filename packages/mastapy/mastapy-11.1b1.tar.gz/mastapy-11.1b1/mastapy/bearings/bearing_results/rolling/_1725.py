...
from mastapy.bearings.bearing_results.rolling import _1724, _1749
...
class LoadedCrossedRollerBearingRow(_1749.LoadedRollerBearingRow):
    '''LoadedCrossedRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1724.LoadedCrossedRollerBearingResults':
        ...
        return constructor.new(_1724.LoadedCrossedRollerBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
