...
from mastapy.bearings.bearing_results.rolling import _1768, _1744
...
class LoadedTaperRollerBearingRow(_1744.LoadedNonBarrelRollerBearingRow):
    '''LoadedTaperRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1768.LoadedTaperRollerBearingResults':
        ...
        return constructor.new(_1768.LoadedTaperRollerBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
