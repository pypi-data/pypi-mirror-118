...
from mastapy.bearings import _1612
from mastapy.bearings.bearing_results.rolling.fitting import _1831, _1829, _1832
from mastapy.bearings.bearing_results.rolling import (
    _1696, _1794, _1693, _1780,
    _1753
)
from mastapy._internal.cast_exception import CastException
from mastapy.bearings.bearing_results.rolling.abma import _1835, _1833, _1834
from mastapy.bearings.bearing_results.rolling.iso_rating_results import (
    _1822, _1820, _1826, _1825,
    _1821, _1827, _1823
)
from mastapy.bearings.bearing_results.rolling.skf_module import _1817
from mastapy.bearings.bearing_results import _1679
...
class LoadedRollingBearingResults(_1679.LoadedDetailedBearingResults):
    '''LoadedRollingBearingResults
    ...
    @property
    def fluid_film_temperature_source(self) -> '_1612.FluidFilmTemperatureOptions':
        ...
        return constructor.new(_1612.FluidFilmTemperatureOptions)(value) if value else None
    ...
    @property
    def outer_ring_fitting_at_assembly(self) -> '_1831.OuterRingFittingThermalResults':
        ...
        return constructor.new(_1831.OuterRingFittingThermalResults)(self.wrapped.OuterRingFittingAtAssembly) if self.wrapped.OuterRingFittingAtAssembly else None

    @property
    def outer_ring_fitting_at_operating_conditions(self) -> '_1831.OuterRingFittingThermalResults':
        ...
        return constructor.new(_1831.OuterRingFittingThermalResults)(self.wrapped.OuterRingFittingAtOperatingConditions) if self.wrapped.OuterRingFittingAtOperatingConditions else None

    @property
    def inner_ring_fitting_at_assembly(self) -> '_1829.InnerRingFittingThermalResults':
        ...
        return constructor.new(_1829.InnerRingFittingThermalResults)(self.wrapped.InnerRingFittingAtAssembly) if self.wrapped.InnerRingFittingAtAssembly else None

    @property
    def inner_ring_fitting_at_operating_conditions(self) -> '_1829.InnerRingFittingThermalResults':
        ...
        return constructor.new(_1829.InnerRingFittingThermalResults)(self.wrapped.InnerRingFittingAtOperatingConditions) if self.wrapped.InnerRingFittingAtOperatingConditions else None
    ...
    @property
    def din732(self) -> '_1693.DIN732Results':
        ...
        return constructor.new(_1693.DIN732Results)(self.wrapped.DIN732) if self.wrapped.DIN732 else None

    @property
    def ansiabma(self) -> '_1835.ANSIABMAResults':
        ...
        if _1835.ANSIABMAResults.TYPE not in self.wrapped.ANSIABMA.__class__.__mro__:
    ...
    @property
    def ansiabma_of_type_ansiabma112014_results(self) -> '_1833.ANSIABMA112014Results':
        ...
        if _1833.ANSIABMA112014Results.TYPE not in self.wrapped.ANSIABMA.__class__.__mro__:
    ...
    @property
    def ansiabma_of_type_ansiabma92015_results(self) -> '_1834.ANSIABMA92015Results':
        ...
        if _1834.ANSIABMA92015Results.TYPE not in self.wrapped.ANSIABMA.__class__.__mro__:
    ...
    @property
    def iso2812007(self) -> '_1822.ISO2812007Results':
        ...
        if _1822.ISO2812007Results.TYPE not in self.wrapped.ISO2812007.__class__.__mro__:
    ...
    @property
    def iso2812007_of_type_ball_iso2812007_results(self) -> '_1820.BallISO2812007Results':
        ...
        if _1820.BallISO2812007Results.TYPE not in self.wrapped.ISO2812007.__class__.__mro__:
    ...
    @property
    def iso2812007_of_type_roller_iso2812007_results(self) -> '_1826.RollerISO2812007Results':
        ...
        if _1826.RollerISO2812007Results.TYPE not in self.wrapped.ISO2812007.__class__.__mro__:
    ...
    @property
    def isots162812008(self) -> '_1825.ISOTS162812008Results':
        ...
        if _1825.ISOTS162812008Results.TYPE not in self.wrapped.ISOTS162812008.__class__.__mro__:
    ...
    @property
    def isots162812008_of_type_ball_isots162812008_results(self) -> '_1821.BallISOTS162812008Results':
        ...
        if _1821.BallISOTS162812008Results.TYPE not in self.wrapped.ISOTS162812008.__class__.__mro__:
    ...
    @property
    def isots162812008_of_type_roller_isots162812008_results(self) -> '_1827.RollerISOTS162812008Results':
        ...
        if _1827.RollerISOTS162812008Results.TYPE not in self.wrapped.ISOTS162812008.__class__.__mro__:
    ...
    @property
    def iso762006(self) -> '_1823.ISO762006Results':
        ...
        return constructor.new(_1823.ISO762006Results)(self.wrapped.ISO762006) if self.wrapped.ISO762006 else None

    @property
    def maximum_static_contact_stress(self) -> '_1780.MaximumStaticContactStress':
        ...
        return constructor.new(_1780.MaximumStaticContactStress)(self.wrapped.MaximumStaticContactStress) if self.wrapped.MaximumStaticContactStress else None

    @property
    def skf_module_results(self) -> '_1817.SKFModuleResults':
        ...
        return constructor.new(_1817.SKFModuleResults)(self.wrapped.SKFModuleResults) if self.wrapped.SKFModuleResults else None

    @property
    def rows(self) -> 'List[_1753.LoadedRollingBearingRow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Rows, constructor.new(_1753.LoadedRollingBearingRow))
        return value

    @property
    def all_mounting_results(self) -> 'List[_1832.RingFittingThermalResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AllMountingResults, constructor.new(_1832.RingFittingThermalResults))
        return value
