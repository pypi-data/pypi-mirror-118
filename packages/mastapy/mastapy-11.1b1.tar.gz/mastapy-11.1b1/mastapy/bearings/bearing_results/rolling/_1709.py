...
from mastapy.bearings.bearing_results.rolling import _1708, _1749
...
class LoadedAsymmetricSphericalRollerBearingRow(_1749.LoadedRollerBearingRow):
    '''LoadedAsymmetricSphericalRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1708.LoadedAsymmetricSphericalRollerBearingResults':
        ...
        return constructor.new(_1708.LoadedAsymmetricSphericalRollerBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
