...
class ISO14179SettingsPerBearingType(_1364.IndependentReportablePropertiesBase['ISO14179SettingsPerBearingType']):
    '''ISO14179SettingsPerBearingType
    ...
    @property
    def rolling_bearing_type(self) -> '_1624.RollingBearingType':
        ...
        return constructor.new(_1624.RollingBearingType)(value) if value else None
