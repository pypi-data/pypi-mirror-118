...
from mastapy.bearings.bearing_results.rolling import _1771, _1722
...
class LoadedThreePointContactBallBearingRow(_1722.LoadedBallBearingRow):
    '''LoadedThreePointContactBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1771.LoadedThreePointContactBallBearingResults':
        ...
        return constructor.new(_1771.LoadedThreePointContactBallBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
