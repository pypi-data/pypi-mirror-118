...
from mastapy.bearings.bearing_results.rolling import _1731, _1722
...
class LoadedDeepGrooveBallBearingRow(_1722.LoadedBallBearingRow):
    '''LoadedDeepGrooveBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1731.LoadedDeepGrooveBallBearingResults':
        ...
        return constructor.new(_1731.LoadedDeepGrooveBallBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
