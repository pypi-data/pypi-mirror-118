...
from mastapy.bearings.bearing_results.rolling import _1755, _1722
...
class LoadedSelfAligningBallBearingRow(_1722.LoadedBallBearingRow):
    '''LoadedSelfAligningBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1755.LoadedSelfAligningBallBearingResults':
        ...
        return constructor.new(_1755.LoadedSelfAligningBallBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
