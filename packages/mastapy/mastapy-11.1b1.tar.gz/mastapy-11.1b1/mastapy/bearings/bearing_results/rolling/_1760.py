...
from mastapy.bearings.bearing_results.rolling import _1759, _1749
...
class LoadedSphericalRollerRadialBearingRow(_1749.LoadedRollerBearingRow):
    '''LoadedSphericalRollerRadialBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1759.LoadedSphericalRollerRadialBearingResults':
        ...
        return constructor.new(_1759.LoadedSphericalRollerRadialBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
