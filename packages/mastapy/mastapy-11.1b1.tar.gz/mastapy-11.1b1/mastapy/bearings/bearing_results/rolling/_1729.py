...
from mastapy.bearings.bearing_results.rolling import _1728, _1740, _1744
...
class LoadedCylindricalRollerBearingRow(_1744.LoadedNonBarrelRollerBearingRow):
    '''LoadedCylindricalRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1728.LoadedCylindricalRollerBearingResults':
