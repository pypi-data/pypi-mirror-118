...
from mastapy.bearings.bearing_results.rolling import _1712
...
class LoadedAxialThrustNeedleRollerBearingElement(_1712.LoadedAxialThrustCylindricalRollerBearingElement):
    '''LoadedAxialThrustNeedleRollerBearingElement
