...
from mastapy.bearings.tolerances import _1646, _1651, _1642
...
class RoundnessSpecification(_1364.IndependentReportablePropertiesBase['RoundnessSpecification']):
    '''RoundnessSpecification
    ...
    @property
    def specification_type(self) -> '_1646.RoundnessSpecificationType':
        ...
        return constructor.new(_1646.RoundnessSpecificationType)(value) if value else None

    @specification_type.setter
    def specification_type(self, value: '_1646.RoundnessSpecificationType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.SpecificationType = value

    @property
    def user_specified_deviation(self) -> '_1315.Vector2DListAccessor':
        '''Vector2DListAccessor: 'UserSpecifiedDeviation' is the original name of this property.'''

        return constructor.new(_1315.Vector2DListAccessor)(self.wrapped.UserSpecifiedDeviation) if self.wrapped.UserSpecifiedDeviation else None

    @user_specified_deviation.setter
    def user_specified_deviation(self, value: '_1315.Vector2DListAccessor'):
        value = value.wrapped if value else None
        self.wrapped.UserSpecifiedDeviation = value

    @property
    def type_of_fit(self) -> '_1651.TypeOfFit':
        '''TypeOfFit: 'TypeOfFit' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.TypeOfFit)
        return constructor.new(_1651.TypeOfFit)(value) if value else None

    @type_of_fit.setter
    def type_of_fit(self, value: '_1651.TypeOfFit'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.TypeOfFit = value

    @property
    def roundness_distribution(self) -> 'List[_1642.RaceRoundnessAtAngle]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RoundnessDistribution, constructor.new(_1642.RaceRoundnessAtAngle))
        return value
