...
from mastapy.gears.manufacturing.bevel.cutters import _765, _766
...
class ConicalPinionManufacturingConfig(_728.ConicalGearManufacturingConfig):
    '''ConicalPinionManufacturingConfig
    ...
    @property
    def mesh_config(self) -> '_737.ConicalMeshManufacturingConfig':
        ...
        return constructor.new(_737.ConicalMeshManufacturingConfig)(self.wrapped.MeshConfig) if self.wrapped.MeshConfig else None

    @property
    def pinion_concave_ob_configuration(self) -> '_733.ConicalMeshFlankManufacturingConfig':
        ...
        return constructor.new(_733.ConicalMeshFlankManufacturingConfig)(self.wrapped.PinionConcaveOBConfiguration) if self.wrapped.PinionConcaveOBConfiguration else None

    @property
    def pinion_convex_ib_configuration(self) -> '_733.ConicalMeshFlankManufacturingConfig':
        ...
        return constructor.new(_733.ConicalMeshFlankManufacturingConfig)(self.wrapped.PinionConvexIBConfiguration) if self.wrapped.PinionConvexIBConfiguration else None

    @property
    def pinion_finish_cutter(self) -> '_765.PinionFinishCutter':
        ...
        return constructor.new(_765.PinionFinishCutter)(self.wrapped.PinionFinishCutter) if self.wrapped.PinionFinishCutter else None

    @property
    def pinion_rough_cutter(self) -> '_766.PinionRoughCutter':
        ...
        return constructor.new(_766.PinionRoughCutter)(self.wrapped.PinionRoughCutter) if self.wrapped.PinionRoughCutter else None

    @property
    def pinion_cutter_parameters_concave(self) -> '_758.PinionFinishMachineSettings':
        ...
        if _758.PinionFinishMachineSettings.TYPE not in self.wrapped.PinionCutterParametersConcave.__class__.__mro__:
    ...
    @property
    def pinion_cutter_parameters_concave_of_type_pinion_bevel_generating_modified_roll_machine_settings(self) -> '_753.PinionBevelGeneratingModifiedRollMachineSettings':
        ...
        if _753.PinionBevelGeneratingModifiedRollMachineSettings.TYPE not in self.wrapped.PinionCutterParametersConcave.__class__.__mro__:
    ...
    @property
    def pinion_cutter_parameters_concave_of_type_pinion_bevel_generating_tilt_machine_settings(self) -> '_754.PinionBevelGeneratingTiltMachineSettings':
        ...
        if _754.PinionBevelGeneratingTiltMachineSettings.TYPE not in self.wrapped.PinionCutterParametersConcave.__class__.__mro__:
    ...
    @property
    def pinion_cutter_parameters_concave_of_type_pinion_conical_machine_settings_specified(self) -> '_756.PinionConicalMachineSettingsSpecified':
        ...
        if _756.PinionConicalMachineSettingsSpecified.TYPE not in self.wrapped.PinionCutterParametersConcave.__class__.__mro__:
    ...
    @property
    def pinion_cutter_parameters_concave_of_type_pinion_hypoid_formate_tilt_machine_settings(self) -> '_759.PinionHypoidFormateTiltMachineSettings':
        ...
        if _759.PinionHypoidFormateTiltMachineSettings.TYPE not in self.wrapped.PinionCutterParametersConcave.__class__.__mro__:
    ...
    @property
    def pinion_cutter_parameters_concave_of_type_pinion_hypoid_generating_tilt_machine_settings(self) -> '_760.PinionHypoidGeneratingTiltMachineSettings':
        ...
        if _760.PinionHypoidGeneratingTiltMachineSettings.TYPE not in self.wrapped.PinionCutterParametersConcave.__class__.__mro__:
    ...
    @property
    def pinion_cutter_parameters_concave_of_type_pinion_machine_settings_smt(self) -> '_761.PinionMachineSettingsSMT':
        ...
        if _761.PinionMachineSettingsSMT.TYPE not in self.wrapped.PinionCutterParametersConcave.__class__.__mro__:
    ...
    @property
    def pinion_cutter_parameters_convex(self) -> '_758.PinionFinishMachineSettings':
        ...
        if _758.PinionFinishMachineSettings.TYPE not in self.wrapped.PinionCutterParametersConvex.__class__.__mro__:
    ...
    @property
    def pinion_cutter_parameters_convex_of_type_pinion_bevel_generating_modified_roll_machine_settings(self) -> '_753.PinionBevelGeneratingModifiedRollMachineSettings':
        ...
        if _753.PinionBevelGeneratingModifiedRollMachineSettings.TYPE not in self.wrapped.PinionCutterParametersConvex.__class__.__mro__:
    ...
    @property
    def pinion_cutter_parameters_convex_of_type_pinion_bevel_generating_tilt_machine_settings(self) -> '_754.PinionBevelGeneratingTiltMachineSettings':
        ...
        if _754.PinionBevelGeneratingTiltMachineSettings.TYPE not in self.wrapped.PinionCutterParametersConvex.__class__.__mro__:
    ...
    @property
    def pinion_cutter_parameters_convex_of_type_pinion_conical_machine_settings_specified(self) -> '_756.PinionConicalMachineSettingsSpecified':
        ...
        if _756.PinionConicalMachineSettingsSpecified.TYPE not in self.wrapped.PinionCutterParametersConvex.__class__.__mro__:
    ...
    @property
    def pinion_cutter_parameters_convex_of_type_pinion_hypoid_formate_tilt_machine_settings(self) -> '_759.PinionHypoidFormateTiltMachineSettings':
        ...
        if _759.PinionHypoidFormateTiltMachineSettings.TYPE not in self.wrapped.PinionCutterParametersConvex.__class__.__mro__:
    ...
    @property
    def pinion_cutter_parameters_convex_of_type_pinion_hypoid_generating_tilt_machine_settings(self) -> '_760.PinionHypoidGeneratingTiltMachineSettings':
        ...
        if _760.PinionHypoidGeneratingTiltMachineSettings.TYPE not in self.wrapped.PinionCutterParametersConvex.__class__.__mro__:
    ...
    @property
    def pinion_cutter_parameters_convex_of_type_pinion_machine_settings_smt(self) -> '_761.PinionMachineSettingsSMT':
        ...
        if _761.PinionMachineSettingsSMT.TYPE not in self.wrapped.PinionCutterParametersConvex.__class__.__mro__:
    ...
    @property
    def pinion_rough_machine_setting(self) -> '_762.PinionRoughMachineSetting':
        ...
        return constructor.new(_762.PinionRoughMachineSetting)(self.wrapped.PinionRoughMachineSetting) if self.wrapped.PinionRoughMachineSetting else None
