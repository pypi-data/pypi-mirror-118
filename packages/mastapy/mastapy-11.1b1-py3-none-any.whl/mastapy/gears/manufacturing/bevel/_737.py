...
from mastapy.gears.manufacturing.bevel import _746, _739
...
class ConicalMeshManufacturingConfig(_739.ConicalMeshMicroGeometryConfigBase):
    '''ConicalMeshManufacturingConfig
    ...
    @property
    def wheel_config(self) -> '_746.ConicalWheelManufacturingConfig':
        ...
        return constructor.new(_746.ConicalWheelManufacturingConfig)(self.wrapped.WheelConfig) if self.wrapped.WheelConfig else None
