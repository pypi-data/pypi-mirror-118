...
from mastapy.gears.manufacturing.bevel.basic_machine_settings import _775, _776
...
class ConicalMeshFlankManufacturingConfig(_734.ConicalMeshFlankMicroGeometryConfig):
    '''ConicalMeshFlankManufacturingConfig
    ...
    @property
    def control_parameters(self) -> '_769.ConicalGearManufacturingControlParameters':
        ...
        if _769.ConicalGearManufacturingControlParameters.TYPE not in self.wrapped.ControlParameters.__class__.__mro__:
    ...
    @property
    def control_parameters_of_type_conical_manufacturing_sgm_control_parameters(self) -> '_770.ConicalManufacturingSGMControlParameters':
        ...
        if _770.ConicalManufacturingSGMControlParameters.TYPE not in self.wrapped.ControlParameters.__class__.__mro__:
    ...
    @property
    def control_parameters_of_type_conical_manufacturing_sgt_control_parameters(self) -> '_771.ConicalManufacturingSGTControlParameters':
        ...
        if _771.ConicalManufacturingSGTControlParameters.TYPE not in self.wrapped.ControlParameters.__class__.__mro__:
    ...
    @property
    def control_parameters_of_type_conical_manufacturing_smt_control_parameters(self) -> '_772.ConicalManufacturingSMTControlParameters':
        ...
        if _772.ConicalManufacturingSMTControlParameters.TYPE not in self.wrapped.ControlParameters.__class__.__mro__:
    ...
    @property
    def specified_phoenix_style_machine_settings(self) -> '_775.BasicConicalGearMachineSettingsGenerated':
        ...
        return constructor.new(_775.BasicConicalGearMachineSettingsGenerated)(self.wrapped.SpecifiedPhoenixStyleMachineSettings) if self.wrapped.SpecifiedPhoenixStyleMachineSettings else None

    @property
    def specified_cradle_style_machine_settings(self) -> '_776.CradleStyleConicalMachineSettingsGenerated':
        ...
        return constructor.new(_776.CradleStyleConicalMachineSettingsGenerated)(self.wrapped.SpecifiedCradleStyleMachineSettings) if self.wrapped.SpecifiedCradleStyleMachineSettings else None
