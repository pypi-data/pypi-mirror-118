...
from mastapy.gears.gear_designs.conical import _1087, _1086
from mastapy._internal.overridable_constructor import _unpack_overridable
from mastapy._internal import enum_with_selected_value_runtime, conversion, constructor
from mastapy.gears.manufacturing.bevel import _728, _737, _745
...
class ConicalSetManufacturingConfig(_745.ConicalSetMicroGeometryConfigBase):
    '''ConicalSetManufacturingConfig
    ...
    @property
    def gear_manufacturing_configurations(self) -> 'List[_728.ConicalGearManufacturingConfig]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearManufacturingConfigurations, constructor.new(_728.ConicalGearManufacturingConfig))
        return value

    @property
    def meshes(self) -> 'List[_737.ConicalMeshManufacturingConfig]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Meshes, constructor.new(_737.ConicalMeshManufacturingConfig))
        return value
