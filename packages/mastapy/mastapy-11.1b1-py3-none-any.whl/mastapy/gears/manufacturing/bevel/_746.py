...
from mastapy.gears.manufacturing.bevel.cutters import _768, _767
...
class ConicalWheelManufacturingConfig(_728.ConicalGearManufacturingConfig):
    '''ConicalWheelManufacturingConfig
    ...
    @property
    def wheel_rough_cutter(self) -> '_768.WheelRoughCutter':
        ...
        return constructor.new(_768.WheelRoughCutter)(self.wrapped.WheelRoughCutter) if self.wrapped.WheelRoughCutter else None

    @property
    def wheel_finish_cutter(self) -> '_767.WheelFinishCutter':
        ...
        return constructor.new(_767.WheelFinishCutter)(self.wrapped.WheelFinishCutter) if self.wrapped.WheelFinishCutter else None
    ...
    @property
    def specified_machine_settings(self) -> '_773.BasicConicalGearMachineSettings':
        ...
        if _773.BasicConicalGearMachineSettings.TYPE not in self.wrapped.SpecifiedMachineSettings.__class__.__mro__:
    ...
    @property
    def specified_machine_settings_of_type_basic_conical_gear_machine_settings_formate(self) -> '_774.BasicConicalGearMachineSettingsFormate':
        ...
        if _774.BasicConicalGearMachineSettingsFormate.TYPE not in self.wrapped.SpecifiedMachineSettings.__class__.__mro__:
    ...
    @property
    def specified_machine_settings_of_type_basic_conical_gear_machine_settings_generated(self) -> '_775.BasicConicalGearMachineSettingsGenerated':
        ...
        if _775.BasicConicalGearMachineSettingsGenerated.TYPE not in self.wrapped.SpecifiedMachineSettings.__class__.__mro__:
