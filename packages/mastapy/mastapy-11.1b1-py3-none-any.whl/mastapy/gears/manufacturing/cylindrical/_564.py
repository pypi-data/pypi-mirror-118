...
from mastapy.gears.manufacturing.cylindrical import _576, _575, _563
...
from mastapy.gears.gear_designs.cylindrical import _981, _950, _977
from mastapy.gears.manufacturing.cylindrical.cutter_simulation import (
    _663, _660, _668, _657,
    _666
)
from mastapy.gears.manufacturing.cylindrical.process_simulation import _591, _592, _593
...
class CylindricalGearManufacturingConfig(_1147.GearImplementationDetail):
    '''CylindricalGearManufacturingConfig
    ...
    @property
    def rough_cutter(self) -> '_683.CylindricalGearRealCutterDesign':
        ...
        if _683.CylindricalGearRealCutterDesign.TYPE not in self.wrapped.RoughCutter.__class__.__mro__:
    ...
    @property
    def rough_cutter_of_type_cylindrical_gear_form_grinding_wheel(self) -> '_677.CylindricalGearFormGrindingWheel':
        ...
        if _677.CylindricalGearFormGrindingWheel.TYPE not in self.wrapped.RoughCutter.__class__.__mro__:
    ...
    @property
    def rough_cutter_of_type_cylindrical_gear_grinding_worm(self) -> '_678.CylindricalGearGrindingWorm':
        ...
        if _678.CylindricalGearGrindingWorm.TYPE not in self.wrapped.RoughCutter.__class__.__mro__:
    ...
    @property
    def rough_cutter_of_type_cylindrical_gear_hob_design(self) -> '_679.CylindricalGearHobDesign':
        ...
        if _679.CylindricalGearHobDesign.TYPE not in self.wrapped.RoughCutter.__class__.__mro__:
    ...
    @property
    def rough_cutter_of_type_cylindrical_gear_plunge_shaver(self) -> '_680.CylindricalGearPlungeShaver':
        ...
        if _680.CylindricalGearPlungeShaver.TYPE not in self.wrapped.RoughCutter.__class__.__mro__:
    ...
    @property
    def rough_cutter_of_type_cylindrical_gear_rack_design(self) -> '_682.CylindricalGearRackDesign':
        ...
        if _682.CylindricalGearRackDesign.TYPE not in self.wrapped.RoughCutter.__class__.__mro__:
    ...
    @property
    def rough_cutter_of_type_cylindrical_gear_shaper(self) -> '_684.CylindricalGearShaper':
        ...
        if _684.CylindricalGearShaper.TYPE not in self.wrapped.RoughCutter.__class__.__mro__:
    ...
    @property
    def rough_cutter_of_type_cylindrical_gear_shaver(self) -> '_685.CylindricalGearShaver':
        ...
        if _685.CylindricalGearShaver.TYPE not in self.wrapped.RoughCutter.__class__.__mro__:
    ...
    @property
    def rough_cutter_of_type_involute_cutter_design(self) -> '_688.InvoluteCutterDesign':
        ...
        if _688.InvoluteCutterDesign.TYPE not in self.wrapped.RoughCutter.__class__.__mro__:
    ...
    @property
    def finish_cutter(self) -> '_683.CylindricalGearRealCutterDesign':
        ...
        if _683.CylindricalGearRealCutterDesign.TYPE not in self.wrapped.FinishCutter.__class__.__mro__:
    ...
    @property
    def finish_cutter_of_type_cylindrical_gear_form_grinding_wheel(self) -> '_677.CylindricalGearFormGrindingWheel':
        ...
        if _677.CylindricalGearFormGrindingWheel.TYPE not in self.wrapped.FinishCutter.__class__.__mro__:
    ...
    @property
    def finish_cutter_of_type_cylindrical_gear_grinding_worm(self) -> '_678.CylindricalGearGrindingWorm':
        ...
        if _678.CylindricalGearGrindingWorm.TYPE not in self.wrapped.FinishCutter.__class__.__mro__:
    ...
    @property
    def finish_cutter_of_type_cylindrical_gear_hob_design(self) -> '_679.CylindricalGearHobDesign':
        ...
        if _679.CylindricalGearHobDesign.TYPE not in self.wrapped.FinishCutter.__class__.__mro__:
    ...
    @property
    def finish_cutter_of_type_cylindrical_gear_plunge_shaver(self) -> '_680.CylindricalGearPlungeShaver':
        ...
        if _680.CylindricalGearPlungeShaver.TYPE not in self.wrapped.FinishCutter.__class__.__mro__:
    ...
    @property
    def finish_cutter_of_type_cylindrical_gear_rack_design(self) -> '_682.CylindricalGearRackDesign':
        ...
        if _682.CylindricalGearRackDesign.TYPE not in self.wrapped.FinishCutter.__class__.__mro__:
    ...
    @property
    def finish_cutter_of_type_cylindrical_gear_shaper(self) -> '_684.CylindricalGearShaper':
        ...
        if _684.CylindricalGearShaper.TYPE not in self.wrapped.FinishCutter.__class__.__mro__:
    ...
    @property
    def finish_cutter_of_type_cylindrical_gear_shaver(self) -> '_685.CylindricalGearShaver':
        ...
        if _685.CylindricalGearShaver.TYPE not in self.wrapped.FinishCutter.__class__.__mro__:
    ...
    @property
    def finish_cutter_of_type_involute_cutter_design(self) -> '_688.InvoluteCutterDesign':
        ...
        if _688.InvoluteCutterDesign.TYPE not in self.wrapped.FinishCutter.__class__.__mro__:
    ...
    @property
    def rough_cutter_simulation(self) -> '_663.GearCutterSimulation':
        ...
        if _663.GearCutterSimulation.TYPE not in self.wrapped.RoughCutterSimulation.__class__.__mro__:
    ...
    @property
    def rough_cutter_simulation_of_type_finish_cutter_simulation(self) -> '_660.FinishCutterSimulation':
        ...
        if _660.FinishCutterSimulation.TYPE not in self.wrapped.RoughCutterSimulation.__class__.__mro__:
    ...
    @property
    def rough_cutter_simulation_of_type_rough_cutter_simulation(self) -> '_668.RoughCutterSimulation':
        ...
        if _668.RoughCutterSimulation.TYPE not in self.wrapped.RoughCutterSimulation.__class__.__mro__:
    ...
    @property
    def rough_process_simulation(self) -> '_591.CutterProcessSimulation':
        ...
        if _591.CutterProcessSimulation.TYPE not in self.wrapped.RoughProcessSimulation.__class__.__mro__:
    ...
    @property
    def rough_process_simulation_of_type_form_wheel_grinding_process_simulation(self) -> '_592.FormWheelGrindingProcessSimulation':
        ...
        if _592.FormWheelGrindingProcessSimulation.TYPE not in self.wrapped.RoughProcessSimulation.__class__.__mro__:
    ...
    @property
    def rough_process_simulation_of_type_shaping_process_simulation(self) -> '_593.ShapingProcessSimulation':
        ...
        if _593.ShapingProcessSimulation.TYPE not in self.wrapped.RoughProcessSimulation.__class__.__mro__:
    ...
    @property
    def finish_cutter_simulation(self) -> '_663.GearCutterSimulation':
        ...
        if _663.GearCutterSimulation.TYPE not in self.wrapped.FinishCutterSimulation.__class__.__mro__:
    ...
    @property
    def finish_cutter_simulation_of_type_finish_cutter_simulation(self) -> '_660.FinishCutterSimulation':
        ...
        if _660.FinishCutterSimulation.TYPE not in self.wrapped.FinishCutterSimulation.__class__.__mro__:
    ...
    @property
    def finish_cutter_simulation_of_type_rough_cutter_simulation(self) -> '_668.RoughCutterSimulation':
        ...
        if _668.RoughCutterSimulation.TYPE not in self.wrapped.FinishCutterSimulation.__class__.__mro__:
    ...
    @property
    def finish_process_simulation(self) -> '_591.CutterProcessSimulation':
        ...
        if _591.CutterProcessSimulation.TYPE not in self.wrapped.FinishProcessSimulation.__class__.__mro__:
    ...
    @property
    def finish_process_simulation_of_type_form_wheel_grinding_process_simulation(self) -> '_592.FormWheelGrindingProcessSimulation':
        ...
        if _592.FormWheelGrindingProcessSimulation.TYPE not in self.wrapped.FinishProcessSimulation.__class__.__mro__:
    ...
    @property
    def finish_process_simulation_of_type_shaping_process_simulation(self) -> '_593.ShapingProcessSimulation':
        ...
        if _593.ShapingProcessSimulation.TYPE not in self.wrapped.FinishProcessSimulation.__class__.__mro__:
    ...
    @property
    def design(self) -> '_950.CylindricalGearDesign':
        ...
        if _950.CylindricalGearDesign.TYPE not in self.wrapped.Design.__class__.__mro__:
    ...
    @property
    def rough_gear_specification(self) -> '_657.CylindricalGearSpecification':
        ...
        return constructor.new(_657.CylindricalGearSpecification)(self.wrapped.RoughGearSpecification) if self.wrapped.RoughGearSpecification else None

    @property
    def finished_gear_specification(self) -> '_657.CylindricalGearSpecification':
        ...
        return constructor.new(_657.CylindricalGearSpecification)(self.wrapped.FinishedGearSpecification) if self.wrapped.FinishedGearSpecification else None

    @property
    def gear_blank(self) -> '_563.CylindricalGearBlank':
        ...
        return constructor.new(_563.CylindricalGearBlank)(self.wrapped.GearBlank) if self.wrapped.GearBlank else None

    @property
    def rough_manufacturing_process_controls(self) -> '_666.ManufacturingProcessControls':
        ...
        return constructor.new(_666.ManufacturingProcessControls)(self.wrapped.RoughManufacturingProcessControls) if self.wrapped.RoughManufacturingProcessControls else None

    @property
    def finish_manufacturing_process_controls(self) -> '_666.ManufacturingProcessControls':
        ...
        return constructor.new(_666.ManufacturingProcessControls)(self.wrapped.FinishManufacturingProcessControls) if self.wrapped.FinishManufacturingProcessControls else None
