...
from mastapy.gears.manufacturing.cylindrical.cutters.tangibles import _698, _700, _695
...
class CylindricalGearGrindingWorm(_682.CylindricalGearRackDesign):
    '''CylindricalGearGrindingWorm
    ...
    @property
    def nominal_worm_grinder_shape(self) -> '_698.CylindricalGearWormGrinderShape':
        ...
        return constructor.new(_698.CylindricalGearWormGrinderShape)(self.wrapped.NominalWormGrinderShape) if self.wrapped.NominalWormGrinderShape else None
