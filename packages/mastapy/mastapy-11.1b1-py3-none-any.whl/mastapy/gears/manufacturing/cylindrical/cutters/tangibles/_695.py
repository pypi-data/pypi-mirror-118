...
class CylindricalGearHobShape(_700.RackShape):
    '''CylindricalGearHobShape
    ...
    @property
    def design(self) -> '_679.CylindricalGearHobDesign':
        ...
        return constructor.new(_679.CylindricalGearHobDesign)(self.wrapped.Design) if self.wrapped.Design else None
