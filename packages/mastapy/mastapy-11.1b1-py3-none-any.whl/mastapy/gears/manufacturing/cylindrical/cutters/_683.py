...
from mastapy.gears.manufacturing.cylindrical.cutters import _674, _676
...
class CylindricalGearRealCutterDesign(_676.CylindricalGearAbstractCutterDesign):
    '''CylindricalGearRealCutterDesign
    ...
    @property
    def nominal_cutter_shape(self) -> '_693.CutterShapeDefinition':
        ...
        if _693.CutterShapeDefinition.TYPE not in self.wrapped.NominalCutterShape.__class__.__mro__:
    ...
    @property
    def nominal_cutter_shape_of_type_cylindrical_gear_formed_wheel_grinder_tangible(self) -> '_694.CylindricalGearFormedWheelGrinderTangible':
        ...
        if _694.CylindricalGearFormedWheelGrinderTangible.TYPE not in self.wrapped.NominalCutterShape.__class__.__mro__:
    ...
    @property
    def nominal_cutter_shape_of_type_cylindrical_gear_hob_shape(self) -> '_695.CylindricalGearHobShape':
        ...
        if _695.CylindricalGearHobShape.TYPE not in self.wrapped.NominalCutterShape.__class__.__mro__:
    ...
    @property
    def nominal_cutter_shape_of_type_cylindrical_gear_shaper_tangible(self) -> '_696.CylindricalGearShaperTangible':
        ...
        if _696.CylindricalGearShaperTangible.TYPE not in self.wrapped.NominalCutterShape.__class__.__mro__:
    ...
    @property
    def nominal_cutter_shape_of_type_cylindrical_gear_shaver_tangible(self) -> '_697.CylindricalGearShaverTangible':
        ...
        if _697.CylindricalGearShaverTangible.TYPE not in self.wrapped.NominalCutterShape.__class__.__mro__:
    ...
    @property
    def nominal_cutter_shape_of_type_cylindrical_gear_worm_grinder_shape(self) -> '_698.CylindricalGearWormGrinderShape':
        ...
        if _698.CylindricalGearWormGrinderShape.TYPE not in self.wrapped.NominalCutterShape.__class__.__mro__:
    ...
    @property
    def nominal_cutter_shape_of_type_rack_shape(self) -> '_700.RackShape':
        ...
        if _700.RackShape.TYPE not in self.wrapped.NominalCutterShape.__class__.__mro__:
    ...
    @property
    def customised_cutting_edge_profile(self) -> '_674.CustomisableEdgeProfile':
        ...
        return constructor.new(_674.CustomisableEdgeProfile)(self.wrapped.CustomisedCuttingEdgeProfile) if self.wrapped.CustomisedCuttingEdgeProfile else None
