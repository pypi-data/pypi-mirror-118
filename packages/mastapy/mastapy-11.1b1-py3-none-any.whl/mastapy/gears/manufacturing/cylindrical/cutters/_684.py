...
class CylindricalGearShaper(_688.InvoluteCutterDesign):
    '''CylindricalGearShaper
    ...
    @property
    def shaper_edge_type(self) -> '_1010.ShaperEdgeTypes':
        ...
        return constructor.new(_1010.ShaperEdgeTypes)(value) if value else None

    @shaper_edge_type.setter
    def shaper_edge_type(self, value: '_1010.ShaperEdgeTypes'):
