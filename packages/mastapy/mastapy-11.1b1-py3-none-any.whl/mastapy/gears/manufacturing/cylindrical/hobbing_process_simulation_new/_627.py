...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _618
...
class HobbingProcessTotalModificationCalculation(_618.HobbingProcessCalculation):
    '''HobbingProcessTotalModificationCalculation
