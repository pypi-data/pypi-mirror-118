...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _637, _624, _651
...
class ProcessCalculation(_0.APIBase):
    ...
    @property
    def inputs(self) -> '_637.ProcessSimulationInput':
        ...
        if _637.ProcessSimulationInput.TYPE not in self.wrapped.Inputs.__class__.__mro__:
    ...
    @property
    def inputs_of_type_hobbing_process_simulation_input(self) -> '_624.HobbingProcessSimulationInput':
        ...
        if _624.HobbingProcessSimulationInput.TYPE not in self.wrapped.Inputs.__class__.__mro__:
    ...
    @property
    def inputs_of_type_worm_grinding_process_simulation_input(self) -> '_651.WormGrindingProcessSimulationInput':
        ...
        if _651.WormGrindingProcessSimulationInput.TYPE not in self.wrapped.Inputs.__class__.__mro__:
