...
class ProcessPitchCalculation(_0.APIBase):
    ...
    @property
    def right_flank_accuracy_calculation(self) -> '_613.CalculatePitchDeviationAccuracy':
        ...
        return constructor.new(_613.CalculatePitchDeviationAccuracy)(self.wrapped.RightFlankAccuracyCalculation) if self.wrapped.RightFlankAccuracyCalculation else None

    @property
    def left_flank_accuracy_calculation(self) -> '_613.CalculatePitchDeviationAccuracy':
        ...
        return constructor.new(_613.CalculatePitchDeviationAccuracy)(self.wrapped.LeftFlankAccuracyCalculation) if self.wrapped.LeftFlankAccuracyCalculation else None
