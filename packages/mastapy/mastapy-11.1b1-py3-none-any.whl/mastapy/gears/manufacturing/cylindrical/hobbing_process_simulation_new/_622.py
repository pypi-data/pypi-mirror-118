...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _613, _618
...
class HobbingProcessPitchCalculation(_618.HobbingProcessCalculation):
    '''HobbingProcessPitchCalculation
