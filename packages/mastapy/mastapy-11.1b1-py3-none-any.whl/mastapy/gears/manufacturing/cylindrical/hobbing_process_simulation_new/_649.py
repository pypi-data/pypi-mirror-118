...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _613, _646
...
class WormGrindingProcessPitchCalculation(_646.WormGrindingProcessCalculation):
    '''WormGrindingProcessPitchCalculation
    ...
    @property
    def right_flank(self) -> '_613.CalculatePitchDeviationAccuracy':
        ...
        return constructor.new(_613.CalculatePitchDeviationAccuracy)(self.wrapped.RightFlank) if self.wrapped.RightFlank else None

    @property
    def left_flank(self) -> '_613.CalculatePitchDeviationAccuracy':
        ...
        return constructor.new(_613.CalculatePitchDeviationAccuracy)(self.wrapped.LeftFlank) if self.wrapped.LeftFlank else None
