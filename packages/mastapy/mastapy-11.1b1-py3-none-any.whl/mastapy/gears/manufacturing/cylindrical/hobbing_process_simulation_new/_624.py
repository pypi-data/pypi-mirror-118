...
class HobbingProcessSimulationInput(_637.ProcessSimulationInput):
    '''HobbingProcessSimulationInput
    ...
    @property
    def hob_manufacture_error(self) -> '_628.HobManufactureError':
        ...
        return constructor.new(_628.HobManufactureError)(self.wrapped.HobManufactureError) if self.wrapped.HobManufactureError else None

    @property
    def hob_resharpening_error(self) -> '_629.HobResharpeningError':
        ...
        return constructor.new(_629.HobResharpeningError)(self.wrapped.HobResharpeningError) if self.wrapped.HobResharpeningError else None
