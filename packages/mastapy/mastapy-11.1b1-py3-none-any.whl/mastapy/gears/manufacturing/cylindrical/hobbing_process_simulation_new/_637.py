...
class ProcessSimulationInput(_0.APIBase):
    ...
    @property
    def centre_distance_offset_specification_method(self) -> '_615.CentreDistanceOffsetMethod':
        ...
        return constructor.new(_615.CentreDistanceOffsetMethod)(value) if value else None

    @centre_distance_offset_specification_method.setter
    def centre_distance_offset_specification_method(self, value: '_615.CentreDistanceOffsetMethod'):
    ...
    @property
    def analysis_setting(self) -> '_611.AnalysisMethod':
        ...
        return constructor.new(_611.AnalysisMethod)(value) if value else None

    @analysis_setting.setter
    def analysis_setting(self, value: '_611.AnalysisMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.AnalysisSetting = value

    @property
    def user_specified_center_distance_offset_relative_to_cutter_height(self) -> '_1315.Vector2DListAccessor':
        '''Vector2DListAccessor: 'UserSpecifiedCenterDistanceOffsetRelativeToCutterHeight' is the original name of this property.'''

        return constructor.new(_1315.Vector2DListAccessor)(self.wrapped.UserSpecifiedCenterDistanceOffsetRelativeToCutterHeight) if self.wrapped.UserSpecifiedCenterDistanceOffsetRelativeToCutterHeight else None

    @user_specified_center_distance_offset_relative_to_cutter_height.setter
    def user_specified_center_distance_offset_relative_to_cutter_height(self, value: '_1315.Vector2DListAccessor'):
    ...
    @property
    def cutter_mounting_error(self) -> '_642.RackMountingError':
        ...
        return constructor.new(_642.RackMountingError)(self.wrapped.CutterMountingError) if self.wrapped.CutterMountingError else None

    @property
    def gear_mounting_error(self) -> '_617.GearMountingError':
        ...
        return constructor.new(_617.GearMountingError)(self.wrapped.GearMountingError) if self.wrapped.GearMountingError else None

    @property
    def cutter_head_slide_error(self) -> '_616.CutterHeadSlideError':
        ...
        return constructor.new(_616.CutterHeadSlideError)(self.wrapped.CutterHeadSlideError) if self.wrapped.CutterHeadSlideError else None
