...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _612, _646
...
class WormGrindingLeadCalculation(_646.WormGrindingProcessCalculation):
    '''WormGrindingLeadCalculation
    ...
    @property
    def right_flank(self) -> '_612.CalculateLeadDeviationAccuracy':
        ...
        return constructor.new(_612.CalculateLeadDeviationAccuracy)(self.wrapped.RightFlank) if self.wrapped.RightFlank else None

    @property
    def left_flank(self) -> '_612.CalculateLeadDeviationAccuracy':
        ...
        return constructor.new(_612.CalculateLeadDeviationAccuracy)(self.wrapped.LeftFlank) if self.wrapped.LeftFlank else None
