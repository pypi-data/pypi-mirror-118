...
class CylindricalGearSpecification(_0.APIBase):
    ...
    @property
    def tooth_thickness_specification(self) -> '_1022.ToothThicknessSpecificationBase':
        ...
        if _1022.ToothThicknessSpecificationBase.TYPE not in self.wrapped.ToothThicknessSpecification.__class__.__mro__:
    ...
    @property
    def tooth_thickness_specification_of_type_finish_tooth_thickness_design_specification(self) -> '_982.FinishToothThicknessDesignSpecification':
        ...
        if _982.FinishToothThicknessDesignSpecification.TYPE not in self.wrapped.ToothThicknessSpecification.__class__.__mro__:
    ...
    @property
    def tooth_thickness_specification_of_type_readonly_tooth_thickness_specification(self) -> '_1003.ReadonlyToothThicknessSpecification':
        ...
        if _1003.ReadonlyToothThicknessSpecification.TYPE not in self.wrapped.ToothThicknessSpecification.__class__.__mro__:
    ...
    @property
    def tooth_thickness_specification_of_type_tooth_thickness_specification(self) -> '_1021.ToothThicknessSpecification':
        ...
        if _1021.ToothThicknessSpecification.TYPE not in self.wrapped.ToothThicknessSpecification.__class__.__mro__:
