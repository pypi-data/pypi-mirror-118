...
from mastapy.gears.manufacturing.cylindrical.cutter_simulation import _671
...
class CylindricalManufacturedVirtualGearInMesh(_0.APIBase):
    ...
    @property
    def virtual_gear(self) -> '_671.VirtualSimulationCalculator':
        ...
        return constructor.new(_671.VirtualSimulationCalculator)(self.wrapped.VirtualGear) if self.wrapped.VirtualGear else None
