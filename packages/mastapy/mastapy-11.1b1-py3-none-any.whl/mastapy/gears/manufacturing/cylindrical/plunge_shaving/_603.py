...
from mastapy.gears.manufacturing.cylindrical.plunge_shaving import _595, _601
...
class PlungeShaverOutputs(_0.APIBase):
    ...
    @property
    def calculation_details(self) -> '_601.PlungeShaverGeneration':
        ...
        return constructor.new(_601.PlungeShaverGeneration)(self.wrapped.CalculationDetails) if self.wrapped.CalculationDetails else None
