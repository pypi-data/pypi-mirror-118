...
class RealPlungeShaverOutputs(_603.PlungeShaverOutputs):
    '''RealPlungeShaverOutputs
    ...
    @property
    def lead_measurement_method(self) -> '_597.MicroGeometryDefinitionMethod':
        ...
        return constructor.new(_597.MicroGeometryDefinitionMethod)(value) if value else None

    @lead_measurement_method.setter
    def lead_measurement_method(self, value: '_597.MicroGeometryDefinitionMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.LeadMeasurementMethod = value

    @property
    def profile_measurement_method(self) -> '_597.MicroGeometryDefinitionMethod':
    ...
    def profile_measurement_method(self, value: '_597.MicroGeometryDefinitionMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def left_flank_micro_geometry(self) -> '_565.CylindricalGearSpecifiedMicroGeometry':
        ...
        return constructor.new(_565.CylindricalGearSpecifiedMicroGeometry)(self.wrapped.LeftFlankMicroGeometry) if self.wrapped.LeftFlankMicroGeometry else None

    @property
    def right_flank_micro_geometry(self) -> '_565.CylindricalGearSpecifiedMicroGeometry':
        ...
        return constructor.new(_565.CylindricalGearSpecifiedMicroGeometry)(self.wrapped.RightFlankMicroGeometry) if self.wrapped.RightFlankMicroGeometry else None

    @property
    def shaver(self) -> '_680.CylindricalGearPlungeShaver':
        ...
        return constructor.new(_680.CylindricalGearPlungeShaver)(self.wrapped.Shaver) if self.wrapped.Shaver else None

    @property
    def micro_geometry(self) -> 'List[_565.CylindricalGearSpecifiedMicroGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MicroGeometry, constructor.new(_565.CylindricalGearSpecifiedMicroGeometry))
        return value
