...
from mastapy.gears.manufacturing.cylindrical.plunge_shaving import _600, _609
...
class PlungeShaverCalculation(_0.APIBase):
    ...
    @property
    def inputs(self) -> '_600.PlungeShaverCalculationInputs':
        ...
        return constructor.new(_600.PlungeShaverCalculationInputs)(self.wrapped.Inputs) if self.wrapped.Inputs else None

    @property
    def simulation_of_ideal_shaver_conjugate_to_the_designed_gear(self) -> '_609.VirtualPlungeShaverOutputs':
        ...
        return constructor.new(_609.VirtualPlungeShaverOutputs)(self.wrapped.SimulationOfIdealShaverConjugateToTheDesignedGear) if self.wrapped.SimulationOfIdealShaverConjugateToTheDesignedGear else None
