...
from mastapy.gears.manufacturing.cylindrical import _585, _589
...
class MicroGeometryInputsProfile(_585.MicroGeometryInputs['_589.ProfileModificationSegment']):
    '''MicroGeometryInputsProfile
    ...
    @property
    def profile_micro_geometry_range(self) -> '_1269.Range':
        ...
        if _1269.Range.TYPE not in self.wrapped.ProfileMicroGeometryRange.__class__.__mro__:
