...
from mastapy.gears.manufacturing.cylindrical.axial_and_plunge_shaving_dynamics import _708, _722, _707
...
class PlungeShavingDynamicsViewModel(_722.ShavingDynamicsViewModel['_707.PlungeShaverDynamics']):
    '''PlungeShavingDynamicsViewModel
    ...
    @property
    def settings(self) -> '_708.PlungeShaverDynamicSettings':
        ...
        return constructor.new(_708.PlungeShaverDynamicSettings)(self.wrapped.Settings) if self.wrapped.Settings else None
