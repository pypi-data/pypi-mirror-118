...
from mastapy.gears.fe_model import _1127, _1126
...
class GearSetFEModel(_1157.GearSetImplementationDetail):
    '''GearSetFEModel
    ...
    @property
    def mesh_fe_models(self) -> 'List[_1127.GearMeshFEModel]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshFEModels, constructor.new(_1127.GearMeshFEModel))
        return value

    @property
    def gear_fe_models(self) -> 'List[_1126.GearFEModel]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearFEModels, constructor.new(_1126.GearFEModel))
        return value
    ...
    def calculate_stiffness_from_fe_with_progress(self, progress: '_7242.TaskProgress'):
        ''' 'CalculateStiffnessFromFE' is the original name of this method.
