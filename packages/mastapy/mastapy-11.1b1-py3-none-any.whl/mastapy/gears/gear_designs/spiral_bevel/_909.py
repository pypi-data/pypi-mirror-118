...
from mastapy.gears.gear_designs.spiral_bevel import _907, _908
...
class SpiralBevelGearSetDesign(_1111.BevelGearSetDesign):
    '''SpiralBevelGearSetDesign
    ...
    @property
    def gears(self) -> 'List[_907.SpiralBevelGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_907.SpiralBevelGearDesign))
        return value

    @property
    def spiral_bevel_gears(self) -> 'List[_907.SpiralBevelGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelGears, constructor.new(_907.SpiralBevelGearDesign))
        return value

    @property
    def spiral_bevel_meshes(self) -> 'List[_908.SpiralBevelGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelMeshes, constructor.new(_908.SpiralBevelGearMeshDesign))
        return value
