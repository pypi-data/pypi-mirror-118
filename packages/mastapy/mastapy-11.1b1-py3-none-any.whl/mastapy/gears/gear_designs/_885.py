...
class GearDesign(_886.GearDesignComponent):
    '''GearDesign
    ...
    @property
    def tifffe_model(self) -> '_1126.GearFEModel':
        ...
        if _1126.GearFEModel.TYPE not in self.wrapped.TIFFFEModel.__class__.__mro__:
    ...
    @property
    def tifffe_model_of_type_cylindrical_gear_fe_model(self) -> '_1130.CylindricalGearFEModel':
        ...
        if _1130.CylindricalGearFEModel.TYPE not in self.wrapped.TIFFFEModel.__class__.__mro__:
    ...
    @property
    def tifffe_model_of_type_conical_gear_fe_model(self) -> '_1133.ConicalGearFEModel':
        ...
        if _1133.ConicalGearFEModel.TYPE not in self.wrapped.TIFFFEModel.__class__.__mro__:
