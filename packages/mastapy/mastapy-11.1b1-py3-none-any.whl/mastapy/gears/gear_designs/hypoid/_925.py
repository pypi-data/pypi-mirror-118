...
from mastapy.gears.gear_designs.hypoid import _923, _924
...
class HypoidGearSetDesign(_1124.AGMAGleasonConicalGearSetDesign):
    '''HypoidGearSetDesign
    ...
    @property
    def gears(self) -> 'List[_923.HypoidGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_923.HypoidGearDesign))
        return value

    @property
    def hypoid_gears(self) -> 'List[_923.HypoidGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidGears, constructor.new(_923.HypoidGearDesign))
        return value

    @property
    def meshes(self) -> 'List[_924.HypoidGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Meshes, constructor.new(_924.HypoidGearMeshDesign))
        return value

    @property
    def hypoid_meshes(self) -> 'List[_924.HypoidGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidMeshes, constructor.new(_924.HypoidGearMeshDesign))
        return value
