...
from mastapy.gears.gear_designs.conical import _1094, _1085
...
class AGMAGleasonConicalGearSetDesign(_1085.ConicalGearSetDesign):
    '''AGMAGleasonConicalGearSetDesign
    ...
    @property
    def conical_meshes(self) -> 'List[_1123.AGMAGleasonConicalGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConicalMeshes, constructor.new(_1123.AGMAGleasonConicalGearMeshDesign))
        return value

    @property
    def meshes(self) -> 'List[_1123.AGMAGleasonConicalGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Meshes, constructor.new(_1123.AGMAGleasonConicalGearMeshDesign))
        return value
