...
from mastapy.gears.fe_model import _1129
...
class GearSetDesign(_886.GearDesignComponent):
    '''GearSetDesign
    ...
    @property
    def active_ltcafe_model(self) -> '_1129.GearSetFEModel':
        ...
        if _1129.GearSetFEModel.TYPE not in self.wrapped.ActiveLTCAFEModel.__class__.__mro__:
    ...
    @property
    def active_ltcafe_model_of_type_cylindrical_gear_set_fe_model(self) -> '_1132.CylindricalGearSetFEModel':
        ...
        if _1132.CylindricalGearSetFEModel.TYPE not in self.wrapped.ActiveLTCAFEModel.__class__.__mro__:
    ...
    @property
    def active_ltcafe_model_of_type_conical_set_fe_model(self) -> '_1135.ConicalSetFEModel':
        ...
        if _1135.ConicalSetFEModel.TYPE not in self.wrapped.ActiveLTCAFEModel.__class__.__mro__:
    ...
    @property
    def tifffe_model(self) -> '_1129.GearSetFEModel':
        ...
        if _1129.GearSetFEModel.TYPE not in self.wrapped.TIFFFEModel.__class__.__mro__:
    ...
    @property
    def tifffe_model_of_type_cylindrical_gear_set_fe_model(self) -> '_1132.CylindricalGearSetFEModel':
        ...
        if _1132.CylindricalGearSetFEModel.TYPE not in self.wrapped.TIFFFEModel.__class__.__mro__:
    ...
    @property
    def tifffe_model_of_type_conical_set_fe_model(self) -> '_1135.ConicalSetFEModel':
        ...
        if _1135.ConicalSetFEModel.TYPE not in self.wrapped.TIFFFEModel.__class__.__mro__:
    ...
    @property
    def gears(self) -> 'List[_885.GearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_885.GearDesign))
        return value

    @property
    def ltcafe_models(self) -> 'List[_1129.GearSetFEModel]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LTCAFEModels, constructor.new(_1129.GearSetFEModel))
        return value
