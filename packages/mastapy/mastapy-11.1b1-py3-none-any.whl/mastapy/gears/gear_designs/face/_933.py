...
class FaceGearSetDesign(_888.GearSetDesign):
    '''FaceGearSetDesign
    ...
    @property
    def pinion(self) -> '_932.FaceGearPinionDesign':
        ...
        return constructor.new(_932.FaceGearPinionDesign)(self.wrapped.Pinion) if self.wrapped.Pinion else None

    @property
    def face_gear(self) -> '_935.FaceGearWheelDesign':
        ...
        return constructor.new(_935.FaceGearWheelDesign)(self.wrapped.FaceGear) if self.wrapped.FaceGear else None

    @property
    def cylindrical_gear_set_micro_geometry(self) -> '_934.FaceGearSetMicroGeometry':
        ...
        return constructor.new(_934.FaceGearSetMicroGeometry)(self.wrapped.CylindricalGearSetMicroGeometry) if self.wrapped.CylindricalGearSetMicroGeometry else None

    @property
    def gears(self) -> 'List[_927.FaceGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_927.FaceGearDesign))
        return value

    @property
    def face_gears(self) -> 'List[_927.FaceGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGears, constructor.new(_927.FaceGearDesign))
        return value

    @property
    def face_meshes(self) -> 'List[_929.FaceGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshes, constructor.new(_929.FaceGearMeshDesign))
        return value
