...
from mastapy.gears.gear_designs.face import _928, _927
...
class FaceGearWheelDesign(_927.FaceGearDesign):
    '''FaceGearWheelDesign
    ...
    @property
    def face_width_and_diameters_specification_method(self) -> '_928.FaceGearDiameterFaceWidthSpecificationMethod':
        ...
        return constructor.new(_928.FaceGearDiameterFaceWidthSpecificationMethod)(value) if value else None

    @face_width_and_diameters_specification_method.setter
    def face_width_and_diameters_specification_method(self, value: '_928.FaceGearDiameterFaceWidthSpecificationMethod'):
