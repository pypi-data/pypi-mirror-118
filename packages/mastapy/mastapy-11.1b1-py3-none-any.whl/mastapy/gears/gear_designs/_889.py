...
from mastapy.gears.gear_designs import _884
...
class SelectedDesignConstraintsCollection(_1369.PerMachineSettings):
    '''SelectedDesignConstraintsCollection
    ...
    @property
    def design_constraints(self) -> '_884.DesignConstraintsCollection':
        ...
        return constructor.new(_884.DesignConstraintsCollection)(self.wrapped.DesignConstraints) if self.wrapped.DesignConstraints else None
