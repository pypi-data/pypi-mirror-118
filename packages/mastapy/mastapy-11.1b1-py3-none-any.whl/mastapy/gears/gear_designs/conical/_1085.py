...
class ConicalGearSetDesign(_888.GearSetDesign):
    '''ConicalGearSetDesign
    ...
    @property
    def conical_meshes(self) -> 'List[_1084.ConicalGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConicalMeshes, constructor.new(_1084.ConicalGearMeshDesign))
        return value
