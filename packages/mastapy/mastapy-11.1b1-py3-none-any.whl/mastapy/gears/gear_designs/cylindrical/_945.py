...
class CylindricalGearAbstractRackFlank(_0.APIBase):
    ...
    @property
    def cutter(self) -> '_944.CylindricalGearAbstractRack':
        ...
        if _944.CylindricalGearAbstractRack.TYPE not in self.wrapped.Cutter.__class__.__mro__:
    ...
    @property
    def cutter_of_type_cylindrical_gear_basic_rack(self) -> '_946.CylindricalGearBasicRack':
        ...
        if _946.CylindricalGearBasicRack.TYPE not in self.wrapped.Cutter.__class__.__mro__:
    ...
    @property
    def cutter_of_type_cylindrical_gear_pinion_type_cutter(self) -> '_960.CylindricalGearPinionTypeCutter':
        ...
        if _960.CylindricalGearPinionTypeCutter.TYPE not in self.wrapped.Cutter.__class__.__mro__:
    ...
    @property
    def cutter_of_type_standard_rack(self) -> '_1012.StandardRack':
        ...
        if _1012.StandardRack.TYPE not in self.wrapped.Cutter.__class__.__mro__:
