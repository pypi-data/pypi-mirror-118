...
class CylindricalGearTableWithMGCharts(_1534.CustomTable):
    '''CylindricalGearTableWithMGCharts
    ...
    @property
    def item_detail(self) -> '_969.CylindricalGearTableMGItemDetail':
        ...
        return constructor.new(_969.CylindricalGearTableMGItemDetail)(value) if value else None

    @item_detail.setter
    def item_detail(self, value: '_969.CylindricalGearTableMGItemDetail'):
