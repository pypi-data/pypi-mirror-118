...
class CylindricalGearAbstractRack(_0.APIBase):
    ...
    @property
    def gear(self) -> '_950.CylindricalGearDesign':
        ...
        if _950.CylindricalGearDesign.TYPE not in self.wrapped.Gear.__class__.__mro__:
    ...
    @property
    def shaper_for_agma_rating(self) -> '_684.CylindricalGearShaper':
        ...
        return constructor.new(_684.CylindricalGearShaper)(self.wrapped.ShaperForAGMARating) if self.wrapped.ShaperForAGMARating else None

    @property
    def left_flank(self) -> '_945.CylindricalGearAbstractRackFlank':
        ...
        if _945.CylindricalGearAbstractRackFlank.TYPE not in self.wrapped.LeftFlank.__class__.__mro__:
    ...
    @property
    def left_flank_of_type_cylindrical_gear_basic_rack_flank(self) -> '_947.CylindricalGearBasicRackFlank':
        ...
        if _947.CylindricalGearBasicRackFlank.TYPE not in self.wrapped.LeftFlank.__class__.__mro__:
    ...
    @property
    def left_flank_of_type_cylindrical_gear_pinion_type_cutter_flank(self) -> '_961.CylindricalGearPinionTypeCutterFlank':
        ...
        if _961.CylindricalGearPinionTypeCutterFlank.TYPE not in self.wrapped.LeftFlank.__class__.__mro__:
    ...
    @property
    def left_flank_of_type_standard_rack_flank(self) -> '_1013.StandardRackFlank':
        ...
        if _1013.StandardRackFlank.TYPE not in self.wrapped.LeftFlank.__class__.__mro__:
    ...
    @property
    def right_flank(self) -> '_945.CylindricalGearAbstractRackFlank':
        ...
        if _945.CylindricalGearAbstractRackFlank.TYPE not in self.wrapped.RightFlank.__class__.__mro__:
    ...
    @property
    def right_flank_of_type_cylindrical_gear_basic_rack_flank(self) -> '_947.CylindricalGearBasicRackFlank':
        ...
        if _947.CylindricalGearBasicRackFlank.TYPE not in self.wrapped.RightFlank.__class__.__mro__:
    ...
    @property
    def right_flank_of_type_cylindrical_gear_pinion_type_cutter_flank(self) -> '_961.CylindricalGearPinionTypeCutterFlank':
        ...
        if _961.CylindricalGearPinionTypeCutterFlank.TYPE not in self.wrapped.RightFlank.__class__.__mro__:
    ...
    @property
    def right_flank_of_type_standard_rack_flank(self) -> '_1013.StandardRackFlank':
        ...
        if _1013.StandardRackFlank.TYPE not in self.wrapped.RightFlank.__class__.__mro__:
    ...
    @property
    def flanks(self) -> 'List[_945.CylindricalGearAbstractRackFlank]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Flanks, constructor.new(_945.CylindricalGearAbstractRackFlank))
        return value

    @property
    def both_flanks(self) -> '_945.CylindricalGearAbstractRackFlank':
        ...
        if _945.CylindricalGearAbstractRackFlank.TYPE not in self.wrapped.BothFlanks.__class__.__mro__:
    ...
    @property
    def both_flanks_of_type_cylindrical_gear_basic_rack_flank(self) -> '_947.CylindricalGearBasicRackFlank':
        ...
        if _947.CylindricalGearBasicRackFlank.TYPE not in self.wrapped.BothFlanks.__class__.__mro__:
    ...
    @property
    def both_flanks_of_type_cylindrical_gear_pinion_type_cutter_flank(self) -> '_961.CylindricalGearPinionTypeCutterFlank':
        ...
        if _961.CylindricalGearPinionTypeCutterFlank.TYPE not in self.wrapped.BothFlanks.__class__.__mro__:
    ...
    @property
    def both_flanks_of_type_standard_rack_flank(self) -> '_1013.StandardRackFlank':
        ...
        if _1013.StandardRackFlank.TYPE not in self.wrapped.BothFlanks.__class__.__mro__:
