...
from mastapy.gears.gear_designs.cylindrical import _951
...
class CylindricalGearDesignConstraints(_1577.NamedDatabaseItem):
    '''CylindricalGearDesignConstraints
    ...
    @property
    def design_constraints(self) -> 'List[_951.CylindricalGearDesignConstraint]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DesignConstraints, constructor.new(_951.CylindricalGearDesignConstraint))
        return value
