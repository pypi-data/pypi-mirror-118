...
class LtcaSettings(_1364.IndependentReportablePropertiesBase['LtcaSettings']):
    '''LtcaSettings
    ...
    @property
    def load_case_modifiable_settings(self) -> '_996.LTCALoadCaseModifiableSettings':
        ...
        return constructor.new(_996.LTCALoadCaseModifiableSettings)(self.wrapped.LoadCaseModifiableSettings) if self.wrapped.LoadCaseModifiableSettings else None
