...
from mastapy.gears.gear_designs.cylindrical import _989, _990
...
class CaseHardeningProperties(_0.APIBase):
    ...
    @property
    def hardness_profile_calculation_method(self) -> '_989.HardnessProfileCalculationMethod':
        ...
        return constructor.new(_989.HardnessProfileCalculationMethod)(value) if value else None

    @hardness_profile_calculation_method.setter
    def hardness_profile_calculation_method(self, value: '_989.HardnessProfileCalculationMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.HardnessProfileCalculationMethod = value

    @property
    def heat_treatment_type(self) -> '_990.HeatTreatmentType':
        ...
        return constructor.new(_990.HeatTreatmentType)(value) if value else None
