...
from mastapy.gears.gear_two_d_fe_analysis import _838
...
class CylindricalGearSetMicroGeometryDutyCycle(_1156.GearSetImplementationAnalysisDutyCycle):
    '''CylindricalGearSetMicroGeometryDutyCycle
    ...
    @property
    def tiff_analysis(self) -> '_838.CylindricalGearSetTIFFAnalysisDutyCycle':
        ...
        return constructor.new(_838.CylindricalGearSetTIFFAnalysisDutyCycle)(self.wrapped.TIFFAnalysis) if self.wrapped.TIFFAnalysis else None

    @property
    def meshes(self) -> 'List[_1033.CylindricalGearMeshMicroGeometryDutyCycle]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Meshes, constructor.new(_1033.CylindricalGearMeshMicroGeometryDutyCycle))
        return value
