...
class CylindricalGearMicroGeometryDutyCycle(_1144.GearDesignAnalysis):
    '''CylindricalGearMicroGeometryDutyCycle
    ...
    @property
    def tiff_analysis(self) -> '_840.CylindricalGearTIFFAnalysisDutyCycle':
        ...
        return constructor.new(_840.CylindricalGearTIFFAnalysisDutyCycle)(self.wrapped.TIFFAnalysis) if self.wrapped.TIFFAnalysis else None
