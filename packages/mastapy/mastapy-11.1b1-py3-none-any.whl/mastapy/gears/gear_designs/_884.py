...
from mastapy.utility.property import _1583
from mastapy.gears.gear_designs import _882
...
class DesignConstraintsCollection(_1577.NamedDatabaseItem):
    '''DesignConstraintsCollection
    ...
    @property
    def design_constraints(self) -> 'List[_1583.DeletableCollectionMember[_882.DesignConstraint]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DesignConstraints, constructor.new(_1583.DeletableCollectionMember)[_882.DesignConstraint])
        return value
