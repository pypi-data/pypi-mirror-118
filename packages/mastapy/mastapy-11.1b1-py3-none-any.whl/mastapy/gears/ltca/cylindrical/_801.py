...
from mastapy.gears.gear_two_d_fe_analysis import _837
...
class CylindricalGearSetLoadDistributionAnalysis(_788.GearSetLoadDistributionAnalysis):
    '''CylindricalGearSetLoadDistributionAnalysis
    ...
    @property
    def tiff_analysis(self) -> '_837.CylindricalGearSetTIFFAnalysis':
        ...
        return constructor.new(_837.CylindricalGearSetTIFFAnalysis)(self.wrapped.TIFFAnalysis) if self.wrapped.TIFFAnalysis else None

    @property
    def meshes(self) -> 'List[_798.CylindricalGearMeshLoadDistributionAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Meshes, constructor.new(_798.CylindricalGearMeshLoadDistributionAnalysis))
        return value
