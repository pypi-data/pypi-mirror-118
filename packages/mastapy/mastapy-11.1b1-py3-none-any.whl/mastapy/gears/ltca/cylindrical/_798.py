...
from mastapy.gears.ltca import _778, _784
from mastapy.gears.ltca.cylindrical import _800, _802
...
class CylindricalGearMeshLoadDistributionAnalysis(_784.GearMeshLoadDistributionAnalysis):
    '''CylindricalGearMeshLoadDistributionAnalysis
    ...
    @property
    def cylindrical_mesh_load_case(self) -> '_825.CylindricalMeshLoadCase':
        ...
        return constructor.new(_825.CylindricalMeshLoadCase)(self.wrapped.CylindricalMeshLoadCase) if self.wrapped.CylindricalMeshLoadCase else None

    @property
    def gear_a_in_mesh(self) -> '_778.CylindricalMeshedGearLoadDistributionAnalysis':
        ...
        return constructor.new(_778.CylindricalMeshedGearLoadDistributionAnalysis)(self.wrapped.GearAInMesh) if self.wrapped.GearAInMesh else None

    @property
    def gear_b_in_mesh(self) -> '_778.CylindricalMeshedGearLoadDistributionAnalysis':
        ...
        return constructor.new(_778.CylindricalMeshedGearLoadDistributionAnalysis)(self.wrapped.GearBInMesh) if self.wrapped.GearBInMesh else None
    ...
    @property
    def load_distribution_analyses_at_single_rotation(self) -> 'List[_802.CylindricalMeshLoadDistributionAtRotation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadDistributionAnalysesAtSingleRotation, constructor.new(_802.CylindricalMeshLoadDistributionAtRotation))
        return value

    @property
    def meshed_gears(self) -> 'List[_778.CylindricalMeshedGearLoadDistributionAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshedGears, constructor.new(_778.CylindricalMeshedGearLoadDistributionAnalysis))
        return value
