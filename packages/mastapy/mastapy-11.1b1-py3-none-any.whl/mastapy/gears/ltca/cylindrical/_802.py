...
class CylindricalMeshLoadDistributionAtRotation(_785.GearMeshLoadDistributionAtRotation):
    '''CylindricalMeshLoadDistributionAtRotation
    ...
    @property
    def mesh_alignment(self) -> '_1050.MeshAlignment':
        ...
        return constructor.new(_1050.MeshAlignment)(self.wrapped.MeshAlignment) if self.wrapped.MeshAlignment else None

    @property
    def loaded_contact_lines(self) -> 'List[_799.CylindricalGearMeshLoadedContactLine]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadedContactLines, constructor.new(_799.CylindricalGearMeshLoadedContactLine))
        return value
