...
class PlasticSNCurve(_0.APIBase):
    ...
    @property
    def material(self) -> '_555.PlasticCylindricalGearMaterial':
        ...
        return constructor.new(_555.PlasticCylindricalGearMaterial)(self.wrapped.Material) if self.wrapped.Material else None
