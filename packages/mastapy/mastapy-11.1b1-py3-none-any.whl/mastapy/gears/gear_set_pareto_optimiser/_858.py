...
class MicroGeometryDesignSpaceSearchCandidate(_848.DesignSpaceSearchCandidateBase['_801.CylindricalGearSetLoadDistributionAnalysis', 'MicroGeometryDesignSpaceSearchCandidate']):
    '''MicroGeometryDesignSpaceSearchCandidate
    ...
    @property
    def candidate(self) -> '_801.CylindricalGearSetLoadDistributionAnalysis':
        ...
        if _801.CylindricalGearSetLoadDistributionAnalysis.TYPE not in self.wrapped.Candidate.__class__.__mro__:
    ...
    @property
    def candidate_for_slider(self) -> '_1039.CylindricalGearSetMicroGeometry':
        ...
        return constructor.new(_1039.CylindricalGearSetMicroGeometry)(self.wrapped.CandidateForSlider) if self.wrapped.CandidateForSlider else None
