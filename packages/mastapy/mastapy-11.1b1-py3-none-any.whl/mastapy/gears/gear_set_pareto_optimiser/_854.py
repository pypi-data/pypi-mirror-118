...
class HypoidGearSetParetoOptimiser(_853.GearSetParetoOptimiser):
    '''HypoidGearSetParetoOptimiser
    ...
    @property
    def selected_candidate_geometry(self) -> '_925.HypoidGearSetDesign':
        ...
        return constructor.new(_925.HypoidGearSetDesign)(self.wrapped.SelectedCandidateGeometry) if self.wrapped.SelectedCandidateGeometry else None

    @property
    def candidate_gear_sets(self) -> 'List[_925.HypoidGearSetDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CandidateGearSets, constructor.new(_925.HypoidGearSetDesign))
        return value

    @property
    def all_candidate_gear_sets(self) -> 'List[_925.HypoidGearSetDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AllCandidateGearSets, constructor.new(_925.HypoidGearSetDesign))
        return value
