...
from mastapy.math_utility.optimisation import _1330, _1321, _1327
...
class DesignSpaceSearchBase(_0.APIBase, Generic[TAnalysis, TCandidate]):
    ...
    @property
    def remove_candidates_with(self) -> '_856.LargerOrSmaller':
        ...
        return constructor.new(_856.LargerOrSmaller)(value) if value else None

    @remove_candidates_with.setter
    def remove_candidates_with(self, value: '_856.LargerOrSmaller'):
    ...
    @property
    def selected_design_space_search_strategy(self) -> '_1330.ParetoOptimisationStrategy':
        ...
        return constructor.new(_1330.ParetoOptimisationStrategy)(self.wrapped.SelectedDesignSpaceSearchStrategy) if self.wrapped.SelectedDesignSpaceSearchStrategy else None

    @property
    def optimisation_targets(self) -> 'List[_863.OptimisationTarget[TAnalysis]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.OptimisationTargets, constructor.new(_863.OptimisationTarget)[TAnalysis])
        return value

    @property
    def input_setters(self) -> 'List[_1321.InputSetter[TAnalysis]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.InputSetters, constructor.new(_1321.InputSetter)[TAnalysis])
        return value

    @property
    def table_filters(self) -> 'List[_881.TableFilter[TAnalysis, TCandidate]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.TableFilters, constructor.new(_881.TableFilter)[TAnalysis, TCandidate])
        return value
    ...
    @property
    def chart_details(self) -> 'List[_845.ChartInfoBase[TAnalysis, TCandidate]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ChartDetails, constructor.new(_845.ChartInfoBase)[TAnalysis, TCandidate])
        return value
    ...
    @property
    def reasons_for_invalid_candidates(self) -> 'List[_878.ReasonsForInvalidDesigns]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ReasonsForInvalidCandidates, constructor.new(_878.ReasonsForInvalidDesigns))
        return value

    @property
    def filters(self) -> 'List[_1327.ParetoOptimisationFilter]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Filters, constructor.new(_1327.ParetoOptimisationFilter))
        return value
