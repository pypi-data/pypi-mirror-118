...
class SpiralBevelGearSetParetoOptimiser(_853.GearSetParetoOptimiser):
    '''SpiralBevelGearSetParetoOptimiser
    ...
    @property
    def selected_candidate_geometry(self) -> '_909.SpiralBevelGearSetDesign':
        ...
        return constructor.new(_909.SpiralBevelGearSetDesign)(self.wrapped.SelectedCandidateGeometry) if self.wrapped.SelectedCandidateGeometry else None

    @property
    def candidate_gear_sets(self) -> 'List[_909.SpiralBevelGearSetDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CandidateGearSets, constructor.new(_909.SpiralBevelGearSetDesign))
        return value

    @property
    def all_candidate_gear_sets(self) -> 'List[_909.SpiralBevelGearSetDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AllCandidateGearSets, constructor.new(_909.SpiralBevelGearSetDesign))
        return value
