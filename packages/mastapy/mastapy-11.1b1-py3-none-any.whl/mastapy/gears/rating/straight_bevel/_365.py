...
class StraightBevelGearRating(_507.BevelGearRating):
    '''StraightBevelGearRating
    ...
    @property
    def straight_bevel_gear(self) -> '_903.StraightBevelGearDesign':
        ...
        return constructor.new(_903.StraightBevelGearDesign)(self.wrapped.StraightBevelGear) if self.wrapped.StraightBevelGear else None
