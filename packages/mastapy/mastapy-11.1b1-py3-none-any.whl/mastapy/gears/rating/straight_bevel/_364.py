...
class StraightBevelGearMeshRating(_506.BevelGearMeshRating):
    '''StraightBevelGearMeshRating
    ...
    @property
    def straight_bevel_gear_mesh(self) -> '_904.StraightBevelGearMeshDesign':
        ...
        return constructor.new(_904.StraightBevelGearMeshDesign)(self.wrapped.StraightBevelGearMesh) if self.wrapped.StraightBevelGearMesh else None
