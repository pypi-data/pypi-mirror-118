...
class StraightBevelDiffGearMeshRating(_491.ConicalGearMeshRating):
    '''StraightBevelDiffGearMeshRating
    ...
    @property
    def straight_bevel_diff_gear_mesh(self) -> '_900.StraightBevelDiffGearMeshDesign':
        ...
        return constructor.new(_900.StraightBevelDiffGearMeshDesign)(self.wrapped.StraightBevelDiffGearMesh) if self.wrapped.StraightBevelDiffGearMesh else None
