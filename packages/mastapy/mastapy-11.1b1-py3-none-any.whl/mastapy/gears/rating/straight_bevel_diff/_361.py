...
class StraightBevelDiffGearRating(_492.ConicalGearRating):
    ...
    @property
    def straight_bevel_diff_gear(self) -> '_899.StraightBevelDiffGearDesign':
        ...
        return constructor.new(_899.StraightBevelDiffGearDesign)(self.wrapped.StraightBevelDiffGear) if self.wrapped.StraightBevelDiffGear else None
