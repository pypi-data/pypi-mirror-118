...
from mastapy.gears.gear_designs.cylindrical import _1007, _1006
...
class CylindricalMeshSingleFlankRating(_331.MeshSingleFlankRating):
    ...
    @property
    def coefficient_of_friction_method_flash_temperature_method(self) -> '_1007.ScuffingCoefficientOfFrictionMethods':
        ...
        return constructor.new(_1007.ScuffingCoefficientOfFrictionMethods)(value) if value else None
