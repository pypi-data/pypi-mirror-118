...
class ConicalMeshDutyCycleRating(_330.MeshDutyCycleRating):
    '''ConicalMeshDutyCycleRating
    ...
    @property
    def conical_mesh_ratings(self) -> 'List[_491.ConicalGearMeshRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConicalMeshRatings, constructor.new(_491.ConicalGearMeshRating))
        return value
