...
class SpiralBevelGearSetRating(_508.BevelGearSetRating):
    '''SpiralBevelGearSetRating
    ...
    @property
    def spiral_bevel_gear_set(self) -> '_909.SpiralBevelGearSetDesign':
        ...
        return constructor.new(_909.SpiralBevelGearSetDesign)(self.wrapped.SpiralBevelGearSet) if self.wrapped.SpiralBevelGearSet else None
