...
class SpiralBevelGearMeshRating(_506.BevelGearMeshRating):
    '''SpiralBevelGearMeshRating
    ...
    @property
    def spiral_bevel_gear_mesh(self) -> '_908.SpiralBevelGearMeshDesign':
        ...
        return constructor.new(_908.SpiralBevelGearMeshDesign)(self.wrapped.SpiralBevelGearMesh) if self.wrapped.SpiralBevelGearMesh else None
