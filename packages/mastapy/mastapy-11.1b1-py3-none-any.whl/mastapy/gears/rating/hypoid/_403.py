...
class HypoidGearMeshRating(_517.AGMAGleasonConicalGearMeshRating):
    '''HypoidGearMeshRating
    ...
    @property
    def hypoid_gear_mesh(self) -> '_924.HypoidGearMeshDesign':
        ...
        return constructor.new(_924.HypoidGearMeshDesign)(self.wrapped.HypoidGearMesh) if self.wrapped.HypoidGearMesh else None
    ...
    @property
    def gears_in_mesh(self) -> 'List[_497.ConicalMeshedGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearsInMesh, constructor.new(_497.ConicalMeshedGearRating))
        return value
