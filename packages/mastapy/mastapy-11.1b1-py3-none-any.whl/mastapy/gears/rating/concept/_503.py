...
class ConceptGearRating(_326.GearRating):
    ...
    @property
    def concept_gear(self) -> '_1105.ConceptGearDesign':
        ...
        return constructor.new(_1105.ConceptGearDesign)(self.wrapped.ConceptGear) if self.wrapped.ConceptGear else None
