...
class FaceGearMeshRating(_325.GearMeshRating):
    ...
    @property
    def mesh_load_case(self) -> '_822.FaceMeshLoadCase':
        ...
        return constructor.new(_822.FaceMeshLoadCase)(self.wrapped.MeshLoadCase) if self.wrapped.MeshLoadCase else None
    ...
    @property
    def face_gear_mesh(self) -> '_929.FaceGearMeshDesign':
        ...
        return constructor.new(_929.FaceGearMeshDesign)(self.wrapped.FaceGearMesh) if self.wrapped.FaceGearMesh else None
