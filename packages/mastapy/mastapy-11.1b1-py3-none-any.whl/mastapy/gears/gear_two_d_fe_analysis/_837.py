...
class CylindricalGearSetTIFFAnalysis(_1152.GearSetDesignAnalysis):
    '''CylindricalGearSetTIFFAnalysis
    ...
    @property
    def gears(self) -> 'List[_839.CylindricalGearTIFFAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_839.CylindricalGearTIFFAnalysis))
        return value
