...
class BoltGeometry(_1577.NamedDatabaseItem):
    '''BoltGeometry
    ...
    @property
    def standard_size(self) -> '_1264.StandardSizes':
        '''StandardSizes: 'StandardSize' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.StandardSize)
        return constructor.new(_1264.StandardSizes)(value) if value else None

    @standard_size.setter
    def standard_size(self, value: '_1264.StandardSizes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.StandardSize = value

    @property
    def bolt_sections(self) -> 'List[_1252.BoltSection]':
        '''List[BoltSection]: 'BoltSections' is the original name of this property.'''

        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BoltSections, constructor.new(_1252.BoltSection))
        return value

    @bolt_sections.setter
    def bolt_sections(self, value: 'List[_1252.BoltSection]'):
        value = value if value else None
    ...
    @property
    def bolt_shank_type(self) -> '_1253.BoltShankType':
        ...
        return constructor.new(_1253.BoltShankType)(value) if value else None

    @bolt_shank_type.setter
    def bolt_shank_type(self, value: '_1253.BoltShankType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def type_of_head_cap(self) -> '_1259.HeadCapTypes':
        ...
        return constructor.new(_1259.HeadCapTypes)(value) if value else None

    @type_of_head_cap.setter
    def type_of_head_cap(self, value: '_1259.HeadCapTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.TypeOfHeadCap = value

    @property
    def type_of_thread(self) -> '_1266.ThreadTypes':
        '''ThreadTypes: 'TypeOfThread' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.TypeOfThread)
        return constructor.new(_1266.ThreadTypes)(value) if value else None

    @type_of_thread.setter
    def type_of_thread(self, value: '_1266.ThreadTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def type_of_bolted_joint(self) -> '_1254.BoltTypes':
        ...
        return constructor.new(_1254.BoltTypes)(value) if value else None

    @type_of_bolted_joint.setter
    def type_of_bolted_joint(self, value: '_1254.BoltTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
