...
from mastapy.bolts import _1246, _1250
...
class ClampedSection(_0.APIBase):
    ...
    @property
    def material(self) -> '_1246.BoltedJointMaterial':
        ...
        if _1246.BoltedJointMaterial.TYPE not in self.wrapped.Material.__class__.__mro__:
