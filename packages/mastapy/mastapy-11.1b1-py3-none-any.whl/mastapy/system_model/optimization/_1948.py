...
from mastapy.system_model.optimization import _1949, _1947
...
TStep = TypeVar('TStep', bound='_1947.OptimizationStep')


class OptimizationStrategy(_1949.OptimizationStrategyBase, Generic[TStep]):
    '''OptimizationStrategy
