...
from mastapy.system_model.optimization import _1945
...
class CylindricalGearSetOptimizer(_0.APIBase):
    ...
    @property
    def constraints(self) -> 'List[_1945.MeasuredAndFactorViewModel]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Constraints, constructor.new(_1945.MeasuredAndFactorViewModel))
        return value
