...
from mastapy.system_model.fe import _2095, _2098
...
class FESubstructureWithSelectionForModalAnalysis(_2098.FESubstructureWithSelection):
    '''FESubstructureWithSelectionForModalAnalysis
    ...
    @property
    def full_fe_mode_shapes_at_condensation_nodes(self) -> 'List[_2095.FESubstructureNodeModeShapes]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FullFEModeShapesAtCondensationNodes, constructor.new(_2095.FESubstructureNodeModeShapes))
        return value
