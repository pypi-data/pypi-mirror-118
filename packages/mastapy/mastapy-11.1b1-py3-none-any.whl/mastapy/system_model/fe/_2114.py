...
from mastapy.system_model.fe import _2066, _2073
...
class RaceBearingFE(_0.APIBase):
    ...
    @property
    def alignment_method(self) -> '_2066.AlignmentMethodForRaceBearing':
        ...
        return constructor.new(_2066.AlignmentMethodForRaceBearing)(value) if value else None

    @alignment_method.setter
    def alignment_method(self, value: '_2066.AlignmentMethodForRaceBearing'):
    ...
    @property
    def links(self) -> 'List[_2073.BearingRaceNodeLink]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Links, constructor.new(_2073.BearingRaceNodeLink))
        return value
