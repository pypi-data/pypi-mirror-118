...
from mastapy.system_model.fe.links import _2128
from mastapy.system_model.fe import (
    _2085, _2107, _2077, _2076,
    _2098
)
...
class FESubstructureWithSelectionComponents(_2098.FESubstructureWithSelection):
    '''FESubstructureWithSelectionComponents
    ...
    @property
    def component_links(self) -> 'List[_2128.FELinkWithSelection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentLinks, constructor.new(_2128.FELinkWithSelection))
        return value

    @property
    def links_for_selected_component(self) -> 'List[_2128.FELinkWithSelection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LinksForSelectedComponent, constructor.new(_2128.FELinkWithSelection))
        return value

    @property
    def links_for_electric_machine(self) -> 'List[_2128.FELinkWithSelection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LinksForElectricMachine, constructor.new(_2128.FELinkWithSelection))
        return value

    @property
    def rigid_element_properties(self) -> 'List[_2085.ElementPropertiesWithSelection[_185.ElementPropertiesRigid]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RigidElementProperties, constructor.new(_2085.ElementPropertiesWithSelection)[_185.ElementPropertiesRigid])
        return value

    @property
    def solid_element_properties(self) -> 'List[_2085.ElementPropertiesWithSelection[_187.ElementPropertiesSolid]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SolidElementProperties, constructor.new(_2085.ElementPropertiesWithSelection)[_187.ElementPropertiesSolid])
        return value

    @property
    def shell_element_properties(self) -> 'List[_2085.ElementPropertiesWithSelection[_186.ElementPropertiesShell]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShellElementProperties, constructor.new(_2085.ElementPropertiesWithSelection)[_186.ElementPropertiesShell])
        return value

    @property
    def beam_element_properties(self) -> 'List[_2085.ElementPropertiesWithSelection[_182.ElementPropertiesBeam]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BeamElementProperties, constructor.new(_2085.ElementPropertiesWithSelection)[_182.ElementPropertiesBeam])
        return value

    @property
    def spring_dashpot_element_properties(self) -> 'List[_2085.ElementPropertiesWithSelection[_188.ElementPropertiesSpringDashpot]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpringDashpotElementProperties, constructor.new(_2085.ElementPropertiesWithSelection)[_188.ElementPropertiesSpringDashpot])
        return value

    @property
    def mass_element_properties(self) -> 'List[_2085.ElementPropertiesWithSelection[_184.ElementPropertiesMass]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MassElementProperties, constructor.new(_2085.ElementPropertiesWithSelection)[_184.ElementPropertiesMass])
        return value

    @property
    def interface_element_properties(self) -> 'List[_2085.ElementPropertiesWithSelection[_183.ElementPropertiesInterface]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.InterfaceElementProperties, constructor.new(_2085.ElementPropertiesWithSelection)[_183.ElementPropertiesInterface])
        return value

    @property
    def other_element_properties(self) -> 'List[_2085.ElementPropertiesWithSelection[_181.ElementPropertiesBase]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.OtherElementProperties, constructor.new(_2085.ElementPropertiesWithSelection)[_181.ElementPropertiesBase])
        return value

    @property
    def materials(self) -> 'List[_2107.MaterialPropertiesWithSelection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Materials, constructor.new(_2107.MaterialPropertiesWithSelection))
        return value

    @property
    def coordinate_systems(self) -> 'List[_2077.CoordinateSystemWithSelection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CoordinateSystems, constructor.new(_2077.CoordinateSystemWithSelection))
        return value

    @property
    def contact_pairs(self) -> 'List[_2076.ContactPairWithSelection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ContactPairs, constructor.new(_2076.ContactPairWithSelection))
        return value
