...
class GearMeshingOptions(_0.APIBase):
    ...
    @property
    def element_settings(self) -> '_1128.GearMeshingElementOptions':
        ...
        return constructor.new(_1128.GearMeshingElementOptions)(self.wrapped.ElementSettings) if self.wrapped.ElementSettings else None
