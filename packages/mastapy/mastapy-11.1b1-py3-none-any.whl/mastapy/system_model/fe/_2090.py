...
class FEStiffnessTester(_0.APIBase):
    ...
    @property
    def fe_stiffness(self) -> '_2091.FESubstructure':
        ...
        return constructor.new(_2091.FESubstructure)(self.wrapped.FEStiffness) if self.wrapped.FEStiffness else None

    @property
    def force_and_displacement_results(self) -> 'List[_1341.ForceAndDisplacementResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ForceAndDisplacementResults, constructor.new(_1341.ForceAndDisplacementResults))
        return value
