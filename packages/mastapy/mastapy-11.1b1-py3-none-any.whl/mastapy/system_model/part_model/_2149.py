...
from mastapy.bearings.tolerances import (
    _1630, _1631, _1633, _1644,
    _1639, _1647, _1634, _1648,
    _1640, _1650
)
from mastapy._internal.overridable_constructor import _unpack_overridable
from mastapy.bearings.bearing_results import _1685, _1686, _1668
from mastapy.bearings import (
    _1607, _1614, _1603, _1599
)
from mastapy._internal.python_net import python_net_import
from mastapy.materials.efficiency import _260
from mastapy._internal.cast_exception import CastException
from mastapy.bearings.bearing_designs import (
    _1848, _1849, _1850, _1851,
    _1852
)
from mastapy.bearings.bearing_designs.rolling import (
    _1853, _1854, _1855, _1856,
    _1857, _1858, _1860, _1865,
    _1866, _1867, _1869, _1874,
    _1875, _1876, _1877, _1880,
    _1881, _1884, _1885, _1886,
    _1887, _1888, _1889
)
from mastapy.bearings.bearing_designs.fluid_film import (
    _1902, _1904, _1906, _1908,
    _1909, _1910
)
from mastapy.bearings.bearing_designs.concept import _1912, _1913, _1914
from mastapy.system_model.part_model import (
    _2148, _2181, _2150, _2154,
    _2156
)
from mastapy.materials import _237
from mastapy.bearings.bearing_results.rolling import _1790
...
class Bearing(_2156.Connector):
    ...
    @property
    def bearing_tolerance_definition(self) -> '_1631.BearingToleranceDefinitionOptions':
        ...
        return constructor.new(_1631.BearingToleranceDefinitionOptions)(value) if value else None

    @bearing_tolerance_definition.setter
    def bearing_tolerance_definition(self, value: '_1631.BearingToleranceDefinitionOptions'):
    ...
    @property
    def journal_bearing_type(self) -> '_1614.JournalBearingType':
        ...
        return constructor.new(_1614.JournalBearingType)(value) if value else None

    @journal_bearing_type.setter
    def journal_bearing_type(self, value: '_1614.JournalBearingType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def damping_options(self) -> '_1603.BearingDampingMatrixOption':
        ...
        return constructor.new(_1603.BearingDampingMatrixOption)(value) if value else None

    @damping_options.setter
    def damping_options(self, value: '_1603.BearingDampingMatrixOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def ring_tolerance_inner(self) -> '_1633.InnerRingTolerance':
        ...
        return constructor.new(_1633.InnerRingTolerance)(self.wrapped.RingToleranceInner) if self.wrapped.RingToleranceInner else None

    @property
    def ring_tolerance_left(self) -> '_1644.RingTolerance':
        ...
        if _1644.RingTolerance.TYPE not in self.wrapped.RingToleranceLeft.__class__.__mro__:
    ...
    @property
    def ring_tolerance_left_of_type_inner_ring_tolerance(self) -> '_1633.InnerRingTolerance':
        ...
        if _1633.InnerRingTolerance.TYPE not in self.wrapped.RingToleranceLeft.__class__.__mro__:
    ...
    @property
    def ring_tolerance_left_of_type_outer_ring_tolerance(self) -> '_1639.OuterRingTolerance':
        ...
        if _1639.OuterRingTolerance.TYPE not in self.wrapped.RingToleranceLeft.__class__.__mro__:
    ...
    @property
    def ring_tolerance_outer(self) -> '_1639.OuterRingTolerance':
        ...
        return constructor.new(_1639.OuterRingTolerance)(self.wrapped.RingToleranceOuter) if self.wrapped.RingToleranceOuter else None

    @property
    def ring_tolerance_right(self) -> '_1644.RingTolerance':
        ...
        if _1644.RingTolerance.TYPE not in self.wrapped.RingToleranceRight.__class__.__mro__:
    ...
    @property
    def ring_tolerance_right_of_type_inner_ring_tolerance(self) -> '_1633.InnerRingTolerance':
        ...
        if _1633.InnerRingTolerance.TYPE not in self.wrapped.RingToleranceRight.__class__.__mro__:
    ...
    @property
    def ring_tolerance_right_of_type_outer_ring_tolerance(self) -> '_1639.OuterRingTolerance':
        ...
        if _1639.OuterRingTolerance.TYPE not in self.wrapped.RingToleranceRight.__class__.__mro__:
    ...
    @property
    def inner_support_detail(self) -> '_1647.SupportDetail':
        ...
        return constructor.new(_1647.SupportDetail)(self.wrapped.InnerSupportDetail) if self.wrapped.InnerSupportDetail else None

    @property
    def left_support_detail(self) -> '_1647.SupportDetail':
        ...
        return constructor.new(_1647.SupportDetail)(self.wrapped.LeftSupportDetail) if self.wrapped.LeftSupportDetail else None

    @property
    def outer_support_detail(self) -> '_1647.SupportDetail':
        ...
        return constructor.new(_1647.SupportDetail)(self.wrapped.OuterSupportDetail) if self.wrapped.OuterSupportDetail else None

    @property
    def right_support_detail(self) -> '_1647.SupportDetail':
        ...
        return constructor.new(_1647.SupportDetail)(self.wrapped.RightSupportDetail) if self.wrapped.RightSupportDetail else None

    @property
    def support_tolerance_inner(self) -> '_1634.InnerSupportTolerance':
        ...
        return constructor.new(_1634.InnerSupportTolerance)(self.wrapped.SupportToleranceInner) if self.wrapped.SupportToleranceInner else None

    @property
    def support_tolerance_left(self) -> '_1648.SupportTolerance':
        ...
        if _1648.SupportTolerance.TYPE not in self.wrapped.SupportToleranceLeft.__class__.__mro__:
    ...
    @property
    def support_tolerance_left_of_type_inner_support_tolerance(self) -> '_1634.InnerSupportTolerance':
        ...
        if _1634.InnerSupportTolerance.TYPE not in self.wrapped.SupportToleranceLeft.__class__.__mro__:
    ...
    @property
    def support_tolerance_left_of_type_outer_support_tolerance(self) -> '_1640.OuterSupportTolerance':
        ...
        if _1640.OuterSupportTolerance.TYPE not in self.wrapped.SupportToleranceLeft.__class__.__mro__:
    ...
    @property
    def support_tolerance_outer(self) -> '_1640.OuterSupportTolerance':
        ...
        return constructor.new(_1640.OuterSupportTolerance)(self.wrapped.SupportToleranceOuter) if self.wrapped.SupportToleranceOuter else None

    @property
    def support_tolerance_right(self) -> '_1648.SupportTolerance':
        ...
        if _1648.SupportTolerance.TYPE not in self.wrapped.SupportToleranceRight.__class__.__mro__:
    ...
    @property
    def support_tolerance_right_of_type_inner_support_tolerance(self) -> '_1634.InnerSupportTolerance':
        ...
        if _1634.InnerSupportTolerance.TYPE not in self.wrapped.SupportToleranceRight.__class__.__mro__:
    ...
    @property
    def support_tolerance_right_of_type_outer_support_tolerance(self) -> '_1640.OuterSupportTolerance':
        ...
        if _1640.OuterSupportTolerance.TYPE not in self.wrapped.SupportToleranceRight.__class__.__mro__:
    ...
    @property
    def inner_mounting_sleeve_bore_tolerance(self) -> '_1640.OuterSupportTolerance':
        ...
        return constructor.new(_1640.OuterSupportTolerance)(self.wrapped.InnerMountingSleeveBoreTolerance) if self.wrapped.InnerMountingSleeveBoreTolerance else None

    @property
    def inner_mounting_sleeve_outer_diameter_tolerance(self) -> '_1634.InnerSupportTolerance':
        ...
        return constructor.new(_1634.InnerSupportTolerance)(self.wrapped.InnerMountingSleeveOuterDiameterTolerance) if self.wrapped.InnerMountingSleeveOuterDiameterTolerance else None

    @property
    def outer_mounting_sleeve_bore_tolerance(self) -> '_1640.OuterSupportTolerance':
        ...
        return constructor.new(_1640.OuterSupportTolerance)(self.wrapped.OuterMountingSleeveBoreTolerance) if self.wrapped.OuterMountingSleeveBoreTolerance else None

    @property
    def outer_mounting_sleeve_outer_diameter_tolerance(self) -> '_1634.InnerSupportTolerance':
        ...
        return constructor.new(_1634.InnerSupportTolerance)(self.wrapped.OuterMountingSleeveOuterDiameterTolerance) if self.wrapped.OuterMountingSleeveOuterDiameterTolerance else None

    @property
    def simple_bearing_detail_property(self) -> '_1848.BearingDesign':
        ...
        if _1848.BearingDesign.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_detailed_bearing(self) -> '_1849.DetailedBearing':
        ...
        if _1849.DetailedBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_dummy_rolling_bearing(self) -> '_1850.DummyRollingBearing':
        ...
        if _1850.DummyRollingBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_linear_bearing(self) -> '_1851.LinearBearing':
        ...
        if _1851.LinearBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_non_linear_bearing(self) -> '_1852.NonLinearBearing':
        ...
        if _1852.NonLinearBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_angular_contact_ball_bearing(self) -> '_1853.AngularContactBallBearing':
        ...
        if _1853.AngularContactBallBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_angular_contact_thrust_ball_bearing(self) -> '_1854.AngularContactThrustBallBearing':
        ...
        if _1854.AngularContactThrustBallBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_asymmetric_spherical_roller_bearing(self) -> '_1855.AsymmetricSphericalRollerBearing':
        ...
        if _1855.AsymmetricSphericalRollerBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_axial_thrust_cylindrical_roller_bearing(self) -> '_1856.AxialThrustCylindricalRollerBearing':
        ...
        if _1856.AxialThrustCylindricalRollerBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_axial_thrust_needle_roller_bearing(self) -> '_1857.AxialThrustNeedleRollerBearing':
        ...
        if _1857.AxialThrustNeedleRollerBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_ball_bearing(self) -> '_1858.BallBearing':
        ...
        if _1858.BallBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_barrel_roller_bearing(self) -> '_1860.BarrelRollerBearing':
        ...
        if _1860.BarrelRollerBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_crossed_roller_bearing(self) -> '_1865.CrossedRollerBearing':
        ...
        if _1865.CrossedRollerBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_cylindrical_roller_bearing(self) -> '_1866.CylindricalRollerBearing':
        ...
        if _1866.CylindricalRollerBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_deep_groove_ball_bearing(self) -> '_1867.DeepGrooveBallBearing':
        ...
        if _1867.DeepGrooveBallBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_four_point_contact_ball_bearing(self) -> '_1869.FourPointContactBallBearing':
        ...
        if _1869.FourPointContactBallBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_multi_point_contact_ball_bearing(self) -> '_1874.MultiPointContactBallBearing':
        ...
        if _1874.MultiPointContactBallBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_needle_roller_bearing(self) -> '_1875.NeedleRollerBearing':
        ...
        if _1875.NeedleRollerBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_non_barrel_roller_bearing(self) -> '_1876.NonBarrelRollerBearing':
        ...
        if _1876.NonBarrelRollerBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_roller_bearing(self) -> '_1877.RollerBearing':
        ...
        if _1877.RollerBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_rolling_bearing(self) -> '_1880.RollingBearing':
        ...
        if _1880.RollingBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_self_aligning_ball_bearing(self) -> '_1881.SelfAligningBallBearing':
        ...
        if _1881.SelfAligningBallBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_spherical_roller_bearing(self) -> '_1884.SphericalRollerBearing':
        ...
        if _1884.SphericalRollerBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_spherical_roller_thrust_bearing(self) -> '_1885.SphericalRollerThrustBearing':
        ...
        if _1885.SphericalRollerThrustBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_taper_roller_bearing(self) -> '_1886.TaperRollerBearing':
        ...
        if _1886.TaperRollerBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_three_point_contact_ball_bearing(self) -> '_1887.ThreePointContactBallBearing':
        ...
        if _1887.ThreePointContactBallBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_thrust_ball_bearing(self) -> '_1888.ThrustBallBearing':
        ...
        if _1888.ThrustBallBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_toroidal_roller_bearing(self) -> '_1889.ToroidalRollerBearing':
        ...
        if _1889.ToroidalRollerBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_pad_fluid_film_bearing(self) -> '_1902.PadFluidFilmBearing':
        ...
        if _1902.PadFluidFilmBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_plain_grease_filled_journal_bearing(self) -> '_1904.PlainGreaseFilledJournalBearing':
        ...
        if _1904.PlainGreaseFilledJournalBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_plain_journal_bearing(self) -> '_1906.PlainJournalBearing':
        ...
        if _1906.PlainJournalBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_plain_oil_fed_journal_bearing(self) -> '_1908.PlainOilFedJournalBearing':
        ...
        if _1908.PlainOilFedJournalBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_tilting_pad_journal_bearing(self) -> '_1909.TiltingPadJournalBearing':
        ...
        if _1909.TiltingPadJournalBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_tilting_pad_thrust_bearing(self) -> '_1910.TiltingPadThrustBearing':
        ...
        if _1910.TiltingPadThrustBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_concept_axial_clearance_bearing(self) -> '_1912.ConceptAxialClearanceBearing':
        ...
        if _1912.ConceptAxialClearanceBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_concept_clearance_bearing(self) -> '_1913.ConceptClearanceBearing':
        ...
        if _1913.ConceptClearanceBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def simple_bearing_detail_property_of_type_concept_radial_clearance_bearing(self) -> '_1914.ConceptRadialClearanceBearing':
        ...
        if _1914.ConceptRadialClearanceBearing.TYPE not in self.wrapped.SimpleBearingDetailProperty.__class__.__mro__:
    ...
    @property
    def detail(self) -> '_1848.BearingDesign':
        ...
        if _1848.BearingDesign.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_detailed_bearing(self) -> '_1849.DetailedBearing':
        ...
        if _1849.DetailedBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
            raise CastException('Failed to cast detail to DetailedBearing. Expected: {}.'.format(self.wrapped.Detail.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Detail.__class__)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_dummy_rolling_bearing(self) -> '_1850.DummyRollingBearing':
        ...
        if _1850.DummyRollingBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_linear_bearing(self) -> '_1851.LinearBearing':
        ...
        if _1851.LinearBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
            raise CastException('Failed to cast detail to LinearBearing. Expected: {}.'.format(self.wrapped.Detail.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Detail.__class__)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_non_linear_bearing(self) -> '_1852.NonLinearBearing':
        ...
        if _1852.NonLinearBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
            raise CastException('Failed to cast detail to NonLinearBearing. Expected: {}.'.format(self.wrapped.Detail.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Detail.__class__)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_angular_contact_ball_bearing(self) -> '_1853.AngularContactBallBearing':
        ...
        if _1853.AngularContactBallBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_angular_contact_thrust_ball_bearing(self) -> '_1854.AngularContactThrustBallBearing':
        ...
        if _1854.AngularContactThrustBallBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_asymmetric_spherical_roller_bearing(self) -> '_1855.AsymmetricSphericalRollerBearing':
        ...
        if _1855.AsymmetricSphericalRollerBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_axial_thrust_cylindrical_roller_bearing(self) -> '_1856.AxialThrustCylindricalRollerBearing':
        ...
        if _1856.AxialThrustCylindricalRollerBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_axial_thrust_needle_roller_bearing(self) -> '_1857.AxialThrustNeedleRollerBearing':
        ...
        if _1857.AxialThrustNeedleRollerBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_ball_bearing(self) -> '_1858.BallBearing':
        ...
        if _1858.BallBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
            raise CastException('Failed to cast detail to BallBearing. Expected: {}.'.format(self.wrapped.Detail.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Detail.__class__)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_barrel_roller_bearing(self) -> '_1860.BarrelRollerBearing':
        ...
        if _1860.BarrelRollerBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_crossed_roller_bearing(self) -> '_1865.CrossedRollerBearing':
        ...
        if _1865.CrossedRollerBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_cylindrical_roller_bearing(self) -> '_1866.CylindricalRollerBearing':
        ...
        if _1866.CylindricalRollerBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_deep_groove_ball_bearing(self) -> '_1867.DeepGrooveBallBearing':
        ...
        if _1867.DeepGrooveBallBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_four_point_contact_ball_bearing(self) -> '_1869.FourPointContactBallBearing':
        ...
        if _1869.FourPointContactBallBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_multi_point_contact_ball_bearing(self) -> '_1874.MultiPointContactBallBearing':
        ...
        if _1874.MultiPointContactBallBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_needle_roller_bearing(self) -> '_1875.NeedleRollerBearing':
        ...
        if _1875.NeedleRollerBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_non_barrel_roller_bearing(self) -> '_1876.NonBarrelRollerBearing':
        ...
        if _1876.NonBarrelRollerBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_roller_bearing(self) -> '_1877.RollerBearing':
        ...
        if _1877.RollerBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
            raise CastException('Failed to cast detail to RollerBearing. Expected: {}.'.format(self.wrapped.Detail.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Detail.__class__)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_rolling_bearing(self) -> '_1880.RollingBearing':
        ...
        if _1880.RollingBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
            raise CastException('Failed to cast detail to RollingBearing. Expected: {}.'.format(self.wrapped.Detail.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Detail.__class__)(self.wrapped.Detail) if self.wrapped.Detail else None

    @property
    def detail_of_type_self_aligning_ball_bearing(self) -> '_1881.SelfAligningBallBearing':
        ...
        if _1881.SelfAligningBallBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_spherical_roller_bearing(self) -> '_1884.SphericalRollerBearing':
        ...
        if _1884.SphericalRollerBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_spherical_roller_thrust_bearing(self) -> '_1885.SphericalRollerThrustBearing':
        ...
        if _1885.SphericalRollerThrustBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_taper_roller_bearing(self) -> '_1886.TaperRollerBearing':
        ...
        if _1886.TaperRollerBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_three_point_contact_ball_bearing(self) -> '_1887.ThreePointContactBallBearing':
        ...
        if _1887.ThreePointContactBallBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_thrust_ball_bearing(self) -> '_1888.ThrustBallBearing':
        ...
        if _1888.ThrustBallBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_toroidal_roller_bearing(self) -> '_1889.ToroidalRollerBearing':
        ...
        if _1889.ToroidalRollerBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_pad_fluid_film_bearing(self) -> '_1902.PadFluidFilmBearing':
        ...
        if _1902.PadFluidFilmBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_plain_grease_filled_journal_bearing(self) -> '_1904.PlainGreaseFilledJournalBearing':
        ...
        if _1904.PlainGreaseFilledJournalBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_plain_journal_bearing(self) -> '_1906.PlainJournalBearing':
        ...
        if _1906.PlainJournalBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_plain_oil_fed_journal_bearing(self) -> '_1908.PlainOilFedJournalBearing':
        ...
        if _1908.PlainOilFedJournalBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_tilting_pad_journal_bearing(self) -> '_1909.TiltingPadJournalBearing':
        ...
        if _1909.TiltingPadJournalBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_tilting_pad_thrust_bearing(self) -> '_1910.TiltingPadThrustBearing':
        ...
        if _1910.TiltingPadThrustBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_concept_axial_clearance_bearing(self) -> '_1912.ConceptAxialClearanceBearing':
        ...
        if _1912.ConceptAxialClearanceBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_concept_clearance_bearing(self) -> '_1913.ConceptClearanceBearing':
        ...
        if _1913.ConceptClearanceBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def detail_of_type_concept_radial_clearance_bearing(self) -> '_1914.ConceptRadialClearanceBearing':
        ...
        if _1914.ConceptRadialClearanceBearing.TYPE not in self.wrapped.Detail.__class__.__mro__:
    ...
    @property
    def axial_internal_clearance_tolerance(self) -> '_2148.AxialInternalClearanceTolerance':
        ...
        return constructor.new(_2148.AxialInternalClearanceTolerance)(self.wrapped.AxialInternalClearanceTolerance) if self.wrapped.AxialInternalClearanceTolerance else None

    @property
    def radial_internal_clearance_tolerance(self) -> '_2181.RadialInternalClearanceTolerance':
        ...
        return constructor.new(_2181.RadialInternalClearanceTolerance)(self.wrapped.RadialInternalClearanceTolerance) if self.wrapped.RadialInternalClearanceTolerance else None
    ...
    @property
    def friction_coefficients(self) -> '_1790.RollingBearingFrictionCoefficients':
        ...
        return constructor.new(_1790.RollingBearingFrictionCoefficients)(self.wrapped.FrictionCoefficients) if self.wrapped.FrictionCoefficients else None

    @property
    def force_at_zero_displacement(self) -> '_1345.VectorWithLinearAndAngularComponents':
        ...
        return constructor.new(_1345.VectorWithLinearAndAngularComponents)(self.wrapped.ForceAtZeroDisplacement) if self.wrapped.ForceAtZeroDisplacement else None

    @property
    def tolerance_combinations(self) -> 'List[_1650.ToleranceCombination]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ToleranceCombinations, constructor.new(_1650.ToleranceCombination))
        return value
    ...
    def set_detail_from_catalogue(self, catalogue: '_1599.BearingCatalog', designation: 'str'):
    ...
    def try_attach_left_side_to(self, shaft: '_2190.Shaft', offset: Optional['float'] = float('nan')) -> '_2154.ComponentsConnectedResult':
    ...
    def try_attach_right_side_to(self, shaft: '_2190.Shaft', offset: Optional['float'] = float('nan')) -> '_2154.ComponentsConnectedResult':
