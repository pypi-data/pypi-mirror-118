...
from mastapy.system_model import _1915
from mastapy._internal import constructor, conversion
from mastapy.geometry import _276
from mastapy.system_model.part_model.projections import _2193
from mastapy.system_model.part_model.part_groups import _2198
...
class RootAssembly(_2143.Assembly):
    '''RootAssembly
    ...
    def model(self) -> '_1915.Design':
        ...
        return constructor.new(_1915.Design)(self.wrapped.Model) if self.wrapped.Model else None
    ...
    @property
    def parallel_part_groups_drawing_order(self) -> 'List[_2193.SpecifiedParallelPartGroupDrawingOrder]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ParallelPartGroupsDrawingOrder, constructor.new(_2193.SpecifiedParallelPartGroupDrawingOrder))
        return value

    @property
    def parallel_part_groups(self) -> 'List[_2198.ParallelPartGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ParallelPartGroups, constructor.new(_2198.ParallelPartGroup))
        return value
