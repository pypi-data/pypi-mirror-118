...
from mastapy.system_model import _1928
...
class PlanetCarrierSettings(_1369.PerMachineSettings):
    '''PlanetCarrierSettings
    ...
    @property
    def planet_pin_manufacturing_errors_coordinate_system(self) -> '_1928.PlanetPinManufacturingErrorsCoordinateSystem':
        ...
        return constructor.new(_1928.PlanetPinManufacturingErrorsCoordinateSystem)(value) if value else None

    @planet_pin_manufacturing_errors_coordinate_system.setter
    def planet_pin_manufacturing_errors_coordinate_system(self, value: '_1928.PlanetPinManufacturingErrorsCoordinateSystem'):
