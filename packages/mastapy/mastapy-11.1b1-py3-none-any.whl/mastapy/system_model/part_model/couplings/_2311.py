...
from mastapy.system_model.part_model.couplings import _2310, _2312
...
class SynchroniserHalf(_2312.SynchroniserPart):
    '''SynchroniserHalf
    ...
    @property
    def cones(self) -> 'List[_2310.SynchroniserCone]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Cones, constructor.new(_2310.SynchroniserCone))
        return value
