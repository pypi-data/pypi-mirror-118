...
from mastapy.system_model.part_model.couplings import (
    _2291, _2286, _2289, _2294,
    _2296, _2297, _2303, _2308,
    _2311, _2312, _2313, _2315,
    _2317
)
...
class Coupling(_2184.SpecialisedAssembly):
    '''Coupling
    ...
    @property
    def halves(self) -> 'List[_2291.CouplingHalf]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Halves, constructor.new(_2291.CouplingHalf))
        return value

    @property
    def half_a(self) -> '_2291.CouplingHalf':
        ...
        if _2291.CouplingHalf.TYPE not in self.wrapped.HalfA.__class__.__mro__:
    ...
    @property
    def half_a_of_type_clutch_half(self) -> '_2286.ClutchHalf':
        ...
        if _2286.ClutchHalf.TYPE not in self.wrapped.HalfA.__class__.__mro__:
            raise CastException('Failed to cast half_a to ClutchHalf. Expected: {}.'.format(self.wrapped.HalfA.__class__.__qualname__))

        return constructor.new_override(self.wrapped.HalfA.__class__)(self.wrapped.HalfA) if self.wrapped.HalfA else None

    @property
    def half_a_of_type_concept_coupling_half(self) -> '_2289.ConceptCouplingHalf':
        ...
        if _2289.ConceptCouplingHalf.TYPE not in self.wrapped.HalfA.__class__.__mro__:
    ...
    @property
    def half_a_of_type_cvt_pulley(self) -> '_2294.CVTPulley':
        ...
        if _2294.CVTPulley.TYPE not in self.wrapped.HalfA.__class__.__mro__:
            raise CastException('Failed to cast half_a to CVTPulley. Expected: {}.'.format(self.wrapped.HalfA.__class__.__qualname__))

        return constructor.new_override(self.wrapped.HalfA.__class__)(self.wrapped.HalfA) if self.wrapped.HalfA else None

    @property
    def half_a_of_type_part_to_part_shear_coupling_half(self) -> '_2296.PartToPartShearCouplingHalf':
        ...
        if _2296.PartToPartShearCouplingHalf.TYPE not in self.wrapped.HalfA.__class__.__mro__:
    ...
    @property
    def half_a_of_type_pulley(self) -> '_2297.Pulley':
        ...
        if _2297.Pulley.TYPE not in self.wrapped.HalfA.__class__.__mro__:
            raise CastException('Failed to cast half_a to Pulley. Expected: {}.'.format(self.wrapped.HalfA.__class__.__qualname__))

        return constructor.new_override(self.wrapped.HalfA.__class__)(self.wrapped.HalfA) if self.wrapped.HalfA else None

    @property
    def half_a_of_type_rolling_ring(self) -> '_2303.RollingRing':
        ...
        if _2303.RollingRing.TYPE not in self.wrapped.HalfA.__class__.__mro__:
            raise CastException('Failed to cast half_a to RollingRing. Expected: {}.'.format(self.wrapped.HalfA.__class__.__qualname__))

        return constructor.new_override(self.wrapped.HalfA.__class__)(self.wrapped.HalfA) if self.wrapped.HalfA else None

    @property
    def half_a_of_type_spring_damper_half(self) -> '_2308.SpringDamperHalf':
        ...
        if _2308.SpringDamperHalf.TYPE not in self.wrapped.HalfA.__class__.__mro__:
            raise CastException('Failed to cast half_a to SpringDamperHalf. Expected: {}.'.format(self.wrapped.HalfA.__class__.__qualname__))

        return constructor.new_override(self.wrapped.HalfA.__class__)(self.wrapped.HalfA) if self.wrapped.HalfA else None

    @property
    def half_a_of_type_synchroniser_half(self) -> '_2311.SynchroniserHalf':
        ...
        if _2311.SynchroniserHalf.TYPE not in self.wrapped.HalfA.__class__.__mro__:
            raise CastException('Failed to cast half_a to SynchroniserHalf. Expected: {}.'.format(self.wrapped.HalfA.__class__.__qualname__))

        return constructor.new_override(self.wrapped.HalfA.__class__)(self.wrapped.HalfA) if self.wrapped.HalfA else None

    @property
    def half_a_of_type_synchroniser_part(self) -> '_2312.SynchroniserPart':
        ...
        if _2312.SynchroniserPart.TYPE not in self.wrapped.HalfA.__class__.__mro__:
            raise CastException('Failed to cast half_a to SynchroniserPart. Expected: {}.'.format(self.wrapped.HalfA.__class__.__qualname__))

        return constructor.new_override(self.wrapped.HalfA.__class__)(self.wrapped.HalfA) if self.wrapped.HalfA else None

    @property
    def half_a_of_type_synchroniser_sleeve(self) -> '_2313.SynchroniserSleeve':
        ...
        if _2313.SynchroniserSleeve.TYPE not in self.wrapped.HalfA.__class__.__mro__:
    ...
    @property
    def half_a_of_type_torque_converter_pump(self) -> '_2315.TorqueConverterPump':
        ...
        if _2315.TorqueConverterPump.TYPE not in self.wrapped.HalfA.__class__.__mro__:
    ...
    @property
    def half_a_of_type_torque_converter_turbine(self) -> '_2317.TorqueConverterTurbine':
        ...
        if _2317.TorqueConverterTurbine.TYPE not in self.wrapped.HalfA.__class__.__mro__:
    ...
    @property
    def half_b(self) -> '_2291.CouplingHalf':
        ...
        if _2291.CouplingHalf.TYPE not in self.wrapped.HalfB.__class__.__mro__:
    ...
    @property
    def half_b_of_type_clutch_half(self) -> '_2286.ClutchHalf':
        ...
        if _2286.ClutchHalf.TYPE not in self.wrapped.HalfB.__class__.__mro__:
            raise CastException('Failed to cast half_b to ClutchHalf. Expected: {}.'.format(self.wrapped.HalfB.__class__.__qualname__))

        return constructor.new_override(self.wrapped.HalfB.__class__)(self.wrapped.HalfB) if self.wrapped.HalfB else None

    @property
    def half_b_of_type_concept_coupling_half(self) -> '_2289.ConceptCouplingHalf':
        ...
        if _2289.ConceptCouplingHalf.TYPE not in self.wrapped.HalfB.__class__.__mro__:
    ...
    @property
    def half_b_of_type_cvt_pulley(self) -> '_2294.CVTPulley':
        ...
        if _2294.CVTPulley.TYPE not in self.wrapped.HalfB.__class__.__mro__:
            raise CastException('Failed to cast half_b to CVTPulley. Expected: {}.'.format(self.wrapped.HalfB.__class__.__qualname__))

        return constructor.new_override(self.wrapped.HalfB.__class__)(self.wrapped.HalfB) if self.wrapped.HalfB else None

    @property
    def half_b_of_type_part_to_part_shear_coupling_half(self) -> '_2296.PartToPartShearCouplingHalf':
        ...
        if _2296.PartToPartShearCouplingHalf.TYPE not in self.wrapped.HalfB.__class__.__mro__:
    ...
    @property
    def half_b_of_type_pulley(self) -> '_2297.Pulley':
        ...
        if _2297.Pulley.TYPE not in self.wrapped.HalfB.__class__.__mro__:
            raise CastException('Failed to cast half_b to Pulley. Expected: {}.'.format(self.wrapped.HalfB.__class__.__qualname__))

        return constructor.new_override(self.wrapped.HalfB.__class__)(self.wrapped.HalfB) if self.wrapped.HalfB else None

    @property
    def half_b_of_type_rolling_ring(self) -> '_2303.RollingRing':
        ...
        if _2303.RollingRing.TYPE not in self.wrapped.HalfB.__class__.__mro__:
            raise CastException('Failed to cast half_b to RollingRing. Expected: {}.'.format(self.wrapped.HalfB.__class__.__qualname__))

        return constructor.new_override(self.wrapped.HalfB.__class__)(self.wrapped.HalfB) if self.wrapped.HalfB else None

    @property
    def half_b_of_type_spring_damper_half(self) -> '_2308.SpringDamperHalf':
        ...
        if _2308.SpringDamperHalf.TYPE not in self.wrapped.HalfB.__class__.__mro__:
            raise CastException('Failed to cast half_b to SpringDamperHalf. Expected: {}.'.format(self.wrapped.HalfB.__class__.__qualname__))

        return constructor.new_override(self.wrapped.HalfB.__class__)(self.wrapped.HalfB) if self.wrapped.HalfB else None

    @property
    def half_b_of_type_synchroniser_half(self) -> '_2311.SynchroniserHalf':
        ...
        if _2311.SynchroniserHalf.TYPE not in self.wrapped.HalfB.__class__.__mro__:
            raise CastException('Failed to cast half_b to SynchroniserHalf. Expected: {}.'.format(self.wrapped.HalfB.__class__.__qualname__))

        return constructor.new_override(self.wrapped.HalfB.__class__)(self.wrapped.HalfB) if self.wrapped.HalfB else None

    @property
    def half_b_of_type_synchroniser_part(self) -> '_2312.SynchroniserPart':
        ...
        if _2312.SynchroniserPart.TYPE not in self.wrapped.HalfB.__class__.__mro__:
            raise CastException('Failed to cast half_b to SynchroniserPart. Expected: {}.'.format(self.wrapped.HalfB.__class__.__qualname__))

        return constructor.new_override(self.wrapped.HalfB.__class__)(self.wrapped.HalfB) if self.wrapped.HalfB else None

    @property
    def half_b_of_type_synchroniser_sleeve(self) -> '_2313.SynchroniserSleeve':
        ...
        if _2313.SynchroniserSleeve.TYPE not in self.wrapped.HalfB.__class__.__mro__:
    ...
    @property
    def half_b_of_type_torque_converter_pump(self) -> '_2315.TorqueConverterPump':
        ...
        if _2315.TorqueConverterPump.TYPE not in self.wrapped.HalfB.__class__.__mro__:
    ...
    @property
    def half_b_of_type_torque_converter_turbine(self) -> '_2317.TorqueConverterTurbine':
        ...
        if _2317.TorqueConverterTurbine.TYPE not in self.wrapped.HalfB.__class__.__mro__:
