...
from mastapy.math_utility.stiffness_calculators import _1317
...
class SplineLeadRelief(_0.APIBase):
    ...
    @property
    def contact_position(self) -> '_1317.IndividualContactPosition':
        ...
        return constructor.new(_1317.IndividualContactPosition)(value) if value else None
    ...
    @property
    def crowning(self) -> '_2292.CrowningSpecification':
        ...
        return constructor.new(_2292.CrowningSpecification)(self.wrapped.Crowning) if self.wrapped.Crowning else None
