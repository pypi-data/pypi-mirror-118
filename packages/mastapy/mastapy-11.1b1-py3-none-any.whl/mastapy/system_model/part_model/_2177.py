...
from mastapy.system_model.part_model import _2169, _2172
from mastapy.system_model.connections_and_sockets import _1997
...
class PlanetCarrier(_2172.MountableComponent):
    '''PlanetCarrier
    ...
    @property
    def load_sharing_settings(self) -> '_2169.LoadSharingSettings':
        ...
        return constructor.new(_2169.LoadSharingSettings)(self.wrapped.LoadSharingSettings) if self.wrapped.LoadSharingSettings else None

    @property
    def planetary_sockets(self) -> 'List[_1997.PlanetarySocket]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PlanetarySockets, constructor.new(_1997.PlanetarySocket))
        return value

    def attach_carrier_shaft(self, shaft: '_2190.Shaft', offset: Optional['float'] = float('nan')):
    ...
    def attach_pin_shaft(self, shaft: '_2190.Shaft', offset: Optional['float'] = float('nan')):
