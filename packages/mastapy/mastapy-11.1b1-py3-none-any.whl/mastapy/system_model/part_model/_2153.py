...
from mastapy.math_utility import _1279, _1280
from mastapy.system_model.connections_and_sockets import (
    _1979, _2000, _1981, _2005
)
from mastapy.system_model.part_model import _2154, _2176
...
class Component(_2176.Part):
    ...
    @property
    def local_coordinate_system(self) -> '_1279.CoordinateSystem3D':
        ...
        return constructor.new(_1279.CoordinateSystem3D)(self.wrapped.LocalCoordinateSystem) if self.wrapped.LocalCoordinateSystem else None

    @property
    def component_connections(self) -> 'List[_1979.ComponentConnection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentConnections, constructor.new(_1979.ComponentConnection))
        return value
    ...
    def set_position_and_axis_of_component_and_connected_components(self, origin: 'Vector3D', z_axis: 'Vector3D') -> '_2000.RealignmentResult':
    ...
    def set_position_and_rotation_of_component_and_connected_components(self, new_coordinate_system: '_1279.CoordinateSystem3D') -> '_2000.RealignmentResult':
    ...
    def set_position_of_component_and_connected_components(self, position: 'Vector3D') -> '_2000.RealignmentResult':
    ...
    def create_coordinate_system_editor(self) -> '_1280.CoordinateSystemEditor':
    ...
    def diameter_at_middle_of_connection(self, connection: '_1981.Connection') -> 'float':
    ...
    def diameter_of_socket_for(self, connection: '_1981.Connection') -> 'float':
    ...
    def possible_sockets_to_connect_with(self, socket: '_2005.Socket') -> 'List[_2005.Socket]':
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.PossibleSocketsToConnectWith.Overloads[_SOCKET](socket.wrapped if socket else None), constructor.new(_2005.Socket))

    def connect_to_socket(self, socket: '_2005.Socket') -> '_2154.ComponentsConnectedResult':
    ...
    def possible_sockets_to_connect_with_component(self, component: 'Component') -> 'List[_2005.Socket]':
        ''' 'PossibleSocketsToConnectWith' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.PossibleSocketsToConnectWith.Overloads[_COMPONENT](component.wrapped if component else None), constructor.new(_2005.Socket))

    def try_connect_to(self, component: 'Component', hint_offset: Optional['float'] = float('nan')) -> '_2154.ComponentsConnectedResult':
    ...
    def connect_to(self, component: 'Component') -> '_2154.ComponentsConnectedResult':
        ''' 'ConnectTo' is the original name of this method.
    ...
    def can_delete_connection(self, connection: '_1981.Connection') -> 'bool':
    ...
    def socket_named(self, socket_name: 'str') -> '_2005.Socket':
