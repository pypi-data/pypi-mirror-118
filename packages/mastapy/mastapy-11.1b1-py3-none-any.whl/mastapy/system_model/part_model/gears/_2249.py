...
from mastapy.system_model.part_model.gears import _2232, _2234, _2233
...
class PlanetaryGearSet(_2233.CylindricalGearSet):
    '''PlanetaryGearSet
    ...
    @property
    def suns(self) -> 'List[_2232.CylindricalGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Suns, constructor.new(_2232.CylindricalGear))
        return value

    @property
    def planets(self) -> 'List[_2234.CylindricalPlanetGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Planets, constructor.new(_2234.CylindricalPlanetGear))
        return value

    @property
    def annuluses(self) -> 'List[_2232.CylindricalGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Annuluses, constructor.new(_2232.CylindricalGear))
        return value

    def add_sun(self) -> '_2232.CylindricalGear':
    ...
    def add_planet(self) -> '_2232.CylindricalGear':
    ...
    def add_annulus(self) -> '_2232.CylindricalGear':
