...
from mastapy.gears.gear_designs.worm import _895, _894, _898
...
class WormGear(_2237.Gear):
    ...
    @property
    def active_gear_design(self) -> '_895.WormGearDesign':
    ...
    @property
    def worm_gear_design(self) -> '_895.WormGearDesign':
        ...
        if _895.WormGearDesign.TYPE not in self.wrapped.WormGearDesign.__class__.__mro__:
