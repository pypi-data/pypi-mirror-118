...
class FaceGear(_2237.Gear):
    ...
    @property
    def active_gear_design(self) -> '_927.FaceGearDesign':
    ...
    @property
    def face_gear_design(self) -> '_927.FaceGearDesign':
        ...
        if _927.FaceGearDesign.TYPE not in self.wrapped.FaceGearDesign.__class__.__mro__:
