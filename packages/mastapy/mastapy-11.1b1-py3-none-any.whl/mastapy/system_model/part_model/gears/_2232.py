...
class CylindricalGear(_2237.Gear):
    '''CylindricalGear
    ...
    @property
    def active_gear_design(self) -> '_950.CylindricalGearDesign':
    ...
    @property
    def cylindrical_gear_design(self) -> '_950.CylindricalGearDesign':
        ...
        if _950.CylindricalGearDesign.TYPE not in self.wrapped.CylindricalGearDesign.__class__.__mro__:
