...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4318, _4317, _4331
...
class CylindricalGearSetModalAnalysisAtAStiffness(_4331.GearSetModalAnalysisAtAStiffness):
    '''CylindricalGearSetModalAnalysisAtAStiffness
    ...
    @property
    def cylindrical_gears_modal_analysis_at_a_stiffness(self) -> 'List[_4318.CylindricalGearModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearsModalAnalysisAtAStiffness, constructor.new(_4318.CylindricalGearModalAnalysisAtAStiffness))
        return value

    @property
    def cylindrical_meshes_modal_analysis_at_a_stiffness(self) -> 'List[_4317.CylindricalGearMeshModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshesModalAnalysisAtAStiffness, constructor.new(_4317.CylindricalGearMeshModalAnalysisAtAStiffness))
        return value
