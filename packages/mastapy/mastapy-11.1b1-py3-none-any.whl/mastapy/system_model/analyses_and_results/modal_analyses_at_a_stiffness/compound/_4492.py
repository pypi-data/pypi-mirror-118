...
class RollingRingCompoundModalAnalysisAtAStiffness(_4439.CouplingHalfCompoundModalAnalysisAtAStiffness):
    '''RollingRingCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4364.RollingRingModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4364.RollingRingModalAnalysisAtAStiffness))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4364.RollingRingModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4364.RollingRingModalAnalysisAtAStiffness))
        return value
