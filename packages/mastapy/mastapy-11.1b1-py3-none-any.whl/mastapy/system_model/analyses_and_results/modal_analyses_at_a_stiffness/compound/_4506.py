...
class StraightBevelDiffGearMeshCompoundModalAnalysisAtAStiffness(_4417.BevelGearMeshCompoundModalAnalysisAtAStiffness):
    '''StraightBevelDiffGearMeshCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4376.StraightBevelDiffGearMeshModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4376.StraightBevelDiffGearMeshModalAnalysisAtAStiffness))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_4376.StraightBevelDiffGearMeshModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4376.StraightBevelDiffGearMeshModalAnalysisAtAStiffness))
        return value
