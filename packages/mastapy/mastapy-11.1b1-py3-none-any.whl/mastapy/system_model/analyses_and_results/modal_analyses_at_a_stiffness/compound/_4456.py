...
class FEPartCompoundModalAnalysisAtAStiffness(_4402.AbstractShaftOrHousingCompoundModalAnalysisAtAStiffness):
    '''FEPartCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4327.FEPartModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4327.FEPartModalAnalysisAtAStiffness))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4327.FEPartModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4327.FEPartModalAnalysisAtAStiffness))
        return value
