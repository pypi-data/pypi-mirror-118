...
class ZerolBevelGearMeshCompoundModalAnalysisAtAStiffness(_4417.BevelGearMeshCompoundModalAnalysisAtAStiffness):
    '''ZerolBevelGearMeshCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4397.ZerolBevelGearMeshModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4397.ZerolBevelGearMeshModalAnalysisAtAStiffness))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_4397.ZerolBevelGearMeshModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4397.ZerolBevelGearMeshModalAnalysisAtAStiffness))
        return value
