...
class BevelGearCompoundModalAnalysisAtAStiffness(_4404.AGMAGleasonConicalGearCompoundModalAnalysisAtAStiffness):
    '''BevelGearCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4287.BevelGearModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4287.BevelGearModalAnalysisAtAStiffness))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_4287.BevelGearModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4287.BevelGearModalAnalysisAtAStiffness))
        return value
