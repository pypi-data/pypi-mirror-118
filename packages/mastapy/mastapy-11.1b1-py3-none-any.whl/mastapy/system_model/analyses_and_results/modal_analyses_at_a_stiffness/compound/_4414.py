...
class BevelDifferentialPlanetGearCompoundModalAnalysisAtAStiffness(_4411.BevelDifferentialGearCompoundModalAnalysisAtAStiffness):
    '''BevelDifferentialPlanetGearCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4284.BevelDifferentialPlanetGearModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4284.BevelDifferentialPlanetGearModalAnalysisAtAStiffness))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4284.BevelDifferentialPlanetGearModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4284.BevelDifferentialPlanetGearModalAnalysisAtAStiffness))
        return value
