...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4395, _4394, _4331
...
class WormGearSetModalAnalysisAtAStiffness(_4331.GearSetModalAnalysisAtAStiffness):
    '''WormGearSetModalAnalysisAtAStiffness
    ...
    @property
    def worm_gears_modal_analysis_at_a_stiffness(self) -> 'List[_4395.WormGearModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsModalAnalysisAtAStiffness, constructor.new(_4395.WormGearModalAnalysisAtAStiffness))
        return value

    @property
    def worm_meshes_modal_analysis_at_a_stiffness(self) -> 'List[_4394.WormGearMeshModalAnalysisAtAStiffness]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesModalAnalysisAtAStiffness, constructor.new(_4394.WormGearMeshModalAnalysisAtAStiffness))
        return value
