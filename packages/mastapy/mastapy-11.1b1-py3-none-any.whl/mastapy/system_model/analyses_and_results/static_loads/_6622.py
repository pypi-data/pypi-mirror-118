...
from mastapy.math_utility import _1284, _1294
...
class PointLoadHarmonicLoadData(_6638.SpeedDependentHarmonicLoadData):
    '''PointLoadHarmonicLoadData
    ...
    @property
    def degree_of_freedom(self) -> '_1284.DegreesOfFreedom':
        ...
        return constructor.new(_1284.DegreesOfFreedom)(value) if value else None

    @degree_of_freedom.setter
    def degree_of_freedom(self, value: '_1284.DegreesOfFreedom'):
