...
from mastapy.system_model.analyses_and_results.static_loads import _6522, _6523, _6577
...
class ConceptGearSetLoadCase(_6577.GearSetLoadCase):
    '''ConceptGearSetLoadCase
    ...
    @property
    def gears(self) -> 'List[_6522.ConceptGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_6522.ConceptGearLoadCase))
        return value

    @property
    def concept_gears_load_case(self) -> 'List[_6522.ConceptGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearsLoadCase, constructor.new(_6522.ConceptGearLoadCase))
        return value

    @property
    def concept_meshes_load_case(self) -> 'List[_6523.ConceptGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshesLoadCase, constructor.new(_6523.ConceptGearMeshLoadCase))
        return value
