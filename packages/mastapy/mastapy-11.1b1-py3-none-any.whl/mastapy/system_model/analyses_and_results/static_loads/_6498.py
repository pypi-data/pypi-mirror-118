...
from mastapy.bearings.tolerances import _1645
...
class AllRingPinsManufacturingError(_0.APIBase):
    ...
    @property
    def roundness_specification(self) -> '_1645.RoundnessSpecification':
        ...
        return constructor.new(_1645.RoundnessSpecification)(self.wrapped.RoundnessSpecification) if self.wrapped.RoundnessSpecification else None

    @property
    def ring_pin_manufacturing_errors(self) -> 'List[_6627.RingPinManufacturingError]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RingPinManufacturingErrors, constructor.new(_6627.RingPinManufacturingError))
        return value
