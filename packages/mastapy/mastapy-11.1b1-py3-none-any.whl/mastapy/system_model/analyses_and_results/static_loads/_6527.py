...
from mastapy.gears.gear_designs.conical import _1095, _1089
from mastapy.system_model.analyses_and_results.static_loads import _6528, _6574
...
class ConicalGearMeshLoadCase(_6574.GearMeshLoadCase):
    '''ConicalGearMeshLoadCase
    ...
    @property
    def results_from_imported_xml(self) -> '_1095.KimosBevelHypoidSingleLoadCaseResultsData':
        ...
        return constructor.new(_1095.KimosBevelHypoidSingleLoadCaseResultsData)(self.wrapped.ResultsFromImportedXML) if self.wrapped.ResultsFromImportedXML else None
    ...
    def get_harmonic_load_data_for_import(self) -> '_6528.ConicalGearSetHarmonicLoadData':
