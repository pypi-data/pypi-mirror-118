...
class ClutchConnectionLoadCase(_6532.CouplingConnectionLoadCase):
    '''ClutchConnectionLoadCase
    ...
    @property
    def clutch_pressures(self) -> '_1315.Vector2DListAccessor':
        '''Vector2DListAccessor: 'ClutchPressures' is the original name of this property.'''

        return constructor.new(_1315.Vector2DListAccessor)(self.wrapped.ClutchPressures) if self.wrapped.ClutchPressures else None

    @clutch_pressures.setter
    def clutch_pressures(self, value: '_1315.Vector2DListAccessor'):
