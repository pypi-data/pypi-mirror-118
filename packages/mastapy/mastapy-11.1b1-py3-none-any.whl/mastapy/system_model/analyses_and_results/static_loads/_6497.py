...
from mastapy.gears.manufacturing.bevel import _745, _743, _744
...
class AGMAGleasonConicalGearSetLoadCase(_6529.ConicalGearSetLoadCase):
    '''AGMAGleasonConicalGearSetLoadCase
    ...
    @property
    def overridden_manufacturing_config_micro_geometry(self) -> '_745.ConicalSetMicroGeometryConfigBase':
        ...
        if _745.ConicalSetMicroGeometryConfigBase.TYPE not in self.wrapped.OverriddenManufacturingConfigMicroGeometry.__class__.__mro__:
    ...
    @property
    def overridden_manufacturing_config_micro_geometry_of_type_conical_set_manufacturing_config(self) -> '_743.ConicalSetManufacturingConfig':
        ...
        if _743.ConicalSetManufacturingConfig.TYPE not in self.wrapped.OverriddenManufacturingConfigMicroGeometry.__class__.__mro__:
    ...
    @property
    def overridden_manufacturing_config_micro_geometry_of_type_conical_set_micro_geometry_config(self) -> '_744.ConicalSetMicroGeometryConfig':
        ...
        if _744.ConicalSetMicroGeometryConfig.TYPE not in self.wrapped.OverriddenManufacturingConfigMicroGeometry.__class__.__mro__:
