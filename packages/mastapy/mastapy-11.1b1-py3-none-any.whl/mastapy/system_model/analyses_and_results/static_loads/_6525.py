...
from mastapy.system_model.analyses_and_results.static_loads import _6526, _6572
...
class ConicalGearLoadCase(_6572.GearLoadCase):
    '''ConicalGearLoadCase
    ...
    @property
    def gear_manufacture_errors(self) -> '_6526.ConicalGearManufactureError':
        ...
        return constructor.new(_6526.ConicalGearManufactureError)(self.wrapped.GearManufactureErrors) if self.wrapped.GearManufactureErrors else None
