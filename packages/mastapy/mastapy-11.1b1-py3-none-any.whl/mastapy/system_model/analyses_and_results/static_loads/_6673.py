...
from mastapy.system_model.analyses_and_results.static_loads import _6671, _6672, _6511
...
class ZerolBevelGearSetLoadCase(_6511.BevelGearSetLoadCase):
    '''ZerolBevelGearSetLoadCase
    ...
    @property
    def gears(self) -> 'List[_6671.ZerolBevelGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_6671.ZerolBevelGearLoadCase))
        return value

    @property
    def zerol_bevel_gears_load_case(self) -> 'List[_6671.ZerolBevelGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelGearsLoadCase, constructor.new(_6671.ZerolBevelGearLoadCase))
        return value

    @property
    def zerol_bevel_meshes_load_case(self) -> 'List[_6672.ZerolBevelGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelMeshesLoadCase, constructor.new(_6672.ZerolBevelGearMeshLoadCase))
        return value
