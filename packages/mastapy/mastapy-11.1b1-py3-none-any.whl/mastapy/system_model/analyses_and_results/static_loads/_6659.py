...
class TorqueConverterLoadCase(_6534.CouplingLoadCase):
    '''TorqueConverterLoadCase
    ...
    @property
    def lock_up_clutch_pressure_time_profile(self) -> '_1315.Vector2DListAccessor':
        '''Vector2DListAccessor: 'LockUpClutchPressureTimeProfile' is the original name of this property.'''

        return constructor.new(_1315.Vector2DListAccessor)(self.wrapped.LockUpClutchPressureTimeProfile) if self.wrapped.LockUpClutchPressureTimeProfile else None

    @lock_up_clutch_pressure_time_profile.setter
    def lock_up_clutch_pressure_time_profile(self, value: '_1315.Vector2DListAccessor'):
