...
from mastapy.system_model.analyses_and_results.static_loads import _6594, _6581, _6561
...
class HarmonicLoadDataFluxImport(_6581.HarmonicLoadDataCSVImport['_6561.ElectricMachineHarmonicLoadFluxImportOptions']):
    '''HarmonicLoadDataFluxImport
    ...
    @property
    def inner_diameter_reference(self) -> '_6594.InnerDiameterReference':
        ...
        return constructor.new(_6594.InnerDiameterReference)(value) if value else None

    @inner_diameter_reference.setter
    def inner_diameter_reference(self, value: '_6594.InnerDiameterReference'):
