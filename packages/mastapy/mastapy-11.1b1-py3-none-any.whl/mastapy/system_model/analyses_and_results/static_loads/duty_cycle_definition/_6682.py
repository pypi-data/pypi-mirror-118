...
from mastapy.utility.file_access_helpers import _1567
from mastapy.utility_gui import _1594
...
class MultiTimeSeriesDataInputFileOptions(_1594.DataInputFileOptions):
    '''MultiTimeSeriesDataInputFileOptions
    ...
    @property
    def delimiter_options(self) -> '_1567.TextFileDelimiterOptions':
        ...
        return constructor.new(_1567.TextFileDelimiterOptions)(self.wrapped.DelimiterOptions) if self.wrapped.DelimiterOptions else None
