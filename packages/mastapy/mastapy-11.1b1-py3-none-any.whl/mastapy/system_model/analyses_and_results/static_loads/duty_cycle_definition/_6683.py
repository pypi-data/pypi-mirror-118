...
from mastapy.system_model.analyses_and_results.static_loads.duty_cycle_definition import _6674
from mastapy.utility_gui import _1593
...
class PointLoadInputOptions(_1593.ColumnInputOptions):
    '''PointLoadInputOptions
    ...
    @axis.setter
    def axis(self, value: '_1272.Axis'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.Axis = value

    @property
    def conversion_to_load_case(self) -> '_6674.AdditionalForcesObtainedFrom':
        ...
        return constructor.new(_6674.AdditionalForcesObtainedFrom)(value) if value else None

    @conversion_to_load_case.setter
    def conversion_to_load_case(self, value: '_6674.AdditionalForcesObtainedFrom'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
