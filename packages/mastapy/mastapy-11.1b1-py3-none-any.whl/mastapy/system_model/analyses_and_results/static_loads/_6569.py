...
from mastapy.system_model.fe import _2068, _2091
...
class FEPartLoadCase(_6490.AbstractShaftOrHousingLoadCase):
    '''FEPartLoadCase
    ...
    @property
    def angle_source(self) -> '_2068.AngleSource':
        ...
        return constructor.new(_2068.AngleSource)(value) if value else None
