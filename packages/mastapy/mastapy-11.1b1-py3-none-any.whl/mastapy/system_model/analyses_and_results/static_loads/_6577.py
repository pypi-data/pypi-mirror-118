...
class GearSetLoadCase(_6637.SpecialisedAssemblyLoadCase):
    '''GearSetLoadCase
    ...
    @property
    def gear_mesh_stiffness_model(self) -> '_5131.GearMeshStiffnessModel':
        ...
        return constructor.new(_5131.GearMeshStiffnessModel)(value) if value else None

    @gear_mesh_stiffness_model.setter
    def gear_mesh_stiffness_model(self, value: '_5131.GearMeshStiffnessModel'):
    ...
    @property
    def assembly_design(self) -> '_2239.GearSet':
    ...
    @property
    def advanced_time_stepping_analysis_for_modulation_options(self) -> '_6697.AdvancedTimeSteppingAnalysisForModulationOptions':
        ...
        return constructor.new(_6697.AdvancedTimeSteppingAnalysisForModulationOptions)(self.wrapped.AdvancedTimeSteppingAnalysisForModulationOptions) if self.wrapped.AdvancedTimeSteppingAnalysisForModulationOptions else None

    @property
    def meshes_without_planetary_duplicates(self) -> 'List[_6574.GearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshesWithoutPlanetaryDuplicates, constructor.new(_6574.GearMeshLoadCase))
        return value

    @property
    def gears(self) -> 'List[_6572.GearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_6572.GearLoadCase))
        return value

    @property
    def gears_without_clones(self) -> 'List[_6572.GearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearsWithoutClones, constructor.new(_6572.GearLoadCase))
        return value
