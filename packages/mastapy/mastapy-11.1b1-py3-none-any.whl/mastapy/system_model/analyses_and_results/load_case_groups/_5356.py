...
from mastapy.system_model.analyses_and_results.load_case_groups import _5359, _5352
from mastapy._internal import constructor, conversion
from mastapy.system_model.analyses_and_results.static_loads.duty_cycle_definition import _6687
...
class DutyCycle(_5352.AbstractStaticLoadCaseGroup):
    '''DutyCycle
    ...
    @property
    def duty_cycle_design_states(self) -> 'List[_5359.SubGroupInSingleDesignState]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DutyCycleDesignStates, constructor.new(_5359.SubGroupInSingleDesignState))
        return value

    @property
    def time_series_importer(self) -> '_6687.TimeSeriesImporter':
        ...
        return constructor.new(_6687.TimeSeriesImporter)(self.wrapped.TimeSeriesImporter) if self.wrapped.TimeSeriesImporter else None
    ...
    def add_static_load(self, static_load: '_6486.StaticLoadCase'):
    ...
    def remove_static_load(self, static_load: '_6486.StaticLoadCase'):
    ...
    def remove_design_state_sub_group(self, sub_group: '_5359.SubGroupInSingleDesignState'):
