...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6326, _6327, _6243
...
class SpiralBevelGearSetCriticalSpeedAnalysis(_6243.BevelGearSetCriticalSpeedAnalysis):
    '''SpiralBevelGearSetCriticalSpeedAnalysis
    ...
    @property
    def spiral_bevel_gears_critical_speed_analysis(self) -> 'List[_6326.SpiralBevelGearCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelGearsCriticalSpeedAnalysis, constructor.new(_6326.SpiralBevelGearCriticalSpeedAnalysis))
        return value

    @property
    def spiral_bevel_meshes_critical_speed_analysis(self) -> 'List[_6327.SpiralBevelGearMeshCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelMeshesCriticalSpeedAnalysis, constructor.new(_6327.SpiralBevelGearMeshCriticalSpeedAnalysis))
        return value
