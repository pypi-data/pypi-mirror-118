...
class BevelDifferentialPlanetGearCompoundCriticalSpeedAnalysis(_6367.BevelDifferentialGearCompoundCriticalSpeedAnalysis):
    '''BevelDifferentialPlanetGearCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6239.BevelDifferentialPlanetGearCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6239.BevelDifferentialPlanetGearCriticalSpeedAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_6239.BevelDifferentialPlanetGearCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6239.BevelDifferentialPlanetGearCriticalSpeedAnalysis))
        return value
