...
class InterMountableComponentConnectionCompoundCriticalSpeedAnalysis(_6391.ConnectionCompoundCriticalSpeedAnalysis):
    '''InterMountableComponentConnectionCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6292.InterMountableComponentConnectionCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_6292.InterMountableComponentConnectionCriticalSpeedAnalysis))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_6292.InterMountableComponentConnectionCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_6292.InterMountableComponentConnectionCriticalSpeedAnalysis))
        return value
