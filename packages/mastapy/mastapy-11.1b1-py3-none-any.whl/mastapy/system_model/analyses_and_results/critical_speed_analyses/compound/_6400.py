...
class CycloidalDiscCentralBearingConnectionCompoundCriticalSpeedAnalysis(_6380.CoaxialConnectionCompoundCriticalSpeedAnalysis):
    '''CycloidalDiscCentralBearingConnectionCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6271.CycloidalDiscCentralBearingConnectionCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_6271.CycloidalDiscCentralBearingConnectionCriticalSpeedAnalysis))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_6271.CycloidalDiscCentralBearingConnectionCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_6271.CycloidalDiscCentralBearingConnectionCriticalSpeedAnalysis))
        return value
