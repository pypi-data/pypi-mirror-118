...
from mastapy.system_model.analyses_and_results.critical_speed_analyses.compound import _6435
...
class ComponentCompoundCriticalSpeedAnalysis(_6435.PartCompoundCriticalSpeedAnalysis):
    '''ComponentCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6250.ComponentCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6250.ComponentCriticalSpeedAnalysis))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_6250.ComponentCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6250.ComponentCriticalSpeedAnalysis))
        return value
