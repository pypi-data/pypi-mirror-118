...
class StraightBevelPlanetGearCompoundCriticalSpeedAnalysis(_6461.StraightBevelDiffGearCompoundCriticalSpeedAnalysis):
    '''StraightBevelPlanetGearCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6338.StraightBevelPlanetGearCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6338.StraightBevelPlanetGearCriticalSpeedAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_6338.StraightBevelPlanetGearCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6338.StraightBevelPlanetGearCriticalSpeedAnalysis))
        return value
