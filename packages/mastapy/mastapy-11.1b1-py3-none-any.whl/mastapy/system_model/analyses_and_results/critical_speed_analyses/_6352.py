...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6350, _6351, _6287
...
class WormGearSetCriticalSpeedAnalysis(_6287.GearSetCriticalSpeedAnalysis):
    '''WormGearSetCriticalSpeedAnalysis
    ...
    @property
    def worm_gears_critical_speed_analysis(self) -> 'List[_6350.WormGearCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsCriticalSpeedAnalysis, constructor.new(_6350.WormGearCriticalSpeedAnalysis))
        return value

    @property
    def worm_meshes_critical_speed_analysis(self) -> 'List[_6351.WormGearMeshCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesCriticalSpeedAnalysis, constructor.new(_6351.WormGearMeshCriticalSpeedAnalysis))
        return value
