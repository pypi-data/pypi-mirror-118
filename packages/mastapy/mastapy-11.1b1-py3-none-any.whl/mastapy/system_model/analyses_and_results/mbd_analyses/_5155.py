...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5141, _5180, _5175
from mastapy._internal.implicit import list_with_selected_item
from mastapy._internal.overridable_constructor import _unpack_overridable
from mastapy.system_model.analyses_and_results.analysis_cases import _7220
...
class MBDRunUpAnalysisOptions(_7220.AbstractAnalysisOptions['_6487.TimeSeriesLoadCase']):
    '''MBDRunUpAnalysisOptions
    ...
    @property
    def input_velocity_processing_type(self) -> '_5141.InputVelocityForRunUpProcessingType':
        ...
        return constructor.new(_5141.InputVelocityForRunUpProcessingType)(value) if value else None

    @input_velocity_processing_type.setter
    def input_velocity_processing_type(self, value: '_5141.InputVelocityForRunUpProcessingType'):
    ...
    @property
    def shape_of_initial_acceleration_period(self) -> '_5180.ShapeOfInitialAccelerationPeriodForRunUp':
        ...
        return constructor.new(_5180.ShapeOfInitialAccelerationPeriodForRunUp)(value) if value else None

    @shape_of_initial_acceleration_period.setter
    def shape_of_initial_acceleration_period(self, value: '_5180.ShapeOfInitialAccelerationPeriodForRunUp'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ShapeOfInitialAccelerationPeriod = value

    @property
    def run_up_driving_mode(self) -> '_5175.RunUpDrivingMode':
        ...
        return constructor.new(_5175.RunUpDrivingMode)(value) if value else None

    @run_up_driving_mode.setter
    def run_up_driving_mode(self, value: '_5175.RunUpDrivingMode'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
