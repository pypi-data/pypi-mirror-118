...
from mastapy.system_model.analyses_and_results.mbd_analyses.reporting import _5217, _5219
...
class ShaftHubConnectionMultibodyDynamicsAnalysis(_5108.ConnectorMultibodyDynamicsAnalysis):
    '''ShaftHubConnectionMultibodyDynamicsAnalysis
    ...
    @property
    def peak_dynamic_force(self) -> '_5217.DynamicForceVector3DResult':
        ...
        return constructor.new(_5217.DynamicForceVector3DResult)(self.wrapped.PeakDynamicForce) if self.wrapped.PeakDynamicForce else None

    @property
    def peak_dynamic_force_angular(self) -> '_5219.DynamicTorqueVector3DResult':
        ...
        return constructor.new(_5219.DynamicTorqueVector3DResult)(self.wrapped.PeakDynamicForceAngular) if self.wrapped.PeakDynamicForceAngular else None
