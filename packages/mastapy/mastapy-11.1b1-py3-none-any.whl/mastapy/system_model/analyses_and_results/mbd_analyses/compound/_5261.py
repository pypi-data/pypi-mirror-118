...
class CVTBeltConnectionCompoundMultibodyDynamicsAnalysis(_5230.BeltConnectionCompoundMultibodyDynamicsAnalysis):
    '''CVTBeltConnectionCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5112.CVTBeltConnectionMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_5112.CVTBeltConnectionMultibodyDynamicsAnalysis))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_5112.CVTBeltConnectionMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_5112.CVTBeltConnectionMultibodyDynamicsAnalysis))
        return value
