...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5204, _5109
...
class TorqueConverterConnectionMultibodyDynamicsAnalysis(_5109.CouplingConnectionMultibodyDynamicsAnalysis):
    '''TorqueConverterConnectionMultibodyDynamicsAnalysis
    ...
    @property
    def locking_status(self) -> '_5204.TorqueConverterStatus':
        ...
        return constructor.new(_5204.TorqueConverterStatus)(value) if value else None
