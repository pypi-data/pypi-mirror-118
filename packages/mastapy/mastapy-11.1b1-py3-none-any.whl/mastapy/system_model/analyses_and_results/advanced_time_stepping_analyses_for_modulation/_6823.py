...
class ZerolBevelGearMeshAdvancedTimeSteppingAnalysisForModulation(_6712.BevelGearMeshAdvancedTimeSteppingAnalysisForModulation):
    '''ZerolBevelGearMeshAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def connection_load_case(self) -> '_6672.ZerolBevelGearMeshLoadCase':
        ...
        return constructor.new(_6672.ZerolBevelGearMeshLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None

    @property
    def system_deflection_results(self) -> '_2541.ZerolBevelGearMeshSystemDeflection':
        ...
        return constructor.new(_2541.ZerolBevelGearMeshSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
