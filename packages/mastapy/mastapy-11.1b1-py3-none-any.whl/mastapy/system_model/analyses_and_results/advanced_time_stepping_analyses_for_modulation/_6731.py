...
class ConnectorAdvancedTimeSteppingAnalysisForModulation(_6773.MountableComponentAdvancedTimeSteppingAnalysisForModulation):
    '''ConnectorAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_design(self) -> '_2156.Connector':
    ...
    @property
    def system_deflection_results(self) -> '_2430.ConnectorSystemDeflection':
