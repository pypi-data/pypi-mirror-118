...
class RollingRingAssemblyAdvancedTimeSteppingAnalysisForModulation(_6794.SpecialisedAssemblyAdvancedTimeSteppingAnalysisForModulation):
    '''RollingRingAssemblyAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def assembly_load_case(self) -> '_6630.RollingRingAssemblyLoadCase':
        ...
        return constructor.new(_6630.RollingRingAssemblyLoadCase)(self.wrapped.AssemblyLoadCase) if self.wrapped.AssemblyLoadCase else None

    @property
    def system_deflection_results(self) -> '_2499.RollingRingAssemblySystemDeflection':
        ...
        return constructor.new(_2499.RollingRingAssemblySystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
