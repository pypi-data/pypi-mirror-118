...
class HypoidGearAdvancedTimeSteppingAnalysisForModulation(_6698.AGMAGleasonConicalGearAdvancedTimeSteppingAnalysisForModulation):
    '''HypoidGearAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2467.HypoidGearSystemDeflection':
        ...
        return constructor.new(_2467.HypoidGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
