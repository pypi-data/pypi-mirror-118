...
class BevelDifferentialGearCompoundAdvancedTimeSteppingAnalysisForModulation(_6841.BevelGearCompoundAdvancedTimeSteppingAnalysisForModulation):
    '''BevelDifferentialGearCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6706.BevelDifferentialGearAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6706.BevelDifferentialGearAdvancedTimeSteppingAnalysisForModulation))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_6706.BevelDifferentialGearAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6706.BevelDifferentialGearAdvancedTimeSteppingAnalysisForModulation))
        return value
