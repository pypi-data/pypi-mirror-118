...
class PartToPartShearCouplingHalfCompoundAdvancedTimeSteppingAnalysisForModulation(_6864.CouplingHalfCompoundAdvancedTimeSteppingAnalysisForModulation):
    '''PartToPartShearCouplingHalfCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6778.PartToPartShearCouplingHalfAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6778.PartToPartShearCouplingHalfAdvancedTimeSteppingAnalysisForModulation))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_6778.PartToPartShearCouplingHalfAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6778.PartToPartShearCouplingHalfAdvancedTimeSteppingAnalysisForModulation))
        return value
