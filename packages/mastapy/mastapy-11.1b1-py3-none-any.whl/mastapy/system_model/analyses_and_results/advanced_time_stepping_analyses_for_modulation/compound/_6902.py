...
class MountableComponentCompoundAdvancedTimeSteppingAnalysisForModulation(_6850.ComponentCompoundAdvancedTimeSteppingAnalysisForModulation):
    '''MountableComponentCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6773.MountableComponentAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6773.MountableComponentAdvancedTimeSteppingAnalysisForModulation))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_6773.MountableComponentAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6773.MountableComponentAdvancedTimeSteppingAnalysisForModulation))
        return value
