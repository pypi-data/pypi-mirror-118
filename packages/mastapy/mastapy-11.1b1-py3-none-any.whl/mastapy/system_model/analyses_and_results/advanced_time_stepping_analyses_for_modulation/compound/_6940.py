...
class SynchroniserPartCompoundAdvancedTimeSteppingAnalysisForModulation(_6864.CouplingHalfCompoundAdvancedTimeSteppingAnalysisForModulation):
    '''SynchroniserPartCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6811.SynchroniserPartAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6811.SynchroniserPartAdvancedTimeSteppingAnalysisForModulation))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_6811.SynchroniserPartAdvancedTimeSteppingAnalysisForModulation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6811.SynchroniserPartAdvancedTimeSteppingAnalysisForModulation))
        return value
