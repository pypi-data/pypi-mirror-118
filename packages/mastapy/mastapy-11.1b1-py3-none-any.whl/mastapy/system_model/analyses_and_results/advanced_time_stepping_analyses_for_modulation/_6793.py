...
class ShaftToMountableComponentConnectionAdvancedTimeSteppingAnalysisForModulation(_6694.AbstractShaftToMountableComponentConnectionAdvancedTimeSteppingAnalysisForModulation):
    '''ShaftToMountableComponentConnectionAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def connection_design(self) -> '_2004.ShaftToMountableComponentConnection':
    ...
    @property
    def system_deflection_results(self) -> '_2507.ShaftToMountableComponentConnectionSystemDeflection':
