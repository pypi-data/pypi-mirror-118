...
class FaceGearAdvancedTimeSteppingAnalysisForModulation(_6753.GearAdvancedTimeSteppingAnalysisForModulation):
    '''FaceGearAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2458.FaceGearSystemDeflection':
        ...
        return constructor.new(_2458.FaceGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
