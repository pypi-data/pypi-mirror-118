...
class HypoidGearMeshAdvancedTimeSteppingAnalysisForModulation(_6699.AGMAGleasonConicalGearMeshAdvancedTimeSteppingAnalysisForModulation):
    '''HypoidGearMeshAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def system_deflection_results(self) -> '_2465.HypoidGearMeshSystemDeflection':
        ...
        return constructor.new(_2465.HypoidGearMeshSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
