...
class MeasurementComponentAdvancedTimeSteppingAnalysisForModulation(_6818.VirtualComponentAdvancedTimeSteppingAnalysisForModulation):
    '''MeasurementComponentAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_load_case(self) -> '_6606.MeasurementComponentLoadCase':
        ...
        return constructor.new(_6606.MeasurementComponentLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None

    @property
    def system_deflection_results(self) -> '_2482.MeasurementComponentSystemDeflection':
        ...
        return constructor.new(_2482.MeasurementComponentSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
