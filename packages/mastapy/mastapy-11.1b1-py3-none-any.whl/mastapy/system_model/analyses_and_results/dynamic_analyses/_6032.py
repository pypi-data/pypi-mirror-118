...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6030, _6031, _6029
...
class KlingelnbergCycloPalloidHypoidGearSetDynamicAnalysis(_6029.KlingelnbergCycloPalloidConicalGearSetDynamicAnalysis):
    '''KlingelnbergCycloPalloidHypoidGearSetDynamicAnalysis
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_dynamic_analysis(self) -> 'List[_6030.KlingelnbergCycloPalloidHypoidGearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergCycloPalloidHypoidGearsDynamicAnalysis, constructor.new(_6030.KlingelnbergCycloPalloidHypoidGearDynamicAnalysis))
        return value

    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_dynamic_analysis(self) -> 'List[_6031.KlingelnbergCycloPalloidHypoidGearMeshDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergCycloPalloidHypoidMeshesDynamicAnalysis, constructor.new(_6031.KlingelnbergCycloPalloidHypoidGearMeshDynamicAnalysis))
        return value
