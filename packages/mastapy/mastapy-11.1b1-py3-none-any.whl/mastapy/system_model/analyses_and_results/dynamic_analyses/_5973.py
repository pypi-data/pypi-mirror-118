...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _5971, _5972, _5978
...
class BevelDifferentialGearSetDynamicAnalysis(_5978.BevelGearSetDynamicAnalysis):
    '''BevelDifferentialGearSetDynamicAnalysis
    ...
    @property
    def bevel_differential_gears_dynamic_analysis(self) -> 'List[_5971.BevelDifferentialGearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelDifferentialGearsDynamicAnalysis, constructor.new(_5971.BevelDifferentialGearDynamicAnalysis))
        return value

    @property
    def bevel_differential_meshes_dynamic_analysis(self) -> 'List[_5972.BevelDifferentialGearMeshDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelDifferentialMeshesDynamicAnalysis, constructor.new(_5972.BevelDifferentialGearMeshDynamicAnalysis))
        return value
