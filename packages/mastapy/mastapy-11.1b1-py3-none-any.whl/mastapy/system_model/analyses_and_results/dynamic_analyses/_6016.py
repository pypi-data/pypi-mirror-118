...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6014, _6015, _6021
...
class FaceGearSetDynamicAnalysis(_6021.GearSetDynamicAnalysis):
    '''FaceGearSetDynamicAnalysis
    ...
    @property
    def face_gears_dynamic_analysis(self) -> 'List[_6014.FaceGearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGearsDynamicAnalysis, constructor.new(_6014.FaceGearDynamicAnalysis))
        return value

    @property
    def face_meshes_dynamic_analysis(self) -> 'List[_6015.FaceGearMeshDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshesDynamicAnalysis, constructor.new(_6015.FaceGearMeshDynamicAnalysis))
        return value
