...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6149
...
class CylindricalGearMeshCompoundDynamicAnalysis(_6149.GearMeshCompoundDynamicAnalysis):
    '''CylindricalGearMeshCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6008.CylindricalGearMeshDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_6008.CylindricalGearMeshDynamicAnalysis))
        return value
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6008.CylindricalGearMeshDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_6008.CylindricalGearMeshDynamicAnalysis))
        return value
