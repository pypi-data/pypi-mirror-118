...
class SpringDamperCompoundDynamicAnalysis(_6127.CouplingCompoundDynamicAnalysis):
    '''SpringDamperCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6064.SpringDamperDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_6064.SpringDamperDynamicAnalysis))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_6064.SpringDamperDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_6064.SpringDamperDynamicAnalysis))
        return value
