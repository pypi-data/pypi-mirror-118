...
class BevelDifferentialGearCompoundDynamicAnalysis(_6106.BevelGearCompoundDynamicAnalysis):
    '''BevelDifferentialGearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5971.BevelDifferentialGearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5971.BevelDifferentialGearDynamicAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_5971.BevelDifferentialGearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5971.BevelDifferentialGearDynamicAnalysis))
        return value
