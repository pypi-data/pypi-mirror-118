...
class SynchroniserPartCompoundDynamicAnalysis(_6129.CouplingHalfCompoundDynamicAnalysis):
    '''SynchroniserPartCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6076.SynchroniserPartDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6076.SynchroniserPartDynamicAnalysis))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_6076.SynchroniserPartDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6076.SynchroniserPartDynamicAnalysis))
        return value
