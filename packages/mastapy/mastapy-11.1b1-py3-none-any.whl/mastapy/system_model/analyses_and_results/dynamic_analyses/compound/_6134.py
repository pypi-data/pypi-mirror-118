...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6114
...
class CycloidalDiscCentralBearingConnectionCompoundDynamicAnalysis(_6114.CoaxialConnectionCompoundDynamicAnalysis):
    '''CycloidalDiscCentralBearingConnectionCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6004.CycloidalDiscCentralBearingConnectionDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_6004.CycloidalDiscCentralBearingConnectionDynamicAnalysis))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_6004.CycloidalDiscCentralBearingConnectionDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_6004.CycloidalDiscCentralBearingConnectionDynamicAnalysis))
        return value
