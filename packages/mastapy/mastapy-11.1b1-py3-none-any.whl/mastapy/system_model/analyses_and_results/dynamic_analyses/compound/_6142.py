...
class ExternalCADModelCompoundDynamicAnalysis(_6115.ComponentCompoundDynamicAnalysis):
    '''ExternalCADModelCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6013.ExternalCADModelDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6013.ExternalCADModelDynamicAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_6013.ExternalCADModelDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6013.ExternalCADModelDynamicAnalysis))
        return value
