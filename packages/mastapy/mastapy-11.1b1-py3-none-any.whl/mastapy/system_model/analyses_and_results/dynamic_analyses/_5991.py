...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _5989, _5990, _6021
...
class ConceptGearSetDynamicAnalysis(_6021.GearSetDynamicAnalysis):
    '''ConceptGearSetDynamicAnalysis
    ...
    @property
    def concept_gears_dynamic_analysis(self) -> 'List[_5989.ConceptGearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearsDynamicAnalysis, constructor.new(_5989.ConceptGearDynamicAnalysis))
        return value

    @property
    def concept_meshes_dynamic_analysis(self) -> 'List[_5990.ConceptGearMeshDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshesDynamicAnalysis, constructor.new(_5990.ConceptGearMeshDynamicAnalysis))
        return value
