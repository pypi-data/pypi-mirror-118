...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6084, _6085, _6021
...
class WormGearSetDynamicAnalysis(_6021.GearSetDynamicAnalysis):
    '''WormGearSetDynamicAnalysis
    ...
    @property
    def worm_gears_dynamic_analysis(self) -> 'List[_6084.WormGearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsDynamicAnalysis, constructor.new(_6084.WormGearDynamicAnalysis))
        return value

    @property
    def worm_meshes_dynamic_analysis(self) -> 'List[_6085.WormGearMeshDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesDynamicAnalysis, constructor.new(_6085.WormGearMeshDynamicAnalysis))
        return value
