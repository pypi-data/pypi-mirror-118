...
class KlingelnbergCycloPalloidConicalGearSetCompoundModalAnalysis(_4974.ConicalGearSetCompoundModalAnalysis):
    '''KlingelnbergCycloPalloidConicalGearSetCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4857.KlingelnbergCycloPalloidConicalGearSetModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_4857.KlingelnbergCycloPalloidConicalGearSetModalAnalysis))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4857.KlingelnbergCycloPalloidConicalGearSetModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_4857.KlingelnbergCycloPalloidConicalGearSetModalAnalysis))
        return value
