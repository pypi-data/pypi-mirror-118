...
class CVTPulleyCompoundModalAnalysis(_5028.PulleyCompoundModalAnalysis):
    '''CVTPulleyCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4830.CVTPulleyModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4830.CVTPulleyModalAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4830.CVTPulleyModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4830.CVTPulleyModalAnalysis))
        return value
