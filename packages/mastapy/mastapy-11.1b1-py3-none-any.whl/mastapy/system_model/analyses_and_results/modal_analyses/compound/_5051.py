...
class StraightBevelPlanetGearCompoundModalAnalysis(_5045.StraightBevelDiffGearCompoundModalAnalysis):
    '''StraightBevelPlanetGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4905.StraightBevelPlanetGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4905.StraightBevelPlanetGearModalAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4905.StraightBevelPlanetGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4905.StraightBevelPlanetGearModalAnalysis))
        return value
