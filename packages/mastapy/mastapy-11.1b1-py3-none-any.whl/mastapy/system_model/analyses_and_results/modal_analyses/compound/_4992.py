...
class ExternalCADModelCompoundModalAnalysis(_4965.ComponentCompoundModalAnalysis):
    '''ExternalCADModelCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4840.ExternalCADModelModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4840.ExternalCADModelModalAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4840.ExternalCADModelModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4840.ExternalCADModelModalAnalysis))
        return value
