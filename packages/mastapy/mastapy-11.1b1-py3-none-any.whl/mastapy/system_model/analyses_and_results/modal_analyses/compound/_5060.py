...
class TorqueConverterTurbineCompoundModalAnalysis(_4979.CouplingHalfCompoundModalAnalysis):
    '''TorqueConverterTurbineCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4914.TorqueConverterTurbineModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4914.TorqueConverterTurbineModalAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4914.TorqueConverterTurbineModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4914.TorqueConverterTurbineModalAnalysis))
        return value
