...
from mastapy.system_model.analyses_and_results.modal_analyses.reporting import _4939, _4936, _4938
...
class PartModalAnalysis(_7232.PartStaticLoadAnalysisCase):
    '''PartModalAnalysis
    ...
    @property
    def results_for_modes(self) -> 'List[_4939.SingleModeResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ResultsForModes, constructor.new(_4939.SingleModeResults))
        return value

    @property
    def shaft_excitation_details(self) -> 'List[_4936.RigidlyConnectedDesignEntityGroupModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftExcitationDetails, constructor.new(_4936.RigidlyConnectedDesignEntityGroupModalAnalysis))
        return value

    @property
    def gear_mesh_excitation_details(self) -> 'List[_4936.RigidlyConnectedDesignEntityGroupModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearMeshExcitationDetails, constructor.new(_4936.RigidlyConnectedDesignEntityGroupModalAnalysis))
        return value
    ...
    def create_viewable(self) -> '_1959.ModalAnalysisViewable':
