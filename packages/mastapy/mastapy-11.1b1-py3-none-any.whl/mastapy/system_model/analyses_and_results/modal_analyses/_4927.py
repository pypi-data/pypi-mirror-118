...
from mastapy.system_model.analyses_and_results.modal_analyses import _4926, _4925, _4805
...
class ZerolBevelGearSetModalAnalysis(_4805.BevelGearSetModalAnalysis):
    '''ZerolBevelGearSetModalAnalysis
    ...
    @property
    def zerol_bevel_gears_modal_analysis(self) -> 'List[_4926.ZerolBevelGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelGearsModalAnalysis, constructor.new(_4926.ZerolBevelGearModalAnalysis))
        return value

    @property
    def zerol_bevel_meshes_modal_analysis(self) -> 'List[_4925.ZerolBevelGearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelMeshesModalAnalysis, constructor.new(_4925.ZerolBevelGearMeshModalAnalysis))
        return value
