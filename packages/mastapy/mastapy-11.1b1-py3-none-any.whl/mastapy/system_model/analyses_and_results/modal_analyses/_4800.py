...
from mastapy.system_model.analyses_and_results.modal_analyses import _4799, _4798, _4805
...
class BevelDifferentialGearSetModalAnalysis(_4805.BevelGearSetModalAnalysis):
    '''BevelDifferentialGearSetModalAnalysis
    ...
    @property
    def bevel_differential_gears_modal_analysis(self) -> 'List[_4799.BevelDifferentialGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelDifferentialGearsModalAnalysis, constructor.new(_4799.BevelDifferentialGearModalAnalysis))
        return value

    @property
    def bevel_differential_meshes_modal_analysis(self) -> 'List[_4798.BevelDifferentialGearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelDifferentialMeshesModalAnalysis, constructor.new(_4798.BevelDifferentialGearMeshModalAnalysis))
        return value
