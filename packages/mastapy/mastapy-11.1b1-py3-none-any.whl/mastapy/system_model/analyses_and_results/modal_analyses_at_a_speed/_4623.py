...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _2343, _4536
...
class RootAssemblyModalAnalysisAtASpeed(_4536.AssemblyModalAnalysisAtASpeed):
    '''RootAssemblyModalAnalysisAtASpeed
    ...
    @property
    def modal_analysis_at_a_speed_inputs(self) -> '_2343.ModalAnalysisAtASpeed':
        ...
        return constructor.new(_2343.ModalAnalysisAtASpeed)(self.wrapped.ModalAnalysisAtASpeedInputs) if self.wrapped.ModalAnalysisAtASpeedInputs else None
