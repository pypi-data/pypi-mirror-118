...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4638, _4637, _4547
...
class StraightBevelGearSetModalAnalysisAtASpeed(_4547.BevelGearSetModalAnalysisAtASpeed):
    '''StraightBevelGearSetModalAnalysisAtASpeed
    ...
    @property
    def straight_bevel_gears_modal_analysis_at_a_speed(self) -> 'List[_4638.StraightBevelGearModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelGearsModalAnalysisAtASpeed, constructor.new(_4638.StraightBevelGearModalAnalysisAtASpeed))
        return value

    @property
    def straight_bevel_meshes_modal_analysis_at_a_speed(self) -> 'List[_4637.StraightBevelGearMeshModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelMeshesModalAnalysisAtASpeed, constructor.new(_4637.StraightBevelGearMeshModalAnalysisAtASpeed))
        return value
