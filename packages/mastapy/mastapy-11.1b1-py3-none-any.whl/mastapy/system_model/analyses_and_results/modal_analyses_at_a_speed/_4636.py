...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4635, _4634, _4547
...
class StraightBevelDiffGearSetModalAnalysisAtASpeed(_4547.BevelGearSetModalAnalysisAtASpeed):
    '''StraightBevelDiffGearSetModalAnalysisAtASpeed
    ...
    @property
    def straight_bevel_diff_gears_modal_analysis_at_a_speed(self) -> 'List[_4635.StraightBevelDiffGearModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffGearsModalAnalysisAtASpeed, constructor.new(_4635.StraightBevelDiffGearModalAnalysisAtASpeed))
        return value

    @property
    def straight_bevel_diff_meshes_modal_analysis_at_a_speed(self) -> 'List[_4634.StraightBevelDiffGearMeshModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshesModalAnalysisAtASpeed, constructor.new(_4634.StraightBevelDiffGearMeshModalAnalysisAtASpeed))
        return value
