...
class AGMAGleasonConicalGearSetCompoundModalAnalysisAtASpeed(_4692.ConicalGearSetCompoundModalAnalysisAtASpeed):
    '''AGMAGleasonConicalGearSetCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4535.AGMAGleasonConicalGearSetModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_4535.AGMAGleasonConicalGearSetModalAnalysisAtASpeed))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4535.AGMAGleasonConicalGearSetModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_4535.AGMAGleasonConicalGearSetModalAnalysisAtASpeed))
        return value
