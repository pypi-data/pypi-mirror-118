...
class StraightBevelSunGearCompoundModalAnalysisAtASpeed(_4763.StraightBevelDiffGearCompoundModalAnalysisAtASpeed):
    '''StraightBevelSunGearCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4641.StraightBevelSunGearModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4641.StraightBevelSunGearModalAnalysisAtASpeed))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4641.StraightBevelSunGearModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4641.StraightBevelSunGearModalAnalysisAtASpeed))
        return value
