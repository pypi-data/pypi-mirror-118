...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4583, _4582, _4589
...
class FaceGearSetModalAnalysisAtASpeed(_4589.GearSetModalAnalysisAtASpeed):
    '''FaceGearSetModalAnalysisAtASpeed
    ...
    @property
    def face_gears_modal_analysis_at_a_speed(self) -> 'List[_4583.FaceGearModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGearsModalAnalysisAtASpeed, constructor.new(_4583.FaceGearModalAnalysisAtASpeed))
        return value

    @property
    def face_meshes_modal_analysis_at_a_speed(self) -> 'List[_4582.FaceGearMeshModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshesModalAnalysisAtASpeed, constructor.new(_4582.FaceGearMeshModalAnalysisAtASpeed))
        return value
