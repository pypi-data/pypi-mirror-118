...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _4653, _4652, _4589
...
class WormGearSetModalAnalysisAtASpeed(_4589.GearSetModalAnalysisAtASpeed):
    '''WormGearSetModalAnalysisAtASpeed
    ...
    @property
    def worm_gears_modal_analysis_at_a_speed(self) -> 'List[_4653.WormGearModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsModalAnalysisAtASpeed, constructor.new(_4653.WormGearModalAnalysisAtASpeed))
        return value

    @property
    def worm_meshes_modal_analysis_at_a_speed(self) -> 'List[_4652.WormGearMeshModalAnalysisAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesModalAnalysisAtASpeed, constructor.new(_4652.WormGearMeshModalAnalysisAtASpeed))
        return value
