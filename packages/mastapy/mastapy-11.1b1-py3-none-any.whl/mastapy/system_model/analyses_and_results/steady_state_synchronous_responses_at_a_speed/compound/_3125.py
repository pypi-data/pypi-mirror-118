...
class DatumCompoundSteadyStateSynchronousResponseAtASpeed(_3099.ComponentCompoundSteadyStateSynchronousResponseAtASpeed):
    '''DatumCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2995.DatumSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2995.DatumSteadyStateSynchronousResponseAtASpeed))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_2995.DatumSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2995.DatumSteadyStateSynchronousResponseAtASpeed))
        return value
