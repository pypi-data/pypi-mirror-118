...
class CouplingCompoundSteadyStateSynchronousResponseAtASpeed(_3172.SpecialisedAssemblyCompoundSteadyStateSynchronousResponseAtASpeed):
    '''CouplingCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2983.CouplingSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_2983.CouplingSteadyStateSynchronousResponseAtASpeed))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2983.CouplingSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_2983.CouplingSteadyStateSynchronousResponseAtASpeed))
        return value
