...
class VirtualComponentCompoundSteadyStateSynchronousResponseAtASpeed(_3151.MountableComponentCompoundSteadyStateSynchronousResponseAtASpeed):
    '''VirtualComponentCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3067.VirtualComponentSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3067.VirtualComponentSteadyStateSynchronousResponseAtASpeed))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_3067.VirtualComponentSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3067.VirtualComponentSteadyStateSynchronousResponseAtASpeed))
        return value
