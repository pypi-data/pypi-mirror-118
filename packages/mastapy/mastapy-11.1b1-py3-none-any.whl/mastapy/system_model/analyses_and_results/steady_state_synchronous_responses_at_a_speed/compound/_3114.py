...
class CVTBeltConnectionCompoundSteadyStateSynchronousResponseAtASpeed(_3083.BeltConnectionCompoundSteadyStateSynchronousResponseAtASpeed):
    '''CVTBeltConnectionCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2984.CVTBeltConnectionSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_2984.CVTBeltConnectionSteadyStateSynchronousResponseAtASpeed))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_2984.CVTBeltConnectionSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_2984.CVTBeltConnectionSteadyStateSynchronousResponseAtASpeed))
        return value
