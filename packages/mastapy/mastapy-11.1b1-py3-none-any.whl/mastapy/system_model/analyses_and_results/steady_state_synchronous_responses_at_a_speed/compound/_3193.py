...
class TorqueConverterPumpCompoundSteadyStateSynchronousResponseAtASpeed(_3113.CouplingHalfCompoundSteadyStateSynchronousResponseAtASpeed):
    '''TorqueConverterPumpCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3063.TorqueConverterPumpSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3063.TorqueConverterPumpSteadyStateSynchronousResponseAtASpeed))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3063.TorqueConverterPumpSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3063.TorqueConverterPumpSteadyStateSynchronousResponseAtASpeed))
        return value
