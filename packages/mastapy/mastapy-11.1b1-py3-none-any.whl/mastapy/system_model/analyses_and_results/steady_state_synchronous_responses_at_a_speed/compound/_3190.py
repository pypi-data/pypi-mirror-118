...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses_at_a_speed.compound import _3189
...
class SynchroniserSleeveCompoundSteadyStateSynchronousResponseAtASpeed(_3189.SynchroniserPartCompoundSteadyStateSynchronousResponseAtASpeed):
    '''SynchroniserSleeveCompoundSteadyStateSynchronousResponseAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3060.SynchroniserSleeveSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3060.SynchroniserSleeveSteadyStateSynchronousResponseAtASpeed))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3060.SynchroniserSleeveSteadyStateSynchronousResponseAtASpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3060.SynchroniserSleeveSteadyStateSynchronousResponseAtASpeed))
        return value
