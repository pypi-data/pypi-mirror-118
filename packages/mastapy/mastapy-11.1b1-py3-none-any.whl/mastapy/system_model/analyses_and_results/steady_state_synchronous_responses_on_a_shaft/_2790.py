...
class SteadyStateSynchronousResponseOnAShaft(_7234.StaticLoadAnalysisCase):
    '''SteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def options(self) -> '_3311.SteadyStateSynchronousResponseOptions':
        ...
        return constructor.new(_3311.SteadyStateSynchronousResponseOptions)(self.wrapped.Options) if self.wrapped.Options else None
