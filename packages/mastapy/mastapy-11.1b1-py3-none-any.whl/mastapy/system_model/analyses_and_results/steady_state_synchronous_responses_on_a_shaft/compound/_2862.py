...
class CylindricalGearCompoundSteadyStateSynchronousResponseOnAShaft(_2873.GearCompoundSteadyStateSynchronousResponseOnAShaft):
    '''CylindricalGearCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2734.CylindricalGearSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2734.CylindricalGearSteadyStateSynchronousResponseOnAShaft))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2734.CylindricalGearSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2734.CylindricalGearSteadyStateSynchronousResponseOnAShaft))
        return value
