...
class StraightBevelDiffGearCompoundSteadyStateSynchronousResponseOnAShaft(_2831.BevelGearCompoundSteadyStateSynchronousResponseOnAShaft):
    '''StraightBevelDiffGearCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2793.StraightBevelDiffGearSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2793.StraightBevelDiffGearSteadyStateSynchronousResponseOnAShaft))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_2793.StraightBevelDiffGearSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2793.StraightBevelDiffGearSteadyStateSynchronousResponseOnAShaft))
        return value
