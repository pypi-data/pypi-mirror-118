...
class BevelDifferentialPlanetGearCompoundSteadyStateSynchronousResponseOnAShaft(_2826.BevelDifferentialGearCompoundSteadyStateSynchronousResponseOnAShaft):
    '''BevelDifferentialPlanetGearCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2699.BevelDifferentialPlanetGearSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2699.BevelDifferentialPlanetGearSteadyStateSynchronousResponseOnAShaft))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_2699.BevelDifferentialPlanetGearSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2699.BevelDifferentialPlanetGearSteadyStateSynchronousResponseOnAShaft))
        return value
