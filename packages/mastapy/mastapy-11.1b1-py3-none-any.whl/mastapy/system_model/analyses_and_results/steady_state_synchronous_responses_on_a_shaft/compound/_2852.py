...
class CouplingCompoundSteadyStateSynchronousResponseOnAShaft(_2913.SpecialisedAssemblyCompoundSteadyStateSynchronousResponseOnAShaft):
    '''CouplingCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_2724.CouplingSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_2724.CouplingSteadyStateSynchronousResponseOnAShaft))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2724.CouplingSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_2724.CouplingSteadyStateSynchronousResponseOnAShaft))
        return value
