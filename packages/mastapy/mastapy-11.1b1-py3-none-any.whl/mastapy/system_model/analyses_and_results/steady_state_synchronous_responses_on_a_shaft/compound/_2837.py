...
class ClutchConnectionCompoundSteadyStateSynchronousResponseOnAShaft(_2853.CouplingConnectionCompoundSteadyStateSynchronousResponseOnAShaft):
    '''ClutchConnectionCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2706.ClutchConnectionSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_2706.ClutchConnectionSteadyStateSynchronousResponseOnAShaft))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_2706.ClutchConnectionSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_2706.ClutchConnectionSteadyStateSynchronousResponseOnAShaft))
        return value
