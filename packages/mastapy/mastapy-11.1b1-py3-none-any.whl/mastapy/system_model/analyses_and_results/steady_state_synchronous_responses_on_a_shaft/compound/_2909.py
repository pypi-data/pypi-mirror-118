...
class RootAssemblyCompoundSteadyStateSynchronousResponseOnAShaft(_2822.AssemblyCompoundSteadyStateSynchronousResponseOnAShaft):
    '''RootAssemblyCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2779.RootAssemblySteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_2779.RootAssemblySteadyStateSynchronousResponseOnAShaft))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_2779.RootAssemblySteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_2779.RootAssemblySteadyStateSynchronousResponseOnAShaft))
        return value
