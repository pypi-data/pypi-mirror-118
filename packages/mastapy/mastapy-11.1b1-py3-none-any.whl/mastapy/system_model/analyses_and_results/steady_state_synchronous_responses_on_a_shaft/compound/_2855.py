...
class CVTBeltConnectionCompoundSteadyStateSynchronousResponseOnAShaft(_2824.BeltConnectionCompoundSteadyStateSynchronousResponseOnAShaft):
    '''CVTBeltConnectionCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2725.CVTBeltConnectionSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_2725.CVTBeltConnectionSteadyStateSynchronousResponseOnAShaft))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_2725.CVTBeltConnectionSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_2725.CVTBeltConnectionSteadyStateSynchronousResponseOnAShaft))
        return value
