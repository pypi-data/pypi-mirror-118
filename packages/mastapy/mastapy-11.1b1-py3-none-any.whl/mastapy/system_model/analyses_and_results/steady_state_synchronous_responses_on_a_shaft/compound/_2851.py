...
class ConnectorCompoundSteadyStateSynchronousResponseOnAShaft(_2892.MountableComponentCompoundSteadyStateSynchronousResponseOnAShaft):
    '''ConnectorCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2721.ConnectorSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2721.ConnectorSteadyStateSynchronousResponseOnAShaft))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_2721.ConnectorSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2721.ConnectorSteadyStateSynchronousResponseOnAShaft))
        return value
