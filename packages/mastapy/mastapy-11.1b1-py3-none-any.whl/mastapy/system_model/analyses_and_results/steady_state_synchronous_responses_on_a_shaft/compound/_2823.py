...
class BearingCompoundSteadyStateSynchronousResponseOnAShaft(_2851.ConnectorCompoundSteadyStateSynchronousResponseOnAShaft):
    '''BearingCompoundSteadyStateSynchronousResponseOnAShaft
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2693.BearingSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2693.BearingSteadyStateSynchronousResponseOnAShaft))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2693.BearingSteadyStateSynchronousResponseOnAShaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2693.BearingSteadyStateSynchronousResponseOnAShaft))
        return value
