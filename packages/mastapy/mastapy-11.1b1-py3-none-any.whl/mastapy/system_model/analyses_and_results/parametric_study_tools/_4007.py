...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4006, _4005, _4012
...
class BevelDifferentialGearSetParametricStudyTool(_4012.BevelGearSetParametricStudyTool):
    '''BevelDifferentialGearSetParametricStudyTool
    ...
    @property
    def bevel_differential_gears_parametric_study_tool(self) -> 'List[_4006.BevelDifferentialGearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelDifferentialGearsParametricStudyTool, constructor.new(_4006.BevelDifferentialGearParametricStudyTool))
        return value

    @property
    def bevel_differential_meshes_parametric_study_tool(self) -> 'List[_4005.BevelDifferentialGearMeshParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelDifferentialMeshesParametricStudyTool, constructor.new(_4005.BevelDifferentialGearMeshParametricStudyTool))
        return value
