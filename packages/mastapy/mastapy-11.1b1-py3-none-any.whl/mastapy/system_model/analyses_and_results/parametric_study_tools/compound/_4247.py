...
class StraightBevelDiffGearMeshCompoundParametricStudyTool(_4158.BevelGearMeshCompoundParametricStudyTool):
    '''StraightBevelDiffGearMeshCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4117.StraightBevelDiffGearMeshParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4117.StraightBevelDiffGearMeshParametricStudyTool))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_4117.StraightBevelDiffGearMeshParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4117.StraightBevelDiffGearMeshParametricStudyTool))
        return value
