...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4088, _4087, _4106
from mastapy._internal import constructor, conversion
from mastapy.system_model.analyses_and_results.load_case_groups import (
    _5351, _5350, _5352, _5355,
    _5356, _5359, _5363
)
...
class RootAssemblyCompoundParametricStudyTool(_4148.AssemblyCompoundParametricStudyTool):
    '''RootAssemblyCompoundParametricStudyTool
    ...
    @property
    def parametric_analysis_options(self) -> '_4087.ParametricStudyToolOptions':
        ...
        return constructor.new(_4087.ParametricStudyToolOptions)(self.wrapped.ParametricAnalysisOptions) if self.wrapped.ParametricAnalysisOptions else None

    @property
    def compound_load_case(self) -> '_5351.AbstractLoadCaseGroup':
        ...
        if _5351.AbstractLoadCaseGroup.TYPE not in self.wrapped.CompoundLoadCase.__class__.__mro__:
    ...
    @property
    def compound_load_case_of_type_abstract_design_state_load_case_group(self) -> '_5350.AbstractDesignStateLoadCaseGroup':
        ...
        if _5350.AbstractDesignStateLoadCaseGroup.TYPE not in self.wrapped.CompoundLoadCase.__class__.__mro__:
    ...
    @property
    def compound_load_case_of_type_abstract_static_load_case_group(self) -> '_5352.AbstractStaticLoadCaseGroup':
        ...
        if _5352.AbstractStaticLoadCaseGroup.TYPE not in self.wrapped.CompoundLoadCase.__class__.__mro__:
    ...
    @property
    def compound_load_case_of_type_design_state(self) -> '_5355.DesignState':
        ...
        if _5355.DesignState.TYPE not in self.wrapped.CompoundLoadCase.__class__.__mro__:
    ...
    @property
    def compound_load_case_of_type_duty_cycle(self) -> '_5356.DutyCycle':
        ...
        if _5356.DutyCycle.TYPE not in self.wrapped.CompoundLoadCase.__class__.__mro__:
    ...
    @property
    def compound_load_case_of_type_sub_group_in_single_design_state(self) -> '_5359.SubGroupInSingleDesignState':
        ...
        if _5359.SubGroupInSingleDesignState.TYPE not in self.wrapped.CompoundLoadCase.__class__.__mro__:
    ...
    @property
    def compound_load_case_of_type_time_series_load_case_group(self) -> '_5363.TimeSeriesLoadCaseGroup':
        ...
        if _5363.TimeSeriesLoadCaseGroup.TYPE not in self.wrapped.CompoundLoadCase.__class__.__mro__:
    ...
    @property
    def root_assembly_duty_cycle_results(self) -> '_2605.DutyCycleEfficiencyResults':
        ...
        return constructor.new(_2605.DutyCycleEfficiencyResults)(self.wrapped.RootAssemblyDutyCycleResults) if self.wrapped.RootAssemblyDutyCycleResults else None

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4106.RootAssemblyParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_4106.RootAssemblyParametricStudyTool))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_4106.RootAssemblyParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_4106.RootAssemblyParametricStudyTool))
        return value
