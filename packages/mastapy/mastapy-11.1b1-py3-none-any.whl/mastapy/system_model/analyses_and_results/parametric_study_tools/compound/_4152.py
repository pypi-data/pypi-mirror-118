...
class BevelDifferentialGearCompoundParametricStudyTool(_4157.BevelGearCompoundParametricStudyTool):
    '''BevelDifferentialGearCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4006.BevelDifferentialGearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4006.BevelDifferentialGearParametricStudyTool))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4006.BevelDifferentialGearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4006.BevelDifferentialGearParametricStudyTool))
        return value
