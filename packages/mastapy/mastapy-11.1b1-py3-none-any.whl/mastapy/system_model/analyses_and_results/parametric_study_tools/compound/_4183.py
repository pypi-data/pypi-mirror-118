...
class CVTPulleyCompoundParametricStudyTool(_4229.PulleyCompoundParametricStudyTool):
    '''CVTPulleyCompoundParametricStudyTool
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4036.CVTPulleyParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_4036.CVTPulleyParametricStudyTool))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_4036.CVTPulleyParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_4036.CVTPulleyParametricStudyTool))
        return value
