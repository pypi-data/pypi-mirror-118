...
class CylindricalGearMeshCompoundParametricStudyTool(_4200.GearMeshCompoundParametricStudyTool):
    '''CylindricalGearMeshCompoundParametricStudyTool
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4041.CylindricalGearMeshParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_4041.CylindricalGearMeshParametricStudyTool))
        return value
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4041.CylindricalGearMeshParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_4041.CylindricalGearMeshParametricStudyTool))
        return value
