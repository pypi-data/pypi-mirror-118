...
class PartToPartShearCouplingCompoundParametricStudyTool(_4178.CouplingCompoundParametricStudyTool):
    '''PartToPartShearCouplingCompoundParametricStudyTool
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4094.PartToPartShearCouplingParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_4094.PartToPartShearCouplingParametricStudyTool))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_4094.PartToPartShearCouplingParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_4094.PartToPartShearCouplingParametricStudyTool))
        return value
