...
from mastapy.system_model.analyses_and_results.stability_analyses import _3593, _3591, _3525
...
class WormGearSetStabilityAnalysis(_3525.GearSetStabilityAnalysis):
    '''WormGearSetStabilityAnalysis
    ...
    @property
    def worm_gears_stability_analysis(self) -> 'List[_3593.WormGearStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsStabilityAnalysis, constructor.new(_3593.WormGearStabilityAnalysis))
        return value

    @property
    def worm_meshes_stability_analysis(self) -> 'List[_3591.WormGearMeshStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesStabilityAnalysis, constructor.new(_3591.WormGearMeshStabilityAnalysis))
        return value
