...
from mastapy.system_model.analyses_and_results.stability_analyses import _3575, _3573, _3482
...
class StraightBevelDiffGearSetStabilityAnalysis(_3482.BevelGearSetStabilityAnalysis):
    '''StraightBevelDiffGearSetStabilityAnalysis
    ...
    @property
    def straight_bevel_diff_gears_stability_analysis(self) -> 'List[_3575.StraightBevelDiffGearStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffGearsStabilityAnalysis, constructor.new(_3575.StraightBevelDiffGearStabilityAnalysis))
        return value

    @property
    def straight_bevel_diff_meshes_stability_analysis(self) -> 'List[_3573.StraightBevelDiffGearMeshStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshesStabilityAnalysis, constructor.new(_3573.StraightBevelDiffGearMeshStabilityAnalysis))
        return value
