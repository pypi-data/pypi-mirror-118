...
class MeasurementComponentCompoundStabilityAnalysis(_3719.VirtualComponentCompoundStabilityAnalysis):
    '''MeasurementComponentCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3542.MeasurementComponentStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3542.MeasurementComponentStabilityAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3542.MeasurementComponentStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3542.MeasurementComponentStabilityAnalysis))
        return value
