...
from mastapy.system_model.analyses_and_results.stability_analyses import _3530, _3528, _3470
...
class HypoidGearSetStabilityAnalysis(_3470.AGMAGleasonConicalGearSetStabilityAnalysis):
    '''HypoidGearSetStabilityAnalysis
    ...
    @property
    def hypoid_gears_stability_analysis(self) -> 'List[_3530.HypoidGearStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidGearsStabilityAnalysis, constructor.new(_3530.HypoidGearStabilityAnalysis))
        return value

    @property
    def hypoid_meshes_stability_analysis(self) -> 'List[_3528.HypoidGearMeshStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidMeshesStabilityAnalysis, constructor.new(_3528.HypoidGearMeshStabilityAnalysis))
        return value
