...
class MeasurementComponentCompoundPowerFlow(_3987.VirtualComponentCompoundPowerFlow):
    '''MeasurementComponentCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3809.MeasurementComponentPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3809.MeasurementComponentPowerFlow))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3809.MeasurementComponentPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3809.MeasurementComponentPowerFlow))
        return value
