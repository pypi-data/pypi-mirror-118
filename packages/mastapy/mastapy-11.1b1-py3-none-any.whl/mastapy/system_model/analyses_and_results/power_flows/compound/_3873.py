...
class BearingCompoundPowerFlow(_3901.ConnectorCompoundPowerFlow):
    '''BearingCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3740.BearingPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3740.BearingPowerFlow))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3740.BearingPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3740.BearingPowerFlow))
        return value
