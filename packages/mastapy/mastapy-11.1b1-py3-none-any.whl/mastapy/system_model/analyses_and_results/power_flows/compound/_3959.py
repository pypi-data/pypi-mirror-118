...
class RootAssemblyCompoundPowerFlow(_3872.AssemblyCompoundPowerFlow):
    '''RootAssemblyCompoundPowerFlow
    ...
    @property
    def compound_static_load(self) -> '_5352.AbstractStaticLoadCaseGroup':
        ...
        if _5352.AbstractStaticLoadCaseGroup.TYPE not in self.wrapped.CompoundStaticLoad.__class__.__mro__:
    ...
    @property
    def compound_static_load_of_type_abstract_design_state_load_case_group(self) -> '_5350.AbstractDesignStateLoadCaseGroup':
        ...
        if _5350.AbstractDesignStateLoadCaseGroup.TYPE not in self.wrapped.CompoundStaticLoad.__class__.__mro__:
    ...
    @property
    def compound_static_load_of_type_design_state(self) -> '_5355.DesignState':
        ...
        if _5355.DesignState.TYPE not in self.wrapped.CompoundStaticLoad.__class__.__mro__:
    ...
    @property
    def compound_static_load_of_type_duty_cycle(self) -> '_5356.DutyCycle':
        ...
        if _5356.DutyCycle.TYPE not in self.wrapped.CompoundStaticLoad.__class__.__mro__:
    ...
    @property
    def compound_static_load_of_type_sub_group_in_single_design_state(self) -> '_5359.SubGroupInSingleDesignState':
        ...
        if _5359.SubGroupInSingleDesignState.TYPE not in self.wrapped.CompoundStaticLoad.__class__.__mro__:
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3829.RootAssemblyPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_3829.RootAssemblyPowerFlow))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_3829.RootAssemblyPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_3829.RootAssemblyPowerFlow))
        return value
