...
class BevelDifferentialGearMeshCompoundPowerFlow(_3882.BevelGearMeshCompoundPowerFlow):
    '''BevelDifferentialGearMeshCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3743.BevelDifferentialGearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_3743.BevelDifferentialGearMeshPowerFlow))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_3743.BevelDifferentialGearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_3743.BevelDifferentialGearMeshPowerFlow))
        return value
