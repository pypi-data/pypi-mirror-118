...
class PlanetCarrierCompoundPowerFlow(_3942.MountableComponentCompoundPowerFlow):
    '''PlanetCarrierCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3818.PlanetCarrierPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3818.PlanetCarrierPowerFlow))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3818.PlanetCarrierPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3818.PlanetCarrierPowerFlow))
        return value
