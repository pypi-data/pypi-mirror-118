...
class KlingelnbergCycloPalloidConicalGearSetCompoundPowerFlow(_3899.ConicalGearSetCompoundPowerFlow):
    '''KlingelnbergCycloPalloidConicalGearSetCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3801.KlingelnbergCycloPalloidConicalGearSetPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_3801.KlingelnbergCycloPalloidConicalGearSetPowerFlow))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3801.KlingelnbergCycloPalloidConicalGearSetPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_3801.KlingelnbergCycloPalloidConicalGearSetPowerFlow))
        return value
