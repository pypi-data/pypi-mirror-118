...
class BevelDifferentialPlanetGearCompoundPowerFlow(_3876.BevelDifferentialGearCompoundPowerFlow):
    '''BevelDifferentialPlanetGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3746.BevelDifferentialPlanetGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3746.BevelDifferentialPlanetGearPowerFlow))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3746.BevelDifferentialPlanetGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3746.BevelDifferentialPlanetGearPowerFlow))
        return value
