...
class CouplingHalfCompoundPowerFlow(_3942.MountableComponentCompoundPowerFlow):
    '''CouplingHalfCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3770.CouplingHalfPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3770.CouplingHalfPowerFlow))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_3770.CouplingHalfPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3770.CouplingHalfPowerFlow))
        return value
