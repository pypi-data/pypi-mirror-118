...
class GuideDxfModelCompoundPowerFlow(_3890.ComponentCompoundPowerFlow):
    '''GuideDxfModelCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3794.GuideDxfModelPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3794.GuideDxfModelPowerFlow))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3794.GuideDxfModelPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3794.GuideDxfModelPowerFlow))
        return value
