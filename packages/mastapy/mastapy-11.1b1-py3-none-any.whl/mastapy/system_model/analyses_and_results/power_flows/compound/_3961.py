...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3901
...
class ShaftHubConnectionCompoundPowerFlow(_3901.ConnectorCompoundPowerFlow):
    '''ShaftHubConnectionCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3830.ShaftHubConnectionPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3830.ShaftHubConnectionPowerFlow))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_3830.ShaftHubConnectionPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3830.ShaftHubConnectionPowerFlow))
        return value
