...
class ConnectorCompoundPowerFlow(_3942.MountableComponentCompoundPowerFlow):
    '''ConnectorCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3768.ConnectorPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3768.ConnectorPowerFlow))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_3768.ConnectorPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3768.ConnectorPowerFlow))
        return value
