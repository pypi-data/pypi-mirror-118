...
from mastapy.system_model.analyses_and_results.power_flows import _3744, _3743, _3750
...
class BevelDifferentialGearSetPowerFlow(_3750.BevelGearSetPowerFlow):
    '''BevelDifferentialGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self) -> 'List[_3744.BevelDifferentialGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearsPowerFlow, constructor.new(_3744.BevelDifferentialGearPowerFlow))
        return value

    @property
    def bevel_differential_gears_power_flow(self) -> 'List[_3744.BevelDifferentialGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelDifferentialGearsPowerFlow, constructor.new(_3744.BevelDifferentialGearPowerFlow))
        return value

    @property
    def meshes_power_flow(self) -> 'List[_3743.BevelDifferentialGearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshesPowerFlow, constructor.new(_3743.BevelDifferentialGearMeshPowerFlow))
        return value

    @property
    def bevel_differential_meshes_power_flow(self) -> 'List[_3743.BevelDifferentialGearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelDifferentialMeshesPowerFlow, constructor.new(_3743.BevelDifferentialGearMeshPowerFlow))
        return value
