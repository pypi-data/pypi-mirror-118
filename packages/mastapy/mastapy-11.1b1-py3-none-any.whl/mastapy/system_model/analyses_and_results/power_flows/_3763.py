...
from mastapy.system_model.analyses_and_results.power_flows import _3762, _3761, _3793
...
class ConceptGearSetPowerFlow(_3793.GearSetPowerFlow):
    '''ConceptGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self) -> 'List[_3762.ConceptGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearsPowerFlow, constructor.new(_3762.ConceptGearPowerFlow))
        return value

    @property
    def concept_gears_power_flow(self) -> 'List[_3762.ConceptGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearsPowerFlow, constructor.new(_3762.ConceptGearPowerFlow))
        return value

    @property
    def meshes_power_flow(self) -> 'List[_3761.ConceptGearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshesPowerFlow, constructor.new(_3761.ConceptGearMeshPowerFlow))
        return value

    @property
    def concept_meshes_power_flow(self) -> 'List[_3761.ConceptGearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshesPowerFlow, constructor.new(_3761.ConceptGearMeshPowerFlow))
        return value
