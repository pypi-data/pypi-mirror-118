...
from mastapy.system_model.analyses_and_results.power_flows import _3791, _3792, _3833
...
class GearSetPowerFlow(_3833.SpecialisedAssemblyPowerFlow):
    '''GearSetPowerFlow
    ...
    @property
    def meshes_power_flow(self) -> 'List[_3791.GearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshesPowerFlow, constructor.new(_3791.GearMeshPowerFlow))
        return value

    @property
    def gears_power_flow(self) -> 'List[_3792.GearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearsPowerFlow, constructor.new(_3792.GearPowerFlow))
        return value
