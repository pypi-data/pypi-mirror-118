...
from mastapy.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import _5813, _5797
...
class RootAssemblySingleWhineAnalysisResultsPropertyAccessor(_5797.AbstractSingleWhineAnalysisResultsPropertyAccessor):
    '''RootAssemblySingleWhineAnalysisResultsPropertyAccessor
    ...
    @property
    def orders(self) -> 'List[_5813.ResultsForOrderIncludingGroups]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Orders, constructor.new(_5813.ResultsForOrderIncludingGroups))
        return value
