...
class CouplingHarmonicAnalysis(_5754.SpecialisedAssemblyHarmonicAnalysis):
    '''CouplingHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2433.CouplingSystemDeflection':
