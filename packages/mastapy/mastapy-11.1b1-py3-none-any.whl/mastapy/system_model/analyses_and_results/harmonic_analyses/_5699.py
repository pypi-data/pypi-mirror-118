...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5712, _5632
from mastapy.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import _5800
...
class FEPartHarmonicAnalysis(_5632.AbstractShaftOrHousingHarmonicAnalysis):
    '''FEPartHarmonicAnalysis
    ...
    @property
    def coupled_modal_analysis(self) -> '_4844.FEPartModalAnalysis':
        ...
        return constructor.new(_4844.FEPartModalAnalysis)(self.wrapped.CoupledModalAnalysis) if self.wrapped.CoupledModalAnalysis else None

    @property
    def export(self) -> '_5712.HarmonicAnalysisFEExportOptions':
        ...
        return constructor.new(_5712.HarmonicAnalysisFEExportOptions)(self.wrapped.Export) if self.wrapped.Export else None

    @property
    def results(self) -> '_5800.FEPartHarmonicAnalysisResultsPropertyAccessor':
        ...
        return constructor.new(_5800.FEPartHarmonicAnalysisResultsPropertyAccessor)(self.wrapped.Results) if self.wrapped.Results else None
    ...
    @property
    def component_load_case(self) -> '_6569.FEPartLoadCase':
        ...
        return constructor.new(_6569.FEPartLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None

    @property
    def system_deflection_results(self) -> '_2459.FEPartSystemDeflection':
        ...
        return constructor.new(_2459.FEPartSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
