...
class ConnectorCompoundHarmonicAnalysis(_5899.MountableComponentCompoundHarmonicAnalysis):
    '''ConnectorCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5667.ConnectorHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5667.ConnectorHarmonicAnalysis))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_5667.ConnectorHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5667.ConnectorHarmonicAnalysis))
        return value
