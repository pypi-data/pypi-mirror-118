...
class RollingRingConnectionCompoundHarmonicAnalysis(_5887.InterMountableComponentConnectionCompoundHarmonicAnalysis):
    '''RollingRingConnectionCompoundHarmonicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5747.RollingRingConnectionHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_5747.RollingRingConnectionHarmonicAnalysis))
        return value
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5747.RollingRingConnectionHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_5747.RollingRingConnectionHarmonicAnalysis))
        return value
