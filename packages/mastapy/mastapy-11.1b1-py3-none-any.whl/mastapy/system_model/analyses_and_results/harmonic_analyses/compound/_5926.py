...
class SpringDamperHalfCompoundHarmonicAnalysis(_5861.CouplingHalfCompoundHarmonicAnalysis):
    '''SpringDamperHalfCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5760.SpringDamperHalfHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5760.SpringDamperHalfHarmonicAnalysis))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_5760.SpringDamperHalfHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5760.SpringDamperHalfHarmonicAnalysis))
        return value
