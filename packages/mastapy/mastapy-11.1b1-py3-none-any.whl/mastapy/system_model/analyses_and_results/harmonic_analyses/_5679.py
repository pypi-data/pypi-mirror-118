...
class CylindricalGearMeshHarmonicAnalysis(_5704.GearMeshHarmonicAnalysis):
    '''CylindricalGearMeshHarmonicAnalysis
    ...
    @property
    def advanced_system_deflection_results(self) -> '_7006.CylindricalGearMeshAdvancedSystemDeflection':
        ...
        return constructor.new(_7006.CylindricalGearMeshAdvancedSystemDeflection)(self.wrapped.AdvancedSystemDeflectionResults) if self.wrapped.AdvancedSystemDeflectionResults else None
    ...
    @property
    def system_deflection_results(self) -> '_2441.CylindricalGearMeshSystemDeflection':
