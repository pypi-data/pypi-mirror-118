...
class BoltedJointSystemDeflection(_2508.SpecialisedAssemblySystemDeflection):
    '''BoltedJointSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3751.BoltedJointPowerFlow':
        ...
        return constructor.new(_3751.BoltedJointPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
