...
class BevelDifferentialGearMeshSystemDeflection(_2408.BevelGearMeshSystemDeflection):
    '''BevelDifferentialGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3743.BevelDifferentialGearMeshPowerFlow':
        ...
        return constructor.new(_3743.BevelDifferentialGearMeshPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None

    @property
    def rating(self) -> '_506.BevelGearMeshRating':
    ...
    @property
    def component_detailed_analysis(self) -> '_506.BevelGearMeshRating':
        ...
        if _506.BevelGearMeshRating.TYPE not in self.wrapped.ComponentDetailedAnalysis.__class__.__mro__:
