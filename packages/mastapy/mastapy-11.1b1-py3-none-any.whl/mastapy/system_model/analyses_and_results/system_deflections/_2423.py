...
from mastapy.system_model.analyses_and_results.system_deflections import _2424, _2422, _2462
...
class ConceptGearSetSystemDeflection(_2462.GearSetSystemDeflection):
    '''ConceptGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3763.ConceptGearSetPowerFlow':
        ...
        return constructor.new(_3763.ConceptGearSetPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
    ...
    @property
    def concept_gears_system_deflection(self) -> 'List[_2424.ConceptGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearsSystemDeflection, constructor.new(_2424.ConceptGearSystemDeflection))
        return value

    @property
    def concept_meshes_system_deflection(self) -> 'List[_2422.ConceptGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshesSystemDeflection, constructor.new(_2422.ConceptGearMeshSystemDeflection))
        return value
