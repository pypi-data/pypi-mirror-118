...
from mastapy.system_model.analyses_and_results.power_flows import _3799, _3802, _3805
...
class KlingelnbergCycloPalloidConicalGearMeshSystemDeflection(_2426.ConicalGearMeshSystemDeflection):
    '''KlingelnbergCycloPalloidConicalGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3799.KlingelnbergCycloPalloidConicalGearMeshPowerFlow':
