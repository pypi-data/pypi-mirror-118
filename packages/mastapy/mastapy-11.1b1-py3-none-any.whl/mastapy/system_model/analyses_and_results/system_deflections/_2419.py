...
class ConceptCouplingConnectionSystemDeflection(_2431.CouplingConnectionSystemDeflection):
    '''ConceptCouplingConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3758.ConceptCouplingConnectionPowerFlow':
        ...
        return constructor.new(_3758.ConceptCouplingConnectionPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
