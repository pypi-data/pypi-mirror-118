...
class PartToPartShearCouplingHalfSystemDeflection(_2432.CouplingHalfSystemDeflection):
    '''PartToPartShearCouplingHalfSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3814.PartToPartShearCouplingHalfPowerFlow':
        ...
        return constructor.new(_3814.PartToPartShearCouplingHalfPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
