...
class KlingelnbergCycloPalloidHypoidGearMeshSystemDeflection(_2470.KlingelnbergCycloPalloidConicalGearMeshSystemDeflection):
    '''KlingelnbergCycloPalloidHypoidGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3802.KlingelnbergCycloPalloidHypoidGearMeshPowerFlow':
        ...
        return constructor.new(_3802.KlingelnbergCycloPalloidHypoidGearMeshPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
