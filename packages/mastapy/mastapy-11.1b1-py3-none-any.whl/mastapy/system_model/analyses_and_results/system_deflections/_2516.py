...
from mastapy.system_model.analyses_and_results.system_deflections import _2517, _2515, _2409
...
class StraightBevelDiffGearSetSystemDeflection(_2409.BevelGearSetSystemDeflection):
    '''StraightBevelDiffGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3842.StraightBevelDiffGearSetPowerFlow':
        ...
        return constructor.new(_3842.StraightBevelDiffGearSetPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
    ...
    @property
    def straight_bevel_diff_gears_system_deflection(self) -> 'List[_2517.StraightBevelDiffGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffGearsSystemDeflection, constructor.new(_2517.StraightBevelDiffGearSystemDeflection))
        return value

    @property
    def straight_bevel_diff_meshes_system_deflection(self) -> 'List[_2515.StraightBevelDiffGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshesSystemDeflection, constructor.new(_2515.StraightBevelDiffGearMeshSystemDeflection))
        return value
