...
class ConceptGearMeshSystemDeflection(_2461.GearMeshSystemDeflection):
    '''ConceptGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3761.ConceptGearMeshPowerFlow':
        ...
        return constructor.new(_3761.ConceptGearMeshPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None

    @property
    def rating(self) -> '_502.ConceptGearMeshRating':
        ...
        return constructor.new(_502.ConceptGearMeshRating)(self.wrapped.Rating) if self.wrapped.Rating else None

    @property
    def component_detailed_analysis(self) -> '_502.ConceptGearMeshRating':
        ...
        return constructor.new(_502.ConceptGearMeshRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis else None
