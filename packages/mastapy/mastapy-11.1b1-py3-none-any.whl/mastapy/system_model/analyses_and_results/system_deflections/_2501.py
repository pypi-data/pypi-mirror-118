...
class RollingRingSystemDeflection(_2432.CouplingHalfSystemDeflection):
    '''RollingRingSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3828.RollingRingPowerFlow':
        ...
        return constructor.new(_3828.RollingRingPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
