...
from mastapy.system_model.analyses_and_results.power_flows import _3782, _3817
from mastapy.gears.rating.cylindrical import _427
from mastapy.gears.manufacturing.cylindrical import _573
from mastapy.system_model.analyses_and_results.system_deflections import _2447, _2441, _2462
...
class CylindricalGearSetSystemDeflection(_2462.GearSetSystemDeflection):
    '''CylindricalGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3782.CylindricalGearSetPowerFlow':
    ...
    @property
    def manufacturing_analysis(self) -> '_573.CylindricalManufacturedGearSetLoadCase':
        ...
        return constructor.new(_573.CylindricalManufacturedGearSetLoadCase)(self.wrapped.ManufacturingAnalysis) if self.wrapped.ManufacturingAnalysis else None

    @property
    def cylindrical_gears_system_deflection(self) -> 'List[_2447.CylindricalGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearsSystemDeflection, constructor.new(_2447.CylindricalGearSystemDeflection))
        return value

    @property
    def cylindrical_meshes_system_deflection(self) -> 'List[_2441.CylindricalGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshesSystemDeflection, constructor.new(_2441.CylindricalGearMeshSystemDeflection))
        return value
