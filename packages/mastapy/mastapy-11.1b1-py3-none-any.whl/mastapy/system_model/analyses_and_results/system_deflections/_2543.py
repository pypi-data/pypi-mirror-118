...
class ZerolBevelGearSystemDeflection(_2410.BevelGearSystemDeflection):
    '''ZerolBevelGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3863.ZerolBevelGearPowerFlow':
        ...
        return constructor.new(_3863.ZerolBevelGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
