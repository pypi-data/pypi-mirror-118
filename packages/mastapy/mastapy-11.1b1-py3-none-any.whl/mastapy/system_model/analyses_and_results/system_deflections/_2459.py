...
from mastapy.math_utility.measured_vectors import _1345, _1341
from mastapy.system_model.fe import _2118
...
class FEPartSystemDeflection(_2393.AbstractShaftOrHousingSystemDeflection):
    '''FEPartSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3789.FEPartPowerFlow':
        ...
        return constructor.new(_3789.FEPartPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
    ...
    @property
    def applied_internal_forces_in_world_coordinate_system(self) -> 'List[_1345.VectorWithLinearAndAngularComponents]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AppliedInternalForcesInWorldCoordinateSystem, constructor.new(_1345.VectorWithLinearAndAngularComponents))
        return value

    @property
    def node_results_in_shaft_coordinate_system(self) -> 'List[_1341.ForceAndDisplacementResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.NodeResultsInShaftCoordinateSystem, constructor.new(_1341.ForceAndDisplacementResults))
        return value

    @property
    def export(self) -> '_2118.SystemDeflectionFEExportOptions':
        ...
        return constructor.new(_2118.SystemDeflectionFEExportOptions)(self.wrapped.Export) if self.wrapped.Export else None
