...
class HypoidGearSystemDeflection(_2398.AGMAGleasonConicalGearSystemDeflection):
    '''HypoidGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3796.HypoidGearPowerFlow':
        ...
        return constructor.new(_3796.HypoidGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
