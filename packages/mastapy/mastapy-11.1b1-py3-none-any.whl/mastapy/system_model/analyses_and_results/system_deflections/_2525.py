...
class SynchroniserSleeveSystemDeflection(_2524.SynchroniserPartSystemDeflection):
    '''SynchroniserSleeveSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3851.SynchroniserSleevePowerFlow':
        ...
        return constructor.new(_3851.SynchroniserSleevePowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
