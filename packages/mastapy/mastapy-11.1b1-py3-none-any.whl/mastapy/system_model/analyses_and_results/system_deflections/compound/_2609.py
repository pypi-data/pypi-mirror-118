...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2607, _2608, _2614
...
class FaceGearSetCompoundSystemDeflection(_2614.GearSetCompoundSystemDeflection):
    '''FaceGearSetCompoundSystemDeflection
    ...
    @property
    def face_gears_compound_system_deflection(self) -> 'List[_2607.FaceGearCompoundSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGearsCompoundSystemDeflection, constructor.new(_2607.FaceGearCompoundSystemDeflection))
        return value

    @property
    def face_meshes_compound_system_deflection(self) -> 'List[_2608.FaceGearMeshCompoundSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshesCompoundSystemDeflection, constructor.new(_2608.FaceGearMeshCompoundSystemDeflection))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_2457.FaceGearSetSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_2457.FaceGearSetSystemDeflection))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_2457.FaceGearSetSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_2457.FaceGearSetSystemDeflection))
        return value
