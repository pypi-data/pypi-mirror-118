...
class RollingRingCompoundSystemDeflection(_2592.CouplingHalfCompoundSystemDeflection):
    '''RollingRingCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2501.RollingRingSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2501.RollingRingSystemDeflection))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2501.RollingRingSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2501.RollingRingSystemDeflection))
        return value
