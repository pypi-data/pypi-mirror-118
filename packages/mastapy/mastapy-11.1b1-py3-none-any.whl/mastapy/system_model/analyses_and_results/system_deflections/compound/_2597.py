...
class CycloidalDiscCentralBearingConnectionCompoundSystemDeflection(_2577.CoaxialConnectionCompoundSystemDeflection):
    '''CycloidalDiscCentralBearingConnectionCompoundSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_2438.CycloidalDiscCentralBearingConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_2438.CycloidalDiscCentralBearingConnectionSystemDeflection))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_2438.CycloidalDiscCentralBearingConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_2438.CycloidalDiscCentralBearingConnectionSystemDeflection))
        return value
