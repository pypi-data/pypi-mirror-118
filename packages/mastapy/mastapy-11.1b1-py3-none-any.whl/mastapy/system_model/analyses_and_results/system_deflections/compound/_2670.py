...
class SynchroniserPartCompoundSystemDeflection(_2592.CouplingHalfCompoundSystemDeflection):
    '''SynchroniserPartCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_2524.SynchroniserPartSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2524.SynchroniserPartSystemDeflection))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_2524.SynchroniserPartSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2524.SynchroniserPartSystemDeflection))
        return value
