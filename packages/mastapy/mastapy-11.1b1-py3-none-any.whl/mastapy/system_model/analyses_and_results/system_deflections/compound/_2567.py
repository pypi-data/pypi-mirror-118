...
class BevelDifferentialPlanetGearCompoundSystemDeflection(_2564.BevelDifferentialGearCompoundSystemDeflection):
    '''BevelDifferentialPlanetGearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_2406.BevelDifferentialPlanetGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_2406.BevelDifferentialPlanetGearSystemDeflection))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_2406.BevelDifferentialPlanetGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_2406.BevelDifferentialPlanetGearSystemDeflection))
        return value
