...
class ConceptGearSystemDeflection(_2463.GearSystemDeflection):
    '''ConceptGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3762.ConceptGearPowerFlow':
        ...
        return constructor.new(_3762.ConceptGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
