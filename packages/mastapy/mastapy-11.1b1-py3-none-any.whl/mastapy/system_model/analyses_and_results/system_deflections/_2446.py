...
from mastapy.gears.ltca.cylindrical import _801, _803
...
class CylindricalGearSetSystemDeflectionWithLTCAResults(_2444.CylindricalGearSetSystemDeflection):
    '''CylindricalGearSetSystemDeflectionWithLTCAResults
    ...
    @property
    def basic_ltca_results(self) -> '_801.CylindricalGearSetLoadDistributionAnalysis':
        ...
        if _801.CylindricalGearSetLoadDistributionAnalysis.TYPE not in self.wrapped.BasicLTCAResults.__class__.__mro__:
    ...
    @property
    def basic_ltca_results_only_first_planetary_mesh(self) -> '_801.CylindricalGearSetLoadDistributionAnalysis':
        ...
        if _801.CylindricalGearSetLoadDistributionAnalysis.TYPE not in self.wrapped.BasicLTCAResultsOnlyFirstPlanetaryMesh.__class__.__mro__:
    ...
    @property
    def advanced_ltca_results(self) -> '_801.CylindricalGearSetLoadDistributionAnalysis':
        ...
        if _801.CylindricalGearSetLoadDistributionAnalysis.TYPE not in self.wrapped.AdvancedLTCAResults.__class__.__mro__:
    ...
    @property
    def advanced_ltca_results_only_first_planetary_mesh(self) -> '_801.CylindricalGearSetLoadDistributionAnalysis':
        ...
        if _801.CylindricalGearSetLoadDistributionAnalysis.TYPE not in self.wrapped.AdvancedLTCAResultsOnlyFirstPlanetaryMesh.__class__.__mro__:
