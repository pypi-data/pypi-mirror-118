...
class CycloidalDiscSystemDeflection(_2394.AbstractShaftSystemDeflection):
    '''CycloidalDiscSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3778.CycloidalDiscPowerFlow':
        ...
        return constructor.new(_3778.CycloidalDiscPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
