...
from mastapy.system_model.analyses_and_results.system_deflections import _2458, _2456, _2462
...
class FaceGearSetSystemDeflection(_2462.GearSetSystemDeflection):
    '''FaceGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3788.FaceGearSetPowerFlow':
        ...
        return constructor.new(_3788.FaceGearSetPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
    ...
    @property
    def face_gears_system_deflection(self) -> 'List[_2458.FaceGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGearsSystemDeflection, constructor.new(_2458.FaceGearSystemDeflection))
        return value

    @property
    def face_meshes_system_deflection(self) -> 'List[_2456.FaceGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshesSystemDeflection, constructor.new(_2456.FaceGearMeshSystemDeflection))
        return value
