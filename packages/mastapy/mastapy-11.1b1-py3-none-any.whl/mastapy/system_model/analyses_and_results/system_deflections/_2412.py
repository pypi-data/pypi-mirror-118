...
class BoltSystemDeflection(_2417.ComponentSystemDeflection):
    '''BoltSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3752.BoltPowerFlow':
        ...
        return constructor.new(_3752.BoltPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
