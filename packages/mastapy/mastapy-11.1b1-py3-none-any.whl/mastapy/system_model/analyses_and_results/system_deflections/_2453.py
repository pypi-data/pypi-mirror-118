...
class DatumSystemDeflection(_2417.ComponentSystemDeflection):
    '''DatumSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3784.DatumPowerFlow':
        ...
        return constructor.new(_3784.DatumPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
