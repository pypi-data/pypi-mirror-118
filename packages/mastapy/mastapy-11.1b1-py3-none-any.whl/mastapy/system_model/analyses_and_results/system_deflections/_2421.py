...
class ConceptCouplingSystemDeflection(_2433.CouplingSystemDeflection):
    '''ConceptCouplingSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3760.ConceptCouplingPowerFlow':
        ...
        return constructor.new(_3760.ConceptCouplingPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
