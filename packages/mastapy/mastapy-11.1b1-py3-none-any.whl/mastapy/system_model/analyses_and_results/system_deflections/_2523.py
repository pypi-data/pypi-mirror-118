...
from mastapy.system_model.analyses_and_results.system_deflections import _2413, _2524
...
class SynchroniserHalfSystemDeflection(_2524.SynchroniserPartSystemDeflection):
    '''SynchroniserHalfSystemDeflection
    ...
    @property
    def clutch_connection(self) -> '_2413.ClutchConnectionSystemDeflection':
        ...
        return constructor.new(_2413.ClutchConnectionSystemDeflection)(self.wrapped.ClutchConnection) if self.wrapped.ClutchConnection else None
    ...
    @property
    def power_flow_results(self) -> '_3848.SynchroniserHalfPowerFlow':
        ...
        return constructor.new(_3848.SynchroniserHalfPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
