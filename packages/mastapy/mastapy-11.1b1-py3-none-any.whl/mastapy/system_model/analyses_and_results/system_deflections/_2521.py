...
class StraightBevelPlanetGearSystemDeflection(_2517.StraightBevelDiffGearSystemDeflection):
    '''StraightBevelPlanetGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3846.StraightBevelPlanetGearPowerFlow':
        ...
        return constructor.new(_3846.StraightBevelPlanetGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
