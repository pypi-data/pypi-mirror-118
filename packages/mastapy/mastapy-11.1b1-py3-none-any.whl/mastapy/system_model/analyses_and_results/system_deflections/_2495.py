...
from mastapy.system_model.analyses_and_results.power_flows import _3823, _3774
...
class PulleySystemDeflection(_2432.CouplingHalfSystemDeflection):
    '''PulleySystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3823.PulleyPowerFlow':
