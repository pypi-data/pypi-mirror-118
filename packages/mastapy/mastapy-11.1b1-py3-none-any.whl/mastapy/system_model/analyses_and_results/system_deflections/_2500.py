...
class RollingRingConnectionSystemDeflection(_2469.InterMountableComponentConnectionSystemDeflection):
    '''RollingRingConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3827.RollingRingConnectionPowerFlow':
        ...
        return constructor.new(_3827.RollingRingConnectionPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
