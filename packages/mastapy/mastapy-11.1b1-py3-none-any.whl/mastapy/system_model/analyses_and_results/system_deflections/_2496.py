...
class RingPinsSystemDeflection(_2484.MountableComponentSystemDeflection):
    '''RingPinsSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3824.RingPinsPowerFlow':
        ...
        return constructor.new(_3824.RingPinsPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
