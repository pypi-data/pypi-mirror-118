...
class SplineFlankContactReporting(_0.APIBase):
    ...
    @property
    def relative_deflection_wcs(self) -> '_1345.VectorWithLinearAndAngularComponents':
        ...
        return constructor.new(_1345.VectorWithLinearAndAngularComponents)(self.wrapped.RelativeDeflectionWCS) if self.wrapped.RelativeDeflectionWCS else None

    @property
    def relative_deflection_lcs(self) -> '_1345.VectorWithLinearAndAngularComponents':
        ...
        return constructor.new(_1345.VectorWithLinearAndAngularComponents)(self.wrapped.RelativeDeflectionLCS) if self.wrapped.RelativeDeflectionLCS else None

    @property
    def force_on_inner_wcs(self) -> '_1345.VectorWithLinearAndAngularComponents':
        ...
        return constructor.new(_1345.VectorWithLinearAndAngularComponents)(self.wrapped.ForceOnInnerWCS) if self.wrapped.ForceOnInnerWCS else None

    @property
    def force_on_inner_contact_coordinate_system(self) -> '_1345.VectorWithLinearAndAngularComponents':
        ...
        return constructor.new(_1345.VectorWithLinearAndAngularComponents)(self.wrapped.ForceOnInnerContactCoordinateSystem) if self.wrapped.ForceOnInnerContactCoordinateSystem else None
