...
from mastapy.utility.enums import _1569
...
class ShaftSystemDeflectionSectionsReport(_1510.CustomReportChart):
    '''ShaftSystemDeflectionSectionsReport
    ...
    @property
    def display(self) -> '_1569.TableAndChartOptions':
        '''TableAndChartOptions: 'Display' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.Display)
        return constructor.new(_1569.TableAndChartOptions)(value) if value else None

    @display.setter
    def display(self, value: '_1569.TableAndChartOptions'):
