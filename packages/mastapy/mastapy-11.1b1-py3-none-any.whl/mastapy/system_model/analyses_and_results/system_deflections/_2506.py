...
from mastapy.system_model.analyses_and_results.system_deflections import _2504, _2505, _2394
...
class ShaftSystemDeflection(_2394.AbstractShaftSystemDeflection):
    '''ShaftSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3831.ShaftPowerFlow':
        ...
        return constructor.new(_3831.ShaftPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None

    @property
    def shaft_section_end_with_worst_static_safety_factor(self) -> '_2504.ShaftSectionEndResultsSystemDeflection':
        ...
        return constructor.new(_2504.ShaftSectionEndResultsSystemDeflection)(self.wrapped.ShaftSectionEndWithWorstStaticSafetyFactor) if self.wrapped.ShaftSectionEndWithWorstStaticSafetyFactor else None

    @property
    def shaft_section_end_with_worst_fatigue_safety_factor(self) -> '_2504.ShaftSectionEndResultsSystemDeflection':
        ...
        return constructor.new(_2504.ShaftSectionEndResultsSystemDeflection)(self.wrapped.ShaftSectionEndWithWorstFatigueSafetyFactor) if self.wrapped.ShaftSectionEndWithWorstFatigueSafetyFactor else None

    @property
    def shaft_section_end_with_worst_fatigue_safety_factor_for_infinite_life(self) -> '_2504.ShaftSectionEndResultsSystemDeflection':
        ...
        return constructor.new(_2504.ShaftSectionEndResultsSystemDeflection)(self.wrapped.ShaftSectionEndWithWorstFatigueSafetyFactorForInfiniteLife) if self.wrapped.ShaftSectionEndWithWorstFatigueSafetyFactorForInfiniteLife else None
    ...
    @property
    def shaft_section_results(self) -> 'List[_2505.ShaftSectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftSectionResults, constructor.new(_2505.ShaftSectionSystemDeflection))
        return value

    @property
    def shaft_section_end_results_by_offset_with_worst_safety_factor(self) -> 'List[_2504.ShaftSectionEndResultsSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftSectionEndResultsByOffsetWithWorstSafetyFactor, constructor.new(_2504.ShaftSectionEndResultsSystemDeflection))
        return value

    @property
    def mounted_components_applying_torque(self) -> 'List[_1342.ForceResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MountedComponentsApplyingTorque, constructor.new(_1342.ForceResults))
        return value
