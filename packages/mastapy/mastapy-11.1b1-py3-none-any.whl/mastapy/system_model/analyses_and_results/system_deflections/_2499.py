...
class RollingRingAssemblySystemDeflection(_2508.SpecialisedAssemblySystemDeflection):
    '''RollingRingAssemblySystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3826.RollingRingAssemblyPowerFlow':
        ...
        return constructor.new(_3826.RollingRingAssemblyPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
