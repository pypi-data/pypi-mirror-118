...
class VirtualComponentSystemDeflection(_2484.MountableComponentSystemDeflection):
    '''VirtualComponentSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3858.VirtualComponentPowerFlow':
