...
from mastapy.system_model.analyses_and_results.load_case_groups import _5356
...
from mastapy.system_model.analyses_and_results.flexible_pin_analyses import _5951
...
class WindTurbineCertificationReport(_5951.CombinationAnalysis):
    '''WindTurbineCertificationReport
    ...
    @property
    def design(self) -> '_2182.RootAssembly':
        ...
        return constructor.new(_2182.RootAssembly)(self.wrapped.Design) if self.wrapped.Design else None

    @property
    def ldd_static_analysis(self) -> '_2648.RootAssemblyCompoundSystemDeflection':
        ...
        return constructor.new(_2648.RootAssemblyCompoundSystemDeflection)(self.wrapped.LDDStaticAnalysis) if self.wrapped.LDDStaticAnalysis else None

    @property
    def nominal_load_case_static_analysis(self) -> '_2502.RootAssemblySystemDeflection':
        ...
        return constructor.new(_2502.RootAssemblySystemDeflection)(self.wrapped.NominalLoadCaseStaticAnalysis) if self.wrapped.NominalLoadCaseStaticAnalysis else None

    @property
    def extreme_load_case_static_analysis(self) -> '_2502.RootAssemblySystemDeflection':
        ...
        return constructor.new(_2502.RootAssemblySystemDeflection)(self.wrapped.ExtremeLoadCaseStaticAnalysis) if self.wrapped.ExtremeLoadCaseStaticAnalysis else None
