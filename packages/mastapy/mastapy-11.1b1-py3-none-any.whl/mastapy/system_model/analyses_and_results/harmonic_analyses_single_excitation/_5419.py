...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation import _5417, _5418, _5430
...
class CylindricalGearSetHarmonicAnalysisOfSingleExcitation(_5430.GearSetHarmonicAnalysisOfSingleExcitation):
    '''CylindricalGearSetHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def cylindrical_gears_harmonic_analysis_of_single_excitation(self) -> 'List[_5417.CylindricalGearHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearsHarmonicAnalysisOfSingleExcitation, constructor.new(_5417.CylindricalGearHarmonicAnalysisOfSingleExcitation))
        return value

    @property
    def cylindrical_meshes_harmonic_analysis_of_single_excitation(self) -> 'List[_5418.CylindricalGearMeshHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshesHarmonicAnalysisOfSingleExcitation, constructor.new(_5418.CylindricalGearMeshHarmonicAnalysisOfSingleExcitation))
        return value
