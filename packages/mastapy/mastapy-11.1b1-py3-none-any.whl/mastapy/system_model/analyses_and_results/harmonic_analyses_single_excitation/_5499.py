...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation import _5497, _5498, _5388
...
class ZerolBevelGearSetHarmonicAnalysisOfSingleExcitation(_5388.BevelGearSetHarmonicAnalysisOfSingleExcitation):
    '''ZerolBevelGearSetHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def zerol_bevel_gears_harmonic_analysis_of_single_excitation(self) -> 'List[_5497.ZerolBevelGearHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelGearsHarmonicAnalysisOfSingleExcitation, constructor.new(_5497.ZerolBevelGearHarmonicAnalysisOfSingleExcitation))
        return value

    @property
    def zerol_bevel_meshes_harmonic_analysis_of_single_excitation(self) -> 'List[_5498.ZerolBevelGearMeshHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelMeshesHarmonicAnalysisOfSingleExcitation, constructor.new(_5498.ZerolBevelGearMeshHarmonicAnalysisOfSingleExcitation))
        return value
