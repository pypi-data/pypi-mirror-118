...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation import _5479, _5480, _5388
...
class StraightBevelGearSetHarmonicAnalysisOfSingleExcitation(_5388.BevelGearSetHarmonicAnalysisOfSingleExcitation):
    '''StraightBevelGearSetHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def straight_bevel_gears_harmonic_analysis_of_single_excitation(self) -> 'List[_5479.StraightBevelGearHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelGearsHarmonicAnalysisOfSingleExcitation, constructor.new(_5479.StraightBevelGearHarmonicAnalysisOfSingleExcitation))
        return value

    @property
    def straight_bevel_meshes_harmonic_analysis_of_single_excitation(self) -> 'List[_5480.StraightBevelGearMeshHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelMeshesHarmonicAnalysisOfSingleExcitation, constructor.new(_5480.StraightBevelGearMeshHarmonicAnalysisOfSingleExcitation))
        return value
