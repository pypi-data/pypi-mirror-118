...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation import _5433, _5434, _5376
...
class HypoidGearSetHarmonicAnalysisOfSingleExcitation(_5376.AGMAGleasonConicalGearSetHarmonicAnalysisOfSingleExcitation):
    '''HypoidGearSetHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def hypoid_gears_harmonic_analysis_of_single_excitation(self) -> 'List[_5433.HypoidGearHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidGearsHarmonicAnalysisOfSingleExcitation, constructor.new(_5433.HypoidGearHarmonicAnalysisOfSingleExcitation))
        return value

    @property
    def hypoid_meshes_harmonic_analysis_of_single_excitation(self) -> 'List[_5434.HypoidGearMeshHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidMeshesHarmonicAnalysisOfSingleExcitation, constructor.new(_5434.HypoidGearMeshHarmonicAnalysisOfSingleExcitation))
        return value
