...
class CouplingCompoundHarmonicAnalysisOfSingleExcitation(_5598.SpecialisedAssemblyCompoundHarmonicAnalysisOfSingleExcitation):
    '''CouplingCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5409.CouplingHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_5409.CouplingHarmonicAnalysisOfSingleExcitation))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5409.CouplingHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_5409.CouplingHarmonicAnalysisOfSingleExcitation))
        return value
