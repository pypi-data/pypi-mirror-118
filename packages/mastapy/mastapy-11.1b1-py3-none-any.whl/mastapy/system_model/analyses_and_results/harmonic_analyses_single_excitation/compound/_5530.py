...
class ConceptGearMeshCompoundHarmonicAnalysisOfSingleExcitation(_5559.GearMeshCompoundHarmonicAnalysisOfSingleExcitation):
    '''ConceptGearMeshCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5400.ConceptGearMeshHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_5400.ConceptGearMeshHarmonicAnalysisOfSingleExcitation))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_5400.ConceptGearMeshHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_5400.ConceptGearMeshHarmonicAnalysisOfSingleExcitation))
        return value
