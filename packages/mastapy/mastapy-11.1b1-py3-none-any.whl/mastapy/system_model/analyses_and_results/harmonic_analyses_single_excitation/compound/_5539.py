...
class CouplingHalfCompoundHarmonicAnalysisOfSingleExcitation(_5577.MountableComponentCompoundHarmonicAnalysisOfSingleExcitation):
    '''CouplingHalfCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5408.CouplingHalfHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5408.CouplingHalfHarmonicAnalysisOfSingleExcitation))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_5408.CouplingHalfHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5408.CouplingHalfHarmonicAnalysisOfSingleExcitation))
        return value
