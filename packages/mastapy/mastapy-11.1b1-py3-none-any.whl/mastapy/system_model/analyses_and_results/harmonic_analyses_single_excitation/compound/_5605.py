...
class StraightBevelDiffGearCompoundHarmonicAnalysisOfSingleExcitation(_5516.BevelGearCompoundHarmonicAnalysisOfSingleExcitation):
    '''StraightBevelDiffGearCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5476.StraightBevelDiffGearHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5476.StraightBevelDiffGearHarmonicAnalysisOfSingleExcitation))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_5476.StraightBevelDiffGearHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5476.StraightBevelDiffGearHarmonicAnalysisOfSingleExcitation))
        return value
