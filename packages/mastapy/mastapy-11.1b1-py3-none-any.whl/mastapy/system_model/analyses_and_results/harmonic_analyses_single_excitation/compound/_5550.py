...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation.compound import _5547
...
class CylindricalPlanetGearCompoundHarmonicAnalysisOfSingleExcitation(_5547.CylindricalGearCompoundHarmonicAnalysisOfSingleExcitation):
    '''CylindricalPlanetGearCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5420.CylindricalPlanetGearHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5420.CylindricalPlanetGearHarmonicAnalysisOfSingleExcitation))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_5420.CylindricalPlanetGearHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5420.CylindricalPlanetGearHarmonicAnalysisOfSingleExcitation))
        return value
