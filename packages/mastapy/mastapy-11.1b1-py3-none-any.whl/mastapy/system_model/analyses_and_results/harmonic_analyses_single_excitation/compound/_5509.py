...
class BeltConnectionCompoundHarmonicAnalysisOfSingleExcitation(_5565.InterMountableComponentConnectionCompoundHarmonicAnalysisOfSingleExcitation):
    '''BeltConnectionCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5379.BeltConnectionHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_5379.BeltConnectionHarmonicAnalysisOfSingleExcitation))
        return value

    @property
    def connection_analysis_cases(self) -> 'List[_5379.BeltConnectionHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_5379.BeltConnectionHarmonicAnalysisOfSingleExcitation))
        return value
