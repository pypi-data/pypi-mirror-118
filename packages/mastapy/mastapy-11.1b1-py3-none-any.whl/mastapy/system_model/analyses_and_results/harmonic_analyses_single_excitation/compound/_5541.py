...
class CVTCompoundHarmonicAnalysisOfSingleExcitation(_5510.BeltDriveCompoundHarmonicAnalysisOfSingleExcitation):
    '''CVTCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5411.CVTHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_5411.CVTHarmonicAnalysisOfSingleExcitation))
        return value

    @property
    def assembly_analysis_cases(self) -> 'List[_5411.CVTHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_5411.CVTHarmonicAnalysisOfSingleExcitation))
        return value
