...
class ConicalGearCompoundHarmonicAnalysisOfSingleExcitation(_5558.GearCompoundHarmonicAnalysisOfSingleExcitation):
    '''ConicalGearCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5402.ConicalGearHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_5402.ConicalGearHarmonicAnalysisOfSingleExcitation))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_5402.ConicalGearHarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_5402.ConicalGearHarmonicAnalysisOfSingleExcitation))
        return value
