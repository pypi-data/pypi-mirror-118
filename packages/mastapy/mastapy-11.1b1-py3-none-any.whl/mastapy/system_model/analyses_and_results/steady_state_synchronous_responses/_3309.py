...
from mastapy.system_model.analyses_and_results.analysis_cases import _7221
...
class SteadyStateSynchronousResponse(_7221.CompoundAnalysisCase):
    '''SteadyStateSynchronousResponse
    ...
    @property
    def steady_state_analysis_options(self) -> '_3311.SteadyStateSynchronousResponseOptions':
        ...
        return constructor.new(_3311.SteadyStateSynchronousResponseOptions)(self.wrapped.SteadyStateAnalysisOptions) if self.wrapped.SteadyStateAnalysisOptions else None
