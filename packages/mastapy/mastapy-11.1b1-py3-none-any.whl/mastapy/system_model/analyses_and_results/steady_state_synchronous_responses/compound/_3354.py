...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses.compound import _3342
...
class BevelGearSetCompoundSteadyStateSynchronousResponse(_3342.AGMAGleasonConicalGearSetCompoundSteadyStateSynchronousResponse):
    '''BevelGearSetCompoundSteadyStateSynchronousResponse
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_3220.BevelGearSetSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCases, constructor.new(_3220.BevelGearSetSteadyStateSynchronousResponse))
        return value

    @property
    def assembly_analysis_cases_ready(self) -> 'List[_3220.BevelGearSetSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyAnalysisCasesReady, constructor.new(_3220.BevelGearSetSteadyStateSynchronousResponse))
        return value
