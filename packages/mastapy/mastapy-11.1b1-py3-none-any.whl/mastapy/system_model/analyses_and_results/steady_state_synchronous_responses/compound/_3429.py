...
class RollingRingConnectionCompoundSteadyStateSynchronousResponse(_3401.InterMountableComponentConnectionCompoundSteadyStateSynchronousResponse):
    '''RollingRingConnectionCompoundSteadyStateSynchronousResponse
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_3296.RollingRingConnectionSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_3296.RollingRingConnectionSteadyStateSynchronousResponse))
        return value
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_3296.RollingRingConnectionSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_3296.RollingRingConnectionSteadyStateSynchronousResponse))
        return value
