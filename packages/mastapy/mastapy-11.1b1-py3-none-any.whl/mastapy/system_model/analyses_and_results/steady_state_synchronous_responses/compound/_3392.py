...
class FEPartCompoundSteadyStateSynchronousResponse(_3338.AbstractShaftOrHousingCompoundSteadyStateSynchronousResponse):
    '''FEPartCompoundSteadyStateSynchronousResponse
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_3260.FEPartSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_3260.FEPartSteadyStateSynchronousResponse))
        return value
    ...
    @property
    def component_analysis_cases(self) -> 'List[_3260.FEPartSteadyStateSynchronousResponse]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_3260.FEPartSteadyStateSynchronousResponse))
        return value
