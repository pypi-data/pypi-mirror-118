...
class PartSteadyStateSynchronousResponse(_7232.PartStaticLoadAnalysisCase):
    '''PartSteadyStateSynchronousResponse
    ...
    @property
    def steady_state_synchronous_response(self) -> '_3309.SteadyStateSynchronousResponse':
        ...
        return constructor.new(_3309.SteadyStateSynchronousResponse)(self.wrapped.SteadyStateSynchronousResponse) if self.wrapped.SteadyStateSynchronousResponse else None
