...
class ConicalGearMeshAdvancedSystemDeflection(_7018.GearMeshAdvancedSystemDeflection):
    '''ConicalGearMeshAdvancedSystemDeflection
    ...
    @property
    def inactive_flank(self) -> '_1079.ActiveConicalFlank':
    ...
    @property
    def connection_design(self) -> '_2016.ConicalGearMesh':
