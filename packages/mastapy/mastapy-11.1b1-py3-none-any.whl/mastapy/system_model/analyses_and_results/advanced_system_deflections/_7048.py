...
class PulleyAdvancedSystemDeflection(_6997.CouplingHalfAdvancedSystemDeflection):
    '''PulleyAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2495.PulleySystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2495.PulleySystemDeflection))
        return value
