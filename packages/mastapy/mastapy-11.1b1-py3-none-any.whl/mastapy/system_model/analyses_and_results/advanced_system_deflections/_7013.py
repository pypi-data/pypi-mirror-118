...
class FaceGearMeshAdvancedSystemDeflection(_7018.GearMeshAdvancedSystemDeflection):
    '''FaceGearMeshAdvancedSystemDeflection
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2456.FaceGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2456.FaceGearMeshSystemDeflection))
        return value
