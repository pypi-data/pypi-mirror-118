...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7081, _7083
...
class PowerLoadAdvancedSystemDeflection(_7083.VirtualComponentAdvancedSystemDeflection):
    '''PowerLoadAdvancedSystemDeflection
    ...
    @property
    def component_load_case(self) -> '_6624.PowerLoadLoadCase':
        ...
        return constructor.new(_6624.PowerLoadLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None

    @property
    def transmission_error_to_other_power_loads(self) -> 'List[_7081.TransmissionErrorToOtherPowerLoad]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.TransmissionErrorToOtherPowerLoads, constructor.new(_7081.TransmissionErrorToOtherPowerLoad))
        return value

    @property
    def component_system_deflection_results(self) -> 'List[_2494.PowerLoadSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2494.PowerLoadSystemDeflection))
        return value
