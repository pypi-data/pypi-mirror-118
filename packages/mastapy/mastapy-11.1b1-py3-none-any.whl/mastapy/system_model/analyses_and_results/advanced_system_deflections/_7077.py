...
class TorqueConverterAdvancedSystemDeflection(_6995.CouplingAdvancedSystemDeflection):
    '''TorqueConverterAdvancedSystemDeflection
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2532.TorqueConverterSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySystemDeflectionResults, constructor.new(_2532.TorqueConverterSystemDeflection))
        return value
