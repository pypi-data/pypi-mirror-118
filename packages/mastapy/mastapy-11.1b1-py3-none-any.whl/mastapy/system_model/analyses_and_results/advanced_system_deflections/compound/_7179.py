...
class RingPinsCompoundAdvancedSystemDeflection(_7167.MountableComponentCompoundAdvancedSystemDeflection):
    '''RingPinsCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7049.RingPinsAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_7049.RingPinsAdvancedSystemDeflection))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_7049.RingPinsAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_7049.RingPinsAdvancedSystemDeflection))
        return value
