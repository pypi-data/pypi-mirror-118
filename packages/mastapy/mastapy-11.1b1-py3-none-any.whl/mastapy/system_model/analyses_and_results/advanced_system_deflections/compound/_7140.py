...
from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import _7137
...
class CylindricalPlanetGearCompoundAdvancedSystemDeflection(_7137.CylindricalGearCompoundAdvancedSystemDeflection):
    '''CylindricalPlanetGearCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7009.CylindricalPlanetGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_7009.CylindricalPlanetGearAdvancedSystemDeflection))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_7009.CylindricalPlanetGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_7009.CylindricalPlanetGearAdvancedSystemDeflection))
        return value
