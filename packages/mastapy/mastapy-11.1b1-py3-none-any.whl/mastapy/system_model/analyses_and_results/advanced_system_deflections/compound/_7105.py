...
class BevelDifferentialSunGearCompoundAdvancedSystemDeflection(_7101.BevelDifferentialGearCompoundAdvancedSystemDeflection):
    '''BevelDifferentialSunGearCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6972.BevelDifferentialSunGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6972.BevelDifferentialSunGearAdvancedSystemDeflection))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_6972.BevelDifferentialSunGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6972.BevelDifferentialSunGearAdvancedSystemDeflection))
        return value
