...
class KlingelnbergCycloPalloidConicalGearMeshCompoundAdvancedSystemDeflection(_7123.ConicalGearMeshCompoundAdvancedSystemDeflection):
    '''KlingelnbergCycloPalloidConicalGearMeshCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7026.KlingelnbergCycloPalloidConicalGearMeshAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCases, constructor.new(_7026.KlingelnbergCycloPalloidConicalGearMeshAdvancedSystemDeflection))
        return value

    @property
    def connection_analysis_cases_ready(self) -> 'List[_7026.KlingelnbergCycloPalloidConicalGearMeshAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionAnalysisCasesReady, constructor.new(_7026.KlingelnbergCycloPalloidConicalGearMeshAdvancedSystemDeflection))
        return value
