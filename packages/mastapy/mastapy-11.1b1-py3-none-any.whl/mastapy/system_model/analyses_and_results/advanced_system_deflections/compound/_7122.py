...
from mastapy.system_model.analyses_and_results.advanced_system_deflections.compound import _7148
...
class ConicalGearCompoundAdvancedSystemDeflection(_7148.GearCompoundAdvancedSystemDeflection):
    '''ConicalGearCompoundAdvancedSystemDeflection
    ...
    @property
    def gear_duty_cycle_rating(self) -> '_490.ConicalGearDutyCycleRating':
        ...
        return constructor.new(_490.ConicalGearDutyCycleRating)(self.wrapped.GearDutyCycleRating) if self.wrapped.GearDutyCycleRating else None

    @property
    def conical_gear_duty_cycle_rating(self) -> '_490.ConicalGearDutyCycleRating':
        ...
        return constructor.new(_490.ConicalGearDutyCycleRating)(self.wrapped.ConicalGearDutyCycleRating) if self.wrapped.ConicalGearDutyCycleRating else None
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6989.ConicalGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_6989.ConicalGearAdvancedSystemDeflection))
        return value

    @property
    def component_analysis_cases_ready(self) -> 'List[_6989.ConicalGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_6989.ConicalGearAdvancedSystemDeflection))
        return value
