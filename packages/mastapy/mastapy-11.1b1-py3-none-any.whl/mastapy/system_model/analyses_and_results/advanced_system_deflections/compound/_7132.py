...
class CVTPulleyCompoundAdvancedSystemDeflection(_7178.PulleyCompoundAdvancedSystemDeflection):
    '''CVTPulleyCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7000.CVTPulleyAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCasesReady, constructor.new(_7000.CVTPulleyAdvancedSystemDeflection))
        return value

    @property
    def component_analysis_cases(self) -> 'List[_7000.CVTPulleyAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentAnalysisCases, constructor.new(_7000.CVTPulleyAdvancedSystemDeflection))
        return value
