...
class ConceptGearAdvancedSystemDeflection(_7017.GearAdvancedSystemDeflection):
    '''ConceptGearAdvancedSystemDeflection
    ...
    @property
    def component_detailed_analysis(self) -> '_503.ConceptGearRating':
        ...
        return constructor.new(_503.ConceptGearRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis else None

    @property
    def component_system_deflection_results(self) -> 'List[_2424.ConceptGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2424.ConceptGearSystemDeflection))
        return value
