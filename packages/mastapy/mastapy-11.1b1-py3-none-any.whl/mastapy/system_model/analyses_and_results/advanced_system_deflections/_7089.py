...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7087, _7088, _6975
...
class ZerolBevelGearSetAdvancedSystemDeflection(_6975.BevelGearSetAdvancedSystemDeflection):
    '''ZerolBevelGearSetAdvancedSystemDeflection
    ...
    @property
    def zerol_bevel_gears_advanced_system_deflection(self) -> 'List[_7087.ZerolBevelGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelGearsAdvancedSystemDeflection, constructor.new(_7087.ZerolBevelGearAdvancedSystemDeflection))
        return value

    @property
    def zerol_bevel_meshes_advanced_system_deflection(self) -> 'List[_7088.ZerolBevelGearMeshAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelMeshesAdvancedSystemDeflection, constructor.new(_7088.ZerolBevelGearMeshAdvancedSystemDeflection))
        return value
