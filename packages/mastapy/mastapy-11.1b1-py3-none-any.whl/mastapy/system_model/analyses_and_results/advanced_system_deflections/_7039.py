...
from mastapy.math_utility.convergence import _1354, _1353
from mastapy.utility_gui import _1595
from mastapy.system_model.drawing import _1952
...
class PartAdvancedSystemDeflection(_7232.PartStaticLoadAnalysisCase):
    '''PartAdvancedSystemDeflection
    ...
    @property
    def advanced_system_deflection(self) -> '_6958.AdvancedSystemDeflection':
        ...
        return constructor.new(_6958.AdvancedSystemDeflection)(self.wrapped.AdvancedSystemDeflection) if self.wrapped.AdvancedSystemDeflection else None

    @property
    def data_logger(self) -> '_1354.DataLogger':
        ...
        if _1354.DataLogger.TYPE not in self.wrapped.DataLogger.__class__.__mro__:
    ...
    def create_viewable(self) -> '_1952.AdvancedSystemDeflectionViewable':
