...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7012, _7013, _7019
...
class FaceGearSetAdvancedSystemDeflection(_7019.GearSetAdvancedSystemDeflection):
    '''FaceGearSetAdvancedSystemDeflection
    ...
    @property
    def face_gears_advanced_system_deflection(self) -> 'List[_7012.FaceGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGearsAdvancedSystemDeflection, constructor.new(_7012.FaceGearAdvancedSystemDeflection))
        return value

    @property
    def face_meshes_advanced_system_deflection(self) -> 'List[_7013.FaceGearMeshAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshesAdvancedSystemDeflection, constructor.new(_7013.FaceGearMeshAdvancedSystemDeflection))
        return value
