...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7006, _7008, _7017
...
class CylindricalGearAdvancedSystemDeflection(_7017.GearAdvancedSystemDeflection):
    '''CylindricalGearAdvancedSystemDeflection
    ...
    @property
    def cylindrical_gear_advanced_system_deflection_meshes(self) -> 'List[_7006.CylindricalGearMeshAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearAdvancedSystemDeflectionMeshes, constructor.new(_7006.CylindricalGearMeshAdvancedSystemDeflection))
        return value

    @property
    def cylindrical_meshed_gear_advanced_system_deflections(self) -> 'List[_7008.CylindricalMeshedGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshedGearAdvancedSystemDeflections, constructor.new(_7008.CylindricalMeshedGearAdvancedSystemDeflection))
        return value

    @property
    def cylindrical_gear_advanced_system_deflections_in_meshes(self) -> 'List[_7008.CylindricalMeshedGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearAdvancedSystemDeflectionsInMeshes, constructor.new(_7008.CylindricalMeshedGearAdvancedSystemDeflection))
        return value
