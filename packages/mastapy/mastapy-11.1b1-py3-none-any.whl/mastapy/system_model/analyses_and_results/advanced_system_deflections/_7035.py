...
class MassDiscAdvancedSystemDeflection(_7083.VirtualComponentAdvancedSystemDeflection):
    '''MassDiscAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2481.MassDiscSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2481.MassDiscSystemDeflection))
        return value
