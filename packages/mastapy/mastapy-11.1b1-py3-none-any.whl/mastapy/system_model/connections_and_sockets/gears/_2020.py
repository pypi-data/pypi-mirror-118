...
class FaceGearMesh(_2022.GearMesh):
    '''FaceGearMesh
    ...
    @property
    def face_gear_mesh_design(self) -> '_929.FaceGearMeshDesign':
        ...
        return constructor.new(_929.FaceGearMeshDesign)(self.wrapped.FaceGearMeshDesign) if self.wrapped.FaceGearMeshDesign else None
