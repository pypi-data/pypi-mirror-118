...
from mastapy.system_model.part_model.gears import _2233, _2249, _2232
...
class CylindricalGearMesh(_2022.GearMesh):
    '''CylindricalGearMesh
    ...
    @property
    def cylindrical_gear_set(self) -> '_2233.CylindricalGearSet':
        ...
        if _2233.CylindricalGearSet.TYPE not in self.wrapped.CylindricalGearSet.__class__.__mro__:
    ...
    @property
    def centre_distance_range(self) -> '_1346.ShortLengthRange':
        ...
        return constructor.new(_1346.ShortLengthRange)(self.wrapped.CentreDistanceRange) if self.wrapped.CentreDistanceRange else None

    @property
    def cylindrical_gear_mesh_design(self) -> '_957.CylindricalGearMeshDesign':
        ...
        return constructor.new(_957.CylindricalGearMeshDesign)(self.wrapped.CylindricalGearMeshDesign) if self.wrapped.CylindricalGearMeshDesign else None
