...
from mastapy.gears.gear_designs.worm import _896
...
class WormGearMesh(_2022.GearMesh):
    '''WormGearMesh
    ...
    @property
    def worm_gear_mesh_design(self) -> '_896.WormGearMeshDesign':
        ...
        return constructor.new(_896.WormGearMeshDesign)(self.wrapped.WormGearMeshDesign) if self.wrapped.WormGearMeshDesign else None
