...
from mastapy.detailed_rigid_connectors.splines import (
    _1180, _1197, _1172, _1175,
    _1179, _1182, _1183, _1190,
    _1202
)
from mastapy._internal.cast_exception import CastException
from mastapy.detailed_rigid_connectors.splines.tolerances_and_deviations import _1203
from mastapy.detailed_rigid_connectors import _1170
...
class SplineHalfDesign(_1170.DetailedRigidConnectorHalfDesign):
    '''SplineHalfDesign
    ...
    @property
    def heat_treatment(self) -> '_1180.HeatTreatmentTypes':
        ...
        return constructor.new(_1180.HeatTreatmentTypes)(value) if value else None

    @heat_treatment.setter
    def heat_treatment(self, value: '_1180.HeatTreatmentTypes'):
    ...
    @property
    def fit_and_tolerance(self) -> '_1203.FitAndTolerance':
        ...
        return constructor.new(_1203.FitAndTolerance)(self.wrapped.FitAndTolerance) if self.wrapped.FitAndTolerance else None
