...
from mastapy.detailed_rigid_connectors.splines import (
    _1176, _1187, _1199, _1191,
    _1188, _1195, _1196, _1171,
    _1174, _1178, _1181, _1189,
    _1201
)
from mastapy._internal.overridable_constructor import _unpack_overridable
from mastapy._internal.cast_exception import CastException
from mastapy.detailed_rigid_connectors import _1169
...
class SplineJointDesign(_1169.DetailedRigidConnectorDesign):
    '''SplineJointDesign
    ...
    @property
    def root_type(self) -> '_1187.RootTypes':
        '''RootTypes: 'RootType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.RootType)
        return constructor.new(_1187.RootTypes)(value) if value else None

    @root_type.setter
    def root_type(self, value: '_1187.RootTypes'):
    ...
    @property
    def torque_cycles(self) -> '_1191.SAETorqueCycles':
        ...
        return constructor.new(_1191.SAETorqueCycles)(value) if value else None

    @torque_cycles.setter
    def torque_cycles(self, value: '_1191.SAETorqueCycles'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.TorqueCycles = value

    @property
    def fatigue_life_factor_type(self) -> '_1188.SAEFatigueLifeFactorTypes':
        ...
        return constructor.new(_1188.SAEFatigueLifeFactorTypes)(value) if value else None

    @fatigue_life_factor_type.setter
    def fatigue_life_factor_type(self, value: '_1188.SAEFatigueLifeFactorTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.FatigueLifeFactorType = value

    @property
    def spline_fixture_type(self) -> '_1195.SplineFixtureTypes':
        ...
        return constructor.new(_1195.SplineFixtureTypes)(value) if value else None

    @spline_fixture_type.setter
    def spline_fixture_type(self, value: '_1195.SplineFixtureTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def external_half(self) -> '_1196.SplineHalfDesign':
        ...
        if _1196.SplineHalfDesign.TYPE not in self.wrapped.ExternalHalf.__class__.__mro__:
    ...
    @property
    def external_half_of_type_custom_spline_half_design(self) -> '_1171.CustomSplineHalfDesign':
        ...
        if _1171.CustomSplineHalfDesign.TYPE not in self.wrapped.ExternalHalf.__class__.__mro__:
    ...
    @property
    def external_half_of_type_din5480_spline_half_design(self) -> '_1174.DIN5480SplineHalfDesign':
        ...
        if _1174.DIN5480SplineHalfDesign.TYPE not in self.wrapped.ExternalHalf.__class__.__mro__:
    ...
    @property
    def external_half_of_type_gbt3478_spline_half_design(self) -> '_1178.GBT3478SplineHalfDesign':
        ...
        if _1178.GBT3478SplineHalfDesign.TYPE not in self.wrapped.ExternalHalf.__class__.__mro__:
    ...
    @property
    def external_half_of_type_iso4156_spline_half_design(self) -> '_1181.ISO4156SplineHalfDesign':
        ...
        if _1181.ISO4156SplineHalfDesign.TYPE not in self.wrapped.ExternalHalf.__class__.__mro__:
    ...
    @property
    def external_half_of_type_sae_spline_half_design(self) -> '_1189.SAESplineHalfDesign':
        ...
        if _1189.SAESplineHalfDesign.TYPE not in self.wrapped.ExternalHalf.__class__.__mro__:
    ...
    @property
    def external_half_of_type_standard_spline_half_design(self) -> '_1201.StandardSplineHalfDesign':
        ...
        if _1201.StandardSplineHalfDesign.TYPE not in self.wrapped.ExternalHalf.__class__.__mro__:
    ...
    @property
    def internal_half(self) -> '_1196.SplineHalfDesign':
        ...
        if _1196.SplineHalfDesign.TYPE not in self.wrapped.InternalHalf.__class__.__mro__:
    ...
    @property
    def internal_half_of_type_custom_spline_half_design(self) -> '_1171.CustomSplineHalfDesign':
        ...
        if _1171.CustomSplineHalfDesign.TYPE not in self.wrapped.InternalHalf.__class__.__mro__:
    ...
    @property
    def internal_half_of_type_din5480_spline_half_design(self) -> '_1174.DIN5480SplineHalfDesign':
        ...
        if _1174.DIN5480SplineHalfDesign.TYPE not in self.wrapped.InternalHalf.__class__.__mro__:
    ...
    @property
    def internal_half_of_type_gbt3478_spline_half_design(self) -> '_1178.GBT3478SplineHalfDesign':
        ...
        if _1178.GBT3478SplineHalfDesign.TYPE not in self.wrapped.InternalHalf.__class__.__mro__:
    ...
    @property
    def internal_half_of_type_iso4156_spline_half_design(self) -> '_1181.ISO4156SplineHalfDesign':
        ...
        if _1181.ISO4156SplineHalfDesign.TYPE not in self.wrapped.InternalHalf.__class__.__mro__:
    ...
    @property
    def internal_half_of_type_sae_spline_half_design(self) -> '_1189.SAESplineHalfDesign':
        ...
        if _1189.SAESplineHalfDesign.TYPE not in self.wrapped.InternalHalf.__class__.__mro__:
    ...
    @property
    def internal_half_of_type_standard_spline_half_design(self) -> '_1201.StandardSplineHalfDesign':
        ...
        if _1201.StandardSplineHalfDesign.TYPE not in self.wrapped.InternalHalf.__class__.__mro__:
