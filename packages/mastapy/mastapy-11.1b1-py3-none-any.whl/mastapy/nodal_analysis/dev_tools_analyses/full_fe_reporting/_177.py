...
from mastapy.fe_tools.vis_tools_visualisation.enums import _1158
...
class CoordinateSystemReporting(_0.APIBase):
    ...
    @property
    def type_(self) -> '_1158.CoordinateSystemType':
        ...
        return constructor.new(_1158.CoordinateSystemType)(value) if value else None
