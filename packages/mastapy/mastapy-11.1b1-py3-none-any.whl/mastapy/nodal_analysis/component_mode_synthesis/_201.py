...
from mastapy.fe_tools.vfx_tools import _1164
...
class CMSOptions(_0.APIBase):
    ...
    @property
    def precision_when_saving_expansion_vectors(self) -> '_1283.DataPrecision':
        ...
        return constructor.new(_1283.DataPrecision)(value) if value else None

    @precision_when_saving_expansion_vectors.setter
    def precision_when_saving_expansion_vectors(self, value: '_1283.DataPrecision'):
    ...
    @property
    def solver_options(self) -> '_1164.ProSolveOptions':
        ...
        return constructor.new(_1164.ProSolveOptions)(self.wrapped.SolverOptions) if self.wrapped.SolverOptions else None
