...
from mastapy.math_utility.optimisation import _1336, _1334
...
class ParetoOptimistaionVariable(_1334.ParetoOptimisationVariableBase):
    '''ParetoOptimistaionVariable
    ...
    @property
    def property_target_for_dominant_candidate_search(self) -> '_1336.PropertyTargetForDominantCandidateSearch':
        ...
        return constructor.new(_1336.PropertyTargetForDominantCandidateSearch)(value) if value else None

    @property_target_for_dominant_candidate_search.setter
    def property_target_for_dominant_candidate_search(self, value: '_1336.PropertyTargetForDominantCandidateSearch'):
