...
from mastapy.bearings import (
    _1620, _1623, _1599, _1600,
    _1601, _1602
)
from mastapy._internal.overridable_constructor import _unpack_overridable
from mastapy.bearings.bearing_designs.rolling import (
    _1890, _1873, _1868, _1864,
    _1883, _1861, _1870, _1882
)
from mastapy._internal.python_net import python_net_import
from mastapy.utility import _1361
from mastapy.materials import _217
from mastapy.bearings.bearing_designs import _1849
...
class RollingBearing(_1849.DetailedBearing):
    '''RollingBearing
    ...
    @property
    def catalogue(self) -> '_1599.BearingCatalog':
        ...
        return constructor.new(_1599.BearingCatalog)(value) if value else None
    ...
    @property
    def type_information(self) -> '_1864.BearingTypeExtraInformation':
        ...
        return constructor.new(_1864.BearingTypeExtraInformation)(value) if value else None
    ...
    @property
    def cage_material(self) -> '_1602.BearingCageMaterial':
        ...
        return constructor.new(_1602.BearingCageMaterial)(value) if value else None

    @cage_material.setter
    def cage_material(self, value: '_1602.BearingCageMaterial'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.CageMaterial = value

    @property
    def sleeve_type(self) -> '_1883.SleeveType':
        ...
        return constructor.new(_1883.SleeveType)(value) if value else None
    ...
    @property
    def history(self) -> '_1361.FileHistory':
        ...
        return constructor.new(_1361.FileHistory)(self.wrapped.History) if self.wrapped.History else None

    @property
    def protection(self) -> '_1861.BearingProtection':
        ...
        return constructor.new(_1861.BearingProtection)(self.wrapped.Protection) if self.wrapped.Protection else None
    ...
    @property
    def geometric_constants(self) -> '_1870.GeometricConstants':
        ...
        return constructor.new(_1870.GeometricConstants)(self.wrapped.GeometricConstants) if self.wrapped.GeometricConstants else None

    @property
    def skf_seal_frictional_moment_constants(self) -> '_1882.SKFSealFrictionalMomentConstants':
        ...
        return constructor.new(_1882.SKFSealFrictionalMomentConstants)(self.wrapped.SKFSealFrictionalMomentConstants) if self.wrapped.SKFSealFrictionalMomentConstants else None
