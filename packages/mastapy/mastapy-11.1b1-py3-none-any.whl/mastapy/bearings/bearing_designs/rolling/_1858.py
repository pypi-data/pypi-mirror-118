...
from mastapy.bearings.bearing_designs.rolling import _1859, _1880
...
class BallBearing(_1880.RollingBearing):
    '''BallBearing
    ...
    @property
    def shoulders(self) -> 'List[_1859.BallBearingShoulderDefinition]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Shoulders, constructor.new(_1859.BallBearingShoulderDefinition))
        return value
