...
from mastapy.bearings.bearing_designs.fluid_film import _1902
...
class TiltingPadThrustBearing(_1902.PadFluidFilmBearing):
    '''TiltingPadThrustBearing
    ...
    @property
    def tilting_pad_type(self) -> '_1627.TiltingPadTypes':
        ...
        return constructor.new(_1627.TiltingPadTypes)(value) if value else None

    @tilting_pad_type.setter
    def tilting_pad_type(self, value: '_1627.TiltingPadTypes'):
