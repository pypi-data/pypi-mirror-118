...
class PlainGreaseFilledJournalBearing(_1906.PlainJournalBearing):
    '''PlainGreaseFilledJournalBearing
    ...
    @property
    def housing_type(self) -> '_1905.PlainGreaseFilledJournalBearingHousingType':
        ...
        return constructor.new(_1905.PlainGreaseFilledJournalBearingHousingType)(value) if value else None

    @housing_type.setter
    def housing_type(self, value: '_1905.PlainGreaseFilledJournalBearingHousingType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.HousingType = value

    @property
    def housing_detail(self) -> '_1907.PlainJournalHousing':
        ...
        if _1907.PlainJournalHousing.TYPE not in self.wrapped.HousingDetail.__class__.__mro__:
    ...
    @property
    def housing_detail_of_type_cylindrical_housing_journal_bearing(self) -> '_1900.CylindricalHousingJournalBearing':
        ...
        if _1900.CylindricalHousingJournalBearing.TYPE not in self.wrapped.HousingDetail.__class__.__mro__:
    ...
    @property
    def housing_detail_of_type_machinery_encased_journal_bearing(self) -> '_1901.MachineryEncasedJournalBearing':
        ...
        if _1901.MachineryEncasedJournalBearing.TYPE not in self.wrapped.HousingDetail.__class__.__mro__:
    ...
    @property
    def housing_detail_of_type_pedestal_journal_bearing(self) -> '_1903.PedestalJournalBearing':
        ...
        if _1903.PedestalJournalBearing.TYPE not in self.wrapped.HousingDetail.__class__.__mro__:
