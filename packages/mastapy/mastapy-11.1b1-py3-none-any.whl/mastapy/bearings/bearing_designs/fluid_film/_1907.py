...
from mastapy.bearings.bearing_results import _1669
...
class PlainJournalHousing(_0.APIBase):
    ...
    @property
    def heat_emitting_area_method(self) -> '_1669.DefaultOrUserInput':
        ...
        return constructor.new(_1669.DefaultOrUserInput)(value) if value else None

    @heat_emitting_area_method.setter
    def heat_emitting_area_method(self, value: '_1669.DefaultOrUserInput'):
