...
class RollingBearingDatabase(_1579.SQLDatabase['_1622.RollingBearingKey', '_1880.RollingBearing']):
    '''RollingBearingDatabase
    ...
    def add_to_database(self, bearing: '_1880.RollingBearing'):
    ...
    def remove_from_database(self, bearing: '_1880.RollingBearing'):
    ...
    def search_for_rolling_bearing(self, designation: 'str', catalog: '_1599.BearingCatalog', type_: '_1624.RollingBearingType', bore_range: '_1269.Range', outer_diameter_range: '_1269.Range', width_range: '_1269.Range', dynamic_capacity_range: '_1269.Range', number_of_rows: 'int', material_type: '_1613.HybridSteelAll') -> 'List[_1880.RollingBearing]':
    ...
    def search_for_rolling_bearing_with_name_catalog_and_type(self, designation: 'str', catalog: '_1599.BearingCatalog', type_: '_1624.RollingBearingType') -> 'List[_1880.RollingBearing]':
        ...
        catalog = conversion.mp_to_pn_enum(catalog)
        type_ = conversion.mp_to_pn_enum(type_)
        return conversion.pn_to_mp_objects_in_list(self.wrapped.SearchForRollingBearing.Overloads[_STRING, _BEARING_CATALOG, _ROLLING_BEARING_TYPE](designation if designation else None, catalog, type_), constructor.new(_1880.RollingBearing))

    def search_for_rolling_bearing_with_name_and_catalog(self, designation: 'str', catalog: '_1599.BearingCatalog') -> '_1880.RollingBearing':
        ''' 'SearchForRollingBearing' is the original name of this method.
    ...
    def search_for_rolling_bearing_with_catalog(self, catalog: '_1599.BearingCatalog') -> 'List[_1880.RollingBearing]':
        ''' 'SearchForRollingBearing' is the original name of this method.
        ...
        catalog = conversion.mp_to_pn_enum(catalog)
        return conversion.pn_to_mp_objects_in_list(self.wrapped.SearchForRollingBearing.Overloads[_BEARING_CATALOG](catalog), constructor.new(_1880.RollingBearing))

    def create_bearing(self, type_: '_1624.RollingBearingType', designation: Optional['str'] = 'None') -> '_1880.RollingBearing':
    ...
    def create_bearing_with_type_name(self, type_: 'str', designation: Optional['str'] = 'None') -> '_1880.RollingBearing':
        ''' 'CreateBearing' is the original name of this method.
    ...
    def create_key(self, type_: '_1624.RollingBearingType', designation: Optional['str'] = 'None') -> '_1622.RollingBearingKey':
    ...
    def create_key_with_type_name(self, type_: 'str', designation: Optional['str'] = 'None') -> '_1622.RollingBearingKey':
        ''' 'CreateKey' is the original name of this method.
