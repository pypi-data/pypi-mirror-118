...
from mastapy.bearings.bearing_results.rolling import _1702, _1705, _1722
...
class LoadedAngularContactBallBearingRow(_1722.LoadedBallBearingRow):
    '''LoadedAngularContactBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1702.LoadedAngularContactBallBearingResults':
