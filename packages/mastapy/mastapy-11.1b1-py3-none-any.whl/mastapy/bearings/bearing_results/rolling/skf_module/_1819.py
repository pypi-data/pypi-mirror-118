...
from mastapy.bearings.bearing_results.rolling.skf_module import _1812, _1815
...
class Viscosities(_1815.SKFCalculationResult):
    '''Viscosities
    ...
    @property
    def operating_viscosity(self) -> '_1812.OperatingViscosity':
        ...
        return constructor.new(_1812.OperatingViscosity)(self.wrapped.OperatingViscosity) if self.wrapped.OperatingViscosity else None
