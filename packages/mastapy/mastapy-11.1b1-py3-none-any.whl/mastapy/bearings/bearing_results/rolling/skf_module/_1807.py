...
class GreaseLifeAndRelubricationInterval(_1815.SKFCalculationResult):
    '''GreaseLifeAndRelubricationInterval
    ...
    def grease(self) -> '_1806.Grease':
        ...
        return constructor.new(_1806.Grease)(self.wrapped.Grease) if self.wrapped.Grease else None

    @property
    def initial_fill(self) -> '_1809.InitialFill':
        ...
        return constructor.new(_1809.InitialFill)(self.wrapped.InitialFill) if self.wrapped.InitialFill else None

    @property
    def grease_quantity(self) -> '_1808.GreaseQuantity':
        ...
        return constructor.new(_1808.GreaseQuantity)(self.wrapped.GreaseQuantity) if self.wrapped.GreaseQuantity else None
