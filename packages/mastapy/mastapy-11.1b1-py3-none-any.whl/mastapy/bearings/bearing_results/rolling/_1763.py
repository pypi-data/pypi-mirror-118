...
from mastapy.bearings.bearing_results.rolling import _1762, _1749
...
class LoadedSphericalRollerThrustBearingRow(_1749.LoadedRollerBearingRow):
    '''LoadedSphericalRollerThrustBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1762.LoadedSphericalRollerThrustBearingResults':
        ...
        return constructor.new(_1762.LoadedSphericalRollerThrustBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
