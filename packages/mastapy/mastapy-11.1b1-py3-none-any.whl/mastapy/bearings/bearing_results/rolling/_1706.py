...
from mastapy.bearings.bearing_results.rolling import _1705, _1703
...
class LoadedAngularContactThrustBallBearingRow(_1703.LoadedAngularContactBallBearingRow):
    '''LoadedAngularContactThrustBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1705.LoadedAngularContactThrustBallBearingResults':
        ...
        return constructor.new(_1705.LoadedAngularContactThrustBallBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
