...
from mastapy.bearings.bearing_results.rolling import _1692, _1733
...
class LoadedBallBearingElement(_1733.LoadedElement):
    '''LoadedBallBearingElement
    ...
    @property
    def inner_race_contact_geometries(self) -> 'List[_1692.BallBearingRaceContactGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.InnerRaceContactGeometries, constructor.new(_1692.BallBearingRaceContactGeometry))
        return value

    @property
    def outer_race_contact_geometries(self) -> 'List[_1692.BallBearingRaceContactGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.OuterRaceContactGeometries, constructor.new(_1692.BallBearingRaceContactGeometry))
        return value
