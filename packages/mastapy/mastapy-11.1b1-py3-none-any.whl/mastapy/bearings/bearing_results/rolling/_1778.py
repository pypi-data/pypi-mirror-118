...
from mastapy.bearings.bearing_results.rolling import _1777, _1749
...
class LoadedToroidalRollerBearingRow(_1749.LoadedRollerBearingRow):
    '''LoadedToroidalRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1777.LoadedToroidalRollerBearingResults':
        ...
        return constructor.new(_1777.LoadedToroidalRollerBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
