...
from mastapy.bearings.bearing_results.rolling import _1716, _1714
...
class LoadedAxialThrustNeedleRollerBearingRow(_1714.LoadedAxialThrustCylindricalRollerBearingRow):
    '''LoadedAxialThrustNeedleRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1716.LoadedAxialThrustNeedleRollerBearingResults':
        ...
        return constructor.new(_1716.LoadedAxialThrustNeedleRollerBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
