...
from mastapy.bearings.bearing_results.rolling import (
    _1721, _1702, _1705, _1731,
    _1736, _1755, _1771, _1774,
    _1720, _1753
)
...
class LoadedBallBearingRow(_1753.LoadedRollingBearingRow):
    '''LoadedBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1721.LoadedBallBearingResults':
    ...
    @property
    def race_results(self) -> 'List[_1720.LoadedBallBearingRaceResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RaceResults, constructor.new(_1720.LoadedBallBearingRaceResults))
        return value
