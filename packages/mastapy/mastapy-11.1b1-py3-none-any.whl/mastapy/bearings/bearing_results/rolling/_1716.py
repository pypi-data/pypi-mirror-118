...
from mastapy.bearings.bearing_results.rolling import _1713
...
class LoadedAxialThrustNeedleRollerBearingResults(_1713.LoadedAxialThrustCylindricalRollerBearingResults):
    '''LoadedAxialThrustNeedleRollerBearingResults
