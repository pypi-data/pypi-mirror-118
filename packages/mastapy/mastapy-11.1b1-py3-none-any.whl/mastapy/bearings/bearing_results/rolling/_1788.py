...
class RingForceAndDisplacement(_0.APIBase):
    ...
    @property
    def force(self) -> '_1345.VectorWithLinearAndAngularComponents':
        ...
        return constructor.new(_1345.VectorWithLinearAndAngularComponents)(self.wrapped.Force) if self.wrapped.Force else None
