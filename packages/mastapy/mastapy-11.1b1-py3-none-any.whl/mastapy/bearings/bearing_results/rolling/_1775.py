...
from mastapy.bearings.bearing_results.rolling import _1774, _1722
...
class LoadedThrustBallBearingRow(_1722.LoadedBallBearingRow):
    '''LoadedThrustBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1774.LoadedThrustBallBearingResults':
        ...
        return constructor.new(_1774.LoadedThrustBallBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
