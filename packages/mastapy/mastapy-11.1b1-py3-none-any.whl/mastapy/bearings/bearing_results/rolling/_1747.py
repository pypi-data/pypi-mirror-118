...
from mastapy.bearings.bearing_results.rolling import _1787, _1733
...
class LoadedRollerBearingElement(_1733.LoadedElement):
    '''LoadedRollerBearingElement
    ...
    @property
    def results_at_roller_offsets(self) -> 'List[_1787.ResultsAtRollerOffset]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ResultsAtRollerOffsets, constructor.new(_1787.ResultsAtRollerOffset))
        return value
