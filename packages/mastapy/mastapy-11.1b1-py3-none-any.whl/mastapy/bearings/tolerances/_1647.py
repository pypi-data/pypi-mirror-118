...
from mastapy.bearings.tolerances import _1643, _1635
...
class SupportDetail(_1635.InterferenceDetail):
    '''SupportDetail
    ...
    @property
    def radial_specification_method(self) -> '_1643.RadialSpecificationMethod':
        ...
        return constructor.new(_1643.RadialSpecificationMethod)(value) if value else None

    @radial_specification_method.setter
    def radial_specification_method(self, value: '_1643.RadialSpecificationMethod'):
