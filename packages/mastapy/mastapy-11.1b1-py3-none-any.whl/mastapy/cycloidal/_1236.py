...
class CycloidalDiscDesign(_0.APIBase):
    ...
    @property
    def modifications_specification(self) -> '_1239.CycloidalDiscModificationsSpecification':
        ...
        return constructor.new(_1239.CycloidalDiscModificationsSpecification)(self.wrapped.ModificationsSpecification) if self.wrapped.ModificationsSpecification else None
