...
from mastapy.cycloidal import _1242, _1236, _1241
...
class CycloidalAssemblyDesign(_0.APIBase):
    ...
    @property
    def ring_pins(self) -> '_1242.RingPinsDesign':
        ...
        return constructor.new(_1242.RingPinsDesign)(self.wrapped.RingPins) if self.wrapped.RingPins else None

    @property
    def discs(self) -> 'List[_1236.CycloidalDiscDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Discs, constructor.new(_1236.CycloidalDiscDesign))
        return value

    @property
    def disc_phases(self) -> 'List[_1241.NamedDiscPhase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DiscPhases, constructor.new(_1241.NamedDiscPhase))
        return value
