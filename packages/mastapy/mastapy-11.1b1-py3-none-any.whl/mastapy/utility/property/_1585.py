...
from mastapy.utility.units_and_measurements.measurements import _1411
...
class DutyCyclePropertySummaryForce(_1584.DutyCyclePropertySummary['_1411.Force', 'T'], Generic[T]):
    '''DutyCyclePropertySummaryForce
