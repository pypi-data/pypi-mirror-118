...
from mastapy.utility.units_and_measurements.measurements import _1390
...
class DutyCyclePropertySummarySmallAngle(_1584.DutyCyclePropertySummary['_1390.AngleSmall', 'T'], Generic[T]):
    '''DutyCyclePropertySummarySmallAngle
