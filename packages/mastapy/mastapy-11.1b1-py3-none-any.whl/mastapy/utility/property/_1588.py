...
from mastapy.utility.units_and_measurements.measurements import _1473
...
class DutyCyclePropertySummaryStress(_1584.DutyCyclePropertySummary['_1473.Stress', 'T'], Generic[T]):
    '''DutyCyclePropertySummaryStress
