...
from mastapy.utility.cad_export import _1581
from mastapy.utility.report import _1525
...
class CustomReportCadDrawing(_1525.CustomReportNameableItem):
    '''CustomReportCadDrawing
    ...
    @property
    def stock_drawing(self) -> '_1581.StockDrawings':
        '''StockDrawings: 'StockDrawing' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.StockDrawing)
        return constructor.new(_1581.StockDrawings)(value) if value else None

    @stock_drawing.setter
    def stock_drawing(self, value: '_1581.StockDrawings'):
