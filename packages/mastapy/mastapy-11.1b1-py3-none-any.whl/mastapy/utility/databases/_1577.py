...
class NamedDatabaseItem(_0.APIBase):
    ...
    @property
    def database_key(self) -> '_1578.NamedKey':
        '''NamedKey: 'DatabaseKey' is the original name of this property.'''

        return constructor.new(_1578.NamedKey)(self.wrapped.DatabaseKey) if self.wrapped.DatabaseKey else None

    @database_key.setter
    def database_key(self, value: '_1578.NamedKey'):
