...
from mastapy.utility.model_validation import _1542
...
class StatusItem(_0.APIBase):
    ...
    def fixes(self) -> 'List[_1542.Fix]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Fixes, constructor.new(_1542.Fix))
        return value
