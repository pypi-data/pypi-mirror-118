...
class Status(_0.APIBase):
    ...
    @property
    def errors(self) -> 'List[_1545.StatusItem]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Errors, constructor.new(_1545.StatusItem))
        return value

    @property
    def warnings(self) -> 'List[_1545.StatusItem]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Warnings, constructor.new(_1545.StatusItem))
        return value
