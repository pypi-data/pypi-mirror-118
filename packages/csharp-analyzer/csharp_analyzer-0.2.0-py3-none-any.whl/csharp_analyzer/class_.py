            ...
            if char == '[':
                ...
                if abs(open_brace_class - close_brace_class) == 1:
                    ...
                    property_match = re.search(
                        r'(public|internal|private|protected)\s*([a-zA-Z]*)\s*([a-zA-Z_<>]*)\s([a-zA-Z_0-9]*)\s*[\s\S]*?return ([\s\S]*?);', code)
                    ...
                    if property_match is not None:
                        self.Propeties.append(
                            Property(Access_modifiers=property_match.group(1),
                                     ...
                                     Return_value=property_match.group(5),
                                     Code=code
                                     ))

                    method_match = re.search(
                        r'(public|internal|private|protected)\s*(async|)\s*([a-zA-Z]*)\s*([a-zA-Z_]*)\(([a-zA-Z.0-9 ,]*)\)([\s\S]*?return\s*([\s\S]*?);|)', code)
