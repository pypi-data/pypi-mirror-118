...
class Arduino:
    ...
    def pump_connect(self, pressure, target_pressure, status):
        self.pump.write(bytes(str(pressure) + '/' + str(target_pressure) + '/' + str(status) + '/\n', 'utf-8'))
