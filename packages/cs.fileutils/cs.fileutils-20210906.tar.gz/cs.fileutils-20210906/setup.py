...
setup(
 ...
 "Additional release because I'm unsure @atomic_filename made it into the "    
 'previous release.\n'    
 '\n'    
 ...
 '\n'    
 '## Function `atomic_filename(filename, exists_ok=False, placeholder=False, '    
 'dir=None, prefix=None, suffix=None, **kw)`\n'    
 '\n'    
 'A context manager to create `filename` atomicly on completion.\n'    
 '      This returns a `NamedTemporaryFile` to use to create the file '    
 'contents.\n'    
 '      On completion the temporary file is renamed to the target name '    
 '`filename`.\n'    
 '\n'    
 '      Parameters:\n'    
 ...
 "        for the temporary file; the default is a dot (`'.'`) plus the "    
 'prefix\n'    
 ...
 '        from `splitext(basename(filename))`\n'    
 '      Other keyword arguments are passed to the `NamedTemporaryFile` '    
 'constructor.\n'    
 '\n'    
 '      Example:\n'    
 '\n'    
 ...
 '\n'    
 '*Release 20210731*:\n'    
 'New atomic_filename context manager wrapping NamedTemporaryFile for '    
 'presenting a file after its contents are prepared.\n'    
 '\n'    
 '*Release 20210717*:\n'    
 ...
 'Initial PyPI release.'),
  install_requires = ['cs.buffer', 'cs.deco', 'cs.env', 'cs.filestate', 'cs.lex>=20200914', 'cs.logutils', 'cs.mappings>=20210717', 'cs.obj', 'cs.pfx>=20210731', 'cs.progress', 'cs.py3', 'cs.range', 'cs.result', 'cs.threads', 'cs.timeutils', 'cs.units'],
