...
class TestInferences:
    ...
    def test_format_inference_no_gt(self, mock_client, tabular_batch_model):
        inference = tabular_batch_model._format_inference_request(
    ...
    @responses.activate
    def test_format_inference_request(self, tabular_batch_model):
        inf = tabular_batch_model._format_inference_request(
    ...
    def test_send_inferences(self, tabular_batch_model, case: InferencesCase):
        ...
        with patch("arthurai.core.models.shortuuid.uuid") as uuid_mock:
            with patch("arthurai.core.models.datetime") as datetime_mock:
                ...
                actual_response = tabular_batch_model.send_inferences(*case.pos_args, **case.kwargs)
    ...
    def test_update_ground_truth(self, tabular_batch_model, case: InferencesCase):
        pos_args_copy = deepcopy(case.pos_args)
        kwargs_copy = deepcopy(case.kwargs)
        ...
        with patch("arthurai.core.models.datetime") as datetime_mock:
            datetime_mock.now.side_effect = datetime_generator.next
            actual_response = tabular_batch_model.update_inference_ground_truths(*case.pos_args, **case.kwargs)
