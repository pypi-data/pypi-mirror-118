...
class TestBenchmarkGroup(object):
    ...
    def update_benchmark_parameters(self, benchmark_pars,  parameters, group_name, group_key, project):
        benchmark_pars["group_key"] = group_key
        benchmark_pars["group_name"] = group_name
        benchmark_pars["key"] = parameters["key"]
        benchmark_pars["project_name"] = project
        ...
        try:
            ...
            if benchmarks is not None:
                ...
                for item in benchmarks:
                    fio = Fio()
                    benchmark_parm = self.update_benchmark_parameters(item, parameters, test_name, group_key, parameters["project"])
