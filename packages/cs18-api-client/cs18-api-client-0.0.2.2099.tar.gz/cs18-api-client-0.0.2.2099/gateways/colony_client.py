...
class Colony:
    ...
    def submit_new_user_survey(self, account_id: str, survey: NewUserSurveyRequest) -> Response:
        method_url = self._api_root.account.submit_new_user_survey(account_id)
