...
class RMLogin(BaseResposne):
    ...
    INSIGNIFICANT_KEYS = ['debarrDate','createdAt','__v' ,'success','debarr','extraCurriculars']

    current_tz="GMT"
    conversion_tz="Asia/Kolkata"

    courses=["BTech", "MTech", "MSc", "MBA", "BBA", "BAE", "BDes"]
    ...
    def extract_profile(self, **kwargs):
        ...
        profile['data']['lockResumes'] =kwargs.get('lockResumes')
