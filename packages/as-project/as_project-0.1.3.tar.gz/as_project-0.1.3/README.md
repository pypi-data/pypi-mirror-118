...
```
alphabet_soup.py--contains the alphabet soup function.  Calling it with a
      the name of a valid input file will produce the outputs
test/soup_test.py--runs unit tests
data/--contains some sample input files
bin/given.py--runs the example problem given
