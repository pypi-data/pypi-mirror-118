...
class Parser:
    def __init__(self):
        ...
        parser = argparse.ArgumentParser(description='Gan Refiner Framework.')
        ...
        parser_test.add_argument(
                ...
                nargs=1,
                required=True,
                help='1.use GAN to refine a folder, 2.use GAN to refine a tfrecords file, 3.to read images from a tfrecords file')
        parser_test.add_argument(
                '-s',
                metavar='step',
                nargs=1,
    ...
    def testParser(self, args):
        ...
        self.env.in_root_path=None
        if args.in_root:
            self.env.in_root_path = args.in_root[0]
