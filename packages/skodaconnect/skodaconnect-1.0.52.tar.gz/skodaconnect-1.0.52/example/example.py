...
#USERNAME = 'marcin.szafranski@gmail.com'
#PASSWORD = 'qqQ$9CwnrhRP#R+&'
PRINTRESPONSE = True
INTERVAL = 20
...
async def main():
    ...
    async with ClientSession(headers={'Connection': 'keep-alive'}) as session:
        ...
        myCar = connection.vehicle("TMBJW7NP0L7050944")
        result = await  myCar.set_timer_schedule(id = 2, schedule = {'id': 2, 'enabled': True, 'recurring': True, 'date': None, 'time': '13:30', 'days': 'yyynnnn', 'temp': 2950})
        print(result)
