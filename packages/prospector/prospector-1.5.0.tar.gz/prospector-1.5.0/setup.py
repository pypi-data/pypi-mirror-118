...
['PyYAML',
 ...
 'setoptconf>=0.2.0,<0.3.0',
 'toml>=0.10.2,<0.11.0']

extras_require = \
{'with_bandit': ['bandit>=1.7.0,<2.0.0'],
 'with_everything': ['bandit>=1.7.0,<2.0.0',
                     'frosted>=1.4.1,<2.0.0',
                     'vulture>=1.5,<2.0',
                     'mypy>=0.910,<0.911',
                     'pyroma>=2.4,<2.5'],
 'with_frosted': ['frosted>=1.4.1,<2.0.0'],
 'with_mypy': ['mypy>=0.910,<0.911'],
 'with_pyroma': ['pyroma>=2.4,<2.5'],
 'with_vulture': ['vulture>=1.5,<2.0']}
