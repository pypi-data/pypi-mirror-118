...
VersionFitz = "1.18.0"
VersionBind = "1.18.17"
VersionDate = "2021-08-23 00:00:01"
version = (VersionBind, VersionFitz, "20210823000001")
...
class Page(object):
    ...
    def get_cdrawings(self, clippings: int = 0) -> AnyType:
        ...
        val = _fitz.Page_get_cdrawings(self, clippings)
    ...
    def _get_texttrace(self) -> AnyType:
        ...
        val = _fitz.Page__get_texttrace(self)
