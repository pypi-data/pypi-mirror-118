...
@LastEditTime: 2021-09-06 13:36:17
                ...
                if len(order_data)>0: 
                    ...
                    if len(tao_pay_order_list) > 0:
                        ...
                        if result == True and buy_num > 0: 
                            ...
                            asset_invoke_result_data = asset_base_model.update_user_asset(app_id,act_id,module_id,user_id,user_info_dict["open_id"],user_info_dict["user_nick"],asset_type,buy_num,asset_object_id,1,"","","购买",only_id,handler_name,request_code,info_json={})
