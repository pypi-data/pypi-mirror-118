...
@LastEditTime: 2021-08-26 10:28:43
...
class AssetBaseModel():
    ...
    def update_user_asset(self, app_id, act_id, module_id, user_id, open_id, user_nick, asset_type, asset_value, asset_object_id, source_type, source_object_id, source_object_name, log_title, only_id="",handler_name="",request_code="", info_json={}, sub_table=None):
        """
        :description: 变更资产
        :param act_id：活动标识
        ...
        acquire_lock_name = f"userasset:{user_asset_id}"
        ...
        try:
            ...
            user_asset.asset_check_code = self._get_asset_check_code(user_asset_id, user_asset.asset_value, app_id)
    ...
    def get_user_asset_list(self, app_id, act_id, user_ids, asset_type=0, sub_table=None):
        """
    ...
    def get_asset_log_list(self, app_id, act_id, asset_type, page_size=20, page_index=0, user_id=0, asset_object_id="", start_date="", end_date="", user_nick="", open_id="", source_type=0, source_object_id="", field="*", sub_table=None):
        """
