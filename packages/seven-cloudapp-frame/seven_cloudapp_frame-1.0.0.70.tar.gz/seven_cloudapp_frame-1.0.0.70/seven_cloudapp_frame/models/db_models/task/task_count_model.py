...
@LastEditTime: 2021-08-11 18:48:36
...
class TaskCount:
    ...
    def __init__(self):
        ...
        self.id = 0  # 标识由 md5_encrypt_int(actid+moduleid+tasktype+tasksubtype+userid)生成
        self.app_id = ""  # 应用标识
        self.act_id = 0  # 活动标识
    ...
    def get_field_list(self):
        return ['id', 'app_id', 'act_id', 'module_id', 'user_id', 'open_id', 'task_type', 'task_sub_type', 'complete_count', 'now_count', 'create_date', 'modify_date', 'modify_day', 'remark']
