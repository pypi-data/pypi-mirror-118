...
@LastEditTime: 2021-09-06 15:04:53
...
class UserBaseModel(FrameBaseModel):
    ...
    def get_join_member_url(self,access_token,app_key,app_secret,is_log):
        ...
        join_member_url = top_base_model.get_join_member_url(access_token,app_key,app_secret,is_log)
        if join_member_url and (("https:" not in join_member_url) or ("http:" not in join_member_url)):
            join_member_url = "https:" + join_member_url
