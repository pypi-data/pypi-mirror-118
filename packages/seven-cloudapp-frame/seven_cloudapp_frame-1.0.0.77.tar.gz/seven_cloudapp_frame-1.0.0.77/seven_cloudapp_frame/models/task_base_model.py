...
@LastEditTime: 2021-09-01 10:25:16
...
class TaskBaseModel(FrameBaseModel):
    ...
    def get_client_task_list(self,app_id,act_id,module_id,user_id,task_types="",app_key="",app_secret="",is_log=False):
        ...
        :last_editors: HuangJianYi
        """
        task_sub_table = self.get_sub_table(act_id,config.get_value("task_sub_table_count",0))
                ...
                if task_invoke_result_data.success == True:
                    ...
                    if reward_value <= 0 or task_count.now_count <=0:
                        ...
                        if task_type == int(TaskType.invite_new_user.value) or task_type == int(TaskType.invite_join_member.value):     
                            ...
                            invite_sub_table = self.get_sub_table(act_id,config.get_value("invite_sub_table_count",0))
                            ...
                            if task_type == int(TaskType.collect_goods.value):
                                collect_sub_table = self.get_sub_table(act_id,config.get_value("collect_sub_table_count",0))
                                ...
                                browse_sub_table = self.get_sub_table(act_id,config.get_value("browse_sub_table_count",0))
