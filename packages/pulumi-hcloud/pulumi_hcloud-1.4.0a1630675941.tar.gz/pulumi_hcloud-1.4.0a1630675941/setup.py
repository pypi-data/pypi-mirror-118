...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'hcloud', '1.4.0-alpha.1630675941+db2b9c19'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource hcloud 1.4.0-alpha.1630675941+db2b9c19`
                """)
            else:
                raise
