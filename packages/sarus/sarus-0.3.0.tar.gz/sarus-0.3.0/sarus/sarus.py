...
class Dataset:
    ...
    def as_tensorflow(
        ...
        if max_download_size is not None:
            logging.warning(
                "If `max_download_size` lower than total number of "
                "remote synth data,"
    ...
    def as_pandas(
        ...
        if max_download_size is not None:
            logging.warning(
                "If `max_download_size` lower than total number of remote "
                "synth data, local operations' results will differ from "
                "remote results. \nUse `max_download_size`=None to "
                "locally download all available synth data"
            )
