...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, name=None, pulp_labels=None, description=None, retained_versions=None, pulp_created=None, latest_version_href=None, pulp_href=None, versions_href=None, local_vars_configuration=None):  # noqa: E501
