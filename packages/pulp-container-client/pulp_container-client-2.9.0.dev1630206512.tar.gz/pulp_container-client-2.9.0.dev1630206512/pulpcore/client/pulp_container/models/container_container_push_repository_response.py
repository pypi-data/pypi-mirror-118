...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, name=None, retained_versions=None, pulp_labels=None, pulp_href=None, description=None, latest_version_href=None, versions_href=None, pulp_created=None, local_vars_configuration=None):  # noqa: E501
