...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, base_path=None, repository=None, pulp_href=None, name=None, pulp_created=None, content_guard=None, pulp_labels=None, repository_version=None, registry_path=None, namespace=None, private=None, description=None, local_vars_configuration=None):  # noqa: E501
