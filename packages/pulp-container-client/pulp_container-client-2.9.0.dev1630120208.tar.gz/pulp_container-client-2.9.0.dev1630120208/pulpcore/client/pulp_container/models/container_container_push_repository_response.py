...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, latest_version_href=None, pulp_href=None, versions_href=None, name=None, description=None, pulp_created=None, pulp_labels=None, retained_versions=None, local_vars_configuration=None):  # noqa: E501
