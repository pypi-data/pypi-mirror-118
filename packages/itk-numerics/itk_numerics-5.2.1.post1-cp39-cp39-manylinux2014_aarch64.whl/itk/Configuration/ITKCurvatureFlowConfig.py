...
templates = (
  ...
  ('CurvatureFlowImageFilter', 'itk::CurvatureFlowImageFilter', 'itkCurvatureFlowImageFilterIF4IF4', True, 'itk::Image< float,4 >, itk::Image< float,4 >'),
  ...
  ('CurvatureFlowImageFilter', 'itk::CurvatureFlowImageFilter', 'itkCurvatureFlowImageFilterID4ID4', True, 'itk::Image< double,4 >, itk::Image< double,4 >'),
  ...
  ('MinMaxCurvatureFlowImageFilter', 'itk::MinMaxCurvatureFlowImageFilter', 'itkMinMaxCurvatureFlowImageFilterIF4IF4', True, 'itk::Image< float,4 >, itk::Image< float,4 >'),
  ...
  ('MinMaxCurvatureFlowImageFilter', 'itk::MinMaxCurvatureFlowImageFilter', 'itkMinMaxCurvatureFlowImageFilterID4ID4', True, 'itk::Image< double,4 >, itk::Image< double,4 >'),
  ...
  ('BinaryMinMaxCurvatureFlowImageFilter', 'itk::BinaryMinMaxCurvatureFlowImageFilter', 'itkBinaryMinMaxCurvatureFlowImageFilterIF4IF4', True, 'itk::Image< float,4 >, itk::Image< float,4 >'),
  ...
  ('BinaryMinMaxCurvatureFlowImageFilter', 'itk::BinaryMinMaxCurvatureFlowImageFilter', 'itkBinaryMinMaxCurvatureFlowImageFilterID4ID4', True, 'itk::Image< double,4 >, itk::Image< double,4 >'),
)
