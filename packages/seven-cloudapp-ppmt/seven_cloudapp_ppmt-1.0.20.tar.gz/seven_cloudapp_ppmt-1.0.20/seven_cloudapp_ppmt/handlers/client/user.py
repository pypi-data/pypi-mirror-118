...
@LastEditTime: 2021-08-31 17:09:48
...
class GivePropHandler(SevenBaseHandler):
    ...
    def get_async(self):
        ...
        give_config_json = self.json_loads(act_dict["give_config_json"])
        if not give_config_json:
        ...
        if prop_type == 3:
            ...
            if prop_give_total >= int(give_config_json["tips_limit_count"]):
            ...
            if prop_give_total >= int(give_config_json["redraw_limit_count"]):
            ...
            if prop_give_total >= int(give_config_json["perspective_limit_count"]):
