...
from qingtest.globals import g, now, timestamp
from qingtest.elements import e
from qingtest.windows import w
from qingtest.snapshot import Snapshot
from qingtest.locator import locating_elements, locating_data, locating_element
from qingtest.keywords import web, common, mobile, http, files
from qingtest.config import web_keywords, common_keywords, mobile_keywords, http_keywords, windows_keywords, files_keywords
from qingtest.utility import replace_dict, replace
        ...
        for index, step in enumerate(self.testcase['steps']):
            ...
            try:
                ...
                if g.platform.lower() in ('desktop',) and step['keyword'].upper() in web_keywords:
                    ...
                    from qingtest.keywords import windows
                    _page = ''
