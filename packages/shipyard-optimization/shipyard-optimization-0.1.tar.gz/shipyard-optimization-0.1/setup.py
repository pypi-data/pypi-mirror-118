...
setup(
    ...
    name                = 'shipyard-optimization',
    # 배포할 패키지의 버전을 적어줍니다. 첫 등록이므로 0.1 또는 0.0.1을 사용합니다.
    version             = '0.1',
    # 배포할 패키지에 대한 설명을 작성합니다.
    description         = 'shipyard_optimization',
    # 배포하는 사람의 이름을 작성합니다.
    author              = 'cscUOU',
    # 배포하는 사람의 메일주소를 작성합니다.
    author_email        = 'kgm0817@gmail.com',
    # 배포하는 패키지의 url을 적어줍니다. 보통 github 링크를 적습니다.
    url                 = 'https://github.com/cscUOU/Shipyard-process-logistics-optimization',
    # 배포하는 패키지의 다운로드 url을 적어줍니다.
    download_url        = 'https://github.com/cscUOU/Shipyard-process-logistics-optimization/archive/master.zip',
