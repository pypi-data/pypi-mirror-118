...
2. You should install DeepParcellation with force parameter when all the other dependencies were manually met, i.e., you have installed tensorflow dependencies for Apple M1 chips.
