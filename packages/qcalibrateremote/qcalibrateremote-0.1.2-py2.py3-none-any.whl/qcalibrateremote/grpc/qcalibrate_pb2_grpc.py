...
class QCalibrateStub(object):
    ...
    def __init__(self, channel):
        ...
        self.AddExperiment = channel.unary_unary(
                '/qcalibrateremote.grpc.QCalibrate/AddExperiment',
        ...
        self.Run = channel.stream_stream(
                '/qcalibrateremote.grpc.QCalibrate/Run',
...
def add_QCalibrateServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'qcalibrateremote.grpc.QCalibrate', rpc_method_handlers)
...
class QCalibrate(object):
    ...
    def AddExperiment(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/qcalibrateremote.grpc.QCalibrate/AddExperiment',
    ...
    def Run(request_iterator,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.stream_stream(request_iterator, target, '/qcalibrateremote.grpc.QCalibrate/Run',
