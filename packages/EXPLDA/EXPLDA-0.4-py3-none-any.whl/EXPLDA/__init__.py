...
class EXDA:
    ...
    """
    Provides methods to replace null values with mean,median or mode and to standardize and normalize data using Standard Scaler

    Example
    -------
    1. Create an object of the class
        eda=EXDA()
    2.Call the functions in theis class using this object
        eda.nullreplace_mean(data)
        eda.nullreplace_median(data)
        eda.nullreplace_mode(data)
        eda.normalize(data)
    """
