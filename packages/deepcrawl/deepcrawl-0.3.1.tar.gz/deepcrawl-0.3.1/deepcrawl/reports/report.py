...
from deepcrawl.statistics.statistic import DeepCrawlReportStatistic
...
class DeepCrawlReport(ImmutableAttributesMixin):
    ...
    def load_statistics(
        ...
        """
        connection = connection or deepcrawl.DeepCrawlConnection.get_instance()
        self.statistics = connection.get_report_statistics(
            self.account_id, self.project_id, self.crawl_id, self.id,
            filters=filters, **kwargs
        )
    ...
    def get_report_downloads(
        ...
        * use_cache=True > get_report_downloads will return cached report downloads or will do a call to DeepCrawl if downloads attribute is empty.
        * use_cache=False > get_report_downloads will call DeepCrawl api and will override downloads attribute.
    ...
    def get_report_statistic(
        ...
        >>> self.get_report_statistic('report_trend')
        Template 29 Trend
        ...
        """
        connection = connection or deepcrawl.DeepCrawlConnection.get_instance()
        return connection.get_report_statistic(
            self.account_id, self.project_id, self.crawl_id, self.id, statistic_type
        )
    ...
    def get_report_statistics(
        ...
        * use_cache=True > get_report_statistics will return cached statistics or will do a call to DeepCrawl if statistics attribute is empty.
        * use_cache=False > get_report_statistics will call DeepCrawl api and will override statistics attribute.
