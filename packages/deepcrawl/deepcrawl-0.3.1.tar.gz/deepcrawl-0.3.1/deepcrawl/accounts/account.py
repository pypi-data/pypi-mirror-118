...
class DeepCrawlAccount(ImmutableAttributesMixin):
    ...
    post_fields = [
        'address_city', 'address_street', 'country', 'custom_color_header', 'limit_levels_max',
    ...
    def load_account_users(
        ...
        """
        connection = connection or deepcrawl.DeepCrawlConnection.get_instance()
        self.account_users: List['deepcrawl.accounts_users.DeepCrawlUser'] = connection.get_account_users(
            self.id, filters=filters, **kwargs
        )
