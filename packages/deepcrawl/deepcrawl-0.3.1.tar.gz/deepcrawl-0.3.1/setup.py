...
setuptools.setup(
    ...
    long_description="""
        DeepCrawl is a cloud based website crawler to diagnose & fix technical SEO and performance issues.
        This Python package simplifies the use of the DeepCrawl’s REST API.
    """,
