...
class HtmlRenderer(Renderer):
    ...
    def get_permalink(self, ar, ba, obj, **apv):
        ...
        return settings.SITE.buildurl(
            "api", str(ba.actor.app_label), str(ba.actor.__name__), str(obj.pk), **kwargs)
    ...
    def row_action_button(
        ...
        if ar is not None and ar.permalink_uris:
            uri = ar.get_permalink(ba, obj, **request_kwargs['action_param_values'])  # "20210712"
        else:
