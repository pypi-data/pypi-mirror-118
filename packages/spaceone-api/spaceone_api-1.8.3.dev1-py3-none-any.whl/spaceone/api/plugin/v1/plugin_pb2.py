...
_PLUGINENDPOINTREQUEST_AUTOUPGRADE = _descriptor.EnumDescriptor(
  name='AutoUpgrade',
  full_name='spaceone.api.plugin.v1.PluginEndpointRequest.AutoUpgrade',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
...
_sym_db.RegisterEnumDescriptor(_PLUGINENDPOINTREQUEST_AUTOUPGRADE)
...
_PLUGINENDPOINTREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='auto_upgrade', full_name='spaceone.api.plugin.v1.PluginEndpointRequest.auto_upgrade', index=4,
  ...
  nested_types=[],
  enum_types=[
    _PLUGINENDPOINTREQUEST_AUTOUPGRADE,
  ],
  serialized_options=None,
  is_extendable=False,
  syntax='proto3',
...
_PLUGINENDPOINTREQUEST.fields_by_name['auto_upgrade'].enum_type = _PLUGINENDPOINTREQUEST_AUTOUPGRADE
_PLUGINENDPOINTREQUEST_AUTOUPGRADE.containing_type = _PLUGINENDPOINTREQUEST
