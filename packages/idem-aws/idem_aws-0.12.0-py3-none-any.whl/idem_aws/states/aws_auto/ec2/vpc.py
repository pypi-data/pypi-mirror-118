    ...
    if before:
        ...
        try:
            ret = await hub.exec.boto3.client.ec2.create_vpc(
                ...
                **{"CidrBlock": cidr_block, "AmazonProvidedIpv6CidrBlock": amazon_provided_ipv6_cidr_block, "Ipv6Pool": ipv6_pool, "Ipv6CidrBlock": ipv6_cidr_block, "InstanceTenancy": instance_tenancy, "Ipv6CidrBlockNetworkBorderGroup": ipv6_cidr_block_network_border_group, "TagSpecifications": tag_specifications}
            )
