...
async def describe(hub, ctx) -> Dict[str, Dict[str, Any]]:
    ...
    for instance in instances:
        ...
        result[instance["InstanceId"]] = new_instance
        for i, data in enumerate(instance["NetworkInterfaces"]):
            sub_instance = new_instance.copy()
            sub_instance["ipv6_addresses"] = data.get("Ipv6Addresses", [])
            # The id needs to be in the name
            sub_instance["name"] = instance["InstanceId"]
            # Create a new state for this association set
            result[f"{instance['InstanceId']}-{i}"] = new_instance
    return result
