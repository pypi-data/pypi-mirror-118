...
@jsii.data_type(
    ...
    jsii_struct_bases=[],
    name_mapping={"changelog_file": "changelogFile", "version_file": "versionFile"},
)
    ...
    def publish_to_git_hub_releases(
        ...
        *,
        ...
        options = GitHubReleasesPublishOptions(
            changelog_file=changelog_file, version_file=version_file
        )
...
class Release(
    ...
    def __init__(
        ...
        *,
        ...
        :param failure_issue: (experimental) Create a github issue on every failed publishing task. Default: false
        :param failure_issue_label: (experimental) The label to apply to issues indicating publish failures. Only applies if ``failureIssue`` is true. Default: "failed-release"
