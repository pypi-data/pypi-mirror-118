...
class LegacyTranslationEnum:
    ...
    DECK_CONFIG_MAXIMUM_ANSWER_SECS_TOOLTIP = (11, 37)
    DECK_CONFIG_MAXIMUM_INTERVAL_TOOLTIP = (11, 38)
    DECK_CONFIG_MINIMUM_INTERVAL_TOOLTIP = (11, 39)
    DECK_CONFIG_NAME_PROMPT = (11, 40)
    DECK_CONFIG_NEW_CARD_SORT_ORDER = (11, 41)
    DECK_CONFIG_NEW_CARD_SORT_ORDER_TOOLTIP = (11, 42)
    DECK_CONFIG_NEW_GATHER_PRIORITY = (11, 43)
    DECK_CONFIG_NEW_GATHER_PRIORITY_DECK = (11, 44)
    DECK_CONFIG_NEW_GATHER_PRIORITY_POSITION_HIGHEST_FIRST = (11, 45)
    DECK_CONFIG_NEW_GATHER_PRIORITY_POSITION_LOWEST_FIRST = (11, 46)
    DECK_CONFIG_NEW_GATHER_PRIORITY_TOOLTIP = (11, 47)
    DECK_CONFIG_NEW_INSERTION_ORDER = (11, 48)
    DECK_CONFIG_NEW_INSERTION_ORDER_RANDOM = (11, 49)
    DECK_CONFIG_NEW_INSERTION_ORDER_SEQUENTIAL = (11, 50)
    DECK_CONFIG_NEW_INSERTION_ORDER_TOOLTIP = (11, 51)
    DECK_CONFIG_NEW_INTERVAL_TOOLTIP = (11, 52)
    DECK_CONFIG_NEW_LIMIT_TOOLTIP = (11, 53)
    DECK_CONFIG_NEW_REVIEW_PRIORITY = (11, 54)
    DECK_CONFIG_NEW_REVIEW_PRIORITY_TOOLTIP = (11, 55)
    DECK_CONFIG_ORDERING_TITLE = (11, 56)
    DECK_CONFIG_RELEARNING_STEPS = (11, 57)
    DECK_CONFIG_RELEARNING_STEPS_ABOVE_MINIMUM_INTERVAL = (11, 58)
    DECK_CONFIG_RELEARNING_STEPS_TOOLTIP = (11, 59)
    DECK_CONFIG_REMOVE_GROUP = (11, 60)
    DECK_CONFIG_RENAME_GROUP = (11, 61)
    DECK_CONFIG_REVERT_BUTTON_TOOLTIP = (11, 62)
    DECK_CONFIG_REVIEW_LIMIT_TOOLTIP = (11, 63)
    DECK_CONFIG_REVIEW_MIX_MIX_WITH_REVIEWS = (11, 64)
    DECK_CONFIG_REVIEW_MIX_SHOW_AFTER_REVIEWS = (11, 65)
    DECK_CONFIG_REVIEW_MIX_SHOW_BEFORE_REVIEWS = (11, 66)
    DECK_CONFIG_REVIEW_SORT_ORDER = (11, 67)
    DECK_CONFIG_REVIEW_SORT_ORDER_TOOLTIP = (11, 68)
    DECK_CONFIG_REVIEWS_TOO_LOW = (11, 69)
    DECK_CONFIG_SAVE_BUTTON = (11, 70)
    DECK_CONFIG_SAVE_TO_ALL_SUBDECKS = (11, 71)
    DECK_CONFIG_SHOW_ANSWER_TIMER_TOOLTIP = (11, 72)
    DECK_CONFIG_SKIP_QUESTION_WHEN_REPLAYING = (11, 73)
    DECK_CONFIG_SORT_ORDER_ASCENDING_EASE = (11, 74)
    DECK_CONFIG_SORT_ORDER_ASCENDING_INTERVALS = (11, 75)
    DECK_CONFIG_SORT_ORDER_CARD_TEMPLATE_THEN_HIGHEST_POSITION = (11, 76)
    DECK_CONFIG_SORT_ORDER_CARD_TEMPLATE_THEN_LOWEST_POSITION = (11, 77)
    DECK_CONFIG_SORT_ORDER_CARD_TEMPLATE_THEN_RANDOM = (11, 78)
    DECK_CONFIG_SORT_ORDER_DECK_THEN_DUE_DATE = (11, 79)
    DECK_CONFIG_SORT_ORDER_DESCENDING_EASE = (11, 80)
    DECK_CONFIG_SORT_ORDER_DESCENDING_INTERVALS = (11, 81)
    DECK_CONFIG_SORT_ORDER_DUE_DATE_THEN_DECK = (11, 82)
    DECK_CONFIG_SORT_ORDER_DUE_DATE_THEN_RANDOM = (11, 83)
    DECK_CONFIG_SORT_ORDER_GATHER = (11, 84)
    DECK_CONFIG_SORT_ORDER_HIGHEST_POSITION = (11, 85)
    DECK_CONFIG_SORT_ORDER_LOWEST_POSITION = (11, 86)
    DECK_CONFIG_SORT_ORDER_RANDOM = (11, 87)
    DECK_CONFIG_SORT_ORDER_TEMPLATE_THEN_GATHER = (11, 88)
    DECK_CONFIG_STARTING_EASE_TOOLTIP = (11, 89)
    DECK_CONFIG_TIMER_TITLE = (11, 90)
    DECK_CONFIG_TITLE = (11, 91)
    DECK_CONFIG_USED_BY_DECKS = (11, 92)
    DECK_CONFIG_WHICH_DECK = (11, 93)
    DECK_CONFIG_WILL_REQUIRE_FULL_SYNC = (11, 94)
...
sort orders preferable. '''
    ...
    def deck_config_reviews_too_low(self, cards: int, expected: FluentVariable) -> str:
        ...
        return self._translate(11, 69, {"cards": cards, "expected": expected})
...
taking to review each card. '''
    ...
    def deck_config_sort_order_template_then_gather(self, ) -> str:
        r''' Card template, then order gathered '''
...
newly-learned card will delay the next review by 2.5x the previous delay. '''
    ...
    def deck_config_used_by_decks(self, decks: int) -> str:
        ...
        return self._translate(11, 92, {"decks": decks})
