...
setup(
    ...
    entry_points={
        'console_scripts': [
            'chembl_ids=chembl_client.scripts.chembl_ids:main',
            'chembl_sim=chembl_client.scripts.chembl_sim:main',
            'chembl_sub=chembl_client.scripts.chembl_sub:main',
            'chembl_m2t=chembl_client.scripts.chembl_m2t:main',
            'chembl_t2m=chembl_client.scripts.chembl_t2m:main',
            'chembl_act=chembl_client.scripts.chembl_act:main',
        ]
    },
    author='Alex Levshin',
    author_email='aleksandr.levshin@quantori.com',
    description='Python client fot accessing ChEMBL webservices.',
    url='https://www.ebi.ac.uk/chembl/api/data/docs',
    license='Apache Software License',
    packages=['chembl_client',
              'chembl_client.scripts'],
    long_description="""
    Documentation and repository: https://github.com/chembl/chembl_client.
