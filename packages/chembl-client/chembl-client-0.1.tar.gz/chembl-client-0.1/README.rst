...
.. image:: https://travis-ci.org/chembl/chembl_client.svg?branch=master
...
#. Search molecule by synonym:
   ...
   .. code-block:: python
      ...
      from chembl_client.new_client import new_client
...
#. Search for compound in `Unichem <https://www.ebi.ac.uk/unichem/>`_:
   ...
   .. code-block:: python
      ...
      from chembl_client.unichem import unichem_client as unichem
      ret = unichem.get('AIN')
...
.. code-block:: python
   ...
   from chembl_client.settings import Settings
