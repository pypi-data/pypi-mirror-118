...
import sys
import argparse
from chembl_client.scripts.utils import get_serializer, chembl_id_regex, smiles_regex, convert_to_smiles
from chembl_client.scripts.utils import resolve, mols_to_targets
