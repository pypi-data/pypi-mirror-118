                ...
                for column in column_list:
                    if column['editable']:
                        ...
                        if match:
                            ...
                            # If the variable is not found, use property as variable name
                            variable = column.get("property")

                        entry = {'title': column['title'], 'property': column['property'], 'variable': variable, 'editable': column['editable'], 'optional': column['optional']}
