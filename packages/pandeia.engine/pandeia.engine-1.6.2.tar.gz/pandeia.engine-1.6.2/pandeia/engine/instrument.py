...
class Instrument(InstrumentConfig):
    ...
    **kwargs: list of keyword/value pairs
    ...
    def get_exposure_pars(self, name="pattern_name"):
        ...
        if "nreset1" in self.readout_pattern_config[readout_pattern]:
            nreset1 = self.readout_pattern_config[readout_pattern]["nreset1"]
            nreset2 = self.readout_pattern_config[readout_pattern]["nreset2"]
