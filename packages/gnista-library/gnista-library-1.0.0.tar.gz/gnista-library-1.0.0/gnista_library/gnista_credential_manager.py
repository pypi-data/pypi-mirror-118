...
class GnistaCredentialManager(CredentialManager):
    def __init__(self, service_information, proxies=None):
        super(GnistaCredentialManager, self).__init__(service_information, proxies)
        self.id_token = None
    ...
    def _process_token_response(self, token_response, refresh_token_mandatory):
        ...
        super(GnistaCredentialManager, self)._process_token_response(token_response, refresh_token_mandatory)
        self.id_token = decoded
