...
def gview (cols, *imgs, saveas = None, titles = None, axis = True):
    ...
    if saveas:
        plt.savefig (saveas, dpi=100, facecolor='#eeeeee')
    else:
        plt.show ()

def hview (*imgs, saveas = None, titles = None, axis = True):
    if len (imgs) == 1 and isinstance (imgs [0], list):
        cols = len (imgs [0])
    else:
        cols = len (imgs)
    gview (cols, *imgs, saveas = saveas, titles = titles, axis = axis)

def vview (*imgs, saveas = None, titles = None, axis = True):
    gview (1, *imgs, saveas = saveas, titles = titles, axis = axis)
