...
@LastEditTime: 2021-09-01 14:57:24
...
class ExchangeListHandler(SevenBaseHandler):
    ...
    def get_async(self):
        ...
        exchange_info_list = exchange_info_model.get_dict_list(condition, order_by="id asc", field="id,goods_type,goods_name,need_value,is_release", params=[act_id])
