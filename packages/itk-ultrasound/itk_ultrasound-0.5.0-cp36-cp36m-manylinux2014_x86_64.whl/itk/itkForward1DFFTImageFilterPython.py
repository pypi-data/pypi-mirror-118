...
class listIndex2(collections.abc.MutableSequence):
    ...
    __repr__ = _swig_repr
    iterator = _swig_new_instance_method(_itkForward1DFFTImageFilterPython.listIndex2_iterator)
    def __iter__(self):
        return self.iterator()
    __nonzero__ = _swig_new_instance_method(_itkForward1DFFTImageFilterPython.listIndex2___nonzero__)
    __bool__ = _swig_new_instance_method(_itkForward1DFFTImageFilterPython.listIndex2___bool__)
    __len__ = _swig_new_instance_method(_itkForward1DFFTImageFilterPython.listIndex2___len__)
    __getslice__ = _swig_new_instance_method(_itkForward1DFFTImageFilterPython.listIndex2___getslice__)
    __setslice__ = _swig_new_instance_method(_itkForward1DFFTImageFilterPython.listIndex2___setslice__)
    __delslice__ = _swig_new_instance_method(_itkForward1DFFTImageFilterPython.listIndex2___delslice__)
    __delitem__ = _swig_new_instance_method(_itkForward1DFFTImageFilterPython.listIndex2___delitem__)
    __getitem__ = _swig_new_instance_method(_itkForward1DFFTImageFilterPython.listIndex2___getitem__)
    __setitem__ = _swig_new_instance_method(_itkForward1DFFTImageFilterPython.listIndex2___setitem__)
    pop = _swig_new_instance_method(_itkForward1DFFTImageFilterPython.listIndex2_pop)
    append = _swig_new_instance_method(_itkForward1DFFTImageFilterPython.listIndex2_append)
    empty = _swig_new_instance_method(_itkForward1DFFTImageFilterPython.listIndex2_empty)
    size = _swig_new_instance_method(_itkForward1DFFTImageFilterPython.listIndex2_size)
    swap = _swig_new_instance_method(_itkForward1DFFTImageFilterPython.listIndex2_swap)
    begin = _swig_new_instance_method(_itkForward1DFFTImageFilterPython.listIndex2_begin)
    end = _swig_new_instance_method(_itkForward1DFFTImageFilterPython.listIndex2_end)
    rbegin = _swig_new_instance_method(_itkForward1DFFTImageFilterPython.listIndex2_rbegin)
    rend = _swig_new_instance_method(_itkForward1DFFTImageFilterPython.listIndex2_rend)
    clear = _swig_new_instance_method(_itkForward1DFFTImageFilterPython.listIndex2_clear)
    get_allocator = _swig_new_instance_method(_itkForward1DFFTImageFilterPython.listIndex2_get_allocator)
    pop_back = _swig_new_instance_method(_itkForward1DFFTImageFilterPython.listIndex2_pop_back)
    erase = _swig_new_instance_method(_itkForward1DFFTImageFilterPython.listIndex2_erase)
    ...
    def __init__(self, *args):
        ...
        """
        _itkForward1DFFTImageFilterPython.listIndex2_swiginit(self, _itkForward1DFFTImageFilterPython.new_listIndex2(*args))
    push_back = _swig_new_instance_method(_itkForward1DFFTImageFilterPython.listIndex2_push_back)
    front = _swig_new_instance_method(_itkForward1DFFTImageFilterPython.listIndex2_front)
    back = _swig_new_instance_method(_itkForward1DFFTImageFilterPython.listIndex2_back)
    assign = _swig_new_instance_method(_itkForward1DFFTImageFilterPython.listIndex2_assign)
    resize = _swig_new_instance_method(_itkForward1DFFTImageFilterPython.listIndex2_resize)
    insert = _swig_new_instance_method(_itkForward1DFFTImageFilterPython.listIndex2_insert)
    pop_front = _swig_new_instance_method(_itkForward1DFFTImageFilterPython.listIndex2_pop_front)
    push_front = _swig_new_instance_method(_itkForward1DFFTImageFilterPython.listIndex2_push_front)
    reverse = _swig_new_instance_method(_itkForward1DFFTImageFilterPython.listIndex2_reverse)
    __swig_destroy__ = _itkForward1DFFTImageFilterPython.delete_listIndex2

# Register listIndex2 in _itkForward1DFFTImageFilterPython:
_itkForward1DFFTImageFilterPython.listIndex2_swigregister(listIndex2)
...
class listIndex3(collections.abc.MutableSequence):
    ...
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    iterator = _swig_new_instance_method(_itkForward1DFFTImageFilterPython.listIndex3_iterator)
    def __iter__(self):
        return self.iterator()
    __nonzero__ = _swig_new_instance_method(_itkForward1DFFTImageFilterPython.listIndex3___nonzero__)
    __bool__ = _swig_new_instance_method(_itkForward1DFFTImageFilterPython.listIndex3___bool__)
    __len__ = _swig_new_instance_method(_itkForward1DFFTImageFilterPython.listIndex3___len__)
    __getslice__ = _swig_new_instance_method(_itkForward1DFFTImageFilterPython.listIndex3___getslice__)
    __setslice__ = _swig_new_instance_method(_itkForward1DFFTImageFilterPython.listIndex3___setslice__)
    __delslice__ = _swig_new_instance_method(_itkForward1DFFTImageFilterPython.listIndex3___delslice__)
    __delitem__ = _swig_new_instance_method(_itkForward1DFFTImageFilterPython.listIndex3___delitem__)
    __getitem__ = _swig_new_instance_method(_itkForward1DFFTImageFilterPython.listIndex3___getitem__)
    __setitem__ = _swig_new_instance_method(_itkForward1DFFTImageFilterPython.listIndex3___setitem__)
    pop = _swig_new_instance_method(_itkForward1DFFTImageFilterPython.listIndex3_pop)
    append = _swig_new_instance_method(_itkForward1DFFTImageFilterPython.listIndex3_append)
    empty = _swig_new_instance_method(_itkForward1DFFTImageFilterPython.listIndex3_empty)
    size = _swig_new_instance_method(_itkForward1DFFTImageFilterPython.listIndex3_size)
    swap = _swig_new_instance_method(_itkForward1DFFTImageFilterPython.listIndex3_swap)
    begin = _swig_new_instance_method(_itkForward1DFFTImageFilterPython.listIndex3_begin)
    end = _swig_new_instance_method(_itkForward1DFFTImageFilterPython.listIndex3_end)
    rbegin = _swig_new_instance_method(_itkForward1DFFTImageFilterPython.listIndex3_rbegin)
    rend = _swig_new_instance_method(_itkForward1DFFTImageFilterPython.listIndex3_rend)
    clear = _swig_new_instance_method(_itkForward1DFFTImageFilterPython.listIndex3_clear)
    get_allocator = _swig_new_instance_method(_itkForward1DFFTImageFilterPython.listIndex3_get_allocator)
    pop_back = _swig_new_instance_method(_itkForward1DFFTImageFilterPython.listIndex3_pop_back)
    erase = _swig_new_instance_method(_itkForward1DFFTImageFilterPython.listIndex3_erase)
    ...
    def __init__(self, *args):
        ...
        """
        _itkForward1DFFTImageFilterPython.listIndex3_swiginit(self, _itkForward1DFFTImageFilterPython.new_listIndex3(*args))
    push_back = _swig_new_instance_method(_itkForward1DFFTImageFilterPython.listIndex3_push_back)
    front = _swig_new_instance_method(_itkForward1DFFTImageFilterPython.listIndex3_front)
    back = _swig_new_instance_method(_itkForward1DFFTImageFilterPython.listIndex3_back)
    assign = _swig_new_instance_method(_itkForward1DFFTImageFilterPython.listIndex3_assign)
    resize = _swig_new_instance_method(_itkForward1DFFTImageFilterPython.listIndex3_resize)
    insert = _swig_new_instance_method(_itkForward1DFFTImageFilterPython.listIndex3_insert)
    pop_front = _swig_new_instance_method(_itkForward1DFFTImageFilterPython.listIndex3_pop_front)
    push_front = _swig_new_instance_method(_itkForward1DFFTImageFilterPython.listIndex3_push_front)
    reverse = _swig_new_instance_method(_itkForward1DFFTImageFilterPython.listIndex3_reverse)
    __swig_destroy__ = _itkForward1DFFTImageFilterPython.delete_listIndex3

# Register listIndex3 in _itkForward1DFFTImageFilterPython:
_itkForward1DFFTImageFilterPython.listIndex3_swigregister(listIndex3)
...
class listIndex4(collections.abc.MutableSequence):
    ...
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    iterator = _swig_new_instance_method(_itkForward1DFFTImageFilterPython.listIndex4_iterator)
    def __iter__(self):
        return self.iterator()
    __nonzero__ = _swig_new_instance_method(_itkForward1DFFTImageFilterPython.listIndex4___nonzero__)
    __bool__ = _swig_new_instance_method(_itkForward1DFFTImageFilterPython.listIndex4___bool__)
    __len__ = _swig_new_instance_method(_itkForward1DFFTImageFilterPython.listIndex4___len__)
    __getslice__ = _swig_new_instance_method(_itkForward1DFFTImageFilterPython.listIndex4___getslice__)
    __setslice__ = _swig_new_instance_method(_itkForward1DFFTImageFilterPython.listIndex4___setslice__)
    __delslice__ = _swig_new_instance_method(_itkForward1DFFTImageFilterPython.listIndex4___delslice__)
    __delitem__ = _swig_new_instance_method(_itkForward1DFFTImageFilterPython.listIndex4___delitem__)
    __getitem__ = _swig_new_instance_method(_itkForward1DFFTImageFilterPython.listIndex4___getitem__)
    __setitem__ = _swig_new_instance_method(_itkForward1DFFTImageFilterPython.listIndex4___setitem__)
    pop = _swig_new_instance_method(_itkForward1DFFTImageFilterPython.listIndex4_pop)
    append = _swig_new_instance_method(_itkForward1DFFTImageFilterPython.listIndex4_append)
    empty = _swig_new_instance_method(_itkForward1DFFTImageFilterPython.listIndex4_empty)
    size = _swig_new_instance_method(_itkForward1DFFTImageFilterPython.listIndex4_size)
    swap = _swig_new_instance_method(_itkForward1DFFTImageFilterPython.listIndex4_swap)
    begin = _swig_new_instance_method(_itkForward1DFFTImageFilterPython.listIndex4_begin)
    end = _swig_new_instance_method(_itkForward1DFFTImageFilterPython.listIndex4_end)
    rbegin = _swig_new_instance_method(_itkForward1DFFTImageFilterPython.listIndex4_rbegin)
    rend = _swig_new_instance_method(_itkForward1DFFTImageFilterPython.listIndex4_rend)
    clear = _swig_new_instance_method(_itkForward1DFFTImageFilterPython.listIndex4_clear)
    get_allocator = _swig_new_instance_method(_itkForward1DFFTImageFilterPython.listIndex4_get_allocator)
    pop_back = _swig_new_instance_method(_itkForward1DFFTImageFilterPython.listIndex4_pop_back)
    erase = _swig_new_instance_method(_itkForward1DFFTImageFilterPython.listIndex4_erase)
    ...
    def __init__(self, *args):
        ...
        """
        _itkForward1DFFTImageFilterPython.listIndex4_swiginit(self, _itkForward1DFFTImageFilterPython.new_listIndex4(*args))
    push_back = _swig_new_instance_method(_itkForward1DFFTImageFilterPython.listIndex4_push_back)
    front = _swig_new_instance_method(_itkForward1DFFTImageFilterPython.listIndex4_front)
    back = _swig_new_instance_method(_itkForward1DFFTImageFilterPython.listIndex4_back)
    assign = _swig_new_instance_method(_itkForward1DFFTImageFilterPython.listIndex4_assign)
    resize = _swig_new_instance_method(_itkForward1DFFTImageFilterPython.listIndex4_resize)
    insert = _swig_new_instance_method(_itkForward1DFFTImageFilterPython.listIndex4_insert)
    pop_front = _swig_new_instance_method(_itkForward1DFFTImageFilterPython.listIndex4_pop_front)
    push_front = _swig_new_instance_method(_itkForward1DFFTImageFilterPython.listIndex4_push_front)
    reverse = _swig_new_instance_method(_itkForward1DFFTImageFilterPython.listIndex4_reverse)
    __swig_destroy__ = _itkForward1DFFTImageFilterPython.delete_listIndex4

# Register listIndex4 in _itkForward1DFFTImageFilterPython:
_itkForward1DFFTImageFilterPython.listIndex4_swigregister(listIndex4)
