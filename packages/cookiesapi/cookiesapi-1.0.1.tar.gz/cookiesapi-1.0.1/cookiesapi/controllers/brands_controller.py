...
from cookiesapi.models.brand_list import BrandList
...
class BrandsController(BaseController):
    ...
    def list_brands(self):
        ...
        Returns:
            BrandList: Response from the API.
        ...
        decoded = APIHelper.json_deserialize(_response.text, BrandList.from_dictionary)
