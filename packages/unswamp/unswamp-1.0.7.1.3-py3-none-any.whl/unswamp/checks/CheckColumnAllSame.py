...
from unswamp.checks.general.BaseValueCheck import BaseValueCheck
...
class CheckColumnAllSame(BaseCheck, BaseColumnCheck, BaseValueCheck):
    ...
    # Constructor
    ##################################################################################################
    def __init__(self, id, column_name, column_value=None, column_meta_data=None):
        BaseCheck.__init__(self, id, column_meta_data)
