...
class SegmentedButtonGroup(QWidget):
    ...
    def __init__(self, radio=False, parent=None):
        super(SegmentedButtonGroup, self).__init__(parent=None)
    ...
    def __repr__(self):
        return f"<pyqt5extras.SegmentdButtonGroup({len(self._buttons)} buttons)>"
