...
class ImageBox(QLabel):
    ...
    def __repr__(self):
        return f"<pyqt5extras.ImageBox(animated={self.animated})>"
    ...
    def setSource(self, source):
        ...
        if isinstance(self.source, str):
            ...
            raise TypeError(
                f"QImage(source: Union[str, pathlib.Path, QPixmap, QImage, QMovie]) "
                f"-> Argument 1 has unexpected type '{type(self.source)}'")
