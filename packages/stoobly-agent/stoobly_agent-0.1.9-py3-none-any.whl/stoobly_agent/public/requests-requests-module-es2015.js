...
/* harmony import */ var _vex_components_page_layout_page_layout_module__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! @vex/components/page-layout/page-layout.module */ "7lCJ");
/* harmony import */ var _vex_components_scrollbar_scrollbar_module__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! @vex/components/scrollbar/scrollbar.module */ "XVi8");
/* harmony import */ var _vex_components_sidebar_sidebar_module__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! @vex/components/sidebar/sidebar.module */ "zaci");
...
/* harmony import */ var _requests_components_requests_create_requests_create_module__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! @requests/components/requests-create/requests-create.module */ "CTtz");
/* harmony import */ var _requests_components_requests_edit_requests_edit_module__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! @requests/components/requests-edit/requests-edit.module */ "2FU7");
/* harmony import */ var _requests_components_requests_search_requests_search_module__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! @requests/components/requests-search/requests-search.module */ "KAKk");
/* harmony import */ var _requests_components_requests_show_requests_show_module__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! @requests/components/requests-show/requests-show.module */ "aY89");
/* harmony import */ var _components_requests_table_menu_requests_table_menu_component__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! ./components/requests-table-menu/requests-table-menu.component */ "Q4Vm");
/* harmony import */ var _requests_index_component__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(/*! ./requests-index.component */ "Zf3l");
/* harmony import */ var _services_requests_index_icons_service__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(/*! ./services/requests-index-icons.service */ "DXlN");
...
RequestsIndexModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [_requests_index_component__WEBPACK_IMPORTED_MODULE_28__["RequestsIndexComponent"], _components_requests_table_menu_requests_table_menu_component__WEBPACK_IMPORTED_MODULE_27__["RequestsTableMenuComponent"]],
        imports: [
            _angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"],
            ...
            _vex_components_scrollbar_scrollbar_module__WEBPACK_IMPORTED_MODULE_19__["ScrollbarModule"],
            _vex_components_sidebar_sidebar_module__WEBPACK_IMPORTED_MODULE_20__["SidebarModule"],
            ...
            _requests_components_requests_edit_requests_edit_module__WEBPACK_IMPORTED_MODULE_24__["RequestsEditModule"],
            _requests_components_requests_create_requests_create_module__WEBPACK_IMPORTED_MODULE_23__["RequestsCreateModule"],
            _requests_components_requests_search_requests_search_module__WEBPACK_IMPORTED_MODULE_25__["RequestsSearchModule"],
            _requests_components_requests_show_requests_show_module__WEBPACK_IMPORTED_MODULE_26__["RequestsShowModule"],
        ],
        providers: [_services_requests_index_icons_service__WEBPACK_IMPORTED_MODULE_29__["RequestsIndexIcons"]],
    })
], RequestsIndexModule);
...
/* harmony import */ var _iconify_icons_ic_twotone_edit__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @iconify/icons-ic/twotone-edit */ "pN9m");
...
/* harmony import */ var _data_schema__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @data/schema */ "V99k");
...
/* harmony import */ var _shared_helpers__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! @shared/helpers */ "KJ9U");
/* harmony import */ var _services_request_data_service__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../../services/request-data.service */ "Zgkj");
/* harmony import */ var _services_requests_index_icons_service__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./services/requests-index-icons.service */ "DXlN");
/* harmony import */ var _services_requests_table_config_service__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./services/requests-table-config.service */ "E3RN");
...
let RequestsIndexComponent = class RequestsIndexComponent {
    ...
    ngOnInit() {
        ...
        this.requests = requests.list.map(request => new _data_schema__WEBPACK_IMPORTED_MODULE_9__["Request"](request));
    ...
    createRequest(data) {
        ...
        this.requestResource.create(data).subscribe((res) => {
            this.requests = res.list.map(request => {
                return new _data_schema__WEBPACK_IMPORTED_MODULE_9__["Request"](request);
    ...
    getRequests(params = this.indexParams) {
        ...
        this.requestResource.index(params).subscribe((res) => {
            this.requests = res.list.map(request => new _data_schema__WEBPACK_IMPORTED_MODULE_9__["Request"](request));
    ...
    updateRequest(id, data) {
        this.requestResource.update(id, data).subscribe(res => {
            ...
            for (let i = 0; i < clone.length; ++i) {
                ...
                clone[i] = new _data_schema__WEBPACK_IMPORTED_MODULE_9__["Request"](res);
            }
            this.requests = clone;
        }, error => {
        });
    ...
    searchRequests(search) {
        ...
        this.page = 0;
        const { q: queryString, qt } = search;
        if (!queryString.length) {
            delete this.indexParams.q;
            delete this.indexParams.qt;
        }
        else {
            this.indexParams.q = queryString;
            if (qt)
                this.indexParams.qt = qt;
        }
        this.getRequests();
    }
    sortRequests(event) {
    ...
    toggleRequestStar(id) {
        ...
        if (request) {
            const { id, method, status, starred, host, port } = request;
...
RequestsIndexComponent.ctorParameters = () => [
    { type: _services_requests_index_icons_service__WEBPACK_IMPORTED_MODULE_15__["RequestsIndexIcons"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_6__["ActivatedRoute"] },
    { type: _core_http__WEBPACK_IMPORTED_MODULE_8__["AgentService"] },
    { type: _angular_material_dialog__WEBPACK_IMPORTED_MODULE_5__["MatDialog"] },
    { type: _shared_helpers__WEBPACK_IMPORTED_MODULE_13__["FileService"] },
    { type: _shared_helpers__WEBPACK_IMPORTED_MODULE_13__["FileDownload"] },
    { type: _layout_services_layout_config_service__WEBPACK_IMPORTED_MODULE_12__["LayoutConfigService"] },
    { type: _angular_common__WEBPACK_IMPORTED_MODULE_3__["Location"] },
    { type: _services_request_data_service__WEBPACK_IMPORTED_MODULE_14__["RequestDataService"] },
    { type: _core_http__WEBPACK_IMPORTED_MODULE_8__["RequestResource"] },
    { type: _services_requests_table_config_service__WEBPACK_IMPORTED_MODULE_16__["RequestsTableConfig"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_6__["Router"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_6__["ActivatedRoute"] },
    { type: _shared_helpers__WEBPACK_IMPORTED_MODULE_13__["UriService"] }
];
RequestsIndexComponent.propDecorators = {
    sidebar: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_4__["ViewChild"], args: ['configpanel', { static: true },] }]
};
RequestsIndexComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_4__["Component"])({
        ...
        providers: [_services_request_data_service__WEBPACK_IMPORTED_MODULE_14__["RequestDataService"]],
...
class RequestString {
    constructor(request) {
        this.REQUEST_TYPE = 1;
        this.CLRF = '\n';
        // Backend raw request parser errors out if pathname does not start with a /
        if (request.url[0] !== '/') {
    ...
    control() {
        this.lines.unshift(`${this.REQUEST_TYPE} ${this.request.id} ${(new Date).getTime() * 1000 * 1000}`);
    }
    requestLine() {
