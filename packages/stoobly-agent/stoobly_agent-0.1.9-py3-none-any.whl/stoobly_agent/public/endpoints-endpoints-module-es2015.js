...
/* harmony import */ var _shared_helpers__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! @shared/helpers */ "KJ9U");
...
/* harmony import */ var _endpoints_components_endpoints_create_endpoints_create_component__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! @endpoints/components/endpoints-create/endpoints-create.component */ "bU6V");
/* harmony import */ var _shared_helpers__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! @shared/helpers */ "KJ9U");
/* harmony import */ var _mock_endpoints_index_data__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./mock/endpoints-index-data */ "I+wY");
/* harmony import */ var _services_endpoints_data_service__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./services/endpoints-data.service */ "fDgC");
/* harmony import */ var _services_endpoints_index_icons_service__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./services/endpoints-index-icons.service */ "cWny");
...
let EndpointsIndexComponent = class EndpointsIndexComponent {
    constructor(icons, activatedRoute, dialog, endpointsDataService, endpointResource, file, location, router, route, uri) {
        ...
        this.endpointCategories = _data_schema__WEBPACK_IMPORTED_MODULE_17__["EndpointCategories"];
        // Breadcrumb settings
        this.crumbs = [];
    }
    get visibleColumns() {
    ...
    ngOnInit() {
        ...
        const keys = Object.keys(_data_schema__WEBPACK_IMPORTED_MODULE_17__["EndpointCategories"]);
    ...
    openCreateDialog() {
        const dialogRef = this.dialog.open(_endpoints_components_endpoints_create_endpoints_create_component__WEBPACK_IMPORTED_MODULE_18__["EndpointsCreateComponent"], {
            width: '600px',
        });
        const onCreateSub = dialogRef.componentInstance.onCreate.subscribe(($event) => {
...
let EndpointsCreateComponent = class EndpointsCreateComponent {
    ...
    ngOnInit() {
        ...
        this.form = this.fb.group({
            ...
            port: new _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormControl"]('443', [
