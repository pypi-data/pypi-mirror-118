...
/* harmony import */ var _organizations_components_organizations_create_organizations_create_component__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! @organizations/components/organizations-create/organizations-create.component */ "vb3d");
/* harmony import */ var _shared_helpers_file_service__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! @shared/helpers/file.service */ "h5yU");
...
let UserOrganizationsComponent = class UserOrganizationsComponent {
    ...
    ngOnInit() {
        ...
        const organizations = this.route.snapshot.data.organizations.filter(organization => {
            ...
            const o = new _data_schema__WEBPACK_IMPORTED_MODULE_17__["Organization"](organization);
     ...
     */
    openCreateDialog() {
        const dialogRef = this.dialog.open(_organizations_components_organizations_create_organizations_create_component__WEBPACK_IMPORTED_MODULE_18__["OrganizationsCreateComponent"], {
            width: '600px',
        });
