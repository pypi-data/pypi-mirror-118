(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["endpoints-endpoints-module"], {
    ...
    function dKF(module, __webpack_exports__, __webpack_require__) {
      ...
      var _shared_helpers__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(
      /*! @shared/helpers */
      "KJ9U");
      ...
      var EndpointDetailsComponent = /*#__PURE__*/function () {
        ...
        _createClass(EndpointDetailsComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.endpoint = new _data_schema__WEBPACK_IMPORTED_MODULE_14__["Endpoint"](snapshot.data.endpoint);
            this.buildCrumbs();
            this.requestData = snapshot.data.requests.list.map(function (request) {
              return new _data_schema__WEBPACK_IMPORTED_MODULE_14__["Request"](request);
            });
            this.headerNameData = snapshot.data.headerNames.map(function (header) {
              return new _data_schema__WEBPACK_IMPORTED_MODULE_14__["Header"](header);
            });
            this.queryParamNameData = snapshot.data.queryParamNames.map(function (queryParam) {
              return new _data_schema__WEBPACK_IMPORTED_MODULE_14__["QueryParam"](queryParam);
            });
            this.pathSegmentNameData = snapshot.data.pathSegmentNames.map(function (pathSegment) {
              return new _data_schema__WEBPACK_IMPORTED_MODULE_14__["PathSegment"](pathSegment);
            });
            this.bodyParamNameData = snapshot.data.bodyParamNames.map(function (bodyParam) {
              return new _data_schema__WEBPACK_IMPORTED_MODULE_14__["BodyParam"](bodyParam);
            });
          ...
          value: function updateComponentName(component) {
            ...
            switch (component.type) {
              case _data_schema__WEBPACK_IMPORTED_MODULE_14__["RequestComponentType"].Header:
                resource = this.headerNameResource;
                break;

              case _data_schema__WEBPACK_IMPORTED_MODULE_14__["RequestComponentType"].QueryParam:
                resource = this.queryParamNameResource;
                break;

              case _data_schema__WEBPACK_IMPORTED_MODULE_14__["RequestComponentType"].BodyParam:
      ...
      EndpointDetailsComponent.ctorParameters = function () {
        return [{
          ...
          type: _shared_helpers__WEBPACK_IMPORTED_MODULE_15__["UriService"]
        }, {
          type: _angular_common__WEBPACK_IMPORTED_MODULE_3__["Location"]
        }, {
          type: _shared_helpers__WEBPACK_IMPORTED_MODULE_15__["FileService"]
        }, {
    ...
    function BhTb(module, __webpack_exports__, __webpack_require__) {
      ...
      var _endpoints_components_endpoints_create_endpoints_create_component__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(
      /*! @endpoints/components/endpoints-create/endpoints-create.component */
      "bU6V");
      /* harmony import */


      var _shared_helpers__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(
      /*! @shared/helpers */
      "KJ9U");
      /* harmony import */


      var _mock_endpoints_index_data__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(
      /*! ./mock/endpoints-index-data */
      "I+wY");
      /* harmony import */


      var _services_endpoints_data_service__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(
      /*! ./services/endpoints-data.service */
      "fDgC");
      /* harmony import */


      var _services_endpoints_index_icons_service__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(
      ...
      var EndpointsIndexComponent = /*#__PURE__*/function () {
        function EndpointsIndexComponent(icons, activatedRoute, dialog, endpointsDataService, endpointResource, file, location, router, route, uri) {
          ...
          this.labels = _mock_endpoints_index_data__WEBPACK_IMPORTED_MODULE_20__["aioTableLabels"];
          this.endpointCategories = _data_schema__WEBPACK_IMPORTED_MODULE_17__["EndpointCategories"]; // Breadcrumb settings
        ...
        _createClass(EndpointsIndexComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.endpointsDataService.endpoints$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_14__["filter"])(Boolean)).subscribe(function (endpoints) {
              _this6.dataSource.data = endpoints;
            });
            ...
            var keys = Object.keys(_data_schema__WEBPACK_IMPORTED_MODULE_17__["EndpointCategories"]);
          ...
          value: function openCreateDialog() {
            ...
            var dialogRef = this.dialog.open(_endpoints_components_endpoints_create_endpoints_create_component__WEBPACK_IMPORTED_MODULE_18__["EndpointsCreateComponent"], {
              width: '600px'
            });
            var onCreateSub = dialogRef.componentInstance.onCreate.subscribe(function ($event) {
              _this7.createEndpoint($event);
            });
          ...
          value: function getEndpoints(params) {
            ...
            this.endpointResource.index(params).subscribe(function (res) {
              _this8.endpointsDataService.set(res);
            }, function (error) {});
          }
        }, {
          key: "createEndpoint",
          value: function createEndpoint(data) {
            ...
            this.endpointResource.create(data).subscribe(function (res) {
              var curSnapshot = _this9.route.snapshot;
          ...
          value: function deleteEndpoint(endpoint) {
            ...
            this.endpointResource.destroy(endpoint.id).subscribe(function (res) {
              _this10.endpointsDataService["delete"](endpoint.id);

              _this10.selection.deselect(endpoint);
            });
          }
        }, {
          key: "deleteEndpoints",
          value: function deleteEndpoints(endpoints) {
            ...
            endpoints.forEach(function (r) {
              return _this11.deleteEndpoint(r);
            });
          }
        }, {
          key: "updateEndpoint",
      ...
      EndpointsIndexComponent.ctorParameters = function () {
        return [{
          type: _services_endpoints_index_icons_service__WEBPACK_IMPORTED_MODULE_22__["EndpointsIndexIcons"]
        }, {
          type: _angular_router__WEBPACK_IMPORTED_MODULE_12__["ActivatedRoute"]
        }, {
          type: _angular_material_dialog__WEBPACK_IMPORTED_MODULE_7__["MatDialog"]
        }, {
          type: _services_endpoints_data_service__WEBPACK_IMPORTED_MODULE_21__["EndpointsDataService"]
        }, {
          type: _core_http_endpoint_resource_service__WEBPACK_IMPORTED_MODULE_16__["EndpointResource"]
        }, {
          type: _shared_helpers__WEBPACK_IMPORTED_MODULE_19__["FileService"]
        }, {
          ...
          type: _shared_helpers__WEBPACK_IMPORTED_MODULE_19__["UriService"]
        }];
      };
