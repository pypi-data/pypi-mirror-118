...
/* harmony import */ var _shared_helpers__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! @shared/helpers */ "KJ9U");
...
let ProjectMembersComponent = class ProjectMembersComponent {
    ...
    ngOnInit() {
        ...
        const projectMembers = this.route.snapshot.data.members.map(member => {
            return new _data_schema__WEBPACK_IMPORTED_MODULE_16__["ProjectsUser"](member);
        });
...
ProjectMembersComponent.ctorParameters = () => [
    ...
    { type: _shared_helpers__WEBPACK_IMPORTED_MODULE_17__["FileService"] },
