...
setuptools.setup(
    name="HighOrderClustering",                     # This is the name of the package
    ...
    package_dir={'':'/Users/Chen 1/Downloads/HighOrderClustering'},     # Directory of the source code of the package
