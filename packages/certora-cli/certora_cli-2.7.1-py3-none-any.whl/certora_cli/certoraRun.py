...
def check_args_post_argparse(args: argparse.Namespace) -> None:
    ...
    if args.local and args.typecheck_only:
        raise argparse.ArgumentTypeError("cannot use --typecheck_only in local mode")
...
def __get_argparser() -> argparse.ArgumentParser:
    ...
    partial_args.add_argument('--typecheck_only', action='store_true', help='Stop after typechecking')
