...
from tensorflow_probability.substrates.numpy.experimental.distribute import joint_distribution as sharded_jd_lib
from tensorflow_probability.substrates.numpy.experimental.distribute import sharded
