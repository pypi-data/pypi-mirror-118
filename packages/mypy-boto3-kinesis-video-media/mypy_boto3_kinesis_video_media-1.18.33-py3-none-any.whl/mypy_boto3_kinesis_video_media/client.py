...
class KinesisVideoMediaClient(BaseClient):
    """
    [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.33/reference/services/kinesis-video-media.html#KinesisVideoMedia.Client)
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.33/reference/services/kinesis-video-media.html#KinesisVideoMedia.Client.can_paginate)
    ...
    def generate_presigned_url(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.33/reference/services/kinesis-video-media.html#KinesisVideoMedia.Client.generate_presigned_url)
    ...
    def get_media(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.33/reference/services/kinesis-video-media.html#KinesisVideoMedia.Client.get_media)
