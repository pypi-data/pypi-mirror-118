...
chemical_categories = {
        ...
        "Phenylpropanoid": (["Coumarins", "Coumestans", "Flavonoids", "Phenylpropanoid_glycosides", "Hydroxycinnamic_acids", "Lignans", "Monolignols", "O-Methylated_phenylpropanoids", "Phenylpropanoids_metabolism", "Phenylpropenes", "Phenylpropionate_esters", "Stilbenoids"], "Phenyl + Propene tail", True),
