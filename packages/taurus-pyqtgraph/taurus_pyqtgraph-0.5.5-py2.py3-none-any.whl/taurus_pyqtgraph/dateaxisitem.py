...
class DateAxisItem(AxisItem):
    ...
    def _onRangeEdited(self):
        ...
        self._setAxisRange(
            self._minDTE.dateTime().toSecsSinceEpoch(),
            self._maxDTE.dateTime().toSecsSinceEpoch(),
            padding=0,
        )
    ...
    def _updateMenu(self):
        ...
        self._minDTE.setDateTime(Qt.QDateTime.fromSecsSinceEpoch(_min))
        self._maxDTE.setDateTime(Qt.QDateTime.fromSecsSinceEpoch(_max))
