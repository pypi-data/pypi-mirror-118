...
class Agent(Insight, Channel, Catalog, Dataset):
    ...
    def query(self, dataset_slug="", fields:list=[], filters=None, sorted_by=None,  dataset_id=""):
    ...
    def get_dataset_by_slug(self, agent_slug, slug: str) -> Dataset:
        ...
        authentication_url = self._base_url_askdata + '/smartbot/agents/agentslug/'+ agent_slug +'/slug/' + slug
        logging.info("AUTH URL {}".format(authentication_url))
    ...
    def create_or_replace_dataset(self, dataframe: pd.DataFrame, dataset_name: str, slug: str, icon_url=None,
        ...
        dataset = self.get_dataset_by_slug(self.slug, slug)
