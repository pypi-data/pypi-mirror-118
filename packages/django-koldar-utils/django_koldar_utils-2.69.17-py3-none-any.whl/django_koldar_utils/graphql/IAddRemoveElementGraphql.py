...
class SimpleAddRemoveElementGraphQL(RemoveByIds, IAddRemoveElementGraphql):
    ...
    def _add_association_between_models_in_db(self, context: AbstractContext,
                                              object_to_add: any) -> int:
        getattr(context.model_types[0].django_type, self.relationship_manager).add(object_to_add)
        return 1
