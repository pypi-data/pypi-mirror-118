...
class AbstractSettingsGenerator(abc.ABC):
    ...
    def _set_settings_var(self, **kwargs):
        for k,v in kwargs.items():
            modules.add_variable_in_module(settings, k, v)

    def _get_settings_var(self, var_name: str) -> any:
        return modules.get_variable_in_module(settings, var_name)
    ...
    def generate(self, settings_file: str):
        ...
        """
        self.SETTING_DIR, self.BASE_DIR, self.PROJECT_DIR, self.PROJECT_DIRNAME = settings_helper.get_paths(settings_file)
    ...
    def _generate(self, vars_to_set: AttrDict):
        ...
        vars_to_set.AUTHENTICATION_BACKENDS = [
        ...
        vars_to_set.DJANGO_CBIM_GENERAL_SERVICE = {
