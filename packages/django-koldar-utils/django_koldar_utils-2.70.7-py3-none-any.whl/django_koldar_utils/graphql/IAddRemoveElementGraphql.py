...
class AbstractContext(object):
    ...
    def __init__(self, model_types: List[ModelDeclarationContext], relation_name: str, allow_duplicated_in_relationship: bool):
        self.model_types: List[ModelDeclarationContext] = model_types
        self.relation_name = relation_name
        self.allow_duplicated_in_relationship = allow_duplicated_in_relationship
        """
...
class AddMutationContext(AbstractContext):
    ...
    def __init__(self, model_types: List[ModelDeclarationContext], relation_name: str, add_if_not_present: bool, allow_duplicated_in_relationship: bool):
        super().__init__(model_types, relation_name, allow_duplicated_in_relationship)
...
class RemoveMutationContext(AbstractContext):
    ...
    def __init__(self, model_types: List[ModelDeclarationContext], relation_name: str,
                 ignore_if_not_present: bool, allow_duplicated_in_relationship: bool):
        super().__init__(model_types, relation_name, allow_duplicated_in_relationship)
        self.relation_name = relation_name
...
class IAddRemoveElementGraphql(abc.ABC):
    ...
    def generate(self, models_types: List[Tuple[type, type]],
                 ...
                 allow_duplicated_in_relationship: bool = False,
        ...
        :param allow_duplicated_in_relationship: if set, we will accept that in the database there may be multiple rows in the relationship with the same data.
        ...
        if generate_add_mutation:
            context = AddMutationContext(
                ...
                allow_duplicated_in_relationship=allow_duplicated_in_relationship,
            )
...
class SimpleAddRemoveElementGraphQL(RemoveByIds, IAddRemoveElementGraphql):
    ...
    def _add_association_between_models_in_db(self, context: AddMutationContext, model_definitions: List[ModelDefinition], relationship_endpoints: List[any], relationship_specific_data: any) -> Tuple[any, int]:
        ...
        if hasattr(manager, "through"):
            ...
            if already_present == 0 or (already_present > 0 and context.allow_duplicated_in_relationship):
