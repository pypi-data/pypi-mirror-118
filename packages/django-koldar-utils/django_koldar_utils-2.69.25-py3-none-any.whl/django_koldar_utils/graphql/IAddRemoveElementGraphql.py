...
class IAddRemoveElementGraphql(abc.ABC):
    ...
    def _add_mutation_actual_body(self, mutation_class, info, __context_from_generator: AddMutationContext = None, *args, **kwargs) -> any:
        result_create = 0
        context = __context_from_generator
    ...
    def _generate_add_mutation(self, context: AddMutationContext) -> type:
        ...
        return GraphQLHelper.create_mutation(
            ...
            body=functools.partialmethod(self._add_mutation_actual_body, __context_from_generator=context)
        )
