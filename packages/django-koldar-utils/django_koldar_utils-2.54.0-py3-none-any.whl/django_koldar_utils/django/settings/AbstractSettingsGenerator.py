...
class AbstractSettingsGenerator(abc.ABC):
    ...
    def generate(self):
        ...
        INSTALLED_APPS = self._configure_installed_apps(INSTALLED_APPS)
        ...
        MIDDLEWARE = self._configure_middlewares()
        ...
        CACHES = self._configure_caches(CACHES)
