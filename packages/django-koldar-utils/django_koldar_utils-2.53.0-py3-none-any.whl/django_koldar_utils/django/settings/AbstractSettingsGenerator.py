...
class AbstractSettingsGenerator(abc.ABC):
    ...
    def configure_caches(self, original: Dict[str, any]) -> Dict[str, any]:
        return original

    def get_auth_user_model(self) -> Optional[str]:
        """
    ...
    def generate(self):
        ...
        CACHES = self.configure_caches(CACHES)
