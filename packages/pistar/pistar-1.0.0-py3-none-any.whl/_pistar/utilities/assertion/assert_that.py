...
from _pistar.utilities.exceptions import \
    AssertionContainsDuplicatesException
from _pistar.utilities.exceptions import AssertionContainsException
from _pistar.utilities.exceptions import \
    AssertionDoesNotContainDuplicatesException
...
from _pistar.utilities.exceptions import \
    AssertionIsGreaterThanOrEqualToException
...
from _pistar.utilities.exceptions import \
    AssertionIsLessThanOrEqualToException
...
from _pistar.utilities.exceptions import \
    AssertionIsNonStrictlyDecreasingException
from _pistar.utilities.exceptions import \
    AssertionIsNonStrictlyIncreasingException
...
from _pistar.utilities.exceptions import \
    AssertionIsStrictlyDecreasingException
from _pistar.utilities.exceptions import \
    AssertionIsStrictlyIncreasingException
...
class AssertThat:
    ...
    def assert_type(self, *args):
        if not isinstance(self.__value, args):
            raise AssertionTypeMismatchException(
                self,
                "the value {} except type is {}, but its type is '{}'".format(
                    self.__value, get_or_text([item.__name__ for item in args]),
                    type(self.__value).__name__
                )
            )
    ...
    def is_none(self):
        ...
        raise AssertionIsNoneException(
            assertion=self, assert_value=repr(self.__value)
        )
    ...
    def is_not_none(self):
        ...
        raise AssertionIsNotNoneException(
            assertion=self, assert_value=repr(self.__value)
        )
    ...
    def is_lower(self):
        ...
        raise AssertionIsLowerException(
            assertion=self, assert_value=repr(self.__value)
        )
    ...
    def is_upper(self):
        ...
        raise AssertionIsUpperException(
            assertion=self, assert_value=repr(self.__value)
        )
    ...
    def is_length(self, expect_length):
        ...
        raise AssertionIsLengthException(
            assertion=self,
            assert_value=repr(self.__value),
    ...
    def contains(self, *args):
        ...
        raise AssertionContainsException(
            assertion=self,
            assert_value=repr(self.__value),
            expect_value=get_and_text(args)
        )
    ...
    def is_equal_to(self, expect_value):
        ...
        raise AssertionIsEqualToException(
            assertion=self,
            assert_value=repr(self.__value),
            expect_value=repr(expect_value)
        )
    ...
    def is_type_of(self, *args):
        ...
        raise AssertionIsTypeOfException(
            ...
            expect_type=get_or_text(
                [_type.__name__ for _type in args], represent=lambda x: x
            ),
    ...
    def is_not_type_of(self, *args):
        ...
        raise AssertionIsNotTypeOfException(
            assertion=self,
            assert_value=self.__value,
            expect_type=get_or_text([_type.__name__ for _type in args],
    ...
    def matches_schema(self, schema):
        ...
        raise AssertionMatchesSchemaException(
            assertion=self,
    ...
    def is_strictly_increasing(self):
        ...
        raise AssertionIsStrictlyIncreasingException(
            assertion=self,
            assert_value=self.__value
        )
    ...
    def is_strictly_decreasing(self):
        ...
        raise AssertionIsStrictlyDecreasingException(
            assertion=self,
            assert_value=self.__value
        )
    ...
    def is_non_strictly_increasing(self):
        ...
        raise AssertionIsNonStrictlyIncreasingException(
            assertion=self,
            assert_value=self.__value
        )
    ...
    def is_non_strictly_decreasing(self):
        ...
        raise AssertionIsNonStrictlyDecreasingException(
            assertion=self,
            assert_value=self.__value
        )
    ...
    def is_before(self, expect_time):
        ...
        raise AssertionIsBeforeException(
            assertion=self,
            assert_time=self.__value,
    ...
    def is_after(self, expect_time):
        ...
        raise AssertionIsAfterException(
            assertion=self,
            assert_time=self.__value,
            expect_time=expect_time
        )
    ...
    def is_file(self):
        ...
        raise AssertionIsFileException(
            assertion=self,
            assert_value=repr(self.__value)
        )
    ...
    def is_not_file(self):
        ...
        raise AssertionIsNotFileException(
            assertion=self,
            assert_value=repr(self.__value)
        )
    ...
    def is_directory(self):
        ...
        raise AssertionIsDirectoryException(
            assertion=self,
            assert_value=self.__value
        )
    ...
    def is_not_directory(self):
        ...
        raise AssertionIsNotDirectoryException(
            assertion=self,
            assert_value=self.__value
        )
    ...
    def does_not_exist(self):
        ...
        raise AssertionDoesNotExistException(
            assertion=self,
            assert_value=self.__value
        )
    ...
    def is_in(self, expect_value):
        ...
        if not isinstance(expect_value, Iterable):
            raise AssertionTypeMismatchException(
                self,
                'expect_value should be Iterable'
            )
        if self.__value in expect_value:
            return self

        raise AssertionIsInException(
            assertion=self,
            assert_value=repr(self.__value),
            expect_value=repr(expect_value)
        )
    ...
    def is_iterable(self):
        ...
        raise AssertionIsIterableException(
            assertion=self,
            assert_value=self.__value
        )
    ...
    def is_not_iterable(self):
        ...
        raise AssertionIsNotIterableException(
            assertion=self,
            assert_value=self.__value
        )
    ...
    def is_not_inf(self):
        ...
        raise AssertionIsNotInfException(
            assertion=self,
            assert_value=self.__value
        )
    ...
    def is_not_nan(self):
        ...
        raise AssertionIsNotNanException(
            assertion=self,
            assert_value=self.__value
        )
    ...
    def is_same_as(self, expect_value):
        ...
        raise AssertionIsSameAsException(
            assertion=self,
            assert_value=self.__value,
            expect_value=expect_value
        )
    ...
    def is_not_same_as(self, expect_value):
        ...
        raise AssertionIsNotSameAsException(
            assertion=self,
            assert_value=self.__value,
            expect_value=expect_value
        )
    ...
    def matches_regex(self, pattern):
        ...
        raise AssertionMatchesRegexException(
            assertion=self,
            assert_value=repr(self.__value),
            expect_value=pattern
        )
    ...
    def does_not_match_regex(self, pattern):
        ...
        raise AssertionDoesNotMatchRegexException(
            assertion=self,
            assert_value=repr(
                self.__value),
            expect_value=pattern
    ...
    def is_alpha(self):
        ...
        raise AssertionIsAlphaException(
            assertion=self,
            assert_value=self.__value)
    ...
    def is_not_alpha(self):
        ...
        raise AssertionIsNotAlphaException(
            assertion=self,
            assert_value=self.__value
        )
    ...
    def is_digit(self):
        ...
        raise AssertionIsDigitException(
            assertion=self,
            assert_value=self.__value
        )
    ...
    def is_not_digit(self):
        ...
        raise AssertionIsNotDigitException(
            assertion=self,
            assert_value=self.__value
        )
    ...
    def is_negative(self):
        ...
        raise AssertionIsNegativeException(
            assertion=self,
            assert_value=self.__value
        )
    ...
    def is_positive(self):
        ...
        raise AssertionIsPositiveException(
            assertion=self,
            assert_value=self.__value
        )
    ...
    def is_zero(self):
        ...
        raise AssertionIsZeroException(
            assertion=self,
            assert_value=self.__value
        )
    ...
    def is_not_zero(self):
        ...
        raise AssertionIsNotZeroException(
            assertion=self,
            assert_value=self.__value
        )
    ...
    def is_empty(self):
        ...
        raise AssertionIsEmptyException(
            assertion=self,
            assert_value=self.__value
        )
    ...
    def is_not_empty(self):
        ...
        raise AssertionIsNotEmptyException(
            assertion=self,
            assert_value=self.__value
        )
    ...
    def starts_with(self, expect_value):
        ...
        raise AssertionStartsWithException(
            assertion=self,
            assert_value=self.__value,
            expect_value=expect_value
        )
    ...
    def ends_with(self, expect_value):
        ...
        raise AssertionEndsWithException(
            assertion=self,
            assert_value=self.__value,
            expect_value=expect_value
        )
    ...
    def contains_duplicates(self):
        ...
        raise AssertionContainsDuplicatesException(
            assertion=self,
            assert_value=self.__value
        )
    ...
    def does_not_contain_duplicates(self):
        ...
        raise AssertionDoesNotContainDuplicatesException(
            assertion=self,
            assert_value=self.__value)
