...
from conjuguer.aux import aux
from conjuguer.blank import blank_verb

# Version string used by the what(1) and ident(1) commands:
ID = "@(#) $Id: conjuguer - conjugaison des verbes Français v0.1.1 (September 1, 2021) by Hubert Tournier $"
