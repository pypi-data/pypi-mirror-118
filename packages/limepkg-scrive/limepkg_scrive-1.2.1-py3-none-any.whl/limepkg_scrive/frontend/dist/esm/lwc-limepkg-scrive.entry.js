...
const Test = class {
    ...
    render() {
        ...
        return (h("section", null, h("limel-config", { config: { iconPath: '/static/limepkg_scrive/static/' } }), h("limel-button", { label: label, outlined: true, icon: "scrive", onClick: () => this.goToScrive(this.context.id) }), h("limel-checkbox", { label: cloneLabel, checked: this.cloneDocument, onChange: this.setCloneDocument }), h("p", null, cloneWarning)));
    }
