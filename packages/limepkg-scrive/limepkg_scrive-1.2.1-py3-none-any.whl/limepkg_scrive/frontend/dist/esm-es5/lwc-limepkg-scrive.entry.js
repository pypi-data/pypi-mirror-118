...
var Test = /** @class */ (function () {
    ...
    Test.prototype.render = function () {
        ...
        var cloneWarning = translate.get("limepkg_scrive.clone_warning");
        return (h("section", null, h("limel-config", { config: { iconPath: '/static/limepkg_scrive/static/' } }), h("limel-button", { label: label, outlined: true, icon: "scrive", onClick: function () { return _this.goToScrive(_this.context.id); } }), h("limel-checkbox", { label: cloneLabel, checked: this.cloneDocument, onChange: this.setCloneDocument }), h("p", null, cloneWarning)));
    };
