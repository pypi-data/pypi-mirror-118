...
class RNNBase(Layer):
    ...
    def __init__(self, mode: str, hidden_size: int,
                 ...
                 dropout_rate: float = 0., bidirectional: bool = False, proj_size: int = 0, name=None, keep_output=False, in_sequence=True, filter_index=-1) -> None:
            ...
            with torch.no_grad():
                if torch._use_cudnn_rnn_flatten_weight():
                    ...
                    torch._cudnn_rnn_flatten_weight(
                        ...
                        self.input_filters, rnn.get_cudnn_mode(self.mode),
...
class LSTM(RNNBase):
    ...
    def __init__(self, hidden_size, num_layers: int = 2, activation=None, stateful=False, use_bias=False, use_attention=False, attention_size=16, batch_first=False, dropout_rate=0,
                 bidirectional=False, name=None, keep_output=False, in_sequence=True, filter_index=-1, **kwargs):
...
class LSTMDecoder(Layer):
    def __init__(self, num_chars, embedding_dim, h_size=512, num_layers=2, sequence_length=128, stateful=True, dropout_rate=0.2, bidirectional=False, use_attention=False,
                 attention_size=16, teacher_forcing_ratio=1):
        super().__init__()
        ...
        self.lstm = LSTM(hidden_size=h_size, num_layers=num_layers, stateful=stateful, batch_first=False, dropout_rate=dropout_rate, bidirectional=bidirectional,
                         use_attention=use_attention, attention_size=attention_size)
...
class GRU(RNNBase):
    ...
    def __init__(self, hidden_size, num_layers: int = 2, activation=None, stateful=False, use_bias=False, use_attention=False, attention_size=16, batch_first=False, dropout_rate=0,
                 bidirectional=False, name=None, keep_output=False, in_sequence=True, filter_index=-1, **kwargs):
        super(GRU, self).__init__(mode='GRU', hidden_size=hidden_size,
                                  num_layers=num_layers, stateful=stateful, use_bias=use_bias, batch_first=batch_first,
                                  dropout_rate=dropout_rate, bidirectional=bidirectional, name=name, keep_output=keep_output, in_sequence=in_sequence, filter_index=filter_index)
