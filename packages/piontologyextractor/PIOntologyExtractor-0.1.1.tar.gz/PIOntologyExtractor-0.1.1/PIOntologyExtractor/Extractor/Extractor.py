...
class Extractor:
    ...
    def set_main_ontology(self, name: str):
        ...
        df_ont.to_excel(f'{self.out_dir}/{name}_info.xlsx')
        ...
        df_data_prop.to_excel(f'{self.out_dir}/{name}_data_prop_info.xlsx')
        ...
        df_obj_prop.to_excel(f'{self.out_dir}/{name}_obj_prop_info.xlsx')
    ...
    def set_expansion_data_properties(self, name):  
        ...
        df_exploded.to_excel(f'{self.out_dir}/{name}_expansion_data_prop.xlsx')
    ...
    def set_expansion_object_properties(self, name):
        ...
        df_exploded.to_excel(f'{self.out_dir}/{name}_expansion_obj_prop.xlsx')
    ...
    def set_inheritance_object_properties(self, name, inherit_label:str = 'is'):
        ...
        df_exploded.to_excel(f'{self.out_dir}/{name}_inheritance_obj_prop.xlsx')
