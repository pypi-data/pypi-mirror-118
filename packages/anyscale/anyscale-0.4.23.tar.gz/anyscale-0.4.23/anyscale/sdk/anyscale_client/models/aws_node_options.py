...
class AWSNodeOptions(object):
    ...
    def __init__(self, block_device_mappings=[{"DeviceName":"/dev/sda1","Ebs":{"VolumeSize":250}}], iam_instance_profile=None, security_group_ids=None, subnet_id=None, tag_specifications=None, network_interfaces=None, local_vars_configuration=None):  # noqa: E501
