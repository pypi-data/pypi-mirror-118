...
class EbsBlockDevice(object):
    ...
    def __init__(self, delete_on_termination=None, encrypted=None, iops=None, kms_key_id=None, outpost_arn=None, snapshot_id=None, throughput=None, volume_size=250, volume_type=None, local_vars_configuration=None):  # noqa: E501
