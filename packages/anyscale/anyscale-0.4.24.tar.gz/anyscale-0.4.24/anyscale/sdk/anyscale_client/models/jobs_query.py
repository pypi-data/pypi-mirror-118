...
class JobsQuery(object):
    ...
    def __init__(self, name=None, runtime_environment_id=None, cluster_id=None, creator_id=None, project_id=None, paging=None, state_filter=[], local_vars_configuration=None):  # noqa: E501
