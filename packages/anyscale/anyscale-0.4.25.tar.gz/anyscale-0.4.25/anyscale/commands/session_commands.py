...
@click.command(name="down", help="Stop the current cluster.")
...
@click.command(name="push", help="Push current project to cluster.")
@click.argument(
    "session-name", type=str, required=False, default=None, envvar="SESSION_NAME"
)
@click.option(
...
@click.command(name="pull", help="Pull cluster")
@click.argument(
    "session-name", type=str, required=False, default=None, envvar="SESSION_NAME"
)
@click.option(
...
@click.command(
    name="fork", help="Clones an existing cluster by name and initializes it"
)
