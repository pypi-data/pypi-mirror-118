...
class CheckBoxCollection():
    def __init__(self, x, y, amount,  texts, over_all_height=None, individual_height=None, realtive_height_of_element=0.8, only_one_simultaneous_ckeck=False,
        ...
        if not over_all_height and not individual_height:
            raise ValueError

        self.only_one_simultaneous_ckeck = only_one_simultaneous_ckeck

        height = over_all_height
        if individual_height:
            height = individual_height * amount
