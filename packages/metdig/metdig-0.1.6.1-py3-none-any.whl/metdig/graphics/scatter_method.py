...
def scatter_2d(ax, stda, xdim='lon', ydim='lat',
    ...
    Args:
        ...
        s=1400 (float, optional): [三点大小]. Defaults to 1.
    Returns:
        [type]: [绘图对象]
    """
    ...
    if transform is None or (xdim != 'lon' and ydim != 'lat'):
        img = ax.scatter(x, y, z, cmap=cmap,c=z, alpha=alpha, **kwargs)

    else:
        img = ax.scatter(x, y, z, norm=norm, cmap=cmap,c=z, transform=transform, alpha=alpha, **kwargs)
