...
class read_data:
    ...
    def __init__(self, Current_file, Voltage_file, r, AE, L):
        self.L = L
        self.r = r
        self.AE = AE
        self.Current = np.loadtxt(Current_file).transpose() # Matrix L x L-1
        self.Voltage = np.loadtxt(Voltage_file).transpose() # Matrix L x L-1
