...
def get_allgroups_psql(conn, legacy=False):
    ...
    # group_names is a dict-based holdout from prior to having a working db
        ...
        df.loc[df['optimed_boolean'] == 'true', 'optimed_boolean'] = True
        df.loc[df['optimed_boolean'] == 'false', 'optimed_boolean'] = False
        df.loc[df['nonmember_boolean'] == 'true', 'nonmember_boolean'] = True
        df.loc[df['nonmember_boolean'] == 'false', 'nonmember_boolean'] = False
