...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'aiven', '4.2.0-alpha.1630675919+fbb4e174'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource aiven 4.2.0-alpha.1630675919+fbb4e174`
                """)
            else:
                raise
