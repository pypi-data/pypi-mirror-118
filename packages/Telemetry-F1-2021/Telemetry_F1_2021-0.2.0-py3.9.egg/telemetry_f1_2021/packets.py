...
class CarTelemetryData(Packet):
    _fields_ = [
        ...
        ("m_tyre_surface_temperature", ctypes.c_uint8 * 4),
        # tyre surface temperature (celsius)
        ("m_tyre_inner_temperature", ctypes.c_uint8 * 4),
        # tyre inner temperature (celsius)
        ("m_engine_temperature", ctypes.c_uint16),  # Engine temperature (celsius)
        ("m_tyre_pressure", ctypes.c_float * 4),  # tyre pressure (PSI)
...
class CarStatusData(Packet):
    _fields_ = [
        ...
        # 21 = medium , 22 = hard
        ("m_tyre_age_laps", ctypes.c_uint8),  # Age in laps of the current set of tyre
...
class FinalClassificationData(Packet):
    _fields_ = [
        ...
        ("m_num_tyre_stints", ctypes.c_uint8),  # Number of tyre stints up to maximum
...
class CarDamageData(Packet):
    _fields_ = [
        ("m_tyre_wear", ctypes.c_float * 4),  # Tyre wear (percentage)
        ("m_tyre_damage", ctypes.c_uint8 * 4),  # Tyre damage (percentage)
...
class TyreStintHistoryData(Packet):
    _fields_ = [
        ...
        ("m_tyre_actual_compound", ctypes.c_uint8),  # Actual tyre used by this driver
        ("m_tyre_visual_compound", ctypes.c_uint8),  # Visual tyre used by this driver
    ]
