...
def create_connection_to_cos(wml_client, cos_credentials, cos_endpoint, bucket_name, save_data=False, data_path=None,
    ...
    if save_data and data_path and data_cos_path:
        bucket_name = save_data_to_cos_bucket(data_path, data_cos_path, cos_credentials['cos_hmac_keys']['access_key_id'],
                                cos_credentials['cos_hmac_keys']['secret_access_key'], cos_endpoint, bucket_name,
                                is_container=False)
