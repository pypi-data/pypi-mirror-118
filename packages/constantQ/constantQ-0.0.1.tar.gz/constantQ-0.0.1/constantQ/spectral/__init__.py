...
from constantQ.spectral._registry import (get_method, register_method)
from constantQ.spectral._scipy import (
    bartlett,
    csd,
    median,
    rayleigh,
...
from constantQ.spectral._ui import (psd, spectrogram, average_spectrogram)
