...
def do_setup():
    ...
    setup(
        ...
        install_requires=['apache-airflow>=2.1.0rc1', 'sqlalchemy-drill>=1.1.0', 'sqlparse>=0.4.1'],
        ...
        python_requires='~=3.6',
        project_urls={
            'Documentation': 'https://airflow.apache.org/docs/apache-airflow-providers-apache-drill/1.0.1/',
