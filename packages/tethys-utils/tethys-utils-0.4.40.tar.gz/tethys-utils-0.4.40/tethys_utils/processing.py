...
def prepare_results_v02(dataset, results_data, run_date_key, sum_closed='right', other_closed='left', discrete=True, other_attrs=None, other_encoding=None, ignore_resampling=False):
    """
    ...
    ## Aggregate data if necessary
    # Parameter
    if (freq_code == 'T') or ignore_resampling:
        data2 = ts_data1
    else:
        agg_fun = agg_stat_mapping[ds_mapping['aggregation_statistic']]
